...
& gSvSvChiChi,gSvcHpmChiFe,gSvSeChicCha,gSvFeAhcCha,gSvFeFucSd,gSvFeFvcSe,               & 
& gSvhhFecCha,gSvFeSucFd,gSvSvFecFe,gSvFvAhChi,gSvcHpmChaFv,gSvhhChiFv,gSvFvFdcSd,       & 
& gSvFvFucSu,gSvFvFvcSv,gSvcChaFvHpm,gSvFvSdcFd,gSvSeFvcFe,gSvFvSucFu,gSvSvFvcFv,        & 
& gSvSeFucFd,gSvSvChacCha,gSvSvFdcFd,gSvSvFucFu,epsI,deltaM,CheckRealStates,             & 
& gT,gPartial,BR)
...
& Tmup,vd,vu,vS,cplcChacFvSeL,cplcChacFvSeR,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,   & 
