...
(* Fd,VZp, Internal:Fd*) 
{{Fd,VZp,Internal->Fd},chargefactor -> 1,{coup1L -> Cp[bar[Fd], Fd, VZp][L][gt1,i1],coup1R -> Cp[bar[Fd], Fd, VZp][R][gt1,i1],coup2L -> Cp[bar[Fd], Fd, VZp][L][i1,i3],coup2R -> Cp[bar[Fd], Fd, VZp][R][i1,i3],coup3L -> Cp[bar[Fd], Fd, VG][L][i3,gt2],coup3R -> Cp[bar[Fd], Fd, VG][R][i3,gt2]},{mF1 -> M[Fd][i1],mV1 -> M[VZp],MFin -> M[Fd][i3]-M[Fd][gt1]}},
...
{{VZp,Fd,Internal->bar[Fd]},chargefactor -> 1,{coup3L -> Cp[bar[Fd], Fd, VG][L][gt1,i3],coup3R -> Cp[bar[Fd], Fd, VG][R][gt1,i3],coup2L -> Cp[bar[Fd], Fd, VZp][L][i3,i2],coup2R -> Cp[bar[Fd], Fd, VZp][R][i3,i2],coup1L -> Cp[bar[Fd], Fd, VZp][L][i2,gt2],coup1R -> Cp[bar[Fd], Fd, VZp][R][i2,gt2]},{mV1 -> M[VZp],mF1 -> M[Fd][i2],MFin -> M[Fd][i3]-M[Fd][gt2]}},
...
(* VZp,bar[Fd],bar[Fd]*) 
{{VZp,bar[Fd],bar[Fd]},chargefactor -> 1,{coup1L -> Cp[bar[Fd], Fd, VZp][L][gt1,i2],coup1R -> Cp[bar[Fd], Fd, VZp][R][gt1,i2],coup2L -> Cp[bar[Fd], Fd, VZp][L][i3,gt2],coup2R -> Cp[bar[Fd], Fd, VZp][R][i3,gt2],coup3L -> Cp[bar[Fd], Fd, VG][L][i2,i3],coup3R -> Cp[bar[Fd], Fd, VG][R][i2,i3]},}
};