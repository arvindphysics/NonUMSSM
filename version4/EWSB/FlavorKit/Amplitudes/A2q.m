...
(* ----------------------------------------------------------------------------- *) 
(* File created at 16:26 on 21.3.2021  *) 
(* ---------------------------------------------------------------------- *) 
...
(* VZp,Fd, Internal:bar[Fd]*) 
{{VZp,Fd,Internal->bar[Fd]},chargefactor -> 1,{coup1L -> Cp[bar[Fd], Fd, VZp][L][i2,gt1],coup1R -> Cp[bar[Fd], Fd, VZp][R][i2,gt1],coup2L -> Cp[bar[Fd], Fd, VZp][L][i3,i2],coup2R -> Cp[bar[Fd], Fd, VZp][R][i3,i2],coup3L -> Cp[bar[Fd], Fd, Ah][L][gt2,i3,gt3],coup3R -> Cp[bar[Fd], Fd, Ah][R][gt2,i3,gt3]},{mV1 -> M[VZp],mF1 -> M[Fd][i2],MFin -> M[Fd][i3]-M[Fd][gt1]}},
...
(* Fd,VZp, Internal:Fd*) 
{{Fd,VZp,Internal->Fd},chargefactor -> 1,{coup3L -> Cp[bar[Fd], Fd, Ah][L][i3,gt1,gt3],coup3R -> Cp[bar[Fd], Fd, Ah][R][i3,gt1,gt3],coup2L -> Cp[bar[Fd], Fd, VZp][L][i1,i3],coup2R -> Cp[bar[Fd], Fd, VZp][R][i1,i3],coup1L -> Cp[bar[Fd], Fd, VZp][L][gt2,i1],coup1R -> Cp[bar[Fd], Fd, VZp][R][gt2,i1]},{mF1 -> M[Fd][i1],mV1 -> M[VZp],MFin -> M[Fd][i3]-M[Fd][gt2]}},
...
(* VZp,Fd,Fd*) 
{{VZp,Fd,Fd},chargefactor -> 1,{coup1L -> Cp[bar[Fd], Fd, VZp][L][i2,gt1],coup1R -> Cp[bar[Fd], Fd, VZp][R][i2,gt1],coup2L -> Cp[bar[Fd], Fd, VZp][L][gt2,i3],coup2R -> Cp[bar[Fd], Fd, VZp][R][gt2,i3],coup3L -> Cp[bar[Fd], Fd, Ah][L][i3,i2,gt3],coup3R -> Cp[bar[Fd], Fd, Ah][R][i3,i2,gt3]},},
(* bar[Cha],Su,Su*) 
...
(* bar[Fd],VZp,hh*) 
{{bar[Fd],VZp,hh},chargefactor -> 1,{coup1L -> Cp[bar[Fd], Fd, VZp][L][i1,gt1],coup1R -> Cp[bar[Fd], Fd, VZp][R][i1,gt1],coup2L -> Cp[bar[Fd], Fd, hh][L][gt2,i1,i3],coup2R -> Cp[bar[Fd], Fd, hh][R][gt2,i1,i3],coup3 -> Cp[Ah, hh, VZp][gt3,i3]},},
(* bar[Fd],hh,VZ*) 
...
(* bar[Fd],hh,VZp*) 
{{bar[Fd],hh,VZp},chargefactor -> 1,{coup1L -> Cp[bar[Fd], Fd, hh][L][i1,gt1,i2],coup1R -> Cp[bar[Fd], Fd, hh][R][i1,gt1,i2],coup2L -> Cp[bar[Fd], Fd, VZp][L][gt2,i1],coup2R -> Cp[bar[Fd], Fd, VZp][R][gt2,i1],coup3 -> Cp[Ah, hh, VZp][gt3,i2]},},
(* bar[Fu],Hpm,Hpm*) 
