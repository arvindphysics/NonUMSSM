...
Module CouplingsForDecays_NonUMSSMv4
...
& gpinput,Ydinput,Ye11input,Ye22input,Ye33input,laminput,Yv11input,Yv22input,            & 
& Yv33input,Yuinput,Tdinput,TYe11input,TYe22input,TYe33input,Tlaminput,TYv11input,       & 
& TYv22input,TYv33input,Tuinput,mq2input,ml012input,ml022input,ml032input,               & 
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,mvR012input,    & 
& mvR022input,mvR032input,ms2input,M1input,M2input,M3input,M4input,Tepinput,             & 
& Tmupinput,vdinput,vuinput,vSinput,cplAhSdcSd,cplChaFucSdL,cplChaFucSdR,cplChiFdcSdL,   & 
& cplChiFdcSdR,cplGluFdcSdL,cplGluFdcSdR,cplhhSdcSd,cplHpmSucSd,cplSdcSdVZ,              & 
& cplSdcSdVZp,cplSucSdVWm,deltaM)
...
Real(dp),Intent(in) :: g1input,g2input,g3input,gpinput,ml012input,ml022input,ml032input,mHd2input,           & 
& mHu2input,me012input,me022input,me032input,mvR012input,mvR022input,mvR032input,        & 
& ms2input,vdinput,vuinput,vSinput

Complex(dp),Intent(in) :: Ydinput(3,3),Ye11input,Ye22input,Ye33input,laminput,Yv11input,Yv22input,              & 
& Yv33input,Yuinput(3,3),Tdinput(3,3),TYe11input,TYe22input,TYe33input,Tlaminput,        & 
& TYv11input,TYv22input,TYv33input,Tuinput(3,3),mq2input(3,3),md2input(3,3),             & 
& mu2input(3,3),M1input,M2input,M3input,M4input,Tepinput,Tmupinput
...
Real(dp) :: g1,g2,g3,gp,ml012,ml022,ml032,mHd2,mHu2,me012,me022,me032,mvR012,mvR022,              & 
& mvR032,ms2,vd,vu,vS

Complex(dp) :: Yd(3,3),Ye11,Ye22,Ye33,lam,Yv11,Yv22,Yv33,Yu(3,3),Td(3,3),TYe11,TYe22,TYe33,          & 
& Tlam,TYv11,TYv22,TYv33,Tu(3,3),mq2(3,3),md2(3,3),mu2(3,3),M1,M2,M3,M4,Tep,Tmup

Complex(dp),Intent(out) :: cplAhSdcSd(3,6,6),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),cplChiFdcSdL(6,3,6),        & 
& cplChiFdcSdR(6,3,6),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),cplhhSdcSd(3,6,6),             & 
...
Call ParametersToG185(g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yv11,Yv22,Yv33,               & 
...
& Tep,Tmup,vd,vu,vS,g1D)

If ((m_in.le.Qin).and.(RunningCouplingsDecays)) Then 
  tz=Log(m_in/Qin) 
  If (m_in.le.mz) tz=Log(mz/Qin)  
  dt=tz/50._dp 
  Call odeint(g1D,185,0._dp,tz,deltaM,dt,0._dp,rge185,kont)

End if 
Call GToParameters185(g1D,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yv11,Yv22,Yv33,           & 
& Yu,Td,TYe11,TYe22,TYe33,Tlam,TYv11,TYv22,TYv33,Tu,mq2,ml012,ml022,ml032,               & 
& mHd2,mHu2,md2,mu2,me012,me022,me032,mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,              & 
& Tep,Tmup,vd,vu,vS)
...
Do gt1 = 1, 3
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplinghhSdcSdT(gt1,gt2,gt3,g1,g2,gp,Yd,Td,lam,vd,vu,vS,ZD,ZH,cplhhSdcSd(gt1,gt2,gt3))
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,mvR012input,    & 
& mvR022input,mvR032input,ms2input,M1input,M2input,M3input,M4input,Tepinput,             & 
& Tmupinput,vdinput,vuinput,vSinput,cplAhSucSu,cplChiFucSuL,cplChiFucSuR,cplcChaFdcSuL,  & 
& cplcChaFdcSuR,cplGluFucSuL,cplGluFucSuR,cplhhSucSu,cplSdcHpmcSu,cplSdcSucVWm,          & 
& cplSucSuVZ,cplSucSuVZp,deltaM)
...
Complex(dp),Intent(out) :: cplAhSucSu(3,6,6),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6),cplcChaFdcSuL(2,3,6),       & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplinghhSucSuT(gt1,gt2,gt3,g1,g2,gp,lam,Yu,Tu,vd,vu,vS,ZU,ZH,cplhhSucSu(gt1,gt2,gt3))
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,mvR012input,    & 
& mvR022input,mvR032input,ms2input,M1input,M2input,M3input,M4input,Tepinput,             & 
& Tmupinput,vdinput,vuinput,vSinput,cplAhSecSe,cplChaFvcSeL,cplChaFvcSeR,cplChiFecSeL,   & 
& cplChiFecSeR,cplhhSecSe,cplHpmSvcSe,cplSecSeVZ,cplSecSeVZp,cplSvcSeVWm,deltaM)
...
Complex(dp),Intent(out) :: cplAhSecSe(3,6,6),cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),cplChiFecSeL(6,3,6),        & 
& cplChiFecSeR(6,3,6),cplhhSecSe(3,6,6),cplHpmSvcSe(2,6,6),cplSecSeVZ(6,6),              & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplingAhSecSeT(gt1,gt2,gt3,Ye11,TYe11,Ye22,TYe22,Ye33,TYe33,lam,               & 
& Tep,Tmup,vu,vS,ZE,ZA,cplAhSecSe(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplinghhSecSeT(gt1,gt2,gt3,g1,g2,gp,Ye11,TYe11,Ye22,TYe22,Ye33,TYe33,          & 
& lam,Tep,Tmup,vd,vu,vS,ZE,ZH,cplhhSecSe(gt1,gt2,gt3))
...
Do gt1 = 1, 2
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplingHpmSvcSeT(gt1,gt2,gt3,g2,Ye11,TYe11,Ye22,TYe22,Ye33,TYe33,               & 
& lam,Yv11,TYv11,Yv22,TYv22,Yv33,TYv33,Tep,Tmup,vd,vu,vS,ZV,ZE,ZP,cplHpmSvcSe(gt1,gt2,gt3))
...
Do gt1 = 1, 2
 Do gt2 = 1, 3
  Do gt3 = 1, 6
Call CouplingChaFvcSeT(gt1,gt2,gt3,g2,Ye11,Ye22,Ye33,Yv11,Yv22,Yv33,ZVL,              & 
& ZVR,ZE,UM,UP,cplChaFvcSeL(gt1,gt2,gt3),cplChaFvcSeR(gt1,gt2,gt3))
...
Do gt1 = 1, 6
 Do gt2 = 1, 3
  Do gt3 = 1, 6
Call CouplingChiFecSeT(gt1,gt2,gt3,g1,g2,gp,Ye11,Ye22,Ye33,ZE,ZN,ZEL,ZER,             & 
& cplChiFecSeL(gt1,gt2,gt3),cplChiFecSeR(gt1,gt2,gt3))
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,mvR012input,    & 
& mvR022input,mvR032input,ms2input,M1input,M2input,M3input,M4input,Tepinput,             & 
& Tmupinput,vdinput,vuinput,vSinput,cplAhSvcSv,cplChiFvcSvL,cplChiFvcSvR,cplcChaFecSvL,  & 
& cplcChaFecSvR,cplhhSvcSv,cplSecHpmcSv,cplSecSvcVWm,cplSvcSvVZ,cplSvcSvVZp,deltaM)
...
Complex(dp),Intent(out) :: cplAhSvcSv(3,6,6),cplChiFvcSvL(6,3,6),cplChiFvcSvR(6,3,6),cplcChaFecSvL(2,3,6),       & 
& cplcChaFecSvR(2,3,6),cplhhSvcSv(3,6,6),cplSecHpmcSv(6,2,6),cplSecSvcVWm(6,6),          & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplingAhSvcSvT(gt1,gt2,gt3,lam,Yv11,TYv11,Yv22,TYv22,Yv33,TYv33,               & 
& vd,vS,ZV,ZA,cplAhSvcSv(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplinghhSvcSvT(gt1,gt2,gt3,g1,g2,gp,lam,Yv11,TYv11,Yv22,TYv22,Yv33,            & 
& TYv33,vd,vu,vS,ZV,ZH,cplhhSvcSv(gt1,gt2,gt3))
...
Do gt1 = 1, 6
 Do gt2 = 1, 2
  Do gt3 = 1, 6
Call CouplingSecHpmcSvT(gt1,gt2,gt3,g2,Ye11,TYe11,Ye22,TYe22,Ye33,TYe33,              & 
& lam,Yv11,TYv11,Yv22,TYv22,Yv33,TYv33,Tep,Tmup,vd,vu,vS,ZV,ZE,ZP,cplSecHpmcSv(gt1,gt2,gt3))
...
Do gt1 = 1, 6
 Do gt2 = 1, 3
  Do gt3 = 1, 6
Call CouplingChiFvcSvT(gt1,gt2,gt3,g1,g2,gp,Yv11,Yv22,Yv33,ZV,ZVL,ZVR,ZN,             & 
& cplChiFvcSvL(gt1,gt2,gt3),cplChiFvcSvR(gt1,gt2,gt3))
...
Do gt1 = 1, 2
 Do gt2 = 1, 3
  Do gt3 = 1, 6
Call CouplingcChaFecSvT(gt1,gt2,gt3,g2,Ye11,Ye22,Ye33,Yv11,Yv22,Yv33,ZV,              & 
& UM,UP,ZEL,ZER,cplcChaFecSvL(gt1,gt2,gt3),cplcChaFecSvR(gt1,gt2,gt3))
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,mvR012input,    & 
& mvR022input,mvR032input,ms2input,M1input,M2input,M3input,M4input,Tepinput,             & 
& Tmupinput,vdinput,vuinput,vSinput,cplHiggsPP,cplHiggsGG,cplHiggsZZvirt,cplHiggsWWvirt, & 
& cplAhAhhh,cplAhhhhh,cplAhhhVZ,cplAhhhVZp,cplcChaChahhL,cplcChaChahhR,cplChiChihhL,     & 
...
& cplAhhhhh(3,3,3),cplAhhhVZ(3,3),cplAhhhVZp(3,3),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),& 
...
& cplcFvFvhhL(3,3,3),cplcFvFvhhR(3,3,3),cplhhhhhh(3,3,3),cplhhHpmcHpm(3,2,2),            & 
& cplhhHpmcVWm(3,2),cplhhSdcSd(3,6,6),cplhhSecSe(3,6,6),cplhhSucSu(3,6,6),               & 
& cplhhSvcSv(3,6,6),cplhhcVWmVWm(3),cplhhVZVZ(3),cplhhVZVZp(3),cplhhVZpVZp(3)
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingAhAhhhT(gt1,gt2,gt3,g1,g2,gp,lam,Tlam,vd,vu,vS,ZH,ZA,cplAhAhhh(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingAhhhhhT(gt1,gt2,gt3,lam,Tlam,ZH,ZA,cplAhhhhh(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplinghhhhhhT(gt1,gt2,gt3,g1,g2,gp,lam,Tlam,vd,vu,vS,ZH,cplhhhhhh(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 2
  Do gt3 = 1, 2
Call CouplinghhHpmcHpmT(gt1,gt2,gt3,g1,g2,gp,lam,Tlam,vd,vu,vS,ZH,ZP,cplhhHpmcHpm(gt1,gt2,gt3))
...
cplhhVZVZ = 0._dp 
Do gt1 = 1, 3
Call CouplinghhVZVZT(gt1,g1,g2,gp,vd,vu,vS,ZH,TW,TWp,cplhhVZVZ(gt1))
...
cplhhVZVZp = 0._dp 
Do gt1 = 1, 3
Call CouplinghhVZVZpT(gt1,g1,g2,gp,vd,vu,vS,ZH,TW,TWp,cplhhVZVZp(gt1))
...
cplhhVZpVZp = 0._dp 
Do gt1 = 1, 3
Call CouplinghhVZpVZpT(gt1,g1,g2,gp,vd,vu,vS,ZH,TW,TWp,cplhhVZpVZp(gt1))
...
Do gt1 = 1, 6
 Do gt2 = 1, 6
  Do gt3 = 1, 3
Call CouplingChiChihhT(gt1,gt2,gt3,g1,g2,gp,lam,ZH,ZN,cplChiChihhL(gt1,gt2,gt3)       & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingcFeFehhT(gt1,gt2,gt3,Ye11,Ye22,Ye33,ZH,ZEL,ZER,cplcFeFehhL(gt1,gt2,gt3)  & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingcFvFvhhT(gt1,gt2,gt3,Yv11,Yv22,Yv33,ZVL,ZVR,ZH,cplcFvFvhhL(gt1,gt2,gt3)  & 
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,mvR012input,    & 
& mvR022input,mvR032input,ms2input,M1input,M2input,M3input,M4input,Tepinput,             & 
& Tmupinput,vdinput,vuinput,vSinput,cplPseudoHiggsPP,cplPseudoHiggsGG,cplAhAhAh,         & 
...
& cplAhSecSe,cplAhSucSu,cplAhSvcSv,deltaM)
...
& cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),cplChiChiAhL(6,6,3),cplChiChiAhR(6,6,3),     & 
& cplcFdFdAhL(3,3,3),cplcFdFdAhR(3,3,3),cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),           & 
& cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),cplcFvFvAhL(3,3,3),cplcFvFvAhR(3,3,3),           & 
& cplAhhhhh(3,3,3),cplAhhhVZ(3,3),cplAhhhVZp(3,3),cplAhHpmcHpm(3,2,2),cplAhHpmcVWm(3,2), & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingAhAhAhT(gt1,gt2,gt3,lam,Tlam,ZA,cplAhAhAh(gt1,gt2,gt3))
...
Do gt1 = 1, 6
 Do gt2 = 1, 6
  Do gt3 = 1, 3
Call CouplingChiChiAhT(gt1,gt2,gt3,g1,g2,gp,lam,ZA,ZN,cplChiChiAhL(gt1,gt2,gt3)       & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingcFeFeAhT(gt1,gt2,gt3,Ye11,Ye22,Ye33,ZA,ZEL,ZER,cplcFeFeAhL(gt1,gt2,gt3)  & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingcFvFvAhT(gt1,gt2,gt3,Yv11,Yv22,Yv33,ZVL,ZVR,ZA,cplcFvFvAhL(gt1,gt2,gt3)  & 
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,mvR012input,    & 
& mvR022input,mvR032input,ms2input,M1input,M2input,M3input,M4input,Tepinput,             & 
& Tmupinput,vdinput,vuinput,vSinput,cplAhHpmcHpm,cplAhcHpmVWm,cplChiChacHpmL,            & 
& cplChiChacHpmR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFvFecHpmL,cplcFvFecHpmR,cplhhHpmcHpm,   & 
& cplhhcHpmVWm,cplHpmcHpmVZ,cplHpmcHpmVZp,cplSdcHpmcSu,cplSecHpmcSv,cplcHpmVWmVZ,        & 
& cplcHpmVWmVZp,deltaM)
...
Complex(dp),Intent(out) :: cplAhHpmcHpm(3,2,2),cplAhcHpmVWm(3,2),cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),    & 
& cplcFuFdcHpmL(3,3,2),cplcFuFdcHpmR(3,3,2),cplcFvFecHpmL(3,3,2),cplcFvFecHpmR(3,3,2),   & 
& cplhhHpmcHpm(3,2,2),cplhhcHpmVWm(3,2),cplHpmcHpmVZ(2,2),cplHpmcHpmVZp(2,2),            & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 2
Call CouplingcFvFecHpmT(gt1,gt2,gt3,Ye11,Ye22,Ye33,Yv11,Yv22,Yv33,ZVL,ZVR,            & 
& ZP,ZEL,ZER,cplcFvFecHpmL(gt1,gt2,gt3),cplcFvFecHpmR(gt1,gt2,gt3))
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,mvR012input,    & 
& mvR022input,mvR032input,ms2input,M1input,M2input,M3input,M4input,Tepinput,             & 
& Tmupinput,vdinput,vuinput,vSinput,cplAhhhVZp,cplcChaChaVZpL,cplcChaChaVZpR,            & 
& cplChiChiVZpL,cplChiChiVZpR,cplcFdFdVZpL,cplcFdFdVZpR,cplcFeFeVZpL,cplcFeFeVZpR,       & 
& cplcFuFuVZpL,cplcFuFuVZpR,cplcFvFvVZpL,cplcFvFvVZpR,cplhhVZVZp,cplhhVZpVZp,            & 
...
Complex(dp),Intent(out) :: cplAhhhVZp(3,3),cplcChaChaVZpL(2,2),cplcChaChaVZpR(2,2),cplChiChiVZpL(6,6),           & 
...
& cplcFvFvVZpR(3,3),cplhhVZVZp(3),cplhhVZpVZp(3),cplHpmcHpmVZp(2,2),cplHpmcVWmVZp(2),    & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingcFvFvVZpT(gt1,gt2,g1,g2,gp,ZVL,ZVR,TW,TWp,cplcFvFvVZpL(gt1,gt2)          & 
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,mvR012input,    & 
& mvR022input,mvR032input,ms2input,M1input,M2input,M3input,M4input,Tepinput,             & 
& Tmupinput,vdinput,vuinput,vSinput,cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,              & 
& cplGluFucSuR,deltaM)
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,mvR012input,    & 
& mvR022input,mvR032input,ms2input,M1input,M2input,M3input,M4input,Tepinput,             & 
& Tmupinput,vdinput,vuinput,vSinput,cplChiChiAhL,cplChiChiAhR,cplChiChacHpmL,            & 
...
Complex(dp),Intent(out) :: cplChiChiAhL(6,6,3),cplChiChiAhR(6,6,3),cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),  & 
& cplChiChacVWmL(6,2),cplChiChacVWmR(6,2),cplChiChihhL(6,6,3),cplChiChihhR(6,6,3),       & 
...
& cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6),cplChiFvcSvL(6,3,6),cplChiFvcSvR(6,3,6)
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,mvR012input,    & 
& mvR022input,mvR032input,ms2input,M1input,M2input,M3input,M4input,Tepinput,             & 
& Tmupinput,vdinput,vuinput,vSinput,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,           & 
...
Do gt1 = 1, 2
 Do gt2 = 1, 3
  Do gt3 = 1, 6
Call CouplingcChacFvSeT(gt1,gt2,gt3,g2,Ye11,Ye22,Ye33,Yv11,Yv22,Yv33,ZVL,             & 
& ZVR,ZE,UM,UP,cplcChacFvSeL(gt1,gt2,gt3),cplcChacFvSeR(gt1,gt2,gt3))
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,mvR012input,    & 
& mvR022input,mvR032input,ms2input,M1input,M2input,M3input,M4input,Tepinput,             & 
& Tmupinput,vdinput,vuinput,vSinput,cplcFuFuAhL,cplcFuFuAhR,cplcFuChiSuL,cplcFuChiSuR,   & 
...
Complex(dp),Intent(out) :: cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),cplcFuChiSuL(3,6,6),cplcFuChiSuR(3,6,6),        & 
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,mvR012input,    & 
& mvR022input,mvR032input,ms2input,M1input,M2input,M3input,M4input,Tepinput,             & 
& Tmupinput,vdinput,vuinput,vSinput,cplcChacFuSdL,cplcChacFuSdR,cplcChaFdcSuL,           & 
...
& cplcFdChiSdL(3,6,6),cplcFdChiSdR(3,6,6),cplcFdGluSdL(3,6),cplcFdGluSdR(3,6),           & 
& cplcFuChiSuL(3,6,6),cplcFuChiSuR(3,6,6),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),           & 
& cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6),       & 
...
& cplcFuFuVZR,cplcFuGluSuL,cplcFuGluSuR,cplcFvChiSvL,cplcFvChiSvR,cplcFvFvAhL,           & 
...
& cplChiFvcSvR,cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,cplGluFucSuR,deltaM)
...
Do gt1 = 1, 3
 Do gt2 = 1, 2
  Do gt3 = 1, 6
Call CouplingcFeChaSvT(gt1,gt2,gt3,g2,Ye11,Ye22,Ye33,Yv11,Yv22,Yv33,ZV,               & 
& UM,UP,ZEL,ZER,cplcFeChaSvL(gt1,gt2,gt3),cplcFeChaSvR(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplingcFeChiSeT(gt1,gt2,gt3,g1,g2,gp,Ye11,Ye22,Ye33,ZE,ZN,ZEL,ZER,             & 
& cplcFeChiSeL(gt1,gt2,gt3),cplcFeChiSeR(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplingcFvChiSvT(gt1,gt2,gt3,g1,g2,gp,Yv11,Yv22,Yv33,ZV,ZVL,ZVR,ZN,             & 
& cplcFvChiSvL(gt1,gt2,gt3),cplcFvChiSvR(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 2
Call CouplingcFeFvHpmT(gt1,gt2,gt3,Ye11,Ye22,Ye33,Yv11,Yv22,Yv33,ZVL,ZVR,             & 
& ZP,ZEL,ZER,cplcFeFvHpmL(gt1,gt2,gt3),cplcFeFvHpmR(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingcFeFeVZT(gt1,gt2,g1,g2,gp,ZEL,ZER,TW,TWp,cplcFeFeVZL(gt1,gt2)            & 
& ,cplcFeFeVZR(gt1,gt2))
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingcFvFvVZT(gt1,gt2,g1,g2,gp,ZVL,ZVR,TW,TWp,cplcFvFvVZL(gt1,gt2)            & 
& ,cplcFvFvVZR(gt1,gt2))
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,mvR012input,    & 
& mvR022input,mvR032input,ms2input,M1input,M2input,M3input,M4input,Tepinput,             & 
& Tmupinput,vdinput,vuinput,vSinput,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,           & 
...
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFeChaSvL,            & 
& cplcFeChaSvR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,              & 
& cplcFeFeVZpL,cplcFeFeVZpR,cplcFeFeVZR,cplcFuChiSuL,cplcFuChiSuR,cplcFuFdcHpmL,         & 
& cplcFuFdcHpmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,         & 
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplcFuGluSuL,            & 
...
& cplcFeFeVZL(3,3),cplcFeFeVZpL(3,3),cplcFeFeVZpR(3,3),cplcFeFeVZR(3,3),cplcFuChiSuL(3,6,6),& 
...
& cplcFuFuhhR(3,3,3),cplcFuFuVZL(3,3),cplcFuFuVZpL(3,3),cplcFuFuVZpR(3,3),               & 
& cplcFuFuVZR(3,3),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplcFvChiSvL(3,6,6),              & 
& cplcFvChiSvR(3,6,6),cplcFvFecHpmL(3,3,2),cplcFvFecHpmR(3,3,2),cplcFvFecVWmL(3,3),      & 
& cplcFvFecVWmR(3,3),cplcFvFvAhL(3,3,3),cplcFvFvAhR(3,3,3),cplcFvFvhhL(3,3,3),           & 
& cplcFvFvhhR(3,3,3),cplcFvFvVZL(3,3),cplcFvFvVZpL(3,3),cplcFvFvVZpR(3,3),               & 
...
& cplChiFecSeR(6,3,6),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6)
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,mvR012input,    & 
& mvR022input,mvR032input,ms2input,M1input,M2input,M3input,M4input,Tepinput,             & 
& Tmupinput,vdinput,vuinput,vSinput,cplAhSdcSd,cplcChacFuSdL,cplcChacFuSdR,              & 
...
& cplcChaChiHpmR,cplcChaFdcSuL,cplcChaFdcSuR,cplcChaFecSvL,cplcChaFecSvR,cplcFdChaSuL,   & 
& cplcFdChaSuR,cplcFdChiSdL,cplcFdChiSdR,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,            & 
& cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFuHpmL,            & 
...
& cplcFvFvAhR,cplcFvFvhhL,cplcFvFvhhR,cplcFvFvVZL,cplcFvFvVZpL,cplcFvFvVZpR,             & 
& cplcFvFvVZR,cplChaFucSdL,cplChaFucSdR,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,    & 
...
& cplChiFecSeR,cplChiFucSuL,cplChiFucSuR,cplChiFvcSvL,cplChiFvcSvR,cplGluFdcSdL,         & 
& cplGluFdcSdR,cplGluFucSuL,cplGluFucSuR,cplhhSdcSd,cplHpmSucSd,cplSdcSdVZ,              & 
& cplSdcSdVZp,cplSucSdVWm,deltaM)
...
& cplcChaChahhR(2,2,3),cplcChaChaVZL(2,2),cplcChaChaVZpL(2,2),cplcChaChaVZpR(2,2),       & 
& cplcChaChaVZR(2,2),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),cplcChaFdcSuL(2,3,6),   & 
...
& cplcFdFuHpmR(3,3,2),cplcFdGluSdL(3,6),cplcFdGluSdR(3,6),cplcFeChiSeL(3,6,6),           & 
& cplcFeChiSeR(3,6,6),cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplcFeFehhL(3,3,3),          & 
& cplcFeFehhR(3,3,3),cplcFeFeVZL(3,3),cplcFeFeVZpL(3,3),cplcFeFeVZpR(3,3),               & 
& cplcFeFeVZR(3,3),cplcFuChiSuL(3,6,6),cplcFuChiSuR(3,6,6),cplcFuFdcHpmL(3,3,2),         & 
& cplcFuFdcHpmR(3,3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplcFuFuAhL(3,3,3),         & 
& cplcFuFuAhR(3,3,3),cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),cplcFuFuVZL(3,3),             & 
& cplcFuFuVZpL(3,3),cplcFuFuVZpR(3,3),cplcFuFuVZR(3,3),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),& 
& cplcFvChiSvL(3,6,6),cplcFvChiSvR(3,6,6),cplcFvFecHpmL(3,3,2),cplcFvFecHpmR(3,3,2),     & 
& cplcFvFecVWmL(3,3),cplcFvFecVWmR(3,3),cplcFvFvAhL(3,3,3),cplcFvFvAhR(3,3,3),           & 
& cplcFvFvhhL(3,3,3),cplcFvFvhhR(3,3,3),cplcFvFvVZL(3,3),cplcFvFvVZpL(3,3),              & 
& cplcFvFvVZpR(3,3),cplcFvFvVZR(3,3),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),            & 
...
& cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6),cplChiFvcSvL(6,3,6),cplChiFvcSvR(6,3,6),       & 
& cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),cplGluFucSuL(3,6),cplGluFucSuR(3,6),               & 
& cplhhSdcSd(3,6,6),cplHpmSucSd(2,6,6),cplSdcSdVZ(6,6),cplSdcSdVZp(6,6),cplSucSdVWm(6,6)
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,mvR012input,    & 
& mvR022input,mvR032input,ms2input,M1input,M2input,M3input,M4input,Tepinput,             & 
& Tmupinput,vdinput,vuinput,vSinput,cplAhSucSu,cplcChacFuSdL,cplcChacFuSdR,              & 
...
& cplcFeFvVWmR,cplcFuChiSuL,cplcFuChiSuR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFuFuAhL,        & 
& cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZpL,cplcFuFuVZpR,             & 
& cplcFuFuVZR,cplcFuGluSuL,cplcFuGluSuR,cplcFvChiSvL,cplcFvChiSvR,cplcFvFvAhL,           & 
& cplcFvFvAhR,cplcFvFvhhL,cplcFvFvhhR,cplcFvFvVZL,cplcFvFvVZpL,cplcFvFvVZpR,             & 
& cplcFvFvVZR,cplChaFucSdL,cplChaFucSdR,cplChaFvcSeL,cplChaFvcSeR,cplChiChacHpmL,        & 
...
& cplcChaFdcSuR(2,3,6),cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),cplcFdChiSdL(3,6,6),      & 
& cplcFdChiSdR(3,6,6),cplcFdFdAhL(3,3,3),cplcFdFdAhR(3,3,3),cplcFdFdhhL(3,3,3),          & 
& cplcFdFdhhR(3,3,3),cplcFdFdVZL(3,3),cplcFdFdVZpL(3,3),cplcFdFdVZpR(3,3),               & 
...
& cplcFeChaSvR(3,2,6),cplcFeChiSeL(3,6,6),cplcFeChiSeR(3,6,6),cplcFeFeAhL(3,3,3),        & 
...
& cplcFeFvHpmR(3,3,2),cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),cplcFuChiSuL(3,6,6),           & 
& cplcFuChiSuR(3,6,6),cplcFuFdcHpmL(3,3,2),cplcFuFdcHpmR(3,3,2),cplcFuFuAhL(3,3,3),      & 
& cplcFuFuAhR(3,3,3),cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),cplcFuFuVZL(3,3),             & 
& cplcFuFuVZpL(3,3),cplcFuFuVZpR(3,3),cplcFuFuVZR(3,3),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),& 
& cplcFvChiSvL(3,6,6),cplcFvChiSvR(3,6,6),cplcFvFvAhL(3,3,3),cplcFvFvAhR(3,3,3),         & 
& cplcFvFvhhL(3,3,3),cplcFvFvhhR(3,3,3),cplcFvFvVZL(3,3),cplcFvFvVZpL(3,3),              & 
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,mvR012input,    & 
& mvR022input,mvR032input,ms2input,M1input,M2input,M3input,M4input,Tepinput,             & 
& Tmupinput,vdinput,vuinput,vSinput,cplAhSecSe,cplcChacFuSdL,cplcChacFuSdR,              & 
& cplcChacFvSeL,cplcChacFvSeR,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,   & 
& cplcChaChaVZL,cplcChaChaVZpL,cplcChaChaVZpR,cplcChaChaVZR,cplcChaChiHpmL,              & 
& cplcChaChiHpmR,cplcChaFdcSuL,cplcChaFdcSuR,cplcChaFecSvL,cplcChaFecSvR,cplcFdChiSdL,   & 
& cplcFdChiSdR,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,              & 
& cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFeChaSvL,cplcFeChaSvR,cplcFeChiSeL,          & 
& cplcFeChiSeR,cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,              & 
...
& cplcFuFuAhR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZpL,cplcFuFuVZpR,             & 
& cplcFuFuVZR,cplcFvChiSvL,cplcFvChiSvR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFecVWmL,       & 
& cplcFvFecVWmR,cplcFvFvAhL,cplcFvFvAhR,cplcFvFvhhL,cplcFvFvhhR,cplcFvFvVZL,             & 
& cplcFvFvVZpL,cplcFvFvVZpR,cplcFvFvVZR,cplChaFvcSeL,cplChaFvcSeR,cplChiChacHpmL,        & 
& cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,cplChiChiAhL,cplChiChiAhR,cplChiChihhL,   & 
& cplChiChihhR,cplChiChiVZL,cplChiChiVZpL,cplChiChiVZpR,cplChiChiVZR,cplChiFdcSdL,       & 
& cplChiFdcSdR,cplChiFecSeL,cplChiFecSeR,cplChiFucSuL,cplChiFucSuR,cplChiFvcSvL,         & 
& cplChiFvcSvR,cplhhSecSe,cplHpmSvcSe,cplSecSeVZ,cplSecSeVZp,cplSvcSeVWm,deltaM)
...
& cplcChaChahhR(2,2,3),cplcChaChaVZL(2,2),cplcChaChaVZpL(2,2),cplcChaChaVZpR(2,2),       & 
& cplcChaChaVZR(2,2),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),cplcChaFdcSuL(2,3,6),   & 
& cplcChaFdcSuR(2,3,6),cplcChaFecSvL(2,3,6),cplcChaFecSvR(2,3,6),cplcFdChiSdL(3,6,6),    & 
& cplcFdChiSdR(3,6,6),cplcFdFdAhL(3,3,3),cplcFdFdAhR(3,3,3),cplcFdFdhhL(3,3,3),          & 
& cplcFdFdhhR(3,3,3),cplcFdFdVZL(3,3),cplcFdFdVZpL(3,3),cplcFdFdVZpR(3,3),               & 
& cplcFdFdVZR(3,3),cplcFeChaSvL(3,2,6),cplcFeChaSvR(3,2,6),cplcFeChiSeL(3,6,6),          & 
& cplcFeChiSeR(3,6,6),cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplcFeFehhL(3,3,3),          & 
& cplcFeFehhR(3,3,3),cplcFeFeVZL(3,3),cplcFeFeVZpL(3,3),cplcFeFeVZpR(3,3),               & 
& cplcFeFeVZR(3,3),cplcFeFvHpmL(3,3,2),cplcFeFvHpmR(3,3,2),cplcFuChiSuL(3,6,6),          & 
& cplcFuChiSuR(3,6,6),cplcFuFdcHpmL(3,3,2),cplcFuFdcHpmR(3,3,2),cplcFuFdcVWmL(3,3),      & 
& cplcFuFdcVWmR(3,3),cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),cplcFuFuhhL(3,3,3),           & 
& cplcFuFuhhR(3,3,3),cplcFuFuVZL(3,3),cplcFuFuVZpL(3,3),cplcFuFuVZpR(3,3),               & 
& cplcFuFuVZR(3,3),cplcFvChiSvL(3,6,6),cplcFvChiSvR(3,6,6),cplcFvFecHpmL(3,3,2),         & 
& cplcFvFecHpmR(3,3,2),cplcFvFecVWmL(3,3),cplcFvFecVWmR(3,3),cplcFvFvAhL(3,3,3),         & 
& cplcFvFvAhR(3,3,3),cplcFvFvhhL(3,3,3),cplcFvFvhhR(3,3,3),cplcFvFvVZL(3,3),             & 
& cplcFvFvVZpL(3,3),cplcFvFvVZpR(3,3),cplcFvFvVZR(3,3),cplChaFvcSeL(2,3,6),              & 
& cplChaFvcSeR(2,3,6),cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),cplChiChacVWmL(6,2),   & 
& cplChiChacVWmR(6,2),cplChiChiAhL(6,6,3),cplChiChiAhR(6,6,3),cplChiChihhL(6,6,3),       & 
& cplChiChihhR(6,6,3),cplChiChiVZL(6,6),cplChiChiVZpL(6,6),cplChiChiVZpR(6,6),           & 
& cplChiChiVZR(6,6),cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6),cplChiFecSeL(6,3,6),         & 
& cplChiFecSeR(6,3,6),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6),cplChiFvcSvL(6,3,6),       & 
& cplChiFvcSvR(6,3,6),cplhhSecSe(3,6,6),cplHpmSvcSe(2,6,6),cplSecSeVZ(6,6),              & 
& cplSecSeVZp(6,6),cplSvcSeVWm(6,6)
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,mvR012input,    & 
& mvR022input,mvR032input,ms2input,M1input,M2input,M3input,M4input,Tepinput,             & 
& Tmupinput,vdinput,vuinput,vSinput,cplAhSvcSv,cplcChacFvSeL,cplcChacFvSeR,              & 
& cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZpL,  & 
& cplcChaChaVZpR,cplcChaChaVZR,cplcChaChiHpmL,cplcChaChiHpmR,cplcChaChiVWmL,             & 
& cplcChaChiVWmR,cplcChaFecSvL,cplcChaFecSvR,cplcFdChaSuL,cplcFdChaSuR,cplcFdChiSdL,     & 
& cplcFdChiSdR,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,              & 
& cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFdFuVWmL,          & 
...
& cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplcFvChiSvL,cplcFvChiSvR,cplcFvFecHpmL,         & 
& cplcFvFecHpmR,cplcFvFvAhL,cplcFvFvAhR,cplcFvFvhhL,cplcFvFvhhR,cplcFvFvVZL,             & 
& cplcFvFvVZpL,cplcFvFvVZpR,cplcFvFvVZR,cplChaFucSdL,cplChaFucSdR,cplChaFvcSeL,          & 
& cplChaFvcSeR,cplChiChacHpmL,cplChiChacHpmR,cplChiChiAhL,cplChiChiAhR,cplChiChihhL,     & 
& cplChiChihhR,cplChiChiVZL,cplChiChiVZpL,cplChiChiVZpR,cplChiChiVZR,cplChiFdcSdL,       & 
& cplChiFdcSdR,cplChiFecSeL,cplChiFecSeR,cplChiFucSuL,cplChiFucSuR,cplChiFvcSvL,         & 
& cplChiFvcSvR,cplhhSvcSv,cplSecHpmcSv,cplSecSvcVWm,cplSvcSvVZ,cplSvcSvVZp,deltaM)
...
Complex(dp),Intent(out) :: cplAhSvcSv(3,6,6),cplcChacFvSeL(2,3,6),cplcChacFvSeR(2,3,6),cplcChaChaAhL(2,2,3),     & 
& cplcChaChaAhR(2,2,3),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),cplcChaChaVZL(2,2),     & 
& cplcChaChaVZpL(2,2),cplcChaChaVZpR(2,2),cplcChaChaVZR(2,2),cplcChaChiHpmL(2,6,2),      & 
& cplcChaChiHpmR(2,6,2),cplcChaChiVWmL(2,6),cplcChaChiVWmR(2,6),cplcChaFecSvL(2,3,6),    & 
& cplcChaFecSvR(2,3,6),cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),cplcFdChiSdL(3,6,6),      & 
& cplcFdChiSdR(3,6,6),cplcFdFdAhL(3,3,3),cplcFdFdAhR(3,3,3),cplcFdFdhhL(3,3,3),          & 
& cplcFdFdhhR(3,3,3),cplcFdFdVZL(3,3),cplcFdFdVZpL(3,3),cplcFdFdVZpR(3,3),               & 
& cplcFdFdVZR(3,3),cplcFdFuHpmL(3,3,2),cplcFdFuHpmR(3,3,2),cplcFdFuVWmL(3,3),            & 
& cplcFdFuVWmR(3,3),cplcFeChaSvL(3,2,6),cplcFeChaSvR(3,2,6),cplcFeChiSeL(3,6,6),         & 
& cplcFeChiSeR(3,6,6),cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplcFeFehhL(3,3,3),          & 
& cplcFeFehhR(3,3,3),cplcFeFeVZL(3,3),cplcFeFeVZpL(3,3),cplcFeFeVZpR(3,3),               & 
& cplcFeFeVZR(3,3),cplcFeFvHpmL(3,3,2),cplcFeFvHpmR(3,3,2),cplcFeFvVWmL(3,3),            & 
& cplcFeFvVWmR(3,3),cplcFuChiSuL(3,6,6),cplcFuChiSuR(3,6,6),cplcFuFuAhL(3,3,3),          & 
& cplcFuFuAhR(3,3,3),cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),cplcFuFuVZL(3,3),             & 
& cplcFuFuVZpL(3,3),cplcFuFuVZpR(3,3),cplcFuFuVZR(3,3),cplcFvChiSvL(3,6,6),              & 
& cplcFvChiSvR(3,6,6),cplcFvFecHpmL(3,3,2),cplcFvFecHpmR(3,3,2),cplcFvFvAhL(3,3,3),      & 
& cplcFvFvAhR(3,3,3),cplcFvFvhhL(3,3,3),cplcFvFvhhR(3,3,3),cplcFvFvVZL(3,3),             & 
...
& cplChiChacHpmR(6,2,2),cplChiChiAhL(6,6,3),cplChiChiAhR(6,6,3),cplChiChihhL(6,6,3),     & 
& cplChiChihhR(6,6,3),cplChiChiVZL(6,6),cplChiChiVZpL(6,6),cplChiChiVZpR(6,6),           & 
& cplChiChiVZR(6,6),cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6),cplChiFecSeL(6,3,6),         & 
& cplChiFecSeR(6,3,6),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6),cplChiFvcSvL(6,3,6),       & 
& cplChiFvcSvR(6,3,6),cplhhSvcSv(3,6,6),cplSecHpmcSv(6,2,6),cplSecSvcVWm(6,6),           & 
& cplSvcSvVZ(6,6),cplSvcSvVZp(6,6)
...
End Module CouplingsForDecays_NonUMSSMv4
