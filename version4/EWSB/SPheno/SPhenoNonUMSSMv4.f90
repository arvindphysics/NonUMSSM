...
Program SPhenoNonUMSSMv4 
 
Use Control
Use InputOutput_NonUMSSMv4
Use LoopFunctions
Use Settings
Use LowEnergy_NonUMSSMv4
Use Mathematics
...
& ZW,ZZ,betaH,vd,vu,vS,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yv11,Yv22,Yv33,Yu,              & 
& Td,TYe11,TYe22,TYe33,Tlam,TYv11,TYv22,TYv33,Tu,mq2,ml012,ml022,ml032,mHd2,             & 
& mHu2,md2,mu2,me012,me022,me032,mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,Tep,               & 
& Tmup,mGUT)
...
& mu2,me012,me022,me032,mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,Tep,Tmup,mass_uncertainty_Q)
...
& Td,TYe11,TYe22,TYe33,Tlam,TYv11,TYv22,TYv33,Tu,mq2,ml012,ml022,ml032,mHd2,             & 
& mHu2,md2,mu2,me012,me022,me032,mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,Tep,               & 
& Tmup,gPSd,gTSd,BRSd,gPSu,gTSu,BRSu,gPSe,gTSe,BRSe,gPSv,gTSv,BRSv,gPhh,gThh,            & 
& BRhh,gPAh,gTAh,BRAh,gPHpm,gTHpm,BRHpm,gPVZp,gTVZp,BRVZp,gPGlu,gTGlu,BRGlu,             & 
& gPChi,gTChi,BRChi,gPCha,gTCha,BRCha,gPFu,gTFu,BRFu)
...
Call CalculateLowEnergyConstraints(g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yv11,            & 
...
& M3,M4,Tep,Tmup,vd,vu,vS,Tpar,Spar,Upar,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho,             & 
...
& Ye22,Ye33,lam,Yv11,Yv22,Yv33,Yu,Td,TYe11,TYe22,TYe33,Tlam,TYv11,TYv22,TYv33,           & 
& Tu,mq2,ml012,ml022,ml032,mHd2,mHu2,md2,mu2,me012,me022,me032,mvR012,mvR022,            & 
& mvR032,ms2,M1,M2,M3,M4,Tep,Tmup,kont)
...
& MFv,MFv2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,           & 
& MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,pG,TW,TWp,UM,UP,v,ZA,ZD,ZDL,ZDR,ZE,ZEL,ZER,             & 
& ZH,ZN,ZP,ZU,ZUL,ZUR,ZV,ZVL,ZVR,ZW,ZZ,betaH,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,              & 
...
& ms2,M1,M2,M3,M4,Tep,Tmup,mGut,kont,WriteOut,n_run)
...
& Ye22,Ye33,lam,Yv11,Yv22,Yv33,Yu,Td,TYe11,TYe22,TYe33,Tlam,TYv11,TYv22,TYv33,           & 
& Tu,mq2,ml012,ml022,ml032,mHd2,mHu2,md2,mu2,me012,me022,me032,mvR012,mvR022,            & 
& mvR032,ms2,M1,M2,M3,M4,Tep,Tmup,mGut,kont,WriteOut,n_run)
...
& g1input,g2input,g3input,gpinput,Ydinput,Ye11input,Ye22input,Ye33input,laminput,        & 
& Yv11input,Yv22input,Yv33input,Yuinput,Tdinput,TYe11input,TYe22input,TYe33input,        & 
& Tlaminput,TYv11input,TYv22input,TYv33input,Tuinput,mq2input,ml012input,ml022input,     & 
& ml032input,mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,     & 
& mvR012input,mvR022input,mvR032input,ms2input,M1input,M2input,M3input,M4input,          & 
& Tepinput,Tmupinput,mass_Qerror)

Implicit None 
Integer, Intent(inout) :: kont 
Logical, Intent(in) :: WriteOut 
Real(dp), Intent(in) :: delta 
Real(dp) :: mass_in(53), mass_new(53) 
Real(dp), Intent(out) :: mass_Qerror(53) 
Real(dp) :: gD(185), Q, Qsave, Qstep, Qt, g_SM(62), mh_SM 
Integer :: i1, i2, iupdown, ntot 
Real(dp),Intent(in) :: g1input,g2input,g3input,gpinput,ml012input,ml022input,ml032input,mHd2input,           & 
& mHu2input,me012input,me022input,me032input,mvR012input,mvR022input,mvR032input,ms2input
...
If (iupdown.eq.1) Then 
 tz=Log(Q/Qsave)
 dt=-tz/50._dp
 Call odeint(gD,185,0._dp,tz,0.1_dp*delta,dt,0._dp,rge185,kont)
Else 
 tz=-Log(Q/Qsave)
 dt=tz/50._dp
 Call odeint(gD,185,tz,0._dp,0.1_dp*delta,dt,0._dp,rge185,kont)
End if 
