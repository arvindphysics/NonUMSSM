...
Real(dp) :: ZPOS_0(2, 2)
Real(dp) :: ZPOS_p2(2, 2)
Complex(dp) :: ZNOS_0(6, 6)
Complex(dp) :: ZNOS_p2(6, 6)
...
Real(dp) :: ms21L 
Real(dp) :: ms22L 
Real(dp) :: mass_uncertainty_Q(53), mass_uncertainty_Yt(53), g_SM_save(62) 
...
Real(dp) :: g1IN,g2IN,g3IN,gpIN,ml012IN,ml022IN,ml032IN,mHd2IN,mHu2IN,me012IN,me022IN,            & 
& me032IN,mvR012IN,mvR022IN,mvR032IN,ms2IN

Complex(dp) :: YdIN(3,3),Ye11IN,Ye22IN,Ye33IN,lamIN,Yv11IN,Yv22IN,Yv33IN,YuIN(3,3),TdIN(3,3),        & 
& TYe11IN,TYe22IN,TYe33IN,TlamIN,TYv11IN,TYv22IN,TYv33IN,TuIN(3,3),mq2IN(3,3),           & 
& md2IN(3,3),mu2IN(3,3),M1IN,M2IN,M3IN,M4IN,TepIN,TmupIN

Real(dp) :: g1MZ,g2MZ,g3MZ,gpMZ,ml012MZ,ml022MZ,ml032MZ,mHd2MZ,mHu2MZ,me012MZ,me022MZ,            & 
& me032MZ,mvR012MZ,mvR022MZ,mvR032MZ,ms2MZ

Complex(dp) :: YdMZ(3,3),Ye11MZ,Ye22MZ,Ye33MZ,lamMZ,Yv11MZ,Yv22MZ,Yv33MZ,YuMZ(3,3),TdMZ(3,3),        & 
& TYe11MZ,TYe22MZ,TYe33MZ,TlamMZ,TYv11MZ,TYv22MZ,TYv33MZ,TuMZ(3,3),mq2MZ(3,3),           & 
& md2MZ(3,3),mu2MZ(3,3),M1MZ,M2MZ,M3MZ,M4MZ,TepMZ,TmupMZ

Real(dp) :: g1GUT,g2GUT,g3GUT,gpGUT,ml012GUT,ml022GUT,ml032GUT,mHd2GUT,mHu2GUT,me012GUT,          & 
& me022GUT,me032GUT,mvR012GUT,mvR022GUT,mvR032GUT,ms2GUT

Complex(dp) :: YdGUT(3,3),Ye11GUT,Ye22GUT,Ye33GUT,lamGUT,Yv11GUT,Yv22GUT,Yv33GUT,YuGUT(3,3),         & 
& TdGUT(3,3),TYe11GUT,TYe22GUT,TYe33GUT,TlamGUT,TYv11GUT,TYv22GUT,TYv33GUT,              & 
& TuGUT(3,3),mq2GUT(3,3),md2GUT(3,3),mu2GUT(3,3),M1GUT,M2GUT,M3GUT,M4GUT,TepGUT,TmupGUT
...
Real(dp) :: gPSd(6,1425),gTSd(6),BRSd(6,1425),gPSu(6,1425),gTSu(6),BRSu(6,1425),gPSe(6,1344),     & 
...
Real(dp) :: gP1LSd(6,75),gT1LSd(6),BR1LSd(6,75),gP1LSu(6,75),gT1LSu(6),BR1LSu(6,75),              & 
& gP1LSe(6,72),gT1LSe(6),BR1LSe(6,72),gP1LSv(6,72),gT1LSv(6),BR1LSv(6,72),               & 
& gP1Lhh(3,227),gT1Lhh(3),BR1Lhh(3,227),gP1LAh(3,225),gT1LAh(3),BR1LAh(3,225),           & 
& gP1LHpm(2,114),gT1LHpm(2),BR1LHpm(2,114),gP1LVZp(1,217),gT1LVZp,BR1LVZp(1,217),        & 
& gP1LGlu(1,36),gT1LGlu,BR1LGlu(1,36),gP1LChi(6,112),gT1LChi(6),BR1LChi(6,112),          & 
& gP1LCha(2,96),gT1LCha(2),BR1LCha(2,96),gP1LFu(3,78),gT1LFu(3),BR1LFu(3,78)
...
Logical, save :: InputValueforYe11 =.False. 
Logical, save :: InputValueforYe22 =.False. 
Logical, save :: InputValueforYe33 =.False. 
Logical, save :: InputValueforlam =.False. 
Logical, save :: InputValueforYv11 =.False. 
Logical, save :: InputValueforYv22 =.False. 
Logical, save :: InputValueforYv33 =.False. 
Logical, save :: InputValueforYu =.False. 
Logical, save :: InputValueforTd =.False. 
Logical, save :: InputValueforTYe11 =.False. 
Logical, save :: InputValueforTYe22 =.False. 
Logical, save :: InputValueforTYe33 =.False. 
Logical, save :: InputValueforTlam =.False. 
Logical, save :: InputValueforTYv11 =.False. 
Logical, save :: InputValueforTYv22 =.False. 
Logical, save :: InputValueforTYv33 =.False. 
Logical, save :: InputValueforTu =.False. 
Logical, save :: InputValueformq2 =.False. 
Logical, save :: InputValueforml012 =.False. 
Logical, save :: InputValueforml022 =.False. 
Logical, save :: InputValueforml032 =.False. 
...
Logical, save :: InputValueforme012 =.False. 
Logical, save :: InputValueforme022 =.False. 
Logical, save :: InputValueforme032 =.False. 
Logical, save :: InputValueformvR012 =.False. 
Logical, save :: InputValueformvR022 =.False. 
Logical, save :: InputValueformvR032 =.False. 
...
Logical, save :: InputValueforTep =.False. 
Logical, save :: InputValueforTmup =.False. 
...
Real(dp) :: rHB_P_P_Fv(3,3),rHB_P_S_Fv(3,3),rHB_S_S_Fv(3,3),rHB_S_P_Fv(3,3)
...
& vS,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yv11,Yv22,Yv33,Yu,Td,TYe11,TYe22,TYe33,           & 
& Tlam,TYv11,TYv22,TYv33,Tu,mq2,ml012,ml022,ml032,mHd2,mHu2,md2,mu2,me012,               & 
& me022,me032,mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,Tep,Tmup,MZsuffix)
...
End Module Model_Data_NonUMSSMv4