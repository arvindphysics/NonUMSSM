...
! ------------------------------------------------------------------------------  
! File created at 16:27 on 21.3.2021   
! ----------------------------------------------------------------------  
 
 
Module InputOutput_NonUMSSMv4 
...
InputValueformq2= .True. 
   ...
   Else If (read_line(7:14).Eq."IMMSQ2IN") Then 
     If (i_cpv.Lt.2) Then  
...
InputValueformd2= .True. 
   ...
   Else If (read_line(7:14).Eq."IMMSD2IN") Then 
     If (i_cpv.Lt.2) Then  
...
InputValueformu2= .True. 
   ...
   Else If (read_line(7:14).Eq."IMMSU2IN") Then 
     If (i_cpv.Lt.2) Then  
   ...
   Else If (read_line(7:12).Eq."YE11IN") Then 
    Call Read_YE11IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:14).Eq."IMYE11IN") Then 
    Call Read_YE11IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:12).Eq."YE22IN") Then 
    Call Read_YE22IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:14).Eq."IMYE22IN") Then 
    Call Read_YE22IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:12).Eq."YE33IN") Then 
    Call Read_YE33IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:14).Eq."IMYE33IN") Then 
    Call Read_YE33IN(99,1,i_model,set_mod_par,kont) 
   ...
   Else If (read_line(7:12).Eq."YV11IN") Then 
    Call Read_YV11IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:14).Eq."IMYV11IN") Then 
    Call Read_YV11IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:12).Eq."YV22IN") Then 
    Call Read_YV22IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:14).Eq."IMYV22IN") Then 
    Call Read_YV22IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:12).Eq."YV33IN") Then 
    Call Read_YV33IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:14).Eq."IMYV33IN") Then 
    Call Read_YV33IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."TYE11IN") Then 
    Call Read_TYE11IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:15).Eq."IMTYE11IN") Then 
    Call Read_TYE11IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."TYE22IN") Then 
    Call Read_TYE22IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:15).Eq."IMTYE22IN") Then 
    Call Read_TYE22IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."TYE33IN") Then 
    Call Read_TYE33IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:15).Eq."IMTYE33IN") Then 
    Call Read_TYE33IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."TYV11IN") Then 
    Call Read_TYV11IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:15).Eq."IMTYV11IN") Then 
    Call Read_TYV11IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."TYV22IN") Then 
    Call Read_TYV22IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:15).Eq."IMTYV22IN") Then 
    Call Read_TYV22IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."TYV33IN") Then 
    Call Read_TYV33IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:15).Eq."IMTYV33IN") Then 
    Call Read_TYV33IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."ML012IN") Then 
    Call Read_ML012IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:15).Eq."IMML012IN") Then 
    Call Read_ML012IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."ML022IN") Then 
    Call Read_ML022IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:15).Eq."IMML022IN") Then 
    Call Read_ML022IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."ML032IN") Then 
    Call Read_ML032IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:15).Eq."IMML032IN") Then 
    Call Read_ML032IN(99,1,i_model,set_mod_par,kont) 
   ...
   Else If (read_line(7:13).Eq."ME012IN") Then 
    Call Read_ME012IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:15).Eq."IMME012IN") Then 
    Call Read_ME012IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."ME022IN") Then 
    Call Read_ME022IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:15).Eq."IMME022IN") Then 
    Call Read_ME022IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."ME032IN") Then 
    Call Read_ME032IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:15).Eq."IMME032IN") Then 
    Call Read_ME032IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:14).Eq."MVR012IN") Then 
    Call Read_MVR012IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:16).Eq."IMMVR012IN") Then 
    Call Read_MVR012IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:14).Eq."MVR022IN") Then 
    Call Read_MVR022IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:16).Eq."IMMVR022IN") Then 
    Call Read_MVR022IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:14).Eq."MVR032IN") Then 
    Call Read_MVR032IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:16).Eq."IMMVR032IN") Then 
    Call Read_MVR032IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:10).Eq."NPIN") Then 
    Call Read_NPIN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:12).Eq."IMNPIN") Then 
    Call Read_NPIN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:11).Eq."TEPIN") Then 
    Call Read_TEPIN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."IMTEPIN") Then 
    Call Read_TEPIN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:12).Eq."TMUPIN") Then 
    Call Read_TMUPIN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:14).Eq."IMTMUPIN") Then 
    Call Read_TMUPIN(99,1,i_model,set_mod_par,kont) 
   ...
   Else If (read_line(7:15).Eq."XCHARGEIN") Then 
    Call Read_XCHARGEIN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:17).Eq."IMXCHARGEIN") Then 
    Call Read_XCHARGEIN(99,1,i_model,set_mod_par,kont) 
...
If (i_c.Eq.0) m121= Cmplx(wert,Aimag(m121),dp) 
If (i_c.Eq.1) m121= Cmplx(Real(m121,dp),wert,dp) 
Else If (i_par.Eq.3) Then 
If (i_c.Eq.0) m122= Cmplx(wert,Aimag(m122),dp) 
If (i_c.Eq.1) m122= Cmplx(Real(m122,dp),wert,dp) 
Else If (i_par.Eq.4) Then 
If (i_c.Eq.0) m123= Cmplx(wert,Aimag(m123),dp) 
If (i_c.Eq.1) m123= Cmplx(Real(m123,dp),wert,dp) 
Else If (i_par.Eq.5) Then 
If (i_c.Eq.0) m124= Cmplx(wert,Aimag(m124),dp) 
If (i_c.Eq.1) m124= Cmplx(Real(m124,dp),wert,dp) 
...
Ql2= wert 
Else If (i_par.Eq.204) Then 
Ql3= wert 
Else If (i_par.Eq.205) Then 
QHd= wert 
Else If (i_par.Eq.206) Then 
QHu= wert 
Else If (i_par.Eq.207) Then 
Qd= wert 
Else If (i_par.Eq.208) Then 
Qu= wert 
Else If (i_par.Eq.209) Then 
Qe1= wert 
...
Complex(dp) :: PDGSd(6),PDGSu(6),PDGSe(6),PDGSv(6),PDGhh(3),PDGAh(3),PDGHpm(2),PDGVP,PDGVZp,         & 
& PDGgZp,PDGVZ,PDGgZ,PDGVG,PDGVWm,PDGgP,PDGgWm,PDGgWmC,PDGgG,PDGFd(3),PDGFu(3),          & 
& PDGFe(3),PDGFv(3),PDGGlu,PDGChi(6),PDGCha(2)
...
Character(len=30),Dimension(6):: NameParticleSv
...
Character(len=30),Dimension(6):: NameParticleChi
...
PDGSv(4)=2000012
NameParticleSv(4)="Sv_4"
PDGSv(5)=2000014
NameParticleSv(5)="Sv_5"
PDGSv(6)=2000016
NameParticleSv(6)="Sv_6"
PDGhh(1)=25
...
Write(io_L,100) "# SUSY Les Houches Accord 2 - NonUMSSMv4 Spectrum + Decays + Flavor Observables"
...
Write(io_L,101) 2, Real(m121,dp) ,"# m121"
Write(io_L,101) 3, Real(m122,dp) ,"# m122"
Write(io_L,101) 4, Real(m123,dp) ,"# m123"
Write(io_L,101) 5, Real(m124,dp) ,"# m124"
Write(io_L,101) 6, Real(TanBeta,dp) ,"# TanBeta"
Write(io_L,101) 7, Real(Azero,dp) ,"# Azero"
WriteNextBlock = .False. 
If (Abs(Aimag(m121)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(m122)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(m123)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(m124)).gt.0._dp) WriteNextBlock = .True. 
If (Abs(Aimag(Azero)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,100) "Block IMMINPAR  # Input parameters"
If (Abs(Aimag(m121)).gt.0._dp) Then 
Write(io_L,101) 2, Aimag(m121) ,"# m121"
End if 
If (Abs(Aimag(m122)).gt.0._dp) Then 
Write(io_L,101) 3, Aimag(m122) ,"# m122"
End if 
If (Abs(Aimag(m123)).gt.0._dp) Then 
Write(io_L,101) 4, Aimag(m123) ,"# m123"
End if 
If (Abs(Aimag(m124)).gt.0._dp) Then 
Write(io_L,101) 5, Aimag(m124) ,"# m124"
End if 
If (Abs(Aimag(Azero)).gt.0._dp) Then 
Write(io_L,101) 7, Aimag(Azero) ,"# Azero"
End if 
End if 
WriteNextBlock = .false. 
...
Write(io_L,101) 65, Real(vSInput,dp) ,"# vSInput"
End if 
If (Abs(Real(Qq,dp)).gt.0._dp) Then 
Write(io_L,101) 201, Real(Qq,dp) ,"# Qq"
End if 
If (Abs(Real(Ql1,dp)).gt.0._dp) Then 
Write(io_L,101) 202, Real(Ql1,dp) ,"# Ql1"
End if 
If (Abs(Real(Ql2,dp)).gt.0._dp) Then 
Write(io_L,101) 203, Real(Ql2,dp) ,"# Ql2"
End if 
If (Abs(Real(Ql3,dp)).gt.0._dp) Then 
Write(io_L,101) 204, Real(Ql3,dp) ,"# Ql3"
End if 
If (Abs(Real(QHd,dp)).gt.0._dp) Then 
Write(io_L,101) 205, Real(QHd,dp) ,"# QHd"
End if 
If (Abs(Real(QHu,dp)).gt.0._dp) Then 
Write(io_L,101) 206, Real(QHu,dp) ,"# QHu"
End if 
If (Abs(Real(Qd,dp)).gt.0._dp) Then 
Write(io_L,101) 207, Real(Qd,dp) ,"# Qd"
End if 
If (Abs(Real(Qu,dp)).gt.0._dp) Then 
Write(io_L,101) 208, Real(Qu,dp) ,"# Qu"
End if 
If (Abs(Real(Qe1,dp)).gt.0._dp) Then 
Write(io_L,101) 209, Real(Qe1,dp) ,"# Qe1"
End if 
If (Abs(Real(Qe2,dp)).gt.0._dp) Then 
Write(io_L,101) 210, Real(Qe2,dp) ,"# Qe2"
End if 
If (Abs(Real(Qe3,dp)).gt.0._dp) Then 
Write(io_L,101) 211, Real(Qe3,dp) ,"# Qe3"
End if 
If (Abs(Real(Qs,dp)).gt.0._dp) Then 
Write(io_L,101) 212, Real(Qs,dp) ,"# Qs"
End if 
If (Abs(Real(Qv1,dp)).gt.0._dp) Then 
Write(io_L,101) 213, Real(Qv1,dp) ,"# Qv1"
End if 
If (Abs(Real(Qv2,dp)).gt.0._dp) Then 
Write(io_L,101) 214, Real(Qv2,dp) ,"# Qv2"
End if 
If (Abs(Real(Qv3,dp)).gt.0._dp) Then 
Write(io_L,101) 215, Real(Qv3,dp) ,"# Qv3"
End if 
End if 
WriteNextBlock = .false. 
...
Write(io_L,101) 65, Aimag(vSInput) ,"# vSInput"
End if 
End if 
...
Write(io_L,104) 5,Real(gp,dp), "# gp" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block YE11 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(Ye11,dp), "# Ye11" 
If (Abs(Aimag(Ye11)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMYE11 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(Ye11), "# Ye11" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block YE22 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(Ye22,dp), "# Ye22" 
If (Abs(Aimag(Ye22)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMYE22 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(Ye22), "# Ye22" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block YE33 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(Ye33,dp), "# Ye33" 
If (Abs(Aimag(Ye33)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMYE33 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(Ye33), "# Ye33" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
...
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block YV11 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(Yv11,dp), "# Yv11" 
If (Abs(Aimag(Yv11)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMYV11 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(Yv11), "# Yv11" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block YV22 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(Yv22,dp), "# Yv22" 
If (Abs(Aimag(Yv22)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMYV22 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(Yv22), "# Yv22" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block YV33 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(Yv33,dp), "# Yv33" 
If (Abs(Aimag(Yv33)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMYV33 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(Yv33), "# Yv33" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block TYE11 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(TYe11,dp), "# TYe11" 
If (Abs(Aimag(TYe11)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMTYE11 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(TYe11), "# TYe11" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block TYE22 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(TYe22,dp), "# TYe22" 
If (Abs(Aimag(TYe22)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMTYE22 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(TYe22), "# TYe22" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block TYE33 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(TYe33,dp), "# TYe33" 
If (Abs(Aimag(TYe33)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMTYE33 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(TYe33), "# TYe33" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block TYV11 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(TYv11,dp), "# TYv11" 
If (Abs(Aimag(TYv11)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMTYV11 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(TYv11), "# TYv11" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block TYV22 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(TYv22,dp), "# TYv22" 
If (Abs(Aimag(TYv22)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMTYV22 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(TYv22), "# TYv22" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block TYV33 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(TYv33,dp), "# TYv33" 
If (Abs(Aimag(TYv33)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMTYV33 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(TYv33), "# TYv33" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block ML012 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(ml012,dp), "# ml012" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block ML022 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(ml022,dp), "# ml022" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block ML032 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(ml032,dp), "# ml032" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
...
Write(io_L,104) 4,Real(M4,dp), "# M4" 
If (Abs(Aimag(M4)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
...
Write(io_L,104) 4,Aimag(M4), "# M4" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block ME012 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(me012,dp), "# me012" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block ME022 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(me022,dp), "# me022" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block ME032 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(me032,dp), "# me032" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block MVR012 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(mvR012,dp), "# mvR012" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block MVR022 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(mvR022,dp), "# mvR022" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block MVR032 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(mvR032,dp), "# mvR032" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block NP Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 4,Real(ms2,dp), "# ms2" 
Write(io_L,104) 3,Real(vS,dp), "# vS" 
Write(io_L,104) 3,Real(vS,dp), "# vS" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block TEP Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(Tep,dp), "# Tep" 
If (Abs(Aimag(Tep)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMTEP Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(Tep), "# Tep" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block TMUP Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(Tmup,dp), "# Tmup" 
If (Abs(Aimag(Tmup)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMTMUP Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(Tmup), "# Tmup" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
...
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block XCHARGE Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(Qq,dp), "# Qq" 
Write(io_L,104) 4,Real(Ql1,dp), "# Ql1" 
Write(io_L,104) 5,Real(Ql2,dp), "# Ql2" 
Write(io_L,104) 6,Real(Ql3,dp), "# Ql3" 
Write(io_L,104) 8,Real(QHd,dp), "# QHd" 
Write(io_L,104) 7,Real(QHu,dp), "# QHu" 
Write(io_L,104) 9,Real(Qd,dp), "# Qd" 
Write(io_L,104) 12,Real(Qu,dp), "# Qu" 
Write(io_L,104) 15,Real(Qe1,dp), "# Qe1" 
Write(io_L,104) 16,Real(Qe2,dp), "# Qe2" 
Write(io_L,104) 17,Real(Qe3,dp), "# Qe3" 
Write(io_L,104) 18,Real(Qv1,dp), "# Qv1" 
Write(io_L,104) 19,Real(Qv2,dp), "# Qv2" 
Write(io_L,104) 20,Real(Qv3,dp), "# Qv3" 
Write(io_L,104) 21,Real(Qs,dp), "# Qs" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block ANGLES Q=",Q,"# (SUSY Scale)" 
...
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block TREENP Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 4,Real(ms2Tree,dp), "# ms2" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
...
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block LOOPNP Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 4,Real(ms21L,dp), "# ms2" 
Else 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block TREEMSOFT Q=",Q,"# (SUSY Scale)" 
...
Write(io_L,104) 5,Real(gpGUT,dp), "# gp" 
Write(io_L,106) "Block YE11GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(Ye11GUT,dp), "# Ye11" 
Write(io_L,106) "Block YE22GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(Ye22GUT,dp), "# Ye22" 
Write(io_L,106) "Block YE33GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(Ye33GUT,dp), "# Ye33" 
...
Write(io_L,106) "Block YV11GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(Yv11GUT,dp), "# Yv11" 
Write(io_L,106) "Block YV22GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(Yv22GUT,dp), "# Yv22" 
Write(io_L,106) "Block YV33GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(Yv33GUT,dp), "# Yv33" 
Write(io_L,106) "Block TYE11GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(TYe11GUT,dp), "# TYe11" 
Write(io_L,106) "Block TYE22GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(TYe22GUT,dp), "# TYe22" 
Write(io_L,106) "Block TYE33GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(TYe33GUT,dp), "# TYe33" 
Write(io_L,106) "Block TYV11GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(TYv11GUT,dp), "# TYv11" 
Write(io_L,106) "Block TYV22GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(TYv22GUT,dp), "# TYv22" 
Write(io_L,106) "Block TYV33GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(TYv33GUT,dp), "# TYv33" 
Write(io_L,106) "Block ML012GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(ml012GUT,dp), "# ml012" 
Write(io_L,106) "Block ML022GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(ml022GUT,dp), "# ml022" 
Write(io_L,106) "Block ML032GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(ml032GUT,dp), "# ml032" 
...
Write(io_L,104) 4,Real(M4GUT,dp), "# M4" 
Write(io_L,106) "Block ME012GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(me012GUT,dp), "# me012" 
Write(io_L,106) "Block ME022GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(me022GUT,dp), "# me022" 
Write(io_L,106) "Block ME032GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(me032GUT,dp), "# me032" 
Write(io_L,106) "Block MVR012GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(mvR012GUT,dp), "# mvR012" 
Write(io_L,106) "Block MVR022GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(mvR022GUT,dp), "# mvR022" 
Write(io_L,106) "Block MVR032GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(mvR032GUT,dp), "# mvR032" 
Write(io_L,106) "Block NPGUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 4,Real(ms2GUT,dp), "# ms2" 
Write(io_L,106) "Block TEPGUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(TepGUT,dp), "# Tep" 
Write(io_L,106) "Block TMUPGUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(TmupGUT,dp), "# Tmup" 
...
Write(io_L,104) 1, Abs(g1gp), "# g1gp "  
Write(io_L,104) 2, Abs(gpg1), "# gpg1 "  
MassLSP = 100000._dp 
...
End if 
End if 
 Write(io_L,102) INT(Abs(PDGSv(4))),MSv(4),"# "//Trim(NameParticleSv(4))// "" 
If (MassLSP(1).gt.Abs(MSv(4))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 2000012 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MSv(4))
Else 
If (MassLSP(2).gt.Abs(MSv(4))) Then 
PDGLSP(2) = 2000012 
MassLSP(2) = Abs(MSv(4))
End if 
End if 
 Write(io_L,102) INT(Abs(PDGSv(5))),MSv(5),"# "//Trim(NameParticleSv(5))// "" 
If (MassLSP(1).gt.Abs(MSv(5))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 2000014 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MSv(5))
Else 
If (MassLSP(2).gt.Abs(MSv(5))) Then 
PDGLSP(2) = 2000014 
MassLSP(2) = Abs(MSv(5))
End if 
End if 
 Write(io_L,102) INT(Abs(PDGSv(6))),MSv(6),"# "//Trim(NameParticleSv(6))// "" 
If (MassLSP(1).gt.Abs(MSv(6))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 2000016 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MSv(6))
Else 
If (MassLSP(2).gt.Abs(MSv(6))) Then 
PDGLSP(2) = 2000016 
MassLSP(2) = Abs(MSv(6))
End if 
End if 
...
If (MassLSP(1).gt.Abs(MChi(6))) Then 
PDGLSP(2) = PDGLSP(1) 
PDGLSP(1) = 1000055 
MassLSP(2) = MassLSP(1) 
MassLSP(1) = Abs(MChi(6))
Else 
If (MassLSP(2).gt.Abs(MChi(6))) Then 
PDGLSP(2) = 1000055 
MassLSP(2) = Abs(MChi(6))
End if 
End if 
...
Write(io_L,100) "Block DMASS  # Overall uncertainty"
 ...
 Write(io_L,102) INT(Abs(2000012)), Sqrt(mass_uncertainty_Q(10)**2+mass_uncertainty_Yt(10)**2),"# MSv(4) " 
 Write(io_L,102) INT(Abs(2000014)), Sqrt(mass_uncertainty_Q(11)**2+mass_uncertainty_Yt(11)**2),"# MSv(5) " 
 Write(io_L,102) INT(Abs(2000016)), Sqrt(mass_uncertainty_Q(12)**2+mass_uncertainty_Yt(12)**2),"# MSv(6) " 
 Write(io_L,102) INT(Abs(1000002)), Sqrt(mass_uncertainty_Q(13)**2+mass_uncertainty_Yt(13)**2),"# MSu(1) " 
 Write(io_L,102) INT(Abs(1000004)), Sqrt(mass_uncertainty_Q(14)**2+mass_uncertainty_Yt(14)**2),"# MSu(2) " 
 Write(io_L,102) INT(Abs(1000006)), Sqrt(mass_uncertainty_Q(15)**2+mass_uncertainty_Yt(15)**2),"# MSu(3) " 
 Write(io_L,102) INT(Abs(2000002)), Sqrt(mass_uncertainty_Q(16)**2+mass_uncertainty_Yt(16)**2),"# MSu(4) " 
 Write(io_L,102) INT(Abs(2000004)), Sqrt(mass_uncertainty_Q(17)**2+mass_uncertainty_Yt(17)**2),"# MSu(5) " 
 Write(io_L,102) INT(Abs(2000006)), Sqrt(mass_uncertainty_Q(18)**2+mass_uncertainty_Yt(18)**2),"# MSu(6) " 
 Write(io_L,102) INT(Abs(1000011)), Sqrt(mass_uncertainty_Q(19)**2+mass_uncertainty_Yt(19)**2),"# MSe(1) " 
 Write(io_L,102) INT(Abs(1000013)), Sqrt(mass_uncertainty_Q(20)**2+mass_uncertainty_Yt(20)**2),"# MSe(2) " 
 Write(io_L,102) INT(Abs(1000015)), Sqrt(mass_uncertainty_Q(21)**2+mass_uncertainty_Yt(21)**2),"# MSe(3) " 
 Write(io_L,102) INT(Abs(2000011)), Sqrt(mass_uncertainty_Q(22)**2+mass_uncertainty_Yt(22)**2),"# MSe(4) " 
 Write(io_L,102) INT(Abs(2000013)), Sqrt(mass_uncertainty_Q(23)**2+mass_uncertainty_Yt(23)**2),"# MSe(5) " 
 Write(io_L,102) INT(Abs(2000015)), Sqrt(mass_uncertainty_Q(24)**2+mass_uncertainty_Yt(24)**2),"# MSe(6) " 
 Write(io_L,102) INT(Abs(25)), Sqrt(mass_uncertainty_Q(25)**2+mass_uncertainty_Yt(25)**2),"# Mhh(1) " 
 Write(io_L,102) INT(Abs(35)), Sqrt(mass_uncertainty_Q(26)**2+mass_uncertainty_Yt(26)**2),"# Mhh(2) " 
 Write(io_L,102) INT(Abs(45)), Sqrt(mass_uncertainty_Q(27)**2+mass_uncertainty_Yt(27)**2),"# Mhh(3) " 
 Write(io_L,102) INT(Abs(36)), Sqrt(mass_uncertainty_Q(29)**2+mass_uncertainty_Yt(29)**2),"# MAh(2) " 
 Write(io_L,102) INT(Abs(46)), Sqrt(mass_uncertainty_Q(30)**2+mass_uncertainty_Yt(30)**2),"# MAh(3) " 
 Write(io_L,102) INT(Abs(-37)), Sqrt(mass_uncertainty_Q(32)**2+mass_uncertainty_Yt(32)**2),"# MHpm(2) " 
 Write(io_L,102) INT(Abs(1000022)), Sqrt(mass_uncertainty_Q(33)**2+mass_uncertainty_Yt(33)**2),"# MChi(1) " 
 Write(io_L,102) INT(Abs(1000023)), Sqrt(mass_uncertainty_Q(34)**2+mass_uncertainty_Yt(34)**2),"# MChi(2) " 
 Write(io_L,102) INT(Abs(1000025)), Sqrt(mass_uncertainty_Q(35)**2+mass_uncertainty_Yt(35)**2),"# MChi(3) " 
 Write(io_L,102) INT(Abs(1000035)), Sqrt(mass_uncertainty_Q(36)**2+mass_uncertainty_Yt(36)**2),"# MChi(4) " 
 Write(io_L,102) INT(Abs(1000045)), Sqrt(mass_uncertainty_Q(37)**2+mass_uncertainty_Yt(37)**2),"# MChi(5) " 
 Write(io_L,102) INT(Abs(1000055)), Sqrt(mass_uncertainty_Q(38)**2+mass_uncertainty_Yt(38)**2),"# MChi(6) " 
 Write(io_L,102) INT(Abs(-1000024)), Sqrt(mass_uncertainty_Q(39)**2+mass_uncertainty_Yt(39)**2),"# MCha(1) " 
 Write(io_L,102) INT(Abs(-1000037)), Sqrt(mass_uncertainty_Q(40)**2+mass_uncertainty_Yt(40)**2),"# MCha(2) " 
 Write(io_L,102) INT(Abs(1000021)), Sqrt(mass_uncertainty_Q(41)**2+mass_uncertainty_Yt(41)**2),"# MGlu(1) " 
Write(io_L,100) "Block DMASSQ  # Scale uncertainty"
 ...
 Write(io_L,102) INT(Abs(2000012)), mass_uncertainty_Q(10),"# MSv(4) " 
 Write(io_L,102) INT(Abs(2000014)), mass_uncertainty_Q(11),"# MSv(5) " 
 Write(io_L,102) INT(Abs(2000016)), mass_uncertainty_Q(12),"# MSv(6) " 
 Write(io_L,102) INT(Abs(1000002)), mass_uncertainty_Q(13),"# MSu(1) " 
 Write(io_L,102) INT(Abs(1000004)), mass_uncertainty_Q(14),"# MSu(2) " 
 Write(io_L,102) INT(Abs(1000006)), mass_uncertainty_Q(15),"# MSu(3) " 
 Write(io_L,102) INT(Abs(2000002)), mass_uncertainty_Q(16),"# MSu(4) " 
 Write(io_L,102) INT(Abs(2000004)), mass_uncertainty_Q(17),"# MSu(5) " 
 Write(io_L,102) INT(Abs(2000006)), mass_uncertainty_Q(18),"# MSu(6) " 
 Write(io_L,102) INT(Abs(1000011)), mass_uncertainty_Q(19),"# MSe(1) " 
 Write(io_L,102) INT(Abs(1000013)), mass_uncertainty_Q(20),"# MSe(2) " 
 Write(io_L,102) INT(Abs(1000015)), mass_uncertainty_Q(21),"# MSe(3) " 
 Write(io_L,102) INT(Abs(2000011)), mass_uncertainty_Q(22),"# MSe(4) " 
 Write(io_L,102) INT(Abs(2000013)), mass_uncertainty_Q(23),"# MSe(5) " 
 Write(io_L,102) INT(Abs(2000015)), mass_uncertainty_Q(24),"# MSe(6) " 
 Write(io_L,102) INT(Abs(25)), mass_uncertainty_Q(25),"# Mhh(1) " 
 Write(io_L,102) INT(Abs(35)), mass_uncertainty_Q(26),"# Mhh(2) " 
 Write(io_L,102) INT(Abs(45)), mass_uncertainty_Q(27),"# Mhh(3) " 
 Write(io_L,102) INT(Abs(36)), mass_uncertainty_Q(29),"# MAh(2) " 
 Write(io_L,102) INT(Abs(46)), mass_uncertainty_Q(30),"# MAh(3) " 
 Write(io_L,102) INT(Abs(-37)), mass_uncertainty_Q(32),"# MHpm(2) " 
 Write(io_L,102) INT(Abs(1000022)), mass_uncertainty_Q(33),"# MChi(1) " 
 Write(io_L,102) INT(Abs(1000023)), mass_uncertainty_Q(34),"# MChi(2) " 
 Write(io_L,102) INT(Abs(1000025)), mass_uncertainty_Q(35),"# MChi(3) " 
 Write(io_L,102) INT(Abs(1000035)), mass_uncertainty_Q(36),"# MChi(4) " 
 Write(io_L,102) INT(Abs(1000045)), mass_uncertainty_Q(37),"# MChi(5) " 
 Write(io_L,102) INT(Abs(1000055)), mass_uncertainty_Q(38),"# MChi(6) " 
 Write(io_L,102) INT(Abs(-1000024)), mass_uncertainty_Q(39),"# MCha(1) " 
 Write(io_L,102) INT(Abs(-1000037)), mass_uncertainty_Q(40),"# MCha(2) " 
 Write(io_L,102) INT(Abs(1000021)), mass_uncertainty_Q(41),"# MGlu(1) " 
Write(io_L,100) "Block DMASST  # Top Matching uncertainty"
 ...
 Write(io_L,102) INT(Abs(2000012)), mass_uncertainty_Yt(10),"# MSv(4) " 
 Write(io_L,102) INT(Abs(2000014)), mass_uncertainty_Yt(11),"# MSv(5) " 
 Write(io_L,102) INT(Abs(2000016)), mass_uncertainty_Yt(12),"# MSv(6) " 
 Write(io_L,102) INT(Abs(1000002)), mass_uncertainty_Yt(13),"# MSu(1) " 
 Write(io_L,102) INT(Abs(1000004)), mass_uncertainty_Yt(14),"# MSu(2) " 
 Write(io_L,102) INT(Abs(1000006)), mass_uncertainty_Yt(15),"# MSu(3) " 
 Write(io_L,102) INT(Abs(2000002)), mass_uncertainty_Yt(16),"# MSu(4) " 
 Write(io_L,102) INT(Abs(2000004)), mass_uncertainty_Yt(17),"# MSu(5) " 
 Write(io_L,102) INT(Abs(2000006)), mass_uncertainty_Yt(18),"# MSu(6) " 
 Write(io_L,102) INT(Abs(1000011)), mass_uncertainty_Yt(19),"# MSe(1) " 
 Write(io_L,102) INT(Abs(1000013)), mass_uncertainty_Yt(20),"# MSe(2) " 
 Write(io_L,102) INT(Abs(1000015)), mass_uncertainty_Yt(21),"# MSe(3) " 
 Write(io_L,102) INT(Abs(2000011)), mass_uncertainty_Yt(22),"# MSe(4) " 
 Write(io_L,102) INT(Abs(2000013)), mass_uncertainty_Yt(23),"# MSe(5) " 
 Write(io_L,102) INT(Abs(2000015)), mass_uncertainty_Yt(24),"# MSe(6) " 
 Write(io_L,102) INT(Abs(25)), mass_uncertainty_Yt(25),"# Mhh(1) " 
 Write(io_L,102) INT(Abs(35)), mass_uncertainty_Yt(26),"# Mhh(2) " 
 Write(io_L,102) INT(Abs(45)), mass_uncertainty_Yt(27),"# Mhh(3) " 
 Write(io_L,102) INT(Abs(36)), mass_uncertainty_Yt(29),"# MAh(2) " 
 Write(io_L,102) INT(Abs(46)), mass_uncertainty_Yt(30),"# MAh(3) " 
 Write(io_L,102) INT(Abs(-37)), mass_uncertainty_Yt(32),"# MHpm(2) " 
 Write(io_L,102) INT(Abs(1000022)), mass_uncertainty_Yt(33),"# MChi(1) " 
 Write(io_L,102) INT(Abs(1000023)), mass_uncertainty_Yt(34),"# MChi(2) " 
 Write(io_L,102) INT(Abs(1000025)), mass_uncertainty_Yt(35),"# MChi(3) " 
 Write(io_L,102) INT(Abs(1000035)), mass_uncertainty_Yt(36),"# MChi(4) " 
 Write(io_L,102) INT(Abs(1000045)), mass_uncertainty_Yt(37),"# MChi(5) " 
 Write(io_L,102) INT(Abs(1000055)), mass_uncertainty_Yt(38),"# MChi(6) " 
 Write(io_L,102) INT(Abs(-1000024)), mass_uncertainty_Yt(39),"# MCha(1) " 
 Write(io_L,102) INT(Abs(-1000037)), mass_uncertainty_Yt(40),"# MCha(2) " 
 Write(io_L,102) INT(Abs(1000021)), mass_uncertainty_Yt(41),"# MGlu(1) " 
End if
...
Write(io_L,107)1,4,Real(ZV(1,4),dp), "# Real(ZV(1,4),dp)" 
Write(io_L,107)1,5,Real(ZV(1,5),dp), "# Real(ZV(1,5),dp)" 
Write(io_L,107)1,6,Real(ZV(1,6),dp), "# Real(ZV(1,6),dp)" 
...
Write(io_L,107)2,4,Real(ZV(2,4),dp), "# Real(ZV(2,4),dp)" 
Write(io_L,107)2,5,Real(ZV(2,5),dp), "# Real(ZV(2,5),dp)" 
Write(io_L,107)2,6,Real(ZV(2,6),dp), "# Real(ZV(2,6),dp)" 
...
Write(io_L,107)3,4,Real(ZV(3,4),dp), "# Real(ZV(3,4),dp)" 
Write(io_L,107)3,5,Real(ZV(3,5),dp), "# Real(ZV(3,5),dp)" 
Write(io_L,107)3,6,Real(ZV(3,6),dp), "# Real(ZV(3,6),dp)" 
Write(io_L,107)4,1,Real(ZV(4,1),dp), "# Real(ZV(4,1),dp)" 
Write(io_L,107)4,2,Real(ZV(4,2),dp), "# Real(ZV(4,2),dp)" 
Write(io_L,107)4,3,Real(ZV(4,3),dp), "# Real(ZV(4,3),dp)" 
Write(io_L,107)4,4,Real(ZV(4,4),dp), "# Real(ZV(4,4),dp)" 
Write(io_L,107)4,5,Real(ZV(4,5),dp), "# Real(ZV(4,5),dp)" 
Write(io_L,107)4,6,Real(ZV(4,6),dp), "# Real(ZV(4,6),dp)" 
Write(io_L,107)5,1,Real(ZV(5,1),dp), "# Real(ZV(5,1),dp)" 
Write(io_L,107)5,2,Real(ZV(5,2),dp), "# Real(ZV(5,2),dp)" 
Write(io_L,107)5,3,Real(ZV(5,3),dp), "# Real(ZV(5,3),dp)" 
Write(io_L,107)5,4,Real(ZV(5,4),dp), "# Real(ZV(5,4),dp)" 
Write(io_L,107)5,5,Real(ZV(5,5),dp), "# Real(ZV(5,5),dp)" 
Write(io_L,107)5,6,Real(ZV(5,6),dp), "# Real(ZV(5,6),dp)" 
Write(io_L,107)6,1,Real(ZV(6,1),dp), "# Real(ZV(6,1),dp)" 
Write(io_L,107)6,2,Real(ZV(6,2),dp), "# Real(ZV(6,2),dp)" 
Write(io_L,107)6,3,Real(ZV(6,3),dp), "# Real(ZV(6,3),dp)" 
Write(io_L,107)6,4,Real(ZV(6,4),dp), "# Real(ZV(6,4),dp)" 
Write(io_L,107)6,5,Real(ZV(6,5),dp), "# Real(ZV(6,5),dp)" 
Write(io_L,107)6,6,Real(ZV(6,6),dp), "# Real(ZV(6,6),dp)" 
...
Write(io_L,107)1,4,Aimag(ZV(1,4)), "# Aimag(ZV(1,4))" 
Write(io_L,107)1,5,Aimag(ZV(1,5)), "# Aimag(ZV(1,5))" 
Write(io_L,107)1,6,Aimag(ZV(1,6)), "# Aimag(ZV(1,6))" 
...
Write(io_L,107)2,4,Aimag(ZV(2,4)), "# Aimag(ZV(2,4))" 
Write(io_L,107)2,5,Aimag(ZV(2,5)), "# Aimag(ZV(2,5))" 
Write(io_L,107)2,6,Aimag(ZV(2,6)), "# Aimag(ZV(2,6))" 
...
Write(io_L,107)3,4,Aimag(ZV(3,4)), "# Aimag(ZV(3,4))" 
Write(io_L,107)3,5,Aimag(ZV(3,5)), "# Aimag(ZV(3,5))" 
Write(io_L,107)3,6,Aimag(ZV(3,6)), "# Aimag(ZV(3,6))" 
Write(io_L,107)4,1,Aimag(ZV(4,1)), "# Aimag(ZV(4,1))" 
Write(io_L,107)4,2,Aimag(ZV(4,2)), "# Aimag(ZV(4,2))" 
Write(io_L,107)4,3,Aimag(ZV(4,3)), "# Aimag(ZV(4,3))" 
Write(io_L,107)4,4,Aimag(ZV(4,4)), "# Aimag(ZV(4,4))" 
Write(io_L,107)4,5,Aimag(ZV(4,5)), "# Aimag(ZV(4,5))" 
Write(io_L,107)4,6,Aimag(ZV(4,6)), "# Aimag(ZV(4,6))" 
Write(io_L,107)5,1,Aimag(ZV(5,1)), "# Aimag(ZV(5,1))" 
Write(io_L,107)5,2,Aimag(ZV(5,2)), "# Aimag(ZV(5,2))" 
Write(io_L,107)5,3,Aimag(ZV(5,3)), "# Aimag(ZV(5,3))" 
Write(io_L,107)5,4,Aimag(ZV(5,4)), "# Aimag(ZV(5,4))" 
Write(io_L,107)5,5,Aimag(ZV(5,5)), "# Aimag(ZV(5,5))" 
Write(io_L,107)5,6,Aimag(ZV(5,6)), "# Aimag(ZV(5,6))" 
Write(io_L,107)6,1,Aimag(ZV(6,1)), "# Aimag(ZV(6,1))" 
Write(io_L,107)6,2,Aimag(ZV(6,2)), "# Aimag(ZV(6,2))" 
Write(io_L,107)6,3,Aimag(ZV(6,3)), "# Aimag(ZV(6,3))" 
Write(io_L,107)6,4,Aimag(ZV(6,4)), "# Aimag(ZV(6,4))" 
Write(io_L,107)6,5,Aimag(ZV(6,5)), "# Aimag(ZV(6,5))" 
Write(io_L,107)6,6,Aimag(ZV(6,6)), "# Aimag(ZV(6,6))" 
End If 

Write(io_L,106) "Block SNULMIX Q=",Q,"# ()" 
Write(io_L,107)1,1,Real(ZVL(1,1),dp), "# Real(ZVL(1,1),dp)" 
Write(io_L,107)1,2,Real(ZVL(1,2),dp), "# Real(ZVL(1,2),dp)" 
Write(io_L,107)1,3,Real(ZVL(1,3),dp), "# Real(ZVL(1,3),dp)" 
Write(io_L,107)2,1,Real(ZVL(2,1),dp), "# Real(ZVL(2,1),dp)" 
Write(io_L,107)2,2,Real(ZVL(2,2),dp), "# Real(ZVL(2,2),dp)" 
Write(io_L,107)2,3,Real(ZVL(2,3),dp), "# Real(ZVL(2,3),dp)" 
Write(io_L,107)3,1,Real(ZVL(3,1),dp), "# Real(ZVL(3,1),dp)" 
Write(io_L,107)3,2,Real(ZVL(3,2),dp), "# Real(ZVL(3,2),dp)" 
Write(io_L,107)3,3,Real(ZVL(3,3),dp), "# Real(ZVL(3,3),dp)" 
If ((MaxVal(Abs(AImag(ZVL))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMSNULMIX Q=",Q,"# ()" 
Write(io_L,107)1,1,Aimag(ZVL(1,1)), "# Aimag(ZVL(1,1))" 
Write(io_L,107)1,2,Aimag(ZVL(1,2)), "# Aimag(ZVL(1,2))" 
Write(io_L,107)1,3,Aimag(ZVL(1,3)), "# Aimag(ZVL(1,3))" 
Write(io_L,107)2,1,Aimag(ZVL(2,1)), "# Aimag(ZVL(2,1))" 
Write(io_L,107)2,2,Aimag(ZVL(2,2)), "# Aimag(ZVL(2,2))" 
Write(io_L,107)2,3,Aimag(ZVL(2,3)), "# Aimag(ZVL(2,3))" 
Write(io_L,107)3,1,Aimag(ZVL(3,1)), "# Aimag(ZVL(3,1))" 
Write(io_L,107)3,2,Aimag(ZVL(3,2)), "# Aimag(ZVL(3,2))" 
Write(io_L,107)3,3,Aimag(ZVL(3,3)), "# Aimag(ZVL(3,3))" 
End If 

Write(io_L,106) "Block SNURMIX Q=",Q,"# ()" 
Write(io_L,107)1,1,Real(ZVR(1,1),dp), "# Real(ZVR(1,1),dp)" 
Write(io_L,107)1,2,Real(ZVR(1,2),dp), "# Real(ZVR(1,2),dp)" 
Write(io_L,107)1,3,Real(ZVR(1,3),dp), "# Real(ZVR(1,3),dp)" 
Write(io_L,107)2,1,Real(ZVR(2,1),dp), "# Real(ZVR(2,1),dp)" 
Write(io_L,107)2,2,Real(ZVR(2,2),dp), "# Real(ZVR(2,2),dp)" 
Write(io_L,107)2,3,Real(ZVR(2,3),dp), "# Real(ZVR(2,3),dp)" 
Write(io_L,107)3,1,Real(ZVR(3,1),dp), "# Real(ZVR(3,1),dp)" 
Write(io_L,107)3,2,Real(ZVR(3,2),dp), "# Real(ZVR(3,2),dp)" 
Write(io_L,107)3,3,Real(ZVR(3,3),dp), "# Real(ZVR(3,3),dp)" 
If ((MaxVal(Abs(AImag(ZVR))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMSNURMIX Q=",Q,"# ()" 
Write(io_L,107)1,1,Aimag(ZVR(1,1)), "# Aimag(ZVR(1,1))" 
Write(io_L,107)1,2,Aimag(ZVR(1,2)), "# Aimag(ZVR(1,2))" 
Write(io_L,107)1,3,Aimag(ZVR(1,3)), "# Aimag(ZVR(1,3))" 
Write(io_L,107)2,1,Aimag(ZVR(2,1)), "# Aimag(ZVR(2,1))" 
Write(io_L,107)2,2,Aimag(ZVR(2,2)), "# Aimag(ZVR(2,2))" 
Write(io_L,107)2,3,Aimag(ZVR(2,3)), "# Aimag(ZVR(2,3))" 
Write(io_L,107)3,1,Aimag(ZVR(3,1)), "# Aimag(ZVR(3,1))" 
Write(io_L,107)3,2,Aimag(ZVR(3,2)), "# Aimag(ZVR(3,2))" 
Write(io_L,107)3,3,Aimag(ZVR(3,3)), "# Aimag(ZVR(3,3))" 
End If 
...
Write(io_L,106) "Block IMNMHMIX Q=",Q,"# ()" 
...
Write(io_L,106) "Block IMNMAMIX Q=",Q,"# ()" 
...
Write(io_L,107)1,6,Real(ZN(1,6),dp), "# Real(ZN(1,6),dp)" 
...
Write(io_L,107)2,6,Real(ZN(2,6),dp), "# Real(ZN(2,6),dp)" 
...
Write(io_L,107)3,6,Real(ZN(3,6),dp), "# Real(ZN(3,6),dp)" 
...
Write(io_L,107)4,6,Real(ZN(4,6),dp), "# Real(ZN(4,6),dp)" 
...
Write(io_L,107)5,6,Real(ZN(5,6),dp), "# Real(ZN(5,6),dp)" 
Write(io_L,107)6,1,Real(ZN(6,1),dp), "# Real(ZN(6,1),dp)" 
Write(io_L,107)6,2,Real(ZN(6,2),dp), "# Real(ZN(6,2),dp)" 
Write(io_L,107)6,3,Real(ZN(6,3),dp), "# Real(ZN(6,3),dp)" 
Write(io_L,107)6,4,Real(ZN(6,4),dp), "# Real(ZN(6,4),dp)" 
Write(io_L,107)6,5,Real(ZN(6,5),dp), "# Real(ZN(6,5),dp)" 
Write(io_L,107)6,6,Real(ZN(6,6),dp), "# Real(ZN(6,6),dp)" 
...
Write(io_L,107)1,6,Aimag(ZN(1,6)), "# Aimag(ZN(1,6))" 
...
Write(io_L,107)2,6,Aimag(ZN(2,6)), "# Aimag(ZN(2,6))" 
...
Write(io_L,107)3,6,Aimag(ZN(3,6)), "# Aimag(ZN(3,6))" 
...
Write(io_L,107)4,6,Aimag(ZN(4,6)), "# Aimag(ZN(4,6))" 
...
Write(io_L,107)5,6,Aimag(ZN(5,6)), "# Aimag(ZN(5,6))" 
Write(io_L,107)6,1,Aimag(ZN(6,1)), "# Aimag(ZN(6,1))" 
Write(io_L,107)6,2,Aimag(ZN(6,2)), "# Aimag(ZN(6,2))" 
Write(io_L,107)6,3,Aimag(ZN(6,3)), "# Aimag(ZN(6,3))" 
Write(io_L,107)6,4,Aimag(ZN(6,4)), "# Aimag(ZN(6,4))" 
Write(io_L,107)6,5,Aimag(ZN(6,5)), "# Aimag(ZN(6,5))" 
Write(io_L,107)6,6,Aimag(ZN(6,6)), "# Aimag(ZN(6,6))" 
End If 
...
Write(io_L,201) BRSd(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(1))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
icount = icount +1 
  End Do 
If (Maxval(BRSd(1,76:1425)).Gt.BRmin) Then 
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSd(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(2))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
icount = icount +1 
  End Do 
If (Maxval(BRSd(2,76:1425)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSd(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(3))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
icount = icount +1 
  End Do 
If (Maxval(BRSd(3,76:1425)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSd(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(4))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
icount = icount +1 
  End Do 
If (Maxval(BRSd(4,76:1425)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSd(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(5))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
icount = icount +1 
  End Do 
If (Maxval(BRSd(5,76:1425)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSd(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSd(6))//" -> "//Trim(NameParticleSd(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
icount = icount +1 
  End Do 
If (Maxval(BRSd(6,76:1425)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSu(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(1))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSu(1,76:1425)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,6
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSu(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(2))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSu(2,76:1425)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,6
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSu(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(3))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSu(3,76:1425)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,6
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSu(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(4))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSu(4,76:1425)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,6
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSu(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(5))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSu(5,76:1425)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,6
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSu(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSu(6))//" -> "//Trim(NameParticleSu(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSu(6,76:1425)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,6
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSe(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSe(1))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
icount = icount +1 
  End Do 
If (Maxval(BRSe(1,73:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSe(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSe(2))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
icount = icount +1 
  End Do 
If (Maxval(BRSe(2,73:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSe(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSe(3))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
icount = icount +1 
  End Do 
If (Maxval(BRSe(3,73:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSe(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSe(4))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
icount = icount +1 
  End Do 
If (Maxval(BRSe(4,73:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSe(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSe(5))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
icount = icount +1 
  End Do 
If (Maxval(BRSe(5,73:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSe(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSe(6))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
icount = icount +1 
  End Do 
If (Maxval(BRSe(6,73:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
Write(io_L,201) BRSv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(1))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSv(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(1))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSv(1,73:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,6
...
Write(io_L,202) BRSv(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(1))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGCha(gt3) 
Write(io_L,202) BRSv(1,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(1))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleCha(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRSv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(2))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSv(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(2))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSv(2,73:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,6
...
Write(io_L,202) BRSv(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(2))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGCha(gt3) 
Write(io_L,202) BRSv(2,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(2))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleCha(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRSv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(3))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSv(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(3))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSv(3,73:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,6
...
Write(io_L,202) BRSv(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(3))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGCha(gt3) 
Write(io_L,202) BRSv(3,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(3))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleCha(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
End if 
If ((gTSv(4).gt.MinWidth).or.(OutputForMG)) Then 
Write(io_L,200) INT(PDGSv(4)),gTSv(4),Trim(NameParticleSv(4)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=3, 3
If (BRSv(4,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSv(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BRSv(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGChi(gt2) 
Write(io_L,201) BRSv(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleChi(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGFe(gt2) 
Write(io_L,201) BRSv(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleFe(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGhh(gt2) 
Write(io_L,201) BRSv(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticlehh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGSe(gt2) 
Write(io_L,201) BRSv(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleSe(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGVWm 
Write(io_L,201) BRSv(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleVWm)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRSv(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSv(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSv(4,73:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,6
...
CurrentPDG3(2) = PDGChi(gt2) 
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGCha(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleCha(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGChi(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleChi(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGCha(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleCha(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSd(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleSd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSe(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleSe(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGCha(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleCha(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleSu(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFe(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleFe(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleCha(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSd(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleSd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSu(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleSu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSv(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleSv(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGHpm(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleHpm(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleSd(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFe(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFe(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleSu(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFv(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFv(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGCha(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleCha(gt2))//" "//Trim(NameParticleCha(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSv(4,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(4))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
End if 
If ((gTSv(5).gt.MinWidth).or.(OutputForMG)) Then 
Write(io_L,200) INT(PDGSv(5)),gTSv(5),Trim(NameParticleSv(5)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=3, 3
If (BRSv(5,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSv(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BRSv(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGChi(gt2) 
Write(io_L,201) BRSv(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleChi(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGFe(gt2) 
Write(io_L,201) BRSv(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleFe(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGhh(gt2) 
Write(io_L,201) BRSv(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticlehh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGSe(gt2) 
Write(io_L,201) BRSv(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleSe(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGVWm 
Write(io_L,201) BRSv(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleVWm)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRSv(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSv(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSv(5,73:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,6
...
CurrentPDG3(2) = PDGChi(gt2) 
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGCha(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleCha(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGChi(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleChi(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGCha(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleCha(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSd(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleSd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSe(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleSe(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGCha(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleCha(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleSu(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFe(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleFe(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleCha(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSd(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleSd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSu(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleSu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSv(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleSv(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGHpm(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleHpm(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleSd(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFe(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFe(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleSu(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFv(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFv(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGCha(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleCha(gt2))//" "//Trim(NameParticleCha(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSv(5,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(5))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
End if 
If ((gTSv(6).gt.MinWidth).or.(OutputForMG)) Then 
Write(io_L,200) INT(PDGSv(6)),gTSv(6),Trim(NameParticleSv(6)) 
Write(io_L,100) "#    BR                NDA      ID1      ID2" 
icount = 1 
Do gt1= 1, 6
  Do gt2=3, 3
If (BRSv(6,icount).Gt.BrMin) Then 
CurrentPDG2(1) = PDGSv(gt1) 
CurrentPDG2(2) = PDGAh(gt2) 
Write(io_L,201) BRSv(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleAh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGChi(gt2) 
Write(io_L,201) BRSv(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleChi(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGFe(gt2) 
Write(io_L,201) BRSv(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleFe(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGhh(gt2) 
Write(io_L,201) BRSv(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticlehh(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGSe(gt2) 
Write(io_L,201) BRSv(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleSe(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = -PDGVWm 
Write(io_L,201) BRSv(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleVWm)//"^* "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGVZ 
Write(io_L,201) BRSv(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleVZ)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRSv(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
If (Maxval(BRSv(6,73:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,6
...
CurrentPDG3(2) = PDGChi(gt2) 
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGCha(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleAh(gt1))//" "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleCha(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGChi(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleChi(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGCha(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleChi(gt2))//" "//Trim(NameParticleCha(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSd(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleSd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSe(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleSe(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGCha(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticlehh(gt1))//" "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleCha(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleSu(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFe(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleFe(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleCha(gt2))//" "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSd(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleSd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSu(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleSu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGSv(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleSv(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGHpm(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleHpm(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleSd(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFe(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFe(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleSu(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFv(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleFv(gt2))//" "//Trim(NameParticleFv(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleSe(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGCha(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleCha(gt2))//" "//Trim(NameParticleCha(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFd(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleFd(gt2))//" "//Trim(NameParticleFd(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = -PDGFu(gt3) 
Write(io_L,202) BRSv(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleSv(6))//" -> "//Trim(NameParticleSv(gt1))//" "//Trim(NameParticleFu(gt2))//" "//Trim(NameParticleFu(gt3))//"^* "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGSe(gt2) 
Write(io_L,201) BRhh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(3))//" -> "//Trim(NameParticleSe(gt1))//"^* "//Trim(NameParticleSe(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGSv(gt2) 
Write(io_L,201) BRhh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticlehh(3))//" -> "//Trim(NameParticleSv(gt1))//"^* "//Trim(NameParticleSv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGSe(gt2) 
Write(io_L,201) BRAh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(3))//" -> "//Trim(NameParticleSe(gt1))//"^* "//Trim(NameParticleSe(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGSv(gt2) 
Write(io_L,201) BRAh(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleAh(3))//" -> "//Trim(NameParticleSv(gt1))//"^* "//Trim(NameParticleSv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRHpm(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(2))//"^* -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRHpm(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleHpm(2))//"^* -> "//Trim(NameParticleVWm)//"^* "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
End if 
...
CurrentPDG2(2) = PDGCha(gt2) 
Write(io_L,201) BRVZp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZp)//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleCha(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGChi(gt2) 
Write(io_L,201) BRVZp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZp)//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleChi(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
Write(io_L,201) BRVZp(1,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleVZp)//" -> "//Trim(NameParticleHpm(gt1))//" "//Trim(NameParticleVWm)//"^* "//")"
Write(io_L,201) BRVZp(1,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleVZp)//" -> "//Trim(NameParticleHpm(gt1))//"^* "//Trim(NameParticleVWm)//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGSd(gt2) 
Write(io_L,201) BRVZp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZp)//" -> "//Trim(NameParticleSd(gt1))//"^* "//Trim(NameParticleSd(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGSe(gt2) 
Write(io_L,201) BRVZp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZp)//" -> "//Trim(NameParticleSe(gt1))//"^* "//Trim(NameParticleSe(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGSu(gt2) 
Write(io_L,201) BRVZp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZp)//" -> "//Trim(NameParticleSu(gt1))//"^* "//Trim(NameParticleSu(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG2(2) = PDGSv(gt2) 
Write(io_L,201) BRVZp(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleVZp)//" -> "//Trim(NameParticleSv(gt1))//"^* "//Trim(NameParticleSv(gt2))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
If (Maxval(BRGlu(1,37:162)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,3
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRChi(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(1))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
If (Maxval(BRChi(1,113:622)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRChi(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(2))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
If (Maxval(BRChi(2,113:622)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRChi(3,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(3))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
If (Maxval(BRChi(3,113:622)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRChi(4,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(4))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
If (Maxval(BRChi(4,113:622)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRChi(5,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(5))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = -PDGSe(gt2) 
Write(io_L,201) BRChi(5,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleChi(5))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleSe(gt2))//"^* "//")"
Write(io_L,201) BRChi(5,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleChi(5))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleSe(gt2))//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = -PDGSv(gt2) 
Write(io_L,201) BRChi(5,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleChi(5))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleSv(gt2))//"^* "//")"
Write(io_L,201) BRChi(5,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleChi(5))//" -> "//Trim(NameParticleFv(gt1))//"^* "//Trim(NameParticleSv(gt2))//" "//")"
End if 
icount = icount +1 
...
If (Maxval(BRChi(5,113:622)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,2
...
End if 
If ((gTChi(6).gt.MinWidth).or.(OutputForMG)) Then 
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRChi(6,icount),2,CurrentPDG2, & 
 & Trim(NameParticleChi(6))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 3
...
CurrentPDG2(2) = -PDGSe(gt2) 
Write(io_L,201) BRChi(6,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleChi(6))//" -> "//Trim(NameParticleFe(gt1))//" "//Trim(NameParticleSe(gt2))//"^* "//")"
Write(io_L,201) BRChi(6,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleChi(6))//" -> "//Trim(NameParticleFe(gt1))//"^* "//Trim(NameParticleSe(gt2))//" "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = -PDGSv(gt2) 
Write(io_L,201) BRChi(6,icount)/2._dp,2,CurrentPDG2, & 
 & Trim(NameParticleChi(6))//" -> "//Trim(NameParticleFv(gt1))//" "//Trim(NameParticleSv(gt2))//"^* "//")"
Write(io_L,201) BRChi(6,icount)/2._dp,2,-CurrentPDG2, & 
 & Trim(NameParticleChi(6))//" -> "//Trim(NameParticleFv(gt1))//"^* "//Trim(NameParticleSv(gt2))//" "//")"
End if 
icount = icount +1 
...
If (Maxval(BRChi(6,113:622)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,2
...
CurrentPDG3(3) = PDGFe(gt3) 
Write(io_L,202) BRChi(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleChi(6))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFe(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRChi(6,icount),3,CurrentPDG3, & 
 & Trim(NameParticleChi(6))//" -> "//Trim(NameParticleChi(gt1))//" "//Trim(NameParticleFv(gt2))//"^* "//Trim(NameParticleFv(gt3))//" "//")"
End if 
icount = icount +1 
  End Do 
End Do 
...
CurrentPDG3(3) = PDGFv(gt3) 
Write(io_L,202) BRChi(6,icount)/2._dp,3,CurrentPDG3, & 
 & Trim(NameParticleChi(6))//" -> "//Trim(NameParticleCha(gt1))//" "//Trim(NameParticleFe(gt2))//"^* "//Trim(NameParticleFv(gt3))//" "//")"
Write(io_L,202) BRChi(6,icount)/2._dp,3,-CurrentPDG3, & 
 & Trim(NameParticleChi(6))//" -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleFe(gt2))//" "//Trim(NameParticleFv(gt3))//"^* "//")"
End if 
icount = icount +1 
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRCha(1,icount),2,CurrentPDG2, & 
 & Trim(NameParticleCha(1))//"^* -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
If (Maxval(BRCha(1,97:365)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,2
  Do gt2=1,2
...
CurrentPDG2(2) = PDGVZp 
Write(io_L,201) BRCha(2,icount),2,CurrentPDG2, & 
 & Trim(NameParticleCha(2))//"^* -> "//Trim(NameParticleCha(gt1))//"^* "//Trim(NameParticleVZp)//" "//")"
End if 
icount = icount +1 
  End Do 
Do gt1= 1, 6
...
If (Maxval(BRCha(2,97:365)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,2
  Do gt2=1,2
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.NonUMSSMv4",status="unknown")
...
Write(123,*) "Ye11_r = ",Real(Ye11,dp) 
Write(123,*) "Ye11_i = ",AImag(Ye11) 
Write(123,*) "Ye22_r = ",Real(Ye22,dp) 
Write(123,*) "Ye22_i = ",AImag(Ye22) 
Write(123,*) "Ye33_r = ",Real(Ye33,dp) 
Write(123,*) "Ye33_i = ",AImag(Ye33) 
Write(123,*) "lam_r = ",Real(lam,dp) 
Write(123,*) "lam_i = ",AImag(lam) 
Write(123,*) "Yv11_r = ",Real(Yv11,dp) 
Write(123,*) "Yv11_i = ",AImag(Yv11) 
Write(123,*) "Yv22_r = ",Real(Yv22,dp) 
Write(123,*) "Yv22_i = ",AImag(Yv22) 
Write(123,*) "Yv33_r = ",Real(Yv33,dp) 
Write(123,*) "Yv33_i = ",AImag(Yv33) 
...
Write(123,*) "TYe11_r = ",Real(TYe11,dp) 
Write(123,*) "TYe11_i = ",AImag(TYe11) 
Write(123,*) "TYe22_r = ",Real(TYe22,dp) 
Write(123,*) "TYe22_i = ",AImag(TYe22) 
Write(123,*) "TYe33_r = ",Real(TYe33,dp) 
Write(123,*) "TYe33_i = ",AImag(TYe33) 
Write(123,*) "Tlam_r = ",Real(Tlam,dp) 
Write(123,*) "Tlam_i = ",AImag(Tlam) 
Write(123,*) "TYv11_r = ",Real(TYv11,dp) 
Write(123,*) "TYv11_i = ",AImag(TYv11) 
Write(123,*) "TYv22_r = ",Real(TYv22,dp) 
Write(123,*) "TYv22_i = ",AImag(TYv22) 
Write(123,*) "TYv33_r = ",Real(TYv33,dp) 
Write(123,*) "TYv33_i = ",AImag(TYv33) 
...
Write(123,*) "Tep_r = ",Real(Tep,dp) 
Write(123,*) "Tep_i = ",AImag(Tep) 
Write(123,*) "Tmup_r = ",Real(Tmup,dp) 
Write(123,*) "Tmup_i = ",AImag(Tmup) 
Write(123,*) "vS= ",vS
Write(123,*) "vS= ",vS
...
Write(123,*) "Msv4= ", Abs(MSv(4)) 
Write(123,*) "Msv5= ", Abs(MSv(5)) 
Write(123,*) "Msv6= ", Abs(MSv(6)) 
...
Write(123,*) "Wsv4 = ",gTSv(4)
Write(123,*) "Wsv5 = ",gTSv(5)
Write(123,*) "Wsv6 = ",gTSv(6)
...
Write(123,*) "ZV14_r = ", Real(ZV(1,4),dp)
Write(123,*) "ZV14_i = ", AImag(ZV(1,4))
Write(123,*) "ZV15_r = ", Real(ZV(1,5),dp)
Write(123,*) "ZV15_i = ", AImag(ZV(1,5))
Write(123,*) "ZV16_r = ", Real(ZV(1,6),dp)
Write(123,*) "ZV16_i = ", AImag(ZV(1,6))
Else 
...
Write(123,*) "ZV14_i = ", Real(ZV(1,4),dp)
Write(123,*) "ZV14_r = ", -AImag(ZV(1,4))
Write(123,*) "ZV15_i = ", Real(ZV(1,5),dp)
Write(123,*) "ZV15_r = ", -AImag(ZV(1,5))
Write(123,*) "ZV16_i = ", Real(ZV(1,6),dp)
Write(123,*) "ZV16_r = ", -AImag(ZV(1,6))
End if 
...
Write(123,*) "ZV24_r = ", Real(ZV(2,4),dp)
Write(123,*) "ZV24_i = ", AImag(ZV(2,4))
Write(123,*) "ZV25_r = ", Real(ZV(2,5),dp)
Write(123,*) "ZV25_i = ", AImag(ZV(2,5))
Write(123,*) "ZV26_r = ", Real(ZV(2,6),dp)
Write(123,*) "ZV26_i = ", AImag(ZV(2,6))
Else 
...
Write(123,*) "ZV24_i = ", Real(ZV(2,4),dp)
Write(123,*) "ZV24_r = ", -AImag(ZV(2,4))
Write(123,*) "ZV25_i = ", Real(ZV(2,5),dp)
Write(123,*) "ZV25_r = ", -AImag(ZV(2,5))
Write(123,*) "ZV26_i = ", Real(ZV(2,6),dp)
Write(123,*) "ZV26_r = ", -AImag(ZV(2,6))
End if 
...
Write(123,*) "ZV34_r = ", Real(ZV(3,4),dp)
Write(123,*) "ZV34_i = ", AImag(ZV(3,4))
Write(123,*) "ZV35_r = ", Real(ZV(3,5),dp)
Write(123,*) "ZV35_i = ", AImag(ZV(3,5))
Write(123,*) "ZV36_r = ", Real(ZV(3,6),dp)
Write(123,*) "ZV36_i = ", AImag(ZV(3,6))
Else 
...
Write(123,*) "ZV34_i = ", Real(ZV(3,4),dp)
Write(123,*) "ZV34_r = ", -AImag(ZV(3,4))
Write(123,*) "ZV35_i = ", Real(ZV(3,5),dp)
Write(123,*) "ZV35_r = ", -AImag(ZV(3,5))
Write(123,*) "ZV36_i = ", Real(ZV(3,6),dp)
Write(123,*) "ZV36_r = ", -AImag(ZV(3,6))
End if 
If (MSv(4).Gt.0._dp) Then 
Write(123,*) "ZV41_r = ", Real(ZV(4,1),dp)
Write(123,*) "ZV41_i = ", AImag(ZV(4,1))
Write(123,*) "ZV42_r = ", Real(ZV(4,2),dp)
Write(123,*) "ZV42_i = ", AImag(ZV(4,2))
Write(123,*) "ZV43_r = ", Real(ZV(4,3),dp)
Write(123,*) "ZV43_i = ", AImag(ZV(4,3))
Write(123,*) "ZV44_r = ", Real(ZV(4,4),dp)
Write(123,*) "ZV44_i = ", AImag(ZV(4,4))
Write(123,*) "ZV45_r = ", Real(ZV(4,5),dp)
Write(123,*) "ZV45_i = ", AImag(ZV(4,5))
Write(123,*) "ZV46_r = ", Real(ZV(4,6),dp)
Write(123,*) "ZV46_i = ", AImag(ZV(4,6))
Else 
Write(123,*) "ZV41_i = ", Real(ZV(4,1),dp)
Write(123,*) "ZV41_r = ", -AImag(ZV(4,1))
Write(123,*) "ZV42_i = ", Real(ZV(4,2),dp)
Write(123,*) "ZV42_r = ", -AImag(ZV(4,2))
Write(123,*) "ZV43_i = ", Real(ZV(4,3),dp)
Write(123,*) "ZV43_r = ", -AImag(ZV(4,3))
Write(123,*) "ZV44_i = ", Real(ZV(4,4),dp)
Write(123,*) "ZV44_r = ", -AImag(ZV(4,4))
Write(123,*) "ZV45_i = ", Real(ZV(4,5),dp)
Write(123,*) "ZV45_r = ", -AImag(ZV(4,5))
Write(123,*) "ZV46_i = ", Real(ZV(4,6),dp)
Write(123,*) "ZV46_r = ", -AImag(ZV(4,6))
End if 
If (MSv(5).Gt.0._dp) Then 
Write(123,*) "ZV51_r = ", Real(ZV(5,1),dp)
Write(123,*) "ZV51_i = ", AImag(ZV(5,1))
Write(123,*) "ZV52_r = ", Real(ZV(5,2),dp)
Write(123,*) "ZV52_i = ", AImag(ZV(5,2))
Write(123,*) "ZV53_r = ", Real(ZV(5,3),dp)
Write(123,*) "ZV53_i = ", AImag(ZV(5,3))
Write(123,*) "ZV54_r = ", Real(ZV(5,4),dp)
Write(123,*) "ZV54_i = ", AImag(ZV(5,4))
Write(123,*) "ZV55_r = ", Real(ZV(5,5),dp)
Write(123,*) "ZV55_i = ", AImag(ZV(5,5))
Write(123,*) "ZV56_r = ", Real(ZV(5,6),dp)
Write(123,*) "ZV56_i = ", AImag(ZV(5,6))
Else 
Write(123,*) "ZV51_i = ", Real(ZV(5,1),dp)
Write(123,*) "ZV51_r = ", -AImag(ZV(5,1))
Write(123,*) "ZV52_i = ", Real(ZV(5,2),dp)
Write(123,*) "ZV52_r = ", -AImag(ZV(5,2))
Write(123,*) "ZV53_i = ", Real(ZV(5,3),dp)
Write(123,*) "ZV53_r = ", -AImag(ZV(5,3))
Write(123,*) "ZV54_i = ", Real(ZV(5,4),dp)
Write(123,*) "ZV54_r = ", -AImag(ZV(5,4))
Write(123,*) "ZV55_i = ", Real(ZV(5,5),dp)
Write(123,*) "ZV55_r = ", -AImag(ZV(5,5))
Write(123,*) "ZV56_i = ", Real(ZV(5,6),dp)
Write(123,*) "ZV56_r = ", -AImag(ZV(5,6))
End if 
If (MSv(6).Gt.0._dp) Then 
Write(123,*) "ZV61_r = ", Real(ZV(6,1),dp)
Write(123,*) "ZV61_i = ", AImag(ZV(6,1))
Write(123,*) "ZV62_r = ", Real(ZV(6,2),dp)
Write(123,*) "ZV62_i = ", AImag(ZV(6,2))
Write(123,*) "ZV63_r = ", Real(ZV(6,3),dp)
Write(123,*) "ZV63_i = ", AImag(ZV(6,3))
Write(123,*) "ZV64_r = ", Real(ZV(6,4),dp)
Write(123,*) "ZV64_i = ", AImag(ZV(6,4))
Write(123,*) "ZV65_r = ", Real(ZV(6,5),dp)
Write(123,*) "ZV65_i = ", AImag(ZV(6,5))
Write(123,*) "ZV66_r = ", Real(ZV(6,6),dp)
Write(123,*) "ZV66_i = ", AImag(ZV(6,6))
Else 
Write(123,*) "ZV61_i = ", Real(ZV(6,1),dp)
Write(123,*) "ZV61_r = ", -AImag(ZV(6,1))
Write(123,*) "ZV62_i = ", Real(ZV(6,2),dp)
Write(123,*) "ZV62_r = ", -AImag(ZV(6,2))
Write(123,*) "ZV63_i = ", Real(ZV(6,3),dp)
Write(123,*) "ZV63_r = ", -AImag(ZV(6,3))
Write(123,*) "ZV64_i = ", Real(ZV(6,4),dp)
Write(123,*) "ZV64_r = ", -AImag(ZV(6,4))
Write(123,*) "ZV65_i = ", Real(ZV(6,5),dp)
Write(123,*) "ZV65_r = ", -AImag(ZV(6,5))
Write(123,*) "ZV66_i = ", Real(ZV(6,6),dp)
Write(123,*) "ZV66_r = ", -AImag(ZV(6,6))
End if 
If (MFv(1).Gt.0._dp) Then 
Write(123,*) "ZVL11_r = ", Real(ZVL(1,1),dp)
Write(123,*) "ZVL11_i = ", AImag(ZVL(1,1))
Write(123,*) "ZVL12_r = ", Real(ZVL(1,2),dp)
Write(123,*) "ZVL12_i = ", AImag(ZVL(1,2))
Write(123,*) "ZVL13_r = ", Real(ZVL(1,3),dp)
Write(123,*) "ZVL13_i = ", AImag(ZVL(1,3))
Else 
Write(123,*) "ZVL11_i = ", Real(ZVL(1,1),dp)
Write(123,*) "ZVL11_r = ", -AImag(ZVL(1,1))
Write(123,*) "ZVL12_i = ", Real(ZVL(1,2),dp)
Write(123,*) "ZVL12_r = ", -AImag(ZVL(1,2))
Write(123,*) "ZVL13_i = ", Real(ZVL(1,3),dp)
Write(123,*) "ZVL13_r = ", -AImag(ZVL(1,3))
End if 
If (MFv(2).Gt.0._dp) Then 
Write(123,*) "ZVL21_r = ", Real(ZVL(2,1),dp)
Write(123,*) "ZVL21_i = ", AImag(ZVL(2,1))
Write(123,*) "ZVL22_r = ", Real(ZVL(2,2),dp)
Write(123,*) "ZVL22_i = ", AImag(ZVL(2,2))
Write(123,*) "ZVL23_r = ", Real(ZVL(2,3),dp)
Write(123,*) "ZVL23_i = ", AImag(ZVL(2,3))
Else 
Write(123,*) "ZVL21_i = ", Real(ZVL(2,1),dp)
Write(123,*) "ZVL21_r = ", -AImag(ZVL(2,1))
Write(123,*) "ZVL22_i = ", Real(ZVL(2,2),dp)
Write(123,*) "ZVL22_r = ", -AImag(ZVL(2,2))
Write(123,*) "ZVL23_i = ", Real(ZVL(2,3),dp)
Write(123,*) "ZVL23_r = ", -AImag(ZVL(2,3))
End if 
If (MFv(3).Gt.0._dp) Then 
Write(123,*) "ZVL31_r = ", Real(ZVL(3,1),dp)
Write(123,*) "ZVL31_i = ", AImag(ZVL(3,1))
Write(123,*) "ZVL32_r = ", Real(ZVL(3,2),dp)
Write(123,*) "ZVL32_i = ", AImag(ZVL(3,2))
Write(123,*) "ZVL33_r = ", Real(ZVL(3,3),dp)
Write(123,*) "ZVL33_i = ", AImag(ZVL(3,3))
Else 
Write(123,*) "ZVL31_i = ", Real(ZVL(3,1),dp)
Write(123,*) "ZVL31_r = ", -AImag(ZVL(3,1))
Write(123,*) "ZVL32_i = ", Real(ZVL(3,2),dp)
Write(123,*) "ZVL32_r = ", -AImag(ZVL(3,2))
Write(123,*) "ZVL33_i = ", Real(ZVL(3,3),dp)
Write(123,*) "ZVL33_r = ", -AImag(ZVL(3,3))
End if 
If (MFv(1).Gt.0._dp) Then 
Write(123,*) "ZVR11_r = ", Real(ZVR(1,1),dp)
Write(123,*) "ZVR11_i = ", AImag(ZVR(1,1))
Write(123,*) "ZVR12_r = ", Real(ZVR(1,2),dp)
Write(123,*) "ZVR12_i = ", AImag(ZVR(1,2))
Write(123,*) "ZVR13_r = ", Real(ZVR(1,3),dp)
Write(123,*) "ZVR13_i = ", AImag(ZVR(1,3))
Else 
Write(123,*) "ZVR11_i = ", Real(ZVR(1,1),dp)
Write(123,*) "ZVR11_r = ", -AImag(ZVR(1,1))
Write(123,*) "ZVR12_i = ", Real(ZVR(1,2),dp)
Write(123,*) "ZVR12_r = ", -AImag(ZVR(1,2))
Write(123,*) "ZVR13_i = ", Real(ZVR(1,3),dp)
Write(123,*) "ZVR13_r = ", -AImag(ZVR(1,3))
End if 
If (MFv(2).Gt.0._dp) Then 
Write(123,*) "ZVR21_r = ", Real(ZVR(2,1),dp)
Write(123,*) "ZVR21_i = ", AImag(ZVR(2,1))
Write(123,*) "ZVR22_r = ", Real(ZVR(2,2),dp)
Write(123,*) "ZVR22_i = ", AImag(ZVR(2,2))
Write(123,*) "ZVR23_r = ", Real(ZVR(2,3),dp)
Write(123,*) "ZVR23_i = ", AImag(ZVR(2,3))
Else 
Write(123,*) "ZVR21_i = ", Real(ZVR(2,1),dp)
Write(123,*) "ZVR21_r = ", -AImag(ZVR(2,1))
Write(123,*) "ZVR22_i = ", Real(ZVR(2,2),dp)
Write(123,*) "ZVR22_r = ", -AImag(ZVR(2,2))
Write(123,*) "ZVR23_i = ", Real(ZVR(2,3),dp)
Write(123,*) "ZVR23_r = ", -AImag(ZVR(2,3))
End if 
If (MFv(3).Gt.0._dp) Then 
Write(123,*) "ZVR31_r = ", Real(ZVR(3,1),dp)
Write(123,*) "ZVR31_i = ", AImag(ZVR(3,1))
Write(123,*) "ZVR32_r = ", Real(ZVR(3,2),dp)
Write(123,*) "ZVR32_i = ", AImag(ZVR(3,2))
Write(123,*) "ZVR33_r = ", Real(ZVR(3,3),dp)
Write(123,*) "ZVR33_i = ", AImag(ZVR(3,3))
Else 
Write(123,*) "ZVR31_i = ", Real(ZVR(3,1),dp)
Write(123,*) "ZVR31_r = ", -AImag(ZVR(3,1))
Write(123,*) "ZVR32_i = ", Real(ZVR(3,2),dp)
Write(123,*) "ZVR32_r = ", -AImag(ZVR(3,2))
Write(123,*) "ZVR33_i = ", Real(ZVR(3,3),dp)
Write(123,*) "ZVR33_r = ", -AImag(ZVR(3,3))
End if 
...
Write(123,*) "ZN16_r = ", Real(ZN(1,6),dp)
Write(123,*) "ZN16_i = ", AImag(ZN(1,6))
Else 
...
Write(123,*) "ZN16_i = ", Real(ZN(1,6),dp)
Write(123,*) "ZN16_r = ", -AImag(ZN(1,6))
End if 
...
Write(123,*) "ZN26_r = ", Real(ZN(2,6),dp)
Write(123,*) "ZN26_i = ", AImag(ZN(2,6))
Else 
...
Write(123,*) "ZN26_i = ", Real(ZN(2,6),dp)
Write(123,*) "ZN26_r = ", -AImag(ZN(2,6))
End if 
...
Write(123,*) "ZN36_r = ", Real(ZN(3,6),dp)
Write(123,*) "ZN36_i = ", AImag(ZN(3,6))
Else 
...
Write(123,*) "ZN36_i = ", Real(ZN(3,6),dp)
Write(123,*) "ZN36_r = ", -AImag(ZN(3,6))
End if 
...
Write(123,*) "ZN46_r = ", Real(ZN(4,6),dp)
Write(123,*) "ZN46_i = ", AImag(ZN(4,6))
Else 
...
Write(123,*) "ZN46_i = ", Real(ZN(4,6),dp)
Write(123,*) "ZN46_r = ", -AImag(ZN(4,6))
End if 
...
Write(123,*) "ZN56_r = ", Real(ZN(5,6),dp)
Write(123,*) "ZN56_i = ", AImag(ZN(5,6))
Else 
...
Write(123,*) "ZN56_i = ", Real(ZN(5,6),dp)
Write(123,*) "ZN56_r = ", -AImag(ZN(5,6))
End if 
If (MChi(6).Gt.0._dp) Then 
Write(123,*) "ZN61_r = ", Real(ZN(6,1),dp)
Write(123,*) "ZN61_i = ", AImag(ZN(6,1))
Write(123,*) "ZN62_r = ", Real(ZN(6,2),dp)
Write(123,*) "ZN62_i = ", AImag(ZN(6,2))
Write(123,*) "ZN63_r = ", Real(ZN(6,3),dp)
Write(123,*) "ZN63_i = ", AImag(ZN(6,3))
Write(123,*) "ZN64_r = ", Real(ZN(6,4),dp)
Write(123,*) "ZN64_i = ", AImag(ZN(6,4))
Write(123,*) "ZN65_r = ", Real(ZN(6,5),dp)
Write(123,*) "ZN65_i = ", AImag(ZN(6,5))
Write(123,*) "ZN66_r = ", Real(ZN(6,6),dp)
Write(123,*) "ZN66_i = ", AImag(ZN(6,6))
Else 
Write(123,*) "ZN61_i = ", Real(ZN(6,1),dp)
Write(123,*) "ZN61_r = ", -AImag(ZN(6,1))
Write(123,*) "ZN62_i = ", Real(ZN(6,2),dp)
Write(123,*) "ZN62_r = ", -AImag(ZN(6,2))
Write(123,*) "ZN63_i = ", Real(ZN(6,3),dp)
Write(123,*) "ZN63_r = ", -AImag(ZN(6,3))
Write(123,*) "ZN64_i = ", Real(ZN(6,4),dp)
Write(123,*) "ZN64_r = ", -AImag(ZN(6,4))
Write(123,*) "ZN65_i = ", Real(ZN(6,5),dp)
Write(123,*) "ZN65_r = ", -AImag(ZN(6,5))
Write(123,*) "ZN66_i = ", Real(ZN(6,6),dp)
Write(123,*) "ZN66_r = ", -AImag(ZN(6,6))
End if 
...
Subroutine WriteWCXF 
   Open(123,file="WC.NonUMSSMv4_1.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
...
Write(123,*) "}"
    Close(123) 
   Open(123,file="WC.NonUMSSMv4_2.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
Write(123,*) '  "basis": "FlavorKit",'
Write(123,*) '  "scale": "91.",'
...
Subroutine Read_YE11IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) Ye11IN= Cmplx(wert,Aimag(Ye11IN),dp) 
If (i_c.Eq.1) Ye11IN= Cmplx(Real(Ye11IN,dp),wert,dp) 
InputValueforYe11= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block YE11IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMYE11IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block YE11IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMYE11IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_YE11IN 
 
 
Subroutine Read_YE22IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) Ye22IN= Cmplx(wert,Aimag(Ye22IN),dp) 
If (i_c.Eq.1) Ye22IN= Cmplx(Real(Ye22IN,dp),wert,dp) 
InputValueforYe22= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block YE22IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMYE22IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block YE22IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMYE22IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_YE22IN 
 
 
Subroutine Read_YE33IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) Ye33IN= Cmplx(wert,Aimag(Ye33IN),dp) 
If (i_c.Eq.1) Ye33IN= Cmplx(Real(Ye33IN,dp),wert,dp) 
InputValueforYe33= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block YE33IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMYE33IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block YE33IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMYE33IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_YE33IN 
...
Subroutine Read_YV11IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) Yv11IN= Cmplx(wert,Aimag(Yv11IN),dp) 
If (i_c.Eq.1) Yv11IN= Cmplx(Real(Yv11IN,dp),wert,dp) 
InputValueforYv11= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block YV11IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMYV11IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block YV11IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMYV11IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_YV11IN 
 
 
Subroutine Read_YV22IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) Yv22IN= Cmplx(wert,Aimag(Yv22IN),dp) 
If (i_c.Eq.1) Yv22IN= Cmplx(Real(Yv22IN,dp),wert,dp) 
InputValueforYv22= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block YV22IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMYV22IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block YV22IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMYV22IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_YV22IN 
 
 
Subroutine Read_YV33IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) Yv33IN= Cmplx(wert,Aimag(Yv33IN),dp) 
If (i_c.Eq.1) Yv33IN= Cmplx(Real(Yv33IN,dp),wert,dp) 
InputValueforYv33= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block YV33IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMYV33IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block YV33IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMYV33IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_YV33IN 
 
 
Subroutine Read_TYE11IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) TYe11IN= Cmplx(wert,Aimag(TYe11IN),dp) 
If (i_c.Eq.1) TYe11IN= Cmplx(Real(TYe11IN,dp),wert,dp) 
InputValueforTYe11= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block TYE11IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMTYE11IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block TYE11IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMTYE11IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_TYE11IN 
 
 
Subroutine Read_TYE22IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) TYe22IN= Cmplx(wert,Aimag(TYe22IN),dp) 
If (i_c.Eq.1) TYe22IN= Cmplx(Real(TYe22IN,dp),wert,dp) 
InputValueforTYe22= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block TYE22IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMTYE22IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block TYE22IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMTYE22IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_TYE22IN 
 
 
Subroutine Read_TYE33IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) TYe33IN= Cmplx(wert,Aimag(TYe33IN),dp) 
If (i_c.Eq.1) TYe33IN= Cmplx(Real(TYe33IN,dp),wert,dp) 
InputValueforTYe33= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block TYE33IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMTYE33IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block TYE33IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMTYE33IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_TYE33IN 
 
 
Subroutine Read_TYV11IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) TYv11IN= Cmplx(wert,Aimag(TYv11IN),dp) 
If (i_c.Eq.1) TYv11IN= Cmplx(Real(TYv11IN,dp),wert,dp) 
InputValueforTYv11= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block TYV11IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMTYV11IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block TYV11IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMTYV11IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_TYV11IN 
 
 
Subroutine Read_TYV22IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) TYv22IN= Cmplx(wert,Aimag(TYv22IN),dp) 
If (i_c.Eq.1) TYv22IN= Cmplx(Real(TYv22IN,dp),wert,dp) 
InputValueforTYv22= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block TYV22IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMTYV22IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block TYV22IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMTYV22IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_TYV22IN 
 
 
Subroutine Read_TYV33IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) TYv33IN= Cmplx(wert,Aimag(TYv33IN),dp) 
If (i_c.Eq.1) TYv33IN= Cmplx(Real(TYv33IN,dp),wert,dp) 
InputValueforTYv33= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block TYV33IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMTYV33IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block TYV33IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMTYV33IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_TYV33IN 
 
 
Subroutine Read_ML012IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
ml012IN= wert 
InputValueforml012= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block ML012IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMML012IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block ML012IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMML012IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_ML012IN 
 
 
Subroutine Read_ML022IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
ml022IN= wert 
InputValueforml022= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block ML022IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMML022IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block ML022IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMML022IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_ML022IN 
 
 
Subroutine Read_ML032IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
ml032IN= wert 
InputValueforml032= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block ML032IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMML032IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block ML032IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMML032IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_ML032IN 
...
Else If (i_par.Eq.4) Then 
If (i_c.Eq.0) M4IN= Cmplx(wert,Aimag(M4IN),dp) 
If (i_c.Eq.1) M4IN= Cmplx(Real(M4IN,dp),wert,dp) 
InputValueforM4= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
...
Subroutine Read_ME012IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
me012IN= wert 
InputValueforme012= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block ME012IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMME012IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block ME012IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMME012IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_ME012IN 
 
 
Subroutine Read_ME022IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
me022IN= wert 
InputValueforme022= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block ME022IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMME022IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block ME022IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMME022IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_ME022IN 
 
 
Subroutine Read_ME032IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
me032IN= wert 
InputValueforme032= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block ME032IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMME032IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block ME032IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMME032IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_ME032IN 
 
 
Subroutine Read_MVR012IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
mvR012IN= wert 
InputValueformvR012= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block MVR012IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMMVR012IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block MVR012IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMMVR012IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_MVR012IN 
 
 
Subroutine Read_MVR022IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
mvR022IN= wert 
InputValueformvR022= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block MVR022IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMMVR022IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block MVR022IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMMVR022IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_MVR022IN 
 
 
Subroutine Read_MVR032IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
mvR032IN= wert 
InputValueformvR032= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block MVR032IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMMVR032IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block MVR032IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMMVR032IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_MVR032IN 
 
 
Subroutine Read_NPIN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block NPIN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMNPIN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block NPIN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMNPIN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_NPIN 
 
 
Subroutine Read_TEPIN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) TepIN= Cmplx(wert,Aimag(TepIN),dp) 
If (i_c.Eq.1) TepIN= Cmplx(Real(TepIN,dp),wert,dp) 
InputValueforTep= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block TEPIN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMTEPIN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block TEPIN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMTEPIN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_TEPIN 
 
 
Subroutine Read_TMUPIN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) TmupIN= Cmplx(wert,Aimag(TmupIN),dp) 
If (i_c.Eq.1) TmupIN= Cmplx(Real(TmupIN,dp),wert,dp) 
InputValueforTmup= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block TMUPIN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMTMUPIN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block TMUPIN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMTMUPIN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_TMUPIN 
...
Subroutine Read_XCHARGEIN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
End Module InputOutput_NonUMSSMv4 
