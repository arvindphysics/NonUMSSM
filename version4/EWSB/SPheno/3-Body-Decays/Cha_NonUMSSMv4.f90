...
Real(dp),Intent(in) :: MCha(2),MFe(3),MVZ,MVZp,MSv(6),MAh(3),Mhh(3)
...
Real(dp),Intent(in) :: MCha(2),MFv(3),MVZ,MVZp,MSe(6),MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplcChacFvSeL(2,3,6),cplcChacFvSeR(2,3,6),cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),  & 
& cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),       & 
& cplcChaChaVZpL(2,2),cplcChaChaVZpR(2,2),cplcFvFvAhL(3,3,3),cplcFvFvAhR(3,3,3),         & 
...
Real(dp),Intent(in) :: MChi(6),MFv(3),MFe(3),MVWm,MHpm(2),MSv(6),MSe(6),MCha(2)

Complex(dp),Intent(in) :: cplcChacFvSeL(2,3,6),cplcChacFvSeR(2,3,6),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),& 
& cplcChaChiVWmL(2,6),cplcChaChiVWmR(2,6),cplcChaFecSvL(2,3,6),cplcChaFecSvR(2,3,6),     & 
...
End Module Cha3Decays_NonUMSSMv4 
