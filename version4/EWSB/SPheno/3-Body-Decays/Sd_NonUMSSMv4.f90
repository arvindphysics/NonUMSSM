...
! ------------------------------------------------------------------------------  
! File created at 16:02 on 21.3.2021   
! ----------------------------------------------------------------------  
 
 
Module Sd3Decays_NonUMSSMv4 
...
& mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,Tep,Tmup,vd,vu,vS,gSdAhChaFu,gSdAhChiFd,          & 
...
& cplAhSdcSd,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,cplcChaChaAhL,      & 
...
Real(dp),Intent(in) :: MFd(3),MFv(3),MSv(6),MChi(6),MSd(6)
...
Real(dp),Intent(in) :: MFd(3),MSv(6),MFv(3),MChi(6),MSd(6)

Complex(dp),Intent(in) :: cplcFvChiSvL(3,6,6),cplcFvChiSvR(3,6,6),cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6)
...
Real(dp),Intent(in) :: MSd(6),MFv(3),MVZ,MVZp,MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplAhSdcSd(3,6,6),cplhhSdcSd(3,6,6),cplSdcSdVZ(6,6),cplSdcSdVZp(6,6),cplcFvFvAhL(3,3,3),& 
...
End Module Sd3Decays_NonUMSSMv4 
