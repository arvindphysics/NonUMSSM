...
! ------------------------------------------------------------------------------  
! File created at 16:05 on 21.3.2021   
! ----------------------------------------------------------------------  
 
 
Module Sv3Decays_NonUMSSMv4 
...
& mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,Tep,Tmup,vd,vu,vS,gSvAhChiFv,gSvAhFecCha,         & 
...
Complex(dp) :: cplAhSvcSv(3,6,6),cplcChacFvSeL(2,3,6),cplcChacFvSeR(2,3,6),cplcChaChaAhL(2,2,3),     & 
...
Real(dp),Intent(inout) :: gSvAhChiFv(6,3,6,3),gSvAhFecCha(6,3,3,2),gSvSvChiChi(6,6,6,6),gSvcHpmChiFe(6,2,6,3),  & 
& gSvhhChiFv(6,3,6,3),gSvSeChicCha(6,6,6,2),gSvFeFucSd(6,3,3,6),gSvFeFvcSe(6,3,3,6),     & 
& gSvhhFecCha(6,3,3,2),gSvFeSucFd(6,3,6,3),gSvSvFecFe(6,6,3,3),gSvcHpmChaFv(6,2,2,3),    & 
...
Real(dp) :: gSvAhChiFvi(3,6,3),gSvAhFecChai(3,3,2),gSvSvChiChii(6,6,6),gSvcHpmChiFei(2,6,3),      & 
& gSvhhChiFvi(3,6,3),gSvSeChicChai(6,6,2),gSvFeFucSdi(3,3,6),gSvFeFvcSei(3,3,6),         & 
& gSvhhFecChai(3,3,2),gSvFeSucFdi(3,6,3),gSvSvFecFei(6,3,3),gSvcHpmChaFvi(2,2,3),        & 
...
& cplAhSvcSv,cplcChacFvSeL,cplcChacFvSeR,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,      & 
...
& cplcFuFuVZR,cplcFvChiSvL,cplcFvChiSvR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFvAhL,         & 
...
Real(dp),Intent(in) :: MAh(3),MChi(6),MFv(3),MSv(6)

Complex(dp),Intent(in) :: cplAhSvcSv(3,6,6),cplcFvFvAhL(3,3,3),cplcFvFvAhR(3,3,3),cplChiChiAhL(6,6,3),          & 
& cplChiChiAhR(6,6,3),cplChiFvcSvL(6,3,6),cplChiFvcSvR(6,3,6)
...
Real(dp),Intent(in) :: MAh(3),MFe(3),MCha(2),MSv(6)

Complex(dp),Intent(in) :: cplAhSvcSv(3,6,6),cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),cplcChaFecSvL(2,3,6),     & 
& cplcChaFecSvR(2,3,6),cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3)
...
Real(dp),Intent(in) :: MSv(6),MChi(6),MVZ,MVZp,MAh(3),Mhh(3),MFv(3)

Complex(dp),Intent(in) :: cplAhSvcSv(3,6,6),cplhhSvcSv(3,6,6),cplSvcSvVZ(6,6),cplSvcSvVZp(6,6),cplcFvChiSvL(3,6,6),& 
& cplcFvChiSvR(3,6,6),cplChiChiAhL(6,6,3),cplChiChiAhR(6,6,3),cplChiChihhL(6,6,3),       & 
& cplChiChihhR(6,6,3),cplChiChiVZL(6,6),cplChiChiVZR(6,6),cplChiChiVZpL(6,6),            & 
& cplChiChiVZpR(6,6),cplChiFvcSvL(6,3,6),cplChiFvcSvR(6,3,6)
...
Real(dp),Intent(in) :: MHpm(2),MChi(6),MFe(3),MSe(6),MFv(3),MCha(2),MSv(6)
...
& cplChiFecSeR(6,3,6),cplChiFvcSvL(6,3,6),cplChiFvcSvR(6,3,6)
...
Real(dp),Intent(in) :: Mhh(3),MChi(6),MFv(3),MSv(6)

Complex(dp),Intent(in) :: cplhhSvcSv(3,6,6),cplcFvFvhhL(3,3,3),cplcFvFvhhR(3,3,3),cplChiChihhL(6,6,3),          & 
& cplChiChihhR(6,6,3),cplChiFvcSvL(6,3,6),cplChiFvcSvR(6,3,6)
...
Real(dp),Intent(in) :: MSe(6),MChi(6),MCha(2),MVWm,MHpm(2),MFv(3),MFe(3),MSv(6)
...
& cplcChaFecSvL(2,3,6),cplcChaFecSvR(2,3,6),cplcFeChiSeL(3,6,6),cplcFeChiSeR(3,6,6),     & 
& cplChiFvcSvL(6,3,6),cplChiFvcSvR(6,3,6)
...
Real(dp),Intent(in) :: MFe(3),MFv(3),MSe(6),MCha(2),MChi(6),MSv(6)

Complex(dp),Intent(in) :: cplcChaFecSvL(2,3,6),cplcChaFecSvR(2,3,6),cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),    & 
& cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6),cplChiFvcSvL(6,3,6),cplChiFvcSvR(6,3,6)
...
Real(dp),Intent(in) :: Mhh(3),MFe(3),MCha(2),MSv(6)

Complex(dp),Intent(in) :: cplhhSvcSv(3,6,6),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),cplcChaFecSvL(2,3,6),     & 
& cplcChaFecSvR(2,3,6),cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3)
...
Real(dp),Intent(in) :: MSv(6),MFe(3),MVZ,MVZp,MAh(3),Mhh(3),MCha(2)

Complex(dp),Intent(in) :: cplAhSvcSv(3,6,6),cplhhSvcSv(3,6,6),cplSvcSvVZ(6,6),cplSvcSvVZp(6,6),cplcChaFecSvL(2,3,6),& 
& cplcChaFecSvR(2,3,6),cplcFeChaSvL(3,2,6),cplcFeChaSvR(3,2,6),cplcFeFeAhL(3,3,3),       & 
...
Real(dp),Intent(in) :: MHpm(2),MCha(2),MFv(3),MSe(6),MChi(6),MSv(6)

Complex(dp),Intent(in) :: cplSecHpmcSv(6,2,6),cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),cplChiChacHpmL(6,2,2),    & 
& cplChiChacHpmR(6,2,2),cplChiFvcSvL(6,3,6),cplChiFvcSvR(6,3,6)
...
Real(dp),Intent(in) :: MFv(3),MFd(3),MSd(6),MChi(6),MSv(6)

Complex(dp),Intent(in) :: cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6),cplChiFvcSvL(6,3,6),cplChiFvcSvR(6,3,6)
...
Real(dp),Intent(in) :: MFv(3),MFu(3),MSu(6),MChi(6),MSv(6)

Complex(dp),Intent(in) :: cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6),cplChiFvcSvL(6,3,6),cplChiFvcSvR(6,3,6)
...
Real(dp),Intent(in) :: MFv(3),MSv(6),MChi(6)

Complex(dp),Intent(in) :: cplChiFvcSvL(6,3,6),cplChiFvcSvR(6,3,6)
...
Real(dp),Intent(in) :: MCha(2),MFv(3),MHpm(2),MFe(3),MChi(6),MSv(6)

Complex(dp),Intent(in) :: cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),cplcChaFecSvL(2,3,6),cplcChaFecSvR(2,3,6),& 
& cplcFeFvHpmL(3,3,2),cplcFeFvHpmR(3,3,2),cplChiFvcSvL(6,3,6),cplChiFvcSvR(6,3,6)
...
Real(dp),Intent(in) :: MFv(3),MSd(6),MFd(3),MChi(6),MSv(6)

Complex(dp),Intent(in) :: cplcFdChiSdL(3,6,6),cplcFdChiSdR(3,6,6),cplChiFvcSvL(6,3,6),cplChiFvcSvR(6,3,6)
...
Real(dp),Intent(in) :: MSe(6),MFv(3),MFe(3),MVWm,MHpm(2),MChi(6),MSv(6)

Complex(dp),Intent(in) :: cplSecHpmcSv(6,2,6),cplSecSvcVWm(6,6),cplcFeChiSeL(3,6,6),cplcFeChiSeR(3,6,6),        & 
...
Real(dp),Intent(in) :: MFv(3),MSu(6),MFu(3),MChi(6),MSv(6)

Complex(dp),Intent(in) :: cplcFuChiSuL(3,6,6),cplcFuChiSuR(3,6,6),cplChiFvcSvL(6,3,6),cplChiFvcSvR(6,3,6)
...
Real(dp),Intent(in) :: MSv(6),MFv(3),MVZ,MVZp,MAh(3),Mhh(3),MChi(6)

Complex(dp),Intent(in) :: cplAhSvcSv(3,6,6),cplhhSvcSv(3,6,6),cplSvcSvVZ(6,6),cplSvcSvVZp(6,6),cplcFvChiSvL(3,6,6),& 
& cplcFvChiSvR(3,6,6),cplcFvFvAhL(3,3,3),cplcFvFvAhR(3,3,3),cplcFvFvhhL(3,3,3),          & 
& cplcFvFvhhR(3,3,3),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplcFvFvVZpL(3,3),cplcFvFvVZpR(3,3),& 
& cplChiFvcSvL(6,3,6),cplChiFvcSvR(6,3,6)
...
Real(dp),Intent(in) :: MSv(6),MCha(2),MVZ,MVZp,MAh(3),Mhh(3),MFe(3)

Complex(dp),Intent(in) :: cplAhSvcSv(3,6,6),cplhhSvcSv(3,6,6),cplSvcSvVZ(6,6),cplSvcSvVZp(6,6),cplcChaChaAhL(2,2,3),& 
& cplcChaChaAhR(2,2,3),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),cplcChaChaVZL(2,2),     & 
...
Real(dp),Intent(in) :: MSv(6),MFd(3),MVZ,MVZp,MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplAhSvcSv(3,6,6),cplhhSvcSv(3,6,6),cplSvcSvVZ(6,6),cplSvcSvVZp(6,6),cplcFdFdAhL(3,3,3),& 
...
Real(dp),Intent(in) :: MSv(6),MFu(3),MVZ,MVZp,MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplAhSvcSv(3,6,6),cplhhSvcSv(3,6,6),cplSvcSvVZ(6,6),cplSvcSvVZp(6,6),cplcFuFuAhL(3,3,3),& 
& cplcFuFuAhR(3,3,3),cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),cplcFuFuVZL(3,3),             & 
...
End Module Sv3Decays_NonUMSSMv4 
