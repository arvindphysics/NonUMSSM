...
! ------------------------------------------------------------------------------  
! File created at 16:04 on 21.3.2021   
! ----------------------------------------------------------------------  
 
 
Module Se3Decays_NonUMSSMv4 
...
& mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,Tep,Tmup,vd,vu,vS,gSeAhChaFv,gSeAhChiFe,          & 
...
Real(dp),Intent(inout) :: gSeAhChaFv(6,3,2,3),gSeAhChiFe(6,3,6,3),gSeSvChaChi(6,6,2,6),gSeChaFecHpm(6,2,3,2),   & 
& gSehhChaFv(6,3,2,3),gSeSeChacCha(6,6,2,2),gSeSeChiChi(6,6,6,6),gSehhChiFe(6,3,6,3),    & 
& gSeHpmChiFv(6,2,6,3),gSeFeFdcSd(6,3,3,6),gSeFeFecSe(6,3,3,6),gSeFeFucSu(6,3,3,6),      & 
...
Real(dp) :: gSeAhChaFvi(3,2,3),gSeAhChiFei(3,6,3),gSeSvChaChii(6,2,6),gSeChaFecHpmi(2,3,2),       & 
& gSehhChaFvi(3,2,3),gSeSeChacChai(6,2,2),gSeSeChiChii(6,6,6),gSehhChiFei(3,6,3),        & 
& gSeHpmChiFvi(2,6,3),gSeFeFdcSdi(3,3,6),gSeFeFecSei(3,3,6),gSeFeFucSui(3,3,6),          & 
...
& cplAhSecSe,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,cplcChaChaAhL,      & 
...
Complex(dp),Intent(in) :: cplAhSecSe(3,6,6),cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),cplcFvFvAhL(3,3,3),       & 
& cplcFvFvAhR(3,3,3),cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6)
...
Real(dp),Intent(in) :: MSv(6),MCha(2),MChi(6),MVWm,MHpm(2),MFv(3),MFe(3),MSe(6)

Complex(dp),Intent(in) :: cplHpmSvcSe(2,6,6),cplSvcSeVWm(6,6),cplcFeChaSvL(3,2,6),cplcFeChaSvR(3,2,6),          & 
& cplcFvChiSvL(3,6,6),cplcFvChiSvR(3,6,6),cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),       & 
...
Complex(dp),Intent(in) :: cplhhSecSe(3,6,6),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),cplcFvFvhhL(3,3,3),       & 
& cplcFvFvhhR(3,3,3),cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6)
...
Real(dp),Intent(in) :: MHpm(2),MChi(6),MFv(3),MSv(6),MFe(3),MCha(2),MSe(6)

Complex(dp),Intent(in) :: cplHpmSvcSe(2,6,6),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),cplcFeFvHpmL(3,3,2),   & 
...
Real(dp),Intent(in) :: MFv(3),MFe(3),MSv(6),MCha(2),MChi(6),MSe(6)
...
Real(dp),Intent(in) :: MHpm(2),MFe(3),MCha(2),MSv(6),MChi(6),MSe(6)

Complex(dp),Intent(in) :: cplHpmSvcSe(2,6,6),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),cplcChaFecSvL(2,3,6),  & 
& cplcChaFecSvR(2,3,6),cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6)
...
Real(dp),Intent(in) :: MSv(6),MFe(3),MFv(3),MVWm,MHpm(2),MChi(6),MSe(6)

Complex(dp),Intent(in) :: cplHpmSvcSe(2,6,6),cplSvcSeVWm(6,6),cplcFvChiSvL(3,6,6),cplcFvChiSvR(3,6,6),          & 
...
Real(dp),Intent(in) :: MSe(6),MFv(3),MVZ,MVZp,MAh(3),Mhh(3),MCha(2)

Complex(dp),Intent(in) :: cplAhSecSe(3,6,6),cplhhSecSe(3,6,6),cplSecSeVZ(6,6),cplSecSeVZp(6,6),cplcChacFvSeL(2,3,6),& 
& cplcChacFvSeR(2,3,6),cplcFvFvAhL(3,3,3),cplcFvFvAhR(3,3,3),cplcFvFvhhL(3,3,3),         & 
...
End Module Se3Decays_NonUMSSMv4 
