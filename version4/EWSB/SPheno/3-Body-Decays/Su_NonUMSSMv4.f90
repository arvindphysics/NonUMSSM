...
! ------------------------------------------------------------------------------  
! File created at 16:03 on 21.3.2021   
! ----------------------------------------------------------------------  
 
 
Module Su3Decays_NonUMSSMv4 
...
& mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,Tep,Tmup,vd,vu,vS,gSuAhChiFu,gSuAhFdcCha,         & 
...
& gSuSuFucFu(6,6,3,3),gSuFuSvcFv(6,3,6,3),gSucHpmFdGlu(6,2,3,1),gSuhhFuGlu(6,3,3,1),     & 
...
& gSuSuFucFui(6,3,3),gSuFuSvcFvi(3,6,3),gSucHpmFdGlui(2,3,1),gSuhhFuGlui(3,3,1),         & 
...
& cplcFuGluSuR,cplcFvChiSvL,cplcFvChiSvR,cplcFvFvAhL,cplcFvFvAhR,cplcFvFvhhL,            & 
...
Real(dp),Intent(in) :: MFu(3),MFv(3),MSv(6),MChi(6),MSu(6)
...
Real(dp),Intent(in) :: MFu(3),MSv(6),MFv(3),MChi(6),MSu(6)

Complex(dp),Intent(in) :: cplcFvChiSvL(3,6,6),cplcFvChiSvR(3,6,6),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6)
...
Real(dp),Intent(in) :: MSu(6),MFv(3),MVZ,MVZp,MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplAhSucSu(3,6,6),cplhhSucSu(3,6,6),cplSucSuVZ(6,6),cplSucSuVZp(6,6),cplcFvFvAhL(3,3,3),& 
...
End Module Su3Decays_NonUMSSMv4 
