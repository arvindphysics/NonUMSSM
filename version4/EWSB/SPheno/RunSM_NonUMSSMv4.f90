...
& Tep,Tmup,vd,vu,vS,CKMout,sinW2_out,Alpha_out,AlphaS_out,realCKM)
...
Real(dp) :: scale_save, Qin, tz, dt, g1D(185), g62_SM(62) 
 
 
! Run SUSY RGEs from M_SUSY to Qin 
Qin=sqrt(getRenormalizationScale()) 
scale_save = Qin 
Call ParametersToG185(g1input,g2input,g3input,gpinput,Ydinput,Ye11input,              & 
