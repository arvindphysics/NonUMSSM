...
Real(dp) :: comp(3) 
Complex(dp) :: cplAhAhUhh(3,3,3),cplAhUhhhh(3,3,3),cplAhUhhVZ(3,3),cplAhUhhVZp(3,3),cplcChaChaUhhL(2,2,3),& 
...
Call GToParameters182(gA,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yv11,Yv22,Yv33,            & 
...
Call ParametersToG182(g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yv11,Yv22,Yv33,               & 
& Yu,Td,TYe11,TYe22,TYe33,Tlam,TYv11,TYv22,TYv33,Tu,mq2,ml012,ml022,ml032,               & 
& mHd2,mHu2,md2,mu2,me012,me022,me032,mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,              & 
& Tep,Tmup,gB)
...
TYe33 = Azero*Ye33
End If 
If (InputValueforTYv11) Then 
TYv11 = TYv11IN 
Else 
TYv11 = Azero*Yv11
End If 
If (InputValueforTYv22) Then 
TYv22 = TYv22IN 
Else 
TYv22 = Azero*Yv22
End If 
If (InputValueforTYv33) Then 
TYv33 = TYv33IN 
Else 
TYv33 = Azero*Yv33
End If 
...
If (ErrorLevel.gt.0) Call TerminateProgram 
End if 
If (Abs(Yv11).gt.3._dp) Then 
Write(*,*) "Non pertubative coupling at GUT scale Yv11" 
If (ErrorLevel.gt.0) Call TerminateProgram 
End if 
If (Abs(Yv22).gt.3._dp) Then 
Write(*,*) "Non pertubative coupling at GUT scale Yv22" 
If (ErrorLevel.gt.0) Call TerminateProgram 
End if 
If (Abs(Yv33).gt.3._dp) Then 
Write(*,*) "Non pertubative coupling at GUT scale Yv33" 
If (ErrorLevel.gt.0) Call TerminateProgram 
End if 
...
& ZDL,ZDR,ZE,ZEL,ZER,ZH,ZN,ZP,ZU,ZUL,ZUR,ZV,ZVL,ZVR,ZW,ZZ,betaH,vd,vu,vS,g1,             & 
...
& me032,mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,Tep,Tmup,delta0,gMZ,kont)
...
Complex(dp) :: cplcUFeFeAhL(3,3,3),cplcUFeFeAhR(3,3,3),cplcUFeChaSvL(3,2,6),cplcUFeChaSvR(3,2,6),    & 
...
& MVZp,g1,g2,gp,TW,TWp,UM,UP,vd,vu,Ye11,Ye22,Ye33,Yv11,Yv22,Yv33,ZA,ZE,ZEL,              & 
& ZER,ZH,ZN,ZP,ZV,ZVL,ZVR,delta)
...
& g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yv11,Yv22,Yv33,Yu,Td,TYe11,TYe22,TYe33,Tlam,            & 
& TYv11,TYv22,TYv33,Tu,mq2,ml012,ml022,ml032,mHd2,mHu2,md2,mu2,me012,me022,              & 
& me032,mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,Tep,Tmup,.True.)
...
Call CouplingsForSMfermions(Ye11,Ye22,Ye33,ZA,ZEL,ZER,g2,Yv11,Yv22,Yv33,              & 
& ZV,UM,UP,g1,gp,ZE,ZN,ZH,TW,TWp,ZVL,ZVR,ZP,Yd,ZDL,ZDR,Yu,ZU,ZD,g3,ZUL,ZUR,              & 
& pG,cplcUFeFeAhL,cplcUFeFeAhR,cplcUFeChaSvL,cplcUFeChaSvR,cplcUFeChiSeL,cplcUFeChiSeR,  & 
...
& cplcUFdFuVWmL,cplcUFdFuVWmR,cplcUFdGluSdL,cplcUFdGluSdR,cplcUFuFuAhL,cplcUFuFuAhR,     & 
& cplcUFuChiSuL,cplcUFuChiSuR,cplcUFuFdcHpmL,cplcUFuFdcHpmR,cplcUFuFdcVWmL,              & 
& cplcUFuFdcVWmR,cplcUFuFuhhL,cplcUFuFuhhR,cplcUFuFuVGL,cplcUFuFuVGR,cplcUFuFuVPL,       & 
& cplcUFuFuVPR,cplcUFuFuVZL,cplcUFuFuVZR,cplcUFuFuVZpL,cplcUFuFuVZpR,cplcUFuGluSuL,      & 
...
Call CalculateMSd(g1,g2,gp,Qq,QHd,QHu,Qd,Qs,Yd,Td,lam,mq2,md2,vd,vu,vS,               & 
& ZD,MSd,MSd2,kont)
...
& ZE,ZEL,ZER,ZH,ZN,ZP,ZU,ZUL,ZUR,ZV,ZVL,ZVR,ZW,ZZ,betaH,g1,g2,g3,gp,Yd,Ye11,             & 
& Ye22,Ye33,lam,Yv11,Yv22,Yv33,Yu,Td,TYe11,TYe22,TYe33,Tlam,TYv11,TYv22,TYv33,           & 
& Tu,mq2,ml012,ml022,ml032,mHd2,mHu2,md2,mu2,me012,me022,me032,mvR012,mvR022,            & 
& mvR032,ms2,M1,M2,M3,M4,Tep,Tmup,mGut,kont,WriteComment,niter)

Implicit None
Logical,Intent(in) :: WriteComment
Integer,Intent(inout) :: kont
Integer,Intent(in) :: niter
Real(dp) :: delta0,deltaG0, gA(182), gB(182)
Real(dp) :: gC(185),  gD(185) 
...
Real(dp) ::mass_new(41),mass_old(41),diff_m(41)
...
& mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,Tep,Tmup,delta0,gB,kont)
...
& Yu,Td,TYe11,TYe22,TYe33,Tlam,TYv11,TYv22,TYv33,Tu,mq2,ml012,ml022,ml032,               & 
& mHd2,mHu2,md2,mu2,me012,me022,me032,mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,              & 
& Tep,Tmup,vd,vu,vS,gC)

Call odeint(gC,185,tz,0._dp,0.1_dp*delta0,dt,0._dp,rge185,kont)
Call GToParameters185(gC,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yv11,Yv22,Yv33,            & 
& Yu,Td,TYe11,TYe22,TYe33,Tlam,TYv11,TYv22,TYv33,Tu,mq2,ml012,ml022,ml032,               & 
& mHd2,mHu2,md2,mu2,me012,me022,me032,mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,              & 
& Tep,Tmup,vd,vu,vS)
...
& Yu,Td,TYe11,TYe22,TYe33,Tlam,TYv11,TYv22,TYv33,Tu,mq2,ml012,ml022,ml032,               & 
& mHd2,mHu2,md2,mu2,me012,me022,me032,mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,              & 
& Tep,Tmup,vd,vu,vS,gD)

tz=Log(mZ/Q)
dt=-tz/50._dp
Call odeint(gD,185,tz,0._dp,0.1_dp*delta0,dt,0._dp,rge185,kont)
Call GToParameters185(gD,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yv11,Yv22,Yv33,            & 
& Yu,Td,TYe11,TYe22,TYe33,Tlam,TYv11,TYv22,TYv33,Tu,mq2,ml012,ml022,ml032,               & 
& mHd2,mHu2,md2,mu2,me012,me022,me032,mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,              & 
& Tep,Tmup,vd,vu,vS)
...
Real(dp),Intent(in)::delta0
Integer :: i1, i2, i3, i4 
Real(dp),Intent(inout)::g1A(182)
Real(dp),Intent(out)::g1C(182),mGUT
Real(dp)::tz,dt,t_out 
Real(dp)::mudim,gGUT,gA_h(182),g1b(182),m_hi,m_lo
Real(dp)::g1S(182)
...
dt=tz/100._dp
Call odeint(g1A,182,tz,0._dp,delta0,dt,0._dp,rge182,kont)
...
Call odeint(g1B,182,tz,0._dp,delta0,dt,0._dp,rge182,kont)
...
Call odeintB2(g1B,182,tz,0._dp,delta0,dt,0._dp,rge182,checkGUT182,t_out,kont)
...
dt=tz/100._dp
Call odeint(g1c,182,0._dp,tz,delta0,dt,0._dp,rge182,kont)
Iname=Iname-1
...
& TYv22,TYv33,Tu,mq2,ml012,ml022,ml032,mHd2,mHu2,md2,mu2,me012,me022,me032,              & 
& mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,Tep,Tmup,mGut,kont,WriteComment,niter)
...
Real(dp) ::mass_new(53),mass_old(53),diff_m(53)
...
Real(dp),Intent(out)::g1C(182),mGUT
Real(dp)::tz,dt,t_out 
Real(dp)::mudim,gGUT,gA_h(182),m_hi,m_lo
Real(dp)::g1B(182)
Real(dp)::g1S(182)
Logical :: FoundUnification, unified, greater 
...
Subroutine checkGUT182(y,eps,unified,greater)  
Implicit None 
Real(dp), Intent(in) :: y(182), eps 
...
Call GToParameters182(y,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yv11,Yv22,Yv33,             & 
& Yu,Td,TYe11,TYe22,TYe33,Tlam,TYv11,TYv22,TYv33,Tu,mq2,ml012,ml022,ml032,               & 
& mHd2,mHu2,md2,mu2,me012,me022,me032,mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,Tep,Tmup)
...
Real(dp):: gA(182), gB(182), Scale_Save 
...
Iname=Iname-1 
    ...
    Call TerminateProgram
End if 
Call GToParameters182(gB,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yv11,Yv22,Yv33,            & 
& Yu,Td,TYe11,TYe22,TYe33,Tlam,TYv11,TYv22,TYv33,Tu,mq2,ml012,ml022,ml032,               & 
& mHd2,mHu2,md2,mu2,me012,me022,me032,mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,Tep,Tmup)
...
End Module Boundaries_NonUMSSMv4 
