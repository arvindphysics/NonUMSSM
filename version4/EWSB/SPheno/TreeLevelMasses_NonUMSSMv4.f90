...
Module TreeLevelMasses_NonUMSSMv4 
...
& mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,Tep,Tmup,GenerationMixing,kont)
...
Complex(dp) :: MGluC 
Iname = Iname + 1 
NameOfUnit(Iname) = 'TreeMassesNonUMSSMv4'
...
Call CalculateMSv(g1,g2,gp,Ql1,Ql2,Ql3,QHd,QHu,Qv1,Qv2,Qv3,Qs,lam,Yv11,               & 
& TYv11,Yv22,TYv22,Yv33,TYv33,ml012,ml022,ml032,mvR012,mvR022,mvR032,vd,vu,              & 
& vS,ZV,MSv,MSv2,kont)

Call CalculateMFv(Yv11,Yv22,Yv33,vu,ZVL,ZVR,MFv,kont)
...
& vd,vu,vS,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yv11,Yv22,Yv33,Yu,Td,TYe11,TYe22,           & 
& TYe33,Tlam,TYv11,TYv22,TYv33,Tu,mq2,ml012,ml022,ml032,mHd2,mHu2,md2,mu2,               & 
& me012,me022,me032,mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,Tep,Tmup,kont)
...
& me032,mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,Tep,Tmup,GenerationMixing,kont)
...
End if
! ------------------------------- 
Call CalculateMSdEffPot(g1,g2,gp,Qq,QHd,QHu,Qd,Qs,Yd,Td,lam,mq2,md2,vd,               & 
& vu,vS,ZD,MSd,MSd2,kont)

Call CalculateMSvEffPot(g1,g2,gp,Ql1,Ql2,Ql3,QHd,QHu,Qv1,Qv2,Qv3,Qs,lam,              & 
& Yv11,TYv11,Yv22,TYv22,Yv33,TYv33,ml012,ml022,ml032,mvR012,mvR022,mvR032,               & 
& vd,vu,vS,ZV,MSv,MSv2,kont)

Call CalculateMFvEffPot(Yv11,Yv22,Yv33,vu,ZVL,ZVR,MFv,kont)
...
Subroutine CalculateMSd(g1,g2,gp,Qq,QHd,QHu,Qd,Qs,Yd,Td,lam,mq2,md2,vd,               & 
& vu,vS,ZD,MSd,MSd2,kont)
...
Subroutine CalculateMSv(g1,g2,gp,Ql1,Ql2,Ql3,QHd,QHu,Qv1,Qv2,Qv3,Qs,lam,              & 
& Yv11,TYv11,Yv22,TYv22,Yv33,TYv33,ml012,ml022,ml032,mvR012,mvR022,mvR032,               & 
& vd,vu,vS,ZV,MSv,MSv2,kont)
...
mat(1,1) = mat(1,1)+(vu**2*Yv11*Conjg(Yv11))/2._dp
mat(1,2) = 0._dp 
mat(1,3) = 0._dp 
mat(1,4) = 0._dp 
mat(1,4) = mat(1,4)-(vd*vS*lam*Conjg(Yv11))/2._dp
mat(1,4) = mat(1,4)+(vu*Conjg(TYv11))/sqrt(2._dp)
mat(1,5) = 0._dp 
mat(1,6) = 0._dp 
mat(2,2) = 0._dp 
...
mat(2,2) = mat(2,2)+(vu**2*Yv22*Conjg(Yv22))/2._dp
mat(2,3) = 0._dp 
mat(2,4) = 0._dp 
mat(2,5) = 0._dp 
mat(2,5) = mat(2,5)-(vd*vS*lam*Conjg(Yv22))/2._dp
mat(2,5) = mat(2,5)+(vu*Conjg(TYv22))/sqrt(2._dp)
mat(2,6) = 0._dp 
mat(3,3) = 0._dp 
...
mat(3,3) = mat(3,3)+(vu**2*Yv33*Conjg(Yv33))/2._dp
mat(3,4) = 0._dp 
mat(3,5) = 0._dp 
mat(3,6) = 0._dp 
mat(3,6) = mat(3,6)-(vd*vS*lam*Conjg(Yv33))/2._dp
mat(3,6) = mat(3,6)+(vu*Conjg(TYv33))/sqrt(2._dp)
mat(4,4) = 0._dp 
mat(4,4) = mat(4,4)+mvR012
mat(4,4) = mat(4,4)+(gp**2*QHd*Qv1*vd**2)/2._dp
mat(4,4) = mat(4,4)+(gp**2*Qs*Qv1*vS**2)/2._dp
mat(4,4) = mat(4,4)+(gp**2*QHu*Qv1*vu**2)/2._dp
mat(4,4) = mat(4,4)+(vu**2*Yv11*Conjg(Yv11))/2._dp
mat(4,5) = 0._dp 
mat(4,6) = 0._dp 
mat(5,5) = 0._dp 
mat(5,5) = mat(5,5)+mvR022
mat(5,5) = mat(5,5)+(gp**2*QHd*Qv2*vd**2)/2._dp
mat(5,5) = mat(5,5)+(gp**2*Qs*Qv2*vS**2)/2._dp
mat(5,5) = mat(5,5)+(gp**2*QHu*Qv2*vu**2)/2._dp
mat(5,5) = mat(5,5)+(vu**2*Yv22*Conjg(Yv22))/2._dp
mat(5,6) = 0._dp 
mat(6,6) = 0._dp 
mat(6,6) = mat(6,6)+mvR032
mat(6,6) = mat(6,6)+(gp**2*QHd*Qv3*vd**2)/2._dp
mat(6,6) = mat(6,6)+(gp**2*Qs*Qv3*vS**2)/2._dp
mat(6,6) = mat(6,6)+(gp**2*QHu*Qv3*vu**2)/2._dp
mat(6,6) = mat(6,6)+(vu**2*Yv33*Conjg(Yv33))/2._dp
...
Subroutine CalculateMFv(Yv11,Yv22,Yv33,vu,ZVL,ZVR,MFv,kont)
...
ZVR = 0._dp 
mat(1,1) = 0._dp 
mat(1,1) = mat(1,1)+(vu*Yv11)/sqrt(2._dp)
mat(1,2) = 0._dp 
mat(1,3) = 0._dp 
mat(2,1) = 0._dp 
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)+(vu*Yv22)/sqrt(2._dp)
mat(2,3) = 0._dp 
mat(3,1) = 0._dp 
mat(3,2) = 0._dp 
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+(vu*Yv33)/sqrt(2._dp)
...
Subroutine CalculateMSvEffPot(g1,g2,gp,Ql1,Ql2,Ql3,QHd,QHu,Qv1,Qv2,Qv3,               & 
& Qs,lam,Yv11,TYv11,Yv22,TYv22,Yv33,TYv33,ml012,ml022,ml032,mvR012,mvR022,               & 
& mvR032,vd,vu,vS,ZV,MSv,MSv2,kont)
...
mat(4,4) = 0._dp 
mat(4,4) = mat(4,4)+mvR012
mat(4,4) = mat(4,4)+(gp**2*QHd*Qv1*vdFix**2)/2._dp
mat(4,4) = mat(4,4)+(gp**2*Qs*Qv1*vSFix**2)/2._dp
mat(4,4) = mat(4,4)+(gp**2*QHu*Qv1*vuFix**2)/2._dp
mat(4,4) = mat(4,4)+(vu**2*Yv11*Conjg(Yv11))/2._dp
mat(4,5) = 0._dp 
mat(4,6) = 0._dp 
mat(5,5) = 0._dp 
mat(5,5) = mat(5,5)+mvR022
mat(5,5) = mat(5,5)+(gp**2*QHd*Qv2*vdFix**2)/2._dp
mat(5,5) = mat(5,5)+(gp**2*Qs*Qv2*vSFix**2)/2._dp
mat(5,5) = mat(5,5)+(gp**2*QHu*Qv2*vuFix**2)/2._dp
mat(5,5) = mat(5,5)+(vu**2*Yv22*Conjg(Yv22))/2._dp
mat(5,6) = 0._dp 
mat(6,6) = 0._dp 
mat(6,6) = mat(6,6)+mvR032
mat(6,6) = mat(6,6)+(gp**2*QHd*Qv3*vdFix**2)/2._dp
mat(6,6) = mat(6,6)+(gp**2*Qs*Qv3*vSFix**2)/2._dp
mat(6,6) = mat(6,6)+(gp**2*QHu*Qv3*vuFix**2)/2._dp
mat(6,6) = mat(6,6)+(vu**2*Yv33*Conjg(Yv33))/2._dp
...
Subroutine CalculateMFvEffPot(Yv11,Yv22,Yv33,vu,ZVL,ZVR,MFv,kont)
...
& g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yv11,Yv22,Yv33,Yu,Td,TYe11,TYe22,TYe33,              & 
& Tlam,TYv11,TYv22,TYv33,Tu,mq2,ml012,ml022,ml032,mHd2,mHu2,md2,mu2,me012,               & 
& me022,me032,mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,Tep,Tmup,GenerationMixing,kont)
...
End Module TreeLevelMasses_NonUMSSMv4 
