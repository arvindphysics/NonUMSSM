...
! ------------------------------------------------------------------------------  
! File created at 16:06 on 21.3.2021   
! ----------------------------------------------------------------------  
 
 
Module LowEnergy_NonUMSSMv4 
Use Control 
Use Settings 
...
Use LoopFunctions 
Use LoopMasses_NonUMSSMv4 
Use StandardModel 
Use RunSM_NonUMSSMv4
Use FlavorKit_LFV_NonUMSSMv4
Use FlavorKit_QFV_NonUMSSMv4
Use FlavorKit_Observables_NonUMSSMv4
...
& MFv2(3),Mhh(3),Mhh2(3),MHpm(2),MHpm2(2),MSe(6),MSe2(6),MSv(6),MSv2(6),MVZp,MVZp2

Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplcFeChaSvL(3,2,6),cplcFeChaSvR(3,2,6),        & 
...
Implicit None
Real(dp),Intent(in)  :: MAh(3),MAh2(3),MCha(2),MCha2(2),MChi(6),MChi2(6),MFe(3),MFe2(3),MFv(3),               & 
& MFv2(3),Mhh(3),Mhh2(3),MHpm(2),MHpm2(2),MSe(6),MSe2(6),MSv(6),MSv2(6),MVWm,            & 
...
& cplSecSeVZ(6,6),cplSucSuVZ(6,6),cplSvcSvVZ(6,6),cplcVWmVWmVZ,cplAhAhVZVZ(3,3),         & 
...
& cplhhHpmcVWm(3,2),cplhhcVWmVWm(3),cplSdcSucVWm(6,6),cplSecSvcVWm(6,6),cplAhAhcVWmVWm(3,3),& 
...
& Ydinput,Ye11input,Ye22input,Ye33input,laminput,Yv11input,Yv22input,Yv33input,          & 
& Yuinput,Tdinput,TYe11input,TYe22input,TYe33input,Tlaminput,TYv11input,TYv22input,      & 
& TYv33input,Tuinput,mq2input,ml012input,ml022input,ml032input,mHd2input,mHu2input,      & 
& md2input,mu2input,me012input,me022input,me032input,mvR012input,mvR022input,            & 
& mvR032input,ms2input,M1input,M2input,M3input,M4input,Tepinput,Tmupinput,               & 
...
Real(dp),Intent(inout) :: g1input,g2input,g3input,gpinput,ml012input,ml022input,ml032input,mHd2input,           & 
& mHu2input,me012input,me022input,me032input,mvR012input,mvR022input,mvR032input,        & 
& ms2input,vdinput,vuinput,vSinput

Complex(dp),Intent(inout) :: Ydinput(3,3),Ye11input,Ye22input,Ye33input,laminput,Yv11input,Yv22input,              & 
...
& cplAhAhVZVZp(3,3),cplAhcHpmVWm(3,2),cplAhhhhh(3,3,3),cplAhhhVZ(3,3),cplAhhhVZp(3,3),   & 
& cplAhHpmcHpm(3,2,2),cplAhHpmcVWm(3,2),cplAhSdcSd(3,6,6),cplAhSecSe(3,6,6),             & 
& cplAhSucSu(3,6,6),cplAhSvcSv(3,6,6),cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),         & 
...
& cplChiFvcSvR(6,3,6),cplcHpmVPVWm(2),cplcHpmVWmVZ(2),cplcHpmVWmVZp(2),cplcVWmcVWmVWmVWm1,& 
...
& cplhhSucSu(3,6,6),cplhhSvcSv(3,6,6),cplhhVZpVZp(3),cplhhVZVZ(3),cplhhVZVZp(3),         & 
...
& Ye11input,Ye22input,Ye33input,laminput,Yv11input,Yv22input,Yv33input,Yuinput,          & 
& Tdinput,TYe11input,TYe22input,TYe33input,Tlaminput,TYv11input,TYv22input,              & 
& TYv33input,Tuinput,mq2input,ml012input,ml022input,ml032input,mHd2input,mHu2input,      & 
& md2input,mu2input,me012input,me022input,me032input,mvR012input,mvR022input,            & 
& mvR032input,ms2input,M1input,M2input,M3input,M4input,Tepinput,Tmupinput,               & 
& vdinput,vuinput,vSinput,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yv11,Yv22,Yv33,              & 
...
& Tep,Tmup,vd,vu,vS,CKM_160,sinW2_160,Alpha_160,AlphaS_160,.false.)
...
MHpm(1)=MVWm
MHpm2(1)=MVWm2
Call AllCouplings(lam,Tlam,ZA,g1,g2,gp,vd,vu,vS,ZH,ZP,Yd,Td,ZD,Ye11,TYe11,            & 
& Ye22,TYe22,Ye33,TYe33,Tep,Tmup,ZE,Yu,Tu,ZU,Yv11,TYv11,Yv22,TYv22,Yv33,TYv33,           & 
& ZV,TW,TWp,g3,UM,UP,ZN,ZDL,ZDR,ZEL,ZER,ZUL,ZUR,ZVL,ZVR,pG,cplAhAhAh,cplAhAhhh,          & 
& cplAhhhhh,cplAhHpmcHpm,cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplAhSvcSv,cplhhhhhh,          & 
...
& cplChiChiVZpL,cplChiChiVZpR,cplcChaChiVWmL,cplcChaChiVWmR,cplcFdFdVGL,cplcFdFdVGR,     & 
...
& cplcFeFeVZpL,cplcFeFeVZpR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFuFuVGL,cplcFuFuVGR,         & 
& cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,             & 
& cplcFuFuVZpL,cplcFuFuVZpR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,           & 
& cplcFvFvVZpL,cplcFvFvVZpR,cplGluGluVGL,cplGluGluVGR)
...
& Ye22input,Ye33input,laminput,Yv11input,Yv22input,Yv33input,Yuinput,Tdinput,            & 
& TYe11input,TYe22input,TYe33input,Tlaminput,TYv11input,TYv22input,TYv33input,           & 
& Tuinput,mq2input,ml012input,ml022input,ml032input,mHd2input,mHu2input,md2input,        & 
& mu2input,me012input,me022input,me032input,mvR012input,mvR022input,mvR032input,         & 
& ms2input,M1input,M2input,M3input,M4input,Tepinput,Tmupinput,vdinput,vuinput,           & 
& vSinput,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yv11,Yv22,Yv33,Yu,Td,TYe11,TYe22,            & 
...
& g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yv11,Yv22,Yv33,Yu,Td,TYe11,TYe22,TYe33,Tlam,            & 
& TYv11,TYv22,TYv33,Tu,mq2,ml012,ml022,ml032,mHd2,mHu2,md2,mu2,me012,me022,              & 
& me032,mvR012,mvR022,mvR032,ms2,M1,M2,M3,M4,Tep,Tmup,.False.)
...
End Module LowEnergy_NonUMSSMv4 
