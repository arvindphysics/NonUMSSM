...
! ------------------------------------------------------------------------------  
! File created at 15:56 on 21.3.2021   
! ----------------------------------------------------------------------  
 
 
Module LoopCouplings_NonUMSSMv4 
...
& MSv,MVWm,MVZp,g1,g2,gp,TW,TWp,UM,UP,vd,vu,Ye11,Ye22,Ye33,Yv11,Yv22,Yv33,               & 
& ZA,ZE,ZEL,ZER,ZH,ZN,ZP,ZV,ZVLinput,ZVR,res)

Implicit None 
Real(dp),Intent(in) :: MAh(3),MCha(2),MChi(6),MFe(3),MFv(3),Mhh(3),MHpm(2),MSe(6),MSv(6),MVWm,               & 
& MVZp,g1,g2,gp,TW,TWp,vd,vu,ZP(2,2)

Complex(dp),Intent(in) :: UM(2,2),UP(2,2),Ye11,Ye22,Ye33,Yv11,Yv22,Yv33,ZA(3,3),ZE(6,6),ZEL(3,3),               & 
& ZER(3,3),ZH(3,3),ZN(6,6),ZV(6,6),ZVLinput(3,3),ZVR(3,3)

Real(dp) :: MAh2(3),MCha2(2),MChi2(6),MFe2(3),MFv2(3),Mhh2(3),MHpm2(2),MSe2(6),MSv2(6),           & 
& MVWm2,MVZp2

Complex(dp) :: cplAhcHpmVWm(3,2),cplcChacFvSeL(2,3,6),cplcChacFvSeR(2,3,6),cplcChaChiVWmL(2,6),      & 
& cplcChaChiVWmR(2,6),cplcChaFecSvL(2,3,6),cplcChaFecSvR(2,3,6),cplcFeChaSvL(3,2,6),     & 
...
& cplcFeFvVWmR(3,3),cplcFvChiSvL(3,6,6),cplcFvChiSvR(3,6,6),cplcFvFecHpmL(3,3,2),        & 
& cplcFvFecHpmR(3,3,2),cplcFvFvAhL(3,3,3),cplcFvFvAhR(3,3,3),cplcFvFvhhL(3,3,3),         & 
& cplcFvFvhhR(3,3,3),cplcFvFvVZpL(3,3),cplcFvFvVZpR(3,3),cplChaFvcSeL(2,3,6),            & 
& cplChaFvcSeR(2,3,6),cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6),cplChiFvcSvL(6,3,6),       & 
& cplChiFvcSvR(6,3,6),cplcHpmVWmVZp(2),cplcVWmVWmVZp,cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),  & 
& cplSvcSeVWm(6,6)
...
End Module LoopCouplings_NonUMSSMv4 
