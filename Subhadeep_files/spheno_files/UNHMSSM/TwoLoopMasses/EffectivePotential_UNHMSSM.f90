Module EffectivePotential_UNHMSSM 
...
Call SecondDerivativeEffPot2Loop(vd,vu,vS,g1,g2,g3,gp,Yd,y12,y3,lam,Yu,               & 
& Td,Ty12,Ty3,Tlam,Tu,mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,ml12l32,           & 
& M1,M2,M3,M4,Tdp,Tep,kont,pi_ep2L,ti_ep2L)
...
Real(dp) Function EffPotFunction(vevs) 
  ...
  Real(dp) :: effPot 
Call CalculateEffPot(vevs(1),vevs(2),vevs(3),g1,g2,g3,gp,Yd,y12,y3,lam,               & 
& Yu,Td,Ty12,Ty3,Tlam,Tu,mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,ml12l32,        & 
& M1,M2,M3,M4,Tdp,Tep,kont,effPot)
...
Real(dp) Function EffPotFunction2Loop(vevs) 
  ...
  Real(dp), Intent(in) :: vevs(3) 
  Real(dp) :: effPot2L 
Call CalculateEffPot2Loop(vevs(1),vevs(2),vevs(3),g1,g2,g3,gp,Yd,y12,y3,              & 
& lam,Yu,Td,Ty12,Ty3,Tlam,Tu,mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,            & 
& ml12l32,M1,M2,M3,M4,Tdp,Tep,kont,effPot2L)
...
Subroutine CalculateEffPot(vd,vu,vS,g1,g2,g3,gp,Yd,y12,y3,lam,Yu,Td,Ty12,             & 
& Ty3,Tlam,Tu,mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,ml12l32,M1,M2,             & 
& M3,M4,Tdp,Tep,kont,effPot)
...
Subroutine CalculateEffPot2Loop(vd,vu,vS,g1,g2,g3,gp,Yd,y12,y3,lam,Yu,Td,             & 
...
& me32,ms2,ml12l32,M1,M2,M3,M4,Tdp,Tep,.True.,kont)

Call CouplingsForEffPot3(lam,Tlam,vd,vu,vS,ZH,ZA,ZP,Yd,Td,Tdp,ZD,y12,Ty12,            & 
& y3,Ty3,Tep,ZE,Yu,Tu,ZU,ZV,g3,UM,UP,ZN,ZDL,ZDR,ZEL,ZER,ZUL,ZUR,ZVL,pG,cplAhAhhh,        & 
...
Call CouplingsForEffPot4(lam,ZA,ZH,ZP,Yd,ZD,y12,y3,ZE,Yu,ZU,ZV,g3,cplAhAhAhAh,        & 
...
Subroutine SecondDerivativeEffPot2Loop(vd,vu,vS,g1,g2,g3,gp,Yd,y12,y3,lam,            & 
& Yu,Td,Ty12,Ty3,Tlam,Tu,mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,ml12l32,        & 
& M1,M2,M3,M4,Tdp,Tep,kont,pi2L,ti2L)
...
Do i1=1,3
Call FirstDerivativeMassesCoups(i1,vd,vu,vS,g1,g2,g3,gp,Yd,y12,y3,lam,Yu,             & 
& Td,Ty12,Ty3,Tlam,Tu,mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,ml12l32,           & 
...
Do i1=1,3
  Do i2=i1,3
Call SecondDerivativeMassesCoups(i1,i2,vd,vu,vS,g1,g2,g3,gp,Yd,y12,y3,lam,            & 
& Yu,Td,Ty12,Ty3,Tlam,Tu,mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,ml12l32,        & 
& M1,M2,M3,M4,Tdp,Tep,gout)
...
Subroutine FirstDerivativeEffPot2Loop(vd,vu,vS,g1,g2,g3,gp,Yd,y12,y3,lam,             & 
& Yu,Td,Ty12,Ty3,Tlam,Tu,mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,ml12l32,        & 
& M1,M2,M3,M4,Tdp,Tep,kont,ti2L)
...
Subroutine SecondDerivativeMassesCoups(i1,i2,vd,vu,vS,g1,g2,g3,gp,Yd,y12,             & 
& y3,lam,Yu,Td,Ty12,Ty3,Tlam,Tu,mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,             & 
& ms2,ml12l32,M1,M2,M3,M4,Tdp,Tep,gout)
...
Subroutine FirstDerivativeMassesCoups(i1,vd,vu,vS,g1,g2,g3,gp,Yd,y12,y3,              & 
& lam,Yu,Td,Ty12,Ty3,Tlam,Tu,mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,            & 
& ml12l32,M1,M2,M3,M4,Tdp,Tep,gout)
...
vu=vevs(2) 
vS=vevs(3) 
Call WrapperForDerivatives(vd,vu,vS,g1,g2,g3,gp,Yd,y12,y3,lam,Yu,Td,Ty12,             & 
& Ty3,Tlam,Tu,mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,ml12l32,M1,M2,             & 
& M3,M4,Tdp,Tep,gout)

End Subroutine 

Subroutine WrapperForDerivatives(vd,vu,vS,g1,g2,g3,gp,Yd,y12,y3,lam,Yu,               & 
& Td,Ty12,Ty3,Tlam,Tu,mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,ml12l32,           & 
& M1,M2,M3,M4,Tdp,Tep,gout)
...
End Module EffectivePotential_UNHMSSM 
