...
InputValueforYd= .True. 
   ...
   Else If (read_line(7:11).Eq."Y12IN") Then 
InputValuefory12= .True. 
    Call ReadMatrixC(99,2,2,y12IN,0, "y12IN",kont)

 
   Else If (read_line(7:13).Eq."IMY12IN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMy12") 
       Cycle 
     End If 
    Call ReadMatrixC(99,2,2,y12IN,1, "y12IN",kont)
...
InputValueforTd= .True. 
   ...
   Else If (read_line(7:12).Eq."TY12IN") Then 
InputValueforTy12= .True. 
    Call ReadMatrixC(99,2,2,Ty12IN,0, "Ty12IN",kont)

 
   Else If (read_line(7:14).Eq."IMTY12IN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMTy12") 
       Cycle 
     End If 
    Call ReadMatrixC(99,2,2,Ty12IN,1, "Ty12IN",kont)
...
InputValueformq2= .True. 
   ...
   Else If (read_line(7:13).Eq."ML122IN") Then 
InputValueforml122= .True. 
    Call ReadMatrixC(99,2,2,ml122IN,0, "ml122IN",kont)

 
   Else If (read_line(7:15).Eq."IMML122IN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMml122") 
       Cycle 
     End If 
    Call ReadMatrixC(99,2,2,ml122IN,1, "ml122IN",kont)
...
InputValueformu2= .True. 
   ...
   Else If (read_line(7:13).Eq."ME122IN") Then 
InputValueforme122= .True. 
    Call ReadMatrixC(99,2,2,me122IN,0, "me122IN",kont)

 
   Else If (read_line(7:15).Eq."IMME122IN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMme122") 
       Cycle 
     End If 
    Call ReadMatrixC(99,2,2,me122IN,1, "me122IN",kont)

 
   Else If (read_line(7:15).Eq."ML12L32IN") Then 
InputValueforml12l32= .True. 
    Call ReadVectorR(99,2,ml12l32IN, "ml12l32IN",kont)
...
InputValueforTep= .True. 
   ...
   Else If (read_line(7:10).Eq."Y3IN") Then 
    Call Read_y3IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:12).Eq."IMY3IN") Then 
    Call Read_y3IN(99,1,i_model,set_mod_par,kont) 
   ...
   Else If (read_line(7:11).Eq."TY3IN") Then 
    Call Read_TY3IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."IMTY3IN") Then 
    Call Read_TY3IN(99,1,i_model,set_mod_par,kont) 
...
Write(io_L,100) "# SUSY Les Houches Accord 2 - UNHMSSM Spectrum + Decays + Flavor Observables"
...
End if 
If (Abs(Real(Ql,dp)).gt.0._dp) Then 
Write(io_L,101) 72, Real(Ql,dp) ,"# Ql"
End if 
If (Abs(Real(QHu,dp)).gt.0._dp) Then 
Write(io_L,101) 73, Real(QHu,dp) ,"# QHu"
End if 
If (Abs(Real(QHd,dp)).gt.0._dp) Then 
Write(io_L,101) 74, Real(QHd,dp) ,"# QHd"
End if 
If (Abs(Real(Qd,dp)).gt.0._dp) Then 
Write(io_L,101) 75, Real(Qd,dp) ,"# Qd"
End if 
If (Abs(Real(Qu,dp)).gt.0._dp) Then 
Write(io_L,101) 76, Real(Qu,dp) ,"# Qu"
End if 
If (Abs(Real(Qe12,dp)).gt.0._dp) Then 
Write(io_L,101) 77, Real(Qe12,dp) ,"# Qe12"
End if 
If (Abs(Real(Qe3,dp)).gt.0._dp) Then 
Write(io_L,101) 78, Real(Qe3,dp) ,"# Qe3"
End if 
If (Abs(Real(Qs,dp)).gt.0._dp) Then 
Write(io_L,101) 79, Real(Qs,dp) ,"# Qs"
End if 
End if 
WriteNextBlock = .false. 
If(WriteNextBlock) Then 
...
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block Y3 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(y3,dp), "# y3" 
If (Abs(Aimag(y3)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMY3 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(y3), "# y3" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
...
Write(io_L,104) 6,Real(ml32,dp), "# ml32" 
Write(io_L,104) 5,Real(me32,dp), "# me32" 
Write(io_L,104) 4,Real(ms2,dp), "# ms2" 
Write(io_L,104) 3,Real(vS,dp), "# vS" 
Write(io_L,104) 3,Real(vS,dp), "# vS" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block TY3 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(Ty3,dp), "# Ty3" 
If (Abs(Aimag(Ty3)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMTY3 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(Ty3), "# Ty3" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
...
End if 
If (WriteSLHA1) Then 
Write(io_L,104)  31,  Real(sqrt(ml122(1,1)),dp), " # mL(1,1) " 
Write(io_L,104)  32,  Real(sqrt(ml122(2,2)),dp), " # mL(2,2)" 
Write(io_L,104)  33,  Real(sqrt(ml32),dp), " # mL(3,3)" 
Write(io_L,104)  34,  Real(sqrt(me122(1,1)),dp), " # mE(1,1)" 
Write(io_L,104)  35,  Real(sqrt(me122(2,2)),dp), " # mE(2,2)" 
Write(io_L,104)  36,  Real(sqrt(me32),dp), " # mE(3,3)" 
...
Write(io_L,104) 2,Real(Ql,dp), "# Ql" 
Write(io_L,104) 4,Real(QHd,dp), "# QHd" 
Write(io_L,104) 3,Real(QHu,dp), "# QHu" 
Write(io_L,104) 5,Real(Qd,dp), "# Qd" 
Write(io_L,104) 6,Real(Qu,dp), "# Qu" 
Write(io_L,104) 7,Real(Qe12,dp), "# Qe12" 
Write(io_L,104) 8,Real(Qe3,dp), "# Qe3" 
...
Write(io_L,106) "Block Y12 Q=",Q,"# (SUSY Scale)" 
Write(io_L,107)1,1,Real(y12(1,1),dp), "# Real(y12(1,1),dp)" 
Write(io_L,107)1,2,Real(y12(1,2),dp), "# Real(y12(1,2),dp)" 
Write(io_L,107)2,1,Real(y12(2,1),dp), "# Real(y12(2,1),dp)" 
Write(io_L,107)2,2,Real(y12(2,2),dp), "# Real(y12(2,2),dp)" 
If ((MaxVal(Abs(AImag(y12))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMY12 Q=",Q,"# (SUSY Scale)" 
Write(io_L,107)1,1,Aimag(y12(1,1)), "# Aimag(y12(1,1))" 
Write(io_L,107)1,2,Aimag(y12(1,2)), "# Aimag(y12(1,2))" 
Write(io_L,107)2,1,Aimag(y12(2,1)), "# Aimag(y12(2,1))" 
Write(io_L,107)2,2,Aimag(y12(2,2)), "# Aimag(y12(2,2))" 
End If 
...
Write(io_L,106) "Block TY12 Q=",Q,"# (SUSY Scale)" 
Write(io_L,107)1,1,Real(Ty12(1,1),dp), "# Real(Ty12(1,1),dp)" 
Write(io_L,107)1,2,Real(Ty12(1,2),dp), "# Real(Ty12(1,2),dp)" 
Write(io_L,107)2,1,Real(Ty12(2,1),dp), "# Real(Ty12(2,1),dp)" 
Write(io_L,107)2,2,Real(Ty12(2,2),dp), "# Real(Ty12(2,2),dp)" 
If ((MaxVal(Abs(AImag(Ty12))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMTY12 Q=",Q,"# (SUSY Scale)" 
Write(io_L,107)1,1,Aimag(Ty12(1,1)), "# Aimag(Ty12(1,1))" 
Write(io_L,107)1,2,Aimag(Ty12(1,2)), "# Aimag(Ty12(1,2))" 
Write(io_L,107)2,1,Aimag(Ty12(2,1)), "# Aimag(Ty12(2,1))" 
Write(io_L,107)2,2,Aimag(Ty12(2,2)), "# Aimag(Ty12(2,2))" 
End If 
...
Write(io_L,106) "Block ML122 Q=",Q,"# (SUSY Scale)" 
Write(io_L,107)1,1,Real(ml122(1,1),dp), "# Real(ml122(1,1),dp)" 
Write(io_L,107)1,2,Real(ml122(1,2),dp), "# Real(ml122(1,2),dp)" 
Write(io_L,107)2,1,Real(ml122(2,1),dp), "# Real(ml122(2,1),dp)" 
Write(io_L,107)2,2,Real(ml122(2,2),dp), "# Real(ml122(2,2),dp)" 
If ((MaxVal(Abs(AImag(ml122))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMML122 Q=",Q,"# (SUSY Scale)" 
Write(io_L,107)1,1,Aimag(ml122(1,1)), "# Aimag(ml122(1,1))" 
Write(io_L,107)1,2,Aimag(ml122(1,2)), "# Aimag(ml122(1,2))" 
Write(io_L,107)2,1,Aimag(ml122(2,1)), "# Aimag(ml122(2,1))" 
Write(io_L,107)2,2,Aimag(ml122(2,2)), "# Aimag(ml122(2,2))" 
End If 
...
Write(io_L,106) "Block ME122 Q=",Q,"# (SUSY Scale)" 
Write(io_L,107)1,1,Real(me122(1,1),dp), "# Real(me122(1,1),dp)" 
Write(io_L,107)1,2,Real(me122(1,2),dp), "# Real(me122(1,2),dp)" 
Write(io_L,107)2,1,Real(me122(2,1),dp), "# Real(me122(2,1),dp)" 
Write(io_L,107)2,2,Real(me122(2,2),dp), "# Real(me122(2,2),dp)" 
If ((MaxVal(Abs(AImag(me122))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMME122 Q=",Q,"# (SUSY Scale)" 
Write(io_L,107)1,1,Aimag(me122(1,1)), "# Aimag(me122(1,1))" 
Write(io_L,107)1,2,Aimag(me122(1,2)), "# Aimag(me122(1,2))" 
Write(io_L,107)2,1,Aimag(me122(2,1)), "# Aimag(me122(2,1))" 
Write(io_L,107)2,2,Aimag(me122(2,2)), "# Aimag(me122(2,2))" 
End If 

Write(io_L,106) "Block ML12L32 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,ml12l32(1), "# ml12l32(1) " 
Write(io_L,104) 2,ml12l32(2), "# ml12l32(2) " 
...
Write(io_L,106) "Block AE Q=",Q," # " 
 Write(io_L,107) 1, 1, Real(Ty12(1,1),dp)/Real(Y12(1,1),dp),"# Te(1,1)/Ye(1,1) " 
Write(io_L,107) 2, 2, Real(Ty12(2,2),dp)/Real(Y12(2,2),dp),"# Te(2,2)/Ye(2,2) " 
Write(io_L,107) 3, 3, Real(Ty3,dp)/Real(Y3,dp),"# Te(3,3)/Ye(3,3) " 
End if 
...
Write(io_L,104) 1,Real(y3GUT,dp), "# y3" 
Write(io_L,106) "Block NPGUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(lamGUT,dp), "# lam" 
Write(io_L,104) 2,Real(TlamGUT,dp), "# Tlam" 
Write(io_L,104) 6,Real(ml32GUT,dp), "# ml32" 
Write(io_L,104) 5,Real(me32GUT,dp), "# me32" 
Write(io_L,104) 4,Real(ms2GUT,dp), "# ms2" 
Write(io_L,106) "Block TY3GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(Ty3GUT,dp), "# Ty3" 
...
Write(io_L,106) "Block y12GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Real(y12GUT(1,1),dp), "# Real(y12GUT(1,1),dp)" 
Write(io_L,107)1,2,Real(y12GUT(1,2),dp), "# Real(y12GUT(1,2),dp)" 
Write(io_L,107)2,1,Real(y12GUT(2,1),dp), "# Real(y12GUT(2,1),dp)" 
Write(io_L,107)2,2,Real(y12GUT(2,2),dp), "# Real(y12GUT(2,2),dp)" 
If ((MaxVal(Abs(AImag(y12GUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMy12GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(y12GUT(1,1)), "# Aimag(y12GUT(1,1))" 
Write(io_L,107)1,2,Aimag(y12GUT(1,2)), "# Aimag(y12GUT(1,2))" 
Write(io_L,107)2,1,Aimag(y12GUT(2,1)), "# Aimag(y12GUT(2,1))" 
Write(io_L,107)2,2,Aimag(y12GUT(2,2)), "# Aimag(y12GUT(2,2))" 
End If 
...
Write(io_L,106) "Block Ty12GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Real(Ty12GUT(1,1),dp), "# Real(Ty12GUT(1,1),dp)" 
Write(io_L,107)1,2,Real(Ty12GUT(1,2),dp), "# Real(Ty12GUT(1,2),dp)" 
Write(io_L,107)2,1,Real(Ty12GUT(2,1),dp), "# Real(Ty12GUT(2,1),dp)" 
Write(io_L,107)2,2,Real(Ty12GUT(2,2),dp), "# Real(Ty12GUT(2,2),dp)" 
If ((MaxVal(Abs(AImag(Ty12GUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMTy12GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(Ty12GUT(1,1)), "# Aimag(Ty12GUT(1,1))" 
Write(io_L,107)1,2,Aimag(Ty12GUT(1,2)), "# Aimag(Ty12GUT(1,2))" 
Write(io_L,107)2,1,Aimag(Ty12GUT(2,1)), "# Aimag(Ty12GUT(2,1))" 
Write(io_L,107)2,2,Aimag(Ty12GUT(2,2)), "# Aimag(Ty12GUT(2,2))" 
End If 
...
Write(io_L,106) "Block ml122GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Real(ml122GUT(1,1),dp), "# Real(ml122GUT(1,1),dp)" 
Write(io_L,107)1,2,Real(ml122GUT(1,2),dp), "# Real(ml122GUT(1,2),dp)" 
Write(io_L,107)2,1,Real(ml122GUT(2,1),dp), "# Real(ml122GUT(2,1),dp)" 
Write(io_L,107)2,2,Real(ml122GUT(2,2),dp), "# Real(ml122GUT(2,2),dp)" 
If ((MaxVal(Abs(AImag(ml122GUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMml122GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(ml122GUT(1,1)), "# Aimag(ml122GUT(1,1))" 
Write(io_L,107)1,2,Aimag(ml122GUT(1,2)), "# Aimag(ml122GUT(1,2))" 
Write(io_L,107)2,1,Aimag(ml122GUT(2,1)), "# Aimag(ml122GUT(2,1))" 
Write(io_L,107)2,2,Aimag(ml122GUT(2,2)), "# Aimag(ml122GUT(2,2))" 
End If 
...
Write(io_L,106) "Block me122GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Real(me122GUT(1,1),dp), "# Real(me122GUT(1,1),dp)" 
Write(io_L,107)1,2,Real(me122GUT(1,2),dp), "# Real(me122GUT(1,2),dp)" 
Write(io_L,107)2,1,Real(me122GUT(2,1),dp), "# Real(me122GUT(2,1),dp)" 
Write(io_L,107)2,2,Real(me122GUT(2,2),dp), "# Real(me122GUT(2,2),dp)" 
If ((MaxVal(Abs(AImag(me122GUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMme122GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(me122GUT(1,1)), "# Aimag(me122GUT(1,1))" 
Write(io_L,107)1,2,Aimag(me122GUT(1,2)), "# Aimag(me122GUT(1,2))" 
Write(io_L,107)2,1,Aimag(me122GUT(2,1)), "# Aimag(me122GUT(2,1))" 
Write(io_L,107)2,2,Aimag(me122GUT(2,2)), "# Aimag(me122GUT(2,2))" 
End If 

Write(io_L,106) "Block ml12l32GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,104) 1,ml12l32GUT(1), "# ml12l32GUT(1) " 
Write(io_L,104) 2,ml12l32GUT(2), "# ml12l32GUT(2) " 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.UNHMSSM",status="unknown")
...
Write(123,*) "y1211_r= ",Real(y12(1,1),dp)
Write(123,*) "y1212_r= ",Real(y12(1,2),dp)
Write(123,*) "y1221_r= ",Real(y12(2,1),dp)
Write(123,*) "y1222_r= ",Real(y12(2,2),dp)
Write(123,*) "y1211_i= ",AImag(y12(1,1))
Write(123,*) "y1212_i= ",AImag(y12(1,2))
Write(123,*) "y1221_i= ",AImag(y12(2,1))
Write(123,*) "y1222_i= ",AImag(y12(2,2))
Write(123,*) "y3_r = ",Real(y3,dp) 
Write(123,*) "y3_i = ",AImag(y3) 
Write(123,*) "lam= ",lam
...
Write(123,*) "Ty1211_r= ",Real(Ty12(1,1),dp)
Write(123,*) "Ty1212_r= ",Real(Ty12(1,2),dp)
Write(123,*) "Ty1221_r= ",Real(Ty12(2,1),dp)
Write(123,*) "Ty1222_r= ",Real(Ty12(2,2),dp)
Write(123,*) "Ty1211_i= ",AImag(Ty12(1,1))
Write(123,*) "Ty1212_i= ",AImag(Ty12(1,2))
Write(123,*) "Ty1221_i= ",AImag(Ty12(2,1))
Write(123,*) "Ty1222_i= ",AImag(Ty12(2,2))
Write(123,*) "Ty3_r = ",Real(Ty3,dp) 
Write(123,*) "Ty3_i = ",AImag(Ty3) 
Write(123,*) "Tlam= ",Tlam
...
Subroutine WriteWCXF 
   Open(123,file="WC.UNHMSSM_1.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
...
Write(123,*) "}"
    Close(123) 
   Open(123,file="WC.UNHMSSM_2.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
Write(123,*) '  "basis": "FlavorKit",'
Write(123,*) '  "scale": "91.",'
...
Subroutine Read_y3IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) y3IN= Cmplx(wert,Aimag(y3IN),dp) 
If (i_c.Eq.1) y3IN= Cmplx(Real(y3IN,dp),wert,dp) 
InputValuefory3= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block y3IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMy3IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block y3IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMy3IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_y3IN 
...
ml32IN= wert 
InputValueforml32= .True. 
Else If (i_par.Eq.5) Then 
me32IN= wert 
InputValueforme32= .True. 
...
Subroutine Read_TY3IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) Ty3IN= Cmplx(wert,Aimag(Ty3IN),dp) 
If (i_c.Eq.1) Ty3IN= Cmplx(Real(Ty3IN,dp),wert,dp) 
InputValueforTy3= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block TY3IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMTY3IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block TY3IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMTY3IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_TY3IN 
...
End Module InputOutput_UNHMSSM 
