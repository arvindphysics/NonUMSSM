...
Module LowEnergy_UNHMSSM 
Use Control 
Use Settings 
Use Couplings_UNHMSSM 
Use LoopCouplings_UNHMSSM 
Use LoopMasses_SM_HC 
Use LoopFunctions 
Use LoopMasses_UNHMSSM 
Use StandardModel 
Use RunSM_UNHMSSM
Use FlavorKit_LFV_UNHMSSM
Use FlavorKit_QFV_UNHMSSM
Use FlavorKit_Observables_UNHMSSM
...
Real(dp),Intent(in)  :: MAh(3),MAh2(3),MCha(2),MCha2(2),MChi(6),MChi2(6),MFe(3),MFe2(3),MFv(3),               & 
& MFv2(3),Mhh(3),Mhh2(3),MHpm(2),MHpm2(2),MSe(6),MSe2(6),MSv(3),MSv2(3),MVZp,MVZp2

Complex(dp),Intent(in)  :: cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplcFeChaSvL(3,2,3),cplcFeChaSvR(3,2,3),        & 
& cplcChaChaVPL(2,2),cplcChaChaVPR(2,2),cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6),         & 
& cplcFeChiSeL(3,6,6),cplcFeChiSeR(3,6,6),cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),         & 
& cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcFeFeVZpL(3,3),cplcFeFeVZpR(3,3),cplcChaFecSvL(2,3,3),& 
& cplcChaFecSvR(2,3,3),cplcFvFecHpmL(3,3,2),cplcFvFecHpmR(3,3,2),cplcFeFvHpmL(3,3,2),    & 
...
Implicit None
Real(dp),Intent(in)  :: MAh(3),MAh2(3),MCha(2),MCha2(2),MChi(6),MChi2(6),MFe(3),MFe2(3),MFv(3),               & 
& MFv2(3),Mhh(3),Mhh2(3),MHpm(2),MHpm2(2),MSe(6),MSe2(6),MSv(3),MSv2(3),MVWm,            & 
...
& cplcgWpCgZpcVWm,cplcgZgWmcVWm,cplcgZpgWmcVWm,cplChiChacVWmL(6,2),cplChiChacVWmR(6,2),  & 
& cplChiChiVZL(6,6),cplChiChiVZR(6,6),cplcVWmcVWmVWmVWm1,cplcVWmcVWmVWmVWm2,             & 
& cplcVWmcVWmVWmVWm3,cplcVWmVPVPVWm1,cplcVWmVPVPVWm2,cplcVWmVPVPVWm3,cplcVWmVPVWm,       & 
& cplcVWmVWmVZ,cplcVWmVWmVZp,cplcVWmVWmVZpVZp1,cplcVWmVWmVZpVZp2,cplcVWmVWmVZpVZp3,      & 
& cplcVWmVWmVZVZ1,cplcVWmVWmVZVZ2,cplcVWmVWmVZVZ3,cplhhcVWmVWm(3),cplhhhhcVWmVWm(3,3),   & 
& cplhhhhVZVZ(3,3),cplhhHpmcVWm(3,2),cplhhVZVZ(3),cplhhVZVZp(3),cplHpmcHpmcVWmVWm(2,2),  & 
...
& cplSecSecVWmVWm(6,6),cplSecSeVZ(6,6),cplSecSeVZVZ(6,6),cplSecSvcVWm(6,3),              & 
& cplSucSucVWmVWm(6,6),cplSucSuVZ(6,6),cplSucSuVZVZ(6,6),cplSvcSvcVWmVWm(3,3),           & 
& cplSvcSvVZ(3,3),cplSvcSvVZVZ(3,3)
...
& Ydinput,y12input,y3input,laminput,Yuinput,Tdinput,Ty12input,Ty3input,Tlaminput,        & 
& Tuinput,mq2input,ml122input,ml32input,mHd2input,mHu2input,md2input,mu2input,           & 
& me122input,me32input,ms2input,ml12l32input,M1input,M2input,M3input,M4input,            & 
& Tdpinput,Tepinput,vdinput,vuinput,vSinput,Tpar,Spar,Upar,ae,amu,atau,EDMe,             & 
...
Real(dp),Intent(inout) :: g1input,g2input,g3input,gpinput,laminput,Tlaminput,ml32input,mHd2input,               & 
& mHu2input,me32input,ms2input,ml12l32input(2),vdinput,vuinput,vSinput

Complex(dp),Intent(inout) :: Ydinput(3,3),y12input(2,2),y3input,Yuinput(3,3),Tdinput(3,3),Ty12input(2,2),          & 
& Ty3input,Tuinput(3,3),mq2input(3,3),ml122input(2,2),md2input(3,3),mu2input(3,3),       & 
& me122input(2,2),M1input,M2input,M3input,M4input,Tdpinput(3,3),Tepinput(2,2)
...
Real(dp) :: g1,g2,g3,gp,lam,Tlam,ml32,mHd2,mHu2,me32,ms2,ml12l32(2),vd,vu,vS

Complex(dp) :: Yd(3,3),y12(2,2),y3,Yu(3,3),Td(3,3),Ty12(2,2),Ty3,Tu(3,3),mq2(3,3),ml122(2,2),        & 
& md2(3,3),mu2(3,3),me122(2,2),M1,M2,M3,M4,Tdp(3,3),Tep(2,2)

Complex(dp) :: cplAhAhcVWmVWm(3,3),cplAhAhhh(3,3,3),cplAhAhVZVZ(3,3),cplAhAhVZVZp(3,3),              & 
& cplAhcHpmVWm(3,2),cplAhhhVZ(3,3),cplAhhhVZp(3,3),cplAhHpmcHpm(3,2,2),cplAhHpmcVWm(3,2),& 
...
& cplChiFvcSvR(6,3,3),cplcHpmVPVWm(2),cplcHpmVWmVZ(2),cplcHpmVWmVZp(2),cplcVWmcVWmVWmVWm1,& 
...
Complex(dp) :: cplcVWmVWmVZVZp1,cplcVWmVWmVZVZp2,cplcVWmVWmVZVZp3,cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),& 
& cplGluFucSuL(3,6),cplGluFucSuR(3,6),cplGluGluVGL,cplGluGluVGR,cplhhcHpmVWm(3,2),       & 
& cplhhcVWmVWm(3),cplhhhhcVWmVWm(3,3),cplhhhhhh(3,3,3),cplhhhhVZVZ(3,3),cplhhhhVZVZp(3,3),& 
...
& cplHpmSvcSe(2,3,6),cplSdcHpmcSu(6,2,6),cplSdcSdcVWmVWm(6,6),cplSdcSdVG(6,6),           & 
...
& cplSecHpmcSv(6,2,3),cplSecSecVWmVWm(6,6),cplSecSeVP(6,6),cplSecSeVPVP(6,6),            & 
& cplSecSeVPVZ(6,6),cplSecSeVPVZp(6,6),cplSecSeVZ(6,6),cplSecSeVZp(6,6),cplSecSeVZVZ(6,6),& 
& cplSecSeVZVZp(6,6),cplSecSvcVWm(6,3),cplSucSdVWm(6,6),cplSucSucVWmVWm(6,6),            & 
& cplSucSuVG(6,6),cplSucSuVP(6,6),cplSucSuVPVP(6,6),cplSucSuVPVZ(6,6),cplSucSuVPVZp(6,6),& 
& cplSucSuVZ(6,6),cplSucSuVZp(6,6),cplSucSuVZVZ(6,6),cplSucSuVZVZp(6,6),cplSvcSeVWm(3,6),& 
& cplSvcSvcVWmVWm(3,3),cplSvcSvVZ(3,3),cplSvcSvVZp(3,3),cplSvcSvVZVZ(3,3),               & 
& cplSvcSvVZVZp(3,3),cplVGVGVG
...
Complex(dp), Dimension(3,3) :: Yu_save, Yd_save, ElectronYukawa_save, CKMsave 
Complex(dp) :: YuSM(3,3),YeSM(3,3),YdSM(3,3) 
Real(dp)::g1SM, g2SM, g3SM, vSM 
Real(dp) :: g1D(212), tz, dt 
...
& y12input,y3input,laminput,Yuinput,Tdinput,Ty12input,Ty3input,Tlaminput,Tuinput,        & 
& mq2input,ml122input,ml32input,mHd2input,mHu2input,md2input,mu2input,me122input,        & 
& me32input,ms2input,ml12l32input,M1input,M2input,M3input,M4input,Tdpinput,              & 
& Tepinput,vdinput,vuinput,vSinput,g1,g2,g3,gp,Yd,y12,y3,lam,Yu,Td,Ty12,Ty3,             & 
& Tlam,Tu,mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,ml12l32,M1,M2,M3,              & 
& M4,Tdp,Tep,vd,vu,vS,CKM_160,sinW2_160,Alpha_160,AlphaS_160,.false.)
...
MHpm(1)=MVWm
MHpm2(1)=MVWm2
Call AllCouplings(g1,g2,gp,lam,Tlam,vd,vu,vS,ZH,ZA,ZP,Yd,Td,Tdp,ZD,y12,               & 
& Ty12,y3,Ty3,Tep,ZE,Yu,Tu,ZU,ZV,TW,TWp,g3,UM,UP,ZN,ZDL,ZDR,ZEL,ZER,ZUL,ZUR,             & 
& ZVL,pG,cplAhAhhh,cplAhHpmcHpm,cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplhhhhhh,              & 
& cplhhHpmcHpm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,cplHpmSucSd,cplHpmSvcSe,      & 
& cplSdcHpmcSu,cplSecHpmcSv,cplAhhhVZ,cplAhhhVZp,cplAhHpmcVWm,cplAhcHpmVWm,              & 
...
& cplHpmcVWmVZ,cplHpmcVWmVZp,cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,cplVGVGVG,          & 
& cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,      & 
...
& cplcFuChiSuR,cplcFvChiSvL,cplcFvChiSvR,cplGluFdcSdL,cplGluFdcSdR,cplcFdFdhhL,          & 
...
& cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,cplChiChacVWmL,cplChiChacVWmR,               & 
...
& MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,          & 
& cplAhcHpmVWm,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSecSe,     & 
...
& cplcFuFuVZpR,cplcFuFuVZR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,      & 
...
& MChi2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,              & 
& MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhhhVZ,          & 
& cplAhhhVZp,cplcChacFvSeL,cplcChacFvSeR,cplcChaChaVZL,cplcChaChaVZpL,cplcChaChaVZpR,    & 
& cplcChaChaVZR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdChaSuL,cplcFdChaSuR,cplcFdChiSdL,      & 
...
& cplcFdFuVWmR,cplcFdGluSdL,cplcFdGluSdR,cplcFeFeVZL,cplcFeFeVZpL,cplcFeFeVZpR,          & 
& cplcFeFeVZR,cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFuFdcHpmL,         & 
& cplcFuFdcHpmR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFuFuVZL,cplcFuFuVZpL,cplcFuFuVZpR,       & 
...
& cplChaFvcSeR,cplChiChiVZL,cplChiChiVZpL,cplChiChiVZpR,cplChiChiVZR,cplChiFdcSdL,       & 
& cplChiFdcSdR,cplChiFvcSvL,cplChiFvcSvR,cplcHpmVWmVZ,cplcHpmVWmVZp,cplcVWmVWmVZ,        & 
& cplcVWmVWmVZp,cplGluFdcSdL,cplGluFdcSdR,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,              & 
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVZ,cplSdcSdVZp,          & 
& cplSecSeVZ,cplSecSeVZp,cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,TSOddvvVRR(gt1,gt2,gt3,gt4)& 
...
& cplcVWmVWmVZp,cplGluFdcSdL,cplGluFdcSdR,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,              & 
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVZ,cplSdcSdVZp,          & 
& cplSecSeVZ,cplSecSeVZp,cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,TVOddvvVRR(gt1,gt2,gt3,gt4)& 
...
& cplChiChiVZpR,cplChiChiVZR,cplChiFdcSdL,cplChiFdcSdR,cplcHpmVPVWm,cplcHpmVWmVZ,        & 
& cplcHpmVWmVZp,cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,cplGluFdcSdL,cplGluFdcSdR,       & 
& cplGluGluVGL,cplGluGluVGR,cplhhcHpmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHpmcHpm,            & 
& cplhhHpmcVWm,cplhhSdcSd,cplhhSucSu,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,      & 
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVG,         & 
& cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSucSuVG,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,        & 
...
& cplhhHpmcHpm,cplhhHpmcVWm,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,       & 
& cplHpmSvcSe,cplSdcHpmcSu,cplSdcSucVWm,cplSvcSeVWm,TSOdulvSLL(gt1,gt2,gt3,gt4)          & 
...
& cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,cplGluFucSuR,cplhhcHpmVWm,cplhhcVWmVWm,         & 
& cplhhHpmcHpm,cplhhHpmcVWm,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,       & 
& cplHpmSvcSe,cplSdcHpmcSu,cplSdcSucVWm,cplSvcSeVWm,TVOdulvSLL(gt1,gt2,gt3,gt4)          & 
...
& cplcVWmVWmVZp,cplGluFdcSdL,cplGluFdcSdR,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,              & 
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVZ,cplSdcSdVZp,          & 
& cplSecSeVZ,cplSecSeVZp,cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,BOddvvVRR(gt1,gt2,gt3,gt4)& 
...
& cplcVWmVWmVZp,cplGluFdcSdL,cplGluFdcSdR,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,              & 
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVZ,cplSdcSdVZp,          & 
& cplSecSeVZ,cplSecSeVZp,cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,PSOddvvVRR(gt1,gt2,gt3,gt4)& 
...
& cplcVWmVWmVZp,cplGluFdcSdL,cplGluFdcSdR,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,              & 
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVZ,cplSdcSdVZp,          & 
& cplSecSeVZ,cplSecSeVZp,cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,PVOddvvVRR(gt1,gt2,gt3,gt4)& 
...
& cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplChiChiAhL,            & 
& cplChiChiAhR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZpL,cplChiChiVZpR,       & 
& cplChiChiVZR,cplChiFdcSdL,cplChiFdcSdR,cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,        & 
& cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,cplGluFdcSdL,cplGluFdcSdR,cplGluGluVGL,        & 
& cplGluGluVGR,cplhhcHpmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,            & 
& cplhhSdcSd,cplhhSucSu,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,      & 
& cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVG,cplSdcSdVP,           & 
& cplSdcSdVZ,cplSdcSdVZp,cplSucSuVG,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,BO4dSLL(gt1,gt2,gt3,gt4)& 
...
& MFd2,MFu,MFu2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSu,MSu2,MVWm,MVWm2,             & 
& MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,cplAhhhVZ,cplAhhhVZp,cplcChaChahhL,cplcChaChahhR,        & 
...
& cplhhHpmcVWm,cplhhSdcSd,cplhhSucSu,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,OH2qSL(gt1,gt2,gt3)& 
& ,OH2qSR(gt1,gt2,gt3))
...
& cplcVWmVWmVZp,cplGluFdcSdL,cplGluFdcSdR,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,              & 
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVZ,cplSdcSdVZp,          & 
& cplSecSeVZ,cplSecSeVZp,cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,TSOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcVWmVWmVZp,cplGluFdcSdL,cplGluFdcSdR,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,              & 
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVZ,cplSdcSdVZp,          & 
& cplSecSeVZ,cplSecSeVZp,cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,TVOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
& cplhhSdcSd,cplhhSucSu,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,      & 
& cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVG,cplSdcSdVP,           & 
& cplSdcSdVZ,cplSdcSdVZp,cplSucSuVG,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,TSO4dSLLSM(gt1,gt2,gt3,gt4)& 
...
& cplhhSdcSd,cplhhSucSu,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,      & 
& cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVG,cplSdcSdVP,           & 
& cplSdcSdVZ,cplSdcSdVZp,cplSucSuVG,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,TVO4dSLLSM(gt1,gt2,gt3,gt4)& 
...
& cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,cplGluFucSuR,cplhhcHpmVWm,cplhhcVWmVWm,         & 
& cplhhHpmcHpm,cplhhHpmcVWm,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,       & 
& cplHpmSvcSe,cplSdcHpmcSu,cplSdcSucVWm,cplSvcSeVWm,TSOdulvSLLSM(gt1,gt2,gt3,gt4)        & 
...
& cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,cplGluFucSuR,cplhhcHpmVWm,cplhhcVWmVWm,         & 
& cplhhHpmcHpm,cplhhHpmcVWm,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,       & 
& cplHpmSvcSe,cplSdcHpmcSu,cplSdcSucVWm,cplSvcSeVWm,TVOdulvSLLSM(gt1,gt2,gt3,gt4)        & 
...
& MSe,MSe2,MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,cplAhcHpmVWm,      & 
...
& cplcVWmVWmVZp,cplGluFdcSdL,cplGluFdcSdR,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,              & 
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVZ,cplSdcSdVZp,          & 
& cplSecSeVZ,cplSecSeVZp,cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,BOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcVWmVWmVZp,cplGluFdcSdL,cplGluFdcSdR,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,              & 
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVZ,cplSdcSdVZp,          & 
& cplSecSeVZ,cplSecSeVZp,cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,PSOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
& cplcVWmVWmVZp,cplGluFdcSdL,cplGluFdcSdR,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,              & 
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVZ,cplSdcSdVZp,          & 
& cplSecSeVZ,cplSecSeVZp,cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,cplSvcSvVZp,PVOddvvVRRSM(gt1,gt2,gt3,gt4)& 
...
& cplhhSdcSd,cplhhSucSu,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,      & 
& cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVG,cplSdcSdVP,           & 
& cplSdcSdVZ,cplSdcSdVZp,cplSucSuVG,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,BO4dSLLSM(gt1,gt2,gt3,gt4)& 
...
& cplcFuFuhhL,cplcFuFuhhR,cplChiChihhL,cplChiChihhR,cplChiFdcSdL,cplChiFdcSdR,           & 
& cplGluFdcSdL,cplGluFdcSdR,cplhhcHpmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHpmcHpm,            & 
& cplhhHpmcVWm,cplhhSdcSd,cplhhSucSu,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,OH2qSLSM(gt1,gt2,gt3)& 
...
If (MatchingOrder.gt.-1) Then 
Call RunSM_and_SUSY_RGEs(mz,g1input,g2input,g3input,gpinput,Ydinput,y12input,         & 
& y3input,laminput,Yuinput,Tdinput,Ty12input,Ty3input,Tlaminput,Tuinput,mq2input,        & 
& ml122input,ml32input,mHd2input,mHu2input,md2input,mu2input,me122input,me32input,       & 
& ms2input,ml12l32input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,               & 
& vdinput,vuinput,vSinput,g1,g2,g3,gp,Yd,y12,y3,lam,Yu,Td,Ty12,Ty3,Tlam,Tu,              & 
& mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,ml12l32,M1,M2,M3,M4,Tdp,               & 
& Tep,vd,vu,vS,CKM_MZ,sinW2_MZ,Alpha_MZ,AlphaS_MZ,.true.)
...
& cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZpL,cplcChaChaVZpR, & 
& cplcChaChaVZR,cplcChaFecSvL,cplcChaFecSvR,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,         & 
...
& cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplcFuGluSuL,cplcFuGluSuR,cplcFvFecHpmL,         & 
& cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZpL,cplcFvFvVZpR,       & 
& cplcFvFvVZR,cplChaFucSdL,cplChaFucSdR,cplChiChiAhL,cplChiChiAhR,cplChiChihhL,          & 
& cplChiChihhR,cplChiChiVZL,cplChiChiVZpL,cplChiChiVZpR,cplChiChiVZR,cplChiFecSeL,       & 
& cplChiFecSeR,cplChiFucSuL,cplChiFucSuR,cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,        & 
& cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,cplGluFucSuL,cplGluFucSuR,cplhhcHpmVWm,        & 
& cplhhcVWmVWm,cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,     & 
& cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,   & 
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,        & 
& cplSvcSvVZp,TSOlluuSLL(gt1,gt2,gt3,gt4),TSOlluuSRR(gt1,gt2,gt3,gt4),TSOlluuSRL(gt1,gt2,gt3,gt4)& 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,        & 
& cplSvcSvVZp,TVOlluuSLL(gt1,gt2,gt3,gt4),TVOlluuSRR(gt1,gt2,gt3,gt4),TVOlluuSRL(gt1,gt2,gt3,gt4)& 
...
& MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,cplAhcHpmVWm,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,          & 
& cplAhHpmcVWm,cplAhSecSe,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,       & 
& cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZpL,cplcChaChaVZpR,               & 
& cplcChaChaVZR,cplcChaFecSvL,cplcChaFecSvR,cplcFeChaSvL,cplcFeChaSvR,cplcFeChiSeL,      & 
...
& cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZpL,cplcFvFvVZpR,cplcFvFvVZR,cplChiChiAhL,          & 
& cplChiChiAhR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZpL,cplChiChiVZpR,       & 
& cplChiChiVZR,cplChiFecSeL,cplChiFecSeR,cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,        & 
& cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,cplhhcHpmVWm,cplhhcVWmVWm,cplhhhhhh,           & 
& cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,      & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,       & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSvcSvVZ,cplSvcSvVZp,TSO4lSLL(gt1,gt2,gt3,gt4)     & 
...
& cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,      & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,       & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSvcSvVZ,cplSvcSvVZp,TVO4lSLL(gt1,gt2,gt3,gt4)     & 
...
& cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,      & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,       & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSvcSvVZ,cplSvcSvVZp,TSO4lSLLcross(gt1,gt2,gt3,gt4)& 
...
& cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,      & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,       & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSvcSvVZ,cplSvcSvVZp,TVO4lSLLcross(gt1,gt2,gt3,gt4)& 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,        & 
& cplSvcSvVZp,BOlluuSLL(gt1,gt2,gt3,gt4),BOlluuSRR(gt1,gt2,gt3,gt4),BOlluuSRL(gt1,gt2,gt3,gt4)& 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,        & 
& cplSvcSvVZp,PSOlluuSLL(gt1,gt2,gt3,gt4),PSOlluuSRR(gt1,gt2,gt3,gt4),PSOlluuSRL(gt1,gt2,gt3,gt4)& 
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvcSvVZ,        & 
& cplSvcSvVZp,PVOlluuSLL(gt1,gt2,gt3,gt4),PVOlluuSRR(gt1,gt2,gt3,gt4),PVOlluuSRL(gt1,gt2,gt3,gt4)& 
...
& cplAhSecSe,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,      & 
& cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZpL,cplcChaChaVZpR,cplcChaChaVZR,               & 
...
& cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,      & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,       & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSvcSvVZ,cplSvcSvVZp,PSO4lSLL(gt1,gt2,gt3,gt4)     & 
...
& cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,      & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,       & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSvcSvVZ,cplSvcSvVZp,PVO4lSLL(gt1,gt2,gt3,gt4)     & 
...
& cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,      & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,       & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSvcSvVZ,cplSvcSvVZp,BO4lSLLcross(gt1,gt2,gt3,gt4) & 
...
& cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,      & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,       & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSvcSvVZ,cplSvcSvVZp,PSO4lSLLcross(gt1,gt2,gt3,gt4)& 
...
& cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,      & 
& cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,       & 
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSvcSvVZ,cplSvcSvVZp,PVO4lSLLcross(gt1,gt2,gt3,gt4)& 
...
& MVZp,MVZp2,cplAhAhhh,cplAhhhVZ,cplAhhhVZp,cplcChaChahhL,cplcChaChahhR,cplcChaFecSvL,   & 
...
& cplcFeFeVZR,cplcFeFvHpmL,cplcFeFvHpmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFecHpmL,         & 
& cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,cplChiChihhL,cplChiChihhR,cplChiFecSeL,      & 
& cplChiFecSeR,cplhhcHpmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,            & 
& cplhhSecSe,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,OH2lSL(gt1,gt2,gt3)             & 
& ,OH2lSR(gt1,gt2,gt3))
...
sinW2=0.22290_dp 
TW = asin(sqrt(sinW2)) 
mW2=(1._dp-sinW2)*mz2 + (g2**2*(vd**2 + vu**2 - (vd**2 + vu**2)*Cos(TWp)**2 - (4*gp*Sin(TWp)*(Sqrt(g1**2 + g2**2)*(QHd*vd**2 - QHu*vu**2)*Cos(TWp) + gp*(QHd**2*vd**2 + Qs**2*vS**2 + QHu**2*vu**2)*Sin(TWp)))/(g1**2 + g2**2)))/4._dp
...
& g2,g3,gp,Yd,y12,y3,lam,Yu,Td,Ty12,Ty3,Tlam,Tu,mq2,ml122,ml32,mHd2,mHu2,md2,            & 
& mu2,me122,me32,ms2,ml12l32,M1,M2,M3,M4,Tdp,Tep,.False.)
