...
Real(dp) :: g1,g2,g3,gp,lam,Tlam,ml32,mHd2,mHu2,me32,ms2,ml12l32(2)
...
Call GToParameters209(gA,g1,g2,g3,gp,Yd,y12,y3,lam,Yu,Td,Ty12,Ty3,Tlam,               & 
...
Call ParametersToG209(g1,g2,g3,gp,Yd,y12,y3,lam,Yu,Td,Ty12,Ty3,Tlam,Tu,               & 
& mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,ml12l32,M1,M2,M3,M4,Tdp,Tep,gB)
...
End if 
If (Maxval(Abs(y12)).gt.3._dp) Then 
Write(*,*) "Non pertubative coupling at GUT scale y12" 
If (ErrorLevel.gt.0) Call TerminateProgram 
End if 
If (Abs(y3).gt.3._dp) Then 
Write(*,*) "Non pertubative coupling at GUT scale y3" 
If (ErrorLevel.gt.0) Call TerminateProgram 
End if 
...
& mu2,me122,me32,ms2,ml12l32,M1,M2,M3,M4,Tdp,Tep,delta0,gMZ,kont)
...
& MVZp,g1,g2,gp,TW,TWp,UM,UP,vd,vu,y12,y3,ZA,ZE,ZEL,ZER,ZH,ZN,ZP,ZV,ZVL,delta)
...
Call SetMatchingConditions(g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,vSM,vd,vu,vS,g1,             & 
& g2,g3,gp,Yd,y12,y3,lam,Yu,Td,Ty12,Ty3,Tlam,Tu,mq2,ml122,ml32,mHd2,mHu2,md2,            & 
& mu2,me122,me32,ms2,ml12l32,M1,M2,M3,M4,Tdp,Tep,.True.)
...
Call CouplingsForSMfermions(y12,y3,ZA,ZEL,ZER,g2,ZV,UM,UP,g1,gp,ZE,ZN,ZH,             & 
& TW,TWp,ZVL,ZP,Yd,ZDL,ZDR,Yu,ZU,ZD,g3,ZUL,ZUR,pG,cplcUFeFeAhL,cplcUFeFeAhR,             & 
...
Call ParametersToG209(g1,g2,g3,gp,Yd,y12,y3,lam,Yu,Td,Ty12,Ty3,Tlam,Tu,               & 
& mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,ml12l32,M1,M2,M3,M4,Tdp,Tep,gMZ)
...
& ZE,ZEL,ZER,ZH,ZN,ZP,ZU,ZUL,ZUR,ZV,ZVL,ZW,ZZ,betaH,g1,g2,g3,gp,Yd,y12,y3,               & 
& lam,Yu,Td,Ty12,Ty3,Tlam,Tu,mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,            & 
& ml12l32,M1,M2,M3,M4,Tdp,Tep,mGut,kont,WriteComment,niter)

Implicit None
Logical,Intent(in) :: WriteComment
Integer,Intent(inout) :: kont
Integer,Intent(in) :: niter
Real(dp) :: delta0,deltaG0, gA(209), gB(209)
Real(dp) :: gC(212),  gD(212) 
...
& me32,ms2,ml12l32,M1,M2,M3,M4,Tdp,Tep,delta0,gB,kont)
...
Call odeint(gC,212,tz,0._dp,0.1_dp*delta0,dt,0._dp,rge212,kont)
Call GToParameters212(gC,g1,g2,g3,gp,Yd,y12,y3,lam,Yu,Td,Ty12,Ty3,Tlam,               & 
& Tu,mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,ml12l32,M1,M2,M3,M4,Tdp,            & 
& Tep,vd,vu,vS)
...
tz=Log(mZ/Q)
dt=-tz/50._dp
Call odeint(gD,212,tz,0._dp,0.1_dp*delta0,dt,0._dp,rge212,kont)
Call GToParameters212(gD,g1,g2,g3,gp,Yd,y12,y3,lam,Yu,Td,Ty12,Ty3,Tlam,               & 
& Tu,mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,ml12l32,M1,M2,M3,M4,Tdp,            & 
& Tep,vd,vu,vS)
...
Real(dp),Intent(in)::delta0
Integer :: i1, i2, i3, i4 
Real(dp),Intent(inout)::g1A(209)
Real(dp),Intent(out)::g1C(209),mGUT
Real(dp)::tz,dt,t_out 
Real(dp)::mudim,gGUT,gA_h(209),g1b(209),m_hi,m_lo
Real(dp)::g1S(209)
...
dt=tz/100._dp
Call odeint(g1A,209,tz,0._dp,delta0,dt,0._dp,rge209,kont)
...
Call odeint(g1B,209,tz,0._dp,delta0,dt,0._dp,rge209,kont)
...
Call odeintB2(g1B,209,tz,0._dp,delta0,dt,0._dp,rge209,checkGUT209,t_out,kont)
...
dt=tz/100._dp
Call odeint(g1c,209,0._dp,tz,delta0,dt,0._dp,rge209,kont)
Iname=Iname-1
...
& y12,y3,lam,Yu,Td,Ty12,Ty3,Tlam,Tu,mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,              & 
& me32,ms2,ml12l32,M1,M2,M3,M4,Tdp,Tep,mGut,kont,WriteComment,niter)
...
Real(dp),Intent(out)::g1C(209),mGUT
Real(dp)::tz,dt,t_out 
Real(dp)::mudim,gGUT,gA_h(209),m_hi,m_lo
Real(dp)::g1B(209)
Real(dp)::g1S(209)
Logical :: FoundUnification, unified, greater 
...
Subroutine checkGUT209(y,eps,unified,greater)  
Implicit None 
Real(dp), Intent(in) :: y(209), eps 
...
Call GToParameters209(y,g1,g2,g3,gp,Yd,y12,y3,lam,Yu,Td,Ty12,Ty3,Tlam,Tu,             & 
& mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,ml12l32,M1,M2,M3,M4,Tdp,Tep)
...
Real(dp):: gA(209), gB(209), Scale_Save 
...
Call ParametersToG209(g1,g2,g3,gp,Yd,y12,y3,lam,Yu,Td,Ty12,Ty3,Tlam,Tu,               & 
& mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,ml12l32,M1,M2,M3,M4,Tdp,Tep,gA)
...
Iname=Iname-1 
    ...
    Call TerminateProgram
End if 
Call GToParameters209(gB,g1,g2,g3,gp,Yd,y12,y3,lam,Yu,Td,Ty12,Ty3,Tlam,               & 
& Tu,mq2,ml122,ml32,mHd2,mHu2,md2,mu2,me122,me32,ms2,ml12l32,M1,M2,M3,M4,Tdp,Tep)
