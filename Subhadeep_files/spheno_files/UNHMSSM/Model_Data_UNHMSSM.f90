...
Real(dp) :: g1IN,g2IN,g3IN,gpIN,lamIN,TlamIN,ml32IN,mHd2IN,mHu2IN,me32IN,ms2IN,ml12l32IN(2)

Complex(dp) :: YdIN(3,3),y12IN(2,2),y3IN,YuIN(3,3),TdIN(3,3),Ty12IN(2,2),Ty3IN,TuIN(3,3),            & 
& mq2IN(3,3),ml122IN(2,2),md2IN(3,3),mu2IN(3,3),me122IN(2,2),M1IN,M2IN,M3IN,             & 
& M4IN,TdpIN(3,3),TepIN(2,2)

Real(dp) :: g1MZ,g2MZ,g3MZ,gpMZ,lamMZ,TlamMZ,ml32MZ,mHd2MZ,mHu2MZ,me32MZ,ms2MZ,ml12l32MZ(2)

Complex(dp) :: YdMZ(3,3),y12MZ(2,2),y3MZ,YuMZ(3,3),TdMZ(3,3),Ty12MZ(2,2),Ty3MZ,TuMZ(3,3),            & 
& mq2MZ(3,3),ml122MZ(2,2),md2MZ(3,3),mu2MZ(3,3),me122MZ(2,2),M1MZ,M2MZ,M3MZ,             & 
& M4MZ,TdpMZ(3,3),TepMZ(2,2)

Real(dp) :: g1GUT,g2GUT,g3GUT,gpGUT,lamGUT,TlamGUT,ml32GUT,mHd2GUT,mHu2GUT,me32GUT,               & 
& ms2GUT,ml12l32GUT(2)

Complex(dp) :: YdGUT(3,3),y12GUT(2,2),y3GUT,YuGUT(3,3),TdGUT(3,3),Ty12GUT(2,2),Ty3GUT,               & 
& TuGUT(3,3),mq2GUT(3,3),ml122GUT(2,2),md2GUT(3,3),mu2GUT(3,3),me122GUT(2,2),            & 
& M1GUT,M2GUT,M3GUT,M4GUT,TdpGUT(3,3),TepGUT(2,2)
...
Real(dp) :: gPSd(6,1344),gTSd(6),BRSd(6,1344),gPSu(6,1344),gTSu(6),BRSu(6,1344),gPSe(6,1221),     & 
...
& gP1LSe(6,66),gT1LSe(6),BR1LSe(6,66),gP1LSv(3,51),gT1LSv(3),BR1LSv(3,51),               & 
& gP1Lhh(3,188),gT1Lhh(3),BR1Lhh(3,188),gP1LAh(3,173),gT1LAh(3),BR1LAh(3,173),           & 
& gP1LHpm(2,96),gT1LHpm(2),BR1LHpm(2,96),gP1LVZp(1,190),gT1LVZp,BR1LVZp(1,190),          & 
& gP1LGlu(1,36),gT1LGlu,BR1LGlu(1,36),gP1LChi(6,103),gT1LChi(6),BR1LChi(6,103),          & 
& gP1LCha(2,87),gT1LCha(2),BR1LCha(2,87),gP1LFu(3,78),gT1LFu(3),BR1LFu(3,78)
...
Logical, save :: InputValuefory12 =.False. 
...
Logical, save :: InputValueforTy12 =.False. 
Logical, save :: InputValueforTy3 =.False. 
Logical, save :: InputValueforTlam =.False. 
Logical, save :: InputValueforTu =.False. 
Logical, save :: InputValueformq2 =.False. 
Logical, save :: InputValueforml122 =.False. 
Logical, save :: InputValueforml32 =.False. 
...
Logical, save :: InputValueforme122 =.False. 
Logical, save :: InputValueforme32 =.False. 
Logical, save :: InputValueforms2 =.False. 
Logical, save :: InputValueforml12l32 =.False. 
...
& vS,g1,g2,g3,gp,Yd,y12,y3,lam,Yu,Td,Ty12,Ty3,Tlam,Tu,mq2,ml122,ml32,mHd2,               & 
& mHu2,md2,mu2,me122,me32,ms2,ml12l32,M1,M2,M3,M4,Tdp,Tep,MZsuffix)
