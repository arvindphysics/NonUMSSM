...
Module TreeLevelMasses_UNHMSSM 
...
& me32,ms2,ml12l32,M1,M2,M3,M4,Tdp,Tep,GenerationMixing,kont)
...
Complex(dp) :: MGluC 
Iname = Iname + 1 
NameOfUnit(Iname) = 'TreeMassesUNHMSSM'
...
Call CalculateMSv(g1,g2,gp,Ql,QHd,QHu,Qs,ml122,ml12l32,ml32,vd,vu,vS,ZV,              & 
& MSv,MSv2,kont)
...
Call CalculateMSe(g1,g2,gp,Ql,QHd,QHu,Qe12,Qe3,Qs,y12,Ty12,y3,Ty3,lam,ml122,          & 
& ml12l32,ml32,me122,me32,Tep,vd,vu,vS,ZE,MSe,MSe2,kont)
...
MCha2 = MCha**2 
Call CalculateMFe(y12,y3,vd,ZEL,ZER,MFe,kont)
...
& vd,vu,vS,g1,g2,g3,gp,Yd,y12,y3,lam,Yu,Td,Ty12,Ty3,Tlam,Tu,mq2,ml122,ml32,              & 
& mHd2,mHu2,md2,mu2,me122,me32,ms2,ml12l32,M1,M2,M3,M4,Tdp,Tep,kont)
...
& g3,gp,Yd,y12,y3,lam,Yu,Td,Ty12,Ty3,Tlam,Tu,mq2,ml122,ml32,mHd2,mHu2,md2,               & 
& mu2,me122,me32,ms2,ml12l32,M1,M2,M3,M4,Tdp,Tep,GenerationMixing,kont)
...
Call CalculateMSvEffPot(g1,g2,gp,Ql,QHd,QHu,Qs,ml122,ml12l32,ml32,vd,vu,              & 
& vS,ZV,MSv,MSv2,kont)
...
Call CalculateMSeEffPot(g1,g2,gp,Ql,QHd,QHu,Qe12,Qe3,Qs,y12,Ty12,y3,Ty3,              & 
& lam,ml122,ml12l32,ml32,me122,me32,Tep,vd,vu,vS,ZE,MSe,MSe2,kont)
...
MCha2 = MCha**2 
Call CalculateMFeEffPot(y12,y3,vd,ZEL,ZER,MFe,kont)
...
Subroutine CalculateMSv(g1,g2,gp,Ql,QHd,QHu,Qs,ml122,ml12l32,ml32,vd,vu,              & 
& vS,ZV,MSv,MSv2,kont)
...
mat(1,1) = mat(1,1)+ml122(1,1)
mat(1,2) = 0._dp 
mat(1,2) = mat(1,2)+ml122(1,2)
mat(1,3) = 0._dp 
mat(1,3) = mat(1,3)+ml12l32(1)
mat(2,2) = 0._dp 
...
mat(2,2) = mat(2,2)+ml122(2,2)
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)+ml12l32(2)
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+ml32
...
Subroutine CalculateMSe(g1,g2,gp,Ql,QHd,QHu,Qe12,Qe3,Qs,y12,Ty12,y3,Ty3,              & 
& lam,ml122,ml12l32,ml32,me122,me32,Tep,vd,vu,vS,ZE,MSe,MSe2,kont)
...
mat(1,1) = mat(1,1)+ml122(1,1)
Do j1 = 1,2
mat(1,1) = mat(1,1)+(vd**2*Conjg(y12(j1,1))*y12(j1,1))/2._dp
End Do 
mat(1,2) = 0._dp 
mat(1,2) = mat(1,2)+ml122(1,2)
Do j1 = 1,2
mat(1,2) = mat(1,2)+(vd**2*Conjg(y12(j1,1))*y12(j1,2))/2._dp
End Do 
mat(1,3) = 0._dp 
mat(1,3) = mat(1,3)+ml12l32(1)
mat(1,4) = 0._dp 
mat(1,4) = mat(1,4)-((vu*Conjg(Tep(1,1)))/sqrt(2._dp))
mat(1,4) = mat(1,4)-(vS*vu*lam*Conjg(y12(1,1)))/2._dp
mat(1,4) = mat(1,4)+(vd*Conjg(Ty12(1,1)))/sqrt(2._dp)
mat(1,5) = 0._dp 
mat(1,5) = mat(1,5)-((vu*Conjg(Tep(2,1)))/sqrt(2._dp))
mat(1,5) = mat(1,5)-(vS*vu*lam*Conjg(y12(2,1)))/2._dp
mat(1,5) = mat(1,5)+(vd*Conjg(Ty12(2,1)))/sqrt(2._dp)
mat(1,6) = 0._dp 
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)+(g1**2*vd**2)/8._dp
mat(2,2) = mat(2,2)-(g2**2*vd**2)/8._dp
...
mat(2,2) = mat(2,2)+ml122(2,2)
Do j1 = 1,2
mat(2,2) = mat(2,2)+(vd**2*Conjg(y12(j1,2))*y12(j1,2))/2._dp
End Do 
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)+ml12l32(2)
mat(2,4) = 0._dp 
mat(2,4) = mat(2,4)-((vu*Conjg(Tep(1,2)))/sqrt(2._dp))
mat(2,4) = mat(2,4)-(vS*vu*lam*Conjg(y12(1,2)))/2._dp
mat(2,4) = mat(2,4)+(vd*Conjg(Ty12(1,2)))/sqrt(2._dp)
mat(2,5) = 0._dp 
mat(2,5) = mat(2,5)-((vu*Conjg(Tep(2,2)))/sqrt(2._dp))
mat(2,5) = mat(2,5)-(vS*vu*lam*Conjg(y12(2,2)))/2._dp
mat(2,5) = mat(2,5)+(vd*Conjg(Ty12(2,2)))/sqrt(2._dp)
mat(2,6) = 0._dp 
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+ml32
mat(3,3) = mat(3,3)+(g1**2*vd**2)/8._dp
...
mat(3,3) = mat(3,3)+(g2**2*vu**2)/8._dp
mat(3,3) = mat(3,3)+(gp**2*QHu*Ql*vu**2)/2._dp
mat(3,3) = mat(3,3)+(vd**2*y3*Conjg(y3))/2._dp
mat(3,4) = 0._dp 
mat(3,5) = 0._dp 
mat(3,6) = 0._dp 
mat(3,6) = mat(3,6)-(vS*vu*lam*Conjg(y3))/2._dp
mat(3,6) = mat(3,6)+(vd*Conjg(Ty3))/sqrt(2._dp)
mat(4,4) = 0._dp 
mat(4,4) = mat(4,4)-(g1**2*vd**2)/4._dp
mat(4,4) = mat(4,4)+(gp**2*Qe12*QHd*vd**2)/2._dp
mat(4,4) = mat(4,4)+(gp**2*Qe12*Qs*vS**2)/2._dp
mat(4,4) = mat(4,4)+(g1**2*vu**2)/4._dp
mat(4,4) = mat(4,4)+(gp**2*Qe12*QHu*vu**2)/2._dp
mat(4,4) = mat(4,4)+me122(1,1)
Do j1 = 1,2
mat(4,4) = mat(4,4)+(vd**2*Conjg(y12(1,j1))*y12(1,j1))/2._dp
End Do 
mat(4,5) = 0._dp 
mat(4,5) = mat(4,5)+me122(1,2)
Do j1 = 1,2
mat(4,5) = mat(4,5)+(vd**2*Conjg(y12(2,j1))*y12(1,j1))/2._dp
End Do 
mat(4,6) = 0._dp 
mat(5,5) = 0._dp 
mat(5,5) = mat(5,5)-(g1**2*vd**2)/4._dp
mat(5,5) = mat(5,5)+(gp**2*Qe12*QHd*vd**2)/2._dp
mat(5,5) = mat(5,5)+(gp**2*Qe12*Qs*vS**2)/2._dp
mat(5,5) = mat(5,5)+(g1**2*vu**2)/4._dp
mat(5,5) = mat(5,5)+(gp**2*Qe12*QHu*vu**2)/2._dp
mat(5,5) = mat(5,5)+me122(2,2)
Do j1 = 1,2
mat(5,5) = mat(5,5)+(vd**2*Conjg(y12(2,j1))*y12(2,j1))/2._dp
End Do 
mat(5,6) = 0._dp 
mat(6,6) = 0._dp 
mat(6,6) = mat(6,6)+me32
...
mat(6,6) = mat(6,6)+(vd**2*y3*Conjg(y3))/2._dp
...
Subroutine CalculateMFe(y12,y3,vd,ZEL,ZER,MFe,kont)
...
ZER = 0._dp 
mat(1,1) = 0._dp 
mat(1,1) = mat(1,1)+(vd*y12(1,1))/sqrt(2._dp)
mat(1,2) = 0._dp 
mat(1,2) = mat(1,2)+(vd*y12(2,1))/sqrt(2._dp)
mat(1,3) = 0._dp 
mat(2,1) = 0._dp 
mat(2,1) = mat(2,1)+(vd*y12(1,2))/sqrt(2._dp)
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)+(vd*y12(2,2))/sqrt(2._dp)
mat(2,3) = 0._dp 
mat(3,1) = 0._dp 
mat(3,2) = 0._dp 
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+(vd*y3)/sqrt(2._dp)
...
Subroutine CalculateMSvEffPot(g1,g2,gp,Ql,QHd,QHu,Qs,ml122,ml12l32,ml32,              & 
...
Subroutine CalculateMSeEffPot(g1,g2,gp,Ql,QHd,QHu,Qe12,Qe3,Qs,y12,Ty12,               & 
& y3,Ty3,lam,ml122,ml12l32,ml32,me122,me32,Tep,vd,vu,vS,ZE,MSe,MSe2,kont)
...
mat(4,4) = mat(4,4)+(gp**2*Qe12*QHd*vdFix**2)/2._dp
mat(4,4) = mat(4,4)+(gp**2*Qe12*Qs*vSFix**2)/2._dp
mat(4,4) = mat(4,4)+(g1**2*vuFix**2)/4._dp
mat(4,4) = mat(4,4)+(gp**2*Qe12*QHu*vuFix**2)/2._dp
mat(4,4) = mat(4,4)+me122(1,1)
Do j1 = 1,2
mat(4,4) = mat(4,4)+(vd**2*Conjg(y12(1,j1))*y12(1,j1))/2._dp
End Do 
...
mat(5,5) = mat(5,5)+(gp**2*Qe12*QHd*vdFix**2)/2._dp
mat(5,5) = mat(5,5)+(gp**2*Qe12*Qs*vSFix**2)/2._dp
mat(5,5) = mat(5,5)+(g1**2*vuFix**2)/4._dp
mat(5,5) = mat(5,5)+(gp**2*Qe12*QHu*vuFix**2)/2._dp
mat(5,5) = mat(5,5)+me122(2,2)
Do j1 = 1,2
mat(5,5) = mat(5,5)+(vd**2*Conjg(y12(2,j1))*y12(2,j1))/2._dp
End Do 
...
Subroutine CalculateMFeEffPot(y12,y3,vd,ZEL,ZER,MFe,kont)
...
End Module TreeLevelMasses_UNHMSSM 
