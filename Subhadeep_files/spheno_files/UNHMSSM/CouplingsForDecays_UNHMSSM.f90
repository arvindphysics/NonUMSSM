...
Module CouplingsForDecays_UNHMSSM
...
& ZVinput,ZVLinput,ZWinput,ZZinput,betaHinput,g1input,g2input,g3input,gpinput,           & 
...
& Tdpinput,Tepinput,vdinput,vuinput,vSinput,cplAhSdcSd,cplChaFucSdL,cplChaFucSdR,        & 
...
Real(dp),Intent(in) :: g1input,g2input,g3input,gpinput,laminput,Tlaminput,ml32input,mHd2input,               & 
& mHu2input,me32input,ms2input,ml12l32input(2),vdinput,vuinput,vSinput

Complex(dp),Intent(in) :: Ydinput(3,3),y12input(2,2),y3input,Yuinput(3,3),Tdinput(3,3),Ty12input(2,2),          & 
...
Call ParametersToG212(g1,g2,g3,gp,Yd,y12,y3,lam,Yu,Td,Ty12,Ty3,Tlam,Tu,               & 
...
If ((m_in.le.Qin).and.(RunningCouplingsDecays)) Then 
  ...
  dt=tz/50._dp 
  Call odeint(g1D,212,0._dp,tz,deltaM,dt,0._dp,rge212,kont)

End if 
Call GToParameters212(g1D,g1,g2,g3,gp,Yd,y12,y3,lam,Yu,Td,Ty12,Ty3,Tlam,              & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplingAhSdcSdT(gt1,gt2,gt3,Yd,Td,lam,Tdp,vu,vS,ZD,ZA,cplAhSdcSd(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplinghhSdcSdT(gt1,gt2,gt3,g1,g2,gp,Yd,Td,lam,Tdp,vd,vu,vS,ZD,ZH,              & 
& cplhhSdcSd(gt1,gt2,gt3))
...
Do gt1 = 1, 2
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplingHpmSucSdT(gt1,gt2,gt3,g2,Yd,Td,lam,Yu,Tu,Tdp,vd,vu,vS,ZD,ZU,             & 
& ZP,cplHpmSucSd(gt1,gt2,gt3))
...
& Tuinput,mq2input,ml122input,ml32input,mHd2input,mHu2input,md2input,mu2input,           & 
& me122input,me32input,ms2input,ml12l32input,M1input,M2input,M3input,M4input,            & 
& Tdpinput,Tepinput,vdinput,vuinput,vSinput,cplAhSucSu,cplChiFucSuL,cplChiFucSuR,        & 
...
Do gt1 = 1, 6
 Do gt2 = 1, 2
  Do gt3 = 1, 6
Call CouplingSdcHpmcSuT(gt1,gt2,gt3,g2,Yd,Td,lam,Yu,Tu,Tdp,vd,vu,vS,ZD,               & 
& ZU,ZP,cplSdcHpmcSu(gt1,gt2,gt3))
...
& Tuinput,mq2input,ml122input,ml32input,mHd2input,mHu2input,md2input,mu2input,           & 
& me122input,me32input,ms2input,ml12l32input,M1input,M2input,M3input,M4input,            & 
& Tdpinput,Tepinput,vdinput,vuinput,vSinput,cplAhSecSe,cplChaFvcSeL,cplChaFvcSeR,        & 
& cplChiFecSeL,cplChiFecSeR,cplhhSecSe,cplHpmSvcSe,cplSecSeVZ,cplSecSeVZp,               & 
& cplSvcSeVWm,deltaM)
...
& cplChiFecSeR(6,3,6),cplhhSecSe(3,6,6),cplHpmSvcSe(2,3,6),cplSecSeVZ(6,6),              & 
& cplSecSeVZp(6,6),cplSvcSeVWm(3,6)
...
Do gt1 = 1, 3
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplingAhSecSeT(gt1,gt2,gt3,y12,Ty12,y3,Ty3,lam,Tep,vu,vS,ZE,ZA,cplAhSecSe(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplinghhSecSeT(gt1,gt2,gt3,g1,g2,gp,y12,Ty12,y3,Ty3,lam,Tep,vd,vu,             & 
& vS,ZE,ZH,cplhhSecSe(gt1,gt2,gt3))
...
Do gt1 = 1, 2
 Do gt2 = 1, 3
  Do gt3 = 1, 6
Call CouplingHpmSvcSeT(gt1,gt2,gt3,g2,y12,Ty12,y3,Ty3,lam,Tep,vd,vu,vS,               & 
& ZV,ZE,ZP,cplHpmSvcSe(gt1,gt2,gt3))
...
Do gt1 = 1, 2
 Do gt2 = 1, 3
  Do gt3 = 1, 6
Call CouplingChaFvcSeT(gt1,gt2,gt3,g2,y12,y3,ZVL,ZE,UM,cplChaFvcSeL(gt1,gt2,gt3)      & 
...
Do gt1 = 1, 6
 Do gt2 = 1, 3
  Do gt3 = 1, 6
Call CouplingChiFecSeT(gt1,gt2,gt3,g1,g2,gp,y12,y3,ZE,ZN,ZEL,ZER,cplChiFecSeL(gt1,gt2,gt3)& 
...
& Tuinput,mq2input,ml122input,ml32input,mHd2input,mHu2input,md2input,mu2input,           & 
& me122input,me32input,ms2input,ml12l32input,M1input,M2input,M3input,M4input,            & 
& Tdpinput,Tepinput,vdinput,vuinput,vSinput,cplChiFvcSvL,cplChiFvcSvR,cplcChaFecSvL,     & 
...
Complex(dp),Intent(out) :: cplChiFvcSvL(6,3,3),cplChiFvcSvR(6,3,3),cplcChaFecSvL(2,3,3),cplcChaFecSvR(2,3,3),    & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplinghhSvcSvT(gt1,gt2,gt3,g1,g2,gp,vd,vu,vS,ZV,ZH,cplhhSvcSv(gt1,gt2,gt3))
...
Do gt1 = 1, 6
 Do gt2 = 1, 2
  Do gt3 = 1, 3
Call CouplingSecHpmcSvT(gt1,gt2,gt3,g2,y12,Ty12,y3,Ty3,lam,Tep,vd,vu,vS,              & 
& ZV,ZE,ZP,cplSecHpmcSv(gt1,gt2,gt3))
...
Do gt1 = 1, 2
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingcChaFecSvT(gt1,gt2,gt3,g2,y12,y3,ZV,UM,UP,ZEL,ZER,cplcChaFecSvL(gt1,gt2,gt3)& 
...
& Tuinput,mq2input,ml122input,ml32input,mHd2input,mHu2input,md2input,mu2input,           & 
& me122input,me32input,ms2input,ml12l32input,M1input,M2input,M3input,M4input,            & 
& Tdpinput,Tepinput,vdinput,vuinput,vSinput,cplHiggsPP,cplHiggsGG,cplHiggsZZvirt,        & 
...
& cplAhhhVZ(3,3),cplAhhhVZp(3,3),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),              & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingcFeFehhT(gt1,gt2,gt3,y12,y3,ZH,ZEL,ZER,cplcFeFehhL(gt1,gt2,gt3)          & 
...
& Tuinput,mq2input,ml122input,ml32input,mHd2input,mHu2input,md2input,mu2input,           & 
& me122input,me32input,ms2input,ml12l32input,M1input,M2input,M3input,M4input,            & 
& Tdpinput,Tepinput,vdinput,vuinput,vSinput,cplPseudoHiggsPP,cplPseudoHiggsGG,           & 
& cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,           & 
& cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhhhVZ,cplAhhhVZp,      & 
& cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSecSe,cplAhSucSu,deltaM)
...
Complex(dp),Intent(out) :: cplPseudoHiggsPP(3),cplPseudoHiggsGG(3),cplAhAhhh(3,3,3),cplcChaChaAhL(2,2,3),        & 
& cplcChaChaAhR(2,2,3),cplChiChiAhL(6,6,3),cplChiChiAhR(6,6,3),cplcFdFdAhL(3,3,3),       & 
...
& cplAhSdcSd(3,6,6),cplAhSecSe(3,6,6),cplAhSucSu(3,6,6)
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingcFeFeAhT(gt1,gt2,gt3,y12,y3,ZA,ZEL,ZER,cplcFeFeAhL(gt1,gt2,gt3)          & 
...
& Tuinput,mq2input,ml122input,ml32input,mHd2input,mHu2input,md2input,mu2input,           & 
& me122input,me32input,ms2input,ml12l32input,M1input,M2input,M3input,M4input,            & 
& Tdpinput,Tepinput,vdinput,vuinput,vSinput,cplAhHpmcHpm,cplAhcHpmVWm,cplChiChacHpmL,    & 
...
& cplSdcHpmcSu(6,2,6),cplSecHpmcSv(6,2,3),cplcHpmVWmVZ(2),cplcHpmVWmVZp(2)
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 2
Call CouplingcFvFecHpmT(gt1,gt2,gt3,y12,y3,ZVL,ZP,ZER,cplcFvFecHpmL(gt1,gt2,gt3)      & 
...
& Tuinput,mq2input,ml122input,ml32input,mHd2input,mHu2input,md2input,mu2input,           & 
& me122input,me32input,ms2input,ml12l32input,M1input,M2input,M3input,M4input,            & 
& Tdpinput,Tepinput,vdinput,vuinput,vSinput,cplAhhhVZp,cplcChaChaVZpL,cplcChaChaVZpR,    & 
...
& cplSdcSdVZp(6,6),cplSecSeVZp(6,6),cplSucSuVZp(6,6),cplSvcSvVZp(3,3),cplcVWmVWmVZp
...
& Tuinput,mq2input,ml122input,ml32input,mHd2input,mHu2input,md2input,mu2input,           & 
& me122input,me32input,ms2input,ml12l32input,M1input,M2input,M3input,M4input,            & 
& Tdpinput,Tepinput,vdinput,vuinput,vSinput,cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,      & 
& cplGluFucSuR,deltaM)
...
& Tuinput,mq2input,ml122input,ml32input,mHd2input,mHu2input,md2input,mu2input,           & 
& me122input,me32input,ms2input,ml12l32input,M1input,M2input,M3input,M4input,            & 
& Tdpinput,Tepinput,vdinput,vuinput,vSinput,cplChiChiAhL,cplChiChiAhR,cplChiChacHpmL,    & 
...
& Tuinput,mq2input,ml122input,ml32input,mHd2input,mHu2input,md2input,mu2input,           & 
& me122input,me32input,ms2input,ml12l32input,M1input,M2input,M3input,M4input,            & 
& Tdpinput,Tepinput,vdinput,vuinput,vSinput,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,   & 
...
Do gt1 = 1, 2
 Do gt2 = 1, 3
  Do gt3 = 1, 6
Call CouplingcChacFvSeT(gt1,gt2,gt3,g2,y12,y3,ZVL,ZE,UM,cplcChacFvSeL(gt1,gt2,gt3)    & 
...
& Tuinput,mq2input,ml122input,ml32input,mHd2input,mHu2input,md2input,mu2input,           & 
& me122input,me32input,ms2input,ml12l32input,M1input,M2input,M3input,M4input,            & 
& Tdpinput,Tepinput,vdinput,vuinput,vSinput,cplcFuFuAhL,cplcFuFuAhR,cplcFuChiSuL,        & 
...
& Tuinput,mq2input,ml122input,ml32input,mHd2input,mHu2input,md2input,mu2input,           & 
& me122input,me32input,ms2input,ml12l32input,M1input,M2input,M3input,M4input,            & 
& Tdpinput,Tepinput,vdinput,vuinput,vSinput,cplcChacFuSdL,cplcChacFuSdR,cplcChaFdcSuL,   & 
...
& cplcFvChiSvL(3,6,3),cplcFvChiSvR(3,6,3),cplcFvFvVZL(3,3),cplcFvFvVZpL(3,3),            & 
...
& cplChiFvcSvL(6,3,3),cplChiFvcSvR(6,3,3),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6),           & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 2
  Do gt3 = 1, 3
Call CouplingcFeChaSvT(gt1,gt2,gt3,g2,y12,y3,ZV,UM,UP,ZEL,ZER,cplcFeChaSvL(gt1,gt2,gt3)& 
...
Do gt1 = 1, 3
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplingcFeChiSeT(gt1,gt2,gt3,g1,g2,gp,y12,y3,ZE,ZN,ZEL,ZER,cplcFeChiSeL(gt1,gt2,gt3)& 
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 2
Call CouplingcFeFvHpmT(gt1,gt2,gt3,y12,y3,ZVL,ZP,ZER,cplcFeFvHpmL(gt1,gt2,gt3)        & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
Call CouplingcFvFvVZT(gt1,gt2,g1,g2,gp,ZVL,TW,TWp,cplcFvFvVZL(gt1,gt2),               & 
& cplcFvFvVZR(gt1,gt2))
...
& Tuinput,mq2input,ml122input,ml32input,mHd2input,mHu2input,md2input,mu2input,           & 
& me122input,me32input,ms2input,ml12l32input,M1input,M2input,M3input,M4input,            & 
& Tdpinput,Tepinput,vdinput,vuinput,vSinput,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,   & 
...
& cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZpL,cplcFvFvVZpR,cplcFvFvVZR,cplChaFucSdL,          & 
...
& cplcFdFdVZpR(3,3),cplcFdFdVZR(3,3),cplcFeChaSvL(3,2,3),cplcFeChaSvR(3,2,3),            & 
...
& Tuinput,mq2input,ml122input,ml32input,mHd2input,mHu2input,md2input,mu2input,           & 
& me122input,me32input,ms2input,ml12l32input,M1input,M2input,M3input,M4input,            & 
& Tdpinput,Tepinput,vdinput,vuinput,vSinput,cplAhSdcSd,cplcChacFuSdL,cplcChacFuSdR,      & 
...
& cplcFvFvVZpL,cplcFvFvVZpR,cplcFvFvVZR,cplChaFucSdL,cplChaFucSdR,cplChiChacHpmL,        & 
...
& cplChiFvcSvR,cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,cplGluFucSuR,cplhhSdcSd,           & 
...
& Tuinput,mq2input,ml122input,ml32input,mHd2input,mHu2input,md2input,mu2input,           & 
& me122input,me32input,ms2input,ml12l32input,M1input,M2input,M3input,M4input,            & 
& Tdpinput,Tepinput,vdinput,vuinput,vSinput,cplAhSucSu,cplcChacFuSdL,cplcChacFuSdR,      & 
...
& cplChiChihhR,cplChiChiVZL,cplChiChiVZpL,cplChiChiVZpR,cplChiChiVZR,cplChiFdcSdL,       & 
& cplChiFdcSdR,cplChiFecSeL,cplChiFecSeR,cplChiFucSuL,cplChiFucSuR,cplChiFvcSvL,         & 
& cplChiFvcSvR,cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,cplGluFucSuR,cplhhSucSu,           & 
...
& Tuinput,mq2input,ml122input,ml32input,mHd2input,mHu2input,md2input,mu2input,           & 
& me122input,me32input,ms2input,ml12l32input,M1input,M2input,M3input,M4input,            & 
& Tdpinput,Tepinput,vdinput,vuinput,vSinput,cplAhSecSe,cplcChacFuSdL,cplcChacFuSdR,      & 
& cplcChacFvSeL,cplcChacFvSeR,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,   & 
& cplcChaChaVZL,cplcChaChaVZpL,cplcChaChaVZpR,cplcChaChaVZR,cplcChaChiHpmL,              & 
...
& cplcChaChahhR(2,2,3),cplcChaChaVZL(2,2),cplcChaChaVZpL(2,2),cplcChaChaVZpR(2,2),       & 
& cplcChaChaVZR(2,2),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),cplcChaFdcSuL(2,3,6),   & 
& cplcChaFdcSuR(2,3,6),cplcChaFecSvL(2,3,3),cplcChaFecSvR(2,3,3),cplcFdChiSdL(3,6,6),    & 
& cplcFdChiSdR(3,6,6),cplcFdFdAhL(3,3,3),cplcFdFdAhR(3,3,3),cplcFdFdhhL(3,3,3),          & 
& cplcFdFdhhR(3,3,3),cplcFdFdVZL(3,3),cplcFdFdVZpL(3,3),cplcFdFdVZpR(3,3),               & 
& cplcFdFdVZR(3,3),cplcFeChaSvL(3,2,3),cplcFeChaSvR(3,2,3),cplcFeChiSeL(3,6,6),          & 
& cplcFeChiSeR(3,6,6),cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplcFeFehhL(3,3,3),          & 
& cplcFeFehhR(3,3,3),cplcFeFeVZL(3,3),cplcFeFeVZpL(3,3),cplcFeFeVZpR(3,3),               & 
...
& cplcFuFdcVWmR(3,3),cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),cplcFuFuhhL(3,3,3),           & 
& cplcFuFuhhR(3,3,3),cplcFuFuVZL(3,3),cplcFuFuVZpL(3,3),cplcFuFuVZpR(3,3),               & 
& cplcFuFuVZR(3,3),cplcFvChiSvL(3,6,3),cplcFvChiSvR(3,6,3),cplcFvFecHpmL(3,3,2),         & 
...
& cplChiFvcSvR(6,3,3),cplhhSecSe(3,6,6),cplHpmSvcSe(2,3,6),cplSecSeVZ(6,6),              & 
& cplSecSeVZp(6,6),cplSvcSeVWm(3,6)
...
& Tuinput,mq2input,ml122input,ml32input,mHd2input,mHu2input,md2input,mu2input,           & 
& me122input,me32input,ms2input,ml12l32input,M1input,M2input,M3input,M4input,            & 
& Tdpinput,Tepinput,vdinput,vuinput,vSinput,cplcChacFvSeL,cplcChacFvSeR,cplcChaChaAhL,   & 
...
& cplcFeFvVWmL,cplcFeFvVWmR,cplcFuChiSuL,cplcFuChiSuR,cplcFuFuhhL,cplcFuFuhhR,           & 
& cplcFuFuVZL,cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplcFvChiSvL,cplcFvChiSvR,           & 
& cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFvVZL,cplcFvFvVZpL,cplcFvFvVZpR,cplcFvFvVZR,         & 
...
End Module CouplingsForDecays_UNHMSSM
