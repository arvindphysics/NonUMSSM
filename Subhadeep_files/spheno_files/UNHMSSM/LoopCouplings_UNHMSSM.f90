...
! ------------------------------------------------------------------------------  
! File created at 10:35 on 5.3.2019   
! ----------------------------------------------------------------------  
 
 
Module LoopCouplings_UNHMSSM 
...
& MSv,MVWm,MVZp,g1,g2,gp,TW,TWp,UM,UP,vd,vu,y12,y3,ZA,ZE,ZEL,ZER,ZH,ZN,ZP,               & 
& ZV,ZVL,res)
...
Complex(dp),Intent(in) :: UM(2,2),UP(2,2),y12(2,2),y3,ZA(3,3),ZE(6,6),ZEL(3,3),ZER(3,3),ZH(3,3),ZN(6,6),        & 
& ZV(3,3),ZVL(3,3)
...
End Module LoopCouplings_UNHMSSM 
