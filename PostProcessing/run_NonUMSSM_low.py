...
###########################################################################
            ...
            LambdaIN = uniform(3e-3, 0.6) # np.random.normal(2.09166267E-01, 0.1)
            InvLamIN = uniform(-6000., 6000) # np.random.normal(5.12492636E+03, 10.)
            vSIN = uniform(13000., 20000.)  # np.random.normal(1.21591000E+04, 100.)

            Tdp11IN = uniform(-50., 50.) # np.random.normal(5.29566845E-01, 0.1)
            Tdp22IN = uniform(-50., 50.) # np.random.normal(5.29566845E-01, 0.1)
            Tdp33IN = uniform(-50., 50.) # np.random.normal(5.29566845E-01, 0.1) 
            ...
            M1IN = uniform(0., 5000.)  # np.random.normal(5.96741221E+01, 10)  # uniform(-3000., 3000.)
            M2IN = uniform(0., 5000.)  # np.random.normal(2.20167876E+03, 10)  # -1.*np.sign(M1IN)*uniform(0., 3000.)
            M3IN = uniform(0., 5000.)  # np.random.normal(2.79591885E+03, 10)
            M4IN = uniform(-5000., 0.) # np.random.normal(-2.17335959E+03, 10)

            me012 = uniform(1e4, 5000**2)  # np.random.normal(7.46054725E+06, 100000)
            me022 = uniform(me012, 5000**2)  # np.random.normal(8.41835696E+06, 100000) 
            me032 = uniform(me022, 5000**2)  # np.random.normal(8.50282542E+06, 100000)
            ml012 = uniform(1e4, 5000**2) # np.random.normal(2.24287690E+06, 100000) 
            ml022 = uniform(ml012, 5000**2)  # np.random.normal(8.81432832E+06, 100000)
            ml032 = uniform(ml022, 5000**2)  # np.random.normal(8.82332008E+06, 100000)
