...
datafilepath     = os.path.abspath("/scratch/oo1m20/projects/NonUMSSM/data/NonUMSSMv4_LepG2.csv")
...
#                if SLHA.G2Bound() == False: SLHA.Erase(outputfilefullpath)
                ...
                if SLHA.MassBounds() == True and SLHA.CheckBPhysics() == True and SLHA.Check_DAELDAMU_Sig() == True: # SLHA.chi2STU() == True and SLHA.CheckWhoIsLSP() == True
                        ...
                        g.write("%.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %d %6s %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E %.6E" % (SLHA.MZp, SLHA.Zptotalwidth/SLHA.MZp, SLHA.BRZptoll, SLHA.BRZptoqq, SLHA.gpSUSY, SLHA.DAEL, SLHA.DAMU, SLHA.Chi1, SLHA.Chi2, SLHA.Cha1, SLHA.BRCha1toWChi1, SLHA.BRZptoCha1Cha1, SLHA.chi2, SLHA.Sv1, SLHA.tanBeta, SLHA.LambdaInput, SLHA.ALambdaInput, SLHA.vSInput, SLHA.NMIX11, SLHA.NMIX12, SLHA.NMIX13, SLHA.NMIX14, SLHA.NMIX15, SLHA.NMIX16, SLHA.Se1, SLHA.M1, SLHA.M2, SLHA.M3, SLHA.M4, SLHA.Tep, SLHA.Tmup, SLHA.TYe33, SLHA.WhoIsLSP(), SLHA.Calculate_DAELDAMU(), SLHA.Ql1, SLHA.Ql2, SLHA.Qe1, SLHA.Qe2, SLHA.Selectron1, SLHA.Selectron2, SLHA.Smuon1, SLHA.Smuon2, SLHA.Stau1, SLHA.Stau2 ))
                        g.write('\n')
                        g.close()
                else:
