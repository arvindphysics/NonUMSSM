{{{Ah[{gt1}], hh[{gt2}], VZ[{lt3}]}, 
 ...
 {{Se[{gt1}], conj[Sv[{gt2}]], conj[VWm[{lt3}]]}, 
  {((-I)*g2*(conj[ZE[gt1, 1]]*ZV[gt2, 1] + conj[ZE[gt1, 2]]*ZV[gt2, 2] + 
   ...
   VG[{ct3, lt3}]}, {(-I/2)*g3*Lam[ct3, ct2, ct1]*
    sumExp[j1, 1, 6, conj[ZU[gt1, j1]]*ZU[gt2, j1]], 
 ...
 {{Sv[{gt1}], conj[Sv[{gt2}]], VZp[{lt3}]}, 
  {(I/2)*(conj[ZV[gt1, 1]]*(-2*gp*Ql1*Cos[ThetaWp] + 
     ...
     conj[ZV[gt1, 2]]*(-2*gp*Ql2*Cos[ThetaWp] + g2*Cos[ThetaW]*Sin[ThetaWp] + 
       g1*Sin[ThetaW]*Sin[ThetaWp])*ZV[gt2, 2] + conj[ZV[gt1, 3]]*
      (-2*gp*Ql3*Cos[ThetaWp] + g2*Cos[ThetaW]*Sin[ThetaWp] + 
       g1*Sin[ThetaW]*Sin[ThetaWp])*ZV[gt2, 3]), -Mom[conj[Sv[{gt2}]], lt3] + 
    Mom[Sv[{gt1}], lt3]}}}
