{{{bar[Cha[{gt1}]], Cha[{gt2}], Ah[{gt3}]}, 
  ...
  {(g2*conj[ZA[gt3, 1]]*UM[gt1, 2]*UP[gt2, 1] + 
     (g2*conj[ZA[gt3, 2]]*UM[gt1, 1] - \[Lambda]*conj[ZA[gt3, 3]]*UM[gt1, 2])*
      UP[gt2, 2])/Sqrt[2], PR}}, {{Chi[{gt1}], Chi[{gt2}], Ah[{gt3}]}, 
  ...
  {(conj[ZA[gt3, 3]]*(2*gp*Qs*ZN[gt1, 6]*ZN[gt2, 1] + 
       Sqrt[2]*\[Lambda]*ZN[gt1, 5]*ZN[gt2, 4] + Sqrt[2]*\[Lambda]*ZN[gt1, 4]*
        ZN[gt2, 5] + 2*gp*Qs*ZN[gt1, 1]*ZN[gt2, 6]) + 
     conj[ZA[gt3, 2]]*(ZN[gt1, 5]*(2*gp*QHu*ZN[gt2, 1] + g1*ZN[gt2, 2] - 
         g2*ZN[gt2, 3]) + Sqrt[2]*\[Lambda]*ZN[gt1, 6]*ZN[gt2, 4] + 
       2*gp*QHu*ZN[gt1, 1]*ZN[gt2, 5] + g1*ZN[gt1, 2]*ZN[gt2, 5] - 
       g2*ZN[gt1, 3]*ZN[gt2, 5] + Sqrt[2]*\[Lambda]*ZN[gt1, 4]*ZN[gt2, 6]) + 
     conj[ZA[gt3, 1]]*(ZN[gt1, 4]*(2*gp*QHd*ZN[gt2, 1] - g1*ZN[gt2, 2] + 
       ...
       Sqrt[2]*\[Lambda]*ZN[gt1, 6]*ZN[gt2, 5] + Sqrt[2]*\[Lambda]*ZN[gt1, 5]*
        ZN[gt2, 6]))/2, PR}}, {{bar[Fd[{gt1, ct1}]], Fd[{gt2, ct2}], 
   Ah[{gt3}]}, {(conj[ZA[gt3, 1]]*Delta[ct1, ct2]*
     sum[j2, 1, 3, conj[ZDL[gt2, j2]]*sum[j1, 1, 3, conj[ZDR[gt1, j1]]*
         Yd[j1, j2]]])/Sqrt[2], PL}, 
 ...
 {{bar[Fu[{gt1, ct1}]], Fu[{gt2, ct2}], Ah[{gt3}]}, 
  ...
  {-((conj[ZA[gt3, 2]]*Delta[ct1, ct2]*sum[j2, 1, 3, 
   ...
   PR}}, {{Chi[{gt1}], Cha[{gt2}], conj[Hpm[{gt3}]]}, 
  ...
  {(-I/2)*(2*g2*UP[gt2, 1]*ZN[gt1, 5]*ZP[gt3, 2] + 
     UP[gt2, 2]*(2*\[Lambda]*ZN[gt1, 6]*ZP[gt3, 1] + 
       Sqrt[2]*(2*gp*QHu*ZN[gt1, 1] + g1*ZN[gt1, 2] + g2*ZN[gt1, 3])*
        ZP[gt3, 2])), PR}}, {{Cha[{gt1}], Fu[{gt2, ct2}], 
   conj[Sd[{gt3, ct3}]]}, {(-I)*Delta[ct2, ct3]*
    (g2*conj[UM[gt1, 1]]*sum[j1, 1, 3, conj[ZUL[gt2, j1]]*ZD[gt3, j1]] - 
     conj[UM[gt1, 2]]*sum[j2, 1, 3, conj[ZUL[gt2, j2]]*
 ...
 {{bar[Cha[{gt1}]], Cha[{gt2}], hh[{gt3}]}, 
  ...
  {((-I)*(g2*conj[ZH[gt3, 1]]*UM[gt1, 2]*UP[gt2, 1] + 
      (g2*conj[ZH[gt3, 2]]*UM[gt1, 1] + \[Lambda]*conj[ZH[gt3, 3]]*
 ...
 {{bar[Fe[{gt1}]], Cha[{gt2}], Sv[{gt3}]}, 
  {I*conj[UM[gt2, 2]]*(Ye11*conj[ZER[gt1, 1]]*conj[ZV[gt3, 1]] + 
     Ye22*conj[ZER[gt1, 2]]*conj[ZV[gt3, 2]] + Ye33*conj[ZER[gt1, 3]]*
      conj[ZV[gt3, 3]]), PL}, 
  {(-I)*g2*UP[gt2, 1]*(conj[ZV[gt3, 1]]*ZEL[gt1, 1] + 
     conj[ZV[gt3, 2]]*ZEL[gt1, 2] + conj[ZV[gt3, 3]]*ZEL[gt1, 3]), PR}}, 
 {{Chi[{gt1}], Chi[{gt2}], hh[{gt3}]}, 
  ...
  {(-I/2)*(conj[ZH[gt3, 3]]*(2*gp*Qs*ZN[gt1, 6]*ZN[gt2, 1] - 
     ...
     conj[ZH[gt3, 1]]*(ZN[gt1, 4]*(2*gp*QHd*ZN[gt2, 1] - g1*ZN[gt2, 2] + 
       ...
       g1*ZN[gt1, 2]*ZN[gt2, 4] + g2*ZN[gt1, 3]*ZN[gt2, 4] - 
       Sqrt[2]*\[Lambda]*ZN[gt1, 6]*ZN[gt2, 5] - Sqrt[2]*\[Lambda]*ZN[gt1, 5]*
        ZN[gt2, 6])), PR}}, {{Chi[{gt1}], Fd[{gt2, ct2}], 
   conj[Sd[{gt3, ct3}]]}, {(-I/6)*Delta[ct2, ct3]*
    (6*Sqrt[2]*gp*Qq*conj[ZN[gt1, 1]]*sum[j1, 1, 3, conj[ZDL[gt2, j1]]*
        ZD[gt3, j1]] + Sqrt[2]*g1*conj[ZN[gt1, 2]]*
      sum[j1, 1, 3, conj[ZDL[gt2, j1]]*ZD[gt3, j1]] - 
     3*Sqrt[2]*g2*conj[ZN[gt1, 3]]*sum[j1, 1, 3, conj[ZDL[gt2, j1]]*
        ZD[gt3, j1]] + 6*conj[ZN[gt1, 4]]*sum[j2, 1, 3, 
 ...
 {{Chi[{gt1}], Fv[{gt2}], conj[Sv[{gt3}]]}, 
  {((-I)*(-((g1*conj[ZN[gt1, 2]] - g2*conj[ZN[gt1, 3]])*
        (conj[ZVL[gt2, 1]]*ZV[gt3, 1] + conj[ZVL[gt2, 2]]*ZV[gt3, 2] + 
         conj[ZVL[gt2, 3]]*ZV[gt3, 3])) + 2*gp*conj[ZN[gt1, 1]]*
       (Ql1*conj[ZVL[gt2, 1]]*ZV[gt3, 1] + Ql2*conj[ZVL[gt2, 2]]*ZV[gt3, 2] + 
        Ql3*conj[ZVL[gt2, 3]]*ZV[gt3, 3])))/Sqrt[2], PL}, {0, PR}}, 
 ...
 {{bar[Fv[{gt1}]], Chi[{gt2}], Sv[{gt3}]}, {0, PL}, 
  {((-I)*(conj[ZV[gt3, 1]]*(2*gp*Ql1*ZN[gt2, 1] - g1*ZN[gt2, 2] + 
        g2*ZN[gt2, 3])*ZVL[gt1, 1] + conj[ZV[gt3, 2]]*(2*gp*Ql2*ZN[gt2, 1] - 
        g1*ZN[gt2, 2] + g2*ZN[gt2, 3])*ZVL[gt1, 2] + 
      conj[ZV[gt3, 3]]*(2*gp*Ql3*ZN[gt2, 1] - g1*ZN[gt2, 2] + g2*ZN[gt2, 3])*
       ZVL[gt1, 3]))/Sqrt[2], PR}}, 
 ...
 {{bar[Cha[{gt1}]], Fe[{gt2}], conj[Sv[{gt3}]]}, 
  {(-I)*g2*conj[UP[gt1, 1]]*(conj[ZEL[gt2, 1]]*ZV[gt3, 1] + 
     conj[ZEL[gt2, 2]]*ZV[gt3, 2] + conj[ZEL[gt2, 3]]*ZV[gt3, 3]), PL}, 
  {I*UM[gt1, 2]*(conj[Ye11]*ZER[gt2, 1]*ZV[gt3, 1] + 
     conj[Ye22]*ZER[gt2, 2]*ZV[gt3, 2] + conj[Ye33]*ZER[gt2, 3]*ZV[gt3, 3]), 
   PR}}, {{bar[Fv[{gt1}]], Fe[{gt2}], conj[Hpm[{gt3}]]}, {0, PL}, 
  {I*ZP[gt3, 1]*(conj[Ye11]*ZER[gt2, 1]*ZVL[gt1, 1] + 
 ...
 {{bar[Fd[{gt1, ct1}]], Fu[{gt2, ct2}], Hpm[{gt3}]}, 
  ...
  {I*(Ye11*conj[ZER[gt1, 1]]*conj[ZVL[gt2, 1]] + Ye22*conj[ZER[gt1, 2]]*
    ...
    ZP[gt3, 1], PL}, {0, PR}}, {{bar[Fd[{gt1, ct1}]], Glu[{ct2}], 
   Sd[{gt3, ct3}]}, {(I*g3*PhaseGlu*Lam[ct2, ct1, ct3]*
     sum[j1, 1, 3, conj[ZD[gt3, 3 + j1]]*conj[ZDR[gt1, j1]]])/Sqrt[2], PL}, 
