{{{Ah[{gt1}], Ah[{gt2}], hh[{gt3}]}, 
  {(-I/4)*(2*conj[ZA[gt1, 3]]*(2*conj[ZA[gt2, 3]]*
        (vd*(gp^2*QHd*Qs + \[Lambda]^2)*conj[ZH[gt3, 1]] + 
         vu*(gp^2*QHu*Qs + \[Lambda]^2)*conj[ZH[gt3, 2]] + 
         gp^2*Qs^2*vS*conj[ZH[gt3, 3]]) + 
       Sqrt[2]*(conj[ZA[gt2, 2]]*conj[ZH[gt3, 1]] + conj[ZA[gt2, 1]]*
          conj[ZH[gt3, 2]])*T[\[Lambda]]) + conj[ZA[gt1, 2]]*
      (conj[ZA[gt2, 2]]*(-(vd*(g1^2 + g2^2 - 4*(gp^2*QHd*QHu + \[Lambda]^2))*
           conj[ZH[gt3, 1]]) + (g1^2 + g2^2 + 4*gp^2*QHu^2)*vu*
          conj[ZH[gt3, 2]] + 4*vS*(gp^2*QHu*Qs + \[Lambda]^2)*
          conj[ZH[gt3, 3]]) + 2*Sqrt[2]*(conj[ZA[gt2, 3]]*conj[ZH[gt3, 1]] + 
         conj[ZA[gt2, 1]]*conj[ZH[gt3, 3]])*T[\[Lambda]]) + 
     conj[ZA[gt1, 1]]*(conj[ZA[gt2, 1]]*((g1^2 + g2^2 + 4*gp^2*QHd^2)*vd*
          conj[ZH[gt3, 1]] - vu*(g1^2 + g2^2 - 4*(gp^2*QHd*QHu + 
             \[Lambda]^2))*conj[ZH[gt3, 2]] + 
         4*vS*(gp^2*QHd*Qs + \[Lambda]^2)*conj[ZH[gt3, 3]]) + 
       2*Sqrt[2]*(conj[ZA[gt2, 3]]*conj[ZH[gt3, 2]] + conj[ZA[gt2, 2]]*
          conj[ZH[gt3, 3]])*T[\[Lambda]])), 1}}, 
 {{Ah[{gt1}], Hpm[{gt2}], conj[Hpm[{gt3}]]}, 
  {((vu*(g2^2 - 2*\[Lambda]^2)*conj[ZA[gt1, 1]] + vd*(g2^2 - 2*\[Lambda]^2)*
       conj[ZA[gt1, 2]] - 2*Sqrt[2]*conj[ZA[gt1, 3]]*T[\[Lambda]])*
     (ZP[gt2, 2]*ZP[gt3, 1] - ZP[gt2, 1]*ZP[gt3, 2]))/4, 1}}, 
 {{Ah[{gt1}], Sd[{gt2, ct2}], conj[Sd[{gt3, ct3}]]}, 
  {(Delta[ct2, ct3]*(vu*\[Lambda]*conj[ZA[gt1, 3]]*
       (sum[j2, 1, 3, conj[ZD[gt2, j2]]*sum[j1, 1, 3, Yd[j1, j2]*
            ZD[gt3, 3 + j1]]] - sum[j2, 1, 3, 
         sum[j1, 1, 3, conj[Yd[j1, j2]]*conj[ZD[gt2, 3 + j1]]]*
          ZD[gt3, j2]]) + conj[ZA[gt1, 2]]*
       (Sqrt[2]*sum[j2, 1, 3, conj[ZD[gt2, j2]]*sum[j1, 1, 3, 
            Tdp[j1, j2]*ZD[gt3, 3 + j1]]] + vS*\[Lambda]*
         sum[j2, 1, 3, conj[ZD[gt2, j2]]*sum[j1, 1, 3, Yd[j1, j2]*
             ZD[gt3, 3 + j1]]] - Sqrt[2]*sum[j2, 1, 3, 
          sum[j1, 1, 3, conj[Tdp[j1, j2]]*conj[ZD[gt2, 3 + j1]]]*
           ZD[gt3, j2]] - vS*\[Lambda]*sum[j2, 1, 3, 
          sum[j1, 1, 3, conj[Yd[j1, j2]]*conj[ZD[gt2, 3 + j1]]]*
  ...
  {(-(Sqrt[2]*conj[T[Ye11]]*conj[ZA[gt1, 1]]*conj[ZE[gt2, 4]]*ZE[gt3, 1]) - 
     ...
     vS*Ye11*\[Lambda]*conj[ZA[gt1, 2]]*conj[ZE[gt2, 1]]*ZE[gt3, 4] + 
     vu*Ye11*\[Lambda]*conj[ZA[gt1, 3]]*conj[ZE[gt2, 1]]*ZE[gt3, 4] + 
     Sqrt[2]*conj[ZA[gt1, 1]]*conj[ZE[gt2, 1]]*T[Ye11]*ZE[gt3, 4] + 
     Sqrt[2]*Tmup*conj[ZA[gt1, 2]]*conj[ZE[gt2, 2]]*ZE[gt3, 5] + 
     vS*Ye22*\[Lambda]*conj[ZA[gt1, 2]]*conj[ZE[gt2, 2]]*ZE[gt3, 5] + 
     vu*Ye22*\[Lambda]*conj[ZA[gt1, 3]]*conj[ZE[gt2, 2]]*ZE[gt3, 5] + 
     Sqrt[2]*conj[ZA[gt1, 1]]*conj[ZE[gt2, 2]]*T[Ye22]*ZE[gt3, 5] + 
     vS*Ye33*\[Lambda]*conj[ZA[gt1, 2]]*conj[ZE[gt2, 3]]*ZE[gt3, 6] + 
     vu*Ye33*\[Lambda]*conj[ZA[gt1, 3]]*conj[ZE[gt2, 3]]*ZE[gt3, 6] + 
     Sqrt[2]*conj[ZA[gt1, 1]]*conj[ZE[gt2, 3]]*T[Ye33]*ZE[gt3, 6])/2, 1}}, 
 {{Ah[{gt1}], Su[{gt2, ct2}], conj[Su[{gt3, ct3}]]}, 
  {(Delta[ct2, ct3]*(vS*\[Lambda]*conj[ZA[gt1, 1]]*
       (sum[j2, 1, 3, conj[ZU[gt2, j2]]*sum[j1, 1, 3, Yu[j1, j2]*
            ZU[gt3, 3 + j1]]] - sum[j2, 1, 3, 
         sum[j1, 1, 3, conj[Yu[j1, j2]]*conj[ZU[gt2, 3 + j1]]]*
          ZU[gt3, j2]]) + vd*\[Lambda]*conj[ZA[gt1, 3]]*
       (sum[j2, 1, 3, conj[ZU[gt2, j2]]*sum[j1, 1, 3, Yu[j1, j2]*
            ZU[gt3, 3 + j1]]] - sum[j2, 1, 3, 
         sum[j1, 1, 3, conj[Yu[j1, j2]]*conj[ZU[gt2, 3 + j1]]]*
       ...
       (sum[j2, 1, 3, conj[ZU[gt2, j2]]*sum[j1, 1, 3, ZU[gt3, 3 + j1]*
         ...
         sum[j1, 1, 3, conj[ZU[gt2, 3 + j1]]*conj[T[Yu][j1, j2]]]*
          ZU[gt3, j2]])))/2, 1}}, {{hh[{gt1}], hh[{gt2}], hh[{gt3}]}, 
  {(-I/4)*(2*conj[ZH[gt1, 3]]*(2*conj[ZH[gt2, 3]]*
        (vd*(gp^2*QHd*Qs + \[Lambda]^2)*conj[ZH[gt3, 1]] + 
         vu*(gp^2*QHu*Qs + \[Lambda]^2)*conj[ZH[gt3, 2]] + 
         3*gp^2*Qs^2*vS*conj[ZH[gt3, 3]]) + conj[ZH[gt2, 2]]*
        (2*vS*(gp^2*QHu*Qs + \[Lambda]^2)*conj[ZH[gt3, 2]] + 
         2*vu*(gp^2*QHu*Qs + \[Lambda]^2)*conj[ZH[gt3, 3]] - 
         Sqrt[2]*conj[ZH[gt3, 1]]*T[\[Lambda]]) + conj[ZH[gt2, 1]]*
        (2*vS*(gp^2*QHd*Qs + \[Lambda]^2)*conj[ZH[gt3, 1]] + 
         2*vd*(gp^2*QHd*Qs + \[Lambda]^2)*conj[ZH[gt3, 3]] - 
         Sqrt[2]*conj[ZH[gt3, 2]]*T[\[Lambda]])) + 
     conj[ZH[gt1, 2]]*(conj[ZH[gt2, 2]]*
        (-(vd*(g1^2 + g2^2 - 4*(gp^2*QHd*QHu + \[Lambda]^2))*
           conj[ZH[gt3, 1]]) + 3*(g1^2 + g2^2 + 4*gp^2*QHu^2)*vu*
          conj[ZH[gt3, 2]] + 4*vS*(gp^2*QHu*Qs + \[Lambda]^2)*
          conj[ZH[gt3, 3]]) + 2*conj[ZH[gt2, 3]]*
        (2*vS*(gp^2*QHu*Qs + \[Lambda]^2)*conj[ZH[gt3, 2]] + 
         2*vu*(gp^2*QHu*Qs + \[Lambda]^2)*conj[ZH[gt3, 3]] - 
         Sqrt[2]*conj[ZH[gt3, 1]]*T[\[Lambda]]) - conj[ZH[gt2, 1]]*
        (vu*(g1^2 + g2^2 - 4*(gp^2*QHd*QHu + \[Lambda]^2))*conj[ZH[gt3, 1]] + 
         vd*(g1^2 + g2^2 - 4*(gp^2*QHd*QHu + \[Lambda]^2))*conj[ZH[gt3, 2]] + 
         2*Sqrt[2]*conj[ZH[gt3, 3]]*T[\[Lambda]])) + 
     conj[ZH[gt1, 1]]*(conj[ZH[gt2, 1]]*(3*(g1^2 + g2^2 + 4*gp^2*QHd^2)*vd*
          conj[ZH[gt3, 1]] - vu*(g1^2 + g2^2 - 4*(gp^2*QHd*QHu + 
             \[Lambda]^2))*conj[ZH[gt3, 2]] + 
         4*vS*(gp^2*QHd*Qs + \[Lambda]^2)*conj[ZH[gt3, 3]]) + 
       2*conj[ZH[gt2, 3]]*(2*vS*(gp^2*QHd*Qs + \[Lambda]^2)*
          conj[ZH[gt3, 1]] + 2*vd*(gp^2*QHd*Qs + \[Lambda]^2)*
          conj[ZH[gt3, 3]] - Sqrt[2]*conj[ZH[gt3, 2]]*T[\[Lambda]]) - 
       conj[ZH[gt2, 2]]*(vu*(g1^2 + g2^2 - 4*(gp^2*QHd*QHu + \[Lambda]^2))*
          conj[ZH[gt3, 1]] + vd*(g1^2 + g2^2 - 4*(gp^2*QHd*QHu + 
             \[Lambda]^2))*conj[ZH[gt3, 2]] + 2*Sqrt[2]*conj[ZH[gt3, 3]]*
          T[\[Lambda]]))), 1}}, {{hh[{gt1}], Hpm[{gt2}], conj[Hpm[{gt3}]]}, 
  {(-I/4)*(conj[ZH[gt1, 2]]*(ZP[gt2, 2]*(vd*(g2^2 - 2*\[Lambda]^2)*
          ZP[gt3, 1] + (g1^2 + g2^2 + 4*gp^2*QHu^2)*vu*ZP[gt3, 2]) + 
       ZP[gt2, 1]*((-g1^2 + g2^2 + 4*gp^2*QHd*QHu)*vu*ZP[gt3, 1] + 
         vd*(g2^2 - 2*\[Lambda]^2)*ZP[gt3, 2])) + 
     conj[ZH[gt1, 1]]*(ZP[gt2, 2]*(vu*(g2^2 - 2*\[Lambda]^2)*ZP[gt3, 1] + 
         (-g1^2 + g2^2 + 4*gp^2*QHd*QHu)*vd*ZP[gt3, 2]) + 
       ZP[gt2, 1]*((g1^2 + g2^2 + 4*gp^2*QHd^2)*vd*ZP[gt3, 1] + 
         vu*(g2^2 - 2*\[Lambda]^2)*ZP[gt3, 2])) + 2*conj[ZH[gt1, 3]]*
      (ZP[gt2, 2]*(Sqrt[2]*T[\[Lambda]]*ZP[gt3, 1] + 
         2*vS*(gp^2*QHu*Qs + \[Lambda]^2)*ZP[gt3, 2]) + 
       ZP[gt2, 1]*(2*vS*(gp^2*QHd*Qs + \[Lambda]^2)*ZP[gt3, 1] + 
 ...
 {{hh[{gt1}], Sd[{gt2, ct2}], conj[Sd[{gt3, ct3}]]}, 
  {(I/12)*Delta[ct2, ct3]*(6*conj[ZH[gt1, 3]]*
      (-2*gp^2*Qq*Qs*vS*sum[j1, 1, 3, conj[ZD[gt2, j1]]*ZD[gt3, j1]] - 
       ...
       vu*\[Lambda]*(sum[j2, 1, 3, conj[ZD[gt2, j2]]*sum[j1, 1, 3, 
            Yd[j1, j2]*ZD[gt3, 3 + j1]]] + sum[j2, 1, 3, 
          sum[j1, 1, 3, conj[Yd[j1, j2]]*conj[ZD[gt2, 3 + j1]]]*
           ZD[gt3, j2]])) - conj[ZH[gt1, 2]]*
      ((g1^2 + 3*(g2^2 + 4*gp^2*QHu*Qq))*vu*sum[j1, 1, 3, 
         conj[ZD[gt2, j1]]*ZD[gt3, j1]] + 
       2*((g1^2 + 6*gp^2*Qd*QHu)*vu*sum[j1, 1, 3, conj[ZD[gt2, 3 + j1]]*
            ZD[gt3, 3 + j1]] - 3*(Sqrt[2]*sum[j2, 1, 3, conj[ZD[gt2, j2]]*
              sum[j1, 1, 3, Tdp[j1, j2]*ZD[gt3, 3 + j1]]] + 
           vS*\[Lambda]*sum[j2, 1, 3, conj[ZD[gt2, j2]]*sum[j1, 1, 3, 
               Yd[j1, j2]*ZD[gt3, 3 + j1]]] + Sqrt[2]*sum[j2, 1, 3, 
             sum[j1, 1, 3, conj[Tdp[j1, j2]]*conj[ZD[gt2, 3 + j1]]]*
              ZD[gt3, j2]] + vS*\[Lambda]*sum[j2, 1, 3, 
             sum[j1, 1, 3, conj[Yd[j1, j2]]*conj[ZD[gt2, 3 + j1]]]*
              ZD[gt3, j2]]))) + conj[ZH[gt1, 1]]*
      ((g1^2 + 3*(g2^2 - 4*gp^2*QHd*Qq))*vd*sum[j1, 1, 3, 
       ...
       2*((g1^2 - 6*gp^2*Qd*QHd)*vd*sum[j1, 1, 3, conj[ZD[gt2, 3 + j1]]*
           ...
           2*vd*(sum[j3, 1, 3, conj[ZD[gt2, 3 + j3]]*sum[j2, 1, 3, 
                sum[j1, 1, 3, conj[Yd[j3, j1]]*Yd[j2, j1]]*ZD[gt3, 
                  3 + j2]]] + sum[j3, 1, 3, sum[j2, 1, 3, conj[ZD[gt2, j2]]*
                 sum[j1, 1, 3, conj[Yd[j1, j3]]*Yd[j1, j2]]]*ZD[gt3, 
                j3]]))))), 1}}, {{hh[{gt1}], Se[{gt2}], conj[Se[{gt3}]]}, 
  {(-I/4)*(2*Sqrt[2]*conj[T[Ye11]]*conj[ZE[gt2, 4]]*conj[ZH[gt1, 1]]*
     ...
     conj[ZE[gt2, 1]]*(2*conj[ZH[gt1, 3]]*(2*gp^2*Ql1*Qs*vS*ZE[gt3, 1] - 
         vu*Ye11*\[Lambda]*ZE[gt3, 4]) + conj[ZH[gt1, 2]]*
        ((-g1^2 + g2^2 + 4*gp^2*QHu*Ql1)*vu*ZE[gt3, 1] - 
         2*(Sqrt[2]*Tep + vS*Ye11*\[Lambda])*ZE[gt3, 4]) + 
     ...
     2*vS*Ye22*\[Lambda]*conj[ZE[gt2, 2]]*conj[ZH[gt1, 2]]*ZE[gt3, 5] + 
     2*g1^2*vu*conj[ZE[gt2, 5]]*conj[ZH[gt1, 2]]*ZE[gt3, 5] + 
     4*gp^2*Qe2*QHu*vu*conj[ZE[gt2, 5]]*conj[ZH[gt1, 2]]*ZE[gt3, 5] - 
     2*vu*Ye22*\[Lambda]*conj[ZE[gt2, 2]]*conj[ZH[gt1, 3]]*ZE[gt3, 5] + 
     ...
     2*vS*Ye33*\[Lambda]*conj[ZE[gt2, 3]]*conj[ZH[gt1, 2]]*ZE[gt3, 6] + 
     2*g1^2*vu*conj[ZE[gt2, 6]]*conj[ZH[gt1, 2]]*ZE[gt3, 6] + 
     4*gp^2*Qe3*QHu*vu*conj[ZE[gt2, 6]]*conj[ZH[gt1, 2]]*ZE[gt3, 6] - 
     2*vu*Ye33*\[Lambda]*conj[ZE[gt2, 3]]*conj[ZH[gt1, 3]]*ZE[gt3, 6] + 
 ...
 {{hh[{gt1}], Su[{gt2, ct2}], conj[Su[{gt3, ct3}]]}, 
  {(I/12)*Delta[ct2, ct3]*(6*conj[ZH[gt1, 3]]*
      (-2*gp^2*Qq*Qs*vS*sum[j1, 1, 3, conj[ZU[gt2, j1]]*ZU[gt3, j1]] - 
       ...
       vd*\[Lambda]*(sum[j2, 1, 3, conj[ZU[gt2, j2]]*sum[j1, 1, 3, 
            Yu[j1, j2]*ZU[gt3, 3 + j1]]] + sum[j2, 1, 3, 
          sum[j1, 1, 3, conj[Yu[j1, j2]]*conj[ZU[gt2, 3 + j1]]]*
           ZU[gt3, j2]])) + conj[ZH[gt1, 1]]*
      ((g1^2 - 3*(g2^2 + 4*gp^2*QHd*Qq))*vd*sum[j1, 1, 3, 
         conj[ZU[gt2, j1]]*ZU[gt3, j1]] - 4*(g1^2 + 3*gp^2*QHd*Qu)*vd*
        sum[j1, 1, 3, conj[ZU[gt2, 3 + j1]]*ZU[gt3, 3 + j1]] + 
       6*vS*\[Lambda]*(sum[j2, 1, 3, conj[ZU[gt2, j2]]*sum[j1, 1, 3, 
            Yu[j1, j2]*ZU[gt3, 3 + j1]]] + sum[j2, 1, 3, 
          sum[j1, 1, 3, conj[Yu[j1, j2]]*conj[ZU[gt2, 3 + j1]]]*
           ZU[gt3, j2]])) - conj[ZH[gt1, 2]]*
      ((g1^2 - 3*g2^2 + 12*gp^2*QHu*Qq)*vu*sum[j1, 1, 3, 
         conj[ZU[gt2, j1]]*ZU[gt3, j1]] + 
       2*(-2*(g1^2 - 3*gp^2*QHu*Qu)*vu*sum[j1, 1, 3, conj[ZU[gt2, 3 + j1]]*
            ZU[gt3, 3 + j1]] + 3*(Sqrt[2]*sum[j2, 1, 3, conj[ZU[gt2, j2]]*
           ...
           2*vu*(sum[j3, 1, 3, conj[ZU[gt2, 3 + j3]]*sum[j2, 1, 3, 
                sum[j1, 1, 3, conj[Yu[j3, j1]]*Yu[j2, j1]]*ZU[gt3, 
                  3 + j2]]] + sum[j3, 1, 3, sum[j2, 1, 3, conj[ZU[gt2, j2]]*
                 sum[j1, 1, 3, conj[Yu[j1, j3]]*Yu[j1, j2]]]*ZU[gt3, 
                j3]]))))), 1}}, {{hh[{gt1}], Sv[{gt2}], conj[Sv[{gt3}]]}, 
  {(-I/4)*(4*gp^2*Qs*vS*conj[ZH[gt1, 3]]*(Ql1*conj[ZV[gt2, 1]]*ZV[gt3, 1] + 
       Ql2*conj[ZV[gt2, 2]]*ZV[gt3, 2] + Ql3*conj[ZV[gt2, 3]]*ZV[gt3, 3]) + 
     vd*conj[ZH[gt1, 1]]*((g1^2 + g2^2 + 4*gp^2*QHd*Ql1)*conj[ZV[gt2, 1]]*
        ZV[gt3, 1] + (g1^2 + g2^2 + 4*gp^2*QHd*Ql2)*conj[ZV[gt2, 2]]*
        ZV[gt3, 2] + (g1^2 + g2^2 + 4*gp^2*QHd*Ql3)*conj[ZV[gt2, 3]]*
        ZV[gt3, 3]) - vu*conj[ZH[gt1, 2]]*((g1^2 + g2^2 - 4*gp^2*QHu*Ql1)*
        conj[ZV[gt2, 1]]*ZV[gt3, 1] + (g1^2 + g2^2 - 4*gp^2*QHu*Ql2)*
        conj[ZV[gt2, 2]]*ZV[gt3, 2] + (g1^2 + g2^2 - 4*gp^2*QHu*Ql3)*
        conj[ZV[gt2, 3]]*ZV[gt3, 3])), 1}}, 
  ...
  {(-I/4)*Delta[ct2, ct3]*(Sqrt[2]*g2^2*sum[j1, 1, 3, 
     ...
     2*(2*sum[j2, 1, 3, conj[ZU[gt2, j2]]*sum[j1, 1, 3, ZD[gt3, 3 + j1]*
       ...
       Sqrt[2]*vd*sum[j3, 1, 3, sum[j2, 1, 3, conj[ZU[gt2, j2]]*
        ...
        ZP[gt1, 1] + 2*sum[j2, 1, 3, conj[ZU[gt2, j2]]*sum[j1, 1, 3, 
           Tdp[j1, j2]*ZD[gt3, 3 + j1]]]*ZP[gt1, 2] + 
       Sqrt[2]*vS*\[Lambda]*sum[j2, 1, 3, conj[ZU[gt2, j2]]*
          sum[j1, 1, 3, Yd[j1, j2]*ZD[gt3, 3 + j1]]]*ZP[gt1, 2] + 
 ...
 {{Hpm[{gt1}], Sv[{gt2}], conj[Se[{gt3}]]}, 
  {(-I/4)*(conj[ZV[gt2, 3]]*(Sqrt[2]*ZE[gt3, 3]*
        (vd*(g2^2 - 2*Ye33*conj[Ye33])*ZP[gt1, 1] + g2^2*vu*ZP[gt1, 2]) - 
       2*ZE[gt3, 6]*(2*T[Ye33]*ZP[gt1, 1] + Sqrt[2]*vS*Ye33*\[Lambda]*
          ZP[gt1, 2])) + conj[ZV[gt2, 1]]*
      (Sqrt[2]*ZE[gt3, 1]*(vd*(g2^2 - 2*Ye11*conj[Ye11])*ZP[gt1, 1] + 
         g2^2*vu*ZP[gt1, 2]) - 2*ZE[gt3, 4]*(2*T[Ye11]*ZP[gt1, 1] + 
         (2*Tep + Sqrt[2]*vS*Ye11*\[Lambda])*ZP[gt1, 2])) + 
     conj[ZV[gt2, 2]]*(Sqrt[2]*ZE[gt3, 2]*(vd*(g2^2 - 2*Ye22*conj[Ye22])*
          ZP[gt1, 1] + g2^2*vu*ZP[gt1, 2]) - 2*ZE[gt3, 5]*
        (2*T[Ye22]*ZP[gt1, 1] + (2*Tmup + Sqrt[2]*vS*Ye22*\[Lambda])*
          ZP[gt1, 2]))), 1}}, {{Sd[{gt1, ct1}], conj[Hpm[{gt2}]], 
   conj[Su[{gt3, ct3}]]}, {(-I/4)*Delta[ct1, ct3]*
    (Sqrt[2]*g2^2*sum[j1, 1, 3, conj[ZD[gt1, j1]]*ZU[gt3, j1]]*
      (vd*ZP[gt2, 1] + vu*ZP[gt2, 2]) - 
     2*(Sqrt[2]*vS*\[Lambda]*sum[j2, 1, 3, conj[ZD[gt1, j2]]*
       ...
       2*sum[j2, 1, 3, conj[ZD[gt1, j2]]*sum[j1, 1, 3, ZU[gt3, 3 + j1]*
            T[Yu][j1, j2]]]*ZP[gt2, 2] + 
       2*sum[j2, 1, 3, sum[j1, 1, 3, conj[Tdp[j1, j2]]*conj[ZD[gt1, 3 + j1]]]*
          ZU[gt3, j2]]*ZP[gt2, 2] + Sqrt[2]*vS*\[Lambda]*
  ...
  {(-I/4)*(-4*conj[T[Ye11]]*conj[ZE[gt1, 4]]*ZP[gt2, 1]*ZV[gt3, 1] - 
     ...
     2*Sqrt[2]*vS*\[Lambda]*conj[Ye11]*conj[ZE[gt1, 4]]*ZP[gt2, 2]*
      ZV[gt3, 1] + Sqrt[2]*conj[ZE[gt1, 1]]*
      (vd*(g2^2 - 2*Ye11*conj[Ye11])*ZP[gt2, 1] + g2^2*vu*ZP[gt2, 2])*
