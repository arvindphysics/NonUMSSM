...
! ------------------------------------------------------------------------------  
! File created at 0:35 on 10.2.2021   
! ----------------------------------------------------------------------  
 
 
Module LowEnergy_NonUMSSM 
Use Control 
Use Settings 
...
Use StandardModel 
Use RunSM_NonUMSSM
Use FlavorKit_LFV_NonUMSSM
Use FlavorKit_QFV_NonUMSSM
Use FlavorKit_Observables_NonUMSSM
...
& Ydinput,Ye11input,Ye22input,Ye33input,laminput,Yuinput,Tdinput,TYe11input,             & 
& TYe22input,TYe33input,Tlaminput,Tuinput,mq2input,ml012input,ml022input,ml032input,     & 
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,ms2input,       & 
& M1input,M2input,M3input,M4input,Tdpinput,Tepinput,Tmupinput,vdinput,vuinput,           & 
...
Real(dp),Intent(inout) :: g1input,g2input,g3input,gpinput,laminput,Tlaminput,ml012input,ml022input,             & 
& ml032input,mHd2input,mHu2input,me012input,me022input,me032input,ms2input,              & 
& vdinput,vuinput,vSinput

Complex(dp),Intent(inout) :: Ydinput(3,3),Ye11input,Ye22input,Ye33input,Yuinput(3,3),Tdinput(3,3),TYe11input,      & 
& TYe22input,TYe33input,Tuinput(3,3),mq2input(3,3),md2input(3,3),mu2input(3,3),          & 
& M1input,M2input,M3input,M4input,Tdpinput(3,3),Tepinput,Tmupinput
...
Real(dp) :: g1,g2,g3,gp,lam,Tlam,ml012,ml022,ml032,mHd2,mHu2,me012,me022,me032,ms2,vd,vu,vS
...
& Ye11input,Ye22input,Ye33input,laminput,Yuinput,Tdinput,TYe11input,TYe22input,          & 
& TYe33input,Tlaminput,Tuinput,mq2input,ml012input,ml022input,ml032input,mHd2input,      & 
& mHu2input,md2input,mu2input,me012input,me022input,me032input,ms2input,M1input,         & 
& M2input,M3input,M4input,Tdpinput,Tepinput,Tmupinput,vdinput,vuinput,vSinput,           & 
& g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yu,Td,TYe11,TYe22,TYe33,Tlam,Tu,mq2,ml012,           & 
& ml022,ml032,mHd2,mHu2,md2,mu2,me012,me022,me032,ms2,M1,M2,M3,M4,Tdp,Tep,               & 
& Tmup,vd,vu,vS,CKM_160,sinW2_160,Alpha_160,AlphaS_160,.false.)
...
MHpm(1)=MVWm
MHpm2(1)=MVWm2
Call AllCouplings(g1,g2,gp,lam,Tlam,vd,vu,vS,ZH,ZA,ZP,Yd,Td,Tdp,ZD,Ye11,              & 
& TYe11,Ye22,TYe22,Ye33,TYe33,Tep,Tmup,ZE,Yu,Tu,ZU,ZV,TW,TWp,g3,UM,UP,ZN,ZDL,            & 
...
& cplHpmSucSd,cplHpmSvcSe,cplSdcHpmcSu,cplSecHpmcSv,cplAhhhVZ,cplAhhhVZp,cplAhHpmcVWm,   & 
...
& cplVGVGVG,cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,cplcChaChaAhL,cplcChaChaAhR,         & 
...
If (MatchingOrder.gt.-1) Then 
Call RunSM_and_SUSY_RGEs(mz,g1input,g2input,g3input,gpinput,Ydinput,Ye11input,        & 
& Ye22input,Ye33input,laminput,Yuinput,Tdinput,TYe11input,TYe22input,TYe33input,         & 
& Tlaminput,Tuinput,mq2input,ml012input,ml022input,ml032input,mHd2input,mHu2input,       & 
& md2input,mu2input,me012input,me022input,me032input,ms2input,M1input,M2input,           & 
& M3input,M4input,Tdpinput,Tepinput,Tmupinput,vdinput,vuinput,vSinput,g1,g2,             & 
...
sinW2=0.22290_dp 
TW = asin(sqrt(sinW2)) 
mW2=(1._dp-sinW2)*mz2 + (g2**2*(-((vd**2 + vu**2)*Cos(TWp)**2) + ((g1**2 + g2**2)*(vd**2 + vu**2) - 4*gp**2*(QHd**2*vd**2 + Qs**2*vS**2 + QHu**2*vu**2)*Sin(TWp)**2)/(g1**2 + g2**2) - (2*gp*(QHd*vd**2 - QHu*vu**2)*Sin(2._dp*(TWp)))/Sqrt(g1**2 + g2**2)))/4._dp
