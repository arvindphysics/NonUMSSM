...
Program SPhenoNonUMSSM 
 
Use Control
Use InputOutput_NonUMSSM
Use LoopFunctions
Use Settings
Use LowEnergy_NonUMSSM
Use Mathematics
...
& ZZ,betaH,vd,vu,vS,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yu,Td,TYe11,TYe22,TYe33,           & 
& Tlam,Tu,mq2,ml012,ml022,ml032,mHd2,mHu2,md2,mu2,me012,me022,me032,ms2,M1,              & 
& M2,M3,M4,Tdp,Tep,Tmup,mGUT)
...
& M4,Tdp,Tep,Tmup,mass_uncertainty_Q)
...
& ZZ,betaH,vd,vu,vS,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yu,Td,TYe11,TYe22,TYe33,           & 
& Tlam,Tu,mq2,ml012,ml022,ml032,mHd2,mHu2,md2,mu2,me012,me022,me032,ms2,M1,              & 
& M2,M3,M4,Tdp,Tep,Tmup,gPSd,gTSd,BRSd,gPSu,gTSu,BRSu,gPSe,gTSe,BRSe,gPSv,               & 
& gTSv,BRSv,gPhh,gThh,BRhh,gPAh,gTAh,BRAh,gPHpm,gTHpm,BRHpm,gPVZp,gTVZp,BRVZp,           & 
& gPGlu,gTGlu,BRGlu,gPChi,gTChi,BRChi,gPCha,gTCha,BRCha,gPFu,gTFu,BRFu)
...
Call CalculateLowEnergyConstraints(g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yu,              & 
& Td,TYe11,TYe22,TYe33,Tlam,Tu,mq2,ml012,ml022,ml032,mHd2,mHu2,md2,mu2,me012,            & 
& me022,me032,ms2,M1,M2,M3,M4,Tdp,Tep,Tmup,vd,vu,vS,Tpar,Spar,Upar,ae,amu,               & 
...
& gp,Yd,Ye11,Ye22,Ye33,lam,Yu,Td,TYe11,TYe22,TYe33,Tlam,Tu,mq2,ml012,ml022,              & 
& ml032,mHd2,mHu2,md2,mu2,me012,me022,me032,ms2,M1,M2,M3,M4,Tdp,Tep,Tmup,kont)
...
& ZH,ZN,ZP,ZU,ZUL,ZUR,ZV,ZVL,ZW,ZZ,betaH,vd,vu,vS,g1,g2,g3,gp,Yd,Ye11,Ye22,              & 
& Ye33,lam,Yu,Td,TYe11,TYe22,TYe33,Tlam,Tu,mq2,ml012,ml022,ml032,mHd2,mHu2,              & 
& md2,mu2,me012,me022,me032,ms2,M1,M2,M3,M4,Tdp,Tep,Tmup,kont)
...
& MFv,MFv2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,           & 
& MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,pG,TW,TWp,UM,UP,v,ZA,ZD,ZDL,ZDR,ZE,ZEL,ZER,             & 
& ZH,ZN,ZP,ZU,ZUL,ZUR,ZV,ZVL,ZW,ZZ,betaH,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,              & 
& Yu,Td,TYe11,TYe22,TYe33,Tlam,Tu,mq2,ml012,ml022,ml032,mHd2,mHu2,md2,mu2,               & 
& me012,me022,me032,ms2,M1,M2,M3,M4,Tdp,Tep,Tmup,mGut,kont,WriteOut,n_run)
...
& Ye33,lam,Yu,Td,TYe11,TYe22,TYe33,Tlam,Tu,mq2,ml012,ml022,ml032,mHd2,mHu2,              & 
& md2,mu2,me012,me022,me032,ms2,M1,M2,M3,M4,Tdp,Tep,Tmup,mGut,kont,WriteOut,n_run)
...
& g2input,g3input,gpinput,Ydinput,Ye11input,Ye22input,Ye33input,laminput,Yuinput,        & 
& Tdinput,TYe11input,TYe22input,TYe33input,Tlaminput,Tuinput,mq2input,ml012input,        & 
& ml022input,ml032input,mHd2input,mHu2input,md2input,mu2input,me012input,me022input,     & 
& me032input,ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,Tmupinput,       & 
& mass_Qerror)
...
Real(dp) :: gD(186), Q, Qsave, Qstep, Qt, g_SM(62), mh_SM 
...
If (iupdown.eq.1) Then 
 tz=Log(Q/Qsave)
 dt=-tz/50._dp
 Call odeint(gD,186,0._dp,tz,0.1_dp*delta,dt,0._dp,rge186,kont)
Else 
 tz=-Log(Q/Qsave)
 dt=tz/50._dp
 Call odeint(gD,186,tz,0._dp,0.1_dp*delta,dt,0._dp,rge186,kont)
End if 
