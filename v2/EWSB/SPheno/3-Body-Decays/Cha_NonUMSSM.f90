...
& gTAh,gThh,gTHpm,gTSd,gTSe,gTSu,gTSv,gTVWm,gTVZ,gTVZp,gChaChacChaCha,gChaChaChiChi,     & 
& gChaChacFdFd,gChaChacFeFe,gChaChacFuFu,gChaChacFvFv,gChaChicFuFd,gChaChicFvFe,         & 
& gChaFdcFuGlu,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
Real(dp),Intent(inout) :: gChaChacChaCha(2,2,2,2),gChaChaChiChi(2,2,6,6),gChaChacFdFd(2,2,3,3),gChaChacFeFe(2,2,3,3),& 
& gChaChacFuFu(2,2,3,3),gChaChacFvFv(2,2,3,3),gChaChicFuFd(2,6,3,3),gChaChicFvFe(2,6,3,3),& 
& gChaFdcFuGlu(2,3,3,1)

Real(dp),Intent(in) :: gTAh(3),gThh(3),gTHpm(2),gTSd(6),gTSe(6),gTSu(6),gTSv(3),gTVWm,gTVZ,gTVZp

Real(dp) :: gChaChacChaChai(2,2,2),gChaChaChiChii(2,6,6),gChaChacFdFdi(2,3,3),gChaChacFeFei(2,3,3),& 
& gChaChacFuFui(2,3,3),gChaChacFvFvi(2,3,3),gChaChicFuFdi(6,3,3),gChaChicFvFei(6,3,3),   & 
& gChaFdcFuGlui(3,3,1)

Real(dp) :: gTAhtemp(3),gThhtemp(3),gTHpmtemp(2),gTSdtemp(6),gTSetemp(6),gTSutemp(6)              & 
& ,gTSvtemp(3),gTVWmtemp,gTVZtemp,gTVZptemp
...
& Tmup,vd,vu,vS,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,cplcChaChaAhL,   & 
...
gChaChacFvFvi = 0._dp 
Call ChaToChacFvFv(i_run,MCha,MFv,MVZ,MVZp,MSe,cplcChacFvSeL,cplcChacFvSeR,           & 
& cplcChaChaVZL,cplcChaChaVZR,cplcChaChaVZpL,cplcChaChaVZpR,cplcFvFvVZL,cplcFvFvVZR,     & 
& cplcFvFvVZpL,cplcFvFvVZpR,cplChaFvcSeL,cplChaFvcSeR,IntegralSs,IntegralSSss,           & 
& IntegralVs,IntegralVSst,IntegralVVss,NSs,NSSss,NVs,NVSst,NVVss,gTVZtemp,               & 
& gTVZptemp,gTSetemp,deltaM,epsI,check,gChaChacFvFvi)
...
Real(dp),Intent(in) :: MCha(2),MVZ,MVZp,MAh(3),Mhh(3)
...
Real(dp),Intent(in) :: MCha(2),MChi(6),MVZ,MVZp,MVWm,MHpm(2),MAh(3),Mhh(3)
...
Real(dp),Intent(in) :: MCha(2),MFd(3),MVZ,MVZp,MSu(6),MAh(3),Mhh(3)
...
Real(dp),Intent(in) :: MCha(2),MFe(3),MVZ,MVZp,MSv(3),MAh(3),Mhh(3)
...
Real(dp),Intent(inout) :: gTVZ,gTVZp,gTSv(3),gTAh(3),gThh(3)
...
Real(dp),Intent(in) :: MCha(2),MFu(3),MVZ,MVZp,MSd(6),MAh(3),Mhh(3)
...
& cplcChaChaVZpL(2,2),cplcChaChaVZpR(2,2),cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),         & 
...
Subroutine ChaToChacFvFv(iIN,MCha,MFv,MVZ,MVZp,MSe,cplcChacFvSeL,cplcChacFvSeR,       & 
& cplcChaChaVZL,cplcChaChaVZR,cplcChaChaVZpL,cplcChaChaVZpR,cplcFvFvVZL,cplcFvFvVZR,     & 
& cplcFvFvVZpL,cplcFvFvVZpR,cplChaFvcSeL,cplChaFvcSeR,IntegralSs,IntegralSSss,           & 
& IntegralVs,IntegralVSst,IntegralVVss,NSs,NSSss,NVs,NVSst,NVVss,gTVZ,gTVZp,             & 
& gTSe,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MCha(2),MFv(3),MVZ,MVZp,MSe(6)

Complex(dp),Intent(in) :: cplcChacFvSeL(2,3,6),cplcChacFvSeR(2,3,6),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),      & 
& cplcChaChaVZpL(2,2),cplcChaChaVZpR(2,2),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),             & 
...
Real(dp),Intent(inout) :: gTVZ,gTVZp,gTSe(6)
...
Real(dp),Intent(in) :: MChi(6),MFu(3),MFd(3),MVWm,MHpm(2),MSu(6),MSd(6),MCha(2)

Complex(dp),Intent(in) :: cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),& 
...
& cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6)
...
Real(dp),Intent(in) :: MChi(6),MFv(3),MFe(3),MVWm,MHpm(2),MSv(3),MSe(6),MCha(2)

Complex(dp),Intent(in) :: cplcChacFvSeL(2,3,6),cplcChacFvSeR(2,3,6),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),& 
...
& cplcFvFecVWmL(3,3),cplcFvFecVWmR(3,3),cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6)
...
End Module Cha3Decays_NonUMSSM 
