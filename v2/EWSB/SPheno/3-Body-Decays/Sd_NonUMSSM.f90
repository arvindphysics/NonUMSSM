...
! ------------------------------------------------------------------------------  
! File created at 0:25 on 10.2.2021   
! ----------------------------------------------------------------------  
 
 
Module Sd3Decays_NonUMSSM 
...
& mHd2,mHu2,md2,mu2,me012,me022,me032,ms2,M1,M2,M3,M4,Tdp,Tep,Tmup,vd,vu,vS,             & 
& gSdAhChaFu,gSdAhChiFd,gSdAhFdGlu,gSdSuChaChi,gSdChaFdcHpm,gSdhhChaFu,gSdChaGluSu,      & 
& gSdSdChacCha,gSdSdChiChi,gSdhhChiFd,gSdHpmChiFu,gSdChiGluSd,gSdFdFdcSd,gSdFdFecSe,     & 
& gSdFuFdcSu,gSdFdFvcSv,gSdHpmFdcCha,gSdSdFdcFd,gSdFdSecFe,gSdSuFdcFu,gSdFdSvcFv,        & 
& gSdFuFecSv,gSdSdFucFu,gSdFuSecFv,gSdhhFdGlu,gSdHpmFuGlu,gSdGluGluSd,gSdSdFecFe,        & 
& gSdSdFvcFv,gSdSuFecFv,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
Real(dp),Intent(inout) :: gSdAhChaFu(6,3,2,3),gSdAhChiFd(6,3,6,3),gSdAhFdGlu(6,3,3,1),gSdSuChaChi(6,6,2,6),     & 
& gSdChaFdcHpm(6,2,3,2),gSdhhChaFu(6,3,2,3),gSdChaGluSu(6,2,1,6),gSdSdChacCha(6,6,2,2),  & 
& gSdSdChiChi(6,6,6,6),gSdhhChiFd(6,3,6,3),gSdHpmChiFu(6,2,6,3),gSdChiGluSd(6,6,1,6),    & 
...
Real(dp) :: gSdAhChaFui(3,2,3),gSdAhChiFdi(3,6,3),gSdAhFdGlui(3,3,1),gSdSuChaChii(6,2,6),         & 
& gSdChaFdcHpmi(2,3,2),gSdhhChaFui(3,2,3),gSdChaGluSui(2,1,6),gSdSdChacChai(6,2,2),      & 
& gSdSdChiChii(6,6,6),gSdhhChiFdi(3,6,3),gSdHpmChiFui(2,6,3),gSdChiGluSdi(6,1,6),        & 
...
& Tmup,vd,vu,vS,cplAhSdcSd,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,      & 
...
gSdSdFvcFvi = 0._dp 
Call SdToSdFvcFv(i_run,MSd,MFv,MVZ,MVZp,cplSdcSdVZ,cplSdcSdVZp,cplcFvFvVZL,           & 
...
Real(dp),Intent(in) :: MAh(3),MChi(6),MFd(3),MSd(6)

Complex(dp),Intent(in) :: cplAhSdcSd(3,6,6),cplcFdFdAhL(3,3,3),cplcFdFdAhR(3,3,3),cplChiChiAhL(6,6,3),          & 
& cplChiChiAhR(6,6,3),cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6)
...
Real(dp),Intent(in) :: MSu(6),MCha(2),MChi(6),MVWm,MHpm(2),MFu(3),MFd(3),MSd(6)

Complex(dp),Intent(in) :: cplHpmSucSd(2,6,6),cplSucSdVWm(6,6),cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),          & 
& cplcFuChiSuL(3,6,6),cplcFuChiSuR(3,6,6),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),       & 
& cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),cplChiChacVWmL(6,2),cplChiChacVWmR(6,2),   & 
& cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6)
...
Real(dp),Intent(in) :: MCha(2),MFd(3),MHpm(2),MFu(3),MChi(6),MSd(6)

Complex(dp),Intent(in) :: cplcFuFdcHpmL(3,3,2),cplcFuFdcHpmR(3,3,2),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),    & 
& cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6)
...
Real(dp),Intent(in) :: MSd(6),MCha(2),MVZ,MVZp,MAh(3),Mhh(3),MFu(3)

Complex(dp),Intent(in) :: cplAhSdcSd(3,6,6),cplhhSdcSd(3,6,6),cplSdcSdVZ(6,6),cplSdcSdVZp(6,6),cplcChacFuSdL(2,3,6),& 
...
Real(dp),Intent(in) :: MSd(6),MChi(6),MVZ,MVZp,MAh(3),Mhh(3),MFd(3)

Complex(dp),Intent(in) :: cplAhSdcSd(3,6,6),cplhhSdcSd(3,6,6),cplSdcSdVZ(6,6),cplSdcSdVZp(6,6),cplcFdChiSdL(3,6,6),& 
& cplcFdChiSdR(3,6,6),cplChiChiAhL(6,6,3),cplChiChiAhR(6,6,3),cplChiChihhL(6,6,3),       & 
& cplChiChihhR(6,6,3),cplChiChiVZL(6,6),cplChiChiVZR(6,6),cplChiChiVZpL(6,6),            & 
& cplChiChiVZpR(6,6),cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6)
...
Real(dp),Intent(in) :: Mhh(3),MChi(6),MFd(3),MSd(6)

Complex(dp),Intent(in) :: cplhhSdcSd(3,6,6),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),cplChiChihhL(6,6,3),          & 
& cplChiChihhR(6,6,3),cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6)
...
Real(dp),Intent(in) :: MHpm(2),MChi(6),MFu(3),MSu(6),MFd(3),MCha(2),MSd(6)

Complex(dp),Intent(in) :: cplHpmSucSd(2,6,6),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),cplcFdFuHpmL(3,3,2),   & 
& cplcFdFuHpmR(3,3,2),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),cplChiFdcSdL(6,3,6),       & 
& cplChiFdcSdR(6,3,6),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6)
...
Real(dp),Intent(in) :: MChi(6),MGlu,MSd(6),MFd(3)
...
Isum = 36 
Allocate( gSum(6,1,6, Isum) ) 
Allocate( Contribution(6,1,6, Isum) ) 
gSum = 0._dp  
Contribution = ' ' 
...
Real(dp),Intent(in) :: MFd(3),MSd(6),MChi(6),MGlu

Complex(dp),Intent(in) :: cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6),cplGluFdcSdL(3,6),cplGluFdcSdR(3,6)
...
Real(dp),Intent(in) :: MFd(3),MFe(3),MSe(6),MChi(6),MSd(6)

Complex(dp),Intent(in) :: cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6),cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6)
...
Real(dp),Intent(in) :: MFu(3),MFd(3),MSu(6),MCha(2),MChi(6),MGlu,MSd(6)
...
Real(dp),Intent(in) :: MFd(3),MFv(3),MSv(3),MChi(6),MSd(6)
...
Real(dp),Intent(in) :: MHpm(2),MFd(3),MCha(2),MSu(6),MChi(6),MSd(6)

Complex(dp),Intent(in) :: cplHpmSucSd(2,6,6),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),cplcChaFdcSuL(2,3,6),  & 
& cplcChaFdcSuR(2,3,6),cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6)
...
Real(dp),Intent(in) :: MSd(6),MFd(3),MVZ,MVZp,MAh(3),Mhh(3),MChi(6),MGlu

Complex(dp),Intent(in) :: cplAhSdcSd(3,6,6),cplhhSdcSd(3,6,6),cplSdcSdVZ(6,6),cplSdcSdVZp(6,6),cplcFdChiSdL(3,6,6),& 
& cplcFdChiSdR(3,6,6),cplcFdFdAhL(3,3,3),cplcFdFdAhR(3,3,3),cplcFdFdhhL(3,3,3),          & 
& cplcFdFdhhR(3,3,3),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFdFdVZpL(3,3),cplcFdFdVZpR(3,3),& 
& cplcFdGluSdL(3,6),cplcFdGluSdR(3,6),cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6),           & 
...
Real(dp),Intent(in) :: MFd(3),MSe(6),MFe(3),MChi(6),MSd(6)

Complex(dp),Intent(in) :: cplcFeChiSeL(3,6,6),cplcFeChiSeR(3,6,6),cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6)
...
Real(dp),Intent(in) :: MSu(6),MFd(3),MFu(3),MVWm,MHpm(2),MChi(6),MGlu,MSd(6)

Complex(dp),Intent(in) :: cplHpmSucSd(2,6,6),cplSucSdVWm(6,6),cplcFuChiSuL(3,6,6),cplcFuChiSuR(3,6,6),          & 
& cplcFuFdcHpmL(3,3,2),cplcFuFdcHpmR(3,3,2),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),       & 
& cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6),           & 
& cplGluFdcSdL(3,6),cplGluFdcSdR(3,6)
...
Real(dp),Intent(in) :: MFd(3),MSv(3),MFv(3),MChi(6),MSd(6)

Complex(dp),Intent(in) :: cplcFvChiSvL(3,6,3),cplcFvChiSvR(3,6,3),cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6)
...
Real(dp),Intent(in) :: MSd(6),MFu(3),MVZ,MVZp,MAh(3),Mhh(3),MCha(2)

Complex(dp),Intent(in) :: cplAhSdcSd(3,6,6),cplhhSdcSd(3,6,6),cplSdcSdVZ(6,6),cplSdcSdVZp(6,6),cplcChacFuSdL(2,3,6),& 
& cplcChacFuSdR(2,3,6),cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),cplcFuFuhhL(3,3,3),         & 
& cplcFuFuhhR(3,3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcFuFuVZpL(3,3),cplcFuFuVZpR(3,3),& 
...
Real(dp),Intent(in) :: MSd(6),MFe(3),MVZ,MVZp,MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplAhSdcSd(3,6,6),cplhhSdcSd(3,6,6),cplSdcSdVZ(6,6),cplSdcSdVZp(6,6),cplcFeFeAhL(3,3,3),& 
...
Subroutine SdToSdFvcFv(iIN,MSd,MFv,MVZ,MVZp,cplSdcSdVZ,cplSdcSdVZp,cplcFvFvVZL,       & 
& cplcFvFvVZR,cplcFvFvVZpL,cplcFvFvVZpR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSd(6),MFv(3),MVZ,MVZp

Complex(dp),Intent(in) :: cplSdcSdVZ(6,6),cplSdcSdVZp(6,6),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplcFvFvVZpL(3,3), & 
& cplcFvFvVZpR(3,3)
