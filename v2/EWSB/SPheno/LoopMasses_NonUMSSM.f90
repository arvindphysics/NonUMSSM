...
! ------------------------------------------------------------------------------  
! File created at 0:24 on 10.2.2021   
! ----------------------------------------------------------------------  
 
 
Module LoopMasses_NonUMSSM 
...
Use Tadpoles_NonUMSSM 
 Use EffectivePotential_NonUMSSM 
 Use Pole2L_NonUMSSM 
...
& g1,gp,ZN,ZDL,ZDR,g3,pG,vd,ZH,Tu,ZU,ZP,TW,TWp,Ye11,Ye22,Ye33,ZE,ZV,ZVL,ZEL,             & 
& ZER,TYe11,TYe22,TYe33,Tep,Tmup,Tlam,cplAhSdcUSd,cplChaFucUSdL,cplChaFucUSdR,           & 
...
& cplUSdcUSdVZpVZp,cplChiFvcUSvL,cplChiFvcUSvR,cplcChaFecUSvL,cplcChaFecUSvR,            & 
...
& cplUSvSvcUSvcSv,cplUSvcUSvcVWmVWm,cplUSvcUSvVZVZ,cplUSvcUSvVZpVZp,cplcUFvChiSvL,       & 
& cplcUFvChiSvR,cplcUFvFecHpmL,cplcUFvFecHpmR,cplcUFvFecVWmL,cplcUFvFecVWmR,             & 
& cplcUFvFvVZL,cplcUFvFvVZR,cplcUFvFvVZpL,cplcUFvFvVZpR,cplcChacUFvSeL,cplcChacUFvSeR,   & 
...
& cplUSucUSuVPVP,cplUSucUSucVWmVWm,cplUSucUSuVZVZ,cplUSucUSuVZpVZp,cplAhSecUSe,          & 
& cplChaFvcUSeL,cplChaFvcUSeR,cplChiFecUSeL,cplChiFecUSeR,cplhhSecUSe,cplHpmSvcUSe,      & 
& cplSecUSeVP,cplSecUSeVZ,cplSecUSeVZp,cplSvcUSeVWm,cplAhAhUSecUSe,cplhhhhUSecUSe,       & 
& cplHpmUSecHpmcUSe,cplSdUSecSdcUSe,cplUSeSecUSecSe,cplUSeSucUSecSu,cplUSeSvcUSecSv,     & 
& cplUSecUSeVPVP,cplUSecUSecVWmVWm,cplUSecUSeVZVZ,cplUSecUSeVZpVZp,cplAhAhUhh,           & 
...
& cplUhhUhhSvcSv,cplUhhUhhcVWmVWm,cplUhhUhhVZVZ,cplUhhUhhVZpVZp,cplUAhAhhh,              & 
...
& cplcChaUChiVWmL,cplcChaUChiVWmR,cplcUChaChaAhL,cplcUChaChaAhR,cplcUChaChahhL,          & 
...
CASE ( 1 , 2 ) 
  ! Make sure that there are no exactly degenerated masses! 
   ...
   Td_saveEP =Td
   where (aint(Abs(Td)).eq.Td) Td=Td*(1 + 3*1.0E-12_dp)
   Tu_saveEP =Tu
   where (aint(Abs(Tu)).eq.Tu) Tu=Tu*(1 + 4*1.0E-12_dp)
   mq2_saveEP =mq2
   where (aint(Abs(mq2)).eq.mq2) mq2=mq2*(1 + 5*1.0E-12_dp)
   md2_saveEP =md2
   where (aint(Abs(md2)).eq.md2) md2=md2*(1 + 6*1.0E-12_dp)
   mu2_saveEP =mu2
   where (aint(Abs(mu2)).eq.mu2) mu2=mu2*(1 + 7*1.0E-12_dp)
   Tdp_saveEP =Tdp
   where (aint(Abs(Tdp)).eq.Tdp) Tdp=Tdp*(1 + 8*1.0E-12_dp)
...
If (NewGBC) Then 
Call CalculatePi2S(125._dp**2,vd,vu,vS,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,             & 
& Yu,Td,TYe11,TYe22,TYe33,Tlam,Tu,mq2,ml012,ml022,ml032,mHd2,mHu2,md2,mu2,               & 
& me012,me022,me032,ms2,M1,M2,M3,M4,Tdp,Tep,Tmup,kont,ti_ep2L,Pi2S_EffPot,               & 
& PiP2S_EffPot)

Else 
Call CalculatePi2S(0._dp,vd,vu,vS,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yu,               & 
& Td,TYe11,TYe22,TYe33,Tlam,Tu,mq2,ml012,ml022,ml032,mHd2,mHu2,md2,mu2,me012,            & 
& me022,me032,ms2,M1,M2,M3,M4,Tdp,Tep,Tmup,kont,ti_ep2L,Pi2S_EffPot,PiP2S_EffPot)
...
Call SolveTadpoleEquations(g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yu,Td,TYe11,             & 
& TYe22,TYe33,Tlam,Tu,mq2,ml012,ml022,ml032,mHd2,mHu2,md2,mu2,me012,me022,               & 
& me032,ms2,M1,M2,M3,M4,Tdp,Tep,Tmup,vd,vu,vS,Tad1Loop)
...
Call OneLoopSv(g1,g2,gp,Ql1,Ql2,Ql3,QHd,QHu,Qs,ml012,ml022,ml032,vd,vu,               & 
& vS,MFv,MFv2,MChi,MChi2,MCha,MCha2,MFe,MFe2,MSv,MSv2,Mhh,Mhh2,MHpm,MHpm2,               & 
& MSe,MSe2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,MAh,MAh2,MSd,MSd2,MSu,MSu2,cplChiFvcUSvL,      & 
...
& cplUSvcUSvVZVZ,cplUSvcUSvVZpVZp,0.1_dp*delta_mass,MSv_1L,MSv2_1L,ZV_1L,kont)
...
Call OneLoopSe(g1,g2,gp,Ql1,Ql2,Ql3,QHd,QHu,Qe1,Qe2,Qe3,Qs,Ye11,TYe11,Ye22,           & 
& TYe22,Ye33,TYe33,lam,ml012,ml022,ml032,me012,me022,me032,Tep,Tmup,vd,vu,               & 
& vS,MSe,MSe2,MAh,MAh2,MFv,MFv2,MCha,MCha2,MFe,MFe2,MChi,MChi2,Mhh,Mhh2,MSv,             & 
& MSv2,MHpm,MHpm2,MVZ,MVZ2,MVZp,MVZp2,MVWm,MVWm2,MSd,MSd2,MSu,MSu2,cplAhSecUSe,          & 
& cplChaFvcUSeL,cplChaFvcUSeR,cplChiFecUSeL,cplChiFecUSeR,cplhhSecUSe,cplHpmSvcUSe,      & 
& cplSecUSeVP,cplSecUSeVZ,cplSecUSeVZp,cplSvcUSeVWm,cplAhAhUSecUSe,cplhhhhUSecUSe,       & 
& cplHpmUSecHpmcUSe,cplSdUSecSdcUSe,cplUSeSecUSecSe,cplUSeSucUSecSu,cplUSeSvcUSecSv,     & 
& cplUSecUSeVPVP,cplUSecUSecVWmVWm,cplUSecUSeVZVZ,cplUSecUSeVZpVZp,0.1_dp*delta_mass,    & 
...
Call OneLoopFe(Ye11,Ye22,Ye33,vd,MFe,MFe2,MAh,MAh2,MSv,MSv2,MCha,MCha2,               & 
& MSe,MSe2,MChi,MChi2,Mhh,Mhh2,MVZ,MVZ2,MVZp,MVZp2,MHpm,MHpm2,MFv,MFv2,MVWm,             & 
& MVWm2,cplcUFeFeAhL,cplcUFeFeAhR,cplcUFeChaSvL,cplcUFeChaSvR,cplcUFeChiSeL,             & 
& cplcUFeChiSeR,cplcUFeFehhL,cplcUFeFehhR,cplcUFeFeVPL,cplcUFeFeVPR,cplcUFeFeVZL,        & 
& cplcUFeFeVZR,cplcUFeFeVZpL,cplcUFeFeVZpR,cplcUFeFvHpmL,cplcUFeFvHpmR,cplcUFeFvVWmL,    & 
...
Subroutine OneLoopSv(g1,g2,gp,Ql1,Ql2,Ql3,QHd,QHu,Qs,ml012,ml022,ml032,               & 
& vd,vu,vS,MFv,MFv2,MChi,MChi2,MCha,MCha2,MFe,MFe2,MSv,MSv2,Mhh,Mhh2,MHpm,               & 
& MHpm2,MSe,MSe2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,MAh,MAh2,MSd,MSd2,MSu,MSu2,              & 
& cplChiFvcUSvL,cplChiFvcUSvR,cplcChaFecUSvL,cplcChaFecUSvR,cplhhSvcUSv,cplSecHpmcUSv,   & 
& cplSecUSvcVWm,cplSvcUSvVZ,cplSvcUSvVZp,cplAhAhUSvcUSv,cplhhhhUSvcUSv,cplHpmUSvcHpmcUSv,& 
& cplSdUSvcSdcUSv,cplSeUSvcSecUSv,cplSuUSvcSucUSv,cplUSvSvcUSvcSv,cplUSvcUSvcVWmVWm,     & 
...
mat2a(1,1) = 0._dp 
mat2a(1,1) = mat2a(1,1)+ml012
mat2a(1,1) = mat2a(1,1)+(g1**2*vd**2)/8._dp
mat2a(1,1) = mat2a(1,1)+(g2**2*vd**2)/8._dp
mat2a(1,1) = mat2a(1,1)+(gp**2*QHd*Ql1*vd**2)/2._dp
mat2a(1,1) = mat2a(1,1)+(gp**2*Ql1*Qs*vS**2)/2._dp
mat2a(1,1) = mat2a(1,1)-(g1**2*vu**2)/8._dp
mat2a(1,1) = mat2a(1,1)-(g2**2*vu**2)/8._dp
mat2a(1,1) = mat2a(1,1)+(gp**2*QHu*Ql1*vu**2)/2._dp
mat2a(1,2) = 0._dp 
mat2a(1,3) = 0._dp 
mat2a(2,2) = 0._dp 
mat2a(2,2) = mat2a(2,2)+ml022
mat2a(2,2) = mat2a(2,2)+(g1**2*vd**2)/8._dp
mat2a(2,2) = mat2a(2,2)+(g2**2*vd**2)/8._dp
mat2a(2,2) = mat2a(2,2)+(gp**2*QHd*Ql2*vd**2)/2._dp
mat2a(2,2) = mat2a(2,2)+(gp**2*Ql2*Qs*vS**2)/2._dp
mat2a(2,2) = mat2a(2,2)-(g1**2*vu**2)/8._dp
mat2a(2,2) = mat2a(2,2)-(g2**2*vu**2)/8._dp
mat2a(2,2) = mat2a(2,2)+(gp**2*QHu*Ql2*vu**2)/2._dp
mat2a(2,3) = 0._dp 
mat2a(3,3) = 0._dp 
mat2a(3,3) = mat2a(3,3)+ml032
mat2a(3,3) = mat2a(3,3)+(g1**2*vd**2)/8._dp
mat2a(3,3) = mat2a(3,3)+(g2**2*vd**2)/8._dp
mat2a(3,3) = mat2a(3,3)+(gp**2*QHd*Ql3*vd**2)/2._dp
mat2a(3,3) = mat2a(3,3)+(gp**2*Ql3*Qs*vS**2)/2._dp
mat2a(3,3) = mat2a(3,3)-(g1**2*vu**2)/8._dp
mat2a(3,3) = mat2a(3,3)-(g2**2*vu**2)/8._dp
mat2a(3,3) = mat2a(3,3)+(gp**2*QHu*Ql3*vu**2)/2._dp
...
Subroutine DerPi1LoopSv(p2,MFv,MFv2,MChi,MChi2,MCha,MCha2,MFe,MFe2,MSv,               & 
& MSv2,Mhh,Mhh2,MHpm,MHpm2,MSe,MSe2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,MAh,MAh2,             & 
& MSd,MSd2,MSu,MSu2,cplChiFvcUSvL,cplChiFvcUSvR,cplcChaFecUSvL,cplcChaFecUSvR,           & 
& cplhhSvcUSv,cplSecHpmcUSv,cplSecUSvcVWm,cplSvcUSvVZ,cplSvcUSvVZp,cplAhAhUSvcUSv,       & 
& cplhhhhUSvcUSv,cplHpmUSvcHpmcUSv,cplSdUSvcSdcUSv,cplSeUSvcSecUSv,cplSuUSvcSucUSv,      & 
& cplUSvSvcUSvcSv,cplUSvcUSvcVWmVWm,cplUSvcUSvVZVZ,cplUSvcUSvVZpVZp,kont,res)
...
Do gO1 = 1, 3
  Do gO2 = 1, 3
B1m2 = -2._dp*Real(SA_DerB1(p2,MChi2(i2),MSv2(i1)),dp) 
B0m2 = 2._dp*MChi(i2)*Real(SA_DerB0(p2,MChi2(i2),MSv2(i1)),dp) 
coupL1 = cplcUFvChiSvL(gO1,i2,i1)
coupR1 = cplcUFvChiSvR(gO1,i2,i1)
coupL2 =  Conjg(cplcUFvChiSvL(gO2,i2,i1))
coupR2 =  Conjg(cplcUFvChiSvR(gO2,i2,i1))
...
Subroutine OneLoopSe(g1,g2,gp,Ql1,Ql2,Ql3,QHd,QHu,Qe1,Qe2,Qe3,Qs,Ye11,TYe11,          & 
& Ye22,TYe22,Ye33,TYe33,lam,ml012,ml022,ml032,me012,me022,me032,Tep,Tmup,vd,             & 
& vu,vS,MSe,MSe2,MAh,MAh2,MFv,MFv2,MCha,MCha2,MFe,MFe2,MChi,MChi2,Mhh,Mhh2,              & 
& MSv,MSv2,MHpm,MHpm2,MVZ,MVZ2,MVZp,MVZp2,MVWm,MVWm2,MSd,MSd2,MSu,MSu2,cplAhSecUSe,      & 
& cplChaFvcUSeL,cplChaFvcUSeR,cplChiFecUSeL,cplChiFecUSeR,cplhhSecUSe,cplHpmSvcUSe,      & 
& cplSecUSeVP,cplSecUSeVZ,cplSecUSeVZp,cplSvcUSeVWm,cplAhAhUSecUSe,cplhhhhUSecUSe,       & 
& cplHpmUSecHpmcUSe,cplSdUSecSdcUSe,cplUSeSecUSecSe,cplUSeSucUSecSu,cplUSeSvcUSecSv,     & 
& cplUSecUSeVPVP,cplUSecUSecVWmVWm,cplUSecUSeVZVZ,cplUSecUSeVZpVZp,delta,mass,           & 
& mass2,RS,kont)
...
mat2a(1,1) = mat2a(1,1)+(g2**2*vu**2)/8._dp
mat2a(1,1) = mat2a(1,1)+(gp**2*QHu*Ql1*vu**2)/2._dp
mat2a(1,1) = mat2a(1,1)+(vd**2*Ye11*Conjg(Ye11))/2._dp
mat2a(1,2) = 0._dp 
mat2a(1,3) = 0._dp 
mat2a(1,4) = 0._dp 
mat2a(1,4) = mat2a(1,4)-((vu*Conjg(Tep))/sqrt(2._dp))
mat2a(1,4) = mat2a(1,4)-(vS*vu*lam*Conjg(Ye11))/2._dp
mat2a(1,4) = mat2a(1,4)+(vd*Conjg(TYe11))/sqrt(2._dp)
mat2a(1,5) = 0._dp 
mat2a(1,6) = 0._dp 
mat2a(2,2) = 0._dp 
mat2a(2,2) = mat2a(2,2)+ml022
...
mat2a(2,2) = mat2a(2,2)+(g2**2*vu**2)/8._dp
mat2a(2,2) = mat2a(2,2)+(gp**2*QHu*Ql2*vu**2)/2._dp
mat2a(2,2) = mat2a(2,2)+(vd**2*Ye22*Conjg(Ye22))/2._dp
mat2a(2,3) = 0._dp 
mat2a(2,4) = 0._dp 
mat2a(2,5) = 0._dp 
mat2a(2,5) = mat2a(2,5)-((vu*Conjg(Tmup))/sqrt(2._dp))
mat2a(2,5) = mat2a(2,5)-(vS*vu*lam*Conjg(Ye22))/2._dp
mat2a(2,5) = mat2a(2,5)+(vd*Conjg(TYe22))/sqrt(2._dp)
mat2a(2,6) = 0._dp 
mat2a(3,3) = 0._dp 
mat2a(3,3) = mat2a(3,3)+ml032
mat2a(3,3) = mat2a(3,3)+(g1**2*vd**2)/8._dp
...
mat2a(3,3) = mat2a(3,3)+(g2**2*vu**2)/8._dp
mat2a(3,3) = mat2a(3,3)+(gp**2*QHu*Ql3*vu**2)/2._dp
mat2a(3,3) = mat2a(3,3)+(vd**2*Ye33*Conjg(Ye33))/2._dp
mat2a(3,4) = 0._dp 
mat2a(3,5) = 0._dp 
mat2a(3,6) = 0._dp 
mat2a(3,6) = mat2a(3,6)-(vS*vu*lam*Conjg(Ye33))/2._dp
mat2a(3,6) = mat2a(3,6)+(vd*Conjg(TYe33))/sqrt(2._dp)
mat2a(4,4) = 0._dp 
mat2a(4,4) = mat2a(4,4)+me012
mat2a(4,4) = mat2a(4,4)-(g1**2*vd**2)/4._dp
mat2a(4,4) = mat2a(4,4)+(gp**2*Qe1*QHd*vd**2)/2._dp
mat2a(4,4) = mat2a(4,4)+(gp**2*Qe1*Qs*vS**2)/2._dp
mat2a(4,4) = mat2a(4,4)+(g1**2*vu**2)/4._dp
mat2a(4,4) = mat2a(4,4)+(gp**2*Qe1*QHu*vu**2)/2._dp
mat2a(4,4) = mat2a(4,4)+(vd**2*Ye11*Conjg(Ye11))/2._dp
mat2a(4,5) = 0._dp 
mat2a(4,6) = 0._dp 
mat2a(5,5) = 0._dp 
mat2a(5,5) = mat2a(5,5)+me022
mat2a(5,5) = mat2a(5,5)-(g1**2*vd**2)/4._dp
mat2a(5,5) = mat2a(5,5)+(gp**2*Qe2*QHd*vd**2)/2._dp
mat2a(5,5) = mat2a(5,5)+(gp**2*Qe2*Qs*vS**2)/2._dp
mat2a(5,5) = mat2a(5,5)+(g1**2*vu**2)/4._dp
mat2a(5,5) = mat2a(5,5)+(gp**2*Qe2*QHu*vu**2)/2._dp
mat2a(5,5) = mat2a(5,5)+(vd**2*Ye22*Conjg(Ye22))/2._dp
mat2a(5,6) = 0._dp 
mat2a(6,6) = 0._dp 
mat2a(6,6) = mat2a(6,6)+me032
...
mat2a(6,6) = mat2a(6,6)+(vd**2*Ye33*Conjg(Ye33))/2._dp
...
& MChi2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWm,MVWm2,MSd,MSd2,              & 
& MSe,MSe2,MSu,MSu2,MSv,MSv2,cplAhAhUhh,cplAhUhhVZ,cplAhUhhVZp,cplcChaChaUhhL,           & 
...
& cplcgZpgZUhh,cplcgZgZpUhh,cplcgZpgZpUhh,cplUhhhhhh,cplUhhHpmcHpm,cplUhhHpmcVWm,        & 
& cplUhhSdcSd,cplUhhSecSe,cplUhhSucSu,cplUhhSvcSv,cplUhhcVWmVWm,cplUhhVZVZ,              & 
& cplUhhVZVZp,cplUhhVZpVZp,cplAhAhUhhUhh,cplUhhUhhhhhh,cplUhhUhhHpmcHpm,cplUhhUhhSdcSd,  & 
& cplUhhUhhSecSe,cplUhhUhhSucSu,cplUhhUhhSvcSv,cplUhhUhhcVWmVWm,cplUhhUhhVZVZ,           & 
& cplUhhUhhVZpVZp,kont,res)
...
& MFd2,MFe,MFe2,MFu,MFu2,MVZ,MVZ2,MVZp,MVZp2,MHpm,MHpm2,MVWm,MVWm2,MSd,MSd2,             & 
& MSe,MSe2,MSu,MSu2,MSv,MSv2,cplUAhAhhh,cplcChaChaUAhL,cplcChaChaUAhR,cplChiChiUAhL,     & 
& cplChiChiUAhR,cplcFdFdUAhL,cplcFdFdUAhR,cplcFeFeUAhL,cplcFeFeUAhR,cplcFuFuUAhL,        & 
& cplcFuFuUAhR,cplcgWmgWmUAh,cplcgWpCgWpCUAh,cplUAhhhVZ,cplUAhhhVZp,cplUAhHpmcHpm,       & 
& cplUAhHpmcVWm,cplUAhSdcSd,cplUAhSecSe,cplUAhSucSu,cplUAhUAhAhAh,cplUAhUAhhhhh,         & 
& cplUAhUAhHpmcHpm,cplUAhUAhSdcSd,cplUAhUAhSecSe,cplUAhUAhSucSu,cplUAhUAhSvcSv,          & 
...
Subroutine OneLoopFe(Ye11,Ye22,Ye33,vd,MFe,MFe2,MAh,MAh2,MSv,MSv2,MCha,               & 
& MCha2,MSe,MSe2,MChi,MChi2,Mhh,Mhh2,MVZ,MVZ2,MVZp,MVZp2,MHpm,MHpm2,MFv,MFv2,            & 
& MVWm,MVWm2,cplcUFeFeAhL,cplcUFeFeAhR,cplcUFeChaSvL,cplcUFeChaSvR,cplcUFeChiSeL,        & 
& cplcUFeChiSeR,cplcUFeFehhL,cplcUFeFehhR,cplcUFeFeVPL,cplcUFeFeVPR,cplcUFeFeVZL,        & 
& cplcUFeFeVZR,cplcUFeFeVZpL,cplcUFeFeVZpR,cplcUFeFvHpmL,cplcUFeFvHpmR,cplcUFeFvVWmL,    & 
...
mat1a(1,1) = 0._dp 
mat1a(1,1) = mat1a(1,1)+(vd*Ye11)/sqrt(2._dp)
mat1a(1,2) = 0._dp 
mat1a(1,3) = 0._dp 
mat1a(2,1) = 0._dp 
mat1a(2,2) = 0._dp 
mat1a(2,2) = mat1a(2,2)+(vd*Ye22)/sqrt(2._dp)
mat1a(2,3) = 0._dp 
mat1a(3,1) = 0._dp 
mat1a(3,2) = 0._dp 
mat1a(3,3) = 0._dp 
mat1a(3,3) = mat1a(3,3)+(vd*Ye33)/sqrt(2._dp)
...
End Module LoopMasses_NonUMSSM 
