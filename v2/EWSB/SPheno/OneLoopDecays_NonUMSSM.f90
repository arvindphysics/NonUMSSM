...
! ------------------------------------------------------------------------------
! File created at 0:33 on 10.2.2021
! ----------------------------------------------------------------------


Module OneLoopDecays_NonUMSSM
Use Couplings_NonUMSSM
Use CouplingsCT_NonUMSSM
...
Use Kinematics
Use CouplingsForDecays_NonUMSSM

Use Wrapper_OneLoopDecay_Sd_NonUMSSM
Use Wrapper_OneLoopDecay_Su_NonUMSSM
Use Wrapper_OneLoopDecay_Se_NonUMSSM
Use Wrapper_OneLoopDecay_Sv_NonUMSSM
Use Wrapper_OneLoopDecay_hh_NonUMSSM
Use Wrapper_OneLoopDecay_Ah_NonUMSSM
Use Wrapper_OneLoopDecay_Hpm_NonUMSSM
Use Wrapper_OneLoopDecay_Glu_NonUMSSM
Use Wrapper_OneLoopDecay_Chi_NonUMSSM
Use Wrapper_OneLoopDecay_Cha_NonUMSSM
Use Wrapper_OneLoopDecay_Fu_NonUMSSM


Contains

Subroutine getZCouplings(g1,g2,gp,lam,Tlam,vd,vu,vS,ZH,ZA,ZP,Yd,Td,Tdp,               &
& ZD,Ye11,TYe11,Ye22,TYe22,Ye33,TYe33,Tep,Tmup,ZE,Yu,Tu,ZU,ZV,g3,TW,TWp,UM,              &
& UP,ZN,ZDL,ZDR,ZEL,ZER,ZUL,ZUR,ZVL,pG,cplAhAhhh,cplAhHpmcHpm,cplAhSdcSd,cplAhSecSe,     &
& cplAhSucSu,cplhhhhhh,cplhhHpmcHpm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,         &
& cplHpmSucSd,cplHpmSvcSe,cplSdcHpmcSu,cplSecHpmcSv,cplAhAhAhAh,cplAhAhhhhh,             &
...
& cplSdcSucVWm,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSecSvcVWm,cplSucSuVG,cplSucSuVP,     &
& cplSucSdVWm,cplSucSuVZ,cplSucSuVZp,cplSvcSeVWm,cplSvcSvVZ,cplSvcSvVZp,cplhhcVWmVWm,    &
& cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,              &
& cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,cplAhAhcVWmVWm,cplAhAhVZVZ,cplAhAhVZVZp,       &
& cplAhAhVZpVZp,cplAhHpmcVWmVP,cplAhHpmcVWmVZ,cplAhHpmcVWmVZp,cplAhcHpmVPVWm,            &
& cplAhcHpmVWmVZ,cplAhcHpmVWmVZp,cplhhhhcVWmVWm,cplhhhhVZVZ,cplhhhhVZVZp,cplhhhhVZpVZp,  &
...
& cplSdcSdVZpVZp,cplSdcSucVWmVZp,cplSecSeVPVP,cplSecSeVPVZ,cplSecSeVPVZp,cplSecSvcVWmVP, &
& cplSecSecVWmVWm,cplSecSeVZVZ,cplSecSeVZVZp,cplSecSvcVWmVZ,cplSecSeVZpVZp,              &
& cplSecSvcVWmVZp,cplSucSuVGVG,cplSucSuVGVP,cplSucSdVGVWm,cplSucSuVGVZ,cplSucSuVGVZp,    &
& cplSucSuVPVP,cplSucSdVPVWm,cplSucSuVPVZ,cplSucSuVPVZp,cplSucSdVWmVZ,cplSucSdVWmVZp,    &
& cplSucSucVWmVWm,cplSucSuVZVZ,cplSucSuVZVZp,cplSucSuVZpVZp,cplSvcSeVPVWm,               &
& cplSvcSeVWmVZ,cplSvcSeVWmVZp,cplSvcSvcVWmVWm,cplSvcSvVZVZ,cplSvcSvVZVZp,               &
& cplSvcSvVZpVZp,cplVGVGVG,cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,cplcChaChaAhL,        &
...
& cplChiChacVWmR,cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZR,cplcChaChaVZpL, &
& cplcChaChaVZpR,cplChiChiVZL,cplChiChiVZR,cplChiChiVZpL,cplChiChiVZpR,cplcChaChiVWmL,   &
& cplcChaChiVWmR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,            &
& cplcFdFdVZR,cplcFdFdVZpL,cplcFdFdVZpR,cplcFuFdcVWmL,cplcFuFdcVWmR,cplcFeFeVPL,         &
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZpL,cplcFeFeVZpR,cplcFvFecVWmL,           &
& cplcFvFecVWmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFdFuVWmL,            &
& cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,cplcFuFuVZpL,cplcFuFuVZpR,cplcFeFvVWmL,           &
& cplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcFvFvVZpL,cplcFvFvVZpR,cplGluGluVGL,           &
...
& cplcgZgZphh,cplcgZpgZphh,cplcgWmgZpHpm,cplcgWpCgZpcHpm,ZRUZD,ZRUZV,ZRUZVL,             &
& ZRUZU,ZRUZE,ZRUZH,ZRUZA,ZRUZP,ZRUZN,ZRUUM,ZRUUP,ZRUZEL,ZRUZER,ZRUZDL,ZRUZDR,           &
& ZRUZUL,ZRUZUR,ZcplAhAhhh,ZcplAhHpmcHpm,ZcplAhSdcSd,ZcplAhSecSe,ZcplAhSucSu,            &
& Zcplhhhhhh,ZcplhhHpmcHpm,ZcplhhSdcSd,ZcplhhSecSe,ZcplhhSucSu,ZcplhhSvcSv,              &
& ZcplHpmSucSd,ZcplHpmSvcSe,ZcplSdcHpmcSu,ZcplSecHpmcSv,ZcplAhAhAhAh,ZcplAhAhhhhh,       &
& ZcplAhAhHpmcHpm,ZcplAhAhSdcSd,ZcplAhAhSecSe,ZcplAhAhSucSu,ZcplAhAhSvcSv,               &
& ZcplAhhhHpmcHpm,ZcplAhhhSdcSd,ZcplAhhhSecSe,ZcplAhhhSucSu,ZcplAhHpmSucSd,              &
...
& ZcplSeSvcSecSv,ZcplSuSucSucSu,ZcplSuSvcSucSv,ZcplSvSvcSvcSv,ZcplAhhhVZ,ZcplAhhhVZp,    &
& ZcplAhHpmcVWm,ZcplAhcHpmVWm,ZcplhhHpmcVWm,ZcplhhcHpmVWm,ZcplHpmcHpmVP,ZcplHpmcHpmVZ,   &
& ZcplHpmcHpmVZp,ZcplSdcSdVG,ZcplSdcSdVP,ZcplSdcSdVZ,ZcplSdcSdVZp,ZcplSdcSucVWm,         &
& ZcplSecSeVP,ZcplSecSeVZ,ZcplSecSeVZp,ZcplSecSvcVWm,ZcplSucSuVG,ZcplSucSuVP,            &
& ZcplSucSdVWm,ZcplSucSuVZ,ZcplSucSuVZp,ZcplSvcSeVWm,ZcplSvcSvVZ,ZcplSvcSvVZp,           &
& ZcplhhcVWmVWm,ZcplhhVZVZ,ZcplhhVZVZp,ZcplhhVZpVZp,ZcplHpmcVWmVP,ZcplHpmcVWmVZ,         &
& ZcplHpmcVWmVZp,ZcplcHpmVPVWm,ZcplcHpmVWmVZ,ZcplcHpmVWmVZp,ZcplAhAhcVWmVWm,             &
& ZcplAhAhVZVZ,ZcplAhAhVZVZp,ZcplAhAhVZpVZp,ZcplAhHpmcVWmVP,ZcplAhHpmcVWmVZ,             &
& ZcplAhHpmcVWmVZp,ZcplAhcHpmVPVWm,ZcplAhcHpmVWmVZ,ZcplAhcHpmVWmVZp,ZcplhhhhcVWmVWm,     &
& ZcplhhhhVZVZ,ZcplhhhhVZVZp,ZcplhhhhVZpVZp,ZcplhhHpmcVWmVP,ZcplhhHpmcVWmVZ,             &
& ZcplhhHpmcVWmVZp,ZcplhhcHpmVPVWm,ZcplhhcHpmVWmVZ,ZcplhhcHpmVWmVZp,ZcplHpmcHpmVPVP,     &
& ZcplHpmcHpmVPVZ,ZcplHpmcHpmVPVZp,ZcplHpmcHpmcVWmVWm,ZcplHpmcHpmVZVZ,ZcplHpmcHpmVZVZp,  &
& ZcplHpmcHpmVZpVZp,ZcplSdcSdVGVG,ZcplSdcSdVGVP,ZcplSdcSdVGVZ,ZcplSdcSdVGVZp,            &
& ZcplSdcSucVWmVG,ZcplSdcSdVPVP,ZcplSdcSdVPVZ,ZcplSdcSdVPVZp,ZcplSdcSucVWmVP,            &
& ZcplSdcSdcVWmVWm,ZcplSdcSdVZVZ,ZcplSdcSdVZVZp,ZcplSdcSucVWmVZ,ZcplSdcSdVZpVZp,         &
& ZcplSdcSucVWmVZp,ZcplSecSeVPVP,ZcplSecSeVPVZ,ZcplSecSeVPVZp,ZcplSecSvcVWmVP,           &
& ZcplSecSecVWmVWm,ZcplSecSeVZVZ,ZcplSecSeVZVZp,ZcplSecSvcVWmVZ,ZcplSecSeVZpVZp,         &
& ZcplSecSvcVWmVZp,ZcplSucSuVGVG,ZcplSucSuVGVP,ZcplSucSdVGVWm,ZcplSucSuVGVZ,             &
...
& ZcplSucSuVZpVZp,ZcplSvcSeVPVWm,ZcplSvcSeVWmVZ,ZcplSvcSeVWmVZp,ZcplSvcSvcVWmVWm,        &
& ZcplSvcSvVZVZ,ZcplSvcSvVZVZp,ZcplSvcSvVZpVZp,ZcplVGVGVG,ZcplcVWmVPVWm,ZcplcVWmVWmVZ,   &
& ZcplcVWmVWmVZp,ZcplcChaChaAhL,ZcplcChaChaAhR,ZcplChiChiAhL,ZcplChiChiAhR,              &
...
& ZcplcFdFuHpmR,ZcplcFeFvHpmL,ZcplcFeFvHpmR,ZcplcFdGluSdL,ZcplcFdGluSdR,ZcplcFuGluSuL,   &
& ZcplcFuGluSuR,ZcplcChacFuSdL,ZcplcChacFuSdR,ZcplcChacFvSeL,ZcplcChacFvSeR,             &
& ZcplChiChacVWmL,ZcplChiChacVWmR,ZcplcChaChaVPL,ZcplcChaChaVPR,ZcplcChaChaVZL,          &
& ZcplcChaChaVZR,ZcplcChaChaVZpL,ZcplcChaChaVZpR,ZcplChiChiVZL,ZcplChiChiVZR,            &
...
& ZcplcFdFdVZpR,ZcplcFuFdcVWmL,ZcplcFuFdcVWmR,ZcplcFeFeVPL,ZcplcFeFeVPR,ZcplcFeFeVZL,    &
& ZcplcFeFeVZR,ZcplcFeFeVZpL,ZcplcFeFeVZpR,ZcplcFvFecVWmL,ZcplcFvFecVWmR,ZcplcFuFuVGL,   &
& ZcplcFuFuVGR,ZcplcFuFuVPL,ZcplcFuFuVPR,ZcplcFdFuVWmL,ZcplcFdFuVWmR,ZcplcFuFuVZL,       &
& ZcplcFuFuVZR,ZcplcFuFuVZpL,ZcplcFuFuVZpR,ZcplcFeFvVWmL,ZcplcFeFvVWmR,ZcplcFvFvVZL,     &
& ZcplcFvFvVZR,ZcplcFvFvVZpL,ZcplcFvFvVZpR,ZcplGluGluVGL,ZcplGluGluVGR,ZcplVGVGVGVG1,    &
& ZcplVGVGVGVG2,ZcplVGVGVGVG3,ZcplcVWmVPVPVWm1,ZcplcVWmVPVPVWm2,ZcplcVWmVPVPVWm3,        &
& ZcplcVWmVPVWmVZ1,ZcplcVWmVPVWmVZ2,ZcplcVWmVPVWmVZ3,ZcplcVWmVPVWmVZp1,ZcplcVWmVPVWmVZp2,&
& ZcplcVWmVPVWmVZp3,ZcplcVWmcVWmVWmVWm1,ZcplcVWmcVWmVWmVWm2,ZcplcVWmcVWmVWmVWm3,         &
& ZcplcVWmVWmVZVZ1,ZcplcVWmVWmVZVZ2,ZcplcVWmVWmVZVZ3,ZcplcVWmVWmVZVZp1,ZcplcVWmVWmVZVZp2,&
& ZcplcVWmVWmVZVZp3,ZcplcVWmVWmVZpVZp1,ZcplcVWmVWmVZpVZp2,ZcplcVWmVWmVZpVZp3,            &
& ZcplcgGgGVG,ZcplcgWmgAVWm,ZcplcgWpCgAcVWm,ZcplcgWmgWmVP,ZcplcgWmgWmVZ,ZcplcgWmgWmVZp,  &
& ZcplcgAgWmcVWm,ZcplcgZgWmcVWm,ZcplcgZpgWmcVWm,ZcplcgWpCgWpCVP,ZcplcgAgWpCVWm,          &
& ZcplcgZgWpCVWm,ZcplcgZpgWpCVWm,ZcplcgWpCgWpCVZ,ZcplcgWpCgWpCVZp,ZcplcgWmgZVWm,         &
& ZcplcgWpCgZcVWm,ZcplcgWmgZpVWm,ZcplcgWpCgZpcVWm,ZcplcgWmgWmAh,ZcplcgWpCgWpCAh,         &
...
Real(dp), Intent(in) :: g1,g2,gp,lam,Tlam,vd,vu,vS,ZP(2,2),g3,TW,TWp
...
& cplhhSecSe(3,6,6),cplhhSucSu(3,6,6),cplhhSvcSv(3,3,3),cplHpmSucSd(2,6,6),              &
& cplHpmSvcSe(2,3,6),cplSdcHpmcSu(6,2,6),cplSecHpmcSv(6,2,3),cplAhAhAhAh(3,3,3,3),       &
& cplAhAhhhhh(3,3,3,3),cplAhAhHpmcHpm(3,3,2,2),cplAhAhSdcSd(3,3,6,6),cplAhAhSecSe(3,3,6,6),&
& cplAhAhSucSu(3,3,6,6),cplAhAhSvcSv(3,3,3,3),cplAhhhHpmcHpm(3,3,2,2),cplAhhhSdcSd(3,3,6,6),&
& cplAhhhSecSe(3,3,6,6),cplAhhhSucSu(3,3,6,6),cplAhHpmSucSd(3,2,6,6),cplAhHpmSvcSe(3,2,3,6),&
& cplAhSdcHpmcSu(3,6,2,6),cplAhSecHpmcSv(3,6,2,3),cplhhhhhhhh(3,3,3,3),cplhhhhHpmcHpm(3,3,2,2),&
& cplhhhhSdcSd(3,3,6,6),cplhhhhSecSe(3,3,6,6),cplhhhhSucSu(3,3,6,6),cplhhhhSvcSv(3,3,3,3),&
& cplhhHpmSucSd(3,2,6,6),cplhhHpmSvcSe(3,2,3,6),cplhhSdcHpmcSu(3,6,2,6),cplhhSecHpmcSv(3,6,2,3),&
...
& cplSdSecSdcSe(6,6,6,6),cplSdSucSdcSu(6,6,6,6),cplSdSvcSdcSv(6,3,6,3),cplSdSvcSecSu(6,3,6,6),&
& cplSeSecSecSe(6,6,6,6),cplSeSucSdcSv(6,6,6,3),cplSeSucSecSu(6,6,6,6),cplSeSvcSecSv(6,3,6,3),&
& cplSuSucSucSu(6,6,6,6),cplSuSvcSucSv(6,3,6,3),cplSvSvcSvcSv(3,3,3,3),cplAhhhVZ(3,3),   &
& cplAhhhVZp(3,3),cplAhHpmcVWm(3,2),cplAhcHpmVWm(3,2),cplhhHpmcVWm(3,2),cplhhcHpmVWm(3,2),&
...
& cplSecSeVZp(6,6),cplSecSvcVWm(6,3),cplSucSuVG(6,6),cplSucSuVP(6,6),cplSucSdVWm(6,6),   &
& cplSucSuVZ(6,6),cplSucSuVZp(6,6),cplSvcSeVWm(3,6),cplSvcSvVZ(3,3),cplSvcSvVZp(3,3),    &
& cplhhcVWmVWm(3),cplhhVZVZ(3),cplhhVZVZp(3),cplhhVZpVZp(3),cplHpmcVWmVP(2),             &
& cplHpmcVWmVZ(2),cplHpmcVWmVZp(2),cplcHpmVPVWm(2),cplcHpmVWmVZ(2),cplcHpmVWmVZp(2),     &
& cplAhAhcVWmVWm(3,3),cplAhAhVZVZ(3,3),cplAhAhVZVZp(3,3),cplAhAhVZpVZp(3,3),             &
& cplAhHpmcVWmVP(3,2),cplAhHpmcVWmVZ(3,2),cplAhHpmcVWmVZp(3,2),cplAhcHpmVPVWm(3,2),      &
& cplAhcHpmVWmVZ(3,2),cplAhcHpmVWmVZp(3,2),cplhhhhcVWmVWm(3,3),cplhhhhVZVZ(3,3),         &
& cplhhhhVZVZp(3,3),cplhhhhVZpVZp(3,3),cplhhHpmcVWmVP(3,2),cplhhHpmcVWmVZ(3,2),          &
& cplhhHpmcVWmVZp(3,2),cplhhcHpmVPVWm(3,2),cplhhcHpmVWmVZ(3,2),cplhhcHpmVWmVZp(3,2),     &
...
& cplSecSeVPVZp(6,6),cplSecSvcVWmVP(6,3),cplSecSecVWmVWm(6,6),cplSecSeVZVZ(6,6),         &
& cplSecSeVZVZp(6,6),cplSecSvcVWmVZ(6,3),cplSecSeVZpVZp(6,6),cplSecSvcVWmVZp(6,3),       &
...
Complex(dp), Intent(in) :: cplSucSuVPVZp(6,6),cplSucSdVWmVZ(6,6),cplSucSdVWmVZp(6,6),cplSucSucVWmVWm(6,6),        &
& cplSucSuVZVZ(6,6),cplSucSuVZVZp(6,6),cplSucSuVZpVZp(6,6),cplSvcSeVPVWm(3,6),           &
& cplSvcSeVWmVZ(3,6),cplSvcSeVWmVZp(3,6),cplSvcSvcVWmVWm(3,3),cplSvcSvVZVZ(3,3),         &
& cplSvcSvVZVZp(3,3),cplSvcSvVZpVZp(3,3),cplVGVGVG,cplcVWmVPVWm,cplcVWmVWmVZ,            &
& cplcVWmVWmVZp,cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),cplChiChiAhL(6,6,3),           &
...
& cplChiFvcSvR(6,3,3),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),cplcFdChiSdL(3,6,6),   &
& cplcFdChiSdR(3,6,6),cplcFeChiSeL(3,6,6),cplcFeChiSeR(3,6,6),cplcFuChiSuL(3,6,6),       &
& cplcFuChiSuR(3,6,6),cplcFvChiSvL(3,6,3),cplcFvChiSvR(3,6,3),cplGluFdcSdL(3,6),         &
...
& cplcChacFvSeR(2,3,6),cplChiChacVWmL(6,2),cplChiChacVWmR(6,2),cplcChaChaVPL(2,2),       &
& cplcChaChaVPR(2,2),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),cplcChaChaVZpL(2,2),          &
& cplcChaChaVZpR(2,2),cplChiChiVZL(6,6),cplChiChiVZR(6,6),cplChiChiVZpL(6,6),            &
& cplChiChiVZpR(6,6),cplcChaChiVWmL(2,6),cplcChaChiVWmR(2,6),cplcFdFdVGL(3,3),           &
...
Complex(dp), Intent(in) :: cplcVWmVWmVZVZp2,cplcVWmVWmVZVZp3,cplcVWmVWmVZpVZp1,cplcVWmVWmVZpVZp2,cplcVWmVWmVZpVZp3,&
& cplcgGgGVG,cplcgWmgAVWm,cplcgWpCgAcVWm,cplcgWmgWmVP,cplcgWmgWmVZ,cplcgWmgWmVZp,        &
& cplcgAgWmcVWm,cplcgZgWmcVWm,cplcgZpgWmcVWm,cplcgWpCgWpCVP,cplcgAgWpCVWm,               &
& cplcgZgWpCVWm,cplcgZpgWpCVWm,cplcgWpCgWpCVZ,cplcgWpCgWpCVZp,cplcgWmgZVWm,              &
& cplcgWpCgZcVWm,cplcgWmgZpVWm,cplcgWpCgZpcVWm,cplcgWmgWmAh(3),cplcgWpCgWpCAh(3),        &
& cplcgWmgAHpm(2),cplcgWpCgAcHpm(2),cplcgWmgWmhh(3),cplcgZgWmcHpm(2),cplcgZpgWmcHpm(2),  &
& cplcgWpCgWpChh(3),cplcgZgWpCHpm(2),cplcgZpgWpCHpm(2),cplcgZgZhh(3),cplcgZpgZhh(3),     &
& cplcgWmgZHpm(2),cplcgWpCgZcHpm(2),cplcgZgZphh(3),cplcgZpgZphh(3),cplcgWmgZpHpm(2),     &
& cplcgWpCgZpcHpm(2)
...
Integer :: gt1, gt2
Complex(dp) :: TempcplAhAhhh(3,3,3),TempcplAhHpmcHpm(3,2,2),TempcplAhSdcSd(3,6,6),TempcplAhSecSe(3,6,6),&
& TempcplAhSucSu(3,6,6),Tempcplhhhhhh(3,3,3),TempcplhhHpmcHpm(3,2,2),TempcplhhSdcSd(3,6,6),&
& TempcplhhSecSe(3,6,6),TempcplhhSucSu(3,6,6),TempcplhhSvcSv(3,3,3),TempcplHpmSucSd(2,6,6),&
& TempcplHpmSvcSe(2,3,6),TempcplSdcHpmcSu(6,2,6),TempcplSecHpmcSv(6,2,3),TempcplAhAhAhAh(3,3,3,3),&
...
& TempcplAhhhHpmcHpm(3,3,2,2),TempcplAhhhSdcSd(3,3,6,6),TempcplAhhhSecSe(3,3,6,6),       &
& TempcplAhhhSucSu(3,3,6,6),TempcplAhHpmSucSd(3,2,6,6),TempcplAhHpmSvcSe(3,2,3,6),       &
& TempcplAhSdcHpmcSu(3,6,2,6),TempcplAhSecHpmcSv(3,6,2,3),Tempcplhhhhhhhh(3,3,3,3),      &
& TempcplhhhhHpmcHpm(3,3,2,2),TempcplhhhhSdcSd(3,3,6,6),TempcplhhhhSecSe(3,3,6,6),       &
& TempcplhhhhSucSu(3,3,6,6),TempcplhhhhSvcSv(3,3,3,3),TempcplhhHpmSucSd(3,2,6,6),        &
& TempcplhhHpmSvcSe(3,2,3,6),TempcplhhSdcHpmcSu(3,6,2,6),TempcplhhSecHpmcSv(3,6,2,3),    &
& TempcplHpmHpmcHpmcHpm(2,2,2,2),TempcplHpmSdcHpmcSd(2,6,2,6),TempcplHpmSecHpmcSe(2,6,2,6),&
& TempcplHpmSucHpmcSu(2,6,2,6),TempcplHpmSvcHpmcSv(2,3,2,3),TempcplSdSdcSdcSd(6,6,6,6),  &
...
& TempcplSuSvcSucSv(6,3,6,3),TempcplSvSvcSvcSv(3,3,3,3),TempcplAhhhVZ(3,3),              &
& TempcplAhhhVZp(3,3),TempcplAhHpmcVWm(3,2),TempcplAhcHpmVWm(3,2),TempcplhhHpmcVWm(3,2), &
& TempcplhhcHpmVWm(3,2),TempcplHpmcHpmVP(2,2),TempcplHpmcHpmVZ(2,2),TempcplHpmcHpmVZp(2,2),&
& TempcplSdcSdVG(6,6),TempcplSdcSdVP(6,6),TempcplSdcSdVZ(6,6),TempcplSdcSdVZp(6,6),      &
& TempcplSdcSucVWm(6,6),TempcplSecSeVP(6,6),TempcplSecSeVZ(6,6),TempcplSecSeVZp(6,6),    &
& TempcplSecSvcVWm(6,3),TempcplSucSuVG(6,6),TempcplSucSuVP(6,6),TempcplSucSdVWm(6,6),    &
& TempcplSucSuVZ(6,6),TempcplSucSuVZp(6,6),TempcplSvcSeVWm(3,6),TempcplSvcSvVZ(3,3),     &
& TempcplSvcSvVZp(3,3),TempcplhhcVWmVWm(3),TempcplhhVZVZ(3),TempcplhhVZVZp(3),           &
& TempcplhhVZpVZp(3),TempcplHpmcVWmVP(2),TempcplHpmcVWmVZ(2),TempcplHpmcVWmVZp(2),       &
& TempcplcHpmVPVWm(2),TempcplcHpmVWmVZ(2),TempcplcHpmVWmVZp(2),TempcplAhAhcVWmVWm(3,3),  &
& TempcplAhAhVZVZ(3,3),TempcplAhAhVZVZp(3,3),TempcplAhAhVZpVZp(3,3),TempcplAhHpmcVWmVP(3,2),&
& TempcplAhHpmcVWmVZ(3,2),TempcplAhHpmcVWmVZp(3,2),TempcplAhcHpmVPVWm(3,2),              &
& TempcplAhcHpmVWmVZ(3,2),TempcplAhcHpmVWmVZp(3,2),TempcplhhhhcVWmVWm(3,3),              &
& TempcplhhhhVZVZ(3,3),TempcplhhhhVZVZp(3,3),TempcplhhhhVZpVZp(3,3),TempcplhhHpmcVWmVP(3,2),&
& TempcplhhHpmcVWmVZ(3,2),TempcplhhHpmcVWmVZp(3,2),TempcplhhcHpmVPVWm(3,2),              &
& TempcplhhcHpmVWmVZ(3,2),TempcplhhcHpmVWmVZp(3,2),TempcplHpmcHpmVPVP(2,2),              &
& TempcplHpmcHpmVPVZ(2,2),TempcplHpmcHpmVPVZp(2,2),TempcplHpmcHpmcVWmVWm(2,2),           &
& TempcplHpmcHpmVZVZ(2,2),TempcplHpmcHpmVZVZp(2,2),TempcplHpmcHpmVZpVZp(2,2),            &
& TempcplSdcSdVGVG(6,6),TempcplSdcSdVGVP(6,6),TempcplSdcSdVGVZ(6,6),TempcplSdcSdVGVZp(6,6),&
& TempcplSdcSucVWmVG(6,6),TempcplSdcSdVPVP(6,6),TempcplSdcSdVPVZ(6,6),TempcplSdcSdVPVZp(6,6)

Complex(dp) :: TempcplSdcSucVWmVP(6,6),TempcplSdcSdcVWmVWm(6,6),TempcplSdcSdVZVZ(6,6),TempcplSdcSdVZVZp(6,6),&
& TempcplSdcSucVWmVZ(6,6),TempcplSdcSdVZpVZp(6,6),TempcplSdcSucVWmVZp(6,6),              &
& TempcplSecSeVPVP(6,6),TempcplSecSeVPVZ(6,6),TempcplSecSeVPVZp(6,6),TempcplSecSvcVWmVP(6,3),&
& TempcplSecSecVWmVWm(6,6),TempcplSecSeVZVZ(6,6),TempcplSecSeVZVZp(6,6),TempcplSecSvcVWmVZ(6,3),&
& TempcplSecSeVZpVZp(6,6),TempcplSecSvcVWmVZp(6,3),TempcplSucSuVGVG(6,6),TempcplSucSuVGVP(6,6),&
& TempcplSucSdVGVWm(6,6),TempcplSucSuVGVZ(6,6),TempcplSucSuVGVZp(6,6),TempcplSucSuVPVP(6,6),&
& TempcplSucSdVPVWm(6,6),TempcplSucSuVPVZ(6,6),TempcplSucSuVPVZp(6,6),TempcplSucSdVWmVZ(6,6),&
& TempcplSucSdVWmVZp(6,6),TempcplSucSucVWmVWm(6,6),TempcplSucSuVZVZ(6,6),TempcplSucSuVZVZp(6,6),&
& TempcplSucSuVZpVZp(6,6),TempcplSvcSeVPVWm(3,6),TempcplSvcSeVWmVZ(3,6),TempcplSvcSeVWmVZp(3,6),&
& TempcplSvcSvcVWmVWm(3,3),TempcplSvcSvVZVZ(3,3),TempcplSvcSvVZVZp(3,3),TempcplSvcSvVZpVZp(3,3),&
& TempcplVGVGVG,TempcplcVWmVPVWm,TempcplcVWmVWmVZ,TempcplcVWmVWmVZp,TempcplcChaChaAhL(2,2,3),&
& TempcplcChaChaAhR(2,2,3),TempcplChiChiAhL(6,6,3),TempcplChiChiAhR(6,6,3),              &
& TempcplcFdFdAhL(3,3,3),TempcplcFdFdAhR(3,3,3),TempcplcFeFeAhL(3,3,3),TempcplcFeFeAhR(3,3,3),&
& TempcplcFuFuAhL(3,3,3),TempcplcFuFuAhR(3,3,3),TempcplChiChacHpmL(6,2,2),               &
& TempcplChiChacHpmR(6,2,2),TempcplChaFucSdL(2,3,6),TempcplChaFucSdR(2,3,6),             &
& TempcplChaFvcSeL(2,3,6),TempcplChaFvcSeR(2,3,6),TempcplcChaChahhL(2,2,3),              &
& TempcplcChaChahhR(2,2,3),TempcplcFdChaSuL(3,2,6),TempcplcFdChaSuR(3,2,6),              &
& TempcplcFeChaSvL(3,2,3),TempcplcFeChaSvR(3,2,3),TempcplChiChihhL(6,6,3),               &
& TempcplChiChihhR(6,6,3),TempcplChiFdcSdL(6,3,6),TempcplChiFdcSdR(6,3,6),               &
& TempcplChiFecSeL(6,3,6),TempcplChiFecSeR(6,3,6),TempcplChiFucSuL(6,3,6),               &
& TempcplChiFucSuR(6,3,6),TempcplChiFvcSvL(6,3,3),TempcplChiFvcSvR(6,3,3),               &
& TempcplcChaChiHpmL(2,6,2),TempcplcChaChiHpmR(2,6,2),TempcplcFdChiSdL(3,6,6),           &
& TempcplcFdChiSdR(3,6,6),TempcplcFeChiSeL(3,6,6),TempcplcFeChiSeR(3,6,6),               &
& TempcplcFuChiSuL(3,6,6),TempcplcFuChiSuR(3,6,6),TempcplcFvChiSvL(3,6,3),               &
& TempcplcFvChiSvR(3,6,3),TempcplGluFdcSdL(3,6),TempcplGluFdcSdR(3,6),TempcplcFdFdhhL(3,3,3),&
& TempcplcFdFdhhR(3,3,3),TempcplcChaFdcSuL(2,3,6),TempcplcChaFdcSuR(2,3,6),              &
...
& TempcplcChacFvSeR(2,3,6),TempcplChiChacVWmL(6,2),TempcplChiChacVWmR(6,2),              &
& TempcplcChaChaVPL(2,2),TempcplcChaChaVPR(2,2),TempcplcChaChaVZL(2,2),TempcplcChaChaVZR(2,2),&
& TempcplcChaChaVZpL(2,2),TempcplcChaChaVZpR(2,2),TempcplChiChiVZL(6,6),TempcplChiChiVZR(6,6),&
& TempcplChiChiVZpL(6,6),TempcplChiChiVZpR(6,6),TempcplcChaChiVWmL(2,6),TempcplcChaChiVWmR(2,6)

Complex(dp) :: TempcplcFdFdVGL(3,3),TempcplcFdFdVGR(3,3),TempcplcFdFdVPL(3,3),TempcplcFdFdVPR(3,3),   &
...
& TempcplcFeFeVZL(3,3),TempcplcFeFeVZR(3,3),TempcplcFeFeVZpL(3,3),TempcplcFeFeVZpR(3,3), &
...
& TempcplcFvFvVZpL(3,3),TempcplcFvFvVZpR(3,3),TempcplGluGluVGL,TempcplGluGluVGR,         &
...
& TempcplcVWmVPVWmVZp1,TempcplcVWmVPVWmVZp2,TempcplcVWmVPVWmVZp3,TempcplcVWmcVWmVWmVWm1, &
& TempcplcVWmcVWmVWmVWm2,TempcplcVWmcVWmVWmVWm3,TempcplcVWmVWmVZVZ1,TempcplcVWmVWmVZVZ2, &
& TempcplcVWmVWmVZVZ3,TempcplcVWmVWmVZVZp1,TempcplcVWmVWmVZVZp2,TempcplcVWmVWmVZVZp3,    &
& TempcplcVWmVWmVZpVZp1,TempcplcVWmVWmVZpVZp2,TempcplcVWmVWmVZpVZp3,TempcplcgGgGVG,      &
& TempcplcgWmgAVWm,TempcplcgWpCgAcVWm,TempcplcgWmgWmVP,TempcplcgWmgWmVZ,TempcplcgWmgWmVZp,&
& TempcplcgAgWmcVWm,TempcplcgZgWmcVWm,TempcplcgZpgWmcVWm,TempcplcgWpCgWpCVP,             &
& TempcplcgAgWpCVWm,TempcplcgZgWpCVWm,TempcplcgZpgWpCVWm,TempcplcgWpCgWpCVZ,             &
& TempcplcgWpCgWpCVZp,TempcplcgWmgZVWm,TempcplcgWpCgZcVWm,TempcplcgWmgZpVWm,             &
& TempcplcgWpCgZpcVWm,TempcplcgWmgWmAh(3),TempcplcgWpCgWpCAh(3),TempcplcgWmgAHpm(2),     &
& TempcplcgWpCgAcHpm(2),TempcplcgWmgWmhh(3),TempcplcgZgWmcHpm(2),TempcplcgZpgWmcHpm(2),  &
& TempcplcgWpCgWpChh(3),TempcplcgZgWpCHpm(2),TempcplcgZpgWpCHpm(2),TempcplcgZgZhh(3),    &
& TempcplcgZpgZhh(3),TempcplcgWmgZHpm(2),TempcplcgWpCgZcHpm(2),TempcplcgZgZphh(3),       &
& TempcplcgZpgZphh(3),TempcplcgWmgZpHpm(2),TempcplcgWpCgZpcHpm(2)

Complex(dp), Intent(out) :: ZcplAhAhhh(3,3,3),ZcplAhHpmcHpm(3,2,2),ZcplAhSdcSd(3,6,6),ZcplAhSecSe(3,6,6),         &
& ZcplAhSucSu(3,6,6),Zcplhhhhhh(3,3,3),ZcplhhHpmcHpm(3,2,2),ZcplhhSdcSd(3,6,6),          &
& ZcplhhSecSe(3,6,6),ZcplhhSucSu(3,6,6),ZcplhhSvcSv(3,3,3),ZcplHpmSucSd(2,6,6),          &
& ZcplHpmSvcSe(2,3,6),ZcplSdcHpmcSu(6,2,6),ZcplSecHpmcSv(6,2,3),ZcplAhAhAhAh(3,3,3,3),   &
& ZcplAhAhhhhh(3,3,3,3),ZcplAhAhHpmcHpm(3,3,2,2),ZcplAhAhSdcSd(3,3,6,6),ZcplAhAhSecSe(3,3,6,6),&
& ZcplAhAhSucSu(3,3,6,6),ZcplAhAhSvcSv(3,3,3,3),ZcplAhhhHpmcHpm(3,3,2,2),ZcplAhhhSdcSd(3,3,6,6),&
...
& ZcplAhhhVZ(3,3),ZcplAhhhVZp(3,3),ZcplAhHpmcVWm(3,2),ZcplAhcHpmVWm(3,2),ZcplhhHpmcVWm(3,2),&
& ZcplhhcHpmVWm(3,2),ZcplHpmcHpmVP(2,2),ZcplHpmcHpmVZ(2,2),ZcplHpmcHpmVZp(2,2),          &
& ZcplSdcSdVG(6,6),ZcplSdcSdVP(6,6),ZcplSdcSdVZ(6,6),ZcplSdcSdVZp(6,6),ZcplSdcSucVWm(6,6),&
& ZcplSecSeVP(6,6),ZcplSecSeVZ(6,6),ZcplSecSeVZp(6,6),ZcplSecSvcVWm(6,3),ZcplSucSuVG(6,6),&
& ZcplSucSuVP(6,6),ZcplSucSdVWm(6,6),ZcplSucSuVZ(6,6),ZcplSucSuVZp(6,6),ZcplSvcSeVWm(3,6),&
& ZcplSvcSvVZ(3,3),ZcplSvcSvVZp(3,3),ZcplhhcVWmVWm(3),ZcplhhVZVZ(3),ZcplhhVZVZp(3),      &
& ZcplhhVZpVZp(3),ZcplHpmcVWmVP(2),ZcplHpmcVWmVZ(2),ZcplHpmcVWmVZp(2),ZcplcHpmVPVWm(2),  &
& ZcplcHpmVWmVZ(2),ZcplcHpmVWmVZp(2),ZcplAhAhcVWmVWm(3,3),ZcplAhAhVZVZ(3,3),             &
& ZcplAhAhVZVZp(3,3),ZcplAhAhVZpVZp(3,3),ZcplAhHpmcVWmVP(3,2),ZcplAhHpmcVWmVZ(3,2),      &
& ZcplAhHpmcVWmVZp(3,2),ZcplAhcHpmVPVWm(3,2),ZcplAhcHpmVWmVZ(3,2),ZcplAhcHpmVWmVZp(3,2), &
& ZcplhhhhcVWmVWm(3,3),ZcplhhhhVZVZ(3,3),ZcplhhhhVZVZp(3,3),ZcplhhhhVZpVZp(3,3),         &
& ZcplhhHpmcVWmVP(3,2),ZcplhhHpmcVWmVZ(3,2),ZcplhhHpmcVWmVZp(3,2),ZcplhhcHpmVPVWm(3,2),  &
& ZcplhhcHpmVWmVZ(3,2),ZcplhhcHpmVWmVZp(3,2),ZcplHpmcHpmVPVP(2,2),ZcplHpmcHpmVPVZ(2,2),  &
...
& ZcplSecSeVPVP(6,6),ZcplSecSeVPVZ(6,6),ZcplSecSeVPVZp(6,6),ZcplSecSvcVWmVP(6,3),        &
& ZcplSecSecVWmVWm(6,6),ZcplSecSeVZVZ(6,6),ZcplSecSeVZVZp(6,6),ZcplSecSvcVWmVZ(6,3),     &
& ZcplSecSeVZpVZp(6,6),ZcplSecSvcVWmVZp(6,3),ZcplSucSuVGVG(6,6),ZcplSucSuVGVP(6,6)

Complex(dp), Intent(out) :: ZcplSucSdVGVWm(6,6),ZcplSucSuVGVZ(6,6),ZcplSucSuVGVZp(6,6),ZcplSucSuVPVP(6,6),         &
...
& ZcplSucSuVZpVZp(6,6),ZcplSvcSeVPVWm(3,6),ZcplSvcSeVWmVZ(3,6),ZcplSvcSeVWmVZp(3,6),     &
& ZcplSvcSvcVWmVWm(3,3),ZcplSvcSvVZVZ(3,3),ZcplSvcSvVZVZp(3,3),ZcplSvcSvVZpVZp(3,3),     &
& ZcplVGVGVG,ZcplcVWmVPVWm,ZcplcVWmVWmVZ,ZcplcVWmVWmVZp,ZcplcChaChaAhL(2,2,3),           &
& ZcplcChaChaAhR(2,2,3),ZcplChiChiAhL(6,6,3),ZcplChiChiAhR(6,6,3),ZcplcFdFdAhL(3,3,3),   &
& ZcplcFdFdAhR(3,3,3),ZcplcFeFeAhL(3,3,3),ZcplcFeFeAhR(3,3,3),ZcplcFuFuAhL(3,3,3),       &
& ZcplcFuFuAhR(3,3,3),ZcplChiChacHpmL(6,2,2),ZcplChiChacHpmR(6,2,2),ZcplChaFucSdL(2,3,6),&
...
& ZcplcFeChaSvR(3,2,3),ZcplChiChihhL(6,6,3),ZcplChiChihhR(6,6,3),ZcplChiFdcSdL(6,3,6),   &
& ZcplChiFdcSdR(6,3,6),ZcplChiFecSeL(6,3,6),ZcplChiFecSeR(6,3,6),ZcplChiFucSuL(6,3,6),   &
& ZcplChiFucSuR(6,3,6),ZcplChiFvcSvL(6,3,3),ZcplChiFvcSvR(6,3,3),ZcplcChaChiHpmL(2,6,2), &
& ZcplcChaChiHpmR(2,6,2),ZcplcFdChiSdL(3,6,6),ZcplcFdChiSdR(3,6,6),ZcplcFeChiSeL(3,6,6), &
& ZcplcFeChiSeR(3,6,6),ZcplcFuChiSuL(3,6,6),ZcplcFuChiSuR(3,6,6),ZcplcFvChiSvL(3,6,3),   &
& ZcplcFvChiSvR(3,6,3),ZcplGluFdcSdL(3,6),ZcplGluFdcSdR(3,6),ZcplcFdFdhhL(3,3,3),        &
...
& ZcplcChacFuSdR(2,3,6),ZcplcChacFvSeL(2,3,6),ZcplcChacFvSeR(2,3,6),ZcplChiChacVWmL(6,2),&
& ZcplChiChacVWmR(6,2),ZcplcChaChaVPL(2,2),ZcplcChaChaVPR(2,2),ZcplcChaChaVZL(2,2),      &
& ZcplcChaChaVZR(2,2),ZcplcChaChaVZpL(2,2),ZcplcChaChaVZpR(2,2),ZcplChiChiVZL(6,6),      &
& ZcplChiChiVZR(6,6),ZcplChiChiVZpL(6,6),ZcplChiChiVZpR(6,6),ZcplcChaChiVWmL(2,6),       &
& ZcplcChaChiVWmR(2,6),ZcplcFdFdVGL(3,3),ZcplcFdFdVGR(3,3),ZcplcFdFdVPL(3,3),            &
...
& ZcplcFvFvVZR(3,3),ZcplcFvFvVZpL(3,3),ZcplcFvFvVZpR(3,3),ZcplGluGluVGL,ZcplGluGluVGR,   &
& ZcplVGVGVGVG1,ZcplVGVGVGVG2,ZcplVGVGVGVG3,ZcplcVWmVPVPVWm1,ZcplcVWmVPVPVWm2

Complex(dp), Intent(out) :: ZcplcVWmVPVPVWm3,ZcplcVWmVPVWmVZ1,ZcplcVWmVPVWmVZ2,ZcplcVWmVPVWmVZ3,ZcplcVWmVPVWmVZp1, &
...
& ZcplcgWmgWmAh(3),ZcplcgWpCgWpCAh(3),ZcplcgWmgAHpm(2),ZcplcgWpCgAcHpm(2),               &
& ZcplcgWmgWmhh(3),ZcplcgZgWmcHpm(2),ZcplcgZpgWmcHpm(2),ZcplcgWpCgWpChh(3),              &
& ZcplcgZgWpCHpm(2),ZcplcgZpgWpCHpm(2),ZcplcgZgZhh(3),ZcplcgZpgZhh(3),ZcplcgWmgZHpm(2),  &
& ZcplcgWpCgZcHpm(2),ZcplcgZgZphh(3),ZcplcgZpgZphh(3),ZcplcgWmgZpHpm(2),ZcplcgWpCgZpcHpm(2)
...
Do gt1=1,3
  Do gt2=1,3
ZcplChaFvcSeR(:,gt2,:) = ZcplChaFvcSeR(:,gt2,:)
 End Do
End Do
TempcplChaFvcSeR = ZcplChaFvcSeR
ZcplChaFvcSeR = 0._dp
...
Do gt1=1,3
  Do gt2=1,3
ZcplChiFvcSvR(:,gt2,:) = ZcplChiFvcSvR(:,gt2,:)
 End Do
End Do
TempcplChiFvcSvR = ZcplChiFvcSvR
ZcplChiFvcSvR = 0._dp
...
Do gt1=1,3
  Do gt2=1,3
ZcplcFvChiSvL(gt2,:,:) = ZcplcFvChiSvL(gt2,:,:)
 End Do
End Do
...
Do gt1=1,3
  Do gt2=1,3
ZcplcFvFecHpmL(gt2,:,:) = ZcplcFvFecHpmL(gt2,:,:)
 End Do
End Do
...
Do gt1=1,3
  Do gt2=1,3
ZcplcFeFvHpmR(:,gt2,:) = ZcplcFeFvHpmR(:,gt2,:)
 End Do
End Do
TempcplcFeFvHpmR = ZcplcFeFvHpmR
ZcplcFeFvHpmR = 0._dp
...
Do gt1=1,3
  Do gt2=1,3
ZcplcChacFvSeL(:,gt2,:) = ZcplcChacFvSeL(:,gt2,:)
 End Do
End Do
TempcplcChacFvSeL = ZcplcChacFvSeL
ZcplcChacFvSeL = 0._dp
...
Do gt1=1,3
  Do gt2=1,3
ZcplcFvFecVWmR(gt2,:) = ZcplcFvFecVWmR(gt2,:)
 End Do
End Do
...
Do gt1=1,3
  Do gt2=1,3
ZcplcFeFvVWmR(:,gt2) = ZcplcFeFvVWmR(:,gt2)
 End Do
End Do
TempcplcFeFvVWmR = ZcplcFeFvVWmR
...
Do gt1=1,3
  Do gt2=1,3
ZcplcFvFvVZR(gt2,:) = ZcplcFvFvVZR(gt2,:)
 End Do
End Do
...
Do gt1=1,3
  Do gt2=1,3
ZcplcFvFvVZpR(gt2,:) = ZcplcFvFvVZpR(gt2,:)
 End Do
End Do
...
Subroutine getGBCouplings(MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,MFv2OS,MSuOS,               &
...
Complex(dp), Intent(in) :: cplAhcHpmVWm(3,2),cplcChaChiVWmL(2,6),cplcChaChiVWmR(2,6),cplcFdFuVWmL(3,3),          &
& cplcFdFuVWmR(3,3),cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),cplcFuFdcVWmL(3,3),              &
& cplcFuFdcVWmR(3,3),cplcFvFecVWmL(3,3),cplcFvFecVWmR(3,3),cplChiChacVWmL(6,2),          &
& cplChiChacVWmR(6,2),cplcHpmVPVWm(2),cplcHpmVWmVZ(2),cplcHpmVWmVZp(2),cplcVWmVPVWm,     &
& cplcVWmVWmVZ,cplcVWmVWmVZp,cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),cplSdcSucVWm(6,6),        &
& cplSecSvcVWm(6,3),cplSucSdVWm(6,6),cplSvcSeVWm(3,6),ZcplAhcHpmVWm(3,2),ZcplcChaChiVWmL(2,6),&
& ZcplcChaChiVWmR(2,6),ZcplcFdFuVWmL(3,3),ZcplcFdFuVWmR(3,3),ZcplcFeFvVWmL(3,3),         &
& ZcplcFeFvVWmR(3,3),ZcplcFuFdcVWmL(3,3),ZcplcFuFdcVWmR(3,3),ZcplcFvFecVWmL(3,3),        &
& ZcplcFvFecVWmR(3,3),ZcplChiChacVWmL(6,2),ZcplChiChacVWmR(6,2),ZcplcHpmVPVWm(2),        &
& ZcplcHpmVWmVZ(2),ZcplcHpmVWmVZp(2),ZcplcVWmVPVWm,ZcplcVWmVWmVZ,ZcplcVWmVWmVZp,         &
& ZcplhhcHpmVWm(3,2),ZcplhhcVWmVWm(3),ZcplSdcSucVWm(6,6),ZcplSecSvcVWm(6,3),             &
& ZcplSucSdVWm(6,6),ZcplSvcSeVWm(3,6)
...
& GcplcHpmVPVWm(2),GcplcHpmVWmVZ(2),GcplcHpmVWmVZp(2),GcplChiChacHpmL(6,2,2),            &
& GcplChiChacHpmR(6,2,2),GcplcChaChiHpmL(2,6,2),GcplcChaChiHpmR(2,6,2),GcplcFuFdcHpmL(3,3,2),&
...
& GZcplcHpmVPVWm(2),GZcplcHpmVWmVZ(2),GZcplcHpmVWmVZp(2),GZcplChiChacHpmL(6,2,2),        &
& GZcplChiChacHpmR(6,2,2),GZcplcChaChiHpmL(2,6,2),GZcplcChaChiHpmR(2,6,2),               &
...
& GosZcplChiChacHpmL(6,2,2),GosZcplChiChacHpmR(6,2,2),GosZcplcChaChiHpmL(2,6,2),         &
& GosZcplcChaChiHpmR(2,6,2),GosZcplcFuFdcHpmL(3,3,2),GosZcplcFuFdcHpmR(3,3,2),           &
...
Subroutine WaveFunctionRenormalisation(MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,               &
& MFv2OS,MSuOS,MSu2OS,MSeOS,MSe2OS,MhhOS,Mhh2OS,MAhOS,MAh2OS,MHpmOS,MHpm2OS,             &
& MChiOS,MChi2OS,MChaOS,MCha2OS,MFeOS,MFe2OS,MFdOS,MFd2OS,MFuOS,MFu2OS,MGluOS,           &
& MGlu2OS,MVZOS,MVZpOS,MVZ2OS,MVZp2OS,MVWmOS,MVWm2OS,ZDOS,ZVOS,ZVLOS,ZUOS,               &
...
& ZV,ZVL,ZW,ZZ,betaH,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yu,Td,TYe11,TYe22,TYe33,          &
& Tlam,Tu,mq2,ml012,ml022,ml032,mHd2,mHu2,md2,mu2,me012,me022,me032,ms2,M1,              &
& M2,M3,M4,Tdp,Tep,Tmup,vd,vu,vS,cplAhAhhh,cplAhHpmcHpm,cplAhSdcSd,cplAhSecSe,           &
& cplAhSucSu,cplhhhhhh,cplhhHpmcHpm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,         &
& cplHpmSucSd,cplHpmSvcSe,cplSdcHpmcSu,cplSecHpmcSv,cplAhAhAhAh,cplAhAhhhhh,             &
& cplAhAhHpmcHpm,cplAhAhSdcSd,cplAhAhSecSe,cplAhAhSucSu,cplAhAhSvcSv,cplAhhhHpmcHpm,     &
& cplAhhhSdcSd,cplAhhhSecSe,cplAhhhSucSu,cplAhHpmSucSd,cplAhHpmSvcSe,cplAhSdcHpmcSu,     &
...
& GcplcFeFvHpmL,GcplcFeFvHpmR,dg1,dg2,dg3,dgp,dSinQq,dCosQq,dTanQq,dSinQl1,              &
& dCosQl1,dTanQl1,dSinQl2,dCosQl2,dTanQl2,dSinQl3,dCosQl3,dTanQl3,dSinQHd,               &
& dCosQHd,dTanQHd,dSinQHu,dCosQHu,dTanQHu,dSinQd,dCosQd,dTanQd,dSinQu,dCosQu,            &
& dTanQu,dSinQe1,dCosQe1,dTanQe1,dSinQe2,dCosQe2,dTanQe2,dSinQe3,dCosQe3,dTanQe3,        &
...
& ZfFUR,ZfVPVZ,ZfVZVP,ZfVPVZp,ZfVZpVP,ZfVZVZp,ZfVZpVZ,ctcplAhAhhh,ctcplAhHpmcHpm,        &
...
Complex(dp) :: PiSd(6,6,6),DerPiSd(6,6,6),PiSv(3,3,3),DerPiSv(3,3,3),SigmaLFv(3,3,3),SigmaSLFv(3,3,3),&
...
& DerSigmaSRirFv(3,3,3),DerSigmaRirFv(3,3,3),PiSu(6,6,6),DerPiSu(6,6,6),PiSe(6,6,6),     &
& DerPiSe(6,6,6),Pihh(3,3,3),DerPihh(3,3,3),PiAh(3,3,3),DerPiAh(3,3,3),PiHpm(2,2,2),     &
& DerPiHpm(2,2,2),SigmaLChi(6,6,6),SigmaSLChi(6,6,6),SigmaSRChi(6,6,6),SigmaRChi(6,6,6), &
& DerSigmaLChi(6,6,6),DerSigmaSLChi(6,6,6),DerSigmaSRChi(6,6,6),DerSigmaRChi(6,6,6),     &
& DerSigmaLirChi(6,6,6),DerSigmaSLirChi(6,6,6),DerSigmaSRirChi(6,6,6),DerSigmaRirChi(6,6,6),&
& SigmaLCha(2,2,2),SigmaSLCha(2,2,2),SigmaSRCha(2,2,2),SigmaRCha(2,2,2),DerSigmaLCha(2,2,2),&
...
& DerPiVZVZp,PiVZpVZ,DerPiVZpVZ,PiVZhh(3,3,3),DerPiVZhh(3,3,3),PihhVZ(3,3,3),            &
& DerPihhVZ(3,3,3),PiVZAh(3,3,3),DerPiVZAh(3,3,3),PiAhVZ(3,3,3),DerPiAhVZ(3,3,3),        &
& PiVZphh(3,3,3),DerPiVZphh(3,3,3),PihhVZp(3,3,3),DerPihhVZp(3,3,3),PiVZpAh(3,3,3),      &
& DerPiVZpAh(3,3,3),PiAhVZp(3,3,3),DerPiAhVZp(3,3,3),PiVWmHpm(2,2,2),DerPiVWmHpm(2,2,2), &
& PiHpmVWm(2,2,2),DerPiHpmVWm(2,2,2)

Complex(dp) :: PiSdDR(6,6,6),DerPiSdDR(6,6,6),PiSvDR(3,3,3),DerPiSvDR(3,3,3),SigmaLFvDR(3,3,3),      &
...
& DerSigmaSLirFvDR(3,3,3),DerSigmaSRirFvDR(3,3,3),DerSigmaRirFvDR(3,3,3),PiSuDR(6,6,6),  &
& DerPiSuDR(6,6,6),PiSeDR(6,6,6),DerPiSeDR(6,6,6),PihhDR(3,3,3),DerPihhDR(3,3,3),        &
& PiAhDR(3,3,3),DerPiAhDR(3,3,3),PiHpmDR(2,2,2),DerPiHpmDR(2,2,2),SigmaLChiDR(6,6,6),    &
& SigmaSLChiDR(6,6,6),SigmaSRChiDR(6,6,6),SigmaRChiDR(6,6,6),DerSigmaLChiDR(6,6,6),      &
& DerSigmaSLChiDR(6,6,6),DerSigmaSRChiDR(6,6,6),DerSigmaRChiDR(6,6,6),DerSigmaLirChiDR(6,6,6),&
& DerSigmaSLirChiDR(6,6,6),DerSigmaSRirChiDR(6,6,6),DerSigmaRirChiDR(6,6,6),             &
...
& DerPiVZpVZDR,PiVZhhDR(3,3,3),DerPiVZhhDR(3,3,3),PihhVZDR(3,3,3),DerPihhVZDR(3,3,3),    &
& PiVZAhDR(3,3,3),DerPiVZAhDR(3,3,3),PiAhVZDR(3,3,3),DerPiAhVZDR(3,3,3),PiVZphhDR(3,3,3),&
& DerPiVZphhDR(3,3,3),PihhVZpDR(3,3,3),DerPihhVZpDR(3,3,3),PiVZpAhDR(3,3,3),             &
& DerPiVZpAhDR(3,3,3),PiAhVZpDR(3,3,3),DerPiAhVZpDR(3,3,3),PiVWmHpmDR(2,2,2),            &
& DerPiVWmHpmDR(2,2,2),PiHpmVWmDR(2,2,2),DerPiHpmVWmDR(2,2,2)

Complex(dp) :: PiSdOS(6,6,6),DerPiSdOS(6,6,6),PiSvOS(3,3,3),DerPiSvOS(3,3,3),SigmaLFvOS(3,3,3),      &
...
& DerSigmaSLirFvOS(3,3,3),DerSigmaSRirFvOS(3,3,3),DerSigmaRirFvOS(3,3,3),PiSuOS(6,6,6),  &
& DerPiSuOS(6,6,6),PiSeOS(6,6,6),DerPiSeOS(6,6,6),PihhOS(3,3,3),DerPihhOS(3,3,3),        &
& PiAhOS(3,3,3),DerPiAhOS(3,3,3),PiHpmOS(2,2,2),DerPiHpmOS(2,2,2),SigmaLChiOS(6,6,6),    &
& SigmaSLChiOS(6,6,6),SigmaSRChiOS(6,6,6),SigmaRChiOS(6,6,6),DerSigmaLChiOS(6,6,6),      &
& DerSigmaSLChiOS(6,6,6),DerSigmaSRChiOS(6,6,6),DerSigmaRChiOS(6,6,6),DerSigmaLirChiOS(6,6,6),&
& DerSigmaSLirChiOS(6,6,6),DerSigmaSRirChiOS(6,6,6),DerSigmaRirChiOS(6,6,6),             &
...
& DerPiVZpVZOS,PiVZhhOS(3,3,3),DerPiVZhhOS(3,3,3),PihhVZOS(3,3,3),DerPihhVZOS(3,3,3),    &
& PiVZAhOS(3,3,3),DerPiVZAhOS(3,3,3),PiAhVZOS(3,3,3),DerPiAhVZOS(3,3,3),PiVZphhOS(3,3,3),&
& DerPiVZphhOS(3,3,3),PihhVZpOS(3,3,3),DerPihhVZpOS(3,3,3),PiVZpAhOS(3,3,3),             &
& DerPiVZpAhOS(3,3,3),PiAhVZpOS(3,3,3),DerPiAhVZpOS(3,3,3),PiVWmHpmOS(2,2,2),            &
& DerPiVWmHpmOS(2,2,2),PiHpmVWmOS(2,2,2),DerPiHpmVWmOS(2,2,2)

Real(dp), Intent(in) :: MLambda, deltaM

Integer, Intent(out) :: kont
Real(dp),Intent(out) :: dg1,dg2,dg3,dgp,dSinQq,dCosQq,dTanQq,dSinQl1,dCosQl1,dTanQl1,dSinQl2,dCosQl2,         &
...
Complex(dp),Intent(out) :: dYd(3,3),dTd(3,3),dYe11,dTYe11,dYe22,dTYe22,dYe33,dTYe33,dYu(3,3),dTu(3,3),           &
...
Complex(dp),Intent(out) :: ZfVG,ZffG,ZfVP,ZfVZ,ZfVZp,ZfVWm,ZfSd(6,6),ZfSv(3,3),ZfFvL(3,3),ZfSu(6,6),             &
...
& MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,cplAhAhhh,cplcChaChahhL,cplcChaChahhR,cplChiChihhL,     &
& cplChiChihhR,cplcFdFdhhL,cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,              &
& cplcFuFuhhR,cplcgWmgWmhh,cplcgWpCgWpChh,cplcgZgZhh,cplcgZpgZphh,cplhhhhhh,             &
& cplhhHpmcHpm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,cplhhcVWmVWm,cplhhVZVZ,       &
& cplhhVZpVZp,Tad1Loop(1:3))
...
Do i1=1,3
p2 = MSv2(i1)
Call Pi1LoopSv(p2,MFv,MFv2,MChi,MChi2,MCha,MCha2,MFe,MFe2,MSv,MSv2,Mhh,               &
& Mhh2,MHpm,MHpm2,MSe,MSe2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,MAh,MAh2,MSd,MSd2,             &
& MSu,MSu2,cplChiFvcSvL,cplChiFvcSvR,cplcChaFecSvL,cplcChaFecSvR,cplhhSvcSv,             &
& cplSecHpmcSv,cplSecSvcVWm,cplSvcSvVZ,cplSvcSvVZp,cplAhAhSvcSv,cplhhhhSvcSv,            &
& cplHpmSvcHpmcSv,cplSdSvcSdcSv,cplSeSvcSecSv,cplSuSvcSucSv,cplSvSvcSvcSv,               &
& cplSvcSvcVWmVWm,cplSvcSvVZVZ,cplSvcSvVZpVZp,kont,PiSv(i1,:,:))

Call DerPi1LoopSv(p2,MFv,MFv2,MChi,MChi2,MCha,MCha2,MFe,MFe2,MSv,MSv2,Mhh,            &
& Mhh2,MHpm,MHpm2,MSe,MSe2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,MAh,MAh2,MSd,MSd2,             &
& MSu,MSu2,cplChiFvcSvL,cplChiFvcSvR,cplcChaFecSvL,cplcChaFecSvR,cplhhSvcSv,             &
& cplSecHpmcSv,cplSecSvcVWm,cplSvcSvVZ,cplSvcSvVZp,cplAhAhSvcSv,cplhhhhSvcSv,            &
& cplHpmSvcHpmcSv,cplSdSvcSdcSv,cplSeSvcSecSv,cplSuSvcSucSv,cplSvSvcSvcSv,               &
...
p2 =MSv2OS(i1)
Call DerPi1LoopSv(p2,MFvOS,MFv2OS,MChiOS,MChi2OS,MChaOS,MCha2OS,MFeOS,MFe2OS,         &
& MSvOS,MSv2OS,MhhOS,Mhh2OS,MHpmOS,MHpm2OS,MSeOS,MSe2OS,MVWmOS,MVWm2OS,MVZOS,            &
& MVZ2OS,MVZpOS,MVZp2OS,MAhOS,MAh2OS,MSdOS,MSd2OS,MSuOS,MSu2OS,cplChiFvcSvL,             &
& cplChiFvcSvR,cplcChaFecSvL,cplcChaFecSvR,cplhhSvcSv,cplSecHpmcSv,cplSecSvcVWm,         &
& cplSvcSvVZ,cplSvcSvVZp,cplAhAhSvcSv,cplhhhhSvcSv,cplHpmSvcHpmcSv,cplSdSvcSdcSv,        &
& cplSeSvcSecSv,cplSuSvcSucSv,cplSvSvcSvcSv,cplSvcSvcVWmVWm,cplSvcSvVZVZ,cplSvcSvVZpVZp, &
& kont,DerPiSvOS(i1,:,:))
...
& MVZ,MVZ2,MFv,MFv2,MVZp,MVZp2,MCha,MCha2,MSe,MSe2,cplcFvChiSvL,cplcFvChiSvR,            &
& cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,       &
& cplcFvFvVZpL,cplcFvFvVZpR,cplcChacFvSeL,cplcChacFvSeR,SigmaLFv(i1,:,:),SigmaRFv(i1,:,:)&
& ,SigmaSLFv(i1,:,:),SigmaSRFv(i1,:,:))

Call DerSigma1LoopFv(p2,MSv,MSv2,MChi,MChi2,MHpm,MHpm2,MFe,MFe2,MVWm,MVWm2,           &
& MVZ,MVZ2,MFv,MFv2,MVZp,MVZp2,MCha,MCha2,MSe,MSe2,cplcFvChiSvL,cplcFvChiSvR,            &
& cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,       &
& cplcFvFvVZpL,cplcFvFvVZpR,cplcChacFvSeL,cplcChacFvSeR,DerSigmaLFv(i1,:,:)              &
...
& MVZ,MVZ2,MFv,MFv2,MVZp,MVZp2,MCha,MCha2,MSe,MSe2,cplcFvChiSvL,cplcFvChiSvR,            &
& cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,       &
& cplcFvFvVZpL,cplcFvFvVZpR,cplcChacFvSeL,cplcChacFvSeR,DerSigmaLFvDR(i1,:,:)            &
...
& MFe2OS,MVWmOS,MVWm2OS,MVZOS,MVZ2OS,MFvOS,MFv2OS,MVZpOS,MVZp2OS,MChaOS,MCha2OS,         &
& MSeOS,MSe2OS,cplcFvChiSvL,cplcFvChiSvR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFecVWmL,      &
& cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcFvFvVZpL,cplcFvFvVZpR,cplcChacFvSeL,         &
...
& MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWm,MVWm2,MSd,MSd2,MSe,MSe2,               &
& MSu,MSu2,MSv,MSv2,cplAhAhhh,cplAhhhVZ,cplAhhhVZp,cplcChaChahhL,cplcChaChahhR,          &
...
& cplhhSecSe,cplhhSucSu,cplhhSvcSv,cplhhcVWmVWm,cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,        &
& cplAhAhhhhh,cplhhhhhhhh,cplhhhhHpmcHpm,cplhhhhSdcSd,cplhhhhSecSe,cplhhhhSucSu,         &
& cplhhhhSvcSv,cplhhhhcVWmVWm,cplhhhhVZVZ,cplhhhhVZpVZp,kont,Pihh(i1,:,:))

Pihh(i1,:,:) = Pihh(i1,:,:) + MatTad_hh
Call DerPi1Loophh(p2,MAh,MAh2,MVZ,MVZ2,MVZp,MVZp2,MCha,MCha2,MChi,MChi2,              &
& MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHpm,MHpm2,MVWm,MVWm2,MSd,MSd2,MSe,MSe2,           &
& MSu,MSu2,MSv,MSv2,cplAhAhhh,cplAhhhVZ,cplAhhhVZp,cplcChaChahhL,cplcChaChahhR,          &
& cplChiChihhL,cplChiChihhR,cplcFdFdhhL,cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,             &
& cplcFuFuhhL,cplcFuFuhhR,cplcgWmgWmhh,cplcgWpCgWpChh,cplcgZgZhh,cplcgZpgZhh,            &
& cplcgZgZphh,cplcgZpgZphh,cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,               &
& cplhhSecSe,cplhhSucSu,cplhhSvcSv,cplhhcVWmVWm,cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,        &
& cplAhAhhhhh,cplhhhhhhhh,cplhhhhHpmcHpm,cplhhhhSdcSd,cplhhhhSecSe,cplhhhhSucSu,         &
& cplhhhhSvcSv,cplhhhhcVWmVWm,cplhhhhVZVZ,cplhhhhVZpVZp,kont,DerPihh(i1,:,:))
...
& cplhhSecSe,cplhhSucSu,cplhhSvcSv,cplhhcVWmVWm,cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,        &
& cplAhAhhhhh,cplhhhhhhhh,cplhhhhHpmcHpm,cplhhhhSdcSd,cplhhhhSecSe,cplhhhhSucSu,         &
& cplhhhhSvcSv,cplhhhhcVWmVWm,cplhhhhVZVZ,cplhhhhVZpVZp,kont,DerPihhDR(i1,:,:))

p2 =Mhh2OS(i1)
Call DerPi1Loophh(p2,MAhOS,MAh2OS,MVZOS,MVZ2OS,MVZpOS,MVZp2OS,MChaOS,MCha2OS,         &
& MChiOS,MChi2OS,MFdOS,MFd2OS,MFeOS,MFe2OS,MFuOS,MFu2OS,MhhOS,Mhh2OS,MHpmOS,             &
& MHpm2OS,MVWmOS,MVWm2OS,MSdOS,MSd2OS,MSeOS,MSe2OS,MSuOS,MSu2OS,MSvOS,MSv2OS,            &
& cplAhAhhh,cplAhhhVZ,cplAhhhVZp,cplcChaChahhL,cplcChaChahhR,cplChiChihhL,               &
& cplChiChihhR,cplcFdFdhhL,cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,              &
& cplcFuFuhhR,cplcgWmgWmhh,cplcgWpCgWpChh,cplcgZgZhh,cplcgZpgZhh,cplcgZgZphh,            &
& cplcgZpgZphh,cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,     &
& cplhhSvcSv,cplhhcVWmVWm,cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,cplAhAhhhhh,cplhhhhhhhh,      &
...
& MFe2,MFu,MFu2,MVZ,MVZ2,MVZp,MVZp2,MHpm,MHpm2,MVWm,MVWm2,MSd,MSd2,MSe,MSe2,             &
& MSu,MSu2,MSv,MSv2,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,     &
...
& cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplAhAhAhAh,cplAhAhhhhh,cplAhAhHpmcHpm,               &
& cplAhAhSdcSd,cplAhAhSecSe,cplAhAhSucSu,cplAhAhSvcSv,cplAhAhcVWmVWm,cplAhAhVZVZ,        &
& cplAhAhVZpVZp,kont,DerPiAhDR(i1,:,:))

p2 =MAh2OS(i1)
Call DerPi1LoopAh(p2,MhhOS,Mhh2OS,MAhOS,MAh2OS,MChaOS,MCha2OS,MChiOS,MChi2OS,         &
& MFdOS,MFd2OS,MFeOS,MFe2OS,MFuOS,MFu2OS,MVZOS,MVZ2OS,MVZpOS,MVZp2OS,MHpmOS,             &
& MHpm2OS,MVWmOS,MVWm2OS,MSdOS,MSd2OS,MSeOS,MSe2OS,MSuOS,MSu2OS,MSvOS,MSv2OS,            &
...
& cplcgWpCgWpCAh,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,              &
...
& MVZp,MVZp2,cplAhAhhh,cplAhcHpmVWm,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,      &
& cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplcChaChaAhL,cplcChaChaAhR,cplcChaChaVZL,            &
...
& cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSdVZ,cplSecSeVZ,cplSucSuVZ,kont,PiVZAh(i1,:,:))
...
& cplcFuFuVZR,cplcgWmgWmAh,cplcgWmgWmVZ,cplcgWpCgWpCAh,cplcgWpCgWpCVZ,cplChiChiAhL,      &
& cplChiChiAhR,cplChiChiVZL,cplChiChiVZR,cplcHpmVWmVZ,cplhhVZVZ,cplhhVZVZp,              &
& cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSdVZ,cplSecSeVZ,cplSucSuVZ,kont,DerPiVZAh(i1,:,:))
...
& cplcFuFuVZR,cplcgWmgWmAh,cplcgWmgWmVZ,cplcgWpCgWpCAh,cplcgWpCgWpCVZ,cplChiChiAhL,      &
& cplChiChiAhR,cplChiChiVZL,cplChiChiVZR,cplcHpmVWmVZ,cplhhVZVZ,cplhhVZVZp,              &
& cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSdVZ,cplSecSeVZ,cplSucSuVZ,kont,DerPiVZAhDR(i1,:,:))
...
& MSeOS,MSe2OS,MSuOS,MSu2OS,MVWmOS,MVWm2OS,MVZOS,MVZ2OS,MVZpOS,MVZp2OS,cplAhAhhh,        &
& GcplAhcHpmVWm,cplAhhhVZ,cplAhhhVZp,GcplAhHpmcHpm,GcplAhHpmcVWm,cplAhSdcSd,             &
...
& cplChiChiVZL,cplChiChiVZR,GcplcHpmVWmVZ,cplhhVZVZ,cplhhVZVZp,GcplHpmcHpmVZ,            &
& GcplHpmcVWmVZ,cplSdcSdVZ,cplSecSeVZ,cplSucSuVZ,kont,DerPiVZAhOS(i1,:,:))
...
& cplcFuFuVZR,cplcgWmgWmAh,cplcgWmgWmVZ,cplcgWpCgWpCAh,cplcgWpCgWpCVZ,cplChiChiAhL,      &
& cplChiChiAhR,cplChiChiVZL,cplChiChiVZR,cplcHpmVWmVZ,cplhhVZVZ,cplhhVZVZp,              &
& cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSdVZ,cplSecSeVZ,cplSucSuVZ,kont,PiAhVZ)
...
& cplcFuFuVZR,cplcgWmgWmAh,cplcgWmgWmVZ,cplcgWpCgWpCAh,cplcgWpCgWpCVZ,cplChiChiAhL,      &
& cplChiChiAhR,cplChiChiVZL,cplChiChiVZR,cplcHpmVWmVZ,cplhhVZVZ,cplhhVZVZp,              &
& cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSdVZ,cplSecSeVZ,cplSucSuVZ,kont,DerPiAhVZ)
...
& cplcFuFuVZR,cplcgWmgWmAh,cplcgWmgWmVZ,cplcgWpCgWpCAh,cplcgWpCgWpCVZ,cplChiChiAhL,      &
& cplChiChiAhR,cplChiChiVZL,cplChiChiVZR,cplcHpmVWmVZ,cplhhVZVZ,cplhhVZVZp,              &
& cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSdVZ,cplSecSeVZ,cplSucSuVZ,kont,DerPiVZAhDR)
...
& cplcgWmgWmAh,cplcgWmgWmVZ,cplcgWpCgWpCAh,cplcgWpCgWpCVZ,cplChiChiAhL,cplChiChiAhR,     &
& cplChiChiVZL,cplChiChiVZR,GcplcHpmVWmVZ,cplhhVZVZ,cplhhVZVZp,GcplHpmcHpmVZ,            &
& GcplHpmcVWmVZ,cplSdcSdVZ,cplSecSeVZ,cplSucSuVZ,kont,DerPiVZAhOS)
...
Do i1=1,3
p2 = Mhh2(i1)
Call Pi1LoopVZphh(p2,MCha,MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MHpm,           &
& MHpm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,MVWm,MVWm2,cplcChaChahhL,cplcChaChahhR,      &
& cplcChaChaVZpL,cplcChaChaVZpR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZpL,cplcFdFdVZpR,       &
...
& cplChiChihhL,cplChiChihhR,cplChiChiVZpL,cplChiChiVZpR,cplcHpmVWmVZp,cplcVWmVWmVZp,     &
& cplhhcHpmVWm,cplhhcVWmVWm,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,cplhhSecSe,             &
& cplhhSucSu,cplhhSvcSv,cplHpmcHpmVZp,cplHpmcVWmVZp,cplSdcSdVZp,cplSecSeVZp,             &
& cplSucSuVZp,cplSvcSvVZp,kont,PiVZphh(i1,:,:))
...
& cplcgWpCgWpCVZp,cplChiChihhL,cplChiChihhR,cplChiChiVZpL,cplChiChiVZpR,cplcHpmVWmVZp,   &
& cplcVWmVWmVZp,cplhhcHpmVWm,cplhhcVWmVWm,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,          &
& cplhhSecSe,cplhhSucSu,cplhhSvcSv,cplHpmcHpmVZp,cplHpmcVWmVZp,cplSdcSdVZp,              &
& cplSecSeVZp,cplSucSuVZp,cplSvcSvVZp,kont,DerPiVZphh(i1,:,:))
...
& cplcVWmVWmVZp,cplhhcHpmVWm,cplhhcVWmVWm,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,          &
& cplhhSecSe,cplhhSucSu,cplhhSvcSv,cplHpmcHpmVZp,cplHpmcVWmVZp,cplSdcSdVZp,              &
& cplSecSeVZp,cplSucSuVZp,cplSvcSvVZp,kont,DerPiVZphhDR(i1,:,:))

p2 =Mhh2OS(i1)
Call DerPi1LoopVZphh(p2,MChaOS,MCha2OS,MChiOS,MChi2OS,MFdOS,MFd2OS,MFeOS,             &
& MFe2OS,MFuOS,MFu2OS,MHpmOS,MHpm2OS,MSdOS,MSd2OS,MSeOS,MSe2OS,MSuOS,MSu2OS,             &
& MSvOS,MSv2OS,MVWmOS,MVWm2OS,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZpL,cplcChaChaVZpR, &
...
& cplcgWmgWmhh,cplcgWmgWmVZp,cplcgWpCgWpChh,cplcgWpCgWpCVZp,cplChiChihhL,cplChiChihhR,   &
& cplChiChiVZpL,cplChiChiVZpR,GcplcHpmVWmVZp,cplcVWmVWmVZp,GcplhhcHpmVWm,cplhhcVWmVWm,   &
& GcplhhHpmcHpm,GcplhhHpmcVWm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,               &
& GcplHpmcHpmVZp,GcplHpmcVWmVZp,cplSdcSdVZp,cplSecSeVZp,cplSucSuVZp,cplSvcSvVZp,         &
...
& cplhhcHpmVWm,cplhhcVWmVWm,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,cplhhSecSe,             &
& cplhhSucSu,cplhhSvcSv,cplHpmcHpmVZp,cplHpmcVWmVZp,cplSdcSdVZp,cplSecSeVZp,             &
& cplSucSuVZp,cplSvcSvVZp,kont,PihhVZp)
...
& cplcVWmVWmVZp,cplhhcHpmVWm,cplhhcVWmVWm,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,          &
& cplhhSecSe,cplhhSucSu,cplhhSvcSv,cplHpmcHpmVZp,cplHpmcVWmVZp,cplSdcSdVZp,              &
& cplSecSeVZp,cplSucSuVZp,cplSvcSvVZp,kont,DerPihhVZp)
...
& cplcVWmVWmVZp,cplhhcHpmVWm,cplhhcVWmVWm,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,          &
& cplhhSecSe,cplhhSucSu,cplhhSvcSv,cplHpmcHpmVZp,cplHpmcVWmVZp,cplSdcSdVZp,              &
& cplSecSeVZp,cplSucSuVZp,cplSvcSvVZp,kont,DerPiVZphhDR)
...
& MFu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,MVWm,MVWm2,MVZ,MVZ2,               &
& MVZp,MVZp2,cplAhAhhh,cplAhcHpmVWm,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,      &
& cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplcChaChaAhL,cplcChaChaAhR,cplcChaChaVZpL,           &
& cplcChaChaVZpR,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdVZpL,cplcFdFdVZpR,cplcFeFeAhL,          &
& cplcFeFeAhR,cplcFeFeVZpL,cplcFeFeVZpR,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuVZpL,            &
& cplcFuFuVZpR,cplcgWmgWmAh,cplcgWmgWmVZp,cplcgWpCgWpCAh,cplcgWpCgWpCVZp,cplChiChiAhL,   &
& cplChiChiAhR,cplChiChiVZpL,cplChiChiVZpR,cplcHpmVWmVZp,cplhhVZpVZp,cplhhVZVZp,         &
& cplHpmcHpmVZp,cplHpmcVWmVZp,cplSdcSdVZp,cplSecSeVZp,cplSucSuVZp,kont,PiVZpAh(i1,:,:))
...
& cplcFuFuVZpR,cplcgWmgWmAh,cplcgWmgWmVZp,cplcgWpCgWpCAh,cplcgWpCgWpCVZp,cplChiChiAhL,   &
& cplChiChiAhR,cplChiChiVZpL,cplChiChiVZpR,cplcHpmVWmVZp,cplhhVZpVZp,cplhhVZVZp,         &
& cplHpmcHpmVZp,cplHpmcVWmVZp,cplSdcSdVZp,cplSecSeVZp,cplSucSuVZp,kont,DerPiVZpAh(i1,:,:))
...
& cplcFuFuVZpR,cplcgWmgWmAh,cplcgWmgWmVZp,cplcgWpCgWpCAh,cplcgWpCgWpCVZp,cplChiChiAhL,   &
& cplChiChiAhR,cplChiChiVZpL,cplChiChiVZpR,cplcHpmVWmVZp,cplhhVZpVZp,cplhhVZVZp,         &
& cplHpmcHpmVZp,cplHpmcVWmVZp,cplSdcSdVZp,cplSecSeVZp,cplSucSuVZp,kont,DerPiVZpAhDR(i1,:,:))
...
& MSeOS,MSe2OS,MSuOS,MSu2OS,MVWmOS,MVWm2OS,MVZOS,MVZ2OS,MVZpOS,MVZp2OS,cplAhAhhh,        &
& GcplAhcHpmVWm,cplAhhhVZ,cplAhhhVZp,GcplAhHpmcHpm,GcplAhHpmcVWm,cplAhSdcSd,             &
& cplAhSecSe,cplAhSucSu,cplcChaChaAhL,cplcChaChaAhR,cplcChaChaVZpL,cplcChaChaVZpR,       &
...
& cplChiChiVZpL,cplChiChiVZpR,GcplcHpmVWmVZp,cplhhVZpVZp,cplhhVZVZp,GcplHpmcHpmVZp,      &
& GcplHpmcVWmVZp,cplSdcSdVZp,cplSecSeVZp,cplSucSuVZp,kont,DerPiVZpAhOS(i1,:,:))
...
& cplcFuFuVZpR,cplcgWmgWmAh,cplcgWmgWmVZp,cplcgWpCgWpCAh,cplcgWpCgWpCVZp,cplChiChiAhL,   &
& cplChiChiAhR,cplChiChiVZpL,cplChiChiVZpR,cplcHpmVWmVZp,cplhhVZpVZp,cplhhVZVZp,         &
& cplHpmcHpmVZp,cplHpmcVWmVZp,cplSdcSdVZp,cplSecSeVZp,cplSucSuVZp,kont,PiAhVZp)
...
& cplcFuFuVZpR,cplcgWmgWmAh,cplcgWmgWmVZp,cplcgWpCgWpCAh,cplcgWpCgWpCVZp,cplChiChiAhL,   &
& cplChiChiAhR,cplChiChiVZpL,cplChiChiVZpR,cplcHpmVWmVZp,cplhhVZpVZp,cplhhVZVZp,         &
& cplHpmcHpmVZp,cplHpmcVWmVZp,cplSdcSdVZp,cplSecSeVZp,cplSucSuVZp,kont,DerPiAhVZp)
...
& cplcFuFuVZpR,cplcgWmgWmAh,cplcgWmgWmVZp,cplcgWpCgWpCAh,cplcgWpCgWpCVZp,cplChiChiAhL,   &
& cplChiChiAhR,cplChiChiVZpL,cplChiChiVZpR,cplcHpmVWmVZp,cplhhVZpVZp,cplhhVZVZp,         &
& cplHpmcHpmVZp,cplHpmcVWmVZp,cplSdcSdVZp,cplSecSeVZp,cplSucSuVZp,kont,DerPiVZpAhDR)
...
& cplcgWmgWmAh,cplcgWmgWmVZp,cplcgWpCgWpCAh,cplcgWpCgWpCVZp,cplChiChiAhL,cplChiChiAhR,   &
& cplChiChiVZpL,cplChiChiVZpR,GcplcHpmVWmVZp,cplhhVZpVZp,cplhhVZVZp,GcplHpmcHpmVZp,      &
& GcplHpmcVWmVZp,cplSdcSdVZp,cplSecSeVZp,cplSucSuVZp,kont,DerPiVZpAhOS)
...
& ms2,M1,M2,M3,M4,Tdp,Tep,Tmup,vd,vu,vS,g1D)

TwoLoopRGEsave=TwoLoopRGE
TwoLoopRGE=.False.
Call rge186(186,0._dp,g1D,g1D)
TwoLoopRGE=TwoLoopRGEsave
Call GToParameters186(g1D,dg1,dg2,dg3,dgp,dYd,dYe11,dYe22,dYe33,dlam,dYu,             &
& dTd,dTYe11,dTYe22,dTYe33,dTlam,dTu,dmq2,dml012,dml022,dml032,dmHd2,dmHu2,              &
& dmd2,dmu2,dme012,dme022,dme032,dms2,dM1,dM2,dM3,dM4,dTdp,dTep,dTmup,dvd,dvu,dvS)
...
dYe11 = 0.5_dp*divergence*dYe11
dTYe11 = 0.5_dp*divergence*dTYe11
dYe22 = 0.5_dp*divergence*dYe22
dTYe22 = 0.5_dp*divergence*dTYe22
dYe33 = 0.5_dp*divergence*dYe33
dTYe33 = 0.5_dp*divergence*dTYe33
...
dml012 = 0.5_dp*divergence*dml012
dml022 = 0.5_dp*divergence*dml022
dml032 = 0.5_dp*divergence*dml032
dmHd2 = 0.5_dp*divergence*dmHd2
dmHu2 = 0.5_dp*divergence*dmHu2
dmd2 = 0.5_dp*divergence*dmd2
dmu2 = 0.5_dp*divergence*dmu2
dme012 = 0.5_dp*divergence*dme012
dme022 = 0.5_dp*divergence*dme022
dme032 = 0.5_dp*divergence*dme032
...
dTdp = 0.5_dp*divergence*dTdp
dTep = 0.5_dp*divergence*dTep
dTmup = 0.5_dp*divergence*dTmup
...
! -----------------------------------------------------------
Call CalculateCouplingCT(g1,g2,gp,lam,Tlam,vd,vu,vS,ZH,ZA,ZP,Yd,Td,Tdp,               &
& ZD,Ye11,TYe11,Ye22,TYe22,Ye33,TYe33,Tep,Tmup,ZE,Yu,Tu,ZU,ZV,TW,TWp,g3,UM,              &
& UP,ZN,ZDL,ZDR,ZEL,ZER,ZUL,ZUR,ZVL,pG,dg1,dg2,dgp,dlam,dTlam,dvd,dvu,dvS,               &
...
& gP1LHpm,gP1LGlu,gP1LChi,gP1LCha,gP1LFu,MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,MFv2OS,         &
& MSuOS,MSu2OS,MSeOS,MSe2OS,MhhOS,Mhh2OS,MAhOS,MAh2OS,MHpmOS,MHpm2OS,MChiOS,             &
& MChi2OS,MChaOS,MCha2OS,MFeOS,MFe2OS,MFdOS,MFd2OS,MFuOS,MFu2OS,MGluOS,MGlu2OS,          &
& MVZOS,MVZpOS,MVZ2OS,MVZp2OS,MVWmOS,MVWm2OS,ZDOS,ZVOS,ZVLOS,ZUOS,ZEOS,ZHOS,             &
...
Real(dp) :: dg1,dg2,dg3,dgp,dSinQq,dCosQq,dTanQq,dSinQl1,dCosQl1,dTanQl1,dSinQl2,dCosQl2,         &
& dTanQl2,dSinQl3,dCosQl3,dTanQl3,dSinQHd,dCosQHd,dTanQHd,dSinQHu,dCosQHu,               &
& dTanQHu,dSinQd,dCosQd,dTanQd,dSinQu,dCosQu,dTanQu,dSinQe1,dCosQe1,dTanQe1,             &
& dSinQe2,dCosQe2,dTanQe2,dSinQe3,dCosQe3,dTanQe3,dSinQs,dCosQs,dTanQs,dlam,             &
& dTlam,dml012,dml022,dml032,dmHd2,dmHu2,dme012,dme022,dme032,dms2,dvd,dvu,              &
...
Complex(dp) :: dYd(3,3),dTd(3,3),dYe11,dTYe11,dYe22,dTYe22,dYe33,dTYe33,dYu(3,3),dTu(3,3),           &
& dmq2(3,3),dmd2(3,3),dmu2(3,3),dM1,dM2,dM3,dM4,dTdp(3,3),dTep,dTmup,dpG,dZD(6,6),       &
& dZV(3,3),dZVL(3,3),dZU(6,6),dZE(6,6),dZH(3,3),dZA(3,3),dZN(6,6),dUM(2,2),              &
& dUP(2,2),dZEL(3,3),dZER(3,3),dZDL(3,3),dZDR(3,3),dZUL(3,3),dZUR(3,3)

Complex(dp) :: ZfVG,ZffG,ZfVP,ZfVZ,ZfVZp,ZfVWm,ZfSd(6,6),ZfSv(3,3),ZfFvL(3,3),ZfSu(6,6),             &
& ZfSe(6,6),Zfhh(3,3),ZfAh(3,3),ZfHpm(2,2),ZfL0(6,6),ZfLm(2,2),ZfLp(2,2),ZfFEL(3,3),     &
& ZfFER(3,3),ZfFDL(3,3),ZfFDR(3,3),ZfFUL(3,3),ZfFUR(3,3),ZfVPVZ,ZfVZVP,ZfVPVZp,          &
& ZfVZpVP,ZfVZVZp,ZfVZpVZ
...
Complex(dp) :: cplAhAhAhAh1(3,3,3,3),cplAhAhhhhh1(3,3,3,3),cplAhAhHpmcHpm1(3,3,2,2),cplAhAhSdcSdaa(3,3,6,6),&
& cplAhAhSecSe1(3,3,6,6),cplAhAhSucSuaa(3,3,6,6),cplAhAhSvcSv1(3,3,3,3),cplAhhhHpmcHpm1(3,3,2,2),&
& cplAhhhSdcSdaa(3,3,6,6),cplAhhhSecSe1(3,3,6,6),cplAhhhSucSuaa(3,3,6,6),cplAhHpmSucSdaa(3,2,6,6),&
& cplAhHpmSvcSe1(3,2,3,6),cplAhSdcHpmcSuaa(3,6,2,6),cplAhSecHpmcSv1(3,6,2,3),            &
...
& cplAhAhVZVZp1(3,3),cplAhAhVZpVZp1(3,3),cplAhHpmcVWmVP1(3,2),cplAhHpmcVWmVZ1(3,2),      &
& cplAhHpmcVWmVZp1(3,2),cplAhcHpmVPVWm1(3,2),cplAhcHpmVWmVZ1(3,2),cplAhcHpmVWmVZp1(3,2), &
& cplhhhhcVWmVWm1(3,3),cplhhhhVZVZ1(3,3),cplhhhhVZVZp1(3,3),cplhhhhVZpVZp1(3,3),         &
& cplhhHpmcVWmVP1(3,2),cplhhHpmcVWmVZ1(3,2),cplhhHpmcVWmVZp1(3,2),cplhhcHpmVPVWm1(3,2),  &
& cplhhcHpmVWmVZ1(3,2),cplhhcHpmVWmVZp1(3,2),cplHpmcHpmVPVP1(2,2),cplHpmcHpmVPVZ1(2,2),  &
& cplHpmcHpmVPVZp1(2,2),cplHpmcHpmcVWmVWm1(2,2),cplHpmcHpmVZVZ1(2,2),cplHpmcHpmVZVZp1(2,2),&
& cplHpmcHpmVZpVZp1(2,2),cplSdcSdVGVGsumj113Lamct3ct2j1Lamct4j1ct1(6,6),cplSdcSdVGVGsumj113Lamct3j1ct1Lamct4ct2j1(6,6),&
& cplSdcSdVGVPLamct3ct2ct1(6,6),cplSdcSdVGVZLamct3ct2ct1(6,6),cplSdcSdVGVZpLamct3ct2ct1(6,6),&
& cplSdcSucVWmVGLamct4ct2ct1(6,6),cplSdcSdVPVPaa(6,6),cplSdcSdVPVZaa(6,6),               &
& cplSdcSdVPVZpaa(6,6),cplSdcSucVWmVPaa(6,6),cplSdcSdcVWmVWmaa(6,6),cplSdcSdVZVZaa(6,6), &
& cplSdcSdVZVZpaa(6,6),cplSdcSucVWmVZaa(6,6),cplSdcSdVZpVZpaa(6,6),cplSdcSucVWmVZpaa(6,6),&
& cplSecSeVPVP1(6,6),cplSecSeVPVZ1(6,6),cplSecSeVPVZp1(6,6),cplSecSvcVWmVP1(6,3),        &
& cplSecSecVWmVWm1(6,6),cplSecSeVZVZ1(6,6),cplSecSeVZVZp1(6,6),cplSecSvcVWmVZ1(6,3),     &
& cplSecSeVZpVZp1(6,6),cplSecSvcVWmVZp1(6,3),cplSucSuVGVGsumj113Lamct3ct2j1Lamct4j1ct1(6,6),&
...
& cplSucSuVZVZpaa(6,6),cplSucSuVZpVZpaa(6,6),cplSvcSeVPVWm1(3,6),cplSvcSeVWmVZ1(3,6),    &
& cplSvcSeVWmVZp1(3,6),cplSvcSvcVWmVWm1(3,3),cplSvcSvVZVZ1(3,3),cplSvcSvVZVZp1(3,3),     &
& cplSvcSvVZpVZp1(3,3),cplVGVGVGVG1Q,cplVGVGVGVG2Q,cplVGVGVGVG3Q,cplcVWmVPVPVWm1Q,       &
& cplcVWmVPVPVWm2Q,cplcVWmVPVPVWm3Q,cplcVWmVPVWmVZ1Q,cplcVWmVPVWmVZ2Q,cplcVWmVPVWmVZ3Q,  &
& cplcVWmVPVWmVZp1Q,cplcVWmVPVWmVZp2Q,cplcVWmVPVWmVZp3Q,cplcVWmcVWmVWmVWm1Q

Complex(dp) :: cplcVWmcVWmVWmVWm2Q,cplcVWmcVWmVWmVWm3Q,cplcVWmVWmVZVZ1Q,cplcVWmVWmVZVZ2Q,             &
& cplcVWmVWmVZVZ3Q,cplcVWmVWmVZVZp1Q,cplcVWmVWmVZVZp2Q,cplcVWmVWmVZVZp3Q,cplcVWmVWmVZpVZp1Q,&
& cplcVWmVWmVZpVZp2Q,cplcVWmVWmVZpVZp3Q
...
Complex(dp) :: cplSucSuVPVZp(6,6),cplSucSdVWmVZ(6,6),cplSucSdVWmVZp(6,6),cplSucSucVWmVWm(6,6),        &
& cplSucSuVZVZ(6,6),cplSucSuVZVZp(6,6),cplSucSuVZpVZp(6,6),cplSvcSeVPVWm(3,6),           &
& cplSvcSeVWmVZ(3,6),cplSvcSeVWmVZp(3,6),cplSvcSvcVWmVWm(3,3),cplSvcSvVZVZ(3,3),         &
& cplSvcSvVZVZp(3,3),cplSvcSvVZpVZp(3,3),cplVGVGVG,cplcVWmVPVWm,cplcVWmVWmVZ,            &
& cplcVWmVWmVZp,cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),cplChiChiAhL(6,6,3),           &
...
Complex(dp) :: cplcVWmVWmVZVZp2,cplcVWmVWmVZVZp3,cplcVWmVWmVZpVZp1,cplcVWmVWmVZpVZp2,cplcVWmVWmVZpVZp3,&
& cplcgGgGVG,cplcgWmgAVWm,cplcgWpCgAcVWm,cplcgWmgWmVP,cplcgWmgWmVZ,cplcgWmgWmVZp,        &
& cplcgAgWmcVWm,cplcgZgWmcVWm,cplcgZpgWmcVWm,cplcgWpCgWpCVP,cplcgAgWpCVWm,               &
& cplcgZgWpCVWm,cplcgZpgWpCVWm,cplcgWpCgWpCVZ,cplcgWpCgWpCVZp,cplcgWmgZVWm,              &
& cplcgWpCgZcVWm,cplcgWmgZpVWm,cplcgWpCgZpcVWm,cplcgWmgWmAh(3),cplcgWpCgWpCAh(3),        &
...
Complex(dp) :: ctcplAhAhhh(3,3,3),ctcplAhHpmcHpm(3,2,2),ctcplAhSdcSd(3,6,6),ctcplAhSecSe(3,6,6),     &
& ctcplAhSucSu(3,6,6),ctcplhhhhhh(3,3,3),ctcplhhHpmcHpm(3,2,2),ctcplhhSdcSd(3,6,6),      &
& ctcplhhSecSe(3,6,6),ctcplhhSucSu(3,6,6),ctcplhhSvcSv(3,3,3),ctcplHpmSucSd(2,6,6),      &
& ctcplHpmSvcSe(2,3,6),ctcplSdcHpmcSu(6,2,6),ctcplSecHpmcSv(6,2,3),ctcplAhhhVZ(3,3),     &
& ctcplAhhhVZp(3,3),ctcplAhHpmcVWm(3,2),ctcplAhcHpmVWm(3,2),ctcplhhHpmcVWm(3,2),         &
...
Complex(dp) :: ctcplcFuFdcVWmR(3,3),ctcplcFeFeVPL(3,3),ctcplcFeFeVPR(3,3),ctcplcFeFeVZL(3,3),         &
& ctcplcFeFeVZR(3,3),ctcplcFeFeVZpL(3,3),ctcplcFeFeVZpR(3,3),ctcplcFvFecVWmL(3,3),       &
& ctcplcFvFecVWmR(3,3),ctcplcFuFuVGL(3,3),ctcplcFuFuVGR(3,3),ctcplcFuFuVPL(3,3),         &
& ctcplcFuFuVPR(3,3),ctcplcFdFuVWmL(3,3),ctcplcFdFuVWmR(3,3),ctcplcFuFuVZL(3,3),         &
& ctcplcFuFuVZR(3,3),ctcplcFuFuVZpL(3,3),ctcplcFuFuVZpR(3,3),ctcplcFeFvVWmL(3,3),        &
...
Complex(dp) :: ZRUZD(6,6),ZRUZV(3,3),ZRUZVL(3,3),ZRUZU(6,6),ZRUZE(6,6),ZRUZH(3,3),ZRUZA(3,3),        &
& ZRUZP(2,2),ZRUZN(6,6),ZRUUM(2,2),ZRUUP(2,2),ZRUZEL(3,3),ZRUZER(3,3),ZRUZDL(3,3),       &
& ZRUZDR(3,3),ZRUZUL(3,3),ZRUZUR(3,3)

Complex(dp) :: ZcplAhAhhh(3,3,3),ZcplAhHpmcHpm(3,2,2),ZcplAhSdcSd(3,6,6),ZcplAhSecSe(3,6,6),         &
& ZcplAhSucSu(3,6,6),Zcplhhhhhh(3,3,3),ZcplhhHpmcHpm(3,2,2),ZcplhhSdcSd(3,6,6),          &
& ZcplhhSecSe(3,6,6),ZcplhhSucSu(3,6,6),ZcplhhSvcSv(3,3,3),ZcplHpmSucSd(2,6,6),          &
& ZcplHpmSvcSe(2,3,6),ZcplSdcHpmcSu(6,2,6),ZcplSecHpmcSv(6,2,3),ZcplAhAhAhAh(3,3,3,3),   &
& ZcplAhAhhhhh(3,3,3,3),ZcplAhAhHpmcHpm(3,3,2,2),ZcplAhAhSdcSd(3,3,6,6),ZcplAhAhSecSe(3,3,6,6),&
...
Complex(dp) :: ZcplSucSdVGVWm(6,6),ZcplSucSuVGVZ(6,6),ZcplSucSuVGVZp(6,6),ZcplSucSuVPVP(6,6),         &
& ZcplSucSdVPVWm(6,6),ZcplSucSuVPVZ(6,6),ZcplSucSuVPVZp(6,6),ZcplSucSdVWmVZ(6,6),        &
& ZcplSucSdVWmVZp(6,6),ZcplSucSucVWmVWm(6,6),ZcplSucSuVZVZ(6,6),ZcplSucSuVZVZp(6,6),     &
& ZcplSucSuVZpVZp(6,6),ZcplSvcSeVPVWm(3,6),ZcplSvcSeVWmVZ(3,6),ZcplSvcSeVWmVZp(3,6),     &
& ZcplSvcSvcVWmVWm(3,3),ZcplSvcSvVZVZ(3,3),ZcplSvcSvVZVZp(3,3),ZcplSvcSvVZpVZp(3,3),     &
...
Complex(dp) :: ZcplcVWmVPVPVWm3,ZcplcVWmVPVWmVZ1,ZcplcVWmVPVWmVZ2,ZcplcVWmVPVWmVZ3,ZcplcVWmVPVWmVZp1, &
& ZcplcVWmVPVWmVZp2,ZcplcVWmVPVWmVZp3,ZcplcVWmcVWmVWmVWm1,ZcplcVWmcVWmVWmVWm2,           &
& ZcplcVWmcVWmVWmVWm3,ZcplcVWmVWmVZVZ1,ZcplcVWmVWmVZVZ2,ZcplcVWmVWmVZVZ3,ZcplcVWmVWmVZVZp1,&
& ZcplcVWmVWmVZVZp2,ZcplcVWmVWmVZVZp3,ZcplcVWmVWmVZpVZp1,ZcplcVWmVWmVZpVZp2,             &
& ZcplcVWmVWmVZpVZp3,ZcplcgGgGVG,ZcplcgWmgAVWm,ZcplcgWpCgAcVWm,ZcplcgWmgWmVP,            &
...
Real(dp), Intent(out) :: gP1LSd(6,87)
Real(dp), Intent(out) :: gP1LSu(6,87)
...
End if
! Couplings
Call AllCouplingsReallyAll(g1,g2,gp,lam,Tlam,vd,vu,vS,ZH,ZA,ZP,Yd,Td,Tdp,             &
& ZD,Ye11,TYe11,Ye22,TYe22,Ye33,TYe33,Tep,Tmup,ZE,Yu,Tu,ZU,ZV,g3,TW,TWp,UM,              &
& UP,ZN,ZDL,ZDR,ZEL,ZER,ZUL,ZUR,ZVL,pG,cplAhAhhh,cplAhHpmcHpm,cplAhSdcSd,cplAhSecSe,     &
& cplAhSucSu,cplhhhhhh,cplhhHpmcHpm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,         &
& cplHpmSucSd,cplHpmSvcSe,cplSdcHpmcSu,cplSecHpmcSv,cplAhAhAhAh,cplAhAhhhhh,             &
...
em = cplcVWmVPVWm
gs = cplcFdFdVGL(1,1)
Call CouplingsColoredQuartics(g1,g2,gp,lam,ZA,ZH,ZP,Yd,ZD,Ye11,Ye22,Ye33,             &
& ZE,Yu,ZU,ZV,g3,TW,TWp,cplAhAhAhAh1,cplAhAhhhhh1,cplAhAhHpmcHpm1,cplAhAhSdcSdaa,        &
& cplAhAhSecSe1,cplAhAhSucSuaa,cplAhAhSvcSv1,cplAhhhHpmcHpm1,cplAhhhSdcSdaa,             &
& cplAhhhSecSe1,cplAhhhSucSuaa,cplAhHpmSucSdaa,cplAhHpmSvcSe1,cplAhSdcHpmcSuaa,          &
& cplAhSecHpmcSv1,cplhhhhhhhh1,cplhhhhHpmcHpm1,cplhhhhSdcSdaa,cplhhhhSecSe1,             &
& cplhhhhSucSuaa,cplhhhhSvcSv1,cplhhHpmSucSdaa,cplhhHpmSvcSe1,cplhhSdcHpmcSuaa,          &
& cplhhSecHpmcSv1,cplHpmHpmcHpmcHpm1,cplHpmSdcHpmcSdaa,cplHpmSecHpmcSe1,cplHpmSucHpmcSuaa,&
& cplHpmSvcHpmcSv1,cplSdSdcSdcSdabba,cplSdSdcSdcSdabab,cplSdSecSdcSeaa,cplSdSucSdcSuabba,&
& cplSdSucSdcSuabab,cplSdSvcSdcSvaa,cplSdSvcSecSuaa,cplSeSecSecSe1,cplSeSucSdcSvaa,      &
& cplSeSucSecSuaa,cplSeSvcSecSv1,cplSuSucSucSuabba,cplSuSucSucSuabab,cplSuSvcSucSvaa,    &
& cplSvSvcSvcSv1,cplAhAhcVWmVWm1,cplAhAhVZVZ1,cplAhAhVZVZp1,cplAhAhVZpVZp1,              &
& cplAhHpmcVWmVP1,cplAhHpmcVWmVZ1,cplAhHpmcVWmVZp1,cplAhcHpmVPVWm1,cplAhcHpmVWmVZ1,      &
& cplAhcHpmVWmVZp1,cplhhhhcVWmVWm1,cplhhhhVZVZ1,cplhhhhVZVZp1,cplhhhhVZpVZp1,            &
...
If (externalZfactors) Then
Call getZCouplings(g1,g2,gp,lam,Tlam,vd,vu,vS,ZH,ZA,ZP,Yd,Td,Tdp,ZD,Ye11,             &
& TYe11,Ye22,TYe22,Ye33,TYe33,Tep,Tmup,ZE,Yu,Tu,ZU,ZV,g3,TW,TWp,UM,UP,ZN,ZDL,            &
& ZDR,ZEL,ZER,ZUL,ZUR,ZVL,pG,cplAhAhhh,cplAhHpmcHpm,cplAhSdcSd,cplAhSecSe,               &
& cplAhSucSu,cplhhhhhh,cplhhHpmcHpm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,         &
& cplHpmSucSd,cplHpmSvcSe,cplSdcHpmcSu,cplSecHpmcSv,cplAhAhAhAh,cplAhAhhhhh,             &
& cplAhAhHpmcHpm,cplAhAhSdcSd,cplAhAhSecSe,cplAhAhSucSu,cplAhAhSvcSv,cplAhhhHpmcHpm,     &
& cplAhhhSdcSd,cplAhhhSecSe,cplAhhhSucSu,cplAhHpmSucSd,cplAhHpmSvcSe,cplAhSdcHpmcSu,     &
...
End if
Call getGBCouplings(MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,MFv2OS,MSuOS,MSu2OS,              &
...
& MVZ2OS,MVZp2OS,MVWmOS,MVWm2OS,ZDOS,ZVOS,ZVLOS,ZUOS,ZEOS,ZHOS,ZAOS,ZPOS,ZNOS,           &
& UMOS,UPOS,ZELOS,ZEROS,ZDLOS,ZDROS,ZULOS,ZUROS,MAh,MAh2,MCha,MCha2,MChi,MChi2,          &
...
& v,ZA,ZD,ZDL,ZDR,ZE,ZEL,ZER,ZH,ZN,ZP,ZU,ZUL,ZUR,ZV,ZVL,ZW,ZZ,betaH,cplAhcHpmVWm,        &
...
& ZcplcHpmVWmVZp,ZcplcVWmVPVWm,ZcplcVWmVWmVZ,ZcplcVWmVWmVZp,ZcplhhcHpmVWm,               &
& ZcplhhcVWmVWm,ZcplSdcSucVWm,ZcplSecSvcVWm,ZcplSucSdVWm,ZcplSvcSeVWm,GcplAhHpmcHpm,     &
& GcplhhHpmcHpm,GcplHpmSucSd,GcplHpmSvcSe,GcplSdcHpmcSu,GcplSecHpmcSv,GcplAhHpmcVWm,     &
& GcplAhcHpmVWm,GcplhhHpmcVWm,GcplhhcHpmVWm,GcplHpmcHpmVP,GcplHpmcHpmVZ,GcplHpmcHpmVZp,  &
& GcplHpmcVWmVP,GcplHpmcVWmVZ,GcplHpmcVWmVZp,GcplcHpmVPVWm,GcplcHpmVWmVZ,GcplcHpmVWmVZp, &
& GcplChiChacHpmL,GcplChiChacHpmR,GcplcChaChiHpmL,GcplcChaChiHpmR,GcplcFuFdcHpmL,        &
& GcplcFuFdcHpmR,GcplcFvFecHpmL,GcplcFvFecHpmR,GcplcFdFuHpmL,GcplcFdFuHpmR,              &
...
& GZcplhhHpmcVWm,GZcplhhcHpmVWm,GZcplHpmcHpmVP,GZcplHpmcHpmVZ,GZcplHpmcHpmVZp,           &
& GZcplHpmcVWmVP,GZcplHpmcVWmVZ,GZcplHpmcVWmVZp,GZcplcHpmVPVWm,GZcplcHpmVWmVZ,           &
& GZcplcHpmVWmVZp,GZcplChiChacHpmL,GZcplChiChacHpmR,GZcplcChaChiHpmL,GZcplcChaChiHpmR,   &
& GZcplcFuFdcHpmL,GZcplcFuFdcHpmR,GZcplcFvFecHpmL,GZcplcFvFecHpmR,GZcplcFdFuHpmL,        &
& GZcplcFdFuHpmR,GZcplcFeFvHpmL,GZcplcFeFvHpmR,GosZcplAhHpmcHpm,GosZcplhhHpmcHpm,        &
& GosZcplHpmSucSd,GosZcplHpmSvcSe,GosZcplSdcHpmcSu,GosZcplSecHpmcSv,GosZcplAhHpmcVWm,    &
& GosZcplAhcHpmVWm,GosZcplhhHpmcVWm,GosZcplhhcHpmVWm,GosZcplHpmcHpmVP,GosZcplHpmcHpmVZ,  &
& GosZcplHpmcHpmVZp,GosZcplHpmcVWmVP,GosZcplHpmcVWmVZ,GosZcplHpmcVWmVZp,GosZcplcHpmVPVWm,&
& GosZcplcHpmVWmVZ,GosZcplcHpmVWmVZp,GosZcplChiChacHpmL,GosZcplChiChacHpmR,              &
& GosZcplcChaChiHpmL,GosZcplcChaChiHpmR,GosZcplcFuFdcHpmL,GosZcplcFuFdcHpmR,             &
& GosZcplcFvFecHpmL,GosZcplcFvFecHpmR,GosZcplcFdFuHpmL,GosZcplcFdFuHpmR,GosZcplcFeFvHpmL,&
& GosZcplcFeFvHpmR)

! Write intilization of all counter terms
Call WaveFunctionRenormalisation(MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,MFv2OS,              &
& MSuOS,MSu2OS,MSeOS,MSe2OS,MhhOS,Mhh2OS,MAhOS,MAh2OS,MHpmOS,MHpm2OS,MChiOS,             &
& MChi2OS,MChaOS,MCha2OS,MFeOS,MFe2OS,MFdOS,MFd2OS,MFuOS,MFu2OS,MGluOS,MGlu2OS,          &
& MVZOS,MVZpOS,MVZ2OS,MVZp2OS,MVWmOS,MVWm2OS,ZDOS,ZVOS,ZVLOS,ZUOS,ZEOS,ZHOS,             &
& ZAOS,ZPOS,ZNOS,UMOS,UPOS,ZELOS,ZEROS,ZDLOS,ZDROS,ZULOS,ZUROS,MAh,MAh2,MCha,            &
& MCha2,MChi,MChi2,MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,MGlu,MGlu2,Mhh,Mhh2,              &
& MHpm,MHpm2,MSd,MSd2,MSe,MSe2,MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,MVZp,               &
& MVZp2,pG,TW,TWp,UM,UP,v,ZA,ZD,ZDL,ZDR,ZE,ZEL,ZER,ZH,ZN,ZP,ZU,ZUL,ZUR,ZV,               &
& ZVL,ZW,ZZ,betaH,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yu,Td,TYe11,TYe22,TYe33,             &
& Tlam,Tu,mq2,ml012,ml022,ml032,mHd2,mHu2,md2,mu2,me012,me022,me032,ms2,M1,              &
& M2,M3,M4,Tdp,Tep,Tmup,vd,vu,vS,cplAhAhhh,cplAhHpmcHpm,cplAhSdcSd,cplAhSecSe,           &
& cplAhSucSu,cplhhhhhh,cplhhHpmcHpm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,         &
& cplHpmSucSd,cplHpmSvcSe,cplSdcHpmcSu,cplSecHpmcSv,cplAhAhAhAh,cplAhAhhhhh,             &
...
Call OneLoopDecay_Sd(MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,MFv2OS,MSuOS,MSu2OS,             &
& MSeOS,MSe2OS,MhhOS,Mhh2OS,MAhOS,MAh2OS,MHpmOS,MHpm2OS,MChiOS,MChi2OS,MChaOS,           &
& MCha2OS,MFeOS,MFe2OS,MFdOS,MFd2OS,MFuOS,MFu2OS,MGluOS,MGlu2OS,MVZOS,MVZpOS,            &
& MVZ2OS,MVZp2OS,MVWmOS,MVWm2OS,ZDOS,ZVOS,ZVLOS,ZUOS,ZEOS,ZHOS,ZAOS,ZPOS,ZNOS,           &
& UMOS,UPOS,ZELOS,ZEROS,ZDLOS,ZDROS,ZULOS,ZUROS,MAh,MAh2,MCha,MCha2,MChi,MChi2,          &
& MFd,MFd2,MFe,MFe2,MFu,MFu2,MFv,MFv2,MGlu,MGlu2,Mhh,Mhh2,MHpm,MHpm2,MSd,MSd2,           &
& MSe,MSe2,MSu,MSu2,MSv,MSv2,MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,pG,TW,TWp,UM,UP,             &
& v,ZA,ZD,ZDL,ZDR,ZE,ZEL,ZER,ZH,ZN,ZP,ZU,ZUL,ZUR,ZV,ZVL,ZW,ZZ,betaH,g1,g2,               &
& g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yu,Td,TYe11,TYe22,TYe33,Tlam,Tu,mq2,ml012,ml022,           &
& ml032,mHd2,mHu2,md2,mu2,me012,me022,me032,ms2,M1,M2,M3,M4,Tdp,Tep,Tmup,vd,             &
& vu,vS,dg1,dg2,dg3,dgp,dSinQq,dCosQq,dTanQq,dSinQl1,dCosQl1,dTanQl1,dSinQl2,            &
& dCosQl2,dTanQl2,dSinQl3,dCosQl3,dTanQl3,dSinQHd,dCosQHd,dTanQHd,dSinQHu,               &
& dCosQHu,dTanQHu,dSinQd,dCosQd,dTanQd,dSinQu,dCosQu,dTanQu,dSinQe1,dCosQe1,             &
& dTanQe1,dSinQe2,dCosQe2,dTanQe2,dSinQe3,dCosQe3,dTanQe3,dSinQs,dCosQs,dTanQs,          &
& dYd,dTd,dYe11,dTYe11,dYe22,dTYe22,dYe33,dTYe33,dlam,dTlam,dYu,dTu,dmq2,dml012,         &
& dml022,dml032,dmHd2,dmHu2,dmd2,dmu2,dme012,dme022,dme032,dms2,dM1,dM2,dM3,             &
& dM4,dTdp,dTep,dTmup,dvd,dvu,dvS,dpG,dZD,dZV,dZVL,dZU,dZE,dZH,dZA,dZP,dZN,              &
& dUM,dUP,dZEL,dZER,dZDL,dZDR,dZUL,dZUR,dSinTW,dCosTW,dTanTW,dSinTWp,dCosTWp,            &
& dTanTWp,ZfVG,ZffG,ZfVP,ZfVZ,ZfVZp,ZfVWm,ZfSd,ZfSv,ZfFvL,ZfSu,ZfSe,Zfhh,ZfAh,           &
& ZfHpm,ZfL0,ZfLm,ZfLp,ZfFEL,ZfFER,ZfFDL,ZfFDR,ZfFUL,ZfFUR,ZfVPVZ,ZfVZVP,ZfVPVZp,        &
& ZfVZpVP,ZfVZVZp,ZfVZpVZ,cplAhAhhh,cplAhAhSdcSdaa,cplAhcHpmVWm,cplAhhhSdcSdaa,          &
...
& cplChiChiVZR,cplChiFdcSdL,cplChiFdcSdR,cplChiFucSuL,cplChiFucSuR,cplcHpmVPVWm,         &
& cplcHpmVWmVZ,cplcHpmVWmVZp,cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,cplGluFdcSdL,       &
...
& cplhhSdcHpmcSuaa,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,cplhhVZpVZp,              &
...
& ZRUZD,ZRUZV,ZRUZVL,ZRUZU,ZRUZE,ZRUZH,ZRUZA,ZRUZP,ZRUZN,ZRUUM,ZRUUP,ZRUZEL,             &
& ZRUZER,ZRUZDL,ZRUZDR,ZRUZUL,ZRUZUR,MLambda,em,gs,deltaM,kont,gP1LSd)

End if
! Su
If (CalcLoopDecay_Su) Then
Call OneLoopDecay_Su(MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,MFv2OS,MSuOS,MSu2OS,             &
& MSeOS,MSe2OS,MhhOS,Mhh2OS,MAhOS,MAh2OS,MHpmOS,MHpm2OS,MChiOS,MChi2OS,MChaOS,           &
& MCha2OS,MFeOS,MFe2OS,MFdOS,MFd2OS,MFuOS,MFu2OS,MGluOS,MGlu2OS,MVZOS,MVZpOS,            &
& MVZ2OS,MVZp2OS,MVWmOS,MVWm2OS,ZDOS,ZVOS,ZVLOS,ZUOS,ZEOS,ZHOS,ZAOS,ZPOS,ZNOS,           &
& UMOS,UPOS,ZELOS,ZEROS,ZDLOS,ZDROS,ZULOS,ZUROS,MAh,MAh2,MCha,MCha2,MChi,MChi2,          &
...
& dTanTWp,ZfVG,ZffG,ZfVP,ZfVZ,ZfVZp,ZfVWm,ZfSd,ZfSv,ZfFvL,ZfSu,ZfSe,Zfhh,ZfAh,           &
& ZfHpm,ZfL0,ZfLm,ZfLp,ZfFEL,ZfFER,ZfFDL,ZfFDR,ZfFUL,ZfFUR,ZfVPVZ,ZfVZVP,ZfVPVZp,        &
& ZfVZpVP,ZfVZVZp,ZfVZpVZ,cplAhAhhh,cplAhAhSucSuaa,cplAhcHpmVWm,cplAhhhSucSuaa,          &
& cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,cplAhHpmSucSdaa,cplAhSdcHpmcSuaa,       &
& cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplcChacFuSdL,cplcChacFuSdR,cplcChaChaAhL,            &
& cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,   &
& cplcChaChaVZpL,cplcChaChaVZpR,cplcChaChaVZR,cplcChaChiHpmL,cplcChaChiHpmR,             &
...
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,             &
& cplHpmcVWmVZ,cplHpmcVWmVZp,cplHpmSdcHpmcSdaa,cplHpmSucHpmcSuaa,cplHpmSucSd,            &
& cplSdcHpmcSu,cplSdcSdcVWmVWmaa,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,           &
...
Call OneLoopDecay_Se(MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,MFv2OS,MSuOS,MSu2OS,             &
& MSeOS,MSe2OS,MhhOS,Mhh2OS,MAhOS,MAh2OS,MHpmOS,MHpm2OS,MChiOS,MChi2OS,MChaOS,           &
& MCha2OS,MFeOS,MFe2OS,MFdOS,MFd2OS,MFuOS,MFu2OS,MGluOS,MGlu2OS,MVZOS,MVZpOS,            &
& MVZ2OS,MVZp2OS,MVWmOS,MVWm2OS,ZDOS,ZVOS,ZVLOS,ZUOS,ZEOS,ZHOS,ZAOS,ZPOS,ZNOS,           &
& UMOS,UPOS,ZELOS,ZEROS,ZDLOS,ZDROS,ZULOS,ZUROS,MAh,MAh2,MCha,MCha2,MChi,MChi2,          &
...
& dTanTWp,ZfVG,ZffG,ZfVP,ZfVZ,ZfVZp,ZfVWm,ZfSd,ZfSv,ZfFvL,ZfSu,ZfSe,Zfhh,ZfAh,           &
& ZfHpm,ZfL0,ZfLm,ZfLp,ZfFEL,ZfFER,ZfFDL,ZfFDR,ZfFUL,ZfFUR,ZfVPVZ,ZfVZVP,ZfVPVZp,        &
& ZfVZpVP,ZfVZVZp,ZfVZpVZ,cplAhAhhh,cplAhAhSecSe1,cplAhcHpmVWm,cplAhhhSecSe1,            &
& cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,cplAhHpmSvcSe1,cplAhSdcSd,              &
& cplAhSecHpmcSv1,cplAhSecSe,cplAhSucSu,cplcChacFvSeL,cplcChacFvSeR,cplcChaChaAhL,       &
& cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,   &
& cplcChaChaVZpL,cplcChaChaVZpR,cplcChaChaVZR,cplcChaChiHpmL,cplcChaChiHpmR,             &
& cplcChaChiVWmL,cplcChaChiVWmR,cplcChaFecSvL,cplcChaFecSvR,cplcFeChaSvL,cplcFeChaSvR,   &
...
& cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZpL,      &
...
Call OneLoopDecay_Sv(MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,MFv2OS,MSuOS,MSu2OS,             &
& MSeOS,MSe2OS,MhhOS,Mhh2OS,MAhOS,MAh2OS,MHpmOS,MHpm2OS,MChiOS,MChi2OS,MChaOS,           &
& MCha2OS,MFeOS,MFe2OS,MFdOS,MFd2OS,MFuOS,MFu2OS,MGluOS,MGlu2OS,MVZOS,MVZpOS,            &
& MVZ2OS,MVZp2OS,MVWmOS,MVWm2OS,ZDOS,ZVOS,ZVLOS,ZUOS,ZEOS,ZHOS,ZAOS,ZPOS,ZNOS,           &
& UMOS,UPOS,ZELOS,ZEROS,ZDLOS,ZDROS,ZULOS,ZUROS,MAh,MAh2,MCha,MCha2,MChi,MChi2,          &
...
& dTanTWp,ZfVG,ZffG,ZfVP,ZfVZ,ZfVZp,ZfVWm,ZfSd,ZfSv,ZfFvL,ZfSu,ZfSe,Zfhh,ZfAh,           &
& ZfHpm,ZfL0,ZfLm,ZfLp,ZfFEL,ZfFER,ZfFDL,ZfFDR,ZfFUL,ZfFUR,ZfVPVZ,ZfVZVP,ZfVPVZp,        &
& ZfVZpVP,ZfVZVZp,ZfVZpVZ,cplAhAhhh,cplAhAhSvcSv1,cplAhcHpmVWm,cplAhhhVZ,cplAhhhVZp,     &
...
& cplcFeFvVWmL,cplcFeFvVWmR,cplcFvChiSvL,cplcFvChiSvR,cplcFvFecHpmL,cplcFvFecHpmR,       &
...
& cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,       &
& cplhhcHpmVWm,cplhhcVWmVWm,cplhhhhhh,cplhhhhSvcSv1,cplhhHpmcHpm,cplhhHpmcVWm,           &
...
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplHpmSecHpmcSe1,cplHpmSvcHpmcSv1,             &
...
Call OneLoopDecay_hh(MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,MFv2OS,MSuOS,MSu2OS,             &
& MSeOS,MSe2OS,MhhOS,Mhh2OS,MAhOS,MAh2OS,MHpmOS,MHpm2OS,MChiOS,MChi2OS,MChaOS,           &
& MCha2OS,MFeOS,MFe2OS,MFdOS,MFd2OS,MFuOS,MFu2OS,MGluOS,MGlu2OS,MVZOS,MVZpOS,            &
& MVZ2OS,MVZp2OS,MVWmOS,MVWm2OS,ZDOS,ZVOS,ZVLOS,ZUOS,ZEOS,ZHOS,ZAOS,ZPOS,ZNOS,           &
& UMOS,UPOS,ZELOS,ZEROS,ZDLOS,ZDROS,ZULOS,ZUROS,MAh,MAh2,MCha,MCha2,MChi,MChi2,          &
...
& dTanTWp,ZfVG,ZffG,ZfVP,ZfVZ,ZfVZp,ZfVWm,ZfSd,ZfSv,ZfFvL,ZfSu,ZfSe,Zfhh,ZfAh,           &
& ZfHpm,ZfL0,ZfLm,ZfLp,ZfFEL,ZfFER,ZfFDL,ZfFDR,ZfFUL,ZfFUR,ZfVPVZ,ZfVZVP,ZfVPVZp,        &
& ZfVZpVP,ZfVZVZp,ZfVZpVZ,cplAhAhAhAh1,cplAhAhcVWmVWm1,cplAhAhhh,cplAhAhhhhh1,           &
...
& cplAhcHpmVWmVZp1,cplAhhhHpmcHpm1,cplAhhhSdcSdaa,cplAhhhSecSe1,cplAhhhSucSuaa,          &
& cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,cplAhHpmcVWmVP1,cplAhHpmcVWmVZ1,        &
& cplAhHpmcVWmVZp1,cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplcChacFuSdL,cplcChacFuSdR,         &
...
& cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZpL,      &
& cplcFvFvVZpR,cplcFvFvVZR,cplcgAgWmcVWm,cplcgAgWpCVWm,cplcgWmgAHpm,cplcgWmgAVWm,        &
& cplcgWmgWmAh,cplcgWmgWmhh,cplcgWmgWmVP,cplcgWmgWmVZ,cplcgWmgWmVZp,cplcgWmgZHpm,        &
& cplcgWmgZpHpm,cplcgWmgZpVWm,cplcgWmgZVWm,cplcgWpCgAcVWm,cplcgWpCgWpCAh,cplcgWpCgWpChh, &
...
& cplcgZgWpCVWm,cplcgZgZhh,cplcgZgZphh,cplcgZpgWmcHpm,cplcgZpgWmcVWm,cplcgZpgWpCHpm,     &
& cplcgZpgWpCVWm,cplcgZpgZhh,cplcgZpgZphh,cplChaFucSdL,cplChaFucSdR,cplChaFvcSeL,        &
...
Call OneLoopDecay_Ah(MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,MFv2OS,MSuOS,MSu2OS,             &
& MSeOS,MSe2OS,MhhOS,Mhh2OS,MAhOS,MAh2OS,MHpmOS,MHpm2OS,MChiOS,MChi2OS,MChaOS,           &
& MCha2OS,MFeOS,MFe2OS,MFdOS,MFd2OS,MFuOS,MFu2OS,MGluOS,MGlu2OS,MVZOS,MVZpOS,            &
& MVZ2OS,MVZp2OS,MVWmOS,MVWm2OS,ZDOS,ZVOS,ZVLOS,ZUOS,ZEOS,ZHOS,ZAOS,ZPOS,ZNOS,           &
& UMOS,UPOS,ZELOS,ZEROS,ZDLOS,ZDROS,ZULOS,ZUROS,MAh,MAh2,MCha,MCha2,MChi,MChi2,          &
...
& cplAhSecHpmcSv1,cplAhSecSe,cplAhSucSu,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,       &
...
& cplcgZpgWpCVWm,cplChaFucSdL,cplChaFucSdR,cplChaFvcSeL,cplChaFvcSeR,cplChiChacHpmL,     &
...
& cplChiFdcSdR,cplChiFecSeL,cplChiFecSeR,cplChiFucSuL,cplChiFucSuR,cplChiFvcSvL,         &
& cplChiFvcSvR,cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,cplcVWmVPVWm,cplcVWmVWmVZ,        &
& cplcVWmVWmVZp,cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,cplGluFucSuR,cplhhcHpmVPVWm1,     &
& cplhhcHpmVWm,cplhhcHpmVWmVZ1,cplhhcHpmVWmVZp1,cplhhcVWmVWm,cplhhhhhh,cplhhhhHpmcHpm1,  &
& cplhhhhSdcSdaa,cplhhhhSecSe1,cplhhhhSucSuaa,cplhhhhVZpVZp1,cplhhhhVZVZ1,               &
& cplhhhhVZVZp1,cplhhHpmcHpm,cplhhHpmcVWm,cplhhHpmcVWmVP1,cplhhHpmcVWmVZ1,               &
& cplhhHpmcVWmVZp1,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,cplhhVZpVZp,              &
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmcVWmVWm1,cplHpmcHpmVP,cplHpmcHpmVPVP1,cplHpmcHpmVPVZ1,  &
& cplHpmcHpmVPVZp1,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcHpmVZpVZp1,cplHpmcHpmVZVZ1,         &
& cplHpmcHpmVZVZp1,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplHpmHpmcHpmcHpm1,           &
...
& cplSdcSdVPVZpaa,cplSdcSdVZ,cplSdcSdVZp,cplSdcSdVZpVZpaa,cplSdcSdVZVZaa,cplSdcSdVZVZpaa,&
& cplSdcSucVWm,cplSdSdcSdcSdabab,cplSdSdcSdcSdabba,cplSdSecSdcSeaa,cplSdSucSdcSuabab,    &
& cplSdSucSdcSuabba,cplSdSvcSdcSvaa,cplSecHpmcSv,cplSecSecVWmVWm1,cplSecSeVP,            &
& cplSecSeVPVP1,cplSecSeVPVZ1,cplSecSeVPVZp1,cplSecSeVZ,cplSecSeVZp,cplSecSeVZpVZp1,     &
& cplSecSeVZVZ1,cplSecSeVZVZp1,cplSecSvcVWm,cplSeSecSecSe1,cplSeSucSecSuaa,              &
& cplSeSvcSecSv1,cplSucSdVWm,cplSucSucVWmVWmaa,cplSucSuVG,cplSucSuVGVGsumj113Lamct3ct2j1Lamct4j1ct1,&
& cplSucSuVGVGsumj113Lamct3j1ct1Lamct4ct2j1,cplSucSuVP,cplSucSuVPVPaa,cplSucSuVPVZaa,    &
& cplSucSuVPVZpaa,cplSucSuVZ,cplSucSuVZp,cplSucSuVZpVZpaa,cplSucSuVZVZaa,cplSucSuVZVZpaa,&
& cplSuSucSucSuabab,cplSuSucSucSuabba,cplSuSvcSucSvaa,cplSvcSeVWm,cplSvcSvVZ,            &
& cplSvcSvVZp,ctcplAhAhhh,ctcplAhhhVZ,ctcplAhhhVZp,ctcplAhHpmcHpm,ctcplAhHpmcVWm,        &
...
& ZRUZD,ZRUZV,ZRUZVL,ZRUZU,ZRUZE,ZRUZH,ZRUZA,ZRUZP,ZRUZN,ZRUUM,ZRUUP,ZRUZEL,             &
& ZRUZER,ZRUZDL,ZRUZDR,ZRUZUL,ZRUZUR,MLambda,em,gs,deltaM,kont,gP1LAh)

End if
! Hpm
If (CalcLoopDecay_Hpm) Then
Call OneLoopDecay_Hpm(MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,MFv2OS,MSuOS,MSu2OS,            &
& MSeOS,MSe2OS,MhhOS,Mhh2OS,MAhOS,MAh2OS,MHpmOS,MHpm2OS,MChiOS,MChi2OS,MChaOS,           &
& MCha2OS,MFeOS,MFe2OS,MFdOS,MFd2OS,MFuOS,MFu2OS,MGluOS,MGlu2OS,MVZOS,MVZpOS,            &
& MVZ2OS,MVZp2OS,MVWmOS,MVWm2OS,ZDOS,ZVOS,ZVLOS,ZUOS,ZEOS,ZHOS,ZAOS,ZPOS,ZNOS,           &
& UMOS,UPOS,ZELOS,ZEROS,ZDLOS,ZDROS,ZULOS,ZUROS,MAh,MAh2,MCha,MCha2,MChi,MChi2,          &
...
& dTanTWp,ZfVG,ZffG,ZfVP,ZfVZ,ZfVZp,ZfVWm,ZfSd,ZfSv,ZfFvL,ZfSu,ZfSe,Zfhh,ZfAh,           &
& ZfHpm,ZfL0,ZfLm,ZfLp,ZfFEL,ZfFER,ZfFDL,ZfFDR,ZfFUL,ZfFUR,ZfVPVZ,ZfVZVP,ZfVPVZp,        &
& ZfVZpVP,ZfVZVZp,ZfVZpVZ,cplAhAhcVWmVWm1,cplAhAhhh,cplAhAhHpmcHpm1,cplAhcHpmVPVWm1,     &
& cplAhcHpmVWm,cplAhcHpmVWmVZ1,cplAhcHpmVWmVZp1,cplAhhhHpmcHpm1,cplAhhhVZ,               &
& cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,cplAhHpmcVWmVP1,cplAhHpmcVWmVZ1,cplAhHpmcVWmVZp1, &
& cplAhHpmSucSdaa,cplAhHpmSvcSe1,cplAhSdcHpmcSuaa,cplAhSdcSd,cplAhSecHpmcSv1,            &
...
& ZcplSdcHpmcSu,ZcplSecHpmcSv,ZRUZD,ZRUZV,ZRUZVL,ZRUZU,ZRUZE,ZRUZH,ZRUZA,ZRUZP,          &
...
Call OneLoopDecay_Glu(MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,MFv2OS,MSuOS,MSu2OS,            &
& MSeOS,MSe2OS,MhhOS,Mhh2OS,MAhOS,MAh2OS,MHpmOS,MHpm2OS,MChiOS,MChi2OS,MChaOS,           &
& MCha2OS,MFeOS,MFe2OS,MFdOS,MFd2OS,MFuOS,MFu2OS,MGluOS,MGlu2OS,MVZOS,MVZpOS,            &
& MVZ2OS,MVZp2OS,MVWmOS,MVWm2OS,ZDOS,ZVOS,ZVLOS,ZUOS,ZEOS,ZHOS,ZAOS,ZPOS,ZNOS,           &
& UMOS,UPOS,ZELOS,ZEROS,ZDLOS,ZDROS,ZULOS,ZUROS,MAh,MAh2,MCha,MCha2,MChi,MChi2,          &
...
& dTanTWp,ZfVG,ZffG,ZfVP,ZfVZ,ZfVZp,ZfVWm,ZfSd,ZfSv,ZfFvL,ZfSu,ZfSe,Zfhh,ZfAh,           &
& ZfHpm,ZfL0,ZfLm,ZfLp,ZfFEL,ZfFER,ZfFDL,ZfFDR,ZfFUL,ZfFUR,ZfVPVZ,ZfVZVP,ZfVPVZp,        &
& ZfVZpVP,ZfVZVZp,ZfVZpVZ,cplAhSdcSd,cplAhSucSu,cplcChaFdcSuL,cplcChaFdcSuR,             &
& cplcFdChiSdL,cplcFdChiSdR,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,             &
& cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZpL,              &
& cplcFdFdVZpR,cplcFdFdVZR,cplcFdFuHpmL,cplcFdFuHpmR,cplcFdFuVWmL,cplcFdFuVWmR,          &
& cplcFdGluSdL,cplcFdGluSdR,cplcFuChiSuL,cplcFuChiSuR,cplcFuFdcHpmL,cplcFuFdcHpmR,       &
...
& cplSucSdVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplVGVGVG,ctcplGluFdcSdL,     &
& ctcplGluFdcSdR,ctcplGluFucSuL,ctcplGluFucSuR,ctcplGluGluVGL,ctcplGluGluVGR,            &
& ZcplAhSdcSd,ZcplAhSucSu,ZcplcFdChiSdL,ZcplcFdChiSdR,ZcplcFdFdAhL,ZcplcFdFdAhR,         &
& ZcplcFdFdhhL,ZcplcFdFdhhR,ZcplcFdFdVGL,ZcplcFdFdVGR,ZcplcFdFdVPL,ZcplcFdFdVPR,         &
& ZcplcFdFdVZL,ZcplcFdFdVZpL,ZcplcFdFdVZpR,ZcplcFdFdVZR,ZcplcFdGluSdL,ZcplcFdGluSdR,     &
& ZcplcFuChiSuL,ZcplcFuChiSuR,ZcplcFuFuAhL,ZcplcFuFuAhR,ZcplcFuFuhhL,ZcplcFuFuhhR,       &
& ZcplcFuFuVGL,ZcplcFuFuVGR,ZcplcFuFuVPL,ZcplcFuFuVPR,ZcplcFuFuVZL,ZcplcFuFuVZpL,        &
& ZcplcFuFuVZpR,ZcplcFuFuVZR,ZcplcFuGluSuL,ZcplcFuGluSuR,ZcplChiFdcSdL,ZcplChiFdcSdR,    &
& ZcplChiFucSuL,ZcplChiFucSuR,ZcplGluFdcSdL,ZcplGluFdcSdR,ZcplGluFucSuL,ZcplGluFucSuR,   &
& ZcplGluGluVGL,ZcplGluGluVGR,ZcplhhSdcSd,ZcplhhSucSu,ZcplSdcSdVG,ZcplSdcSdVP,           &
& ZcplSdcSdVZ,ZcplSdcSdVZp,ZcplSucSuVG,ZcplSucSuVP,ZcplSucSuVZ,ZcplSucSuVZp,             &
& ZcplVGVGVG,ZRUZD,ZRUZV,ZRUZVL,ZRUZU,ZRUZE,ZRUZH,ZRUZA,ZRUZP,ZRUZN,ZRUUM,               &
& ZRUUP,ZRUZEL,ZRUZER,ZRUZDL,ZRUZDR,ZRUZUL,ZRUZUR,MLambda,em,gs,deltaM,kont,gP1LGlu)

End if
! Chi
If (CalcLoopDecay_Chi) Then
Call OneLoopDecay_Chi(MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,MFv2OS,MSuOS,MSu2OS,            &
& MSeOS,MSe2OS,MhhOS,Mhh2OS,MAhOS,MAh2OS,MHpmOS,MHpm2OS,MChiOS,MChi2OS,MChaOS,           &
& MCha2OS,MFeOS,MFe2OS,MFdOS,MFd2OS,MFuOS,MFu2OS,MGluOS,MGlu2OS,MVZOS,MVZpOS,            &
& MVZ2OS,MVZp2OS,MVWmOS,MVWm2OS,ZDOS,ZVOS,ZVLOS,ZUOS,ZEOS,ZHOS,ZAOS,ZPOS,ZNOS,           &
& UMOS,UPOS,ZELOS,ZEROS,ZDLOS,ZDROS,ZULOS,ZUROS,MAh,MAh2,MCha,MCha2,MChi,MChi2,          &
...
& dTanTWp,ZfVG,ZffG,ZfVP,ZfVZ,ZfVZp,ZfVWm,ZfSd,ZfSv,ZfFvL,ZfSu,ZfSe,Zfhh,ZfAh,           &
& ZfHpm,ZfL0,ZfLm,ZfLp,ZfFEL,ZfFER,ZfFDL,ZfFDR,ZfFUL,ZfFUR,ZfVPVZ,ZfVZVP,ZfVPVZp,        &
& ZfVZpVP,ZfVZVZp,ZfVZpVZ,cplAhAhhh,cplAhcHpmVWm,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,      &
...
& ZcplSucSuVG,ZcplSucSuVP,ZRUZD,ZRUZV,ZRUZVL,ZRUZU,ZRUZE,ZRUZH,ZRUZA,ZRUZP,              &
& ZRUZN,ZRUUM,ZRUUP,ZRUZEL,ZRUZER,ZRUZDL,ZRUZDR,ZRUZUL,ZRUZUR,MLambda,em,gs,             &
& deltaM,kont,gP1LChi)
...
Call OneLoopDecay_Cha(MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,MFv2OS,MSuOS,MSu2OS,            &
& MSeOS,MSe2OS,MhhOS,Mhh2OS,MAhOS,MAh2OS,MHpmOS,MHpm2OS,MChiOS,MChi2OS,MChaOS,           &
& MCha2OS,MFeOS,MFe2OS,MFdOS,MFd2OS,MFuOS,MFu2OS,MGluOS,MGlu2OS,MVZOS,MVZpOS,            &
& MVZ2OS,MVZp2OS,MVWmOS,MVWm2OS,ZDOS,ZVOS,ZVLOS,ZUOS,ZEOS,ZHOS,ZAOS,ZPOS,ZNOS,           &
& UMOS,UPOS,ZELOS,ZEROS,ZDLOS,ZDROS,ZULOS,ZUROS,MAh,MAh2,MCha,MCha2,MChi,MChi2,          &
...
& cplHpmSucSd,cplHpmSvcSe,cplSdcHpmcSu,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,     &
& cplSdcSucVWm,cplSecHpmcSv,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSecSvcVWm,              &
& cplSucSdVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplSvcSeVWm,cplSvcSvVZ,       &
& cplSvcSvVZp,ctcplcChacFuSdL,ctcplcChacFuSdR,ctcplcChacFvSeL,ctcplcChacFvSeR,           &
& ctcplcChaChaAhL,ctcplcChaChaAhR,ctcplcChaChahhL,ctcplcChaChahhR,ctcplcChaChaVPL,       &
& ctcplcChaChaVPR,ctcplcChaChaVZL,ctcplcChaChaVZpL,ctcplcChaChaVZpR,ctcplcChaChaVZR,     &
& ctcplcChaChiHpmL,ctcplcChaChiHpmR,ctcplcChaChiVWmL,ctcplcChaChiVWmR,ctcplcChaFdcSuL,   &
& ctcplcChaFdcSuR,ctcplcChaFecSvL,ctcplcChaFecSvR,GcplcChaChiHpmL,GcplcChaChiHpmR,       &
...
& ZcplcChacFuSdL,ZcplcChacFuSdR,ZcplcChacFvSeL,ZcplcChacFvSeR,ZcplcChaChaAhL,            &
...
& ZcplcChaFecSvL,ZcplcChaFecSvR,ZcplcFdChaSuL,ZcplcFdChaSuR,ZcplcFdFdVPL,ZcplcFdFdVPR,   &
& ZcplcFeChaSvL,ZcplcFeChaSvR,ZcplcFeFeVPL,ZcplcFeFeVPR,ZcplcFuFuVPL,ZcplcFuFuVPR,       &
& ZcplChaFucSdL,ZcplChaFucSdR,ZcplChaFvcSeL,ZcplChaFvcSeR,ZcplChiChacHpmL,               &
& ZcplChiChacHpmR,ZcplChiChacVWmL,ZcplChiChacVWmR,ZcplcHpmVPVWm,ZcplcVWmVPVWm,           &
& ZcplHpmcHpmVP,ZcplHpmcVWmVP,ZcplSdcSdVP,ZcplSecSeVP,ZcplSucSuVP,ZRUZD,ZRUZV,           &
& ZRUZVL,ZRUZU,ZRUZE,ZRUZH,ZRUZA,ZRUZP,ZRUZN,ZRUUM,ZRUUP,ZRUZEL,ZRUZER,ZRUZDL,           &
& ZRUZDR,ZRUZUL,ZRUZUR,MLambda,em,gs,deltaM,kont,gP1LCha)

End if
! Fu
If (CalcLoopDecay_Fu) Then
Call OneLoopDecay_Fu(MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,MFv2OS,MSuOS,MSu2OS,             &
& MSeOS,MSe2OS,MhhOS,Mhh2OS,MAhOS,MAh2OS,MHpmOS,MHpm2OS,MChiOS,MChi2OS,MChaOS,           &
& MCha2OS,MFeOS,MFe2OS,MFdOS,MFd2OS,MFuOS,MFu2OS,MGluOS,MGlu2OS,MVZOS,MVZpOS,            &
& MVZ2OS,MVZp2OS,MVWmOS,MVWm2OS,ZDOS,ZVOS,ZVLOS,ZUOS,ZEOS,ZHOS,ZAOS,ZPOS,ZNOS,           &
& UMOS,UPOS,ZELOS,ZEROS,ZDLOS,ZDROS,ZULOS,ZUROS,MAh,MAh2,MCha,MCha2,MChi,MChi2,          &
...
& cplcHpmVWmVZ,cplcHpmVWmVZp,cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp,cplGluFdcSdL,       &
& cplGluFdcSdR,cplGluFucSuL,cplGluFucSuR,cplGluGluVGL,cplGluGluVGR,cplhhcHpmVWm,         &
& cplhhcVWmVWm,cplhhhhhh,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,cplhhSucSu,cplhhVZpVZp,    &
& cplhhVZVZ,cplhhVZVZp,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcVWmVP,             &
& cplHpmcVWmVZ,cplHpmcVWmVZp,cplHpmSucSd,cplSdcHpmcSu,cplSdcSdVG,cplSdcSdVP,             &
& cplSdcSdVZ,cplSdcSdVZp,cplSdcSucVWm,cplSucSdVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,      &
& cplSucSuVZp,cplVGVGVG,ctcplcChacFuSdL,ctcplcChacFuSdR,ctcplcFuChiSuL,ctcplcFuChiSuR,   &
& ctcplcFuFdcHpmL,ctcplcFuFdcHpmR,ctcplcFuFdcVWmL,ctcplcFuFdcVWmR,ctcplcFuFuAhL,         &
& ctcplcFuFuAhR,ctcplcFuFuhhL,ctcplcFuFuhhR,ctcplcFuFuVGL,ctcplcFuFuVGR,ctcplcFuFuVPL,   &
& ctcplcFuFuVPR,ctcplcFuFuVZL,ctcplcFuFuVZpL,ctcplcFuFuVZpR,ctcplcFuFuVZR,               &
...
& ZcplcFuFuVPL,ZcplcFuFuVPR,ZcplcFuFuVZL,ZcplcFuFuVZpL,ZcplcFuFuVZpR,ZcplcFuFuVZR,       &
& ZcplcFuGluSuL,ZcplcFuGluSuR,ZcplChaFucSdL,ZcplChaFucSdR,ZcplChiFucSuL,ZcplChiFucSuR,   &
& ZcplcHpmVPVWm,ZcplcVWmVPVWm,ZcplGluFucSuL,ZcplGluFucSuR,ZcplGluGluVGL,ZcplGluGluVGR,   &
& ZcplHpmcHpmVP,ZcplHpmcVWmVP,ZcplSdcSdVG,ZcplSdcSdVP,ZcplSucSuVG,ZcplSucSuVP,           &
& ZcplVGVGVG,ZRUZD,ZRUZV,ZRUZVL,ZRUZU,ZRUZE,ZRUZH,ZRUZA,ZRUZP,ZRUZN,ZRUUM,               &
& ZRUUP,ZRUZEL,ZRUZER,ZRUZDL,ZRUZDR,ZRUZUL,ZRUZUR,MLambda,em,gs,deltaM,kont,gP1LFu)
...
End Module OneLoopDecays_NonUMSSM
