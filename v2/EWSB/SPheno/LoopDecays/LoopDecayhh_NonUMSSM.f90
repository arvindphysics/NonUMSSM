...
Module OneLoopDecay_hh_NonUMSSM
Use Control 
Use Settings 
Use LoopFunctions 
...
Subroutine Amplitude_Tree_NonUMSSM_hhToAhAh(cplAhAhhh,MAh,Mhh,MAh2,Mhh2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_hhToAhAh


Subroutine Gamma_Real_NonUMSSM_hhToAhAh(MLambda,em,gs,cplAhAhhh,MAh,Mhh,              & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_hhToAhAh


Subroutine Amplitude_WAVE_NonUMSSM_hhToAhAh(cplAhAhhh,ctcplAhAhhh,MAh,MAh2,           & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhToAhAh


Subroutine Amplitude_VERTEX_NonUMSSM_hhToAhAh(MAh,MCha,MChi,MFd,MFe,MFu,              & 
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhToAhAh


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToAhAh(MAh,MCha,MChi,MFd,MFe,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToAhAh


Subroutine Amplitude_Tree_NonUMSSM_hhToAhVZ(cplAhhhVZ,MAh,Mhh,MVZ,MAh2,               & 
& Mhh2,MVZ2,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_hhToAhVZ


Subroutine Gamma_Real_NonUMSSM_hhToAhVZ(MLambda,em,gs,cplAhhhVZ,MAh,Mhh,              & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_hhToAhVZ


Subroutine Amplitude_WAVE_NonUMSSM_hhToAhVZ(cplAhhhVZ,cplAhhhVZp,ctcplAhhhVZ,         & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhToAhVZ


Subroutine Amplitude_VERTEX_NonUMSSM_hhToAhVZ(MAh,MCha,MChi,MFd,MFe,MFu,              & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhToAhVZ


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToAhVZ(MAh,MCha,MChi,MFd,MFe,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToAhVZ


Subroutine Amplitude_Tree_NonUMSSM_hhToAhVZp(cplAhhhVZp,MAh,Mhh,MVZp,MAh2,            & 
& Mhh2,MVZp2,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_hhToAhVZp


Subroutine Gamma_Real_NonUMSSM_hhToAhVZp(MLambda,em,gs,cplAhhhVZp,MAh,Mhh,            & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_hhToAhVZp


Subroutine Amplitude_WAVE_NonUMSSM_hhToAhVZp(cplAhhhVZ,cplAhhhVZp,ctcplAhhhVZ,        & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhToAhVZp


Subroutine Amplitude_VERTEX_NonUMSSM_hhToAhVZp(MAh,MCha,MChi,MFd,MFe,MFu,             & 
& Mhh,MHpm,MSd,MSe,MSu,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,               & 
& MHpm2,MSd2,MSe2,MSu2,MVWm2,MVZ2,MVZp2,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,           & 
& cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,             & 
& cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhVZ,cplAhhhVZp,              & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhToAhVZp


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToAhVZp(MAh,MCha,MChi,MFd,MFe,              & 
& MFu,Mhh,MHpm,MSd,MSe,MSu,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,           & 
& MHpm2,MSd2,MSe2,MSu2,MVWm2,MVZ2,MVZp2,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,           & 
& cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,             & 
& cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhVZ,cplAhhhVZp,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToAhVZp


Subroutine Amplitude_Tree_NonUMSSM_hhTocChaCha(cplcChaChahhL,cplcChaChahhR,           & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_hhTocChaCha


Subroutine Gamma_Real_NonUMSSM_hhTocChaCha(MLambda,em,gs,cplcChaChahhL,               & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_hhTocChaCha


Subroutine Amplitude_WAVE_NonUMSSM_hhTocChaCha(cplcChaChahhL,cplcChaChahhR,           & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhTocChaCha


Subroutine Amplitude_VERTEX_NonUMSSM_hhTocChaCha(MAh,MCha,MChi,MFd,MFe,               & 
...
Complex(dp), Intent(in) :: cplAhAhhh(3,3,3),cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),cplAhhhVZ(3,3),            & 
& cplAhhhVZp(3,3),cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),cplChiChacVWmL(6,2),       & 
& cplChiChacVWmR(6,2),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),cplChaFvcSeL(2,3,6),       & 
...
& cplcChaChaVZpR(2,2),cplChiChihhL(6,6,3),cplChiChihhR(6,6,3),cplcChaChiHpmL(2,6,2),     & 
& cplcChaChiHpmR(2,6,2),cplcChaChiVWmL(2,6),cplcChaChiVWmR(2,6),cplcFdFdhhL(3,3,3),      & 
& cplcFdFdhhR(3,3,3),cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),cplcFeFehhL(3,3,3),       & 
& cplcFeFehhR(3,3,3),cplcChaFecSvL(2,3,3),cplcChaFecSvR(2,3,3),cplcFuFuhhL(3,3,3),       & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhTocChaCha


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTocChaCha(MAh,MCha,MChi,MFd,MFe,            & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,         & 
& cplcChaChaAhL,cplcChaChaAhR,cplAhhhVZ,cplAhhhVZp,cplChiChacHpmL,cplChiChacHpmR,        & 
& cplChiChacVWmL,cplChiChacVWmR,cplChaFucSdL,cplChaFucSdR,cplChaFvcSeL,cplChaFvcSeR,     & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTocChaCha


Subroutine Amplitude_Tree_NonUMSSM_hhToChiChi(cplChiChihhL,cplChiChihhR,              & 
& MChi,Mhh,MChi2,Mhh2,Amp)

Implicit None

Real(dp), Intent(in) :: MChi(6),Mhh(3),MChi2(6),Mhh2(3)

Complex(dp), Intent(in) :: cplChiChihhL(6,6,3),cplChiChihhR(6,6,3)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_hhToChiChi


Subroutine Gamma_Real_NonUMSSM_hhToChiChi(MLambda,em,gs,cplChiChihhL,cplChiChihhR,    & 
...
Real(dp), Intent(in) :: MChi(6),Mhh(3)
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_hhToChiChi


Subroutine Amplitude_WAVE_NonUMSSM_hhToChiChi(cplChiChihhL,cplChiChihhR,              & 
& ctcplChiChihhL,ctcplChiChihhR,MChi,MChi2,Mhh,Mhh2,Zfhh,ZfL0,Amp)

Implicit None

Real(dp), Intent(in) :: MChi(6),MChi2(6),Mhh(3),Mhh2(3)

Complex(dp), Intent(in) :: cplChiChihhL(6,6,3),cplChiChihhR(6,6,3)

Complex(dp), Intent(in) :: ctcplChiChihhL(6,6,3),ctcplChiChihhR(6,6,3)

Complex(dp), Intent(in) :: Zfhh(3,3),ZfL0(6,6)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhToChiChi


Subroutine Amplitude_VERTEX_NonUMSSM_hhToChiChi(MAh,MCha,MChi,MFd,MFe,MFu,            & 
...
Real(dp), Intent(in) :: MAh(3),MCha(2),MChi(6),MFd(3),MFe(3),MFu(3),MFv(3),Mhh(3),MHpm(2),MSd(6),             & 
& MSe(6),MSu(6),MSv(3),MVWm,MVZ,MVZp,MAh2(3),MCha2(2),MChi2(6),MFd2(3),MFe2(3),          & 
& MFu2(3),MFv2(3),Mhh2(3),MHpm2(2),MSd2(6),MSe2(6),MSu2(6),MSv2(3),MVWm2,MVZ2,MVZp2

Complex(dp), Intent(in) :: cplAhAhhh(3,3,3),cplChiChiAhL(6,6,3),cplChiChiAhR(6,6,3),cplAhhhVZ(3,3),              & 
& cplAhhhVZp(3,3),cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),cplChiChacVWmL(6,2),       & 
& cplChiChacVWmR(6,2),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),cplChiChihhL(6,6,3),     & 
...
& cplcFuChiSuR(3,6,6),cplcFvChiSvL(3,6,3),cplcFvChiSvR(3,6,3),cplcChaChiVWmL(2,6),       & 
& cplcChaChiVWmR(2,6),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),cplcFeFehhL(3,3,3),          & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhToChiChi


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToChiChi(MAh,MCha,MChi,MFd,MFe,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToChiChi


Subroutine Amplitude_Tree_NonUMSSM_hhTocFdFd(cplcFdFdhhL,cplcFdFdhhR,MFd,             & 
& Mhh,MFd2,Mhh2,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_hhTocFdFd


Subroutine Gamma_Real_NonUMSSM_hhTocFdFd(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,       & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_hhTocFdFd


Subroutine Amplitude_WAVE_NonUMSSM_hhTocFdFd(cplcFdFdhhL,cplcFdFdhhR,ctcplcFdFdhhL,   & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhTocFdFd


Subroutine Amplitude_VERTEX_NonUMSSM_hhTocFdFd(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
...
& cplhhSucSu,cplhhcHpmVWm,cplhhcVWmVWm,cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,Amp)
...
Complex(dp), Intent(in) :: cplAhAhhh(3,3,3),cplcFdFdAhL(3,3,3),cplcFdFdAhR(3,3,3),cplAhhhVZ(3,3),cplAhhhVZp(3,3),& 
& cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),     & 
& cplChiChihhL(6,6,3),cplChiChihhR(6,6,3),cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6),       & 
...
& cplcFdFuVWmR(3,3),cplcFdGluSdL(3,6),cplcFdGluSdR(3,6),cplhhhhhh(3,3,3),cplhhHpmcHpm(3,2,2),& 
& cplhhHpmcVWm(3,2),cplhhSdcSd(3,6,6),cplhhSucSu(3,6,6),cplhhcHpmVWm(3,2),               & 
& cplhhcVWmVWm(3),cplhhVZVZ(3),cplhhVZVZp(3),cplhhVZpVZp(3)
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhTocFdFd


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTocFdFd(MAh,MCha,MChi,MFd,MFu,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTocFdFd


Subroutine Amplitude_Tree_NonUMSSM_hhTocFeFe(cplcFeFehhL,cplcFeFehhR,MFe,             & 
& Mhh,MFe2,Mhh2,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_hhTocFeFe


Subroutine Gamma_Real_NonUMSSM_hhTocFeFe(MLambda,em,gs,cplcFeFehhL,cplcFeFehhR,       & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_hhTocFeFe


Subroutine Amplitude_WAVE_NonUMSSM_hhTocFeFe(cplcFeFehhL,cplcFeFehhR,ctcplcFeFehhL,   & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhTocFeFe


Subroutine Amplitude_VERTEX_NonUMSSM_hhTocFeFe(MAh,MCha,MChi,MFe,MFv,Mhh,             & 
& MHpm,MSe,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,             & 
& MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVZ,cplAhhhVZp,     & 
...
Complex(dp), Intent(in) :: cplAhAhhh(3,3,3),cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplAhhhVZ(3,3),cplAhhhVZp(3,3),& 
& cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),cplcFeChaSvL(3,2,3),cplcFeChaSvR(3,2,3),     & 
& cplChiChihhL(6,6,3),cplChiChihhR(6,6,3),cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6),       & 
& cplcFeChiSeL(3,6,6),cplcFeChiSeR(3,6,6),cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),         & 
& cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFeVZpL(3,3), & 
& cplcFeFeVZpR(3,3),cplcChaFecSvL(2,3,3),cplcChaFecSvR(2,3,3),cplcFvFecHpmL(3,3,2),      & 
& cplcFvFecHpmR(3,3,2),cplcFvFecVWmL(3,3),cplcFvFecVWmR(3,3),cplcFeFvHpmL(3,3,2),        & 
& cplcFeFvHpmR(3,3,2),cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),cplhhhhhh(3,3,3),              & 
& cplhhHpmcHpm(3,2,2),cplhhHpmcVWm(3,2),cplhhSecSe(3,6,6),cplhhSvcSv(3,3,3),             & 
& cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),cplhhVZVZ(3),cplhhVZVZp(3),cplhhVZpVZp(3)
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhTocFeFe


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTocFeFe(MAh,MCha,MChi,MFe,MFv,              & 
& Mhh,MHpm,MSe,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,              & 
& MSe2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVZ,           & 
...
& cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhcHpmVWm,cplhhcVWmVWm,             & 
& cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,Amp)
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTocFeFe


Subroutine Amplitude_Tree_NonUMSSM_hhTocFuFu(cplcFuFuhhL,cplcFuFuhhR,MFu,             & 
& Mhh,MFu2,Mhh2,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_hhTocFuFu


Subroutine Gamma_Real_NonUMSSM_hhTocFuFu(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,       & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_hhTocFuFu


Subroutine Amplitude_WAVE_NonUMSSM_hhTocFuFu(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,   & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhTocFuFu


Subroutine Amplitude_VERTEX_NonUMSSM_hhTocFuFu(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
Complex(dp), Intent(in) :: cplAhAhhh(3,3,3),cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),cplAhhhVZ(3,3),cplAhhhVZp(3,3),& 
& cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),     & 
& cplChiChihhL(6,6,3),cplChiChihhR(6,6,3),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6),       & 
& cplcFuChiSuL(3,6,6),cplcFuChiSuR(3,6,6),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),         & 
...
& cplhhhhhh(3,3,3),cplhhHpmcHpm(3,2,2),cplhhHpmcVWm(3,2),cplhhSdcSd(3,6,6),              & 
& cplhhSucSu(3,6,6),cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),cplhhVZVZ(3),cplhhVZVZp(3),        & 
& cplhhVZpVZp(3),cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6)
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhTocFuFu


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTocFuFu(MAh,MCha,MChi,MFd,MFu,              & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,cplcFuFuAhL,cplcFuFuAhR,     & 
& cplAhhhVZ,cplAhhhVZp,cplChaFucSdL,cplChaFucSdR,cplcChaChahhL,cplcChaChahhR,            & 
& cplChiChihhL,cplChiChihhR,cplChiFucSuL,cplChiFucSuR,cplcFuChiSuL,cplcFuChiSuR,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTocFuFu


Subroutine Amplitude_Tree_NonUMSSM_hhTohhhh(cplhhhhhh,Mhh,Mhh2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_hhTohhhh


Subroutine Gamma_Real_NonUMSSM_hhTohhhh(MLambda,em,gs,cplhhhhhh,Mhh,GammarealPhoton,  & 
& GammarealGluon)
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_hhTohhhh


Subroutine Amplitude_WAVE_NonUMSSM_hhTohhhh(cplhhhhhh,ctcplhhhhhh,Mhh,Mhh2,Zfhh,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhTohhhh


Subroutine Amplitude_VERTEX_NonUMSSM_hhTohhhh(MAh,MCha,MChi,MFd,MFe,MFu,              & 
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,           & 
...
& cplhhhhVZVZp1,cplhhhhVZpVZp1,Amp)
...
Complex(dp), Intent(in) :: cplAhAhhh(3,3,3),cplAhhhVZ(3,3),cplAhhhVZp(3,3),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),& 
...
& cplcgWmgWmhh(3),cplcgWpCgWpChh(3),cplcgZgZhh(3),cplcgZpgZhh(3),cplcgZgZphh(3),         & 
& cplcgZpgZphh(3),cplhhhhhh(3,3,3),cplhhHpmcHpm(3,2,2),cplhhHpmcVWm(3,2),cplhhSdcSd(3,6,6),& 
& cplhhSecSe(3,6,6),cplhhSucSu(3,6,6),cplhhSvcSv(3,3,3),cplhhcHpmVWm(3,2),               & 
& cplhhcVWmVWm(3),cplhhVZVZ(3),cplhhVZVZp(3),cplhhVZpVZp(3),cplAhAhhhhh1(3,3,3,3),       & 
& cplhhhhhhhh1(3,3,3,3),cplhhhhHpmcHpm1(3,3,2,2),cplhhhhSdcSdaa(3,3,6,6),cplhhhhSecSe1(3,3,6,6),& 
& cplhhhhSucSuaa(3,3,6,6),cplhhhhSvcSv1(3,3,3,3),cplhhhhcVWmVWm1(3,3),cplhhhhVZVZ1(3,3), & 
& cplhhhhVZVZp1(3,3),cplhhhhVZpVZp1(3,3)
...
Amp(gt1, gt2, gt3) = Amp(gt1, gt2, gt3) + oo16pi2*(1._dp/2._dp)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhTohhhh


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTohhhh(MAh,MCha,MChi,MFd,MFe,               & 
& MFu,Mhh,MHpm,MSd,MSe,MSu,MSv,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTohhhh


Subroutine Amplitude_Tree_NonUMSSM_hhTocHpmHpm(cplhhHpmcHpm,Mhh,MHpm,Mhh2,            & 
& MHpm2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_hhTocHpmHpm


Subroutine Gamma_Real_NonUMSSM_hhTocHpmHpm(MLambda,em,gs,cplhhHpmcHpm,Mhh,            & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_hhTocHpmHpm


Subroutine Amplitude_WAVE_NonUMSSM_hhTocHpmHpm(cplhhHpmcHpm,ctcplhhHpmcHpm,           & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhTocHpmHpm


Subroutine Amplitude_VERTEX_NonUMSSM_hhTocHpmHpm(MAh,MCha,MChi,MFd,MFe,               & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,         & 
...
Complex(dp), Intent(in) :: cplAhAhhh(3,3,3),cplAhhhVZ(3,3),cplAhhhVZp(3,3),cplAhHpmcHpm(3,2,2),cplAhHpmcVWm(3,2),& 
& cplAhcHpmVWm(3,2),cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),cplcChaChahhL(2,2,3),    & 
& cplcChaChahhR(2,2,3),cplChiChihhL(6,6,3),cplChiChihhR(6,6,3),cplcChaChiHpmL(2,6,2),    & 
& cplcChaChiHpmR(2,6,2),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),cplcFuFdcHpmL(3,3,2),      & 
...
& cplcgZgWmcHpm(2),cplcgZpgWmcHpm(2),cplcgWpCgWpChh(3),cplcgZgWpCHpm(2),cplcgZpgWpCHpm(2),& 
& cplcgZgZhh(3),cplcgZpgZhh(3),cplcgWmgZHpm(2),cplcgWpCgZcHpm(2),cplcgZgZphh(3),         & 
& cplcgZpgZphh(3),cplcgWmgZpHpm(2),cplcgWpCgZpcHpm(2),cplhhhhhh(3,3,3),cplhhHpmcHpm(3,2,2),& 
& cplhhHpmcVWm(3,2),cplhhSdcSd(3,6,6),cplhhSecSe(3,6,6),cplhhSucSu(3,6,6),               & 
& cplhhSvcSv(3,3,3),cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),cplhhVZVZ(3),cplhhVZVZp(3),        & 
& cplhhVZpVZp(3),cplHpmSucSd(2,6,6),cplHpmSvcSe(2,3,6),cplHpmcHpmVP(2,2),cplHpmcVWmVP(2),& 
& cplHpmcHpmVZ(2,2),cplHpmcVWmVZ(2),cplHpmcHpmVZp(2,2),cplHpmcVWmVZp(2),cplSdcHpmcSu(6,2,6),& 
& cplSecHpmcSv(6,2,3),cplcHpmVPVWm(2),cplcHpmVWmVZ(2),cplcHpmVWmVZp(2),cplAhAhHpmcHpm1(3,3,2,2),& 
& cplAhhhHpmcHpm1(3,3,2,2),cplhhhhHpmcHpm1(3,3,2,2),cplhhHpmSucSdaa(3,2,6,6),            & 
& cplhhHpmSvcSe1(3,2,3,6),cplhhHpmcVWmVP1(3,2),cplhhHpmcVWmVZ1(3,2),cplhhHpmcVWmVZp1(3,2),& 
& cplhhSdcHpmcSuaa(3,6,2,6),cplhhSecHpmcSv1(3,6,2,3),cplhhcHpmVPVWm1(3,2),               & 
& cplhhcHpmVWmVZ1(3,2),cplhhcHpmVWmVZp1(3,2),cplHpmHpmcHpmcHpm1(2,2,2,2),cplHpmSdcHpmcSdaa(2,6,2,6),& 
...
Amp(gt1, gt2, gt3) = Amp(gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhTocHpmHpm


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTocHpmHpm(MAh,MCha,MChi,MFd,MFe,            & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,         & 
& cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,cplAhcHpmVWm,cplChiChacHpmL,            & 
& cplChiChacHpmR,cplcChaChahhL,cplcChaChahhR,cplChiChihhL,cplChiChihhR,cplcChaChiHpmL,   & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTocHpmHpm


Subroutine Amplitude_Tree_NonUMSSM_hhToHpmcVWm(cplhhHpmcVWm,Mhh,MHpm,MVWm,            & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_hhToHpmcVWm


Subroutine Gamma_Real_NonUMSSM_hhToHpmcVWm(MLambda,em,gs,cplhhHpmcVWm,Mhh,            & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_hhToHpmcVWm


Subroutine Amplitude_WAVE_NonUMSSM_hhToHpmcVWm(cplhhHpmcVWm,ctcplhhHpmcVWm,           & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhToHpmcVWm


Subroutine Amplitude_VERTEX_NonUMSSM_hhToHpmcVWm(MAh,MCha,MChi,MFd,MFe,               & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,         & 
...
Complex(dp), Intent(in) :: cplAhAhhh(3,3,3),cplAhhhVZ(3,3),cplAhhhVZp(3,3),cplAhHpmcHpm(3,2,2),cplAhHpmcVWm(3,2),& 
& cplChiChacVWmL(6,2),cplChiChacVWmR(6,2),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),     & 
& cplChiChihhL(6,6,3),cplChiChihhR(6,6,3),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),   & 
...
& cplcFeFvHpmL(3,3,2),cplcFeFvHpmR(3,3,2),cplcgWmgAHpm(2),cplcgWmgWmhh(3),               & 
& cplcgAgWmcVWm,cplcgZgWmcVWm,cplcgZpgWmcVWm,cplcgWpCgWpChh(3),cplcgZgWpCHpm(2),         & 
& cplcgZpgWpCHpm(2),cplcgZgZhh(3),cplcgZpgZhh(3),cplcgWmgZHpm(2),cplcgWpCgZcVWm,         & 
& cplcgZgZphh(3),cplcgZpgZphh(3),cplcgWmgZpHpm(2),cplcgWpCgZpcVWm,cplhhhhhh(3,3,3),      & 
& cplhhHpmcHpm(3,2,2),cplhhHpmcVWm(3,2),cplhhSdcSd(3,6,6),cplhhSecSe(3,6,6),             & 
& cplhhSucSu(3,6,6),cplhhSvcSv(3,3,3),cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),cplhhVZVZ(3),    & 
& cplhhVZVZp(3),cplhhVZpVZp(3),cplHpmSucSd(2,6,6),cplHpmSvcSe(2,3,6),cplHpmcHpmVP(2,2),  & 
...
& cplAhHpmcVWmVZ1(3,2),cplAhHpmcVWmVZp1(3,2),cplhhhhcVWmVWm1(3,3),cplhhHpmcVWmVP1(3,2),  & 
& cplhhHpmcVWmVZ1(3,2),cplhhHpmcVWmVZp1(3,2),cplHpmcHpmcVWmVWm1(2,2)
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhToHpmcVWm


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToHpmcVWm(MAh,MCha,MChi,MFd,MFe,            & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,         & 
& cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,cplChiChacVWmL,cplChiChacVWmR,          & 
& cplcChaChahhL,cplcChaChahhR,cplChiChihhL,cplChiChihhR,cplcChaChiHpmL,cplcChaChiHpmR,   & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToHpmcVWm


Subroutine Amplitude_Tree_NonUMSSM_hhTocSdSd(cplhhSdcSd,Mhh,MSd,Mhh2,MSd2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_hhTocSdSd


Subroutine Gamma_Real_NonUMSSM_hhTocSdSd(MLambda,em,gs,cplhhSdcSd,Mhh,MSd,            & 
& GammarealPhoton,GammarealGluon)
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_hhTocSdSd


Subroutine Amplitude_WAVE_NonUMSSM_hhTocSdSd(cplhhSdcSd,ctcplhhSdcSd,Mhh,             & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhTocSdSd


Subroutine Amplitude_VERTEX_NonUMSSM_hhTocSdSd(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhTocSdSd


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTocSdSd(MAh,MCha,MChi,MFd,MFu,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTocSdSd


Subroutine Amplitude_Tree_NonUMSSM_hhTocSeSe(cplhhSecSe,Mhh,MSe,Mhh2,MSe2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_hhTocSeSe


Subroutine Gamma_Real_NonUMSSM_hhTocSeSe(MLambda,em,gs,cplhhSecSe,Mhh,MSe,            & 
& GammarealPhoton,GammarealGluon)
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_hhTocSeSe


Subroutine Amplitude_WAVE_NonUMSSM_hhTocSeSe(cplhhSecSe,ctcplhhSecSe,Mhh,             & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhTocSeSe


Subroutine Amplitude_VERTEX_NonUMSSM_hhTocSeSe(MAh,MCha,MChi,MFe,MFv,Mhh,             & 
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhTocSeSe


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTocSeSe(MAh,MCha,MChi,MFe,MFv,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTocSeSe


Subroutine Amplitude_Tree_NonUMSSM_hhTocSuSu(cplhhSucSu,Mhh,MSu,Mhh2,MSu2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_hhTocSuSu


Subroutine Gamma_Real_NonUMSSM_hhTocSuSu(MLambda,em,gs,cplhhSucSu,Mhh,MSu,            & 
& GammarealPhoton,GammarealGluon)
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_hhTocSuSu


Subroutine Amplitude_WAVE_NonUMSSM_hhTocSuSu(cplhhSucSu,ctcplhhSucSu,Mhh,             & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhTocSuSu


Subroutine Amplitude_VERTEX_NonUMSSM_hhTocSuSu(MAh,MCha,MChi,MFd,MFu,MGlu,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,             & 
& MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,             & 
...
Complex(dp), Intent(in) :: cplAhAhhh(3,3,3),cplAhhhVZ(3,3),cplAhhhVZp(3,3),cplAhSucSu(3,6,6),cplcChaChahhL(2,2,3),& 
& cplcChaChahhR(2,2,3),cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),cplChiChihhL(6,6,3),      & 
& cplChiChihhR(6,6,3),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6),cplcFuChiSuL(3,6,6),       & 
& cplcFuChiSuR(3,6,6),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),cplcChaFdcSuL(2,3,6),        & 
...
& cplhhHpmcHpm(3,2,2),cplhhHpmcVWm(3,2),cplhhSdcSd(3,6,6),cplhhSecSe(3,6,6),             & 
& cplhhSucSu(3,6,6),cplhhSvcSv(3,3,3),cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),cplhhVZVZ(3),    & 
& cplhhVZVZp(3),cplhhVZpVZp(3),cplHpmSucSd(2,6,6),cplSdcHpmcSu(6,2,6),cplSdcSucVWm(6,6), & 
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhTocSuSu


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTocSuSu(MAh,MCha,MChi,MFd,MFu,              & 
& MGlu,Mhh,MHpm,MSd,MSe,MSu,MSv,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,             & 
& MFu2,MGlu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,        & 
& cplAhhhVZ,cplAhhhVZp,cplAhSucSu,cplcChaChahhL,cplcChaChahhR,cplcFdChaSuL,              & 
& cplcFdChaSuR,cplChiChihhL,cplChiChihhR,cplChiFucSuL,cplChiFucSuR,cplcFuChiSuL,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTocSuSu


Subroutine Amplitude_Tree_NonUMSSM_hhTocSvSv(cplhhSvcSv,Mhh,MSv,Mhh2,MSv2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_hhTocSvSv


Subroutine Gamma_Real_NonUMSSM_hhTocSvSv(MLambda,em,gs,cplhhSvcSv,Mhh,MSv,            & 
& GammarealPhoton,GammarealGluon)
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_hhTocSvSv


Subroutine Amplitude_WAVE_NonUMSSM_hhTocSvSv(cplhhSvcSv,ctcplhhSvcSv,Mhh,             & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhTocSvSv


Subroutine Amplitude_VERTEX_NonUMSSM_hhTocSvSv(MAh,MCha,MChi,MFe,MFv,Mhh,             & 
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhTocSvSv


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTocSvSv(MAh,MCha,MChi,MFe,MFv,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTocSvSv


Subroutine Amplitude_Tree_NonUMSSM_hhTocVWmVWm(cplhhcVWmVWm,Mhh,MVWm,Mhh2,            & 
& MVWm2,Amp)
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_Tree_NonUMSSM_hhTocVWmVWm


Subroutine Gamma_Real_NonUMSSM_hhTocVWmVWm(MLambda,em,gs,cplhhcVWmVWm,Mhh,            & 
...
End if 
End Do
End Subroutine Gamma_Real_NonUMSSM_hhTocVWmVWm


Subroutine Amplitude_WAVE_NonUMSSM_hhTocVWmVWm(cplhhcVWmVWm,ctcplhhcVWmVWm,           & 
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhTocVWmVWm


Subroutine Amplitude_VERTEX_NonUMSSM_hhTocVWmVWm(MAh,MCha,MChi,MFd,MFe,               & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,         & 
...
& cplcVWmVWmVZVZp1Q,cplcVWmVWmVZpVZp2Q,cplcVWmVWmVZpVZp3Q,cplcVWmVWmVZpVZp1Q,Amp)
...
Complex(dp), Intent(in) :: cplAhAhhh(3,3,3),cplAhhhVZ(3,3),cplAhhhVZp(3,3),cplAhHpmcVWm(3,2),cplAhcHpmVWm(3,2),  & 
& cplChiChacVWmL(6,2),cplChiChacVWmR(6,2),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),     & 
& cplChiChihhL(6,6,3),cplChiChihhR(6,6,3),cplcChaChiVWmL(2,6),cplcChaChiVWmR(2,6),       & 
& cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),cplcFuFdcVWmL(3,3),cplcFuFdcVWmR(3,3),           & 
& cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),cplcFvFecVWmL(3,3),cplcFvFecVWmR(3,3),           & 
& cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),             & 
& cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),cplcgWmgAVWm,cplcgWpCgAcVWm,cplcgWmgWmhh(3),       & 
& cplcgAgWmcVWm,cplcgZgWmcVWm,cplcgZpgWmcVWm,cplcgWpCgWpChh(3),cplcgAgWpCVWm,            & 
& cplcgZgWpCVWm,cplcgZpgWpCVWm,cplcgZgZhh(3),cplcgZpgZhh(3),cplcgWmgZVWm,cplcgWpCgZcVWm, & 
& cplcgZgZphh(3),cplcgZpgZphh(3),cplcgWmgZpVWm,cplcgWpCgZpcVWm,cplhhhhhh(3,3,3),         & 
& cplhhHpmcHpm(3,2,2),cplhhHpmcVWm(3,2),cplhhSdcSd(3,6,6),cplhhSecSe(3,6,6),             & 
& cplhhSucSu(3,6,6),cplhhSvcSv(3,3,3),cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),cplhhVZVZ(3),    & 
& cplhhVZVZp(3),cplhhVZpVZp(3),cplHpmcVWmVP(2),cplHpmcVWmVZ(2),cplHpmcVWmVZp(2),         & 
...
& cplhhHpmcVWmVZp1(3,2),cplhhcHpmVPVWm1(3,2),cplhhcHpmVWmVZ1(3,2),cplhhcHpmVWmVZp1(3,2), & 
& cplHpmcHpmcVWmVWm1(2,2),cplSdcSdcVWmVWmaa(6,6),cplSecSecVWmVWm1(6,6),cplSucSucVWmVWmaa(6,6),& 
& cplSvcSvcVWmVWm1(3,3),cplcVWmcVWmVWmVWm1Q,cplcVWmcVWmVWmVWm2Q,cplcVWmcVWmVWmVWm3Q,     & 
& cplcVWmVWmVZVZ2Q,cplcVWmVWmVZVZ3Q,cplcVWmVWmVZVZ1Q,cplcVWmVWmVZVZp3Q,cplcVWmVWmVZVZp2Q,& 
...
End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhTocVWmVWm


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTocVWmVWm(MAh,MCha,MChi,MFd,MFe,            & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,         & 
& cplAhhhVZ,cplAhhhVZp,cplAhHpmcVWm,cplAhcHpmVWm,cplChiChacVWmL,cplChiChacVWmR,          & 
& cplcChaChahhL,cplcChaChahhR,cplChiChihhL,cplChiChihhR,cplcChaChiVWmL,cplcChaChiVWmR,   & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTocVWmVWm


Subroutine Amplitude_Tree_NonUMSSM_hhToVZVZ(cplhhVZVZ,Mhh,MVZ,Mhh2,MVZ2,Amp)
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_Tree_NonUMSSM_hhToVZVZ


Subroutine Gamma_Real_NonUMSSM_hhToVZVZ(MLambda,em,gs,cplhhVZVZ,Mhh,MVZ,              & 
& GammarealPhoton,GammarealGluon)
...
End if 
End Do
End Subroutine Gamma_Real_NonUMSSM_hhToVZVZ


Subroutine Amplitude_WAVE_NonUMSSM_hhToVZVZ(cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,         & 
...
Complex(dp), Intent(in) :: cplhhVZVZ(3),cplhhVZVZp(3),cplhhVZpVZp(3)

Complex(dp), Intent(in) :: ctcplhhVZVZ(3),ctcplhhVZVZp(3),ctcplhhVZpVZp(3)

Complex(dp), Intent(in) :: Zfhh(3,3),ZfVZ,ZfVZpVZ,ZfVZVZp
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhToVZVZ


Subroutine Amplitude_VERTEX_NonUMSSM_hhToVZVZ(MAh,MCha,MChi,MFd,MFe,MFu,              & 
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,           & 
& MHpm2,MSd2,MSe2,MSu2,MSv2,MVWm2,MVZ2,MVZp2,cplAhAhhh,cplAhhhVZ,cplAhhhVZp,             & 
& cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZR,cplChiChihhL,cplChiChihhR,     & 
& cplChiChiVZL,cplChiChiVZR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,             & 
...
Complex(dp), Intent(in) :: cplAhAhhh(3,3,3),cplAhhhVZ(3,3),cplAhhhVZp(3,3),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),& 
& cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),cplChiChihhL(6,6,3),cplChiChihhR(6,6,3),         & 
& cplChiChiVZL(6,6),cplChiChiVZR(6,6),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),             & 
...
& cplhhSecSe(3,6,6),cplhhSucSu(3,6,6),cplhhSvcSv(3,3,3),cplhhcHpmVWm(3,2),               & 
& cplhhcVWmVWm(3),cplhhVZVZ(3),cplhhVZVZp(3),cplhhVZpVZp(3),cplHpmcHpmVZ(2,2),           & 
& cplHpmcVWmVZ(2),cplSdcSdVZ(6,6),cplSecSeVZ(6,6),cplSucSuVZ(6,6),cplSvcSvVZ(3,3),       & 
& cplcHpmVWmVZ(2),cplcVWmVWmVZ,cplAhAhVZVZ1(3,3),cplhhhhVZVZ1(3,3),cplhhhhVZVZp1(3,3),   & 
& cplhhHpmcVWmVZ1(3,2),cplhhcHpmVWmVZ1(3,2),cplHpmcHpmVZVZ1(2,2),cplSdcSdVZVZaa(6,6),    & 
& cplSecSeVZVZ1(6,6),cplSucSuVZVZaa(6,6),cplSvcSvVZVZ1(3,3),cplcVWmVWmVZVZ2Q,            & 
...
Amp(:,gt1) = Amp(:,gt1) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhToVZVZ


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToVZVZ(MAh,MCha,MChi,MFd,MFe,               & 
& MFu,Mhh,MHpm,MSd,MSe,MSu,MSv,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            & 
& Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVWm2,MVZ2,MVZp2,cplAhAhhh,cplAhhhVZ,cplAhhhVZp,        & 
& cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZR,cplChiChihhL,cplChiChihhR,     & 
& cplChiChiVZL,cplChiChiVZR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToVZVZ


Subroutine Amplitude_Tree_NonUMSSM_hhToVZpVZ(cplhhVZVZp,Mhh,MVZ,MVZp,Mhh2,            & 
& MVZ2,MVZp2,Amp)

Implicit None

Real(dp), Intent(in) :: Mhh(3),MVZ,MVZp,Mhh2(3),MVZ2,MVZp2

Complex(dp), Intent(in) :: cplhhVZVZp(3)
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_Tree_NonUMSSM_hhToVZpVZ


Subroutine Gamma_Real_NonUMSSM_hhToVZpVZ(MLambda,em,gs,cplhhVZVZp,Mhh,MVZ,            & 
& MVZp,GammarealPhoton,GammarealGluon)
...
Real(dp), Intent(in) :: Mhh(3),MVZ,MVZp
...
End if 
End Do
End Subroutine Gamma_Real_NonUMSSM_hhToVZpVZ


Subroutine Amplitude_WAVE_NonUMSSM_hhToVZpVZ(cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,        & 
& ctcplhhVZVZ,ctcplhhVZVZp,ctcplhhVZpVZp,Mhh,Mhh2,MVZ,MVZ2,MVZp,MVZp2,Zfhh,              & 
& ZfVZ,ZfVZp,ZfVZpVZ,Amp)

Implicit None

Real(dp), Intent(in) :: Mhh(3),Mhh2(3),MVZ,MVZ2,MVZp,MVZp2

Complex(dp), Intent(in) :: cplhhVZVZ(3),cplhhVZVZp(3),cplhhVZpVZp(3)

Complex(dp), Intent(in) :: ctcplhhVZVZ(3),ctcplhhVZVZp(3),ctcplhhVZpVZp(3)

Complex(dp), Intent(in) :: Zfhh(3,3),ZfVZ,ZfVZp,ZfVZpVZ
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhToVZpVZ


Subroutine Amplitude_VERTEX_NonUMSSM_hhToVZpVZ(MAh,MCha,MChi,MFd,MFe,MFu,             & 
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,           & 
& MHpm2,MSd2,MSe2,MSu2,MSv2,MVWm2,MVZ2,MVZp2,cplAhAhhh,cplAhhhVZ,cplAhhhVZp,             & 
...
& cplcVWmVWmVZVZp2Q,cplcVWmVWmVZVZp1Q,Amp)
...
& cplChiChihhL(6,6,3),cplChiChihhR(6,6,3),cplChiChiVZL(6,6),cplChiChiVZR(6,6),           & 
& cplChiChiVZpL(6,6),cplChiChiVZpR(6,6),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),           & 
& cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcFdFdVZpL(3,3),cplcFdFdVZpR(3,3),cplcFeFehhL(3,3,3),& 
& cplcFeFehhR(3,3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFeFeVZpL(3,3),cplcFeFeVZpR(3,3),& 
& cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),               & 
& cplcFuFuVZpL(3,3),cplcFuFuVZpR(3,3),cplcgWmgWmhh(3),cplcgWmgWmVZ,cplcgWmgWmVZp,        & 
& cplcgWpCgWpChh(3),cplcgWpCgWpCVZ,cplcgWpCgWpCVZp,cplhhhhhh(3,3,3),cplhhHpmcHpm(3,2,2), & 
& cplhhHpmcVWm(3,2),cplhhSdcSd(3,6,6),cplhhSecSe(3,6,6),cplhhSucSu(3,6,6),               & 
& cplhhSvcSv(3,3,3),cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),cplhhVZVZ(3),cplhhVZVZp(3),        & 
& cplhhVZpVZp(3),cplHpmcHpmVZ(2,2),cplHpmcVWmVZ(2),cplHpmcHpmVZp(2,2),cplHpmcVWmVZp(2),  & 
& cplSdcSdVZ(6,6),cplSdcSdVZp(6,6),cplSecSeVZ(6,6),cplSecSeVZp(6,6),cplSucSuVZ(6,6),     & 
& cplSucSuVZp(6,6),cplSvcSvVZ(3,3),cplSvcSvVZp(3,3),cplcHpmVWmVZ(2),cplcVWmVWmVZ,        & 
& cplcHpmVWmVZp(2),cplcVWmVWmVZp,cplAhAhVZVZp1(3,3),cplhhhhVZVZ1(3,3),cplhhhhVZVZp1(3,3),& 
& cplhhhhVZpVZp1(3,3),cplhhHpmcVWmVZ1(3,2),cplhhHpmcVWmVZp1(3,2),cplhhcHpmVWmVZ1(3,2),   & 
& cplhhcHpmVWmVZp1(3,2),cplHpmcHpmVZVZp1(2,2),cplSdcSdVZVZpaa(6,6),cplSecSeVZVZp1(6,6),  & 
& cplSucSuVZVZpaa(6,6),cplSvcSvVZVZp1(3,3),cplcVWmVWmVZVZp3Q,cplcVWmVWmVZVZp2Q,          & 
& cplcVWmVWmVZVZp1Q
...
Amp(:,gt1) = Amp(:,gt1) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhToVZpVZ


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToVZpVZ(MAh,MCha,MChi,MFd,MFe,              & 
& MFu,Mhh,MHpm,MSd,MSe,MSu,MSv,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            & 
& Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVWm2,MVZ2,MVZp2,cplAhAhhh,cplAhhhVZ,cplAhhhVZp,        & 
& cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZR,cplcChaChaVZpL,cplcChaChaVZpR, & 
& cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,cplChiChiVZpL,cplChiChiVZpR,       & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToVZpVZ


Subroutine Amplitude_Tree_NonUMSSM_hhToVZpVZp(cplhhVZpVZp,Mhh,MVZp,Mhh2,              & 
& MVZp2,Amp)

Implicit None

Real(dp), Intent(in) :: Mhh(3),MVZp,Mhh2(3),MVZp2

Complex(dp), Intent(in) :: cplhhVZpVZp(3)
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_Tree_NonUMSSM_hhToVZpVZp


Subroutine Gamma_Real_NonUMSSM_hhToVZpVZp(MLambda,em,gs,cplhhVZpVZp,Mhh,              & 
& MVZp,GammarealPhoton,GammarealGluon)
...
End if 
End Do
End Subroutine Gamma_Real_NonUMSSM_hhToVZpVZp


Subroutine Amplitude_WAVE_NonUMSSM_hhToVZpVZp(cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,       & 
& ctcplhhVZVZ,ctcplhhVZVZp,ctcplhhVZpVZp,Mhh,Mhh2,MVZ,MVZ2,MVZp,MVZp2,Zfhh,              & 
...
Complex(dp), Intent(in) :: Zfhh(3,3),ZfVZp,ZfVZpVZ,ZfVZVZp
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhToVZpVZp


Subroutine Amplitude_VERTEX_NonUMSSM_hhToVZpVZp(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,           & 
& MHpm2,MSd2,MSe2,MSu2,MSv2,MVWm2,MVZ2,MVZp2,cplAhAhhh,cplAhhhVZ,cplAhhhVZp,             & 
& cplcChaChahhL,cplcChaChahhR,cplcChaChaVZpL,cplcChaChaVZpR,cplChiChihhL,cplChiChihhR,   & 
& cplChiChiVZpL,cplChiChiVZpR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZpL,cplcFdFdVZpR,         & 
...
& cplSvcSvVZpVZp1,cplcVWmVWmVZpVZp2Q,cplcVWmVWmVZpVZp3Q,cplcVWmVWmVZpVZp1Q,Amp)
...
Complex(dp), Intent(in) :: cplAhAhhh(3,3,3),cplAhhhVZ(3,3),cplAhhhVZp(3,3),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),& 
& cplcChaChaVZpL(2,2),cplcChaChaVZpR(2,2),cplChiChihhL(6,6,3),cplChiChihhR(6,6,3),       & 
& cplChiChiVZpL(6,6),cplChiChiVZpR(6,6),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),           & 
& cplcFdFdVZpL(3,3),cplcFdFdVZpR(3,3),cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),             & 
& cplcFeFeVZpL(3,3),cplcFeFeVZpR(3,3),cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),             & 
& cplcFuFuVZpL(3,3),cplcFuFuVZpR(3,3),cplcgWmgWmhh(3),cplcgWmgWmVZp,cplcgWpCgWpChh(3),   & 
& cplcgWpCgWpCVZp,cplhhhhhh(3,3,3),cplhhHpmcHpm(3,2,2),cplhhHpmcVWm(3,2),cplhhSdcSd(3,6,6),& 
& cplhhSecSe(3,6,6),cplhhSucSu(3,6,6),cplhhSvcSv(3,3,3),cplhhcHpmVWm(3,2),               & 
& cplhhcVWmVWm(3),cplhhVZVZ(3),cplhhVZVZp(3),cplhhVZpVZp(3),cplHpmcHpmVZp(2,2),          & 
& cplHpmcVWmVZp(2),cplSdcSdVZp(6,6),cplSecSeVZp(6,6),cplSucSuVZp(6,6),cplSvcSvVZp(3,3),  & 
& cplcHpmVWmVZp(2),cplcVWmVWmVZp,cplAhAhVZpVZp1(3,3),cplhhhhVZVZp1(3,3),cplhhhhVZpVZp1(3,3),& 
& cplhhHpmcVWmVZp1(3,2),cplhhcHpmVWmVZp1(3,2),cplHpmcHpmVZpVZp1(2,2),cplSdcSdVZpVZpaa(6,6),& 
& cplSecSeVZpVZp1(6,6),cplSucSuVZpVZpaa(6,6),cplSvcSvVZpVZp1(3,3),cplcVWmVWmVZpVZp2Q,    & 
...
Amp(:,gt1) = Amp(:,gt1) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhToVZpVZp


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToVZpVZp(MAh,MCha,MChi,MFd,MFe,             & 
& MFu,Mhh,MHpm,MSd,MSe,MSu,MSv,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            & 
& Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVWm2,MVZ2,MVZp2,cplAhAhhh,cplAhhhVZ,cplAhhhVZp,        & 
& cplcChaChahhL,cplcChaChahhR,cplcChaChaVZpL,cplcChaChaVZpR,cplChiChihhL,cplChiChihhR,   & 
& cplChiChiVZpL,cplChiChiVZpR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZpL,cplcFdFdVZpR,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToVZpVZp


Subroutine Amplitude_WAVE_NonUMSSM_hhToAhhh(MAh,MAh2,Mhh,Mhh2,ZfAh,Zfhh,Amp)
...
Amp(gt1, gt2, gt3) = 0._dp
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhToAhhh


Subroutine Amplitude_VERTEX_NonUMSSM_hhToAhhh(MAh,MCha,MChi,MFd,MFe,MFu,              & 
...
ML2 = MSe(i2) 
coup1 = cplhhSecSe(gt1,i1,i2)
coup2 = cplAhhhSecSe1(gt2,gt3,i2,i1)
Call Amp_VERTEX_StoSS_Topology2_SS(Mex1,Mex2,Mex3,ML1,ML2,coup1,coup2,AmpC) 
! Colour and symmetry Factor 
Amp(gt1, gt2, gt3) = Amp(gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  End Do
...
ML2 = MSu(i2) 
coup1 = cplhhSucSu(gt1,i1,i2)
coup2 = cplAhhhSucSuaa(gt2,gt3,i2,i1)
Call Amp_VERTEX_StoSS_Topology2_SS(Mex1,Mex2,Mex3,ML1,ML2,coup1,coup2,AmpC) 
! Colour and symmetry Factor 
Amp(gt1, gt2, gt3) = Amp(gt1, gt2, gt3) + oo16pi2*(3)*AmpC 
  End Do
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhToAhhh


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToAhhh(MAh,MCha,MChi,MFd,MFe,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToAhhh


Subroutine Amplitude_WAVE_NonUMSSM_hhToAhVP(cplAhhhVZ,cplAhhhVZp,ctcplAhhhVZ,         & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhToAhVP


Subroutine Amplitude_VERTEX_NonUMSSM_hhToAhVP(MAh,MCha,MFd,MFe,MFu,Mhh,               & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhToAhVP


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToAhVP(MAh,MCha,MFd,MFe,MFu,Mhh,            & 
& MHpm,MSd,MSe,MSu,MVP,MVWm,MAh2,MCha2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MSd2,MSe2,              & 
& MSu2,MVP2,MVWm2,cplcChaChaAhL,cplcChaChaAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,       & 
& cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhHpmcHpm,          & 
& cplAhHpmcVWm,cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplAhcHpmVWm,cplcChaChahhL,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToAhVP


Subroutine Amplitude_WAVE_NonUMSSM_hhToFvcFv(MFv,MFv2,Mhh,Mhh2,ZfFvL,Zfhh,Amp)

Implicit None

Real(dp), Intent(in) :: MFv(3),MFv2(3),Mhh(3),Mhh2(3)
...
Amp(:,gt1, gt2, gt3) = 0._dp
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhToFvcFv


Subroutine Amplitude_VERTEX_NonUMSSM_hhToFvcFv(MCha,MChi,MFe,MFv,Mhh,MHpm,            & 
...
& cplhhcVWmVWm,cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,cplcChacFvSeL,cplcChacFvSeR,Amp)
...
& cplChiChihhL(6,6,3),cplChiChihhR(6,6,3),cplChiFvcSvL(6,3,3),cplChiFvcSvR(6,3,3),       & 
& cplcFvChiSvL(3,6,3),cplcFvChiSvR(3,6,3),cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),         & 
...
& cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplcFvFvVZpL(3,3),cplcFvFvVZpR(3,3),cplhhHpmcHpm(3,2,2),& 
& cplhhHpmcVWm(3,2),cplhhSecSe(3,6,6),cplhhSvcSv(3,3,3),cplhhcHpmVWm(3,2),               & 
& cplhhcVWmVWm(3),cplhhVZVZ(3),cplhhVZVZp(3),cplhhVZpVZp(3),cplcChacFvSeL(2,3,6),        & 
& cplcChacFvSeR(2,3,6)
...
coup2L = -cplcFvFvVZR(i3,gt2)
coup2R = -cplcFvFvVZL(i3,gt2)
coup3L = -cplcFvFvVZpR(gt3,i3)
coup3R = -cplcFvFvVZpL(gt3,i3)
If ((Abs(coup1))*(Abs(coup2L)+Abs(coup2R))*(Abs(coup3L)+Abs(coup3R)).gt.epsCoup) Then 
Call Amp_VERTEX_StoFF_Topology1_VVF(Mex1,Mex2,Mex3,ML1,ML2,ML3,coup1,coup2L,coup2R,coup3L,coup3R,AmpC) 
Else
 AmpC = 0._dp
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhToFvcFv


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToFvcFv(MCha,MChi,MFe,MFv,Mhh,              & 
& MHpm,MSe,MSv,MVWm,MVZ,MVZp,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,MSv2,MVWm2,           & 
& MVZ2,MVZp2,cplChaFvcSeL,cplChaFvcSeR,cplcChaChahhL,cplcChaChahhR,cplChiChihhL,         & 
& cplChiChihhR,cplChiFvcSvL,cplChiFvcSvR,cplcFvChiSvL,cplcFvChiSvR,cplcFeFehhL,          & 
& cplcFeFehhR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFeFvHpmL,      & 
& cplcFeFvHpmR,cplcFeFvVWmL,cplcFeFvVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcFvFvVZpL,           & 
& cplcFvFvVZpR,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSecSe,cplhhSvcSv,cplhhcHpmVWm,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToFvcFv


Subroutine Amplitude_WAVE_NonUMSSM_hhToGluGlu(MGlu,MGlu2,Mhh,Mhh2,ZffG,Zfhh,Amp)
...
Amp(:,gt1) = 0._dp
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhToGluGlu


Subroutine Amplitude_VERTEX_NonUMSSM_hhToGluGlu(MFd,MFu,MGlu,Mhh,MSd,MSu,             & 
...
End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhToGluGlu


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToGluGlu(MFd,MFu,MGlu,Mhh,MSd,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToGluGlu


Subroutine Amplitude_WAVE_NonUMSSM_hhTohhVP(Mhh,Mhh2,MVP,MVP2,Zfhh,ZfVP,Amp)
...
Amp(:,gt1, gt2) = 0._dp
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhTohhVP


Subroutine Amplitude_VERTEX_NonUMSSM_hhTohhVP(MCha,MFd,MFe,MFu,Mhh,MHpm,              & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhTohhVP


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTohhVP(MCha,MFd,MFe,MFu,Mhh,MHpm,           & 
& MSd,MSe,MSu,MVP,MVWm,MCha2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MVP2,              & 
& MVWm2,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,cplcFdFdhhL,             & 
& cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,               & 
& cplcFeFeVPR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,cplcgWmgWmhh,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTohhVP


Subroutine Amplitude_WAVE_NonUMSSM_hhTohhVZ(Mhh,Mhh2,MVZ,MVZ2,Zfhh,ZfVZ,Amp)
...
Amp(:,gt1, gt2) = 0._dp
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhTohhVZ


Subroutine Amplitude_VERTEX_NonUMSSM_hhTohhVZ(MCha,MChi,MFd,MFe,MFu,Mhh,              & 
...
Real(dp), Intent(in) :: MCha(2),MChi(6),MFd(3),MFe(3),MFu(3),Mhh(3),MHpm(2),MSd(6),MSe(6),MSu(6),             & 
& MSv(3),MVWm,MVZ,MCha2(2),MChi2(6),MFd2(3),MFe2(3),MFu2(3),Mhh2(3),MHpm2(2),            & 
...
& cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),               & 
& cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),               & 
& cplcgWmgWmhh(3),cplcgWmgWmVZ,cplcgWpCgWpChh(3),cplcgWpCgWpCVZ,cplhhHpmcHpm(3,2,2),     & 
& cplhhHpmcVWm(3,2),cplhhSdcSd(3,6,6),cplhhSecSe(3,6,6),cplhhSucSu(3,6,6),               & 
& cplhhSvcSv(3,3,3),cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),cplHpmcHpmVZ(2,2),cplHpmcVWmVZ(2), & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhTohhVZ


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTohhVZ(MCha,MChi,MFd,MFe,MFu,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTohhVZ


Subroutine Amplitude_WAVE_NonUMSSM_hhTohhVZp(Mhh,Mhh2,MVZp,MVZp2,Zfhh,ZfVZp,Amp)

Implicit None

Real(dp), Intent(in) :: Mhh(3),Mhh2(3),MVZp,MVZp2

Complex(dp), Intent(in) :: Zfhh(3,3),ZfVZp
...
Amp(:,gt1, gt2) = 0._dp
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhTohhVZp


Subroutine Amplitude_VERTEX_NonUMSSM_hhTohhVZp(MCha,MChi,MFd,MFe,MFu,Mhh,             & 
& MHpm,MSd,MSe,MSu,MSv,MVWm,MVZp,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MSd2,             & 
& MSe2,MSu2,MSv2,MVWm2,MVZp2,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZpL,cplcChaChaVZpR,  & 
...
Real(dp), Intent(in) :: MCha(2),MChi(6),MFd(3),MFe(3),MFu(3),Mhh(3),MHpm(2),MSd(6),MSe(6),MSu(6),             & 
& MSv(3),MVWm,MVZp,MCha2(2),MChi2(6),MFd2(3),MFe2(3),MFu2(3),Mhh2(3),MHpm2(2),           & 
& MSd2(6),MSe2(6),MSu2(6),MSv2(3),MVWm2,MVZp2
...
& cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),cplcFeFeVZpL(3,3),cplcFeFeVZpR(3,3),             & 
& cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),cplcFuFuVZpL(3,3),cplcFuFuVZpR(3,3),             & 
& cplcgWmgWmhh(3),cplcgWmgWmVZp,cplcgWpCgWpChh(3),cplcgWpCgWpCVZp,cplhhHpmcHpm(3,2,2),   & 
& cplhhHpmcVWm(3,2),cplhhSdcSd(3,6,6),cplhhSecSe(3,6,6),cplhhSucSu(3,6,6),               & 
& cplhhSvcSv(3,3,3),cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),cplHpmcHpmVZp(2,2),cplHpmcVWmVZp(2),& 
& cplSdcSdVZp(6,6),cplSecSeVZp(6,6),cplSucSuVZp(6,6),cplSvcSvVZp(3,3),cplcHpmVWmVZp(2),  & 
& cplcVWmVWmVZp,cplhhHpmcVWmVZp1(3,2),cplhhcHpmVWmVZp1(3,2)
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhTohhVZp


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTohhVZp(MCha,MChi,MFd,MFe,MFu,              & 
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVWm,MVZp,MCha2,MChi2,MFd2,MFe2,MFu2,Mhh2,MHpm2,              & 
& MSd2,MSe2,MSu2,MSv2,MVWm2,MVZp2,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZpL,            & 
...
& cplcgWmgWmVZp,cplcgWpCgWpChh,cplcgWpCgWpCVZp,cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,     & 
& cplhhSecSe,cplhhSucSu,cplhhSvcSv,cplhhcHpmVWm,cplhhcVWmVWm,cplHpmcHpmVZp,              & 
& cplHpmcVWmVZp,cplSdcSdVZp,cplSecSeVZp,cplSucSuVZp,cplSvcSvVZp,cplcHpmVWmVZp,           & 
& cplcVWmVWmVZp,cplhhHpmcVWmVZp1,cplhhcHpmVWmVZp1,Amp)
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhTohhVZp


Subroutine Amplitude_WAVE_NonUMSSM_hhToVGVG(Mhh,Mhh2,MVG,MVG2,Zfhh,ZfVG,Amp)
...
Amp(:,gt1) = 0._dp
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhToVGVG


Subroutine Amplitude_VERTEX_NonUMSSM_hhToVGVG(MFd,MFu,Mhh,MSd,MSu,MVG,MFd2,           & 
...
End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhToVGVG


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToVGVG(MFd,MFu,Mhh,MSd,MSu,MVG,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToVGVG


Subroutine Amplitude_WAVE_NonUMSSM_hhToVPVP(cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,         & 
...
Complex(dp), Intent(in) :: Zfhh(3,3),ZfVP,ZfVPVZ,ZfVPVZp,ZfVZpVP,ZfVZVP
...
Amp(:,gt1) = 0._dp
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhToVPVP


Subroutine Amplitude_VERTEX_NonUMSSM_hhToVPVP(MCha,MFd,MFe,MFu,Mhh,MHpm,              & 
& MSd,MSe,MSu,MVP,MVWm,MCha2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MVP2,              & 
& MVWm2,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,cplcFdFdhhL,             & 
& cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,               & 
& cplcFeFeVPR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,cplcgWmgWmhh,              & 
...
Amp(:,gt1) = Amp(:,gt1) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhToVPVP


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToVPVP(MCha,MFd,MFe,MFu,Mhh,MHpm,           & 
& MSd,MSe,MSu,MVP,MVWm,MCha2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MVP2,              & 
& MVWm2,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,cplcFdFdhhL,             & 
& cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,               & 
& cplcFeFeVPR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,cplcgWmgWmhh,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToVPVP


Subroutine Amplitude_WAVE_NonUMSSM_hhToVPVZ(cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,         & 
& ctcplhhVZVZ,ctcplhhVZVZp,ctcplhhVZpVZp,Mhh,Mhh2,MVP,MVP2,MVZ,MVZ2,Zfhh,ZfVP,           & 
...
Complex(dp), Intent(in) :: Zfhh(3,3),ZfVP,ZfVPVZp,ZfVZ,ZfVZpVZ
...
Amp(:,gt1) = 0._dp
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhToVPVZ


Subroutine Amplitude_VERTEX_NonUMSSM_hhToVPVZ(MCha,MFd,MFe,MFu,Mhh,MHpm,              & 
...
Amp(:,gt1) = Amp(:,gt1) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhToVPVZ


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToVPVZ(MCha,MFd,MFe,MFu,Mhh,MHpm,           & 
& MSd,MSe,MSu,MVP,MVWm,MVZ,MCha2,MFd2,MFe2,MFu2,Mhh2,MHpm2,MSd2,MSe2,MSu2,               & 
& MVP2,MVWm2,MVZ2,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,               & 
& cplcChaChaVZL,cplcChaChaVZR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,           & 
& cplcFdFdVZL,cplcFdFdVZR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToVPVZ


Subroutine Amplitude_WAVE_NonUMSSM_hhToVPVZp(cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,        & 
& ctcplhhVZVZ,ctcplhhVZVZp,ctcplhhVZpVZp,Mhh,Mhh2,MVP,MVP2,MVZ,MVZ2,MVZp,MVZp2,          & 
& Zfhh,ZfVP,ZfVPVZ,ZfVZp,ZfVZVZp,Amp)

Implicit None

Real(dp), Intent(in) :: Mhh(3),Mhh2(3),MVP,MVP2,MVZ,MVZ2,MVZp,MVZp2

Complex(dp), Intent(in) :: cplhhVZVZ(3),cplhhVZVZp(3),cplhhVZpVZp(3)

Complex(dp), Intent(in) :: ctcplhhVZVZ(3),ctcplhhVZVZp(3),ctcplhhVZpVZp(3)

Complex(dp), Intent(in) :: Zfhh(3,3),ZfVP,ZfVPVZ,ZfVZp,ZfVZVZp
...
Amp(:,gt1) = 0._dp
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_hhToVPVZp


Subroutine Amplitude_VERTEX_NonUMSSM_hhToVPVZp(MCha,MFd,MFe,MFu,Mhh,MHpm,             & 
...
Real(dp), Intent(in) :: MCha(2),MFd(3),MFe(3),MFu(3),Mhh(3),MHpm(2),MSd(6),MSe(6),MSu(6),MVP,MVWm,            & 
& MVZp,MCha2(2),MFd2(3),MFe2(3),MFu2(3),Mhh2(3),MHpm2(2),MSd2(6),MSe2(6),MSu2(6),        & 
& MVP2,MVWm2,MVZp2

Complex(dp), Intent(in) :: cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),cplcChaChaVPL(2,2),cplcChaChaVPR(2,2),      & 
& cplcChaChaVZpL(2,2),cplcChaChaVZpR(2,2),cplcFdFdhhL(3,3,3),cplcFdFdhhR(3,3,3),         & 
& cplcFdFdVPL(3,3),cplcFdFdVPR(3,3),cplcFdFdVZpL(3,3),cplcFdFdVZpR(3,3),cplcFeFehhL(3,3,3),& 
& cplcFeFehhR(3,3,3),cplcFeFeVPL(3,3),cplcFeFeVPR(3,3),cplcFeFeVZpL(3,3),cplcFeFeVZpR(3,3),& 
& cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),               & 
& cplcFuFuVZpL(3,3),cplcFuFuVZpR(3,3),cplcgWmgWmhh(3),cplcgWmgWmVP,cplcgWmgWmVZp,        & 
& cplcgWpCgWpChh(3),cplcgWpCgWpCVP,cplcgWpCgWpCVZp,cplhhHpmcHpm(3,2,2),cplhhHpmcVWm(3,2),& 
& cplhhSdcSd(3,6,6),cplhhSecSe(3,6,6),cplhhSucSu(3,6,6),cplhhcHpmVWm(3,2),               & 
& cplhhcVWmVWm(3),cplHpmcHpmVP(2,2),cplHpmcVWmVP(2),cplHpmcHpmVZp(2,2),cplHpmcVWmVZp(2), & 
...
& cplhhHpmcVWmVP1(3,2),cplhhHpmcVWmVZp1(3,2),cplhhcHpmVPVWm1(3,2),cplhhcHpmVWmVZp1(3,2), & 
...
Amp(:,gt1) = Amp(:,gt1) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_hhToVPVZp


Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToVPVZp(MCha,MFd,MFe,MFu,Mhh,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_hhToVPVZp



End Module OneLoopDecay_hh_NonUMSSM
