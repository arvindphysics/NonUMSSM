...
! ------------------------------------------------------------------------------  
! File created at 0:31 on 10.2.2021   
! ----------------------------------------------------------------------  
 
 
Module OneLoopDecay_Hpm_NonUMSSM
Use Control 
Use Settings 
Use LoopFunctions 
...
Subroutine Amplitude_Tree_NonUMSSM_HpmToHpmAh(cplAhHpmcHpm,MAh,MHpm,MAh2,             & 
& MHpm2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_HpmToHpmAh


Subroutine Gamma_Real_NonUMSSM_HpmToHpmAh(MLambda,em,gs,cplAhHpmcHpm,MAh,             & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_HpmToHpmAh


Subroutine Amplitude_WAVE_NonUMSSM_HpmToHpmAh(cplAhHpmcHpm,ctcplAhHpmcHpm,            & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_HpmToHpmAh


Subroutine Amplitude_VERTEX_NonUMSSM_HpmToHpmAh(MAh,MCha,MChi,MFd,MFe,MFu,            & 
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_HpmToHpmAh


Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmToHpmAh(MAh,MCha,MChi,MFd,MFe,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmToHpmAh


Subroutine Amplitude_Tree_NonUMSSM_HpmToAhVWm(cplAhcHpmVWm,MAh,MHpm,MVWm,             & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_HpmToAhVWm


Subroutine Gamma_Real_NonUMSSM_HpmToAhVWm(MLambda,em,gs,cplAhcHpmVWm,MAh,             & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_HpmToAhVWm


Subroutine Amplitude_WAVE_NonUMSSM_HpmToAhVWm(cplAhcHpmVWm,ctcplAhcHpmVWm,            & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_HpmToAhVWm


Subroutine Amplitude_VERTEX_NonUMSSM_HpmToAhVWm(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,              & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,           & 
...
& cplcgWpCgWpCAh(3),cplAhhhVZ(3,3),cplAhhhVZp(3,3),cplAhHpmcHpm(3,2,2),cplAhHpmcVWm(3,2),& 
& cplAhSdcSd(3,6,6),cplAhSecSe(3,6,6),cplAhSucSu(3,6,6),cplAhcHpmVWm(3,2),               & 
& cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),cplcChaChiVWmL(2,6),cplcChaChiVWmR(2,6),   & 
& cplcFuFdcHpmL(3,3,2),cplcFuFdcHpmR(3,3,2),cplcFvFecHpmL(3,3,2),cplcFvFecHpmR(3,3,2),   & 
& cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),               & 
& cplcgWpCgAcHpm(2),cplcgZgWmcHpm(2),cplcgZpgWmcHpm(2),cplcgAgWpCVWm,cplcgZgWpCVWm,      & 
& cplcgZpgWpCVWm,cplcgWmgZVWm,cplcgWpCgZcHpm(2),cplcgWmgZpVWm,cplcgWpCgZpcHpm(2),        & 
& cplhhHpmcHpm(3,2,2),cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),cplHpmcHpmVP(2,2),               & 
& cplHpmcHpmVZ(2,2),cplHpmcHpmVZp(2,2),cplSdcHpmcSu(6,2,6),cplSecHpmcSv(6,2,3),          & 
& cplSucSdVWm(6,6),cplSvcSeVWm(3,6),cplcHpmVPVWm(2),cplcVWmVPVWm,cplcHpmVWmVZ(2),        & 
& cplcVWmVWmVZ,cplcHpmVWmVZp(2),cplcVWmVWmVZp,cplAhAhcVWmVWm1(3,3),cplAhcHpmVPVWm1(3,2), & 
& cplAhcHpmVWmVZ1(3,2),cplAhcHpmVWmVZp1(3,2),cplhhcHpmVWmVZ1(3,2),cplhhcHpmVWmVZp1(3,2), & 
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_HpmToAhVWm


Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmToAhVWm(MAh,MCha,MChi,MFd,MFe,             & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,         & 
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,           & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmToAhVWm


Subroutine Amplitude_Tree_NonUMSSM_HpmToChiCha(cplChiChacHpmL,cplChiChacHpmR,         & 
& MCha,MChi,MHpm,MCha2,MChi2,MHpm2,Amp)

Implicit None

Real(dp), Intent(in) :: MCha(2),MChi(6),MHpm(2),MCha2(2),MChi2(6),MHpm2(2)

Complex(dp), Intent(in) :: cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2)

Complex(dp) :: Amp(2,2,6,2) 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_HpmToChiCha


Subroutine Gamma_Real_NonUMSSM_HpmToChiCha(MLambda,em,gs,cplChiChacHpmL,              & 
...
Real(dp), Intent(in) :: MCha(2),MChi(6),MHpm(2)

Real(dp), Intent(in) :: MLambda, em, gs 

Real(dp), Intent(out) :: GammarealPhoton(2,6,2), GammarealGluon(2,6,2) 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_HpmToChiCha


Subroutine Amplitude_WAVE_NonUMSSM_HpmToChiCha(cplChiChacHpmL,cplChiChacHpmR,         & 
& ctcplChiChacHpmL,ctcplChiChacHpmR,MCha,MCha2,MChi,MChi2,MHpm,MHpm2,ZfHpm,              & 
& ZfL0,ZfLm,ZfLp,Amp)

Implicit None

Real(dp), Intent(in) :: MCha(2),MCha2(2),MChi(6),MChi2(6),MHpm(2),MHpm2(2)

Complex(dp), Intent(in) :: cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2)

Complex(dp), Intent(in) :: ctcplChiChacHpmL(6,2,2),ctcplChiChacHpmR(6,2,2)

Complex(dp), Intent(in) :: ZfHpm(2,2),ZfL0(6,6),ZfLm(2,2),ZfLp(2,2)

Complex(dp), Intent(out) :: Amp(2,2,6,2) 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_HpmToChiCha


Subroutine Amplitude_VERTEX_NonUMSSM_HpmToChiCha(MAh,MCha,MChi,MFd,MFe,               & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
...
& cplAhHpmcHpm(3,2,2),cplAhcHpmVWm(3,2),cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),     & 
& cplChiChacVWmL(6,2),cplChiChacVWmR(6,2),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),       & 
...
& cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),cplcFdChiSdL(3,6,6),cplcFdChiSdR(3,6,6),   & 
& cplcFeChiSeL(3,6,6),cplcFeChiSeR(3,6,6),cplcFuChiSuL(3,6,6),cplcFuChiSuR(3,6,6),       & 
...
& cplHpmcHpmVZp(2,2),cplSdcHpmcSu(6,2,6),cplSecHpmcSv(6,2,3),cplcHpmVPVWm(2),            & 
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_HpmToChiCha


Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmToChiCha(MAh,MCha,MChi,MFd,MFe,            & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,     & 
& cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplAhHpmcHpm,cplAhcHpmVWm,cplChiChacHpmL,      & 
& cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,cplChaFucSdL,cplChaFucSdR,cplChaFvcSeL,   & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmToChiCha


Subroutine Amplitude_Tree_NonUMSSM_HpmTocFuFd(cplcFuFdcHpmL,cplcFuFdcHpmR,            & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_HpmTocFuFd


Subroutine Gamma_Real_NonUMSSM_HpmTocFuFd(MLambda,em,gs,cplcFuFdcHpmL,cplcFuFdcHpmR,  & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_HpmTocFuFd


Subroutine Amplitude_WAVE_NonUMSSM_HpmTocFuFd(cplcFuFdcHpmL,cplcFuFdcHpmR,            & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_HpmTocFuFd


Subroutine Amplitude_VERTEX_NonUMSSM_HpmTocFuFd(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
...
& cplAhHpmcHpm(3,2,2),cplAhcHpmVWm(3,2),cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),     & 
& cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6),cplcFuChiSuL(3,6,6),cplcFuChiSuR(3,6,6),       & 
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_HpmTocFuFd


Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmTocFuFd(MAh,MCha,MChi,MFd,MFu,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmTocFuFd


Subroutine Amplitude_Tree_NonUMSSM_HpmTocFvFe(cplcFvFecHpmL,cplcFvFecHpmR,            & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_HpmTocFvFe


Subroutine Gamma_Real_NonUMSSM_HpmTocFvFe(MLambda,em,gs,cplcFvFecHpmL,cplcFvFecHpmR,  & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_HpmTocFvFe


Subroutine Amplitude_WAVE_NonUMSSM_HpmTocFvFe(cplcFvFecHpmL,cplcFvFecHpmR,            & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_HpmTocFvFe


Subroutine Amplitude_VERTEX_NonUMSSM_HpmTocFvFe(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
...
& cplcChacFvSeR,cplSecHpmcSv,cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,Amp)
...
& cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6),   & 
...
& cplcFvFvVZR(3,3),cplcFvFvVZpL(3,3),cplcFvFvVZpR(3,3),cplhhHpmcHpm(3,2,2),              & 
& cplhhcHpmVWm(3,2),cplHpmcHpmVP(2,2),cplHpmcHpmVZ(2,2),cplHpmcHpmVZp(2,2),              & 
& cplcChacFvSeL(2,3,6),cplcChacFvSeR(2,3,6),cplSecHpmcSv(6,2,3),cplcHpmVPVWm(2),         & 
& cplcHpmVWmVZ(2),cplcHpmVWmVZp(2)
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_HpmTocFvFe


Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmTocFvFe(MAh,MCha,MChi,MFe,MFv,             & 
& Mhh,MHpm,MSe,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,              & 
& MSe2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcFeFeAhL,cplcFeFeAhR,cplAhHpmcHpm,cplAhcHpmVWm,     & 
& cplChiChacHpmL,cplChiChacHpmR,cplChiFecSeL,cplChiFecSeR,cplcFvChiSvL,cplcFvChiSvR,     & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               & 
& cplcFeFeVZpL,cplcFeFeVZpR,cplcChaFecSvL,cplcChaFecSvR,cplcFvFecHpmL,cplcFvFecHpmR,     & 
& cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcFvFvVZpL,cplcFvFvVZpR,         & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmTocFvFe


Subroutine Amplitude_Tree_NonUMSSM_HpmToHpmhh(cplhhHpmcHpm,Mhh,MHpm,Mhh2,             & 
& MHpm2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_HpmToHpmhh


Subroutine Gamma_Real_NonUMSSM_HpmToHpmhh(MLambda,em,gs,cplhhHpmcHpm,Mhh,             & 
& MHpm,GammarealPhoton,GammarealGluon)
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_HpmToHpmhh


Subroutine Amplitude_WAVE_NonUMSSM_HpmToHpmhh(cplhhHpmcHpm,ctcplhhHpmcHpm,            & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_HpmToHpmhh


Subroutine Amplitude_VERTEX_NonUMSSM_HpmToHpmhh(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,              & 
...
Amp(gt1, gt2, gt3) = Amp(gt1, gt2, gt3) + oo16pi2*(1._dp/2._dp)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_HpmToHpmhh


Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmToHpmhh(MAh,MCha,MChi,MFd,MFe,             & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,         & 
& cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,cplAhcHpmVWm,cplChiChacHpmL,            & 
& cplChiChacHpmR,cplcChaChahhL,cplcChaChahhR,cplChiChihhL,cplChiChihhR,cplcChaChiHpmL,   & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmToHpmhh


Subroutine Amplitude_Tree_NonUMSSM_HpmTohhVWm(cplhhcHpmVWm,Mhh,MHpm,MVWm,             & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_HpmTohhVWm


Subroutine Gamma_Real_NonUMSSM_HpmTohhVWm(MLambda,em,gs,cplhhcHpmVWm,Mhh,             & 
& MHpm,MVWm,GammarealPhoton,GammarealGluon)
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_HpmTohhVWm


Subroutine Amplitude_WAVE_NonUMSSM_HpmTohhVWm(cplhhcHpmVWm,ctcplhhcHpmVWm,            & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_HpmTohhVWm


Subroutine Amplitude_VERTEX_NonUMSSM_HpmTohhVWm(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,              & 
...
& cplhhcHpmVWmVZp1,cplHpmcHpmcVWmVWm1,Amp)
...
Complex(dp), Intent(in) :: cplAhAhhh(3,3,3),cplAhhhVZ(3,3),cplAhhhVZp(3,3),cplAhHpmcHpm(3,2,2),cplAhcHpmVWm(3,2),& 
& cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3), & 
...
& cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),cplcgWpCgAcHpm(2),cplcgWmgWmhh(3),cplcgZgWmcHpm(2),& 
& cplcgZpgWmcHpm(2),cplcgWpCgWpChh(3),cplcgAgWpCVWm,cplcgZgWpCVWm,cplcgZpgWpCVWm,        & 
& cplcgZgZhh(3),cplcgZpgZhh(3),cplcgWmgZVWm,cplcgWpCgZcHpm(2),cplcgZgZphh(3),            & 
& cplcgZpgZphh(3),cplcgWmgZpVWm,cplcgWpCgZpcHpm(2),cplhhhhhh(3,3,3),cplhhHpmcHpm(3,2,2), & 
& cplhhHpmcVWm(3,2),cplhhSdcSd(3,6,6),cplhhSecSe(3,6,6),cplhhSucSu(3,6,6),               & 
& cplhhSvcSv(3,3,3),cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),cplhhVZVZ(3),cplhhVZVZp(3),        & 
& cplhhVZpVZp(3),cplHpmcHpmVP(2,2),cplHpmcHpmVZ(2,2),cplHpmcHpmVZp(2,2),cplSdcHpmcSu(6,2,6),& 
& cplSecHpmcSv(6,2,3),cplSucSdVWm(6,6),cplSvcSeVWm(3,6),cplcHpmVPVWm(2),cplcVWmVPVWm,    & 
& cplcHpmVWmVZ(2),cplcVWmVWmVZ,cplcHpmVWmVZp(2),cplcVWmVWmVZp,cplAhcHpmVWmVZ1(3,2),      & 
& cplAhcHpmVWmVZp1(3,2),cplhhhhcVWmVWm1(3,3),cplhhcHpmVPVWm1(3,2),cplhhcHpmVWmVZ1(3,2),  & 
& cplhhcHpmVWmVZp1(3,2),cplHpmcHpmcVWmVWm1(2,2)
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_HpmTohhVWm


Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmTohhVWm(MAh,MCha,MChi,MFd,MFe,             & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,         & 
& cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,          & 
& cplcChaChahhL,cplcChaChahhR,cplChiChihhL,cplChiChihhR,cplcChaChiVWmL,cplcChaChiVWmR,   & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmTohhVWm


Subroutine Amplitude_Tree_NonUMSSM_HpmToHpmVZ(cplHpmcHpmVZ,MHpm,MVZ,MHpm2,MVZ2,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_HpmToHpmVZ


Subroutine Gamma_Real_NonUMSSM_HpmToHpmVZ(MLambda,em,gs,cplHpmcHpmVZ,MHpm,            & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_HpmToHpmVZ


Subroutine Amplitude_WAVE_NonUMSSM_HpmToHpmVZ(cplHpmcHpmVP,cplHpmcHpmVZ,              & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_HpmToHpmVZ


Subroutine Amplitude_VERTEX_NonUMSSM_HpmToHpmVZ(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             & 
...
& cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),     & 
& cplChiChiVZL(6,6),cplChiChiVZR(6,6),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),       & 
...
& cplhhHpmcHpm(3,2,2),cplhhHpmcVWm(3,2),cplhhcHpmVWm(3,2),cplhhVZVZ(3),cplhhVZVZp(3),    & 
...
& cplSdcHpmcSu(6,2,6),cplSecSeVZ(6,6),cplSecHpmcSv(6,2,3),cplSucSuVZ(6,6),               & 
& cplSvcSvVZ(3,3),cplcHpmVPVWm(2),cplcHpmVWmVZ(2),cplcVWmVWmVZ,cplcHpmVWmVZp(2),         & 
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_HpmToHpmVZ


Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmToHpmVZ(MAh,MCha,MChi,MFd,MFe,             & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmToHpmVZ


Subroutine Amplitude_Tree_NonUMSSM_HpmToHpmVZp(cplHpmcHpmVZp,MHpm,MVZp,               & 
& MHpm2,MVZp2,Amp)
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_HpmToHpmVZp


Subroutine Gamma_Real_NonUMSSM_HpmToHpmVZp(MLambda,em,gs,cplHpmcHpmVZp,               & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_HpmToHpmVZp


Subroutine Amplitude_WAVE_NonUMSSM_HpmToHpmVZp(cplHpmcHpmVP,cplHpmcHpmVZ,             & 
& cplHpmcHpmVZp,ctcplHpmcHpmVP,ctcplHpmcHpmVZ,ctcplHpmcHpmVZp,MHpm,MHpm2,MVP,            & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_HpmToHpmVZp


Subroutine Amplitude_VERTEX_NonUMSSM_HpmToHpmVZp(MAh,MCha,MChi,MFd,MFe,               & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
...
Complex(dp), Intent(in) :: cplAhhhVZp(3,3),cplAhHpmcHpm(3,2,2),cplAhHpmcVWm(3,2),cplAhcHpmVWm(3,2),              & 
& cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),cplcChaChaVZpL(2,2),cplcChaChaVZpR(2,2),   & 
& cplChiChiVZpL(6,6),cplChiChiVZpR(6,6),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),     & 
...
& cplhhHpmcHpm(3,2,2),cplhhHpmcVWm(3,2),cplhhcHpmVWm(3,2),cplhhVZVZp(3),cplhhVZpVZp(3),  & 
& cplHpmSucSd(2,6,6),cplHpmSvcSe(2,3,6),cplHpmcHpmVP(2,2),cplHpmcVWmVP(2),               & 
& cplHpmcHpmVZ(2,2),cplHpmcVWmVZ(2),cplHpmcHpmVZp(2,2),cplHpmcVWmVZp(2),cplSdcSdVZp(6,6),& 
& cplSdcHpmcSu(6,2,6),cplSecSeVZp(6,6),cplSecHpmcSv(6,2,3),cplSucSuVZp(6,6),             & 
& cplSvcSvVZp(3,3),cplcHpmVPVWm(2),cplcHpmVWmVZ(2),cplcHpmVWmVZp(2),cplcVWmVWmVZp,       & 
& cplAhHpmcVWmVZp1(3,2),cplAhcHpmVWmVZp1(3,2),cplhhHpmcVWmVZp1(3,2),cplhhcHpmVWmVZp1(3,2),& 
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_HpmToHpmVZp


Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmToHpmVZp(MAh,MCha,MChi,MFd,MFe,            & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhhhVZp,        & 
& cplAhHpmcHpm,cplAhHpmcVWm,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,cplcChaChaVZpL,   & 
& cplcChaChaVZpR,cplChiChiVZpL,cplChiChiVZpR,cplcChaChiHpmL,cplcChaChiHpmR,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmToHpmVZp


Subroutine Amplitude_Tree_NonUMSSM_HpmTocSuSd(cplSdcHpmcSu,MHpm,MSd,MSu,              & 
& MHpm2,MSd2,MSu2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_HpmTocSuSd


Subroutine Gamma_Real_NonUMSSM_HpmTocSuSd(MLambda,em,gs,cplSdcHpmcSu,MHpm,            & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_HpmTocSuSd


Subroutine Amplitude_WAVE_NonUMSSM_HpmTocSuSd(cplSdcHpmcSu,ctcplSdcHpmcSu,            & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_HpmTocSuSd


Subroutine Amplitude_VERTEX_NonUMSSM_HpmTocSuSd(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
...
& cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6),   & 
& cplcFdChiSdL(3,6,6),cplcFdChiSdR(3,6,6),cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),     & 
...
& cplSecHpmcSv(6,2,3),cplSucSuVG(6,6),cplSucSuVP(6,6),cplSucSuVZ(6,6),cplSucSuVZp(6,6),  & 
& cplcHpmVPVWm(2),cplcHpmVWmVZ(2),cplcHpmVWmVZp(2),cplAhSdcHpmcSuaa(3,6,2,6),            & 
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_HpmTocSuSd


Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmTocSuSd(MAh,MCha,MChi,MFd,MFu,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmTocSuSd


Subroutine Amplitude_Tree_NonUMSSM_HpmTocSvSe(cplSecHpmcSv,MHpm,MSe,MSv,              & 
& MHpm2,MSe2,MSv2,Amp)
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_HpmTocSvSe


Subroutine Gamma_Real_NonUMSSM_HpmTocSvSe(MLambda,em,gs,cplSecHpmcSv,MHpm,            & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_HpmTocSvSe


Subroutine Amplitude_WAVE_NonUMSSM_HpmTocSvSe(cplSecHpmcSv,ctcplSecHpmcSv,            & 
...
Amp(gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_HpmTocSvSe


Subroutine Amplitude_VERTEX_NonUMSSM_HpmTocSvSe(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_HpmTocSvSe


Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmTocSvSe(MAh,MCha,MChi,MFe,MFv,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmTocSvSe


Subroutine Amplitude_Tree_NonUMSSM_HpmToVZVWm(cplcHpmVWmVZ,MHpm,MVWm,MVZ,             & 
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_Tree_NonUMSSM_HpmToVZVWm


Subroutine Gamma_Real_NonUMSSM_HpmToVZVWm(MLambda,em,gs,cplcHpmVWmVZ,MHpm,            & 
...
End if 
End Do
End Subroutine Gamma_Real_NonUMSSM_HpmToVZVWm


Subroutine Amplitude_WAVE_NonUMSSM_HpmToVZVWm(cplcHpmVPVWm,cplcHpmVWmVZ,              & 
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_HpmToVZVWm


Subroutine Amplitude_VERTEX_NonUMSSM_HpmToVZVWm(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhhhVZ,              & 
...
Complex(dp), Intent(in) :: cplAhhhVZ(3,3),cplAhHpmcHpm(3,2,2),cplAhcHpmVWm(3,2),cplChiChacHpmL(6,2,2),           & 
& cplChiChacHpmR(6,2,2),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),cplChiChiVZL(6,6),         & 
& cplChiChiVZR(6,6),cplcChaChiVWmL(2,6),cplcChaChiVWmR(2,6),cplcFdFdVZL(3,3),            & 
...
& cplcgWmgZVWm,cplcgWpCgZcHpm(2),cplcgWmgZpVWm,cplcgWpCgZpcHpm(2),cplhhHpmcHpm(3,2,2),   & 
& cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),cplhhVZVZ(3),cplhhVZVZp(3),cplHpmcHpmVP(2,2),        & 
& cplHpmcHpmVZ(2,2),cplHpmcVWmVZ(2),cplHpmcHpmVZp(2,2),cplSdcSdVZ(6,6),cplSdcHpmcSu(6,2,6),& 
& cplSecSeVZ(6,6),cplSecHpmcSv(6,2,3),cplSucSdVWm(6,6),cplSucSuVZ(6,6),cplSvcSeVWm(3,6), & 
& cplSvcSvVZ(3,3),cplcHpmVPVWm(2),cplcVWmVPVWm,cplcHpmVWmVZ(2),cplcVWmVWmVZ,             & 
& cplcHpmVWmVZp(2),cplcVWmVWmVZp,cplAhcHpmVWmVZ1(3,2),cplhhcHpmVWmVZ1(3,2),              & 
& cplhhcHpmVWmVZp1(3,2),cplHpmcHpmVPVZ1(2,2),cplHpmcHpmcVWmVWm1(2,2),cplHpmcHpmVZVZ1(2,2),& 
& cplHpmcHpmVZVZp1(2,2),cplSucSdVWmVZaa(6,6),cplSvcSeVWmVZ1(3,6),cplcVWmVPVWmVZ3Q,       & 
...
End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_HpmToVZVWm


Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmToVZVWm(MAh,MCha,MChi,MFd,MFe,             & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhhhVZ,         & 
& cplAhHpmcHpm,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,cplcChaChaVZL,cplcChaChaVZR,   & 
& cplChiChiVZL,cplChiChiVZR,cplcChaChiVWmL,cplcChaChiVWmR,cplcFdFdVZL,cplcFdFdVZR,       & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmToVZVWm


Subroutine Amplitude_Tree_NonUMSSM_HpmToVZpVWm(cplcHpmVWmVZp,MHpm,MVWm,               & 
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_Tree_NonUMSSM_HpmToVZpVWm


Subroutine Gamma_Real_NonUMSSM_HpmToVZpVWm(MLambda,em,gs,cplcHpmVWmVZp,               & 
...
End if 
End Do
End Subroutine Gamma_Real_NonUMSSM_HpmToVZpVWm


Subroutine Amplitude_WAVE_NonUMSSM_HpmToVZpVWm(cplcHpmVPVWm,cplcHpmVWmVZ,             & 
& cplcHpmVWmVZp,ctcplcHpmVPVWm,ctcplcHpmVWmVZ,ctcplcHpmVWmVZp,MHpm,MHpm2,MVP,            & 
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_HpmToVZpVWm


Subroutine Amplitude_VERTEX_NonUMSSM_HpmToVZpVWm(MAh,MCha,MChi,MFd,MFe,               & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhhhVZp,        & 
...
Complex(dp), Intent(in) :: cplAhhhVZp(3,3),cplAhHpmcHpm(3,2,2),cplAhcHpmVWm(3,2),cplChiChacHpmL(6,2,2),          & 
& cplChiChacHpmR(6,2,2),cplcChaChaVZpL(2,2),cplcChaChaVZpR(2,2),cplChiChiVZpL(6,6),      & 
& cplChiChiVZpR(6,6),cplcChaChiVWmL(2,6),cplcChaChiVWmR(2,6),cplcFdFdVZpL(3,3),          & 
...
& cplcgWpCgZpcHpm(2),cplhhHpmcHpm(3,2,2),cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),              & 
& cplhhVZVZp(3),cplhhVZpVZp(3),cplHpmcHpmVP(2,2),cplHpmcHpmVZ(2,2),cplHpmcHpmVZp(2,2),   & 
& cplHpmcVWmVZp(2),cplSdcSdVZp(6,6),cplSdcHpmcSu(6,2,6),cplSecSeVZp(6,6),cplSecHpmcSv(6,2,3),& 
& cplSucSdVWm(6,6),cplSucSuVZp(6,6),cplSvcSeVWm(3,6),cplSvcSvVZp(3,3),cplcHpmVPVWm(2),   & 
& cplcVWmVPVWm,cplcHpmVWmVZ(2),cplcVWmVWmVZ,cplcHpmVWmVZp(2),cplcVWmVWmVZp,              & 
& cplAhcHpmVWmVZp1(3,2),cplhhcHpmVWmVZ1(3,2),cplhhcHpmVWmVZp1(3,2),cplHpmcHpmVPVZp1(2,2),& 
& cplHpmcHpmcVWmVWm1(2,2),cplHpmcHpmVZVZp1(2,2),cplHpmcHpmVZpVZp1(2,2),cplSucSdVWmVZpaa(6,6),& 
& cplSvcSeVWmVZp1(3,6),cplcVWmVPVWmVZp3Q,cplcVWmVPVWmVZp2Q,cplcVWmVPVWmVZp1Q,            & 
...
End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_HpmToVZpVWm


Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmToVZpVWm(MAh,MCha,MChi,MFd,MFe,            & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhhhVZp,        & 
& cplAhHpmcHpm,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,cplcChaChaVZpL,cplcChaChaVZpR, & 
& cplChiChiVZpL,cplChiChiVZpR,cplcChaChiVWmL,cplcChaChiVWmR,cplcFdFdVZpL,cplcFdFdVZpR,   & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmToVZpVWm


Subroutine Amplitude_WAVE_NonUMSSM_HpmToHpmVP(cplHpmcHpmVP,cplHpmcHpmVZ,              & 
& cplHpmcHpmVZp,ctcplHpmcHpmVP,ctcplHpmcHpmVZ,ctcplHpmcHpmVZp,MHpm,MHpm2,MVP,            & 
...
Amp(:,gt1, gt2) = AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_HpmToHpmVP


Subroutine Amplitude_VERTEX_NonUMSSM_HpmToHpmVP(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhHpmcHpm,           & 
...
Complex(dp), Intent(in) :: cplAhHpmcHpm(3,2,2),cplAhHpmcVWm(3,2),cplAhcHpmVWm(3,2),cplChiChacHpmL(6,2,2),        & 
& cplChiChacHpmR(6,2,2),cplcChaChaVPL(2,2),cplcChaChaVPR(2,2),cplcChaChiHpmL(2,6,2),     & 
& cplcChaChiHpmR(2,6,2),cplcFdFdVPL(3,3),cplcFdFdVPR(3,3),cplcFuFdcHpmL(3,3,2),          & 
...
& cplhhHpmcVWm(3,2),cplhhcHpmVWm(3,2),cplHpmSucSd(2,6,6),cplHpmSvcSe(2,3,6),             & 
& cplHpmcHpmVP(2,2),cplHpmcVWmVP(2),cplHpmcHpmVZ(2,2),cplHpmcVWmVZ(2),cplHpmcHpmVZp(2,2),& 
& cplHpmcVWmVZp(2),cplSdcSdVP(6,6),cplSdcHpmcSu(6,2,6),cplSecSeVP(6,6),cplSecHpmcSv(6,2,3),& 
& cplSucSuVP(6,6),cplcHpmVPVWm(2),cplcVWmVPVWm,cplcHpmVWmVZ(2),cplcHpmVWmVZp(2),         & 
& cplAhHpmcVWmVP1(3,2),cplAhcHpmVPVWm1(3,2),cplhhHpmcVWmVP1(3,2),cplhhcHpmVPVWm1(3,2),   & 
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_HpmToHpmVP


Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmToHpmVP(MAh,MCha,MChi,MFd,MFe,             & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmToHpmVP


Subroutine Amplitude_WAVE_NonUMSSM_HpmToVPVWm(cplcHpmVPVWm,cplcHpmVWmVZ,              & 
& cplcHpmVWmVZp,ctcplcHpmVPVWm,ctcplcHpmVWmVZ,ctcplcHpmVWmVZp,MHpm,MHpm2,MVP,            & 
...
Amp(:,gt1) = AmpC 
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_HpmToVPVWm


Subroutine Amplitude_VERTEX_NonUMSSM_HpmToVPVWm(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhHpmcHpm,           & 
...
Complex(dp), Intent(in) :: cplAhHpmcHpm(3,2,2),cplAhcHpmVWm(3,2),cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),    & 
& cplcChaChaVPL(2,2),cplcChaChaVPR(2,2),cplcChaChiVWmL(2,6),cplcChaChiVWmR(2,6),         & 
...
& cplcgWmgZpVWm,cplcgWpCgZpcHpm(2),cplhhHpmcHpm(3,2,2),cplhhcHpmVWm(3,2),cplhhcVWmVWm(3),& 
...
& cplSucSdVWm(6,6),cplSvcSeVWm(3,6),cplcHpmVPVWm(2),cplcVWmVPVWm,cplcHpmVWmVZ(2),        & 
& cplcVWmVWmVZ,cplcHpmVWmVZp(2),cplcVWmVWmVZp,cplAhcHpmVPVWm1(3,2),cplhhcHpmVPVWm1(3,2), & 
& cplHpmcHpmVPVP1(2,2),cplHpmcHpmVPVZ1(2,2),cplHpmcHpmVPVZp1(2,2),cplHpmcHpmcVWmVWm1(2,2),& 
& cplSucSdVPVWmaa(6,6),cplSvcSeVPVWm1(3,6),cplcVWmVPVPVWm3Q,cplcVWmVPVPVWm1Q,            & 
& cplcVWmVPVPVWm2Q,cplcVWmVPVWmVZ3Q,cplcVWmVPVWmVZ2Q,cplcVWmVPVWmVZ1Q,cplcVWmVPVWmVZp3Q, & 
...
End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_HpmToVPVWm


Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmToVPVWm(MAh,MCha,MChi,MFd,MFe,             & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhHpmcHpm,      & 
& cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,cplcChaChaVPL,cplcChaChaVPR,cplcChaChiVWmL, & 
& cplcChaChiVWmR,cplcFdFdVPL,cplcFdFdVPR,cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFeFeVPL,        & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_HpmToVPVWm



End Module OneLoopDecay_Hpm_NonUMSSM
