...
Module Wrapper_OneLoopDecay_Su_NonUMSSM
Use Model_Data_NonUMSSM 
Use Kinematics 
Use OneLoopDecay_Su_NonUMSSM 
Use Control 
Use Settings 
...
Subroutine OneLoopDecay_Su(MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,MFv2OS,MSuOS,              & 
...
& ZfFUR,ZfVPVZ,ZfVZVP,ZfVPVZp,ZfVZpVP,ZfVZVZp,ZfVZpVZ,cplAhAhhh,cplAhAhSucSuaa,          & 
& cplAhcHpmVWm,cplAhhhSucSuaa,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,            & 
...
Complex(dp),Intent(in) :: cplAhAhhh(3,3,3),cplAhAhSucSuaa(3,3,6,6),cplAhcHpmVWm(3,2),cplAhhhSucSuaa(3,3,6,6),   & 
...
Complex(dp),Intent(in) :: cplSucSuVGVPLamct3ct2ct1(6,6),cplSucSuVGVZLamct3ct2ct1(6,6),cplSucSuVGVZpLamct3ct2ct1(6,6),& 
...
& cplSuSvcSucSvaa(6,3,6,3),cplVGVGVG,ctcplAhSucSu(3,6,6),ctcplcChaFdcSuL(2,3,6),         & 
& ctcplcChaFdcSuR(2,3,6),ctcplChiFucSuL(6,3,6),ctcplChiFucSuR(6,3,6),ctcplGluFucSuL(3,6),& 
& ctcplGluFucSuR(3,6),ctcplhhSucSu(3,6,6),ctcplSdcHpmcSu(6,2,6),ctcplSdcSucVWm(6,6),     & 
...
& ZcplChiFucSuL(6,3,6),ZcplChiFucSuR(6,3,6),ZcplGluFucSuL(3,6),ZcplGluFucSuR(3,6),       & 
...
Real(dp) :: MRPSuToFuChi(6,3,6),MRGSuToFuChi(6,3,6), MRPZSuToFuChi(6,3,6),MRGZSuToFuChi(6,3,6) 
Real(dp) :: MVPSuToFuChi(6,3,6) 
Real(dp) :: RMsqTreeSuToFuChi(6,3,6),RMsqWaveSuToFuChi(6,3,6),RMsqVertexSuToFuChi(6,3,6) 
Complex(dp) :: AmpTreeSuToFuChi(2,6,3,6),AmpWaveSuToFuChi(2,6,3,6)=(0._dp,0._dp),AmpVertexSuToFuChi(2,6,3,6)& 
 & ,AmpVertexIRosSuToFuChi(2,6,3,6),AmpVertexIRdrSuToFuChi(2,6,3,6), AmpSumSuToFuChi(2,6,3,6), AmpSum2SuToFuChi(2,6,3,6) 
Complex(dp) :: AmpTreeZSuToFuChi(2,6,3,6),AmpWaveZSuToFuChi(2,6,3,6),AmpVertexZSuToFuChi(2,6,3,6) 
Real(dp) :: AmpSqSuToFuChi(6,3,6),  AmpSqTreeSuToFuChi(6,3,6) 
...
Call Amplitude_Tree_NonUMSSM_SuToSuAh(cplAhSucSu,MAh,MSu,MAh2,MSu2,AmpTreeSuToSuAh)

  Else 
Call Amplitude_Tree_NonUMSSM_SuToSuAh(ZcplAhSucSu,MAh,MSu,MAh2,MSu2,AmpTreeSuToSuAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_SuToSuAh(MLambda,em,gs,cplAhSucSu,MAhOS,MSuOS,               & 
& MRPSuToSuAh,MRGSuToSuAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_SuToSuAh(MLambda,em,gs,ZcplAhSucSu,MAhOS,MSuOS,              & 
& MRPSuToSuAh,MRGSuToSuAh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NonUMSSM_SuToSuAh(MLambda,em,gs,cplAhSucSu,MAh,MSu,MRPSuToSuAh,       & 
& MRGSuToSuAh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NonUMSSM_SuToSuAh(MLambda,em,gs,ZcplAhSucSu,MAh,MSu,MRPSuToSuAh,      & 
& MRGSuToSuAh)
...
Call Amplitude_WAVE_NonUMSSM_SuToSuAh(cplAhSucSu,ctcplAhSucSu,MAh,MAh2,               & 
& MSu,MSu2,ZfAh,ZfSu,AmpWaveSuToSuAh)



!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SuToSuAh(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_SuToSuAh(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSe,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
& Mhh2,MHpm2,MSd2,MSe2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,cplcChaChaAhL,          & 
& cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,           & 
& cplcFuFuAhR,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSecSe,      & 
...
& cplSdSucSdcSuabab,cplSeSucSecSuaa,cplSuSucSucSuabba,cplSuSucSucSuabab,AmpVertexIRdrSuToSuAh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_SuToSuAh(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,           & 
...
& cplSuSucSucSuabab,AmpVertexIRosSuToSuAh)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_SuToFuChi(cplChiFucSuL,cplChiFucSuR,MChi,MFu,            & 
& MSu,MChi2,MFu2,MSu2,AmpTreeSuToFuChi)

  Else 
Call Amplitude_Tree_NonUMSSM_SuToFuChi(ZcplChiFucSuL,ZcplChiFucSuR,MChi,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_SuToFuChi(MLambda,em,gs,cplChiFucSuL,cplChiFucSuR,           & 
& MChiOS,MFuOS,MSuOS,MRPSuToFuChi,MRGSuToFuChi)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_SuToFuChi(MLambda,em,gs,ZcplChiFucSuL,ZcplChiFucSuR,         & 
& MChiOS,MFuOS,MSuOS,MRPSuToFuChi,MRGSuToFuChi)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_SuToFuChi(cplChiFucSuL,cplChiFucSuR,ctcplChiFucSuL,      & 
& ctcplChiFucSuR,MChi,MChi2,MFu,MFu2,MSu,MSu2,ZfFUL,ZfFUR,ZfL0,ZfSu,AmpWaveSuToFuChi)



!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SuToFuChi(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_SuToFuChi(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
...
& cplSucSuVG,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,AmpVertexIRdrSuToFuChi)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_SuToFuChi(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_SuTocChaFd(cplcChaFdcSuL,cplcChaFdcSuR,MCha,             & 
& MFd,MSu,MCha2,MFd2,MSu2,AmpTreeSuTocChaFd)

  Else 
Call Amplitude_Tree_NonUMSSM_SuTocChaFd(ZcplcChaFdcSuL,ZcplcChaFdcSuR,MCha,           & 
& MFd,MSu,MCha2,MFd2,MSu2,AmpTreeSuTocChaFd)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_SuTocChaFd(MLambda,em,gs,cplcChaFdcSuL,cplcChaFdcSuR,        & 
& MChaOS,MFdOS,MSuOS,MRPSuTocChaFd,MRGSuTocChaFd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_SuTocChaFd(MLambda,em,gs,ZcplcChaFdcSuL,ZcplcChaFdcSuR,      & 
& MChaOS,MFdOS,MSuOS,MRPSuTocChaFd,MRGSuTocChaFd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_SuTocChaFd(cplcChaFdcSuL,cplcChaFdcSuR,ctcplcChaFdcSuL,  & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SuTocChaFd(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,             & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_SuTocChaFd(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
& cplSucSuVZp,AmpVertexIRdrSuTocChaFd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_SuTocChaFd(MAhOS,MChaOS,MChiOS,MFdOS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_SuToGluFu(cplGluFucSuL,cplGluFucSuR,MFu,MGlu,            & 
& MSu,MFu2,MGlu2,MSu2,AmpTreeSuToGluFu)

  Else 
Call Amplitude_Tree_NonUMSSM_SuToGluFu(ZcplGluFucSuL,ZcplGluFucSuR,MFu,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_SuToGluFu(MLambda,em,gs,cplGluFucSuL,cplGluFucSuR,           & 
& MFuOS,MGluOS,MSuOS,MRPSuToGluFu,MRGSuToGluFu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_SuToGluFu(MLambda,em,gs,ZcplGluFucSuL,ZcplGluFucSuR,         & 
& MFuOS,MGluOS,MSuOS,MRPSuToGluFu,MRGSuToGluFu)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_SuToGluFu(cplGluFucSuL,cplGluFucSuR,ctcplGluFucSuL,      & 
& ctcplGluFucSuR,MFu,MFu2,MGlu,MGlu2,MSu,MSu2,ZffG,ZfFUL,ZfFUR,ZfSu,AmpWaveSuToGluFu)



!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SuToGluFu(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,              & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_SuToGluFu(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
& cplSucSuVZ,cplSucSuVZp,AmpVertexIRdrSuToGluFu)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_SuToGluFu(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,          & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
& cplSdcSucVWm,cplSucSuVG,cplSucSuVP,cplSucSuVZ,cplSucSuVZp,AmpVertexIRosSuToGluFu)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_SuToSuhh(cplhhSucSu,Mhh,MSu,Mhh2,MSu2,AmpTreeSuToSuhh)

  Else 
Call Amplitude_Tree_NonUMSSM_SuToSuhh(ZcplhhSucSu,Mhh,MSu,Mhh2,MSu2,AmpTreeSuToSuhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_SuToSuhh(MLambda,em,gs,cplhhSucSu,MhhOS,MSuOS,               & 
& MRPSuToSuhh,MRGSuToSuhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_SuToSuhh(MLambda,em,gs,ZcplhhSucSu,MhhOS,MSuOS,              & 
& MRPSuToSuhh,MRGSuToSuhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NonUMSSM_SuToSuhh(MLambda,em,gs,cplhhSucSu,Mhh,MSu,MRPSuToSuhh,       & 
& MRGSuToSuhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NonUMSSM_SuToSuhh(MLambda,em,gs,ZcplhhSucSu,Mhh,MSu,MRPSuToSuhh,      & 
& MRGSuToSuhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_SuToSuhh(cplhhSucSu,ctcplhhSucSu,Mhh,Mhh2,               & 
& MSu,MSu2,Zfhh,ZfSu,AmpWaveSuToSuhh)



!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SuToSuhh(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
...
& cplSucSucVWmVWmaa,cplSucSuVZVZaa,cplSucSuVZVZpaa,cplSucSuVZpVZpaa,AmpVertexSuToSuhh)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_SuToSuhh(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSe,MSu,MSv,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,           & 
& Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,cplAhhhVZ,         & 
& cplAhhhVZp,cplAhSucSu,cplcChaChahhL,cplcChaChahhR,cplcFdChaSuL,cplcFdChaSuR,           & 
& cplChiChihhL,cplChiChihhR,cplChiFucSuL,cplChiFucSuR,cplcFuChiSuL,cplcFuChiSuR,         & 
...
& cplhhhhSucSuaa,cplhhHpmSucSdaa,cplhhSdcHpmcSuaa,cplHpmSucHpmcSuaa,cplSdSucSdcSuabba,   & 
& cplSdSucSdcSuabab,cplSeSucSecSuaa,cplSuSucSucSuabba,cplSuSucSucSuabab,cplSuSvcSucSvaa, & 
& cplSucSucVWmVWmaa,cplSucSuVZVZaa,cplSucSuVZVZpaa,cplSucSuVZpVZpaa,AmpVertexIRdrSuToSuhh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_SuToSuhh(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,           & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_SuTocHpmSd(cplSdcHpmcSu,MHpm,MSd,MSu,MHpm2,              & 
& MSd2,MSu2,AmpTreeSuTocHpmSd)

  Else 
Call Amplitude_Tree_NonUMSSM_SuTocHpmSd(ZcplSdcHpmcSu,MHpm,MSd,MSu,MHpm2,             & 
& MSd2,MSu2,AmpTreeSuTocHpmSd)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_SuTocHpmSd(MLambda,em,gs,cplSdcHpmcSu,MHpmOS,MSdOS,          & 
& MSuOS,MRPSuTocHpmSd,MRGSuTocHpmSd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_SuTocHpmSd(MLambda,em,gs,ZcplSdcHpmcSu,MHpmOS,               & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NonUMSSM_SuTocHpmSd(MLambda,em,gs,cplSdcHpmcSu,MHpm,MSd,              & 
& MSu,MRPSuTocHpmSd,MRGSuTocHpmSd)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NonUMSSM_SuTocHpmSd(MLambda,em,gs,ZcplSdcHpmcSu,MHpm,MSd,             & 
& MSu,MRPSuTocHpmSd,MRGSuTocHpmSd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_SuTocHpmSd(cplSdcHpmcSu,ctcplSdcHpmcSu,MHpm,             & 
& MHpm2,MSd,MSd2,MSu,MSu2,ZfHpm,ZfSd,ZfSu,AmpWaveSuTocHpmSd)



!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SuTocHpmSd(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,             & 
& MHpm,MSd,MSe,MSu,MSv,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,           & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_SuTocHpmSd(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
...
& cplSdSvcSecSuaa,cplSdcSucVWmVPaa,cplSdcSucVWmVZaa,cplSdcSucVWmVZpaa,AmpVertexIRdrSuTocHpmSd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_SuTocHpmSd(MAhOS,MChaOS,MChiOS,MFdOS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_SuToSdcVWm(cplSdcSucVWm,MSd,MSu,MVWm,MSd2,               & 
& MSu2,MVWm2,AmpTreeSuToSdcVWm)

  Else 
Call Amplitude_Tree_NonUMSSM_SuToSdcVWm(ZcplSdcSucVWm,MSd,MSu,MVWm,MSd2,              & 
& MSu2,MVWm2,AmpTreeSuToSdcVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_SuToSdcVWm(MLambda,em,gs,cplSdcSucVWm,MSdOS,MSuOS,           & 
& MVWmOS,MRPSuToSdcVWm,MRGSuToSdcVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_SuToSdcVWm(MLambda,em,gs,ZcplSdcSucVWm,MSdOS,MSuOS,          & 
& MVWmOS,MRPSuToSdcVWm,MRGSuToSdcVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NonUMSSM_SuToSdcVWm(MLambda,em,gs,cplSdcSucVWm,MSd,MSu,               & 
& MVWm,MRPSuToSdcVWm,MRGSuToSdcVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NonUMSSM_SuToSdcVWm(MLambda,em,gs,ZcplSdcSucVWm,MSd,MSu,              & 
& MVWm,MRPSuToSdcVWm,MRGSuToSdcVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_SuToSdcVWm(cplSdcSucVWm,ctcplSdcSucVWm,MSd,              & 
& MSd2,MSu,MSu2,MVWm,MVWm2,ZfSd,ZfSu,ZfVWm,AmpWaveSuToSdcVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SuToSdcVWm(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,             & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_SuToSdcVWm(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
& cplSdcSucVWmVZpaa,cplSucSucVWmVWmaa,AmpVertexIRdrSuToSdcVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_SuToSdcVWm(MAhOS,MChaOS,MChiOS,MFdOS,               & 
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,              & 
& MCha2OS,MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_SuToSuVZ(cplSucSuVZ,MSu,MVZ,MSu2,MVZ2,AmpTreeSuToSuVZ)

  Else 
Call Amplitude_Tree_NonUMSSM_SuToSuVZ(ZcplSucSuVZ,MSu,MVZ,MSu2,MVZ2,AmpTreeSuToSuVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_SuToSuVZ(MLambda,em,gs,cplSucSuVZ,MSuOS,MVZOS,               & 
& MRPSuToSuVZ,MRGSuToSuVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_SuToSuVZ(MLambda,em,gs,ZcplSucSuVZ,MSuOS,MVZOS,              & 
& MRPSuToSuVZ,MRGSuToSuVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NonUMSSM_SuToSuVZ(MLambda,em,gs,cplSucSuVZ,MSu,MVZ,MRPSuToSuVZ,       & 
& MRGSuToSuVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NonUMSSM_SuToSuVZ(MLambda,em,gs,ZcplSucSuVZ,MSu,MVZ,MRPSuToSuVZ,      & 
& MRGSuToSuVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_SuToSuVZ(cplSucSuVP,cplSucSuVZ,cplSucSuVZp,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SuToSuVZ(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_SuToSuVZ(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhhhVZ,cplAhSucSu,cplcFdChaSuL,          & 
& cplcFdChaSuR,cplcChaChaVZL,cplcChaChaVZR,cplChiChiVZL,cplChiChiVZR,cplChiFucSuL,       & 
& cplChiFucSuR,cplcFuChiSuL,cplcFuChiSuR,cplcFdFdVZL,cplcFdFdVZR,cplcChaFdcSuL,          & 
...
& cplSucSuVPVZaa,cplSucSdVWmVZaa,cplSucSuVZVZaa,cplSucSuVZVZpaa,AmpVertexIRdrSuToSuVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_SuToSuVZ(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,           & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_SuToSuVZp(cplSucSuVZp,MSu,MVZp,MSu2,MVZp2,               & 
& AmpTreeSuToSuVZp)

  Else 
Call Amplitude_Tree_NonUMSSM_SuToSuVZp(ZcplSucSuVZp,MSu,MVZp,MSu2,MVZp2,              & 
& AmpTreeSuToSuVZp)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_SuToSuVZp(MLambda,em,gs,cplSucSuVZp,MSuOS,MVZpOS,            & 
& MRPSuToSuVZp,MRGSuToSuVZp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_SuToSuVZp(MLambda,em,gs,ZcplSucSuVZp,MSuOS,MVZpOS,           & 
& MRPSuToSuVZp,MRGSuToSuVZp)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NonUMSSM_SuToSuVZp(MLambda,em,gs,cplSucSuVZp,MSu,MVZp,MRPSuToSuVZp,   & 
& MRGSuToSuVZp)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NonUMSSM_SuToSuVZp(MLambda,em,gs,ZcplSucSuVZp,MSu,MVZp,               & 
& MRPSuToSuVZp,MRGSuToSuVZp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_SuToSuVZp(cplSucSuVP,cplSucSuVZ,cplSucSuVZp,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SuToSuVZp(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,              & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_SuToSuVZp(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
& cplSucSuVZpVZpaa,AmpVertexIRdrSuToSuVZp)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_SuToSuVZp(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,          & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
& MVZ2OS,MVZp2OS,cplAhhhVZp,cplAhSucSu,cplcFdChaSuL,cplcFdChaSuR,cplcChaChaVZpL,         & 
& cplcChaChaVZpR,cplChiChiVZpL,cplChiChiVZpR,cplChiFucSuL,cplChiFucSuR,cplcFuChiSuL,     & 
& cplcFuChiSuR,cplcFdFdVZpL,cplcFdFdVZpR,cplcChaFdcSuL,cplcChaFdcSuR,cplGluFucSuL,       & 
& cplGluFucSuR,cplcFuFuVZpL,cplcFuFuVZpR,cplcFuGluSuL,cplcFuGluSuR,cplhhSucSu,           & 
& cplhhVZVZp,cplhhVZpVZp,cplHpmSucSd,cplHpmcHpmVZp,cplHpmcVWmVZp,cplSdcSdVZp,            & 
& cplSdcHpmcSu,cplSdcSucVWm,cplSucSuVG,cplSucSuVP,cplSucSdVWm,cplSucSuVZ,ZcplSucSuVZp,   & 
& cplcHpmVWmVZp,cplcVWmVWmVZp,cplSdcSucVWmVZpaa,cplSucSuVGVZpLamct3ct2ct1,               & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_NonUMSSM_SuToSuVG(cplSucSuVG,ctcplSucSuVG,MSuOS,MSu2OS,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NonUMSSM_SuToSuVG(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,              & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_SuToSuVG(cplSucSuVG,ctcplSucSuVG,MSu,MSu2,               & 
& MVG,MVG2,ZfSu,ZfVG,AmpWaveSuToSuVG)



!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SuToSuVG(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_NonUMSSM_SuToSuVP(cplSucSuVP,cplSucSuVZ,cplSucSuVZp,              & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NonUMSSM_SuToSuVP(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,              & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SuToSuVP(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhSucSu,cplcFdChaSuL,cplcFdChaSuR,       & 
...
End Module Wrapper_OneLoopDecay_Su_NonUMSSM
