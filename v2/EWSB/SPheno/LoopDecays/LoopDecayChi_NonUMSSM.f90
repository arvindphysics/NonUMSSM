...
! ------------------------------------------------------------------------------  
! File created at 0:32 on 10.2.2021   
! ----------------------------------------------------------------------  
 
 
Module OneLoopDecay_Chi_NonUMSSM
Use Control 
Use Settings 
Use LoopFunctions 
...
Subroutine Amplitude_Tree_NonUMSSM_ChiToChiAh(cplChiChiAhL,cplChiChiAhR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_ChiToChiAh


Subroutine Gamma_Real_NonUMSSM_ChiToChiAh(MLambda,em,gs,cplChiChiAhL,cplChiChiAhR,    & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_ChiToChiAh


Subroutine Amplitude_WAVE_NonUMSSM_ChiToChiAh(cplChiChiAhL,cplChiChiAhR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChiToChiAh


Subroutine Amplitude_VERTEX_NonUMSSM_ChiToChiAh(MAh,MCha,MChi,MFd,MFe,MFu,            & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChiToChiAh


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToChiAh(MAh,MCha,MChi,MFd,MFe,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToChiAh


Subroutine Amplitude_Tree_NonUMSSM_ChiToChacHpm(cplChiChacHpmL,cplChiChacHpmR,        & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_ChiToChacHpm


Subroutine Gamma_Real_NonUMSSM_ChiToChacHpm(MLambda,em,gs,cplChiChacHpmL,             & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_ChiToChacHpm


Subroutine Amplitude_WAVE_NonUMSSM_ChiToChacHpm(cplChiChacHpmL,cplChiChacHpmR,        & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChiToChacHpm


Subroutine Amplitude_VERTEX_NonUMSSM_ChiToChacHpm(MAh,MCha,MChi,MFd,MFe,              & 
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChiToChacHpm


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToChacHpm(MAh,MCha,MChi,MFd,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToChacHpm


Subroutine Amplitude_Tree_NonUMSSM_ChiToChacVWm(cplChiChacVWmL,cplChiChacVWmR,        & 
& MCha,MChi,MVWm,MCha2,MChi2,MVWm2,Amp)

Implicit None

Real(dp), Intent(in) :: MCha(2),MChi(6),MVWm,MCha2(2),MChi2(6),MVWm2

Complex(dp), Intent(in) :: cplChiChacVWmL(6,2),cplChiChacVWmR(6,2)

Complex(dp) :: Amp(4,6,2) 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_ChiToChacVWm


Subroutine Gamma_Real_NonUMSSM_ChiToChacVWm(MLambda,em,gs,cplChiChacVWmL,             & 
...
Real(dp), Intent(in) :: MCha(2),MChi(6),MVWm
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_ChiToChacVWm


Subroutine Amplitude_WAVE_NonUMSSM_ChiToChacVWm(cplChiChacVWmL,cplChiChacVWmR,        & 
& ctcplChiChacVWmL,ctcplChiChacVWmR,MCha,MCha2,MChi,MChi2,MVWm,MVWm2,ZfL0,               & 
& ZfLm,ZfLp,ZfVWm,Amp)

Implicit None

Real(dp), Intent(in) :: MCha(2),MCha2(2),MChi(6),MChi2(6),MVWm,MVWm2

Complex(dp), Intent(in) :: cplChiChacVWmL(6,2),cplChiChacVWmR(6,2)

Complex(dp), Intent(in) :: ctcplChiChacVWmL(6,2),ctcplChiChacVWmR(6,2)

Complex(dp), Intent(in) :: ZfL0(6,6),ZfLm(2,2),ZfLp(2,2),ZfVWm

Complex(dp), Intent(out) :: Amp(4,6,2) 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChiToChacVWm


Subroutine Amplitude_VERTEX_NonUMSSM_ChiToChacVWm(MAh,MCha,MChi,MFd,MFe,              & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,     & 
...
Complex(dp), Intent(in) :: cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),cplChiChiAhL(6,6,3),cplChiChiAhR(6,6,3),    & 
& cplAhHpmcVWm(3,2),cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),cplChiChacVWmL(6,2),     & 
...
& cplcChaChaVZpR(2,2),cplChiChihhL(6,6,3),cplChiChihhR(6,6,3),cplChiChiVZL(6,6),         & 
& cplChiChiVZR(6,6),cplChiChiVZpL(6,6),cplChiChiVZpR(6,6),cplChiFdcSdL(6,3,6),           & 
& cplChiFdcSdR(6,3,6),cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6),cplChiFucSuL(6,3,6),       & 
& cplChiFucSuR(6,3,6),cplChiFvcSvL(6,3,3),cplChiFvcSvR(6,3,3),cplcChaChiHpmL(2,6,2),     & 
& cplcChaChiHpmR(2,6,2),cplcFdChiSdL(3,6,6),cplcFdChiSdR(3,6,6),cplcFeChiSeL(3,6,6),     & 
& cplcFeChiSeR(3,6,6),cplcFuChiSuL(3,6,6),cplcFuChiSuR(3,6,6),cplcFvChiSvL(3,6,3),       & 
& cplcFvChiSvR(3,6,3),cplcChaChiVWmL(2,6),cplcChaChiVWmR(2,6),cplcFuFdcVWmL(3,3),        & 
& cplcFuFdcVWmR(3,3),cplcFvFecVWmL(3,3),cplcFvFecVWmR(3,3),cplhhHpmcVWm(3,2),            & 
& cplhhcVWmVWm(3),cplHpmcVWmVP(2),cplHpmcVWmVZ(2),cplHpmcVWmVZp(2),cplSdcSucVWm(6,6),    & 
& cplSecSvcVWm(6,3),cplcVWmVPVWm,cplcVWmVWmVZ,cplcVWmVWmVZp
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChiToChacVWm


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToChacVWm(MAh,MCha,MChi,MFd,               & 
& MFe,MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,               & 
& MFd2,MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToChacVWm


Subroutine Amplitude_Tree_NonUMSSM_ChiToChihh(cplChiChihhL,cplChiChihhR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_ChiToChihh


Subroutine Gamma_Real_NonUMSSM_ChiToChihh(MLambda,em,gs,cplChiChihhL,cplChiChihhR,    & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_ChiToChihh


Subroutine Amplitude_WAVE_NonUMSSM_ChiToChihh(cplChiChihhL,cplChiChihhR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChiToChihh


Subroutine Amplitude_VERTEX_NonUMSSM_ChiToChihh(MAh,MCha,MChi,MFd,MFe,MFu,            & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChiToChihh


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToChihh(MAh,MCha,MChi,MFd,MFe,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToChihh


Subroutine Amplitude_Tree_NonUMSSM_ChiToChiVZ(cplChiChiVZL,cplChiChiVZR,              & 
& MChi,MVZ,MChi2,MVZ2,Amp)

Implicit None

Real(dp), Intent(in) :: MChi(6),MVZ,MChi2(6),MVZ2

Complex(dp), Intent(in) :: cplChiChiVZL(6,6),cplChiChiVZR(6,6)
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_ChiToChiVZ


Subroutine Gamma_Real_NonUMSSM_ChiToChiVZ(MLambda,em,gs,cplChiChiVZL,cplChiChiVZR,    & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_ChiToChiVZ


Subroutine Amplitude_WAVE_NonUMSSM_ChiToChiVZ(cplChiChiVZL,cplChiChiVZR,              & 
...
Real(dp), Intent(in) :: MChi(6),MChi2(6),MVZ,MVZ2

Complex(dp), Intent(in) :: cplChiChiVZL(6,6),cplChiChiVZR(6,6),cplChiChiVZpL(6,6),cplChiChiVZpR(6,6)

Complex(dp), Intent(in) :: ctcplChiChiVZL(6,6),ctcplChiChiVZR(6,6),ctcplChiChiVZpL(6,6),ctcplChiChiVZpR(6,6)

Complex(dp), Intent(in) :: ZfL0(6,6),ZfVZ,ZfVZpVZ
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChiToChiVZ


Subroutine Amplitude_VERTEX_NonUMSSM_ChiToChiVZ(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            & 
...
Complex(dp), Intent(in) :: cplChiChiAhL(6,6,3),cplChiChiAhR(6,6,3),cplAhhhVZ(3,3),cplChiChacHpmL(6,2,2),         & 
& cplChiChacHpmR(6,2,2),cplChiChacVWmL(6,2),cplChiChacVWmR(6,2),cplcChaChaVZL(2,2),      & 
& cplcChaChaVZR(2,2),cplChiChihhL(6,6,3),cplChiChihhR(6,6,3),cplChiChiVZL(6,6),          & 
& cplChiChiVZR(6,6),cplChiChiVZpL(6,6),cplChiChiVZpR(6,6),cplChiFdcSdL(6,3,6),           & 
& cplChiFdcSdR(6,3,6),cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6),cplChiFucSuL(6,3,6),       & 
& cplChiFucSuR(6,3,6),cplChiFvcSvL(6,3,3),cplChiFvcSvR(6,3,3),cplcChaChiHpmL(2,6,2),     & 
& cplcChaChiHpmR(2,6,2),cplcFdChiSdL(3,6,6),cplcFdChiSdR(3,6,6),cplcFeChiSeL(3,6,6),     & 
& cplcFeChiSeR(3,6,6),cplcFuChiSuL(3,6,6),cplcFuChiSuR(3,6,6),cplcFvChiSvL(3,6,3),       & 
& cplcFvChiSvR(3,6,3),cplcChaChiVWmL(2,6),cplcChaChiVWmR(2,6),cplcFdFdVZL(3,3),          & 
& cplcFdFdVZR(3,3),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),  & 
& cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplhhVZVZ(3),cplhhVZVZp(3),cplHpmcHpmVZ(2,2),        & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChiToChiVZ


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToChiVZ(MAh,MCha,MChi,MFd,MFe,             & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToChiVZ


Subroutine Amplitude_Tree_NonUMSSM_ChiToChiVZp(cplChiChiVZpL,cplChiChiVZpR,           & 
& MChi,MVZp,MChi2,MVZp2,Amp)

Implicit None

Real(dp), Intent(in) :: MChi(6),MVZp,MChi2(6),MVZp2

Complex(dp), Intent(in) :: cplChiChiVZpL(6,6),cplChiChiVZpR(6,6)
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_ChiToChiVZp


Subroutine Gamma_Real_NonUMSSM_ChiToChiVZp(MLambda,em,gs,cplChiChiVZpL,               & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_ChiToChiVZp


Subroutine Amplitude_WAVE_NonUMSSM_ChiToChiVZp(cplChiChiVZL,cplChiChiVZR,             & 
& cplChiChiVZpL,cplChiChiVZpR,ctcplChiChiVZL,ctcplChiChiVZR,ctcplChiChiVZpL,             & 
& ctcplChiChiVZpR,MChi,MChi2,MVZ,MVZ2,MVZp,MVZp2,ZfL0,ZfVZp,ZfVZVZp,Amp)

Implicit None

Real(dp), Intent(in) :: MChi(6),MChi2(6),MVZ,MVZ2,MVZp,MVZp2

Complex(dp), Intent(in) :: cplChiChiVZL(6,6),cplChiChiVZR(6,6),cplChiChiVZpL(6,6),cplChiChiVZpR(6,6)

Complex(dp), Intent(in) :: ctcplChiChiVZL(6,6),ctcplChiChiVZR(6,6),ctcplChiChiVZpL(6,6),ctcplChiChiVZpR(6,6)

Complex(dp), Intent(in) :: ZfL0(6,6),ZfVZp,ZfVZVZp
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChiToChiVZp


Subroutine Amplitude_VERTEX_NonUMSSM_ChiToChiVZp(MAh,MCha,MChi,MFd,MFe,               & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVWm2,MVZ2,MVZp2,cplChiChiAhL,cplChiChiAhR,   & 
...
Complex(dp), Intent(in) :: cplChiChiAhL(6,6,3),cplChiChiAhR(6,6,3),cplAhhhVZp(3,3),cplChiChacHpmL(6,2,2),        & 
& cplChiChacHpmR(6,2,2),cplChiChacVWmL(6,2),cplChiChacVWmR(6,2),cplcChaChaVZpL(2,2),     & 
& cplcChaChaVZpR(2,2),cplChiChihhL(6,6,3),cplChiChihhR(6,6,3),cplChiChiVZL(6,6),         & 
& cplChiChiVZR(6,6),cplChiChiVZpL(6,6),cplChiChiVZpR(6,6),cplChiFdcSdL(6,3,6),           & 
& cplChiFdcSdR(6,3,6),cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6),cplChiFucSuL(6,3,6),       & 
& cplChiFucSuR(6,3,6),cplChiFvcSvL(6,3,3),cplChiFvcSvR(6,3,3),cplcChaChiHpmL(2,6,2),     & 
& cplcChaChiHpmR(2,6,2),cplcFdChiSdL(3,6,6),cplcFdChiSdR(3,6,6),cplcFeChiSeL(3,6,6),     & 
& cplcFeChiSeR(3,6,6),cplcFuChiSuL(3,6,6),cplcFuChiSuR(3,6,6),cplcFvChiSvL(3,6,3),       & 
& cplcFvChiSvR(3,6,3),cplcChaChiVWmL(2,6),cplcChaChiVWmR(2,6),cplcFdFdVZpL(3,3),         & 
& cplcFdFdVZpR(3,3),cplcFeFeVZpL(3,3),cplcFeFeVZpR(3,3),cplcFuFuVZpL(3,3),               & 
& cplcFuFuVZpR(3,3),cplcFvFvVZpL(3,3),cplcFvFvVZpR(3,3),cplhhVZVZp(3),cplhhVZpVZp(3),    & 
& cplHpmcHpmVZp(2,2),cplHpmcVWmVZp(2),cplSdcSdVZp(6,6),cplSecSeVZp(6,6),cplSucSuVZp(6,6),& 
& cplSvcSvVZp(3,3),cplcHpmVWmVZp(2),cplcVWmVWmVZp
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChiToChiVZp


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToChiVZp(MAh,MCha,MChi,MFd,MFe,            & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVWm2,MVZ2,MVZp2,cplChiChiAhL,cplChiChiAhR,   & 
& cplAhhhVZp,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,cplcChaChaVZpL, & 
& cplcChaChaVZpR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZR,cplChiChiVZpL,      & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToChiVZp


Subroutine Amplitude_Tree_NonUMSSM_ChiToFdcSd(cplChiFdcSdL,cplChiFdcSdR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_ChiToFdcSd


Subroutine Gamma_Real_NonUMSSM_ChiToFdcSd(MLambda,em,gs,cplChiFdcSdL,cplChiFdcSdR,    & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_ChiToFdcSd


Subroutine Amplitude_WAVE_NonUMSSM_ChiToFdcSd(cplChiFdcSdL,cplChiFdcSdR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChiToFdcSd


Subroutine Amplitude_VERTEX_NonUMSSM_ChiToFdcSd(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChiToFdcSd


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToFdcSd(MAh,MCha,MChi,MFd,MFu,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToFdcSd


Subroutine Amplitude_Tree_NonUMSSM_ChiToFecSe(cplChiFecSeL,cplChiFecSeR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_ChiToFecSe


Subroutine Gamma_Real_NonUMSSM_ChiToFecSe(MLambda,em,gs,cplChiFecSeL,cplChiFecSeR,    & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_ChiToFecSe


Subroutine Amplitude_WAVE_NonUMSSM_ChiToFecSe(cplChiFecSeL,cplChiFecSeR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChiToFecSe


Subroutine Amplitude_VERTEX_NonUMSSM_ChiToFecSe(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChiToFecSe


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToFecSe(MAh,MCha,MChi,MFe,MFv,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToFecSe


Subroutine Amplitude_Tree_NonUMSSM_ChiToFucSu(cplChiFucSuL,cplChiFucSuR,              & 
& MChi,MFu,MSu,MChi2,MFu2,MSu2,Amp)

Implicit None

Real(dp), Intent(in) :: MChi(6),MFu(3),MSu(6),MChi2(6),MFu2(3),MSu2(6)

Complex(dp), Intent(in) :: cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_ChiToFucSu


Subroutine Gamma_Real_NonUMSSM_ChiToFucSu(MLambda,em,gs,cplChiFucSuL,cplChiFucSuR,    & 
...
Real(dp), Intent(in) :: MChi(6),MFu(3),MSu(6)
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_ChiToFucSu


Subroutine Amplitude_WAVE_NonUMSSM_ChiToFucSu(cplChiFucSuL,cplChiFucSuR,              & 
& ctcplChiFucSuL,ctcplChiFucSuR,MChi,MChi2,MFu,MFu2,MSu,MSu2,ZfFUL,ZfFUR,ZfL0,ZfSu,Amp)

Implicit None

Real(dp), Intent(in) :: MChi(6),MChi2(6),MFu(3),MFu2(3),MSu(6),MSu2(6)

Complex(dp), Intent(in) :: cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6)

Complex(dp), Intent(in) :: ctcplChiFucSuL(6,3,6),ctcplChiFucSuR(6,3,6)

Complex(dp), Intent(in) :: ZfFUL(3,3),ZfFUR(3,3),ZfL0(6,6),ZfSu(6,6)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChiToFucSu


Subroutine Amplitude_VERTEX_NonUMSSM_ChiToFucSu(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplChiChiAhL,cplChiChiAhR,             & 
...
Complex(dp), Intent(in) :: cplChiChiAhL(6,6,3),cplChiChiAhR(6,6,3),cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),        & 
& cplAhSucSu(3,6,6),cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),cplChiChacVWmL(6,2),     & 
& cplChiChacVWmR(6,2),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),cplChiChihhL(6,6,3),       & 
& cplChiChihhR(6,6,3),cplChiChiVZL(6,6),cplChiChiVZR(6,6),cplChiChiVZpL(6,6),            & 
& cplChiChiVZpR(6,6),cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6),cplChiFucSuL(6,3,6),        & 
& cplChiFucSuR(6,3,6),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),cplcFdChiSdL(3,6,6),   & 
& cplcFdChiSdR(3,6,6),cplcFuChiSuL(3,6,6),cplcFuChiSuR(3,6,6),cplcChaChiVWmL(2,6),       & 
& cplcChaChiVWmR(2,6),cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),cplGluFucSuL(3,6),       & 
...
& cplcFuFuVZpR(3,3),cplhhSucSu(3,6,6),cplSdcHpmcSu(6,2,6),cplSdcSucVWm(6,6),             & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChiToFucSu


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToFucSu(MAh,MCha,MChi,MFd,MFu,             & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplChiChiAhL,cplChiChiAhR,             & 
& cplcFuFuAhL,cplcFuFuAhR,cplAhSucSu,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,       & 
& cplChiChacVWmR,cplChaFucSdL,cplChaFucSdR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,       & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToFucSu


Subroutine Amplitude_Tree_NonUMSSM_ChiToFvcSv(cplChiFvcSvL,cplChiFvcSvR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_ChiToFvcSv


Subroutine Gamma_Real_NonUMSSM_ChiToFvcSv(MLambda,em,gs,cplChiFvcSvL,cplChiFvcSvR,    & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_ChiToFvcSv


Subroutine Amplitude_WAVE_NonUMSSM_ChiToFvcSv(cplChiFvcSvL,cplChiFvcSvR,              & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChiToFvcSv


Subroutine Amplitude_VERTEX_NonUMSSM_ChiToFvcSv(MCha,MChi,MFe,MFv,Mhh,MHpm,           & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChiToFvcSv


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToFvcSv(MCha,MChi,MFe,MFv,Mhh,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToFvcSv


Subroutine Amplitude_WAVE_NonUMSSM_ChiToChiVP(cplChiChiVZL,cplChiChiVZR,              & 
& cplChiChiVZpL,cplChiChiVZpR,ctcplChiChiVZL,ctcplChiChiVZR,ctcplChiChiVZpL,             & 
& ctcplChiChiVZpR,MChi,MChi2,MVP,MVP2,MVZ,MVZ2,ZfL0,ZfVP,ZfVZpVP,ZfVZVP,Amp)

Implicit None

Real(dp), Intent(in) :: MChi(6),MChi2(6),MVP,MVP2,MVZ,MVZ2

Complex(dp), Intent(in) :: cplChiChiVZL(6,6),cplChiChiVZR(6,6),cplChiChiVZpL(6,6),cplChiChiVZpR(6,6)

Complex(dp), Intent(in) :: ctcplChiChiVZL(6,6),ctcplChiChiVZR(6,6),ctcplChiChiVZpL(6,6),ctcplChiChiVZpR(6,6)

Complex(dp), Intent(in) :: ZfL0(6,6),ZfVP,ZfVZpVP,ZfVZVP
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChiToChiVP


Subroutine Amplitude_VERTEX_NonUMSSM_ChiToChiVP(MCha,MChi,MFd,MFe,MFu,MHpm,           & 
...
Real(dp), Intent(in) :: MCha(2),MChi(6),MFd(3),MFe(3),MFu(3),MHpm(2),MSd(6),MSe(6),MSu(6),MVP,MVWm,           & 
& MCha2(2),MChi2(6),MFd2(3),MFe2(3),MFu2(3),MHpm2(2),MSd2(6),MSe2(6),MSu2(6),            & 
& MVP2,MVWm2

Complex(dp), Intent(in) :: cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),cplChiChacVWmL(6,2),cplChiChacVWmR(6,2),  & 
& cplcChaChaVPL(2,2),cplcChaChaVPR(2,2),cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6),         & 
& cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6),       & 
& cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),cplcFdChiSdL(3,6,6),cplcFdChiSdR(3,6,6),   & 
& cplcFeChiSeL(3,6,6),cplcFeChiSeR(3,6,6),cplcFuChiSuL(3,6,6),cplcFuChiSuR(3,6,6),       & 
& cplcChaChiVWmL(2,6),cplcChaChiVWmR(2,6),cplcFdFdVPL(3,3),cplcFdFdVPR(3,3),             & 
...
Amp(:,gt1, gt2) = Amp(:,gt1, gt2) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChiToChiVP


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToChiVP(MCha,MChi,MFd,MFe,MFu,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToChiVP


Subroutine Amplitude_WAVE_NonUMSSM_ChiToGluVG(MChi,MChi2,MGlu,MGlu2,MVG,              & 
& MVG2,ZffG,ZfL0,ZfVG,Amp)

Implicit None

Real(dp), Intent(in) :: MChi(6),MChi2(6),MGlu,MGlu2,MVG,MVG2

Complex(dp), Intent(in) :: ZffG,ZfL0(6,6),ZfVG

Complex(dp), Intent(out) :: Amp(4,6) 
...
Amp(:,gt1) = 0._dp
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChiToGluVG


Subroutine Amplitude_VERTEX_NonUMSSM_ChiToGluVG(MChi,MFd,MFu,MGlu,MSd,MSu,            & 
...
Real(dp), Intent(in) :: MChi(6),MFd(3),MFu(3),MGlu,MSd(6),MSu(6),MVG,MChi2(6),MFd2(3),MFu2(3),MGlu2,          & 
& MSd2(6),MSu2(6),MVG2

Complex(dp), Intent(in) :: cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6),      & 
& cplcFdChiSdL(3,6,6),cplcFdChiSdR(3,6,6),cplcFuChiSuL(3,6,6),cplcFuChiSuR(3,6,6),       & 
...
End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChiToGluVG


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToGluVG(MChi,MFd,MFu,MGlu,MSd,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChiToGluVG



End Module OneLoopDecay_Chi_NonUMSSM
