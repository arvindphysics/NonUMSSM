...
Module Wrapper_OneLoopDecay_Fu_NonUMSSM
Use Model_Data_NonUMSSM 
Use Kinematics 
Use OneLoopDecay_Fu_NonUMSSM 
Use Control 
Use Settings 
...
Subroutine OneLoopDecay_Fu(MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,MFv2OS,MSuOS,              & 
...
& cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSucSu,cplcChacFuSdL,    & 
...
& cplHpmcHpmVZp,cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplHpmSucSd,cplSdcHpmcSu,        & 
& cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSdcSucVWm,cplSucSdVWm,cplSucSuVG,      & 
& cplSucSuVP,cplSucSuVZ,cplSucSuVZp,cplVGVGVG,ctcplcChacFuSdL,ctcplcChacFuSdR,           & 
...
& ctcplcFuFuVGL,ctcplcFuFuVGR,ctcplcFuFuVPL,ctcplcFuFuVPR,ctcplcFuFuVZL,ctcplcFuFuVZpL,  & 
& ctcplcFuFuVZpR,ctcplcFuFuVZR,ctcplcFuGluSuL,ctcplcFuGluSuR,GcplcFuFdcHpmL,             & 
...
& ZcplcFdFdVGL,ZcplcFdFdVGR,ZcplcFdFdVPL,ZcplcFdFdVPR,ZcplcFdFuHpmL,ZcplcFdFuHpmR,       & 
& ZcplcFdFuVWmL,ZcplcFdFuVWmR,ZcplcFuChiSuL,ZcplcFuChiSuR,ZcplcFuFdcHpmL,ZcplcFuFdcHpmR, & 
...
& ZcplSucSuVG,ZcplSucSuVP,ZcplVGVGVG,ZRUZD,ZRUZV,ZRUZVL,ZRUZU,ZRUZE,ZRUZH,               & 
...
& cplAhHpmcVWm(3,2),cplAhSdcSd(3,6,6),cplAhSucSu(3,6,6),cplcChacFuSdL(2,3,6),            & 
...
& cplcFdGluSdR(3,6),cplcFuChiSuL(3,6,6),cplcFuChiSuR(3,6,6),cplcFuFdcHpmL(3,3,2),        & 
...
& cplcFuFuVZpR(3,3),cplcFuFuVZR(3,3),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplChaFucSdL(2,3,6),& 
& cplChaFucSdR(2,3,6),cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),cplChiChacVWmL(6,2),   & 
...
& cplChiChiVZR(6,6),cplChiFdcSdL(6,3,6),cplChiFdcSdR(6,3,6),cplChiFucSuL(6,3,6),         & 
& cplChiFucSuR(6,3,6),cplcHpmVPVWm(2),cplcHpmVWmVZ(2),cplcHpmVWmVZp(2),cplcVWmVPVWm,     & 
...
& cplhhSucSu(3,6,6),cplhhVZpVZp(3),cplhhVZVZ(3),cplhhVZVZp(3),cplHpmcHpmVP(2,2),         & 
...
& ctcplcFuChiSuL(3,6,6),ctcplcFuChiSuR(3,6,6),ctcplcFuFdcHpmL(3,3,2),ctcplcFuFdcHpmR(3,3,2),& 
...
Complex(dp),Intent(in) :: ZcplcChacFuSdL(2,3,6),ZcplcChacFuSdR(2,3,6),ZcplcChaChaVPL(2,2),ZcplcChaChaVPR(2,2),   & 
...
& ZcplcFuChiSuL(3,6,6),ZcplcFuChiSuR(3,6,6),ZcplcFuFdcHpmL(3,3,2),ZcplcFuFdcHpmR(3,3,2), & 
...
& ZcplChaFucSdL(2,3,6),ZcplChaFucSdR(2,3,6),ZcplChiFucSuL(6,3,6),ZcplChiFucSuR(6,3,6),   & 
...
Real(dp) :: MRPFuToChiSu(3,6,6),MRGFuToChiSu(3,6,6), MRPZFuToChiSu(3,6,6),MRGZFuToChiSu(3,6,6) 
Real(dp) :: MVPFuToChiSu(3,6,6) 
Real(dp) :: RMsqTreeFuToChiSu(3,6,6),RMsqWaveFuToChiSu(3,6,6),RMsqVertexFuToChiSu(3,6,6) 
Complex(dp) :: AmpTreeFuToChiSu(2,3,6,6),AmpWaveFuToChiSu(2,3,6,6)=(0._dp,0._dp),AmpVertexFuToChiSu(2,3,6,6)& 
 & ,AmpVertexIRosFuToChiSu(2,3,6,6),AmpVertexIRdrFuToChiSu(2,3,6,6), AmpSumFuToChiSu(2,3,6,6), AmpSum2FuToChiSu(2,3,6,6) 
Complex(dp) :: AmpTreeZFuToChiSu(2,3,6,6),AmpWaveZFuToChiSu(2,3,6,6),AmpVertexZFuToChiSu(2,3,6,6) 
Real(dp) :: AmpSqFuToChiSu(3,6,6),  AmpSqTreeFuToChiSu(3,6,6) 
...
Call Amplitude_Tree_NonUMSSM_FuToFuAh(cplcFuFuAhL,cplcFuFuAhR,MAh,MFu,MAh2,           & 
& MFu2,AmpTreeFuToFuAh)

  Else 
Call Amplitude_Tree_NonUMSSM_FuToFuAh(ZcplcFuFuAhL,ZcplcFuFuAhR,MAh,MFu,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_FuToFuAh(MLambda,em,gs,cplcFuFuAhL,cplcFuFuAhR,              & 
& MAhOS,MFuOS,MRPFuToFuAh,MRGFuToFuAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_FuToFuAh(MLambda,em,gs,ZcplcFuFuAhL,ZcplcFuFuAhR,            & 
& MAhOS,MFuOS,MRPFuToFuAh,MRGFuToFuAh)
...
Call Amplitude_WAVE_NonUMSSM_FuToFuAh(cplcFuFuAhL,cplcFuFuAhR,ctcplcFuFuAhL,          & 
& ctcplcFuFuAhR,MAh,MAh2,MFu,MFu2,ZfAh,ZfFUL,ZfFUR,AmpWaveFuToFuAh)



!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_FuToFuAh(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_FuToFuAh(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,      & 
& cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,             & 
& cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSucSu,cplAhcHpmVWm,     & 
...
& AmpVertexIRdrFuToFuAh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_FuToFuAh(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,           & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_FuToChiSu(cplcFuChiSuL,cplcFuChiSuR,MChi,MFu,            & 
& MSu,MChi2,MFu2,MSu2,AmpTreeFuToChiSu)

  Else 
Call Amplitude_Tree_NonUMSSM_FuToChiSu(ZcplcFuChiSuL,ZcplcFuChiSuR,MChi,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_FuToChiSu(MLambda,em,gs,cplcFuChiSuL,cplcFuChiSuR,           & 
& MChiOS,MFuOS,MSuOS,MRPFuToChiSu,MRGFuToChiSu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_FuToChiSu(MLambda,em,gs,ZcplcFuChiSuL,ZcplcFuChiSuR,         & 
& MChiOS,MFuOS,MSuOS,MRPFuToChiSu,MRGFuToChiSu)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_FuToChiSu(cplcFuChiSuL,cplcFuChiSuR,ctcplcFuChiSuL,      & 
& ctcplcFuChiSuR,MChi,MChi2,MFu,MFu2,MSu,MSu2,ZfFUL,ZfFUR,ZfL0,ZfSu,AmpWaveFuToChiSu)



!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_FuToChiSu(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,              & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_FuToChiSu(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
...
& cplSucSuVP,cplSucSdVWm,cplSucSuVZ,cplSucSuVZp,AmpVertexIRdrFuToChiSu)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_FuToChiSu(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,          & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
& MVZ2OS,MVZp2OS,cplChiChiAhL,cplChiChiAhR,cplcFuFuAhL,cplcFuFuAhR,cplAhSucSu,           & 
& cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,cplcFdChaSuL,              & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_FuToFdcHpm(cplcFuFdcHpmL,cplcFuFdcHpmR,MFd,              & 
& MFu,MHpm,MFd2,MFu2,MHpm2,AmpTreeFuToFdcHpm)

  Else 
Call Amplitude_Tree_NonUMSSM_FuToFdcHpm(ZcplcFuFdcHpmL,ZcplcFuFdcHpmR,MFd,            & 
& MFu,MHpm,MFd2,MFu2,MHpm2,AmpTreeFuToFdcHpm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_FuToFdcHpm(MLambda,em,gs,cplcFuFdcHpmL,cplcFuFdcHpmR,        & 
& MFdOS,MFuOS,MHpmOS,MRPFuToFdcHpm,MRGFuToFdcHpm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_FuToFdcHpm(MLambda,em,gs,ZcplcFuFdcHpmL,ZcplcFuFdcHpmR,      & 
& MFdOS,MFuOS,MHpmOS,MRPFuToFdcHpm,MRGFuToFdcHpm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_FuToFdcHpm(cplcFuFdcHpmL,cplcFuFdcHpmR,ctcplcFuFdcHpmL,  & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_FuToFdcHpm(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,             & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_FuToFdcHpm(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
& cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,AmpVertexIRdrFuToFdcHpm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_FuToFdcHpm(MAhOS,MChaOS,MChiOS,MFdOS,               & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,MFd,              & 
& MFu,MVWm,MFd2,MFu2,MVWm2,AmpTreeFuToFdcVWm)

  Else 
Call Amplitude_Tree_NonUMSSM_FuToFdcVWm(ZcplcFuFdcVWmL,ZcplcFuFdcVWmR,MFd,            & 
& MFu,MVWm,MFd2,MFu2,MVWm2,AmpTreeFuToFdcVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_FuToFdcVWm(MLambda,em,gs,cplcFuFdcVWmL,cplcFuFdcVWmR,        & 
& MFdOS,MFuOS,MVWmOS,MRPFuToFdcVWm,MRGFuToFdcVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_FuToFdcVWm(MLambda,em,gs,ZcplcFuFdcVWmL,ZcplcFuFdcVWmR,      & 
& MFdOS,MFuOS,MVWmOS,MRPFuToFdcVWm,MRGFuToFdcVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_FuToFdcVWm(cplcFuFdcVWmL,cplcFuFdcVWmR,ctcplcFuFdcVWmL,  & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_FuToFdcVWm(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,             & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,        & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_FuToFdcVWm(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplcFdFdAhL,cplcFdFdAhR,               & 
...
& cplcVWmVWmVZ,cplcVWmVWmVZp,AmpVertexIRdrFuToFdcVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_FuToFdcVWm(MAhOS,MChaOS,MChiOS,MFdOS,               & 
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,              & 
& MCha2OS,MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,               & 
& MVP2,MVWm2OS,MVZ2OS,MVZp2OS,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,cplcFuFuAhR,           & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,MFu,Mhh,MFu2,           & 
& Mhh2,AmpTreeFuToFuhh)

  Else 
Call Amplitude_Tree_NonUMSSM_FuToFuhh(ZcplcFuFuhhL,ZcplcFuFuhhR,MFu,Mhh,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_FuToFuhh(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,              & 
& MFuOS,MhhOS,MRPFuToFuhh,MRGFuToFuhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_FuToFuhh(MLambda,em,gs,ZcplcFuFuhhL,ZcplcFuFuhhR,            & 
& MFuOS,MhhOS,MRPFuToFuhh,MRGFuToFuhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,          & 
& ctcplcFuFuhhR,MFu,MFu2,Mhh,Mhh2,ZfFUL,ZfFUR,Zfhh,AmpWaveFuToFuhh)



!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_FuToFuhh(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_FuToFuhh(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,cplcFuFuAhL,cplcFuFuAhR,          & 
& cplAhhhVZ,cplAhhhVZp,cplChaFucSdL,cplChaFucSdR,cplcChaChahhL,cplcChaChahhR,            & 
& cplChiChihhL,cplChiChihhR,cplChiFucSuL,cplChiFucSuR,cplcFuChiSuL,cplcFuChiSuR,         & 
...
& cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,cplcChacFuSdL,cplcChacFuSdR,AmpVertexIRdrFuToFuhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_FuToFuhh(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,           & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
& cplcChacFuSdL,cplcChacFuSdR,AmpVertexIRosFuToFuhh)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_FuToFuVZ(cplcFuFuVZL,cplcFuFuVZR,MFu,MVZ,MFu2,           & 
& MVZ2,AmpTreeFuToFuVZ)

  Else 
Call Amplitude_Tree_NonUMSSM_FuToFuVZ(ZcplcFuFuVZL,ZcplcFuFuVZR,MFu,MVZ,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_FuToFuVZ(MLambda,em,gs,cplcFuFuVZL,cplcFuFuVZR,              & 
& MFuOS,MVZOS,MRPFuToFuVZ,MRGFuToFuVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_FuToFuVZ(MLambda,em,gs,ZcplcFuFuVZL,ZcplcFuFuVZR,            & 
& MFuOS,MVZOS,MRPFuToFuVZ,MRGFuToFuVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_FuToFuVZ(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_FuToFuVZ(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_FuToFuVZ(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplcFuFuAhL,cplcFuFuAhR,cplAhhhVZ,          & 
& cplChaFucSdL,cplChaFucSdR,cplcChaChaVZL,cplcChaChaVZR,cplChiChiVZL,cplChiChiVZR,       & 
& cplChiFucSuL,cplChiFucSuR,cplcFuChiSuL,cplcFuChiSuR,cplcFdFdVZL,cplcFdFdVZR,           & 
...
& cplcFuFuVZpL,cplcFuFuVZpR,cplcFuGluSuL,cplcFuGluSuR,cplhhVZVZ,cplhhVZVZp,              & 
& cplHpmcHpmVZ,cplHpmcVWmVZ,cplSdcSdVZ,cplcChacFuSdL,cplcChacFuSdR,cplSucSuVZ,           & 
& cplcHpmVWmVZ,cplcVWmVWmVZ,AmpVertexIRdrFuToFuVZ)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_FuToFuVZ(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,           & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_FuToFuVZp(cplcFuFuVZpL,cplcFuFuVZpR,MFu,MVZp,            & 
& MFu2,MVZp2,AmpTreeFuToFuVZp)

  Else 
Call Amplitude_Tree_NonUMSSM_FuToFuVZp(ZcplcFuFuVZpL,ZcplcFuFuVZpR,MFu,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_FuToFuVZp(MLambda,em,gs,cplcFuFuVZpL,cplcFuFuVZpR,           & 
& MFuOS,MVZpOS,MRPFuToFuVZp,MRGFuToFuVZp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_FuToFuVZp(MLambda,em,gs,ZcplcFuFuVZpL,ZcplcFuFuVZpR,         & 
& MFuOS,MVZpOS,MRPFuToFuVZp,MRGFuToFuVZp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_FuToFuVZp(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,           & 
& cplcFuFuVZR,cplcFuFuVZpL,cplcFuFuVZpR,ctcplcFuFuVPL,ctcplcFuFuVPR,ctcplcFuFuVZL,       & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_FuToFuVZp(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,              & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_FuToFuVZp(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
& cplSucSuVZp,cplcHpmVWmVZp,cplcVWmVWmVZp,AmpVertexIRdrFuToFuVZp)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_FuToFuVZp(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,          & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
& MVZ2OS,MVZp2OS,cplcFuFuAhL,cplcFuFuAhR,cplAhhhVZp,cplChaFucSdL,cplChaFucSdR,           & 
& cplcChaChaVZpL,cplcChaChaVZpR,cplChiChiVZpL,cplChiChiVZpR,cplChiFucSuL,cplChiFucSuR,   & 
& cplcFuChiSuL,cplcFuChiSuR,cplcFdFdVZpL,cplcFdFdVZpR,cplcFuFdcHpmL,cplcFuFdcHpmR,       & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplGluFucSuL,cplGluFucSuR,cplcFuFuhhL,cplcFuFuhhR,         & 
& cplcFdFuHpmL,cplcFdFuHpmR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,             & 
& cplcFdFuVWmL,cplcFdFuVWmR,cplcFuFuVZL,cplcFuFuVZR,ZcplcFuFuVZpL,ZcplcFuFuVZpR,         & 
& cplcFuGluSuL,cplcFuGluSuR,cplhhVZVZp,cplhhVZpVZp,cplHpmcHpmVZp,cplHpmcVWmVZp,          & 
& cplSdcSdVZp,cplcChacFuSdL,cplcChacFuSdR,cplSucSuVZp,cplcHpmVWmVZp,cplcVWmVWmVZp,       & 
& AmpVertexIRosFuToFuVZp)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_FuToGluSu(cplcFuGluSuL,cplcFuGluSuR,MFu,MGlu,            & 
& MSu,MFu2,MGlu2,MSu2,AmpTreeFuToGluSu)

  Else 
Call Amplitude_Tree_NonUMSSM_FuToGluSu(ZcplcFuGluSuL,ZcplcFuGluSuR,MFu,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_FuToGluSu(MLambda,em,gs,cplcFuGluSuL,cplcFuGluSuR,           & 
& MFuOS,MGluOS,MSuOS,MRPFuToGluSu,MRGFuToGluSu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_FuToGluSu(MLambda,em,gs,ZcplcFuGluSuL,ZcplcFuGluSuR,         & 
& MFuOS,MGluOS,MSuOS,MRPFuToGluSu,MRGFuToGluSu)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_FuToGluSu(cplcFuGluSuL,cplcFuGluSuR,ctcplcFuGluSuL,      & 
& ctcplcFuGluSuR,MFu,MFu2,MGlu,MGlu2,MSu,MSu2,ZffG,ZfFUL,ZfFUR,ZfSu,AmpWaveFuToGluSu)



!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_FuToGluSu(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,              & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_FuToGluSu(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplcFuFuAhL,cplcFuFuAhR,               & 
...
& cplSucSuVZ,cplSucSuVZp,AmpVertexIRdrFuToGluSu)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_FuToGluSu(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,          & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
& MVZ2OS,MVZp2OS,cplcFuFuAhL,cplcFuFuAhR,cplAhSucSu,cplcFdChaSuL,cplcFdChaSuR,           & 
& cplcFuChiSuL,cplcFuChiSuR,cplGluFdcSdL,cplGluFdcSdR,cplcFuFdcHpmL,cplcFuFdcHpmR,       & 
& cplcFuFdcVWmL,cplcFuFdcVWmR,cplGluFucSuL,cplGluFucSuR,cplcFuFuhhL,cplcFuFuhhR,         & 
& cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,               & 
& cplcFuFuVZpL,cplcFuFuVZpR,cplGluGluVGL,cplGluGluVGR,cplcFdGluSdL,cplcFdGluSdR,         & 
& ZcplcFuGluSuL,ZcplcFuGluSuR,cplhhSucSu,cplHpmSucSd,cplcChacFuSdL,cplcChacFuSdR,        & 
& cplSucSuVG,cplSucSuVP,cplSucSdVWm,cplSucSuVZ,cplSucSuVZp,AmpVertexIRosFuToGluSu)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_FuTocChaSd(cplcChacFuSdL,cplcChacFuSdR,MCha,             & 
& MFu,MSd,MCha2,MFu2,MSd2,AmpTreeFuTocChaSd)

  Else 
Call Amplitude_Tree_NonUMSSM_FuTocChaSd(ZcplcChacFuSdL,ZcplcChacFuSdR,MCha,           & 
& MFu,MSd,MCha2,MFu2,MSd2,AmpTreeFuTocChaSd)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_FuTocChaSd(MLambda,em,gs,cplcChacFuSdL,cplcChacFuSdR,        & 
& MChaOS,MFuOS,MSdOS,MRPFuTocChaSd,MRGFuTocChaSd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_FuTocChaSd(MLambda,em,gs,ZcplcChacFuSdL,ZcplcChacFuSdR,      & 
& MChaOS,MFuOS,MSdOS,MRPFuTocChaSd,MRGFuTocChaSd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_FuTocChaSd(cplcChacFuSdL,cplcChacFuSdR,ctcplcChacFuSdL,  & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_FuTocChaSd(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,             & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_FuTocChaSd(MAh,MCha,MChi,MFd,MFu,MGlu,              & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
& cplSdcHpmcSu,cplSdcSucVWm,AmpVertexIRdrFuTocChaSd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_FuTocChaSd(MAhOS,MChaOS,MChiOS,MFdOS,               & 
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,              & 
& MCha2OS,MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,               & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_NonUMSSM_FuToFuVG(ZcplcFuFuVGL,ZcplcFuFuVGR,ctcplcFuFuVGL,        & 
& ctcplcFuFuVGR,MFuOS,MFu2OS,MVG,MVG2,ZfFUL,ZfFUR,ZfVG,AmpWaveFuToFuVG)

 Else 
Call Amplitude_WAVE_NonUMSSM_FuToFuVG(cplcFuFuVGL,cplcFuFuVGR,ctcplcFuFuVGL,          & 
& ctcplcFuFuVGR,MFuOS,MFu2OS,MVG,MVG2,ZfFUL,ZfFUR,ZfVG,AmpWaveFuToFuVG)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NonUMSSM_FuToFuVG(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,              & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_FuToFuVG(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_NonUMSSM_FuToFuVP(ZcplcFuFuVPL,ZcplcFuFuVPR,ZcplcFuFuVZL,         & 
...
& ZfFUR,ZfVP,ZfVZpVP,ZfVZVP,AmpWaveFuToFuVP)
 ...
 Else 
Call Amplitude_WAVE_NonUMSSM_FuToFuVP(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,            & 
& cplcFuFuVZR,cplcFuFuVZpL,cplcFuFuVZpR,ctcplcFuFuVPL,ctcplcFuFuVPR,ctcplcFuFuVZL,       & 
& ctcplcFuFuVZR,ctcplcFuFuVZpL,ctcplcFuFuVZpR,MFuOS,MFu2OS,MVP,MVP2,ZfFUL,               & 
& ZfFUR,ZfVP,ZfVZpVP,ZfVZVP,AmpWaveFuToFuVP)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NonUMSSM_FuToFuVP(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,              & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_FuToFuVP(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplcFuFuAhL,cplcFuFuAhR,cplChaFucSdL,       & 
...
End Module Wrapper_OneLoopDecay_Fu_NonUMSSM
