...
&  2*AbsYe11*(-15._dp*(AbsYe22) + 2*(3._dp*(g1p2) + 5*gpp2*(Qe1p2 - QHdp2 +              & 
&  Ql1p2))) - 36*g1p2*gpp2*Qd*Ql2 - 12*g1p2*gpp2*Qe1*Ql2 - 36*g1p2*gpp2*Qe2*Ql2 -        & 
&  12*g1p2*gpp2*Qe3*Ql2 + 24*g1p2*gpp2*QHd*Ql2 - 12*g1p2*gpp2*QHu*Ql2 + 12*g1p2*gpp2*Ql1*Ql2 +& 
...
&  360*gpp4*Qe2p2*Qqp2 + 360*gpp4*QHdp2*Qqp2 + 360*gpp4*Ql2p2*Qqp2 + 20*gpp2*lamp2*Qsp2 +& 
...
&  180*gpp4*Ql2p2*Qup2 + 2*AbsYe22*(-15._dp*(AbsYe33) + 6._dp*(g1p2) + 30._dp*(g2p2) -   & 
&  15._dp*(lamp2) + 20*gpp2*QHdp2 + 20*gpp2*Ql2p2 - 45._dp*(TrYdadjYd)) - 4*g1p2*TrYdadjYd +& 
&  160*g3p2*TrYdadjYd + 60*gpp2*Qdp2*TrYdadjYd - 60*gpp2*QHdp2*TrYdadjYd +               & 
&  60*gpp2*Qqp2*TrYdadjYd - 90._dp*(TrYdadjYdYdadjYd) - 30._dp*(TrYdadjYuYuadjYd) -      & 
...
&  40*gpp4*QHdp2*Ql1p2 + 2*AbsYe11*(-15._dp*(AbsYe33) + 2*(3._dp*(g1p2) + 5*gpp2*(Qe1p2 -& 
&  QHdp2 + Ql1p2))) - 24*g1p2*gpp2*Qe3*Ql2 + 12*g1p2*gpp2*QHd*Ql2 + 40*gpp4*Qe3p2*Ql2p2 +& 
&  40*gpp4*QHdp2*Ql2p2 + 2*AbsYe22*(-15._dp*(AbsYe33) + 2*(3._dp*(g1p2) + 5*gpp2*(Qe2p2 -& 
...
&  (AbsYe11*(6._dp*(g1p2) + 5*(-3._dp*(lamp2) + 2*gpp2*(Qe1p2 - QHdp2 + Ql1p2)))*lam)/5._dp +& 
&  (6*g1p2*gpp2*QHd*Ql2*lam)/5._dp - (6*g1p2*gpp2*QHu*Ql2*lam)/5._dp + 4*gpp4*QHdp2*Ql2p2*lam +& 
&  4*gpp4*QHup2*Ql2p2*lam + (AbsYe22*(6._dp*(g1p2) + 5*(-3._dp*(lamp2) + 2*gpp2*(Qe2p2 - & 
...
&  270*CYe11p2*Ye11*TYe11 + 18*Conjg(Ye11)*((3*g1p2*M1 + 5*gpp2*M4*(Qe1p2 -              & 
&  QHdp2 + Ql1p2))*Ye11 - (3._dp*(g1p2) + 5*gpp2*(Qe1p2 - QHdp2 + Ql1p2))*TYe11) +       & 
&  270*CYe22p2*Ye22*TYe22 + 18*Conjg(Ye22)*((3*g1p2*M1 + 5*gpp2*M4*(Qe2p2 -              & 
&  QHdp2 + Ql2p2))*Ye22 - (3._dp*(g1p2) + 5*gpp2*(Qe2p2 - QHdp2 + Ql2p2))*TYe22) +       & 
...
&  2*Ye11*((3*g1p2*M1 + 5*gpp2*M4*(Qe2p2 - QHdp2 + Ql2p2))*Ye22 - (3._dp*(g1p2) +        & 
&  5*gpp2*(Qe2p2 - QHdp2 + Ql2p2))*TYe22)) - 120*CYe33p2*Ye11*Ye33*TYe33 +               & 
&  24*g1p2*Ye11*Conjg(Ye33)*TYe33 + 40*gpp2*Qe3p2*Ye11*Conjg(Ye33)*TYe33 -               & 
&  40*gpp2*QHdp2*Ye11*Conjg(Ye33)*TYe33 + 40*gpp2*Ql3p2*Ye11*Conjg(Ye33)*TYe33 -         & 
&  120*lamp3*Ye11*Tlam - 40*gpp2*QHdp2*Ye11*lam*Tlam + 40*gpp2*QHup2*Ye11*lam*Tlam +     & 
&  40*gpp2*Qsp2*Ye11*lam*Tlam - 60*TrYuadjYu*Ye11*lam*Tlam - 2*AbsYe11*(-3*(-            & 
& 15._dp*(AbsYe22) - 15._dp*(AbsYe33) + 6._dp*(g1p2) + 30._dp*(g2p2) - 15._dp*(lamp2) +  & 
&  20*gpp2*QHdp2 + 20*gpp2*Ql1p2 - 45._dp*(TrYdadjYd))*TYe11 + 2*Ye11*(6*g1p2*M1 +       & 
&  30*g2p2*M2 + 20*gpp2*M4*QHdp2 + 20*gpp2*M4*Ql1p2 + 45._dp*(TradjYdTd) +               & 
...
&  Conjg(Ye11)*(4*(-15._dp*(AbsYe22) + 2*(3._dp*(g1p2) + 5*gpp2*(Qe1p2 - QHdp2 +         & 
&  Ql1p2)))*Ye22*TYe11 - 2*Ye11*(4*(3*g1p2*M1 + 5*gpp2*M4*(Qe1p2 - QHdp2 +               & 
&  Ql1p2))*Ye22 + (45._dp*(AbsYe22) - 2*(3._dp*(g1p2) + 5*gpp2*(Qe1p2 - QHdp2 +          & 
&  Ql1p2)))*TYe22)) - 120*CYe33p2*Ye22*Ye33*TYe33 + 24*g1p2*Ye22*Conjg(Ye33)*TYe33 +     & 
&  40*gpp2*Qe3p2*Ye22*Conjg(Ye33)*TYe33 - 40*gpp2*QHdp2*Ye22*Conjg(Ye33)*TYe33 +         & 
&  40*gpp2*Ql3p2*Ye22*Conjg(Ye33)*TYe33 - 120*lamp3*Ye22*Tlam - 40*gpp2*QHdp2*Ye22*lam*Tlam +& 
&  40*gpp2*QHup2*Ye22*lam*Tlam + 40*gpp2*Qsp2*Ye22*lam*Tlam - 60*TrYuadjYu*Ye22*lam*Tlam -& 
&  2*AbsYe22*(-3*(-15._dp*(AbsYe33) + 6._dp*(g1p2) + 30._dp*(g2p2) - 15._dp*(lamp2) +    & 
&  20*gpp2*QHdp2 + 20*gpp2*Ql2p2 - 45._dp*(TrYdadjYd))*TYe22 + 2*Ye22*(6*g1p2*M1 +       & 
&  30*g2p2*M2 + 20*gpp2*M4*QHdp2 + 20*gpp2*M4*Ql2p2 + 45._dp*(TradjYdTd) +               & 
&  15*Conjg(Ye33)*TYe33 + 15*lam*Tlam)))/10._dp
...
&  2*(3._dp*(g1p2) + 5*gpp2*(Qe1p2 - QHdp2 + Ql1p2)))*Ye33*TYe11 - 2*Ye11*(4*(3*g1p2*M1 +& 
&  5*gpp2*M4*(Qe1p2 - QHdp2 + Ql1p2))*Ye33 + (45._dp*(AbsYe33) - 2*(3._dp*(g1p2) +       & 
&  5*gpp2*(Qe1p2 - QHdp2 + Ql1p2)))*TYe33)) + Conjg(Ye22)*(4*(-15._dp*(AbsYe33) +        & 
&  2*(3._dp*(g1p2) + 5*gpp2*(Qe2p2 - QHdp2 + Ql2p2)))*Ye33*TYe22 - 2*Ye22*(4*(3*g1p2*M1 +& 
&  5*gpp2*M4*(Qe2p2 - QHdp2 + Ql2p2))*Ye33 + (45._dp*(AbsYe33) - 2*(3._dp*(g1p2) +       & 
&  5*gpp2*(Qe2p2 - QHdp2 + Ql2p2)))*TYe33)) - 120*lamp3*Ye33*Tlam - 40*gpp2*QHdp2*Ye33*lam*Tlam +& 
...
&  Ye22*Tlam) - (Conjg(Ye11)*(-2*(6._dp*(g1p2) + 5*(-3._dp*(lamp2) + 2*gpp2*(Qe1p2 -     & 
&  QHdp2 + Ql1p2)))*lam*TYe11 + Ye11*(4*(3*g1p2*M1 + 5*gpp2*M4*(Qe1p2 - QHdp2 +          & 
&  Ql1p2))*lam + (-6._dp*(g1p2) - 5*(-9._dp*(lamp2) + 2*gpp2*(Qe1p2 - QHdp2 +            & 
&  Ql1p2)))*Tlam)))/5._dp - (Conjg(Ye22)*(-2*(6._dp*(g1p2) + 5*(-3._dp*(lamp2) +         & 
&  2*gpp2*(Qe2p2 - QHdp2 + Ql2p2)))*lam*TYe22 + Ye22*(4*(3*g1p2*M1 + 5*gpp2*M4*(Qe2p2 -  & 
&  QHdp2 + Ql2p2))*lam + (-6._dp*(g1p2) - 5*(-9._dp*(lamp2) + 2*gpp2*(Qe2p2 -            & 
...
&  2._dp*(adjYuTu) + 2*adjYdYd*M1 + 4*adjYuYu*M1) + id3R*(597*g1p2*M1 + 5*(9*g2p2*(2._dp*(M1) +& 
&  M2) + 4*(4*g3p2*(2._dp*(M1) + M3) + 3*gpp2*(2._dp*(M1) + M4)*Qq*(9._dp*(Qd) +         & 
...
&  6*TradjYdTd*Ye11*Conjg(TYe11) + (3*g1p2*Conjg(M1)*(207*g1p2*M1 + 5*(3*g2p2*(2._dp*(M1) +& 
&  M2) - 4*gpp2*(2._dp*(M1) + M4)*Ql1*(3._dp*(Qd) + Qe1 + Qe2 + Qe3 - QHd +              & 
...
&  (3*g1p2*Conjg(M1)*(207*g1p2*M1 + 5*(3*g2p2*(2._dp*(M1) + M2) - 4*gpp2*(2._dp*(M1) +   & 
...
&  5*(3*g2p2*(2._dp*(M1) + M2) - 4*gpp2*(2._dp*(M1) + M4)*Ql3*(3._dp*(Qd) +              & 
...
&  36*mHu2*TrYuadjYuYuadjYu + (g1p2*(3*(207*g1p2*M1 + 5*(3*g2p2*(2._dp*(M1) +            & 
&  M2) + 4*gpp2*(2._dp*(M1) + M4)*QHu*(3._dp*(Qd) + Qe1 + Qe2 + Qe3 - QHd +              & 
&  2._dp*(QHu) - Ql1 - Ql2 - Ql3 + 3._dp*(Qq) - 6._dp*(Qu)))) - 40._dp*(TradjYuTu) +     & 
&  80*M1*TrYuadjYu)*Conjg(M1))/25._dp - 32*g3p2*TradjYuTu*Conjg(M3) + (9*g1p2*g2p2*M1*Conjg(M2))/5._dp +& 
&  12*g2p2*gpp2*M4*QHup2*Conjg(M2) - 4*gpp2*M4*QHdp2*lam*Tlam + 4*gpp2*M4*QHup2*lam*Tlam -& 
&  4*gpp2*M4*Qsp2*lam*Tlam - 6*TradjYdTd*lam*Tlam - 6*TrCTdTpYd*lam*Tlam -               & 
&  2*Ye11*lam*Conjg(TYe11)*Tlam - 2*Ye22*lam*Conjg(TYe22)*Tlam - 2*Ye33*lam*Conjg(TYe33)*Tlam -& 
&  2*lam*Conjg(Ye11)*TYe11*Tlam - 2*lam*Conjg(Ye22)*TYe22*Tlam - 2*lam*Conjg(Ye33)*TYe33*Tlam +& 
...
&  15*g2p2*M2*QHup2 + 270*gpp2*M4*Qdp2*QHup2 + 30*gpp2*M4*Qe1p2*QHup2 + 30*gpp2*M4*Qe2p2*QHup2 +& 
&  30*gpp2*M4*Qe3p2*QHup2 + 60*gpp2*M4*QHdp2*QHup2 + 120*gpp2*M4*QHup4 - 3*g1p2*M1*QHu*Ql1 -& 
&  6*g1p2*M4*QHu*Ql1 + 60*gpp2*M4*QHup2*Ql1p2 - 3*g1p2*M1*QHu*Ql2 - 6*g1p2*M4*QHu*Ql2 +  & 
&  60*gpp2*M4*QHup2*Ql2p2 - 3*g1p2*M1*QHu*Ql3 - 6*g1p2*M4*QHu*Ql3 + 60*gpp2*M4*QHup2*Ql3p2 +& 
...
&  4._dp*(Ydmq2adjYuYuadjYd) + (4*g1p2*(2*id3R*(303*g1p2*M1 + 5*(8*g3p2*(2._dp*(M1) +    & 
&  M3) + 3*gpp2*(2._dp*(M1) + M4)*Qd*(11._dp*(Qd) + 3*(Qe1 + Qe2 + Qe3 - QHd +           & 
&  QHu - Ql1 - Ql2 - Ql3 + 3._dp*(Qq) - 6._dp*(Qu))))) - 45._dp*(TdadjYd) +              & 
&  90*M1*YdadjYd)*Conjg(M1))/225._dp - (64*g3p2*id3R*(-(g1p2*(M1 + 2._dp*(M3))) +        & 
&  15*(2*g3p2*M3 - gpp2*(2._dp*(M3) + M4)*Qdp2))*Conjg(M3))/45._dp + (88*g1p2*gpp2*id3R*M1*Qdp2*Conjg(M4))/15._dp  
...
If (TwoLoopRGE) Then 
betamu22 = (2*(2*g1p2*(4*id3R*(642*g1p2*M1 + 5*(16*g3p2*(2._dp*(M1) + M3) - 3*gpp2*(2._dp*(M1) + & 
&  M4)*(9._dp*(Qd) + 3._dp*(Qe1) + 3._dp*(Qe2) + 3._dp*(Qe3) - 3._dp*(QHd) +             & 
&  3._dp*(QHu) - 3._dp*(Ql1) - 3._dp*(Ql2) - 3._dp*(Ql3) + 9._dp*(Qq) - 22._dp*(Qu))*Qu)) +& 
&  45*(TuadjYu - 2*M1*YuadjYu))*Conjg(M1) + 5*(32*g3p2*id3R*(4*g1p2*(M1 + 2._dp*(M3)) +  & 
&  15*(-2*g3p2*M3 + gpp2*(2._dp*(M3) + M4)*Qup2))*Conjg(M3) - 3*(-4*gpp2*(id3R*Qu*(-     & 
...
&  3*(5._dp*(mu2YuadjYdYdadjYu) + g1p2*mu2YuadjYu - 15*g2p2*mu2YuadjYu + 5*lamp2*mu2YuadjYu +& 
...
&  20*gpp2*M4*Qup2 + 30._dp*(TradjYuTu) + 10*lam*Tlam)) - 4*id3R*(20*g3p4*Tr2(3) +       & 
...
If (TwoLoopRGE) Then 
betame0122 = (4*(3*g1p2*Conjg(M1)*(2*(117*g1p2*M1 + 5*gpp2*(2._dp*(M1) + M4)*Qe1*(3._dp*(Qd) +     & 
...
If (TwoLoopRGE) Then 
betame0222 = (4*(3*g1p2*Conjg(M1)*(2*(117*g1p2*M1 + 5*gpp2*(2._dp*(M1) + M4)*Qe2*(3._dp*(Qd) +     & 
...
If (TwoLoopRGE) Then 
betame0322 = (4*(3*g1p2*Conjg(M1)*(2*(117*g1p2*M1 + 5*gpp2*(2._dp*(M1) + M4)*Qe3*(3._dp*(Qd) +     & 
...
&  8*gpp2*Conjg(M4)*(M4*(2*lamp2*(QHdp2 + QHup2 - Qsp2) + 3*gpp2*Qsp2*(9._dp*(Qdp2) +    & 
&  Qe1p2 + Qe2p2 + Qe3p2 + 2._dp*(QHdp2) + 2._dp*(QHup2) + 2._dp*(Ql1p2) +               & 
...
betaTdp1  = TdpadjYdYd + 3._dp*(TdpadjYuYu) + (Tdp*(2._dp*(g1p2) - 5*(16._dp*(g3p2)   & 
&  - 3._dp*(lamp2) + 6*gpp2*(Qdp2 - QHup2 + Qqp2)) + 45._dp*(TrYuadjYu)))/15._dp +       & 
&  6*TrTdpadjYd*Yd + 2._dp*(YdadjYdTdp) + 2*Tep*Yd*Conjg(Ye11) + 2*Tmup*Yd*Conjg(Ye22)
...
&  20*AbsYe11*(3*g1p2*(4 + Xi) + 5*(4*gpp2*(Qe1p2 + Ql1p2 + QHdp2*(-1 + Xi)) +           & 
&  3*g2p2*Xi)) - 20*AbsYe22*(3*g1p2*(4 + Xi) + 5*(4*gpp2*(Qe2p2 + Ql2p2 + QHdp2*(-       & 
& 1 + Xi)) + 3*g2p2*Xi)) + 9*g1p4*Xip2 + 90*g1p2*g2p2*Xip2 + 120*g1p2*gpp2*QHdp2*Xip2 +  & 
...
betavu1  = (vu*(-60._dp*(TrYuadjYu) + 3*g1p2*(1 + Xi) + 5*(3*g2p2*(1 + Xi)            & 
&  + 4*(-1._dp*(lamp2) + gpp2*QHup2*(1 + Xi)))))/20._dp
