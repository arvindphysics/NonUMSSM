{4*Cp[USd[{gO1}], conj[USd[{gO2}]], conj[VWm], VWm]*
  ...
  sum[gI1, 1, 3, A0[Mass2[Ah[{gI1}]]]*Cp[USv[{gO1}], conj[USv[{gO2}]], 
      Ah[{gI1}], Ah[{gI1}]]]/2 - sum[gI1, 1, 3, 
   A0[Mass2[Sv[{gI1}]]]*Cp[USv[{gO1}], conj[USv[{gO2}]], conj[Sv[{gI1}]], 
     Sv[{gI1}]]] - sum[gI1, 1, 3, A0[Mass2[hh[{gI1}]]]*
     Cp[USv[{gO1}], conj[USv[{gO2}]], hh[{gI1}], hh[{gI1}]]]/2 + 
  sum[gI1, 1, 3, sum[gI2, 1, 3, B0[p^2, Mass2[Sv[{gI1}]], Mass2[hh[{gI2}]]]*
 ...
 {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fe[{gI2}]], Mass2[Hpm[{gI1}]]]*
      conj[Cp[bar[UFv[{gO2}]], conj[Hpm[{gI1}]], Fe[{gI2}]][PL]]*
      Mass[Fe[{gI2}]]*Cp[bar[UFv[{gO1}]], conj[Hpm[{gI1}]], Fe[{gI2}]][
   ...
   sum[gI1, 1, 3, sum[gI2, 1, 6, B0[p^2, Mass2[Chi[{gI2}]], Mass2[Sv[{gI1}]]]*
      conj[Cp[bar[UFv[{gO2}]], Sv[{gI1}], Chi[{gI2}]][PL]]*Mass[Chi[{gI2}]]*
      Cp[bar[UFv[{gO1}]], Sv[{gI1}], Chi[{gI2}]][PR]]] - 
   4*sum[gI2, 1, 3, (-rMS/2 + B0[p^2, Mass2[Fv[{gI2}]], Mass2[VZ]])*
      conj[Cp[bar[UFv[{gO2}]], VZ, Fv[{gI2}]][PR]]*Mass[Fv[{gI2}]]*
  ...
  -sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], Mass2[Hpm[{gI1}]]]*
        conj[Cp[bar[UFv[{gO2}]], conj[Hpm[{gI1}]], Fe[{gI2}]][PR]]*
        Cp[bar[UFv[{gO1}]], conj[Hpm[{gI1}]], Fe[{gI2}]][PR]]]/2 - 
   ...
   sum[gI1, 1, 3, sum[gI2, 1, 6, B1[p^2, Mass2[Chi[{gI2}]], Mass2[Sv[{gI1}]]]*
       conj[Cp[bar[UFv[{gO2}]], Sv[{gI1}], Chi[{gI2}]][PR]]*
       Cp[bar[UFv[{gO1}]], Sv[{gI1}], Chi[{gI2}]][PR]]]/2 - 
  ...
  -sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], Mass2[Hpm[{gI1}]]]*
        conj[Cp[bar[UFv[{gO2}]], conj[Hpm[{gI1}]], Fe[{gI2}]][PL]]*
        Cp[bar[UFv[{gO1}]], conj[Hpm[{gI1}]], Fe[{gI2}]][PL]]]/2 - 
   sum[gI1, 1, 2, sum[gI2, 1, 6, B1[p^2, Mass2[Cha[{gI1}]], Mass2[Se[{gI2}]]]*
       conj[Cp[bar[UFv[{gO2}]], bar[Cha[{gI1}]], Se[{gI2}]][PL]]*
       Cp[bar[UFv[{gO1}]], bar[Cha[{gI1}]], Se[{gI2}]][PL]]]/2 - 
   sum[gI1, 1, 3, sum[gI2, 1, 6, B1[p^2, Mass2[Chi[{gI2}]], Mass2[Sv[{gI1}]]]*
       conj[Cp[bar[UFv[{gO2}]], Sv[{gI1}], Chi[{gI2}]][PL]]*
       Cp[bar[UFv[{gO1}]], Sv[{gI1}], Chi[{gI2}]][PL]]]/2 - 
   sum[gI2, 1, 3, (rMS/2 + B1[p^2, Mass2[Fv[{gI2}]], Mass2[VZ]])*
 ...
 4*Cp[USu[{gO1}], conj[USu[{gO2}]], conj[VWm], VWm]*
   (A0[Mass2[VWm]] - (rMS*Mass2[VWm])/2) + 
  ...
  sum[gI1, 1, 3, A0[Mass2[Ah[{gI1}]]]*Cp[USu[{gO1}], conj[USu[{gO2}]], 
      Ah[{gI1}], Ah[{gI1}]]]/2 - sum[gI1, 1, 3, 
   A0[Mass2[Sv[{gI1}]]]*Cp[USu[{gO1}], conj[USu[{gO2}]], conj[Sv[{gI1}]], 
     Sv[{gI1}]]] - sum[gI1, 1, 3, A0[Mass2[hh[{gI1}]]]*
     Cp[USu[{gO1}], conj[USu[{gO2}]], hh[{gI1}], hh[{gI1}]]]/2 - 
  ...
  sum[gI1, 1, 6, sum[gI2, 1, 3, B0[p^2, Mass2[Su[{gI1}]], Mass2[Ah[{gI2}]]]*
  ...
  sum[gI1, 1, 3, A0[Mass2[Ah[{gI1}]]]*Cp[USe[{gO1}], conj[USe[{gO2}]], 
   ...
   A0[Mass2[Sv[{gI1}]]]*Cp[USe[{gO1}], conj[USe[{gO2}]], conj[Sv[{gI1}]], 
     Sv[{gI1}]]] - sum[gI1, 1, 3, A0[Mass2[hh[{gI1}]]]*
     Cp[USe[{gO1}], conj[USe[{gO2}]], hh[{gI1}], hh[{gI1}]]]/2 + 
  ...
  sum[gI2, 1, 6, conj[Cp[conj[USe[{gO2}]], VZ, Se[{gI2}]]]*
    ...
    Cp[conj[USe[{gO1}]], VZp, Se[{gI2}]]*F0[p^2, Mass2[Se[{gI2}]], 
     Mass2[VZp]]], 2*(-rMS/2 + B0[p^2, Mass2[VZ], Mass2[VZ]])*
   conj[Cp[Uhh[{gO2}], VZ, VZ]]*Cp[Uhh[{gO1}], VZ, VZ] + 
  4*(-rMS/2 + B0[p^2, Mass2[VZ], Mass2[VZp]])*conj[Cp[Uhh[{gO2}], VZp, VZ]]*
   Cp[Uhh[{gO1}], VZp, VZ] + 2*(-rMS/2 + B0[p^2, Mass2[VZp], Mass2[VZp]])*
  ...
  sum[gI1, 1, 2, sum[gI2, 1, 2, B0[p^2, Mass2[Hpm[{gI1}]], Mass2[Hpm[{gI2}]]]*
  ...
  sum[gI1, 1, 3, A0[Mass2[Ah[{gI1}]]]*Cp[Uhh[{gO1}], Uhh[{gO2}], Ah[{gI1}], 
    ...
    Cp[Uhh[{gO1}], Uhh[{gO2}], conj[Sv[{gI1}]], Sv[{gI1}]]] - 
  ...
  sum[gI1, 1, 3, sum[gI2, 1, 3, B0[p^2, Mass2[Ah[{gI1}]], Mass2[Ah[{gI2}]]]*
    ...
    B0[p^2, Mass2[Sv[{gI1}]], Mass2[Sv[{gI2}]]]*
     conj[Cp[Uhh[{gO2}], conj[Sv[{gI1}]], Sv[{gI2}]]]*
     Cp[Uhh[{gO1}], conj[Sv[{gI1}]], Sv[{gI2}]]]] + 
  sum[gI1, 1, 3, sum[gI2, 1, 3, B0[p^2, Mass2[hh[{gI1}]], Mass2[hh[{gI2}]]]*
  ...
  sum[gI1, 1, 6, sum[gI2, 1, 6, G0[p^2, Mass2[Chi[{gI1}]], Mass2[Chi[{gI2}]]]*
      (conj[Cp[Uhh[{gO2}], Chi[{gI1}], Chi[{gI2}]][PL]]*
        Cp[Uhh[{gO1}], Chi[{gI1}], Chi[{gI2}]][PL] + 
       conj[Cp[Uhh[{gO2}], Chi[{gI1}], Chi[{gI2}]][PR]]*
 ...
 4*(-rMS/2 + B0[p^2, 0, Mass2[VWm]])*conj[Cp[conj[UHpm[{gO2}]], VWm, VP]]*
  ...
  sum[gI1, 1, 3, A0[Mass2[Ah[{gI1}]]]*Cp[UHpm[{gO1}], conj[UHpm[{gO2}]], 
      Ah[{gI1}], Ah[{gI1}]]]/2 - sum[gI1, 1, 3, 
   A0[Mass2[Sv[{gI1}]]]*Cp[UHpm[{gO1}], conj[UHpm[{gO2}]], conj[Sv[{gI1}]], 
     Sv[{gI1}]]] - sum[gI1, 1, 3, A0[Mass2[hh[{gI1}]]]*
     Cp[UHpm[{gO1}], conj[UHpm[{gO2}]], hh[{gI1}], hh[{gI1}]]]/2 - 
  6*sum[gI1, 1, 3, Mass[Fu[{gI1}]]*sum[gI2, 1, 3, 
  ...
  sum[gI1, 1, 6, sum[gI2, 1, 2, G0[p^2, Mass2[Chi[{gI1}]], Mass2[Cha[{gI2}]]]*
     (conj[Cp[conj[UHpm[{gO2}]], Chi[{gI1}], Cha[{gI2}]][PL]]*
       Cp[conj[UHpm[{gO1}]], Chi[{gI1}], Cha[{gI2}]][PL] + 
      conj[Cp[conj[UHpm[{gO2}]], Chi[{gI1}], Cha[{gI2}]][PR]]*
       Cp[conj[UHpm[{gO1}]], Chi[{gI1}], Cha[{gI2}]][PR])]] + 
 ...
 {sum[gI1, 1, 2, Mass[Cha[{gI1}]]*sum[gI2, 1, 2, 
   ...
   sum[gI1, 1, 3, sum[gI2, 1, 6, B0[p^2, Mass2[Chi[{gI2}]], Mass2[hh[{gI1}]]]*
  ...
  -sum[gI1, 1, 2, sum[gI2, 1, 2, B1[p^2, Mass2[Cha[{gI1}]], 
   ...
   sum[gI1, 1, 3, sum[gI2, 1, 6, B1[p^2, Mass2[Chi[{gI2}]], Mass2[hh[{gI1}]]]*
       conj[Cp[UChi[{gO2}], hh[{gI1}], Chi[{gI2}]][PR]]*
       Cp[UChi[{gO1}], hh[{gI1}], Chi[{gI2}]][PR]]]/2 - 
   sum[gI1, 1, 6, sum[gI2, 1, 3, B1[p^2, Mass2[Chi[{gI1}]], Mass2[Ah[{gI2}]]]*
   ...
   sum[gI2, 1, 6, (rMS/2 + B1[p^2, Mass2[Chi[{gI2}]], Mass2[VZ]])*
     ...
     Cp[UChi[{gO1}], VZ, Chi[{gI2}]][PL]] - 
   sum[gI2, 1, 6, (rMS/2 + B1[p^2, Mass2[Chi[{gI2}]], Mass2[VZp]])*
 ...
 {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fv[{gI2}]], Mass2[Hpm[{gI1}]]]*
   ...
   sum[gI1, 1, 6, sum[gI2, 1, 6, B0[p^2, Mass2[Chi[{gI2}]], Mass2[Se[{gI1}]]]*
  ...
  -sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fv[{gI2}]], Mass2[Hpm[{gI1}]]]*
   ...
   sum[gI1, 1, 6, sum[gI2, 1, 6, B1[p^2, Mass2[Chi[{gI2}]], Mass2[Se[{gI1}]]]*
 ...
 {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fu[{gI2}]], Mass2[Hpm[{gI1}]]]*
   ...
   sum[gI1, 1, 6, sum[gI2, 1, 6, B0[p^2, Mass2[Chi[{gI2}]], Mass2[Sd[{gI1}]]]*
  ...
  -sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fu[{gI2}]], Mass2[Hpm[{gI1}]]]*
   ...
   sum[gI1, 1, 6, sum[gI2, 1, 6, B1[p^2, Mass2[Chi[{gI2}]], Mass2[Sd[{gI1}]]]*
 ...
 {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fd[{gI2}]], Mass2[Hpm[{gI1}]]]*
   ...
   sum[gI1, 1, 6, sum[gI2, 1, 6, B0[p^2, Mass2[Chi[{gI2}]], Mass2[Su[{gI1}]]]*
  ...
  -sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fd[{gI2}]], Mass2[Hpm[{gI1}]]]*
   ...
   sum[gI1, 1, 6, sum[gI2, 1, 6, B1[p^2, Mass2[Chi[{gI2}]], Mass2[Su[{gI1}]]]*
