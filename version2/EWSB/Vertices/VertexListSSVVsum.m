{{{Ah[{gt1}], Ah[{gt2}], conj[VWm[{lt3}]], VWm[{lt4}]}, 
 ...
 {{Sd[{gt1, ct1}], conj[Sd[{gt2, ct2}]], VG[{ct3, lt3}], VZ[{lt4}]}, 
  {(-I/6)*g3*Lam[ct3, ct2, ct1]*
    ((3*g2*Cos[ThetaW]*Cos[ThetaWp] + g1*Cos[ThetaWp]*Sin[ThetaW] - 
       6*gp*Qq*Sin[ThetaWp])*sumExp[j1, 1, 3, conj[ZD[gt1, j1]]*
        ZD[gt2, j1]] - 2*(g1*Cos[ThetaWp]*Sin[ThetaW] - 3*gp*Qd*Sin[ThetaWp])*
      sumExp[j1, 1, 3, conj[ZD[gt1, 3 + j1]]*ZD[gt2, 3 + j1]]), 
   ...
   VZp[{lt4}]}, {(I/6)*g3*Lam[ct3, ct2, ct1]*
    ((6*gp*Qq*Cos[ThetaWp] + (3*g2*Cos[ThetaW] + g1*Sin[ThetaW])*
        Sin[ThetaWp])*sumExp[j1, 1, 3, conj[ZD[gt1, j1]]*ZD[gt2, j1]] - 
     2*(3*gp*Qd*Cos[ThetaWp] + g1*Sin[ThetaW]*Sin[ThetaWp])*
      sumExp[j1, 1, 3, conj[ZD[gt1, 3 + j1]]*ZD[gt2, 3 + j1]]), 
   g[lt3, lt4]}}, {{Sd[{gt1, ct1}], conj[Su[{gt2, ct2}]], conj[VWm[{lt3}]], 
   VG[{ct4, lt4}]}, {(I*g2*g3*Lam[ct4, ct2, ct1]*sumExp[j1, 1, 3, 
 ...
 {{Sd[{gt1, ct1}], conj[Sd[{gt2, ct2}]], VP[{lt3}], VZ[{lt4}]}, 
  {(I/18)*Delta[ct1, ct2]*(-((g1*Cos[ThetaW] - 3*g2*Sin[ThetaW])*
       ...
       3*gp*Qd*Sin[ThetaWp])*sumExp[j1, 1, 3, conj[ZD[gt1, 3 + j1]]*
        ZD[gt2, 3 + j1]]), g[lt3, lt4]}}, 
 {{Sd[{gt1, ct1}], conj[Sd[{gt2, ct2}]], VP[{lt3}], VZp[{lt4}]}, 
  {(I/18)*Delta[ct1, ct2]*((g1*Cos[ThetaW] - 3*g2*Sin[ThetaW])*
   ...
   VP[{lt4}]}, {((I/3)*g1*g2*Cos[ThetaW]*Delta[ct1, ct2]*
     sumExp[j1, 1, 3, conj[ZD[gt1, j1]]*ZU[gt2, j1]])/Sqrt[2], g[lt3, lt4]}}, 
 ...
 {{Sd[{gt1, ct1}], conj[Sd[{gt2, ct2}]], VZ[{lt3}], VZ[{lt4}]}, 
  {(I/18)*Delta[ct1, ct2]*
    ((3*g2*Cos[ThetaW]*Cos[ThetaWp] + g1*Cos[ThetaWp]*Sin[ThetaW] - 
        6*gp*Qq*Sin[ThetaWp])^2*sumExp[j1, 1, 3, conj[ZD[gt1, j1]]*
        ZD[gt2, j1]] + 4*(g1*Cos[ThetaWp]*Sin[ThetaW] - 3*gp*Qd*Sin[ThetaWp])^
       2*sumExp[j1, 1, 3, conj[ZD[gt1, 3 + j1]]*ZD[gt2, 3 + j1]]), 
 ...
 {{Su[{gt1, ct1}], conj[Su[{gt2, ct2}]], VG[{ct3, lt3}], VZ[{lt4}]}, 
  {(I/6)*g3*Lam[ct3, ct2, ct1]*
    ((3*g2*Cos[ThetaW]*Cos[ThetaWp] - g1*Cos[ThetaWp]*Sin[ThetaW] + 
       6*gp*Qq*Sin[ThetaWp])*sumExp[j1, 1, 3, conj[ZU[gt1, j1]]*
        ZU[gt2, j1]] - 2*(2*g1*Cos[ThetaWp]*Sin[ThetaW] + 
       3*gp*Qu*Sin[ThetaWp])*sumExp[j1, 1, 3, conj[ZU[gt1, 3 + j1]]*
        ZU[gt2, 3 + j1]]), g[lt3, lt4]}}, 
 {{Su[{gt1, ct1}], conj[Su[{gt2, ct2}]], VG[{ct3, lt3}], VZp[{lt4}]}, 
  {(I/6)*g3*Lam[ct3, ct2, ct1]*
    ((6*gp*Qq*Cos[ThetaWp] + (-3*g2*Cos[ThetaW] + g1*Sin[ThetaW])*
        Sin[ThetaWp])*sumExp[j1, 1, 3, conj[ZU[gt1, j1]]*ZU[gt2, j1]] + 
 ...
 {{Su[{gt1, ct1}], conj[Su[{gt2, ct2}]], VP[{lt3}], VZp[{lt4}]}, 
  {(I/18)*Delta[ct1, ct2]*((g1*Cos[ThetaW] + 3*g2*Sin[ThetaW])*
     ...
     8*g1*(-3*gp*Qu*Cos[ThetaW]*Cos[ThetaWp] + g1*Sin[2*ThetaW]*Sin[ThetaWp])*
      sumExp[j1, 1, 3, conj[ZU[gt1, 3 + j1]]*ZU[gt2, 3 + j1]]), 
   g[lt3, lt4]}}, {{Su[{gt1, ct1}], conj[Sd[{gt2, ct2}]], VWm[{lt3}], 
   VZ[{lt4}]}, {((-I/3)*g2*Delta[ct1, ct2]*(g1*Cos[ThetaWp]*Sin[ThetaW] - 
      6*gp*Qq*Sin[ThetaWp])*sumExp[j1, 1, 3, conj[ZU[gt1, j1]]*ZD[gt2, j1]])/
 ...
 {{Su[{gt1, ct1}], conj[Su[{gt2, ct2}]], VZ[{lt3}], VZ[{lt4}]}, 
  {(I/18)*Delta[ct1, ct2]*
    ((3*g2*Cos[ThetaW]*Cos[ThetaWp] - g1*Cos[ThetaWp]*Sin[ThetaW] + 
        6*gp*Qq*Sin[ThetaWp])^2*sumExp[j1, 1, 3, conj[ZU[gt1, j1]]*
        ZU[gt2, j1]] + 4*(2*g1*Cos[ThetaWp]*Sin[ThetaW] + 
        3*gp*Qu*Sin[ThetaWp])^2*sumExp[j1, 1, 3, conj[ZU[gt1, 3 + j1]]*
        ZU[gt2, 3 + j1]]), g[lt3, lt4]}}, 
  ...
  {(I/18)*Delta[ct1, ct2]*((-6*g1*gp*Qq*Cos[ThetaWp]^2*Sin[ThetaW] - 
       ...
       6*g1*gp*Qq*Sin[ThetaW]*Sin[ThetaWp]^2 + 6*g2*Cos[ThetaW]*
        (3*gp*Qq*Cos[ThetaWp]^2 + g1*Cos[ThetaWp]*Sin[ThetaW]*Sin[ThetaWp] - 
         3*gp*Qq*Sin[ThetaWp]^2))*sumExp[j1, 1, 3, conj[ZU[gt1, j1]]*
      ...
      sumExp[j1, 1, 3, conj[ZU[gt1, 3 + j1]]*ZU[gt2, 3 + j1]]), 
   g[lt3, lt4]}}, {{Su[{gt1, ct1}], conj[Su[{gt2, ct2}]], VZp[{lt3}], 
   VZp[{lt4}]}, {(I/18)*Delta[ct1, ct2]*
    ((6*gp*Qq*Cos[ThetaWp] + (-3*g2*Cos[ThetaW] + g1*Sin[ThetaW])*
         Sin[ThetaWp])^2*sumExp[j1, 1, 3, conj[ZU[gt1, j1]]*ZU[gt2, j1]] + 
     4*(3*gp*Qu*Cos[ThetaWp] - 2*g1*Sin[ThetaW]*Sin[ThetaWp])^2*
      sumExp[j1, 1, 3, conj[ZU[gt1, 3 + j1]]*ZU[gt2, 3 + j1]]), 
   g[lt3, lt4]}}, {{Sv[{gt1}], conj[Se[{gt2}]], VP[{lt3}], VWm[{lt4}]}, 
 ...
 {{Sv[{gt1}], conj[Se[{gt2}]], VWm[{lt3}], VZp[{lt4}]}, 
  ...
  {(I/2)*(conj[ZV[gt1, 1]]*(g2*Cos[ThetaW]*Cos[ThetaWp] + 
     ...
     conj[ZV[gt1, 3]]*(g2*Cos[ThetaW]*Cos[ThetaWp] + g1*Cos[ThetaWp]*
         Sin[ThetaW] + 2*gp*Ql3*Sin[ThetaWp])^2*ZV[gt2, 3]), g[lt3, lt4]}}, 
 {{Sv[{gt1}], conj[Sv[{gt2}]], VZ[{lt3}], VZp[{lt4}]}, 
  {(I/2)*(-(conj[ZV[gt1, 1]]*(-2*g1*gp*Ql1*Cos[ThetaWp]^2*Sin[ThetaW] + 
     ...
     conj[ZV[gt1, 3]]*(-2*g1*gp*Ql3*Cos[ThetaWp]^2*Sin[ThetaW] + 
       g2^2*Cos[ThetaW]^2*Cos[ThetaWp]*Sin[ThetaWp] + 
       Cos[ThetaWp]*(-4*gp^2*Ql3^2 + g1^2*Sin[ThetaW]^2)*Sin[ThetaWp] + 
       2*g1*gp*Ql3*Sin[ThetaW]*Sin[ThetaWp]^2 + 2*g2*Cos[ThetaW]*
        (-(gp*Ql3*Cos[ThetaWp]^2) + g1*Cos[ThetaWp]*Sin[ThetaW]*
          Sin[ThetaWp] + gp*Ql3*Sin[ThetaWp]^2))*ZV[gt2, 3]), g[lt3, lt4]}}, 
 {{Sv[{gt1}], conj[Sv[{gt2}]], VZp[{lt3}], VZp[{lt4}]}, 
  {(I/2)*(conj[ZV[gt1, 1]]*(-2*gp*Ql1*Cos[ThetaWp] + 
     ...
     conj[ZV[gt1, 2]]*(-2*gp*Ql2*Cos[ThetaWp] + 
        (g2*Cos[ThetaW] + g1*Sin[ThetaW])*Sin[ThetaWp])^2*ZV[gt2, 2] + 
     conj[ZV[gt1, 3]]*(-2*gp*Ql3*Cos[ThetaWp] + 
        (g2*Cos[ThetaW] + g1*Sin[ThetaW])*Sin[ThetaWp])^2*ZV[gt2, 3]), 
   g[lt3, lt4]}}}
