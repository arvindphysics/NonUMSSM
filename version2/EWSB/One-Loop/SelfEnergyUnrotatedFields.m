{{sum[gI1, 1, 3, Mass[Fd[{gI1}]]*sum[gI2, 1, 6, 
 ...
 B00[p^2, Mass2[gWm], Mass2[gWm]]*conj[Cp[VZp, bar[gWm], gWm]]*
     ...
     H0[p^2, Mass2[Cha[{gI1}]], Mass2[Cha[{gI2}]]]*
      (conj[Cp[VZp, bar[Cha[{gI1}]], Cha[{gI2}]][PL]]*
       ...
       conj[Cp[VZp, bar[Cha[{gI1}]], Cha[{gI2}]][PR]]*
        Cp[VZp, bar[Cha[{gI1}]], Cha[{gI2}]][PR])]] + 
  sum[gI1, 1, 3, A0[Mass2[Ah[{gI1}]]]*Cp[VZp, VZp, Ah[{gI1}], Ah[{gI1}]]]/2 + 
  sum[gI1, 1, 3, A0[Mass2[Sv[{gI1}]]]*Cp[VZp, VZp, conj[Sv[{gI1}]], 
     Sv[{gI1}]]] + sum[gI1, 1, 3, A0[Mass2[hh[{gI1}]]]*
  ...
  sum[gI1, 1, 3, sum[gI2, 1, 3, 4*B0[p^2, Mass2[Fe[{gI1}]], Mass2[Fe[{gI2}]]]*
      Mass[Fe[{gI1}]]*Mass[Fe[{gI2}]]*
      Re[conj[Cp[VZp, bar[Fe[{gI1}]], Fe[{gI2}]][PL]]*
  ...
  sum[gI1, 1, 3, sum[gI2, 1, 3, 4*B0[p^2, Mass2[Fv[{gI1}]], Mass2[Fv[{gI2}]]]*
      Mass[Fv[{gI1}]]*Mass[Fv[{gI2}]]*
      Re[conj[Cp[VZp, bar[Fv[{gI1}]], Fv[{gI2}]][PL]]*
 ...
 B00[p^2, Mass2[gWm], Mass2[gP]]*conj[Cp[conj[VWm], bar[gP], gWm]]*
  ...
  (2*rMS*Mass2[VZp]*Cp[VWm, conj[VWm], VZp, VZp][1] - 
    A0[Mass2[VZp]]*(4*Cp[VWm, conj[VWm], VZp, VZp][1] + 
      Cp[VWm, conj[VWm], VZp, VZp][2] + Cp[VWm, conj[VWm], VZp, VZp][3]))/2 + 
