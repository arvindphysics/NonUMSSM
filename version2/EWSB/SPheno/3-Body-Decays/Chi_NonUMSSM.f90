...
& gTAh,gThh,gTHpm,gTSd,gTSe,gTSu,gTSv,gTVWm,gTVZ,gTVZp,gChiChicChaCha,gChiChiChiChi,     & 
& gChiChicFdFd,gChiChicFeFe,gChiChicFuFu,gChiChacFdFu,gChiChacFeFv,gChiChicFvFv,         & 
& gChiFdcFdGlu,gChiFucFuGlu,epsI,deltaM,CheckRealStates,gT,gPartial,BR)
...
& gChiChicFuFu(6,6,3,3),gChiChacFdFu(6,2,3,3),gChiChacFeFv(6,2,3,3),gChiChicFvFv(6,6,3,3),& 
...
& gChiChicFuFui(6,3,3),gChiChacFdFui(2,3,3),gChiChacFeFvi(2,3,3),gChiChicFvFvi(6,3,3),   & 
...
& Tmup,vd,vu,vS,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,   & 
...
gChiChicFvFvi = 0._dp 
Call ChiToChicFvFv(i_run,MChi,MFv,MVZ,MVZp,MSv,cplcFvChiSvL,cplcFvChiSvR,             & 
& cplcFvFvVZL,cplcFvFvVZR,cplcFvFvVZpL,cplcFvFvVZpR,cplChiChiVZL,cplChiChiVZR,           & 
& cplChiChiVZpL,cplChiChiVZpR,cplChiFvcSvL,cplChiFvcSvR,IntegralSs,IntegralSSss,         & 
& IntegralSSst,IntegralVs,IntegralVSst,IntegralVVss,NSs,NSSss,NSSst,NVs,NVSst,           & 
& NVVss,gTVZtemp,gTVZptemp,gTSvtemp,deltaM,epsI,check,gChiChicFvFvi)
...
Real(dp),Intent(in) :: MCha(2),MFe(3),MFv(3),MVWm,MHpm(2),MSv(3),MSe(6),MChi(6)

Complex(dp),Intent(in) :: cplcFeChaSvL(3,2,3),cplcFeChaSvR(3,2,3),cplcFeChiSeL(3,6,6),cplcFeChiSeR(3,6,6),      & 
& cplcFeFvHpmL(3,3,2),cplcFeFvHpmR(3,3,2),cplcFeFvVWmL(3,3),cplcFeFvVWmR(3,3),           & 
& cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),   & 
& cplChiChacVWmL(6,2),cplChiChacVWmR(6,2),cplChiFvcSvL(6,3,3),cplChiFvcSvR(6,3,3)
...
Subroutine ChiToChicFvFv(iIN,MChi,MFv,MVZ,MVZp,MSv,cplcFvChiSvL,cplcFvChiSvR,         & 
& cplcFvFvVZL,cplcFvFvVZR,cplcFvFvVZpL,cplcFvFvVZpR,cplChiChiVZL,cplChiChiVZR,           & 
& cplChiChiVZpL,cplChiChiVZpR,cplChiFvcSvL,cplChiFvcSvR,IntegralSs,IntegralSSss,         & 
& IntegralSSst,IntegralVs,IntegralVSst,IntegralVVss,NSs,NSSss,NSSst,NVs,NVSst,           & 
& NVVss,gTVZ,gTVZp,gTSv,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MChi(6),MFv(3),MVZ,MVZp,MSv(3)

Complex(dp),Intent(in) :: cplcFvChiSvL(3,6,3),cplcFvChiSvR(3,6,3),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),            & 
& cplcFvFvVZpL(3,3),cplcFvFvVZpR(3,3),cplChiChiVZL(6,6),cplChiChiVZR(6,6),               & 
...
Real(dp),Intent(inout) :: gTVZ,gTVZp,gTSv(3)
...
End Module Chi3Decays_NonUMSSM 
