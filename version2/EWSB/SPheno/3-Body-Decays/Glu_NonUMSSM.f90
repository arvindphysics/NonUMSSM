...
& gTSd,gTSu,gGluFdcFdChi,gGluFdcFucCha,gGluFucFuChi,epsI,deltaM,CheckRealStates,         & 
& gT,gPartial,BR)
...
Real(dp),Intent(inout) :: gGluFdcFdChi(1,3,3,6),gGluFdcFucCha(1,3,3,2),gGluFucFuChi(1,3,3,6)

Real(dp),Intent(in) :: gTSd(6),gTSu(6)

Real(dp) :: gGluFdcFdChii(3,3,6),gGluFdcFucChai(3,3,2),gGluFucFuChii(3,3,6)
...
& vu,vS,cplcChacFuSdL,cplcChacFuSdR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdChiSdL,            & 
...
Real(dp),Intent(in) :: MFd(3),MChi(6),MSd(6),MGlu
...
Real(dp),Intent(in) :: MFu(3),MChi(6),MSu(6),MGlu
...
End Module Glu3Decays_NonUMSSM 
