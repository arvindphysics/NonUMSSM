...
Real(dp) :: ms21L 
Real(dp) :: ms22L 
Real(dp) :: mass_uncertainty_Q(50), mass_uncertainty_Yt(50), g_SM_save(62) 
...
Real(dp) :: g1IN,g2IN,g3IN,gpIN,lamIN,TlamIN,ml012IN,ml022IN,ml032IN,mHd2IN,mHu2IN,               & 
& me012IN,me022IN,me032IN,ms2IN

Complex(dp) :: YdIN(3,3),Ye11IN,Ye22IN,Ye33IN,YuIN(3,3),TdIN(3,3),TYe11IN,TYe22IN,TYe33IN,           & 
& TuIN(3,3),mq2IN(3,3),md2IN(3,3),mu2IN(3,3),M1IN,M2IN,M3IN,M4IN,TdpIN(3,3),             & 
& TepIN,TmupIN

Real(dp) :: g1MZ,g2MZ,g3MZ,gpMZ,lamMZ,TlamMZ,ml012MZ,ml022MZ,ml032MZ,mHd2MZ,mHu2MZ,               & 
& me012MZ,me022MZ,me032MZ,ms2MZ

Complex(dp) :: YdMZ(3,3),Ye11MZ,Ye22MZ,Ye33MZ,YuMZ(3,3),TdMZ(3,3),TYe11MZ,TYe22MZ,TYe33MZ,           & 
& TuMZ(3,3),mq2MZ(3,3),md2MZ(3,3),mu2MZ(3,3),M1MZ,M2MZ,M3MZ,M4MZ,TdpMZ(3,3),             & 
& TepMZ,TmupMZ

Real(dp) :: g1GUT,g2GUT,g3GUT,gpGUT,lamGUT,TlamGUT,ml012GUT,ml022GUT,ml032GUT,mHd2GUT,            & 
& mHu2GUT,me012GUT,me022GUT,me032GUT,ms2GUT

Complex(dp) :: YdGUT(3,3),Ye11GUT,Ye22GUT,Ye33GUT,YuGUT(3,3),TdGUT(3,3),TYe11GUT,TYe22GUT,           & 
& TYe33GUT,TuGUT(3,3),mq2GUT(3,3),md2GUT(3,3),mu2GUT(3,3),M1GUT,M2GUT,M3GUT,             & 
& M4GUT,TdpGUT(3,3),TepGUT,TmupGUT
...
Real(dp) :: gPSd(6,1356),gTSd(6),BRSd(6,1356),gPSu(6,1356),gTSu(6),BRSu(6,1356),gPSe(6,1227),     & 
...
Real(dp) :: gP1LSd(6,87),gT1LSd(6),BR1LSd(6,87),gP1LSu(6,87),gT1LSu(6),BR1LSu(6,87),              & 
& gP1LSe(6,72),gT1LSe(6),BR1LSe(6,72),gP1LSv(3,57),gT1LSv(3),BR1LSv(3,57),               & 
& gP1Lhh(3,215),gT1Lhh(3),BR1Lhh(3,215),gP1LAh(3,213),gT1LAh(3),BR1LAh(3,213),           & 
& gP1LHpm(2,98),gT1LHpm(2),BR1LHpm(2,98),gP1LVZp(1,190),gT1LVZp,BR1LVZp(1,190),          & 
& gP1LGlu(1,50),gT1LGlu,BR1LGlu(1,50),gP1LChi(6,110),gT1LChi(6),BR1LChi(6,110),          & 
& gP1LCha(2,89),gT1LCha(2),BR1LCha(2,89),gP1LFu(3,84),gT1LFu(3),BR1LFu(3,84)
...
Logical, save :: InputValueforTdp =.False. 
...
& vS,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yu,Td,TYe11,TYe22,TYe33,Tlam,Tu,mq2,              & 
& ml012,ml022,ml032,mHd2,mHu2,md2,mu2,me012,me022,me032,ms2,M1,M2,M3,M4,Tdp,             & 
& Tep,Tmup,MZsuffix)
...
End Module Model_Data_NonUMSSM