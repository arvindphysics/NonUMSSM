...
Module Wrapper_OneLoopDecay_Cha_NonUMSSM
Use Model_Data_NonUMSSM
Use Kinematics
Use OneLoopDecay_Cha_NonUMSSM
Use Control
Use Settings
...
Subroutine OneLoopDecay_Cha(MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,MFv2OS,MSuOS,             &
...
& cplSvcSvVZ,cplSvcSvVZp,ctcplcChacFuSdL,ctcplcChacFuSdR,ctcplcChacFvSeL,ctcplcChacFvSeR,&
...
Complex(dp),Intent(in) :: cplSdcSdVP(6,6),cplSdcSdVZ(6,6),cplSdcSdVZp(6,6),cplSdcSucVWm(6,6),cplSecHpmcSv(6,2,3),&
& cplSecSeVP(6,6),cplSecSeVZ(6,6),cplSecSeVZp(6,6),cplSecSvcVWm(6,3),cplSucSdVWm(6,6),   &
& cplSucSuVG(6,6),cplSucSuVP(6,6),cplSucSuVZ(6,6),cplSucSuVZp(6,6),cplSvcSeVWm(3,6),     &
& cplSvcSvVZ(3,3),cplSvcSvVZp(3,3),ctcplcChacFuSdL(2,3,6),ctcplcChacFuSdR(2,3,6),        &
& ctcplcChacFvSeL(2,3,6),ctcplcChacFvSeR(2,3,6),ctcplcChaChaAhL(2,2,3),ctcplcChaChaAhR(2,2,3),&
& ctcplcChaChahhL(2,2,3),ctcplcChaChahhR(2,2,3),ctcplcChaChaVPL(2,2),ctcplcChaChaVPR(2,2),&
& ctcplcChaChaVZL(2,2),ctcplcChaChaVZpL(2,2),ctcplcChaChaVZpR(2,2),ctcplcChaChaVZR(2,2), &
& ctcplcChaChiHpmL(2,6,2),ctcplcChaChiHpmR(2,6,2),ctcplcChaChiVWmL(2,6),ctcplcChaChiVWmR(2,6),&
& ctcplcChaFdcSuL(2,3,6),ctcplcChaFdcSuR(2,3,6),ctcplcChaFecSvL(2,3,3),ctcplcChaFecSvR(2,3,3),&
& GcplcChaChiHpmL(2,6,2),GcplcChaChiHpmR(2,6,2),GcplcHpmVPVWm(2),GcplHpmcVWmVP(2),       &
& GosZcplcChaChiHpmL(2,6,2),GosZcplcChaChiHpmR(2,6,2),GosZcplcHpmVPVWm(2),               &
& GosZcplHpmcVWmVP(2),GZcplcChaChiHpmL(2,6,2),GZcplcChaChiHpmR(2,6,2),GZcplcHpmVPVWm(2), &
& GZcplHpmcVWmVP(2),ZcplcChacFuSdL(2,3,6),ZcplcChacFuSdR(2,3,6),ZcplcChacFvSeL(2,3,6),   &
& ZcplcChacFvSeR(2,3,6),ZcplcChaChaAhL(2,2,3),ZcplcChaChaAhR(2,2,3),ZcplcChaChahhL(2,2,3),&
& ZcplcChaChahhR(2,2,3),ZcplcChaChaVPL(2,2),ZcplcChaChaVPR(2,2),ZcplcChaChaVZL(2,2),     &
& ZcplcChaChaVZpL(2,2),ZcplcChaChaVZpR(2,2),ZcplcChaChaVZR(2,2),ZcplcChaChiHpmL(2,6,2),  &
& ZcplcChaChiHpmR(2,6,2),ZcplcChaChiVWmL(2,6),ZcplcChaChiVWmR(2,6),ZcplcChaFdcSuL(2,3,6),&
...
& ZcplChaFvcSeR(2,3,6),ZcplChiChacHpmL(6,2,2),ZcplChiChacHpmR(6,2,2),ZcplChiChacVWmL(6,2),&
& ZcplChiChacVWmR(6,2),ZcplcHpmVPVWm(2),ZcplcVWmVPVWm,ZcplHpmcHpmVP(2,2),ZcplHpmcVWmVP(2),&
...
Real(dp) :: MRPChaToChiHpm(2,6,2),MRGChaToChiHpm(2,6,2), MRPZChaToChiHpm(2,6,2),MRGZChaToChiHpm(2,6,2)
Real(dp) :: MVPChaToChiHpm(2,6,2)
Real(dp) :: RMsqTreeChaToChiHpm(2,6,2),RMsqWaveChaToChiHpm(2,6,2),RMsqVertexChaToChiHpm(2,6,2)
Complex(dp) :: AmpTreeChaToChiHpm(2,2,6,2),AmpWaveChaToChiHpm(2,2,6,2)=(0._dp,0._dp),AmpVertexChaToChiHpm(2,2,6,2)&
 & ,AmpVertexIRosChaToChiHpm(2,2,6,2),AmpVertexIRdrChaToChiHpm(2,2,6,2), AmpSumChaToChiHpm(2,2,6,2), AmpSum2ChaToChiHpm(2,2,6,2)
Complex(dp) :: AmpTreeZChaToChiHpm(2,2,6,2),AmpWaveZChaToChiHpm(2,2,6,2),AmpVertexZChaToChiHpm(2,2,6,2)
Real(dp) :: AmpSqChaToChiHpm(2,6,2),  AmpSqTreeChaToChiHpm(2,6,2)
Real(dp) :: MRPChaToChiVWm(2,6),MRGChaToChiVWm(2,6), MRPZChaToChiVWm(2,6),MRGZChaToChiVWm(2,6)
Real(dp) :: MVPChaToChiVWm(2,6)
Real(dp) :: RMsqTreeChaToChiVWm(2,6),RMsqWaveChaToChiVWm(2,6),RMsqVertexChaToChiVWm(2,6)
Complex(dp) :: AmpTreeChaToChiVWm(4,2,6),AmpWaveChaToChiVWm(4,2,6)=(0._dp,0._dp),AmpVertexChaToChiVWm(4,2,6)&
 & ,AmpVertexIRosChaToChiVWm(4,2,6),AmpVertexIRdrChaToChiVWm(4,2,6), AmpSumChaToChiVWm(4,2,6), AmpSum2ChaToChiVWm(4,2,6)
Complex(dp) :: AmpTreeZChaToChiVWm(4,2,6),AmpWaveZChaToChiVWm(4,2,6),AmpVertexZChaToChiVWm(4,2,6)
Real(dp) :: AmpSqChaToChiVWm(2,6),  AmpSqTreeChaToChiVWm(2,6)
...
Call Amplitude_Tree_NonUMSSM_ChaToChaAh(cplcChaChaAhL,cplcChaChaAhR,MAh,              &
& MCha,MAh2,MCha2,AmpTreeChaToChaAh)

  Else
Call Amplitude_Tree_NonUMSSM_ChaToChaAh(ZcplcChaChaAhL,ZcplcChaChaAhR,MAh,            &
& MCha,MAh2,MCha2,AmpTreeChaToChaAh)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_ChaToChaAh(MLambda,em,gs,cplcChaChaAhL,cplcChaChaAhR,        &
& MAhOS,MChaOS,MRPChaToChaAh,MRGChaToChaAh)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_ChaToChaAh(MLambda,em,gs,ZcplcChaChaAhL,ZcplcChaChaAhR,      &
& MAhOS,MChaOS,MRPChaToChaAh,MRGChaToChaAh)
...
Call Amplitude_WAVE_NonUMSSM_ChaToChaAh(cplcChaChaAhL,cplcChaChaAhR,ctcplcChaChaAhL,  &
& ctcplcChaChaAhR,MAh,MAh2,MCha,MCha2,ZfAh,ZfLm,ZfLp,AmpWaveChaToChaAh)



!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_ChaToChaAh(MAh,MCha,MChi,MFd,MFe,MFu,MFv,              &
...
If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_ChaToChaAh(MAh,MCha,MChi,MFd,MFe,MFu,               &
...
& cplcChacFvSeL,cplcChacFvSeR,AmpVertexIRdrChaToChaAh)

 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_ChaToChaAh(MAhOS,MChaOS,MChiOS,MFdOS,               &
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_ChaToChahh(cplcChaChahhL,cplcChaChahhR,MCha,             &
& Mhh,MCha2,Mhh2,AmpTreeChaToChahh)

  Else
Call Amplitude_Tree_NonUMSSM_ChaToChahh(ZcplcChaChahhL,ZcplcChaChahhR,MCha,           &
& Mhh,MCha2,Mhh2,AmpTreeChaToChahh)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_ChaToChahh(MLambda,em,gs,cplcChaChahhL,cplcChaChahhR,        &
& MChaOS,MhhOS,MRPChaToChahh,MRGChaToChahh)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_ChaToChahh(MLambda,em,gs,ZcplcChaChahhL,ZcplcChaChahhR,      &
& MChaOS,MhhOS,MRPChaToChahh,MRGChaToChahh)
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_ChaToChahh(cplcChaChahhL,cplcChaChahhR,ctcplcChaChahhL,  &
& ctcplcChaChahhR,MCha,MCha2,Mhh,Mhh2,Zfhh,ZfLm,ZfLp,AmpWaveChaToChahh)



!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_ChaToChahh(MAh,MCha,MChi,MFd,MFe,MFu,MFv,              &
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            &
& MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,cplcChaChaAhL,     &
...
If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_ChaToChahh(MAh,MCha,MChi,MFd,MFe,MFu,               &
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             &
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,              &
...
& cplcChacFvSeR,AmpVertexIRdrChaToChahh)
 ...
 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_ChaToChahh(MAhOS,MChaOS,MChiOS,MFdOS,               &
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,               &
& MVZpOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,              &
& MSd2OS,MSe2OS,MSu2OS,MSv2OS,MVP2,MVWm2OS,MVZ2OS,MVZp2OS,cplAhAhhh,cplcChaChaAhL,       &
& cplcChaChaAhR,cplAhhhVZ,cplAhhhVZp,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,       &
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_ChaToChaVZ(cplcChaChaVZL,cplcChaChaVZR,MCha,             &
& MVZ,MCha2,MVZ2,AmpTreeChaToChaVZ)

  Else
Call Amplitude_Tree_NonUMSSM_ChaToChaVZ(ZcplcChaChaVZL,ZcplcChaChaVZR,MCha,           &
& MVZ,MCha2,MVZ2,AmpTreeChaToChaVZ)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_ChaToChaVZ(MLambda,em,gs,cplcChaChaVZL,cplcChaChaVZR,        &
& MChaOS,MVZOS,MRPChaToChaVZ,MRGChaToChaVZ)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_ChaToChaVZ(MLambda,em,gs,ZcplcChaChaVZL,ZcplcChaChaVZR,      &
& MChaOS,MVZOS,MRPChaToChaVZ,MRGChaToChaVZ)
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_ChaToChaVZ(cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,    &
...
!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_ChaToChaVZ(MAh,MCha,MChi,MFd,MFe,MFu,MFv,              &
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            &
...
If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_ChaToChaVZ(MAh,MCha,MChi,MFd,MFe,MFu,               &
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             &
...
& cplcVWmVWmVZ,AmpVertexIRdrChaToChaVZ)
 ...
 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_ChaToChaVZ(MAhOS,MChaOS,MChiOS,MFdOS,               &
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,               &
& MVZpOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,              &
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_ChaToChaVZp(cplcChaChaVZpL,cplcChaChaVZpR,               &
& MCha,MVZp,MCha2,MVZp2,AmpTreeChaToChaVZp)

  Else
Call Amplitude_Tree_NonUMSSM_ChaToChaVZp(ZcplcChaChaVZpL,ZcplcChaChaVZpR,             &
& MCha,MVZp,MCha2,MVZp2,AmpTreeChaToChaVZp)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_ChaToChaVZp(MLambda,em,gs,cplcChaChaVZpL,cplcChaChaVZpR,     &
& MChaOS,MVZpOS,MRPChaToChaVZp,MRGChaToChaVZp)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_ChaToChaVZp(MLambda,em,gs,ZcplcChaChaVZpL,ZcplcChaChaVZpR,   &
& MChaOS,MVZpOS,MRPChaToChaVZp,MRGChaToChaVZp)
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_ChaToChaVZp(cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,   &
& cplcChaChaVZR,cplcChaChaVZpL,cplcChaChaVZpR,ctcplcChaChaVPL,ctcplcChaChaVPR,           &
& ctcplcChaChaVZL,ctcplcChaChaVZR,ctcplcChaChaVZpL,ctcplcChaChaVZpR,MCha,MCha2,          &
...
!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_ChaToChaVZp(MAh,MCha,MChi,MFd,MFe,MFu,MFv,             &
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            &
& MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,               &
...
If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_ChaToChaVZp(MAh,MCha,MChi,MFd,MFe,MFu,              &
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             &
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,          &
& cplcChaChaAhR,cplAhhhVZp,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,  &
& cplChaFucSdL,cplChaFucSdR,cplChaFvcSeL,cplChaFvcSeR,cplcChaChahhL,cplcChaChahhR,       &
...
& cplcHpmVWmVZp,cplcVWmVWmVZp,AmpVertexIRdrChaToChaVZp)
 ...
 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_ChaToChaVZp(MAhOS,MChaOS,MChiOS,MFdOS,              &
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,               &
& MVZpOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,              &
& MSd2OS,MSe2OS,MSu2OS,MSv2OS,MVP2,MVWm2OS,MVZ2OS,MVZp2OS,cplcChaChaAhL,cplcChaChaAhR,   &
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_ChaToChiHpm(cplcChaChiHpmL,cplcChaChiHpmR,               &
& MCha,MChi,MHpm,MCha2,MChi2,MHpm2,AmpTreeChaToChiHpm)

  Else
Call Amplitude_Tree_NonUMSSM_ChaToChiHpm(ZcplcChaChiHpmL,ZcplcChaChiHpmR,             &
& MCha,MChi,MHpm,MCha2,MChi2,MHpm2,AmpTreeChaToChiHpm)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_ChaToChiHpm(MLambda,em,gs,cplcChaChiHpmL,cplcChaChiHpmR,     &
& MChaOS,MChiOS,MHpmOS,MRPChaToChiHpm,MRGChaToChiHpm)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_ChaToChiHpm(MLambda,em,gs,ZcplcChaChiHpmL,ZcplcChaChiHpmR,   &
& MChaOS,MChiOS,MHpmOS,MRPChaToChiHpm,MRGChaToChiHpm)
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_ChaToChiHpm(cplcChaChiHpmL,cplcChaChiHpmR,               &
...
!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_ChaToChiHpm(MAh,MCha,MChi,MFd,MFe,MFu,MFv,             &
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            &
& MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,               &
...
If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_ChaToChiHpm(MAh,MCha,MChi,MFd,MFe,MFu,              &
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             &
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,          &
& cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplAhHpmcHpm,cplAhHpmcVWm,cplChiChacHpmL,      &
& cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,cplcChaChahhL,cplcChaChahhR,              &
...
& cplcChacFvSeR,AmpVertexIRdrChaToChiHpm)
 ...
 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_ChaToChiHpm(MAhOS,MChaOS,MChiOS,MFdOS,              &
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,               &
& MVZpOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,              &
& MSd2OS,MSe2OS,MSu2OS,MSv2OS,MVP2,MVWm2OS,MVZ2OS,MVZp2OS,cplcChaChaAhL,cplcChaChaAhR,   &
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_ChaToChiVWm(cplcChaChiVWmL,cplcChaChiVWmR,               &
& MCha,MChi,MVWm,MCha2,MChi2,MVWm2,AmpTreeChaToChiVWm)

  Else
Call Amplitude_Tree_NonUMSSM_ChaToChiVWm(ZcplcChaChiVWmL,ZcplcChaChiVWmR,             &
& MCha,MChi,MVWm,MCha2,MChi2,MVWm2,AmpTreeChaToChiVWm)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_ChaToChiVWm(MLambda,em,gs,cplcChaChiVWmL,cplcChaChiVWmR,     &
& MChaOS,MChiOS,MVWmOS,MRPChaToChiVWm,MRGChaToChiVWm)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_ChaToChiVWm(MLambda,em,gs,ZcplcChaChiVWmL,ZcplcChaChiVWmR,   &
& MChaOS,MChiOS,MVWmOS,MRPChaToChiVWm,MRGChaToChiVWm)
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_ChaToChiVWm(cplcChaChiVWmL,cplcChaChiVWmR,               &
...
!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_ChaToChiVWm(MAh,MCha,MChi,MFd,MFe,MFu,MFv,             &
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            &
& MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,               &
...
If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_ChaToChiVWm(MAh,MCha,MChi,MFd,MFe,MFu,              &
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             &
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,          &
& cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,    &
& cplChiChacVWmL,cplChiChacVWmR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,               &
...
& cplcVWmVWmVZp,AmpVertexIRdrChaToChiVWm)
 ...
 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_ChaToChiVWm(MAhOS,MChaOS,MChiOS,MFdOS,              &
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,               &
& MVZpOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,              &
& MSd2OS,MSe2OS,MSu2OS,MSv2OS,MVP2,MVWm2OS,MVZ2OS,MVZp2OS,cplcChaChaAhL,cplcChaChaAhR,   &
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_ChaToFdcSu(cplcChaFdcSuL,cplcChaFdcSuR,MCha,             &
& MFd,MSu,MCha2,MFd2,MSu2,AmpTreeChaToFdcSu)

  Else
Call Amplitude_Tree_NonUMSSM_ChaToFdcSu(ZcplcChaFdcSuL,ZcplcChaFdcSuR,MCha,           &
& MFd,MSu,MCha2,MFd2,MSu2,AmpTreeChaToFdcSu)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_ChaToFdcSu(MLambda,em,gs,cplcChaFdcSuL,cplcChaFdcSuR,        &
& MChaOS,MFdOS,MSuOS,MRPChaToFdcSu,MRGChaToFdcSu)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_ChaToFdcSu(MLambda,em,gs,ZcplcChaFdcSuL,ZcplcChaFdcSuR,      &
& MChaOS,MFdOS,MSuOS,MRPChaToFdcSu,MRGChaToFdcSu)
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_ChaToFdcSu(cplcChaFdcSuL,cplcChaFdcSuR,ctcplcChaFdcSuL,  &
...
!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_ChaToFdcSu(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,             &
...
If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_ChaToFdcSu(MAh,MCha,MChi,MFd,MFu,MGlu,              &
...
& cplSucSuVZp,AmpVertexIRdrChaToFdcSu)
 ...
 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_ChaToFdcSu(MAhOS,MChaOS,MChiOS,MFdOS,               &
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_ChaToFecSv(cplcChaFecSvL,cplcChaFecSvR,MCha,             &
& MFe,MSv,MCha2,MFe2,MSv2,AmpTreeChaToFecSv)

  Else
Call Amplitude_Tree_NonUMSSM_ChaToFecSv(ZcplcChaFecSvL,ZcplcChaFecSvR,MCha,           &
& MFe,MSv,MCha2,MFe2,MSv2,AmpTreeChaToFecSv)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_ChaToFecSv(MLambda,em,gs,cplcChaFecSvL,cplcChaFecSvR,        &
& MChaOS,MFeOS,MSvOS,MRPChaToFecSv,MRGChaToFecSv)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_ChaToFecSv(MLambda,em,gs,ZcplcChaFecSvL,ZcplcChaFecSvR,      &
& MChaOS,MFeOS,MSvOS,MRPChaToFecSv,MRGChaToFecSv)
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_ChaToFecSv(cplcChaFecSvL,cplcChaFecSvR,ctcplcChaFecSvL,  &
...
!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_ChaToFecSv(MAh,MCha,MChi,MFe,MFv,Mhh,MHpm,             &
...
& cplSvcSvVZ,cplSvcSvVZp,AmpVertexChaToFecSv)

If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_ChaToFecSv(MAh,MCha,MChi,MFe,MFv,Mhh,               &
...
& cplcFeFeVZpR,cplcChaFecSvL,cplcChaFecSvR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFvFecVWmL,    &
& cplcFvFecVWmR,cplhhSvcSv,cplcChacFvSeL,cplcChacFvSeR,cplSecHpmcSv,cplSecSvcVWm,        &
& cplSvcSvVZ,cplSvcSvVZp,AmpVertexIRdrChaToFecSv)

 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_ChaToFecSv(MAhOS,MChaOS,MChiOS,MFeOS,               &
...
& cplcFvFecVWmR,cplhhSvcSv,cplcChacFvSeL,cplcChacFvSeR,cplSecHpmcSv,cplSecSvcVWm,        &
& cplSvcSvVZ,cplSvcSvVZp,AmpVertexIRosChaToFecSv)
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_ChaTocFuSd(cplcChacFuSdL,cplcChacFuSdR,MCha,             &
& MFu,MSd,MCha2,MFu2,MSd2,AmpTreeChaTocFuSd)

  Else
Call Amplitude_Tree_NonUMSSM_ChaTocFuSd(ZcplcChacFuSdL,ZcplcChacFuSdR,MCha,           &
& MFu,MSd,MCha2,MFu2,MSd2,AmpTreeChaTocFuSd)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_ChaTocFuSd(MLambda,em,gs,cplcChacFuSdL,cplcChacFuSdR,        &
& MChaOS,MFuOS,MSdOS,MRPChaTocFuSd,MRGChaTocFuSd)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_ChaTocFuSd(MLambda,em,gs,ZcplcChacFuSdL,ZcplcChacFuSdR,      &
& MChaOS,MFuOS,MSdOS,MRPChaTocFuSd,MRGChaTocFuSd)
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_ChaTocFuSd(cplcChacFuSdL,cplcChacFuSdR,ctcplcChacFuSdL,  &
...
!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_ChaTocFuSd(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,             &
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              &
...
If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_ChaTocFuSd(MAh,MCha,MChi,MFd,MFu,MGlu,              &
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               &
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,cplcChaChaAhR,           &
...
& cplSdcHpmcSu,cplSdcSucVWm,AmpVertexIRdrChaTocFuSd)
 ...
 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_ChaTocFuSd(MAhOS,MChaOS,MChiOS,MFdOS,               &
& MFuOS,MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,              &
& MCha2OS,MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,               &
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_ChaTocFvSe(cplcChacFvSeL,cplcChacFvSeR,MCha,             &
& MFv,MSe,MCha2,MFv2,MSe2,AmpTreeChaTocFvSe)

  Else
Call Amplitude_Tree_NonUMSSM_ChaTocFvSe(ZcplcChacFvSeL,ZcplcChacFvSeR,MCha,           &
& MFv,MSe,MCha2,MFv2,MSe2,AmpTreeChaTocFvSe)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_ChaTocFvSe(MLambda,em,gs,cplcChacFvSeL,cplcChacFvSeR,        &
& MChaOS,MFvOS,MSeOS,MRPChaTocFvSe,MRGChaTocFvSe)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_ChaTocFvSe(MLambda,em,gs,ZcplcChacFvSeL,ZcplcChacFvSeR,      &
& MChaOS,MFvOS,MSeOS,MRPChaTocFvSe,MRGChaTocFvSe)
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_ChaTocFvSe(cplcChacFvSeL,cplcChacFvSeR,ctcplcChacFvSeL,  &
& ctcplcChacFvSeR,MCha,MCha2,MFv,MFv2,MSe,MSe2,ZfFvL,ZfLm,ZfLp,ZfSe,AmpWaveChaTocFvSe)



!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_ChaTocFvSe(MAh,MCha,MChi,MFe,MFv,Mhh,MHpm,             &
& MSe,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,MSv2,             &
& MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,cplcChaChaAhR,cplAhSecSe,cplcChaChahhL,            &
...
& cplcChacFvSeR,cplSecHpmcSv,cplSecSvcVWm,AmpVertexChaTocFvSe)

If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_ChaTocFvSe(MAh,MCha,MChi,MFe,MFv,Mhh,               &
& MHpm,MSe,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,             &
...
& cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcFvFvVZpL,        &
& cplcFvFvVZpR,cplhhSecSe,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplcChacFvSeL,               &
& cplcChacFvSeR,cplSecHpmcSv,cplSecSvcVWm,AmpVertexIRdrChaTocFvSe)

 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_ChaTocFvSe(MAhOS,MChaOS,MChiOS,MFeOS,               &
& MFvOS,MhhOS,MHpmOS,MSeOS,MSvOS,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,MChi2OS,         &
& MFe2OS,MFv2OS,Mhh2OS,MHpm2OS,MSe2OS,MSv2OS,MVP2,MVWm2OS,MVZ2OS,MVZp2OS,cplcChaChaAhL,  &
& cplcChaChaAhR,cplAhSecSe,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,      &
& cplcChaChaVZL,cplcChaChaVZR,cplcChaChaVZpL,cplcChaChaVZpR,cplcChaChiHpmL,              &
...
& cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcFvFvVZpL,cplcFvFvVZpR,cplhhSecSe,            &
& cplSecSeVP,cplSecSeVZ,cplSecSeVZp,ZcplcChacFvSeL,ZcplcChacFvSeR,cplSecHpmcSv,          &
& cplSecSvcVWm,AmpVertexIRosChaTocFvSe)
...
& cplcFvChiSvR,cplcChaChiVWmL,cplcChaChiVWmR,cplcChaFecSvL,cplcChaFecSvR,cplcFvFecHpmL,  &
& cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcFvFvVZpL,        &
& cplcFvFvVZpR,cplhhSecSe,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,ZcplcChacFvSeL,              &
...
& cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcFvFvVZpL,        &
& cplcFvFvVZpR,cplhhSecSe,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplcChacFvSeL,               &
& cplcChacFvSeR,cplSecHpmcSv,cplSecSvcVWm,AmpVertexIRosChaTocFvSe)
...
Do gt1=1,3
  Do gt2=1,3
AmpWaveZChaTocFvSe(1,:,gt2,:) = AmpWaveZChaTocFvSe(1,:,gt2,:)
AmpVertexZChaTocFvSe(1,:,gt2,:)= AmpVertexZChaTocFvSe(1,:,gt2,:)
...
!Self-energy Corrections
 If (ExternalZfactors) Then
Call Amplitude_WAVE_NonUMSSM_ChaToChaVP(ZcplcChaChaVPL,ZcplcChaChaVPR,ZcplcChaChaVZL, &
...
& MCha2OS,MVP,MVP2,ZfLm,ZfLp,ZfVP,ZfVZpVP,ZfVZVP,AmpWaveChaToChaVP)
 ...
 Else
Call Amplitude_WAVE_NonUMSSM_ChaToChaVP(cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,    &
& cplcChaChaVZR,cplcChaChaVZpL,cplcChaChaVZpR,ctcplcChaChaVPL,ctcplcChaChaVPR,           &
& ctcplcChaChaVZL,ctcplcChaChaVZR,ctcplcChaChaVZpL,ctcplcChaChaVZpR,MChaOS,              &
& MCha2OS,MVP,MVP2,ZfLm,ZfLp,ZfVP,ZfVZpVP,ZfVZVP,AmpWaveChaToChaVP)
...
!Vertex Corrections
 If (ExternalZfactors) Then
Call Amplitude_VERTEX_NonUMSSM_ChaToChaVP(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,            &
...
!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_ChaToChaVP(MAh,MCha,MChi,MFd,MFe,MFu,MFv,              &
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            &
& MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,               &
...
End Module Wrapper_OneLoopDecay_Cha_NonUMSSM
