...
Module OneLoopDecay_Cha_NonUMSSM
Use Control 
Use Settings 
Use LoopFunctions 
...
Subroutine Amplitude_Tree_NonUMSSM_ChaToChaAh(cplcChaChaAhL,cplcChaChaAhR,            & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_ChaToChaAh


Subroutine Gamma_Real_NonUMSSM_ChaToChaAh(MLambda,em,gs,cplcChaChaAhL,cplcChaChaAhR,  & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_ChaToChaAh


Subroutine Amplitude_WAVE_NonUMSSM_ChaToChaAh(cplcChaChaAhL,cplcChaChaAhR,            & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChaToChaAh


Subroutine Amplitude_VERTEX_NonUMSSM_ChaToChaAh(MAh,MCha,MChi,MFd,MFe,MFu,            & 
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChaToChaAh


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaToChaAh(MAh,MCha,MChi,MFd,MFe,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaToChaAh


Subroutine Amplitude_Tree_NonUMSSM_ChaToChahh(cplcChaChahhL,cplcChaChahhR,            & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_ChaToChahh


Subroutine Gamma_Real_NonUMSSM_ChaToChahh(MLambda,em,gs,cplcChaChahhL,cplcChaChahhR,  & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_ChaToChahh


Subroutine Amplitude_WAVE_NonUMSSM_ChaToChahh(cplcChaChahhL,cplcChaChahhR,            & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChaToChahh


Subroutine Amplitude_VERTEX_NonUMSSM_ChaToChahh(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,              & 
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChaToChahh


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaToChahh(MAh,MCha,MChi,MFd,MFe,             & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,         & 
& cplcChaChaAhL,cplcChaChaAhR,cplAhhhVZ,cplAhhhVZp,cplChiChacHpmL,cplChiChacHpmR,        & 
& cplChiChacVWmL,cplChiChacVWmR,cplChaFucSdL,cplChaFucSdR,cplChaFvcSeL,cplChaFvcSeR,     & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaToChahh


Subroutine Amplitude_Tree_NonUMSSM_ChaToChaVZ(cplcChaChaVZL,cplcChaChaVZR,            & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_ChaToChaVZ


Subroutine Gamma_Real_NonUMSSM_ChaToChaVZ(MLambda,em,gs,cplcChaChaVZL,cplcChaChaVZR,  & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_ChaToChaVZ


Subroutine Amplitude_WAVE_NonUMSSM_ChaToChaVZ(cplcChaChaVPL,cplcChaChaVPR,            & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChaToChaVZ


Subroutine Amplitude_VERTEX_NonUMSSM_ChaToChaVZ(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             & 
...
Complex(dp), Intent(in) :: cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),cplAhhhVZ(3,3),cplChiChacHpmL(6,2,2),       & 
& cplChiChacHpmR(6,2,2),cplChiChacVWmL(6,2),cplChiChacVWmR(6,2),cplChaFucSdL(2,3,6),     & 
& cplChaFucSdR(2,3,6),cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),cplcChaChahhL(2,2,3),      & 
& cplcChaChahhR(2,2,3),cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),cplcFeChaSvL(3,2,3),      & 
& cplcFeChaSvR(3,2,3),cplcChaChaVPL(2,2),cplcChaChaVPR(2,2),cplcChaChaVZL(2,2),          & 
& cplcChaChaVZR(2,2),cplcChaChaVZpL(2,2),cplcChaChaVZpR(2,2),cplChiChiVZL(6,6),          & 
& cplChiChiVZR(6,6),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),cplcChaChiVWmL(2,6),     & 
& cplcChaChiVWmR(2,6),cplcFdFdVZL(3,3),cplcFdFdVZR(3,3),cplcChaFdcSuL(2,3,6),            & 
& cplcChaFdcSuR(2,3,6),cplcFeFeVZL(3,3),cplcFeFeVZR(3,3),cplcChaFecSvL(2,3,3),           & 
& cplcChaFecSvR(2,3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcFvFvVZL(3,3),               & 
& cplcFvFvVZR(3,3),cplhhVZVZ(3),cplhhVZVZp(3),cplHpmcHpmVZ(2,2),cplHpmcVWmVZ(2),         & 
& cplSdcSdVZ(6,6),cplcChacFuSdL(2,3,6),cplcChacFuSdR(2,3,6),cplSecSeVZ(6,6),             & 
& cplcChacFvSeL(2,3,6),cplcChacFvSeR(2,3,6),cplSucSuVZ(6,6),cplSvcSvVZ(3,3),             & 
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChaToChaVZ


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaToChaVZ(MAh,MCha,MChi,MFd,MFe,             & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaToChaVZ


Subroutine Amplitude_Tree_NonUMSSM_ChaToChaVZp(cplcChaChaVZpL,cplcChaChaVZpR,         & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_ChaToChaVZp


Subroutine Gamma_Real_NonUMSSM_ChaToChaVZp(MLambda,em,gs,cplcChaChaVZpL,              & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_ChaToChaVZp


Subroutine Amplitude_WAVE_NonUMSSM_ChaToChaVZp(cplcChaChaVPL,cplcChaChaVPR,           & 
& cplcChaChaVZL,cplcChaChaVZR,cplcChaChaVZpL,cplcChaChaVZpR,ctcplcChaChaVPL,             & 
& ctcplcChaChaVPR,ctcplcChaChaVZL,ctcplcChaChaVZR,ctcplcChaChaVZpL,ctcplcChaChaVZpR,     & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChaToChaVZp


Subroutine Amplitude_VERTEX_NonUMSSM_ChaToChaVZp(MAh,MCha,MChi,MFd,MFe,               & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,     & 
...
Complex(dp), Intent(in) :: cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),cplAhhhVZp(3,3),cplChiChacHpmL(6,2,2),      & 
& cplChiChacHpmR(6,2,2),cplChiChacVWmL(6,2),cplChiChacVWmR(6,2),cplChaFucSdL(2,3,6),     & 
& cplChaFucSdR(2,3,6),cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),cplcChaChahhL(2,2,3),      & 
& cplcChaChahhR(2,2,3),cplcFdChaSuL(3,2,6),cplcFdChaSuR(3,2,6),cplcFeChaSvL(3,2,3),      & 
& cplcFeChaSvR(3,2,3),cplcChaChaVPL(2,2),cplcChaChaVPR(2,2),cplcChaChaVZL(2,2),          & 
& cplcChaChaVZR(2,2),cplcChaChaVZpL(2,2),cplcChaChaVZpR(2,2),cplChiChiVZpL(6,6),         & 
& cplChiChiVZpR(6,6),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),cplcChaChiVWmL(2,6),    & 
& cplcChaChiVWmR(2,6),cplcFdFdVZpL(3,3),cplcFdFdVZpR(3,3),cplcChaFdcSuL(2,3,6),          & 
& cplcChaFdcSuR(2,3,6),cplcFeFeVZpL(3,3),cplcFeFeVZpR(3,3),cplcChaFecSvL(2,3,3),         & 
& cplcChaFecSvR(2,3,3),cplcFuFuVZpL(3,3),cplcFuFuVZpR(3,3),cplcFvFvVZpL(3,3),            & 
...
& cplcChacFvSeL(2,3,6),cplcChacFvSeR(2,3,6),cplSucSuVZp(6,6),cplSvcSvVZp(3,3),           & 
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChaToChaVZp


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaToChaVZp(MAh,MCha,MChi,MFd,MFe,            & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,     & 
& cplcChaChaAhR,cplAhhhVZp,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,  & 
& cplChaFucSdL,cplChaFucSdR,cplChaFvcSeL,cplChaFvcSeR,cplcChaChahhL,cplcChaChahhR,       & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaToChaVZp


Subroutine Amplitude_Tree_NonUMSSM_ChaToChiHpm(cplcChaChiHpmL,cplcChaChiHpmR,         & 
...
Complex(dp), Intent(in) :: cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_ChaToChiHpm


Subroutine Gamma_Real_NonUMSSM_ChaToChiHpm(MLambda,em,gs,cplcChaChiHpmL,              & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_ChaToChiHpm


Subroutine Amplitude_WAVE_NonUMSSM_ChaToChiHpm(cplcChaChiHpmL,cplcChaChiHpmR,         & 
...
Complex(dp), Intent(in) :: ctcplcChaChiHpmL(2,6,2),ctcplcChaChiHpmR(2,6,2)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChaToChiHpm


Subroutine Amplitude_VERTEX_NonUMSSM_ChaToChiHpm(MAh,MCha,MChi,MFd,MFe,               & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,     & 
...
& cplAhHpmcHpm(3,2,2),cplAhHpmcVWm(3,2),cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),     & 
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChaToChiHpm


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaToChiHpm(MAh,MCha,MChi,MFd,MFe,            & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,     & 
& cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplAhHpmcHpm,cplAhHpmcVWm,cplChiChacHpmL,      & 
& cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,cplcChaChahhL,cplcChaChahhR,              & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaToChiHpm


Subroutine Amplitude_Tree_NonUMSSM_ChaToChiVWm(cplcChaChiVWmL,cplcChaChiVWmR,         & 
...
Complex(dp), Intent(in) :: cplcChaChiVWmL(2,6),cplcChaChiVWmR(2,6)

Complex(dp) :: Amp(4,2,6) 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_ChaToChiVWm


Subroutine Gamma_Real_NonUMSSM_ChaToChiVWm(MLambda,em,gs,cplcChaChiVWmL,              & 
...
End if 
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_ChaToChiVWm


Subroutine Amplitude_WAVE_NonUMSSM_ChaToChiVWm(cplcChaChiVWmL,cplcChaChiVWmR,         & 
...
Complex(dp), Intent(in) :: ctcplcChaChiVWmL(2,6),ctcplcChaChiVWmR(2,6)

Complex(dp), Intent(in) :: ZfL0(6,6),ZfLm(2,2),ZfLp(2,2),ZfVWm

Complex(dp), Intent(out) :: Amp(4,2,6) 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChaToChiVWm


Subroutine Amplitude_VERTEX_NonUMSSM_ChaToChiVWm(MAh,MCha,MChi,MFd,MFe,               & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,     & 
...
Complex(dp), Intent(in) :: cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),cplChiChiAhL(6,6,3),cplChiChiAhR(6,6,3),    & 
& cplAhcHpmVWm(3,2),cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),cplChiChacVWmL(6,2),     & 
& cplChiChacVWmR(6,2),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),cplcChaChaVPL(2,2),      & 
& cplcChaChaVPR(2,2),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),cplcChaChaVZpL(2,2),          & 
...
& cplcFvChiSvR(3,6,3),cplcChaChiVWmL(2,6),cplcChaChiVWmR(2,6),cplcChaFdcSuL(2,3,6),      & 
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChaToChiVWm


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaToChiVWm(MAh,MCha,MChi,MFd,MFe,            & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,     & 
& cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,    & 
& cplChiChacVWmL,cplChiChacVWmR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaToChiVWm


Subroutine Amplitude_Tree_NonUMSSM_ChaToFdcSu(cplcChaFdcSuL,cplcChaFdcSuR,            & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_ChaToFdcSu


Subroutine Gamma_Real_NonUMSSM_ChaToFdcSu(MLambda,em,gs,cplcChaFdcSuL,cplcChaFdcSuR,  & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_ChaToFdcSu


Subroutine Amplitude_WAVE_NonUMSSM_ChaToFdcSu(cplcChaFdcSuL,cplcChaFdcSuR,            & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChaToFdcSu


Subroutine Amplitude_VERTEX_NonUMSSM_ChaToFdcSu(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
...
& cplChiFucSuR(6,3,6),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),cplcChaChiVWmL(2,6),   & 
...
& cplcFuFdcVWmR(3,3),cplGluFucSuL(3,6),cplGluFucSuR(3,6),cplhhSucSu(3,6,6),              & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChaToFdcSu


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaToFdcSu(MAh,MCha,MChi,MFd,MFu,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaToFdcSu


Subroutine Amplitude_Tree_NonUMSSM_ChaToFecSv(cplcChaFecSvL,cplcChaFecSvR,            & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_ChaToFecSv


Subroutine Gamma_Real_NonUMSSM_ChaToFecSv(MLambda,em,gs,cplcChaFecSvL,cplcChaFecSvR,  & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_ChaToFecSv


Subroutine Amplitude_WAVE_NonUMSSM_ChaToFecSv(cplcChaFecSvL,cplcChaFecSvR,            & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChaToFecSv


Subroutine Amplitude_VERTEX_NonUMSSM_ChaToFecSv(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
...
Amp(:,gt1, gt2, gt3) = Amp(:,gt1, gt2, gt3) + oo16pi2*(1)*AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChaToFecSv


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaToFecSv(MAh,MCha,MChi,MFe,MFv,             & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaToFecSv


Subroutine Amplitude_Tree_NonUMSSM_ChaTocFuSd(cplcChacFuSdL,cplcChacFuSdR,            & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_ChaTocFuSd


Subroutine Gamma_Real_NonUMSSM_ChaTocFuSd(MLambda,em,gs,cplcChacFuSdL,cplcChacFuSdR,  & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_ChaTocFuSd


Subroutine Amplitude_WAVE_NonUMSSM_ChaTocFuSd(cplcChacFuSdL,cplcChacFuSdR,            & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChaTocFuSd


Subroutine Amplitude_VERTEX_NonUMSSM_ChaTocFuSd(MAh,MCha,MChi,MFd,MFu,MGlu,           & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,cplcChaChaAhR,           & 
...
& cplcChaChaVPR(2,2),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),cplcChaChaVZpL(2,2),          & 
& cplcChaChaVZpR(2,2),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),cplcFdChiSdL(3,6,6),   & 
& cplcFdChiSdR(3,6,6),cplcFuChiSuL(3,6,6),cplcFuChiSuR(3,6,6),cplcChaChiVWmL(2,6),       & 
& cplcChaChiVWmR(2,6),cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),cplcFuFdcHpmL(3,3,2),    & 
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChaTocFuSd


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaTocFuSd(MAh,MCha,MChi,MFd,MFu,             & 
& MGlu,Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,          & 
& Mhh2,MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,cplcChaChaAhR,           & 
& cplcFuFuAhL,cplcFuFuAhR,cplAhSdcSd,cplcChaChahhL,cplcChaChahhR,cplcChaChaVPL,          & 
& cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZR,cplcChaChaVZpL,cplcChaChaVZpR,               & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaTocFuSd


Subroutine Amplitude_Tree_NonUMSSM_ChaTocFvSe(cplcChacFvSeL,cplcChacFvSeR,            & 
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_Tree_NonUMSSM_ChaTocFvSe


Subroutine Gamma_Real_NonUMSSM_ChaTocFvSe(MLambda,em,gs,cplcChacFvSeL,cplcChacFvSeR,  & 
...
End if 
  ...
  End Do
End Do
End Subroutine Gamma_Real_NonUMSSM_ChaTocFvSe


Subroutine Amplitude_WAVE_NonUMSSM_ChaTocFvSe(cplcChacFvSeL,cplcChacFvSeR,            & 
& ctcplcChacFvSeL,ctcplcChacFvSeR,MCha,MCha2,MFv,MFv2,MSe,MSe2,ZfFvL,ZfLm,               & 
& ZfLp,ZfSe,Amp)
...
Amp(:,gt1, gt2, gt3) = AmpC 
  ...
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChaTocFvSe


Subroutine Amplitude_VERTEX_NonUMSSM_ChaTocFvSe(MAh,MCha,MChi,MFe,MFv,Mhh,            & 
& MHpm,MSe,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,             & 
& MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,cplcChaChaAhR,cplAhSecSe,cplcChaChahhL,       & 
& cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZR,cplcChaChaVZpL,  & 
& cplcChaChaVZpR,cplcChaChiHpmL,cplcChaChiHpmR,cplcFeChiSeL,cplcFeChiSeR,cplcFvChiSvL,   & 
& cplcFvChiSvR,cplcChaChiVWmL,cplcChaChiVWmR,cplcChaFecSvL,cplcChaFecSvR,cplcFvFecHpmL,  & 
& cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcFvFvVZpL,        & 
...
& cplcChaChaVZR(2,2),cplcChaChaVZpL(2,2),cplcChaChaVZpR(2,2),cplcChaChiHpmL(2,6,2),      & 
& cplcChaChiHpmR(2,6,2),cplcFeChiSeL(3,6,6),cplcFeChiSeR(3,6,6),cplcFvChiSvL(3,6,3),     & 
& cplcFvChiSvR(3,6,3),cplcChaChiVWmL(2,6),cplcChaChiVWmR(2,6),cplcChaFecSvL(2,3,3),      & 
& cplcChaFecSvR(2,3,3),cplcFvFecHpmL(3,3,2),cplcFvFecHpmR(3,3,2),cplcFvFecVWmL(3,3),     & 
& cplcFvFecVWmR(3,3),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplcFvFvVZpL(3,3),cplcFvFvVZpR(3,3),& 
& cplhhSecSe(3,6,6),cplSecSeVP(6,6),cplSecSeVZ(6,6),cplSecSeVZp(6,6),cplcChacFvSeL(2,3,6),& 
...
End Do
  ...
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChaTocFvSe


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaTocFvSe(MAh,MCha,MChi,MFe,MFv,             & 
& Mhh,MHpm,MSe,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,              & 
& MSe2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,cplcChaChaAhR,cplAhSecSe,cplcChaChahhL,  & 
& cplcChaChahhR,cplcChaChaVPL,cplcChaChaVPR,cplcChaChaVZL,cplcChaChaVZR,cplcChaChaVZpL,  & 
& cplcChaChaVZpR,cplcChaChiHpmL,cplcChaChiHpmR,cplcFeChiSeL,cplcFeChiSeR,cplcFvChiSvL,   & 
& cplcFvChiSvR,cplcChaChiVWmL,cplcChaChiVWmR,cplcChaFecSvL,cplcChaFecSvR,cplcFvFecHpmL,  & 
& cplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcFvFvVZpL,        & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaTocFvSe


Subroutine Amplitude_WAVE_NonUMSSM_ChaToChaVP(cplcChaChaVPL,cplcChaChaVPR,            & 
& cplcChaChaVZL,cplcChaChaVZR,cplcChaChaVZpL,cplcChaChaVZpR,ctcplcChaChaVPL,             & 
& ctcplcChaChaVPR,ctcplcChaChaVZL,ctcplcChaChaVZR,ctcplcChaChaVZpL,ctcplcChaChaVZpR,     & 
...
Amp(:,gt1, gt2) = -AmpC 
  End Do
End Do
End Subroutine Amplitude_WAVE_NonUMSSM_ChaToChaVP


Subroutine Amplitude_VERTEX_NonUMSSM_ChaToChaVP(MAh,MCha,MChi,MFd,MFe,MFu,            & 
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             & 
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,          & 
...
Complex(dp), Intent(in) :: cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),& 
...
& cplcChaChaVPL(2,2),cplcChaChaVPR(2,2),cplcChaChaVZL(2,2),cplcChaChaVZR(2,2),           & 
& cplcChaChaVZpL(2,2),cplcChaChaVZpR(2,2),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),   & 
...
& cplcChaFecSvL(2,3,3),cplcChaFecSvR(2,3,3),cplcFuFuVPL(3,3),cplcFuFuVPR(3,3),           & 
...
End Do
  End Do
End Do
End Subroutine Amplitude_VERTEX_NonUMSSM_ChaToChaVP


Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaToChaVP(MAh,MCha,MChi,MFd,MFe,             & 
& MFu,MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,              & 
& MFe2,MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcChaChaAhL,     & 
& cplcChaChaAhR,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,             & 
& cplChaFucSdL,cplChaFucSdR,cplChaFvcSeL,cplChaFvcSeR,cplcChaChahhL,cplcChaChahhR,       & 
...
IRdivOnly =.false. 
End Subroutine Amplitude_IR_VERTEX_NonUMSSM_ChaToChaVP



End Module OneLoopDecay_Cha_NonUMSSM
