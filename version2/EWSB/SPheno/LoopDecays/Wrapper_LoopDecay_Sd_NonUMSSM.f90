...
Module Wrapper_OneLoopDecay_Sd_NonUMSSM
Use Model_Data_NonUMSSM 
Use Kinematics 
Use OneLoopDecay_Sd_NonUMSSM 
Use Control 
Use Settings 
...
Subroutine OneLoopDecay_Sd(MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,MFv2OS,MSuOS,              & 
...
& ZfFUR,ZfVPVZ,ZfVZVP,ZfVPVZp,ZfVZpVP,ZfVZVZp,ZfVZpVZ,cplAhAhhh,cplAhAhSdcSdaa,          & 
& cplAhcHpmVWm,cplAhhhSdcSdaa,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,            & 
& cplAhHpmSucSdaa,cplAhSdcHpmcSuaa,cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplcChacFuSdL,       & 
...
Complex(dp),Intent(in) :: cplAhAhhh(3,3,3),cplAhAhSdcSdaa(3,3,6,6),cplAhcHpmVWm(3,2),cplAhhhSdcSdaa(3,3,6,6),   & 
& cplAhhhVZ(3,3),cplAhhhVZp(3,3),cplAhHpmcHpm(3,2,2),cplAhHpmcVWm(3,2),cplAhHpmSucSdaa(3,2,6,6),& 
& cplAhSdcHpmcSuaa(3,6,2,6),cplAhSdcSd(3,6,6),cplAhSecSe(3,6,6),cplAhSucSu(3,6,6),       & 
...
& cplcFuGluSuR(3,6),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),cplChiChacHpmL(6,2,2),       & 
...
& cplChiFdcSdR(6,3,6),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6),cplcHpmVPVWm(2),           & 
...
& cplhhhhSdcSdaa(3,3,6,6),cplhhHpmcHpm(3,2,2),cplhhHpmcVWm(3,2),cplhhHpmSucSdaa(3,2,6,6),& 
...
& cplHpmSvcSe(2,3,6),cplSdcHpmcSu(6,2,6),cplSdcSdcVWmVWmaa(6,6),cplSdcSdVG(6,6),         & 
...
& cplSdcSucVWmVZaa(6,6),cplSdcSucVWmVZpaa(6,6),cplSdSdcSdcSdabab(6,6,6,6)

Complex(dp),Intent(in) :: cplSdSdcSdcSdabba(6,6,6,6),cplSdSecSdcSeaa(6,6,6,6),cplSdSucSdcSuabab(6,6,6,6),        & 
& cplSdSucSdcSuabba(6,6,6,6),cplSdSvcSdcSvaa(6,3,6,3),cplSeSucSdcSvaa(6,6,6,3),          & 
...
& cplSucSuVZ(6,6),cplSucSuVZp(6,6),cplVGVGVG,ctcplAhSdcSd(3,6,6),ctcplChaFucSdL(2,3,6),  & 
& ctcplChaFucSdR(2,3,6),ctcplChiFdcSdL(6,3,6),ctcplChiFdcSdR(6,3,6),ctcplGluFdcSdL(3,6), & 
...
& ZcplChiFdcSdL(6,3,6),ZcplChiFdcSdR(6,3,6),ZcplGluFdcSdL(3,6),ZcplGluFdcSdR(3,6),       & 
& ZcplhhSdcSd(3,6,6),ZcplHpmSucSd(2,6,6),ZcplSdcSdVZ(6,6),ZcplSdcSdVZp(6,6),             & 
& ZcplSucSdVWm(6,6)
...
Real(dp) :: MRPSdToFdChi(6,3,6),MRGSdToFdChi(6,3,6), MRPZSdToFdChi(6,3,6),MRGZSdToFdChi(6,3,6) 
Real(dp) :: MVPSdToFdChi(6,3,6) 
Real(dp) :: RMsqTreeSdToFdChi(6,3,6),RMsqWaveSdToFdChi(6,3,6),RMsqVertexSdToFdChi(6,3,6) 
Complex(dp) :: AmpTreeSdToFdChi(2,6,3,6),AmpWaveSdToFdChi(2,6,3,6)=(0._dp,0._dp),AmpVertexSdToFdChi(2,6,3,6)& 
 & ,AmpVertexIRosSdToFdChi(2,6,3,6),AmpVertexIRdrSdToFdChi(2,6,3,6), AmpSumSdToFdChi(2,6,3,6), AmpSum2SdToFdChi(2,6,3,6) 
Complex(dp) :: AmpTreeZSdToFdChi(2,6,3,6),AmpWaveZSdToFdChi(2,6,3,6),AmpVertexZSdToFdChi(2,6,3,6) 
Real(dp) :: AmpSqSdToFdChi(6,3,6),  AmpSqTreeSdToFdChi(6,3,6) 
...
Call Amplitude_Tree_NonUMSSM_SdToSdAh(cplAhSdcSd,MAh,MSd,MAh2,MSd2,AmpTreeSdToSdAh)

  Else 
Call Amplitude_Tree_NonUMSSM_SdToSdAh(ZcplAhSdcSd,MAh,MSd,MAh2,MSd2,AmpTreeSdToSdAh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_SdToSdAh(MLambda,em,gs,cplAhSdcSd,MAhOS,MSdOS,               & 
& MRPSdToSdAh,MRGSdToSdAh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_SdToSdAh(MLambda,em,gs,ZcplAhSdcSd,MAhOS,MSdOS,              & 
& MRPSdToSdAh,MRGSdToSdAh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NonUMSSM_SdToSdAh(MLambda,em,gs,cplAhSdcSd,MAh,MSd,MRPSdToSdAh,       & 
& MRGSdToSdAh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NonUMSSM_SdToSdAh(MLambda,em,gs,ZcplAhSdcSd,MAh,MSd,MRPSdToSdAh,      & 
& MRGSdToSdAh)
...
Call Amplitude_WAVE_NonUMSSM_SdToSdAh(cplAhSdcSd,ctcplAhSdcSd,MAh,MAh2,               & 
& MSd,MSd2,ZfAh,ZfSd,AmpWaveSdToSdAh)



!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SdToSdAh(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_SdToSdAh(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSe,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
& Mhh2,MHpm2,MSd2,MSe2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,cplcChaChaAhL,          & 
& cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFuFuAhL,           & 
& cplcFuFuAhR,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSecSe,      & 
...
& cplSdSecSdcSeaa,cplSdSucSdcSuabba,cplSdSucSdcSuabab,AmpVertexIRdrSdToSdAh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_SdToSdAh(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,           & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_SdToFuCha(cplChaFucSdL,cplChaFucSdR,MCha,MFu,            & 
& MSd,MCha2,MFu2,MSd2,AmpTreeSdToFuCha)

  Else 
Call Amplitude_Tree_NonUMSSM_SdToFuCha(ZcplChaFucSdL,ZcplChaFucSdR,MCha,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_SdToFuCha(MLambda,em,gs,cplChaFucSdL,cplChaFucSdR,           & 
& MChaOS,MFuOS,MSdOS,MRPSdToFuCha,MRGSdToFuCha)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_SdToFuCha(MLambda,em,gs,ZcplChaFucSdL,ZcplChaFucSdR,         & 
& MChaOS,MFuOS,MSdOS,MRPSdToFuCha,MRGSdToFuCha)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_SdToFuCha(cplChaFucSdL,cplChaFucSdR,ctcplChaFucSdL,      & 
& ctcplChaFucSdR,MCha,MCha2,MFu,MFu2,MSd,MSd2,ZfFUL,ZfFUR,ZfLm,ZfLp,ZfSd,AmpWaveSdToFuCha)



!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SdToFuCha(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_SdToFuCha(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
...
& cplHpmSucSd,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSucSdVWm,AmpVertexIRdrSdToFuCha)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_SdToFuCha(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,          & 
...
& cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,cplChiChacVWmR,ZcplChaFucSdL,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_SdToFdChi(cplChiFdcSdL,cplChiFdcSdR,MChi,MFd,            & 
& MSd,MChi2,MFd2,MSd2,AmpTreeSdToFdChi)

  Else 
Call Amplitude_Tree_NonUMSSM_SdToFdChi(ZcplChiFdcSdL,ZcplChiFdcSdR,MChi,              & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_SdToFdChi(MLambda,em,gs,cplChiFdcSdL,cplChiFdcSdR,           & 
& MChiOS,MFdOS,MSdOS,MRPSdToFdChi,MRGSdToFdChi)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_SdToFdChi(MLambda,em,gs,ZcplChiFdcSdL,ZcplChiFdcSdR,         & 
& MChiOS,MFdOS,MSdOS,MRPSdToFdChi,MRGSdToFdChi)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_SdToFdChi(cplChiFdcSdL,cplChiFdcSdR,ctcplChiFdcSdL,      & 
& ctcplChiFdcSdR,MChi,MChi2,MFd,MFd2,MSd,MSd2,ZfFDL,ZfFDR,ZfL0,ZfSd,AmpWaveSdToFdChi)



!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SdToFdChi(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,              & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_SdToFdChi(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
& cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSucSdVWm,AmpVertexIRdrSdToFdChi)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_SdToFdChi(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,          & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_SdToGluFd(cplGluFdcSdL,cplGluFdcSdR,MFd,MGlu,            & 
& MSd,MFd2,MGlu2,MSd2,AmpTreeSdToGluFd)

  Else 
Call Amplitude_Tree_NonUMSSM_SdToGluFd(ZcplGluFdcSdL,ZcplGluFdcSdR,MFd,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_SdToGluFd(MLambda,em,gs,cplGluFdcSdL,cplGluFdcSdR,           & 
& MFdOS,MGluOS,MSdOS,MRPSdToGluFd,MRGSdToGluFd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_SdToGluFd(MLambda,em,gs,ZcplGluFdcSdL,ZcplGluFdcSdR,         & 
& MFdOS,MGluOS,MSdOS,MRPSdToGluFd,MRGSdToGluFd)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_SdToGluFd(cplGluFdcSdL,cplGluFdcSdR,ctcplGluFdcSdL,      & 
& ctcplGluFdcSdR,MFd,MFd2,MGlu,MGlu2,MSd,MSd2,ZfFDL,ZfFDR,ZffG,ZfSd,AmpWaveSdToGluFd)



!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SdToGluFd(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,              & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_SdToGluFd(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
& cplSucSdVWm,AmpVertexIRdrSdToGluFd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_SdToGluFd(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,          & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
& cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSucSdVWm,AmpVertexIRosSdToGluFd)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_SdToSdhh(cplhhSdcSd,Mhh,MSd,Mhh2,MSd2,AmpTreeSdToSdhh)

  Else 
Call Amplitude_Tree_NonUMSSM_SdToSdhh(ZcplhhSdcSd,Mhh,MSd,Mhh2,MSd2,AmpTreeSdToSdhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_SdToSdhh(MLambda,em,gs,cplhhSdcSd,MhhOS,MSdOS,               & 
& MRPSdToSdhh,MRGSdToSdhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_SdToSdhh(MLambda,em,gs,ZcplhhSdcSd,MhhOS,MSdOS,              & 
& MRPSdToSdhh,MRGSdToSdhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NonUMSSM_SdToSdhh(MLambda,em,gs,cplhhSdcSd,Mhh,MSd,MRPSdToSdhh,       & 
& MRGSdToSdhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NonUMSSM_SdToSdhh(MLambda,em,gs,ZcplhhSdcSd,Mhh,MSd,MRPSdToSdhh,      & 
& MRGSdToSdhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_SdToSdhh(cplhhSdcSd,ctcplhhSdcSd,Mhh,Mhh2,               & 
& MSd,MSd2,Zfhh,ZfSd,AmpWaveSdToSdhh)



!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SdToSdhh(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
...
& cplSdcSdcVWmVWmaa,cplSdcSdVZVZaa,cplSdcSdVZVZpaa,cplSdcSdVZpVZpaa,AmpVertexSdToSdhh)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_SdToSdhh(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSe,MSu,MSv,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,           & 
& Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,cplAhhhVZ,         & 
& cplAhhhVZp,cplAhSdcSd,cplChaFucSdL,cplChaFucSdR,cplcChaChahhL,cplcChaChahhR,           & 
& cplChiChihhL,cplChiChihhR,cplChiFdcSdL,cplChiFdcSdR,cplcFdChiSdL,cplcFdChiSdR,         & 
...
& cplhhhhSdcSdaa,cplhhHpmSucSdaa,cplhhSdcHpmcSuaa,cplHpmSdcHpmcSdaa,cplSdSdcSdcSdabba,   & 
& cplSdSdcSdcSdabab,cplSdSecSdcSeaa,cplSdSucSdcSuabba,cplSdSucSdcSuabab,cplSdSvcSdcSvaa, & 
& cplSdcSdcVWmVWmaa,cplSdcSdVZVZaa,cplSdcSdVZVZpaa,cplSdcSdVZpVZpaa,AmpVertexIRdrSdToSdhh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_SdToSdhh(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,           & 
...
& cplSdcSdVZVZaa,cplSdcSdVZVZpaa,cplSdcSdVZpVZpaa,AmpVertexIRosSdToSdhh)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_SdToSuHpm(cplHpmSucSd,MHpm,MSd,MSu,MHpm2,MSd2,           & 
& MSu2,AmpTreeSdToSuHpm)

  Else 
Call Amplitude_Tree_NonUMSSM_SdToSuHpm(ZcplHpmSucSd,MHpm,MSd,MSu,MHpm2,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_SdToSuHpm(MLambda,em,gs,cplHpmSucSd,MHpmOS,MSdOS,            & 
& MSuOS,MRPSdToSuHpm,MRGSdToSuHpm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_SdToSuHpm(MLambda,em,gs,ZcplHpmSucSd,MHpmOS,MSdOS,           & 
& MSuOS,MRPSdToSuHpm,MRGSdToSuHpm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NonUMSSM_SdToSuHpm(MLambda,em,gs,cplHpmSucSd,MHpm,MSd,MSu,            & 
& MRPSdToSuHpm,MRGSdToSuHpm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NonUMSSM_SdToSuHpm(MLambda,em,gs,ZcplHpmSucSd,MHpm,MSd,               & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_SdToSuHpm(cplHpmSucSd,ctcplHpmSucSd,MHpm,MHpm2,          & 
& MSd,MSd2,MSu,MSu2,ZfHpm,ZfSd,ZfSu,AmpWaveSdToSuHpm)



!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SdToSuHpm(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,              & 
& MHpm,MSd,MSe,MSu,MSv,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,           & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_SdToSuHpm(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
...
& cplSucSdVWmVZaa,cplSucSdVWmVZpaa,AmpVertexIRdrSdToSuHpm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_SdToSuHpm(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,          & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,               & 
& MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSe2OS,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_SdToSdVZ(cplSdcSdVZ,MSd,MVZ,MSd2,MVZ2,AmpTreeSdToSdVZ)

  Else 
Call Amplitude_Tree_NonUMSSM_SdToSdVZ(ZcplSdcSdVZ,MSd,MVZ,MSd2,MVZ2,AmpTreeSdToSdVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_SdToSdVZ(MLambda,em,gs,cplSdcSdVZ,MSdOS,MVZOS,               & 
& MRPSdToSdVZ,MRGSdToSdVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_SdToSdVZ(MLambda,em,gs,ZcplSdcSdVZ,MSdOS,MVZOS,              & 
& MRPSdToSdVZ,MRGSdToSdVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NonUMSSM_SdToSdVZ(MLambda,em,gs,cplSdcSdVZ,MSd,MVZ,MRPSdToSdVZ,       & 
& MRGSdToSdVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NonUMSSM_SdToSdVZ(MLambda,em,gs,ZcplSdcSdVZ,MSd,MVZ,MRPSdToSdVZ,      & 
& MRGSdToSdVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_SdToSdVZ(cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SdToSdVZ(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_SdToSdVZ(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,            & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhhhVZ,cplAhSdcSd,cplChaFucSdL,          & 
& cplChaFucSdR,cplcChaChaVZL,cplcChaChaVZR,cplChiChiVZL,cplChiChiVZR,cplChiFdcSdL,       & 
& cplChiFdcSdR,cplcFdChiSdL,cplcFdChiSdR,cplGluFdcSdL,cplGluFdcSdR,cplcFdFdVZL,          & 
...
& AmpVertexIRdrSdToSdVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_SdToSdVZ(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,           & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_SdToSdVZp(cplSdcSdVZp,MSd,MVZp,MSd2,MVZp2,               & 
& AmpTreeSdToSdVZp)

  Else 
Call Amplitude_Tree_NonUMSSM_SdToSdVZp(ZcplSdcSdVZp,MSd,MVZp,MSd2,MVZp2,              & 
& AmpTreeSdToSdVZp)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_SdToSdVZp(MLambda,em,gs,cplSdcSdVZp,MSdOS,MVZpOS,            & 
& MRPSdToSdVZp,MRGSdToSdVZp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_SdToSdVZp(MLambda,em,gs,ZcplSdcSdVZp,MSdOS,MVZpOS,           & 
& MRPSdToSdVZp,MRGSdToSdVZp)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NonUMSSM_SdToSdVZp(MLambda,em,gs,cplSdcSdVZp,MSd,MVZp,MRPSdToSdVZp,   & 
& MRGSdToSdVZp)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NonUMSSM_SdToSdVZp(MLambda,em,gs,ZcplSdcSdVZp,MSd,MVZp,               & 
& MRPSdToSdVZp,MRGSdToSdVZp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_SdToSdVZp(cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SdToSdVZp(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,              & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_SdToSdVZp(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
& AmpVertexIRdrSdToSdVZp)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_SdToSdVZp(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,          & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
& MVZ2OS,MVZp2OS,cplAhhhVZp,cplAhSdcSd,cplChaFucSdL,cplChaFucSdR,cplcChaChaVZpL,         & 
& cplcChaChaVZpR,cplChiChiVZpL,cplChiChiVZpR,cplChiFdcSdL,cplChiFdcSdR,cplcFdChiSdL,     & 
& cplcFdChiSdR,cplGluFdcSdL,cplGluFdcSdR,cplcFdFdVZpL,cplcFdFdVZpR,cplcFuFuVZpL,         & 
& cplcFuFuVZpR,cplcFdGluSdL,cplcFdGluSdR,cplhhSdcSd,cplhhVZVZp,cplhhVZpVZp,              & 
& cplHpmSucSd,cplHpmcHpmVZp,cplHpmcVWmVZp,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,              & 
& ZcplSdcSdVZp,cplcChacFuSdL,cplcChacFuSdR,cplSdcHpmcSu,cplSdcSucVWm,cplSucSdVWm,        & 
& cplSucSuVZp,cplcHpmVWmVZp,cplcVWmVWmVZp,cplSdcSdVGVZpLamct3ct2ct1,cplSdcSdVPVZpaa,     & 
& cplSdcSdVZVZpaa,cplSdcSdVZpVZpaa,cplSdcSucVWmVZpaa,cplSucSdVWmVZpaa,AmpVertexIRosSdToSdVZp)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_NonUMSSM_SdToSuVWm(cplSucSdVWm,MSd,MSu,MVWm,MSd2,MSu2,            & 
& MVWm2,AmpTreeSdToSuVWm)

  Else 
Call Amplitude_Tree_NonUMSSM_SdToSuVWm(ZcplSucSdVWm,MSd,MSu,MVWm,MSd2,MSu2,           & 
& MVWm2,AmpTreeSdToSuVWm)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_NonUMSSM_SdToSuVWm(MLambda,em,gs,cplSucSdVWm,MSdOS,MSuOS,             & 
& MVWmOS,MRPSdToSuVWm,MRGSdToSuVWm)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_NonUMSSM_SdToSuVWm(MLambda,em,gs,ZcplSucSdVWm,MSdOS,MSuOS,            & 
& MVWmOS,MRPSdToSuVWm,MRGSdToSuVWm)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_NonUMSSM_SdToSuVWm(MLambda,em,gs,cplSucSdVWm,MSd,MSu,MVWm,            & 
& MRPSdToSuVWm,MRGSdToSuVWm)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_NonUMSSM_SdToSuVWm(MLambda,em,gs,ZcplSucSdVWm,MSd,MSu,MVWm,           & 
& MRPSdToSuVWm,MRGSdToSuVWm)
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_SdToSuVWm(cplSucSdVWm,ctcplSucSdVWm,MSd,MSd2,            & 
& MSu,MSu2,MVWm,MVWm2,ZfSd,ZfSu,ZfVWm,AmpWaveSdToSuVWm)



!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SdToSuVWm(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,              & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_NonUMSSM_SdToSuVWm(MAh,MCha,MChi,MFd,MFu,MGlu,               & 
& Mhh,MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,               & 
...
& cplSucSucVWmVWmaa,AmpVertexIRdrSdToSuVWm)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_NonUMSSM_SdToSuVWm(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,          & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
& MVZ2OS,MVZp2OS,cplAhSdcSd,cplAhSucSu,cplAhcHpmVWm,cplChaFucSdL,cplChaFucSdR,           & 
& cplcFdChaSuL,cplcFdChaSuR,cplChiFdcSdL,cplChiFdcSdR,cplcFuChiSuL,cplcFuChiSuR,         & 
& cplcChaChiVWmL,cplcChaChiVWmR,cplGluFdcSdL,cplGluFdcSdR,cplcFdFuVWmL,cplcFdFuVWmR,     & 
& cplcFuGluSuL,cplcFuGluSuR,cplhhSdcSd,cplhhSucSu,cplhhcHpmVWm,cplhhcVWmVWm,             & 
& GosZcplHpmSucSd,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSucSuVG,               & 
& cplSucSuVP,ZcplSucSdVWm,cplSucSuVZ,cplSucSuVZp,GosZcplcHpmVPVWm,cplcVWmVPVWm,          & 
& cplcHpmVWmVZ,cplcVWmVWmVZ,cplcHpmVWmVZp,cplcVWmVWmVZp,cplSdcSdcVWmVWmaa,               & 
& cplSucSdVGVWmLamct3ct2ct1,cplSucSdVPVWmaa,cplSucSdVWmVZaa,cplSucSdVWmVZpaa,            & 
...
& cplcChaChiVWmL,cplcChaChiVWmR,cplGluFdcSdL,cplGluFdcSdR,cplcFdFuVWmL,cplcFdFuVWmR,     & 
& cplcFuGluSuL,cplcFuGluSuR,cplhhSdcSd,cplhhSucSu,cplhhcHpmVWm,cplhhcVWmVWm,             & 
& GcplHpmSucSd,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSucSuVG,cplSucSuVP,       & 
& cplSucSdVWm,cplSucSuVZ,cplSucSuVZp,GcplcHpmVPVWm,cplcVWmVPVWm,cplcHpmVWmVZ,            & 
& cplcVWmVWmVZ,cplcHpmVWmVZp,cplcVWmVWmVZp,cplSdcSdcVWmVWmaa,cplSucSdVGVWmLamct3ct2ct1,  & 
& cplSucSdVPVWmaa,cplSucSdVWmVZaa,cplSucSdVWmVZpaa,cplSucSucVWmVWmaa,AmpVertexIRosSdToSuVWm)
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_NonUMSSM_SdToSdVG(cplSdcSdVG,ctcplSdcSdVG,MSdOS,MSd2OS,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NonUMSSM_SdToSdVG(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,              & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_NonUMSSM_SdToSdVG(cplSdcSdVG,ctcplSdcSdVG,MSd,MSd2,               & 
& MVG,MVG2,ZfSd,ZfVG,AmpWaveSdToSdVG)



!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SdToSdVG(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_NonUMSSM_SdToSdVP(cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,              & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_NonUMSSM_SdToSdVP(MAhOS,MChaOS,MChiOS,MFdOS,MFuOS,              & 
& MGluOS,MhhOS,MHpmOS,MSdOS,MSuOS,MVG,MVP,MVWmOS,MVZOS,MVZpOS,MAh2OS,MCha2OS,            & 
& MChi2OS,MFd2OS,MFu2OS,MGlu2OS,Mhh2OS,MHpm2OS,MSd2OS,MSu2OS,MVG2,MVP2,MVWm2OS,          & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_NonUMSSM_SdToSdVP(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,               & 
& MHpm,MSd,MSu,MVG,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFu2,MGlu2,Mhh2,              & 
& MHpm2,MSd2,MSu2,MVG2,MVP2,MVWm2,MVZ2,MVZp2,cplAhSdcSd,cplChaFucSdL,cplChaFucSdR,       & 
...
End Module Wrapper_OneLoopDecay_Sd_NonUMSSM
