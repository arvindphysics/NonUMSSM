...
Module Wrapper_OneLoopDecay_Hpm_NonUMSSM
Use Model_Data_NonUMSSM
Use Kinematics
Use OneLoopDecay_Hpm_NonUMSSM
Use Control
Use Settings
...
Subroutine OneLoopDecay_Hpm(MSdOS,MSd2OS,MSvOS,MSv2OS,MFvOS,MFv2OS,MSuOS,             &
...
& ZfFUR,ZfVPVZ,ZfVZVP,ZfVPVZp,ZfVZpVP,ZfVZVZp,ZfVZpVZ,cplAhAhcVWmVWm1,cplAhAhhh,         &
& cplAhAhHpmcHpm1,cplAhcHpmVPVWm1,cplAhcHpmVWm,cplAhcHpmVWmVZ1,cplAhcHpmVWmVZp1,         &
& cplAhhhHpmcHpm1,cplAhhhVZ,cplAhhhVZp,cplAhHpmcHpm,cplAhHpmcVWm,cplAhHpmcVWmVP1,        &
& cplAhHpmcVWmVZ1,cplAhHpmcVWmVZp1,cplAhHpmSucSdaa,cplAhHpmSvcSe1,cplAhSdcHpmcSuaa,      &
& cplAhSdcSd,cplAhSecHpmcSv1,cplAhSecSe,cplAhSucSu,cplcChacFuSdL,cplcChacFuSdR,          &
...
& cplcFvFvVZpR,cplcFvFvVZR,cplcgAgWpCVWm,cplcgWmgWmAh,cplcgWmgWmhh,cplcgWmgWmVP,         &
& cplcgWmgWmVZ,cplcgWmgWmVZp,cplcgWmgZHpm,cplcgWmgZpHpm,cplcgWmgZpVWm,cplcgWmgZVWm,      &
& cplcgWpCgAcHpm,cplcgWpCgWpCAh,cplcgWpCgWpChh,cplcgWpCgWpCVP,cplcgWpCgWpCVZ,            &
& cplcgWpCgWpCVZp,cplcgWpCgZcHpm,cplcgWpCgZpcHpm,cplcgZgWmcHpm,cplcgZgWpCHpm,            &
& cplcgZgWpCVWm,cplcgZgZhh,cplcgZgZphh,cplcgZpgWmcHpm,cplcgZpgWpCHpm,cplcgZpgWpCVWm,     &
& cplcgZpgZhh,cplcgZpgZphh,cplChaFucSdL,cplChaFucSdR,cplChaFvcSeL,cplChaFvcSeR,          &
...
& cplhhHpmcVWmVZp1,cplhhHpmSucSdaa,cplhhHpmSvcSe1,cplhhSdcHpmcSuaa,cplhhSdcSd,           &
& cplhhSecHpmcSv1,cplhhSecSe,cplhhSucSu,cplhhSvcSv,cplhhVZpVZp,cplhhVZVZ,cplhhVZVZp,     &
& cplHpmcHpmcVWmVWm1,cplHpmcHpmVP,cplHpmcHpmVPVP1,cplHpmcHpmVPVZ1,cplHpmcHpmVPVZp1,      &
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplHpmcHpmVZpVZp1,cplHpmcHpmVZVZ1,cplHpmcHpmVZVZp1,         &
& cplHpmcVWmVP,cplHpmcVWmVZ,cplHpmcVWmVZp,cplHpmHpmcHpmcHpm1,cplHpmSdcHpmcSdaa,          &
& cplHpmSecHpmcSe1,cplHpmSucHpmcSuaa,cplHpmSucSd,cplHpmSvcHpmcSv1,cplHpmSvcSe,           &
& cplSdcHpmcSu,cplSdcSdVG,cplSdcSdVP,cplSdcSdVZ,cplSdcSdVZp,cplSdcSucVWm,cplSdcSucVWmVPaa,&
...
Complex(dp),Intent(in) :: cplAhAhcVWmVWm1(3,3),cplAhAhhh(3,3,3),cplAhAhHpmcHpm1(3,3,2,2),cplAhcHpmVPVWm1(3,2),  &
& cplAhcHpmVWm(3,2),cplAhcHpmVWmVZ1(3,2),cplAhcHpmVWmVZp1(3,2),cplAhhhHpmcHpm1(3,3,2,2), &
& cplAhhhVZ(3,3),cplAhhhVZp(3,3),cplAhHpmcHpm(3,2,2),cplAhHpmcVWm(3,2),cplAhHpmcVWmVP1(3,2),&
& cplAhHpmcVWmVZ1(3,2),cplAhHpmcVWmVZp1(3,2),cplAhHpmSucSdaa(3,2,6,6),cplAhHpmSvcSe1(3,2,3,6),&
...
& cplcChaChaVZpL(2,2),cplcChaChaVZpR(2,2),cplcChaChaVZR(2,2),cplcChaChiHpmL(2,6,2),      &
...
& cplcFdChaSuR(3,2,6),cplcFdChiSdL(3,6,6),cplcFdChiSdR(3,6,6),cplcFdFdAhL(3,3,3),        &
...
& cplcFeChaSvL(3,2,3),cplcFeChaSvR(3,2,3),cplcFeChiSeL(3,6,6),cplcFeChiSeR(3,6,6),       &
...
& cplcFeFvVWmR(3,3),cplcFuChiSuL(3,6,6),cplcFuChiSuR(3,6,6),cplcFuFdcHpmL(3,3,2),        &
...
& cplcFuFuVZpR(3,3),cplcFuFuVZR(3,3),cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplcFvChiSvL(3,6,3),&
...
& cplcgWmgZVWm,cplcgWpCgAcHpm(2),cplcgWpCgWpCAh(3),cplcgWpCgWpChh(3),cplcgWpCgWpCVP,     &
& cplcgWpCgWpCVZ,cplcgWpCgWpCVZp,cplcgWpCgZcHpm(2),cplcgWpCgZpcHpm(2),cplcgZgWmcHpm(2),  &
& cplcgZgWpCHpm(2),cplcgZgWpCVWm,cplcgZgZhh(3),cplcgZgZphh(3),cplcgZpgWmcHpm(2),         &
& cplcgZpgWpCHpm(2),cplcgZpgWpCVWm,cplcgZpgZhh(3),cplcgZpgZphh(3),cplChaFucSdL(2,3,6),   &
& cplChaFucSdR(2,3,6),cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),cplChiChacHpmL(6,2,2),     &
...
& cplChiChiVZpL(6,6),cplChiChiVZpR(6,6),cplChiChiVZR(6,6),cplChiFdcSdL(6,3,6)

Complex(dp),Intent(in) :: cplChiFdcSdR(6,3,6),cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6),cplChiFucSuL(6,3,6),       &
& cplChiFucSuR(6,3,6),cplChiFvcSvL(6,3,3),cplChiFvcSvR(6,3,3),cplcHpmVPVWm(2),           &
...
& cplhhHpmcVWm(3,2),cplhhHpmcVWmVP1(3,2),cplhhHpmcVWmVZ1(3,2),cplhhHpmcVWmVZp1(3,2),     &
& cplhhHpmSucSdaa(3,2,6,6),cplhhHpmSvcSe1(3,2,3,6),cplhhSdcHpmcSuaa(3,6,2,6),            &
...
& cplSdSucSdcSuabba(6,6,6,6),cplSdSvcSecSuaa(6,3,6,6),cplSecHpmcSv(6,2,3),               &
& cplSecSeVP(6,6),cplSecSeVZ(6,6),cplSecSeVZp(6,6),cplSecSvcVWm(6,3),cplSecSvcVWmVP1(6,3),&
& cplSecSvcVWmVZ1(6,3),cplSecSvcVWmVZp1(6,3),cplSeSucSdcSvaa(6,6,6,3),cplSeSvcSecSv1(6,3,6,3),&
& cplSucSdVPVWmaa(6,6),cplSucSdVWm(6,6),cplSucSdVWmVZaa(6,6),cplSucSdVWmVZpaa(6,6),      &
& cplSucSuVG(6,6),cplSucSuVP(6,6),cplSucSuVZ(6,6),cplSucSuVZp(6,6),cplSvcSeVPVWm1(3,6),  &
& cplSvcSeVWm(3,6),cplSvcSeVWmVZ1(3,6),cplSvcSeVWmVZp1(3,6),cplSvcSvVZ(3,3),             &
& cplSvcSvVZp(3,3),ctcplAhcHpmVWm(3,2),ctcplAhHpmcHpm(3,2,2),ctcplcFuFdcHpmL(3,3,2),     &
& ctcplcFuFdcHpmR(3,3,2),ctcplcFvFecHpmL(3,3,2),ctcplcFvFecHpmR(3,3,2),ctcplChiChacHpmL(6,2,2),&
& ctcplChiChacHpmR(6,2,2),ctcplcHpmVPVWm(2),ctcplcHpmVWmVZ(2),ctcplcHpmVWmVZp(2),        &
& ctcplhhcHpmVWm(3,2),ctcplhhHpmcHpm(3,2,2),ctcplHpmcHpmVP(2,2),ctcplHpmcHpmVZ(2,2),     &
& ctcplHpmcHpmVZp(2,2),ctcplSdcHpmcSu(6,2,6),ctcplSecHpmcSv(6,2,3),GcplAhHpmcHpm(3,2,2), &
& GcplcHpmVPVWm(2),GcplhhHpmcHpm(3,2,2),GcplHpmcHpmVZ(2,2),GcplHpmcHpmVZp(2,2),          &
& GcplHpmcVWmVP(2),GosZcplAhHpmcHpm(3,2,2),GosZcplcHpmVPVWm(2),GosZcplhhHpmcHpm(3,2,2),  &
& GosZcplHpmcHpmVZ(2,2),GosZcplHpmcHpmVZp(2,2),GosZcplHpmcVWmVP(2),GZcplAhHpmcHpm(3,2,2),&
& GZcplcHpmVPVWm(2),GZcplhhHpmcHpm(3,2,2),GZcplHpmcHpmVZ(2,2),GZcplHpmcHpmVZp(2,2),      &
& GZcplHpmcVWmVP(2),ZcplAhcHpmVWm(3,2),ZcplAhHpmcHpm(3,2,2),ZcplcFuFdcHpmL(3,3,2)

Complex(dp),Intent(in) :: ZcplcFuFdcHpmR(3,3,2),ZcplcFvFecHpmL(3,3,2),ZcplcFvFecHpmR(3,3,2),ZcplChiChacHpmL(6,2,2),&
& ZcplChiChacHpmR(6,2,2),ZcplcHpmVWmVZ(2),ZcplcHpmVWmVZp(2),ZcplhhcHpmVWm(3,2),          &
& ZcplhhHpmcHpm(3,2,2),ZcplHpmcHpmVZ(2,2),ZcplHpmcHpmVZp(2,2),ZcplSdcHpmcSu(6,2,6),      &
& ZcplSecHpmcSv(6,2,3)
...
Real(dp) :: MRPHpmToChiCha(2,6,2),MRGHpmToChiCha(2,6,2), MRPZHpmToChiCha(2,6,2),MRGZHpmToChiCha(2,6,2)
Real(dp) :: MVPHpmToChiCha(2,6,2)
Real(dp) :: RMsqTreeHpmToChiCha(2,6,2),RMsqWaveHpmToChiCha(2,6,2),RMsqVertexHpmToChiCha(2,6,2)
Complex(dp) :: AmpTreeHpmToChiCha(2,2,6,2),AmpWaveHpmToChiCha(2,2,6,2)=(0._dp,0._dp),AmpVertexHpmToChiCha(2,2,6,2)&
 & ,AmpVertexIRosHpmToChiCha(2,2,6,2),AmpVertexIRdrHpmToChiCha(2,2,6,2), AmpSumHpmToChiCha(2,2,6,2), AmpSum2HpmToChiCha(2,2,6,2)
Complex(dp) :: AmpTreeZHpmToChiCha(2,2,6,2),AmpWaveZHpmToChiCha(2,2,6,2),AmpVertexZHpmToChiCha(2,2,6,2)
Real(dp) :: AmpSqHpmToChiCha(2,6,2),  AmpSqTreeHpmToChiCha(2,6,2)
...
Call Amplitude_Tree_NonUMSSM_HpmToHpmAh(cplAhHpmcHpm,MAh,MHpm,MAh2,MHpm2,             &
& AmpTreeHpmToHpmAh)

  Else
Call Amplitude_Tree_NonUMSSM_HpmToHpmAh(ZcplAhHpmcHpm,MAh,MHpm,MAh2,MHpm2,            &
& AmpTreeHpmToHpmAh)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_HpmToHpmAh(MLambda,em,gs,cplAhHpmcHpm,MAhOS,MHpmOS,          &
& MRPHpmToHpmAh,MRGHpmToHpmAh)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_HpmToHpmAh(MLambda,em,gs,ZcplAhHpmcHpm,MAhOS,MHpmOS,         &
& MRPHpmToHpmAh,MRGHpmToHpmAh)
...
Else
 ! DR and no Z-factors
  If (.not.ExternalZfactors) Then
Call Gamma_Real_NonUMSSM_HpmToHpmAh(MLambda,em,gs,cplAhHpmcHpm,MAh,MHpm,              &
& MRPHpmToHpmAh,MRGHpmToHpmAh)

  Else
 ! DR and Z-factors
Call Gamma_Real_NonUMSSM_HpmToHpmAh(MLambda,em,gs,ZcplAhHpmcHpm,MAh,MHpm,             &
& MRPHpmToHpmAh,MRGHpmToHpmAh)
...
Call Amplitude_WAVE_NonUMSSM_HpmToHpmAh(cplAhHpmcHpm,ctcplAhHpmcHpm,MAh,              &
& MAh2,MHpm,MHpm2,ZfAh,ZfHpm,AmpWaveHpmToHpmAh)



!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_HpmToHpmAh(MAh,MCha,MChi,MFd,MFe,MFu,MFv,              &
...
& cplHpmSecHpmcSe1,cplHpmSucHpmcSuaa,AmpVertexHpmToHpmAh)

If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_HpmToHpmAh(MAh,MCha,MChi,MFd,MFe,MFu,               &
...
& cplHpmSdcHpmcSdaa,cplHpmSecHpmcSe1,cplHpmSucHpmcSuaa,AmpVertexIRdrHpmToHpmAh)
 ...
 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_HpmToHpmAh(MAhOS,MChaOS,MChiOS,MFdOS,               &
...
& cplAhHpmcVWmVP1,cplAhHpmcVWmVZ1,cplAhHpmcVWmVZp1,cplAhSdcHpmcSuaa,cplAhSecHpmcSv1,     &
& cplAhcHpmVPVWm1,cplAhcHpmVWmVZ1,cplAhcHpmVWmVZp1,cplHpmHpmcHpmcHpm1,cplHpmSdcHpmcSdaa, &
& cplHpmSecHpmcSe1,cplHpmSucHpmcSuaa,AmpVertexIRosHpmToHpmAh)
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_HpmToAhVWm(cplAhcHpmVWm,MAh,MHpm,MVWm,MAh2,              &
& MHpm2,MVWm2,AmpTreeHpmToAhVWm)

  Else
Call Amplitude_Tree_NonUMSSM_HpmToAhVWm(ZcplAhcHpmVWm,MAh,MHpm,MVWm,MAh2,             &
& MHpm2,MVWm2,AmpTreeHpmToAhVWm)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_HpmToAhVWm(MLambda,em,gs,cplAhcHpmVWm,MAhOS,MHpmOS,          &
& MVWmOS,MRPHpmToAhVWm,MRGHpmToAhVWm)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_HpmToAhVWm(MLambda,em,gs,ZcplAhcHpmVWm,MAhOS,MHpmOS,         &
& MVWmOS,MRPHpmToAhVWm,MRGHpmToAhVWm)
...
Else
 ! DR and no Z-factors
  If (.not.ExternalZfactors) Then
Call Gamma_Real_NonUMSSM_HpmToAhVWm(MLambda,em,gs,cplAhcHpmVWm,MAh,MHpm,              &
& MVWm,MRPHpmToAhVWm,MRGHpmToAhVWm)

  Else
 ! DR and Z-factors
Call Gamma_Real_NonUMSSM_HpmToAhVWm(MLambda,em,gs,ZcplAhcHpmVWm,MAh,MHpm,             &
& MVWm,MRPHpmToAhVWm,MRGHpmToAhVWm)
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_HpmToAhVWm(cplAhcHpmVWm,ctcplAhcHpmVWm,MAh,              &
& MAh2,MHpm,MHpm2,MVWm,MVWm2,ZfAh,ZfHpm,ZfVWm,AmpWaveHpmToAhVWm)



!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_HpmToAhVWm(MAh,MCha,MChi,MFd,MFe,MFu,MFv,              &
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            &
& MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,cplcChaChaAhL,     &
& cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,           &
& cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhVZ,             &
...
& cplcFeFvVWmR,cplcgWpCgAcHpm,cplcgZgWmcHpm,cplcgZpgWmcHpm,cplcgAgWpCVWm,cplcgZgWpCVWm,  &
...
If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_HpmToAhVWm(MAh,MCha,MChi,MFd,MFe,MFu,               &
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             &
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,              &
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         &
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,           &
...
& AmpVertexIRdrHpmToAhVWm)
 ...
 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_HpmToAhVWm(MAhOS,MChaOS,MChiOS,MFdOS,               &
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,               &
& MVZpOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,              &
& MSd2OS,MSe2OS,MSu2OS,MSv2OS,MVP2,MVWm2OS,MVZ2OS,MVZp2OS,cplAhAhhh,cplcChaChaAhL,       &
& cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,           &
& cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,cplAhhhVZ,             &
& cplAhhhVZp,GosZcplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSecSe,cplAhSucSu,             &
...
& cplcChaChaAhL,cplcChaChaAhR,cplChiChiAhL,cplChiChiAhR,cplcFdFdAhL,cplcFdFdAhR,         &
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWmgWmAh,cplcgWpCgWpCAh,           &
& cplAhhhVZ,cplAhhhVZp,GZcplAhHpmcHpm,cplAhHpmcVWm,cplAhSdcSd,cplAhSecSe,cplAhSucSu,     &
& ZcplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,cplcChaChiVWmL,cplcChaChiVWmR,             &
& cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFvFecHpmL,cplcFvFecHpmR,cplcFdFuVWmL,cplcFdFuVWmR,     &
& cplcFeFvVWmL,cplcFeFvVWmR,cplcgWpCgAcHpm,cplcgZgWmcHpm,cplcgZpgWmcHpm,cplcgAgWpCVWm,   &
& cplcgZgWpCVWm,cplcgZpgWpCVWm,cplcgWmgZVWm,cplcgWpCgZcHpm,cplcgWmgZpVWm,cplcgWpCgZpcHpm,&
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_HpmToChiCha(cplChiChacHpmL,cplChiChacHpmR,               &
& MCha,MChi,MHpm,MCha2,MChi2,MHpm2,AmpTreeHpmToChiCha)

  Else
Call Amplitude_Tree_NonUMSSM_HpmToChiCha(ZcplChiChacHpmL,ZcplChiChacHpmR,             &
& MCha,MChi,MHpm,MCha2,MChi2,MHpm2,AmpTreeHpmToChiCha)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_HpmToChiCha(MLambda,em,gs,cplChiChacHpmL,cplChiChacHpmR,     &
& MChaOS,MChiOS,MHpmOS,MRPHpmToChiCha,MRGHpmToChiCha)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_HpmToChiCha(MLambda,em,gs,ZcplChiChacHpmL,ZcplChiChacHpmR,   &
& MChaOS,MChiOS,MHpmOS,MRPHpmToChiCha,MRGHpmToChiCha)
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_HpmToChiCha(cplChiChacHpmL,cplChiChacHpmR,               &
...
!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_HpmToChiCha(MAh,MCha,MChi,MFd,MFe,MFu,MFv,             &
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            &
...
If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_HpmToChiCha(MAh,MCha,MChi,MFd,MFe,MFu,              &
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             &
...
& cplSdcHpmcSu,cplSecHpmcSv,cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,AmpVertexIRdrHpmToChiCha)
 ...
 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_HpmToChiCha(MAhOS,MChaOS,MChiOS,MFdOS,              &
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,               &
& MVZpOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,              &
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_HpmTocFuFd(cplcFuFdcHpmL,cplcFuFdcHpmR,MFd,              &
& MFu,MHpm,MFd2,MFu2,MHpm2,AmpTreeHpmTocFuFd)

  Else
Call Amplitude_Tree_NonUMSSM_HpmTocFuFd(ZcplcFuFdcHpmL,ZcplcFuFdcHpmR,MFd,            &
& MFu,MHpm,MFd2,MFu2,MHpm2,AmpTreeHpmTocFuFd)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_HpmTocFuFd(MLambda,em,gs,cplcFuFdcHpmL,cplcFuFdcHpmR,        &
& MFdOS,MFuOS,MHpmOS,MRPHpmTocFuFd,MRGHpmTocFuFd)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_HpmTocFuFd(MLambda,em,gs,ZcplcFuFdcHpmL,ZcplcFuFdcHpmR,      &
& MFdOS,MFuOS,MHpmOS,MRPHpmTocFuFd,MRGHpmTocFuFd)
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_HpmTocFuFd(cplcFuFdcHpmL,cplcFuFdcHpmR,ctcplcFuFdcHpmL,  &
...
!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_HpmTocFuFd(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,             &
...
If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_HpmTocFuFd(MAh,MCha,MChi,MFd,MFu,MGlu,              &
...
& cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,AmpVertexIRdrHpmTocFuFd)
 ...
 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_HpmTocFuFd(MAhOS,MChaOS,MChiOS,MFdOS,               &
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_HpmTocFvFe(cplcFvFecHpmL,cplcFvFecHpmR,MFe,              &
& MFv,MHpm,MFe2,MFv2,MHpm2,AmpTreeHpmTocFvFe)

  Else
Call Amplitude_Tree_NonUMSSM_HpmTocFvFe(ZcplcFvFecHpmL,ZcplcFvFecHpmR,MFe,            &
& MFv,MHpm,MFe2,MFv2,MHpm2,AmpTreeHpmTocFvFe)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_HpmTocFvFe(MLambda,em,gs,cplcFvFecHpmL,cplcFvFecHpmR,        &
& MFeOS,MFvOS,MHpmOS,MRPHpmTocFvFe,MRGHpmTocFvFe)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_HpmTocFvFe(MLambda,em,gs,ZcplcFvFecHpmL,ZcplcFvFecHpmR,      &
& MFeOS,MFvOS,MHpmOS,MRPHpmTocFvFe,MRGHpmTocFvFe)
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_HpmTocFvFe(cplcFvFecHpmL,cplcFvFecHpmR,ctcplcFvFecHpmL,  &
& ctcplcFvFecHpmR,MFe,MFe2,MFv,MFv2,MHpm,MHpm2,ZfFEL,ZfFER,ZfFvL,ZfHpm,AmpWaveHpmTocFvFe)



!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_HpmTocFvFe(MAh,MCha,MChi,MFe,MFv,Mhh,MHpm,             &
& MSe,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,MSv2,             &
& MVP2,MVWm2,MVZ2,MVZp2,cplcFeFeAhL,cplcFeFeAhR,cplAhHpmcHpm,cplAhcHpmVWm,               &
& cplChiChacHpmL,cplChiChacHpmR,cplChiFecSeL,cplChiFecSeR,cplcFvChiSvL,cplcFvChiSvR,     &
...
& cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcFvFvVZpL,cplcFvFvVZpR,         &
& cplhhHpmcHpm,cplhhcHpmVWm,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplcChacFvSeL,       &
& cplcChacFvSeR,cplSecHpmcSv,cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,AmpVertexHpmTocFvFe)

If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_HpmTocFvFe(MAh,MCha,MChi,MFe,MFv,Mhh,               &
& MHpm,MSe,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFe2,MFv2,Mhh2,MHpm2,MSe2,             &
& MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplcFeFeAhL,cplcFeFeAhR,cplAhHpmcHpm,cplAhcHpmVWm,          &
& cplChiChacHpmL,cplChiChacHpmR,cplChiFecSeL,cplChiFecSeR,cplcFvChiSvL,cplcFvChiSvR,     &
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               &
& cplcFeFeVZpL,cplcFeFeVZpR,cplcChaFecSvL,cplcChaFecSvR,cplcFvFecHpmL,cplcFvFecHpmR,     &
& cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcFvFvVZpL,cplcFvFvVZpR,         &
& cplhhHpmcHpm,cplhhcHpmVWm,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplcChacFvSeL,       &
& cplcChacFvSeR,cplSecHpmcSv,cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,AmpVertexIRdrHpmTocFvFe)

 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_HpmTocFvFe(MAhOS,MChaOS,MChiOS,MFeOS,               &
...
& cplcFeFeAhR,cplAhHpmcHpm,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,cplChiFecSeL,      &
& cplChiFecSeR,cplcFvChiSvL,cplcFvChiSvR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,            &
& cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFeVZpL,cplcFeFeVZpR,cplcChaFecSvL,           &
& cplcChaFecSvR,ZcplcFvFecHpmL,ZcplcFvFecHpmR,cplcFvFecVWmL,cplcFvFecVWmR,               &
...
& cplChiChacHpmL,cplChiChacHpmR,cplChiFecSeL,cplChiFecSeR,cplcFvChiSvL,cplcFvChiSvR,     &
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFeFeVZL,cplcFeFeVZR,               &
& cplcFeFeVZpL,cplcFeFeVZpR,cplcChaFecSvL,cplcChaFecSvR,ZcplcFvFecHpmL,ZcplcFvFecHpmR,   &
& cplcFvFecVWmL,cplcFvFecVWmR,cplcFvFvVZL,cplcFvFvVZR,cplcFvFvVZpL,cplcFvFvVZpR,         &
& cplhhHpmcHpm,cplhhcHpmVWm,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplcChacFvSeL,       &
& cplcChacFvSeR,cplSecHpmcSv,cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,AmpVertexIRosHpmTocFvFe)
...
& cplcHpmVWmVZ,cplcHpmVWmVZp,AmpVertexIRosHpmTocFvFe)
...
Do gt1=1,3
  Do gt2=1,3
AmpWaveZHpmTocFvFe(1,:,gt2,:) = AmpWaveZHpmTocFvFe(1,:,gt2,:)
AmpVertexZHpmTocFvFe(1,:,gt2,:)= AmpVertexZHpmTocFvFe(1,:,gt2,:)
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_HpmToHpmhh(cplhhHpmcHpm,Mhh,MHpm,Mhh2,MHpm2,             &
& AmpTreeHpmToHpmhh)

  Else
Call Amplitude_Tree_NonUMSSM_HpmToHpmhh(ZcplhhHpmcHpm,Mhh,MHpm,Mhh2,MHpm2,            &
& AmpTreeHpmToHpmhh)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_HpmToHpmhh(MLambda,em,gs,cplhhHpmcHpm,MhhOS,MHpmOS,          &
& MRPHpmToHpmhh,MRGHpmToHpmhh)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_HpmToHpmhh(MLambda,em,gs,ZcplhhHpmcHpm,MhhOS,MHpmOS,         &
& MRPHpmToHpmhh,MRGHpmToHpmhh)
...
Else
 ! DR and no Z-factors
  If (.not.ExternalZfactors) Then
Call Gamma_Real_NonUMSSM_HpmToHpmhh(MLambda,em,gs,cplhhHpmcHpm,Mhh,MHpm,              &
& MRPHpmToHpmhh,MRGHpmToHpmhh)

  Else
 ! DR and Z-factors
Call Gamma_Real_NonUMSSM_HpmToHpmhh(MLambda,em,gs,ZcplhhHpmcHpm,Mhh,MHpm,             &
& MRPHpmToHpmhh,MRGHpmToHpmhh)
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_HpmToHpmhh(cplhhHpmcHpm,ctcplhhHpmcHpm,Mhh,              &
& Mhh2,MHpm,MHpm2,Zfhh,ZfHpm,AmpWaveHpmToHpmhh)



!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_HpmToHpmhh(MAh,MCha,MChi,MFd,MFe,MFu,MFv,              &
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            &
...
If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_HpmToHpmhh(MAh,MCha,MChi,MFd,MFe,MFu,               &
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             &
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,              &
...
& AmpVertexIRdrHpmToHpmhh)
 ...
 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_HpmToHpmhh(MAhOS,MChaOS,MChiOS,MFdOS,               &
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,               &
& MVZpOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,              &
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_HpmTohhVWm(cplhhcHpmVWm,Mhh,MHpm,MVWm,Mhh2,              &
& MHpm2,MVWm2,AmpTreeHpmTohhVWm)

  Else
Call Amplitude_Tree_NonUMSSM_HpmTohhVWm(ZcplhhcHpmVWm,Mhh,MHpm,MVWm,Mhh2,             &
& MHpm2,MVWm2,AmpTreeHpmTohhVWm)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_HpmTohhVWm(MLambda,em,gs,cplhhcHpmVWm,MhhOS,MHpmOS,          &
& MVWmOS,MRPHpmTohhVWm,MRGHpmTohhVWm)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_HpmTohhVWm(MLambda,em,gs,ZcplhhcHpmVWm,MhhOS,MHpmOS,         &
& MVWmOS,MRPHpmTohhVWm,MRGHpmTohhVWm)
...
Else
 ! DR and no Z-factors
  If (.not.ExternalZfactors) Then
Call Gamma_Real_NonUMSSM_HpmTohhVWm(MLambda,em,gs,cplhhcHpmVWm,Mhh,MHpm,              &
& MVWm,MRPHpmTohhVWm,MRGHpmTohhVWm)

  Else
 ! DR and Z-factors
Call Gamma_Real_NonUMSSM_HpmTohhVWm(MLambda,em,gs,ZcplhhcHpmVWm,Mhh,MHpm,             &
& MVWm,MRPHpmTohhVWm,MRGHpmTohhVWm)
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_HpmTohhVWm(cplhhcHpmVWm,ctcplhhcHpmVWm,Mhh,              &
& Mhh2,MHpm,MHpm2,MVWm,MVWm2,Zfhh,ZfHpm,ZfVWm,AmpWaveHpmTohhVWm)



!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_HpmTohhVWm(MAh,MCha,MChi,MFd,MFe,MFu,MFv,              &
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            &
& MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,cplAhhhVZ,         &
& cplAhhhVZp,cplAhHpmcHpm,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,cplcChaChahhL,      &
...
& cplcFvFecHpmR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFuVWmL,cplcFdFuVWmR,cplcFeFvVWmL,          &
& cplcFeFvVWmR,cplcgWpCgAcHpm,cplcgWmgWmhh,cplcgZgWmcHpm,cplcgZpgWmcHpm,cplcgWpCgWpChh,  &
...
& cplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,cplhhcHpmVWm,    &
& cplhhcVWmVWm,cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,cplHpmcHpmVP,cplHpmcHpmVZ,               &
& cplHpmcHpmVZp,cplSdcHpmcSu,cplSecHpmcSv,cplSucSdVWm,cplSvcSeVWm,cplcHpmVPVWm,          &
& cplcVWmVPVWm,cplcHpmVWmVZ,cplcVWmVWmVZ,cplcHpmVWmVZp,cplcVWmVWmVZp,cplAhcHpmVWmVZ1,    &
& cplAhcHpmVWmVZp1,cplhhhhcVWmVWm1,cplhhcHpmVPVWm1,cplhhcHpmVWmVZ1,cplhhcHpmVWmVZp1,     &
& cplHpmcHpmcVWmVWm1,AmpVertexHpmTohhVWm)

If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_HpmTohhVWm(MAh,MCha,MChi,MFd,MFe,MFu,               &
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             &
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhAhhh,              &
...
& cplcFeFvVWmL,cplcFeFvVWmR,cplcgWpCgAcHpm,cplcgWmgWmhh,cplcgZgWmcHpm,cplcgZpgWmcHpm,    &
...
& cplhhcHpmVWm,cplhhcVWmVWm,cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,cplHpmcHpmVP,               &
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplSdcHpmcSu,cplSecHpmcSv,cplSucSdVWm,cplSvcSeVWm,          &
& cplcHpmVPVWm,cplcVWmVPVWm,cplcHpmVWmVZ,cplcVWmVWmVZ,cplcHpmVWmVZp,cplcVWmVWmVZp,       &
& cplAhcHpmVWmVZ1,cplAhcHpmVWmVZp1,cplhhhhcVWmVWm1,cplhhcHpmVPVWm1,cplhhcHpmVWmVZ1,      &
& cplhhcHpmVWmVZp1,cplHpmcHpmcVWmVWm1,AmpVertexIRdrHpmTohhVWm)

 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_HpmTohhVWm(MAhOS,MChaOS,MChiOS,MFdOS,               &
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,               &
& MVZpOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,              &
& MSd2OS,MSe2OS,MSu2OS,MSv2OS,MVP2,MVWm2OS,MVZ2OS,MVZp2OS,cplAhAhhh,cplAhhhVZ,           &
& cplAhhhVZp,cplAhHpmcHpm,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,cplcChaChahhL,      &
...
& cplcgAgWpCVWm,cplcgZgWpCVWm,cplcgZpgWpCVWm,cplcgZgZhh,cplcgZpgZhh,cplcgWmgZVWm,        &
& cplcgWpCgZcHpm,cplcgZgZphh,cplcgZpgZphh,cplcgWmgZpVWm,cplcgWpCgZpcHpm,cplhhhhhh,       &
& GosZcplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,             &
& ZcplhhcHpmVWm,cplhhcVWmVWm,cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,cplHpmcHpmVP,              &
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplSdcHpmcSu,cplSecHpmcSv,cplSucSdVWm,cplSvcSeVWm,          &
& GosZcplcHpmVPVWm,cplcVWmVPVWm,cplcHpmVWmVZ,cplcVWmVWmVZ,cplcHpmVWmVZp,cplcVWmVWmVZp,   &
& cplAhcHpmVWmVZ1,cplAhcHpmVWmVZp1,cplhhhhcVWmVWm1,cplhhcHpmVPVWm1,cplhhcHpmVWmVZ1,      &
& cplhhcHpmVWmVZp1,cplHpmcHpmcVWmVWm1,AmpVertexIRosHpmTohhVWm)
...
& cplcgWpCgWpChh,cplcgAgWpCVWm,cplcgZgWpCVWm,cplcgZpgWpCVWm,cplcgZgZhh,cplcgZpgZhh,      &
& cplcgWmgZVWm,cplcgWpCgZcHpm,cplcgZgZphh,cplcgZpgZphh,cplcgWmgZpVWm,cplcgWpCgZpcHpm,    &
& cplhhhhhh,GZcplhhHpmcHpm,cplhhHpmcVWm,cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,     &
& ZcplhhcHpmVWm,cplhhcVWmVWm,cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,cplHpmcHpmVP,              &
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplSdcHpmcSu,cplSecHpmcSv,cplSucSdVWm,cplSvcSeVWm,          &
...
& cplhhcVWmVWm,cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,cplHpmcHpmVP,cplHpmcHpmVZ,               &
& cplHpmcHpmVZp,cplSdcHpmcSu,cplSecHpmcSv,cplSucSdVWm,cplSvcSeVWm,GcplcHpmVPVWm,         &
& cplcVWmVPVWm,cplcHpmVWmVZ,cplcVWmVWmVZ,cplcHpmVWmVZp,cplcVWmVWmVZp,cplAhcHpmVWmVZ1,    &
& cplAhcHpmVWmVZp1,cplhhhhcVWmVWm1,cplhhcHpmVPVWm1,cplhhcHpmVWmVZ1,cplhhcHpmVWmVZp1,     &
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_HpmToHpmVZ(cplHpmcHpmVZ,MHpm,MVZ,MHpm2,MVZ2,             &
& AmpTreeHpmToHpmVZ)

  Else
Call Amplitude_Tree_NonUMSSM_HpmToHpmVZ(ZcplHpmcHpmVZ,MHpm,MVZ,MHpm2,MVZ2,            &
& AmpTreeHpmToHpmVZ)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_HpmToHpmVZ(MLambda,em,gs,cplHpmcHpmVZ,MHpmOS,MVZOS,          &
& MRPHpmToHpmVZ,MRGHpmToHpmVZ)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_HpmToHpmVZ(MLambda,em,gs,ZcplHpmcHpmVZ,MHpmOS,               &
...
Else
 ! DR and no Z-factors
  If (.not.ExternalZfactors) Then
Call Gamma_Real_NonUMSSM_HpmToHpmVZ(MLambda,em,gs,cplHpmcHpmVZ,MHpm,MVZ,              &
& MRPHpmToHpmVZ,MRGHpmToHpmVZ)

  Else
 ! DR and Z-factors
Call Gamma_Real_NonUMSSM_HpmToHpmVZ(MLambda,em,gs,ZcplHpmcHpmVZ,MHpm,MVZ,             &
& MRPHpmToHpmVZ,MRGHpmToHpmVZ)
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_HpmToHpmVZ(cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,      &
...
!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_HpmToHpmVZ(MAh,MCha,MChi,MFd,MFe,MFu,MFv,              &
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            &
...
If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_HpmToHpmVZ(MAh,MCha,MChi,MFd,MFe,MFu,               &
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             &
...
& cplHpmcHpmVPVZ1,cplHpmcHpmVZVZ1,cplHpmcHpmVZVZp1,AmpVertexIRdrHpmToHpmVZ)
 ...
 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_HpmToHpmVZ(MAhOS,MChaOS,MChiOS,MFdOS,               &
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,               &
& MVZpOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,              &
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_HpmToHpmVZp(cplHpmcHpmVZp,MHpm,MVZp,MHpm2,               &
& MVZp2,AmpTreeHpmToHpmVZp)

  Else
Call Amplitude_Tree_NonUMSSM_HpmToHpmVZp(ZcplHpmcHpmVZp,MHpm,MVZp,MHpm2,              &
& MVZp2,AmpTreeHpmToHpmVZp)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_HpmToHpmVZp(MLambda,em,gs,cplHpmcHpmVZp,MHpmOS,              &
& MVZpOS,MRPHpmToHpmVZp,MRGHpmToHpmVZp)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_HpmToHpmVZp(MLambda,em,gs,ZcplHpmcHpmVZp,MHpmOS,             &
& MVZpOS,MRPHpmToHpmVZp,MRGHpmToHpmVZp)
...
Else
 ! DR and no Z-factors
  If (.not.ExternalZfactors) Then
Call Gamma_Real_NonUMSSM_HpmToHpmVZp(MLambda,em,gs,cplHpmcHpmVZp,MHpm,MVZp,           &
& MRPHpmToHpmVZp,MRGHpmToHpmVZp)

  Else
 ! DR and Z-factors
Call Gamma_Real_NonUMSSM_HpmToHpmVZp(MLambda,em,gs,ZcplHpmcHpmVZp,MHpm,               &
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_HpmToHpmVZp(cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,     &
...
!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_HpmToHpmVZp(MAh,MCha,MChi,MFd,MFe,MFu,MFv,             &
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            &
...
If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_HpmToHpmVZp(MAh,MCha,MChi,MFd,MFe,MFu,              &
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             &
...
& cplhhcHpmVWmVZp1,cplHpmcHpmVPVZp1,cplHpmcHpmVZVZp1,cplHpmcHpmVZpVZp1,AmpVertexIRdrHpmToHpmVZp)
 ...
 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_HpmToHpmVZp(MAhOS,MChaOS,MChiOS,MFdOS,              &
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,               &
& MVZpOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,              &
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_HpmTocSuSd(cplSdcHpmcSu,MHpm,MSd,MSu,MHpm2,              &
& MSd2,MSu2,AmpTreeHpmTocSuSd)

  Else
Call Amplitude_Tree_NonUMSSM_HpmTocSuSd(ZcplSdcHpmcSu,MHpm,MSd,MSu,MHpm2,             &
& MSd2,MSu2,AmpTreeHpmTocSuSd)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_HpmTocSuSd(MLambda,em,gs,cplSdcHpmcSu,MHpmOS,MSdOS,          &
& MSuOS,MRPHpmTocSuSd,MRGHpmTocSuSd)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_HpmTocSuSd(MLambda,em,gs,ZcplSdcHpmcSu,MHpmOS,               &
...
Else
 ! DR and no Z-factors
  If (.not.ExternalZfactors) Then
Call Gamma_Real_NonUMSSM_HpmTocSuSd(MLambda,em,gs,cplSdcHpmcSu,MHpm,MSd,              &
& MSu,MRPHpmTocSuSd,MRGHpmTocSuSd)

  Else
 ! DR and Z-factors
Call Gamma_Real_NonUMSSM_HpmTocSuSd(MLambda,em,gs,ZcplSdcHpmcSu,MHpm,MSd,             &
& MSu,MRPHpmTocSuSd,MRGHpmTocSuSd)
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_HpmTocSuSd(cplSdcHpmcSu,ctcplSdcHpmcSu,MHpm,             &
& MHpm2,MSd,MSd2,MSu,MSu2,ZfHpm,ZfSd,ZfSu,AmpWaveHpmTocSuSd)



!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_HpmTocSuSd(MAh,MCha,MChi,MFd,MFu,MGlu,Mhh,             &
...
If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_HpmTocSuSd(MAh,MCha,MChi,MFd,MFu,MGlu,              &
...
& cplSdSvcSecSuaa,cplSdcSucVWmVPaa,cplSdcSucVWmVZaa,cplSdcSucVWmVZpaa,AmpVertexIRdrHpmTocSuSd)
 ...
 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_HpmTocSuSd(MAhOS,MChaOS,MChiOS,MFdOS,               &
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_HpmTocSvSe(cplSecHpmcSv,MHpm,MSe,MSv,MHpm2,              &
& MSe2,MSv2,AmpTreeHpmTocSvSe)

  Else
Call Amplitude_Tree_NonUMSSM_HpmTocSvSe(ZcplSecHpmcSv,MHpm,MSe,MSv,MHpm2,             &
& MSe2,MSv2,AmpTreeHpmTocSvSe)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_HpmTocSvSe(MLambda,em,gs,cplSecHpmcSv,MHpmOS,MSeOS,          &
& MSvOS,MRPHpmTocSvSe,MRGHpmTocSvSe)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_HpmTocSvSe(MLambda,em,gs,ZcplSecHpmcSv,MHpmOS,               &
...
Else
 ! DR and no Z-factors
  If (.not.ExternalZfactors) Then
Call Gamma_Real_NonUMSSM_HpmTocSvSe(MLambda,em,gs,cplSecHpmcSv,MHpm,MSe,              &
& MSv,MRPHpmTocSvSe,MRGHpmTocSvSe)

  Else
 ! DR and Z-factors
Call Gamma_Real_NonUMSSM_HpmTocSvSe(MLambda,em,gs,ZcplSecHpmcSv,MHpm,MSe,             &
& MSv,MRPHpmTocSvSe,MRGHpmTocSvSe)
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_HpmTocSvSe(cplSecHpmcSv,ctcplSecHpmcSv,MHpm,             &
& MHpm2,MSe,MSe2,MSv,MSv2,ZfHpm,ZfSe,ZfSv,AmpWaveHpmTocSvSe)



!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_HpmTocSvSe(MAh,MCha,MChi,MFe,MFv,Mhh,MHpm,             &
...
& cplSeSvcSecSv1,cplSecSvcVWmVP1,cplSecSvcVWmVZ1,cplSecSvcVWmVZp1,AmpVertexHpmTocSvSe)

If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_HpmTocSvSe(MAh,MCha,MChi,MFe,MFv,Mhh,               &
...
& cplSecSvcVWm,cplSvcSvVZ,cplSvcSvVZp,cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,           &
& cplAhSecHpmcSv1,cplhhSecHpmcSv1,cplHpmSecHpmcSe1,cplHpmSvcHpmcSv1,cplSeSucSdcSvaa,     &
& cplSeSvcSecSv1,cplSecSvcVWmVP1,cplSecSvcVWmVZ1,cplSecSvcVWmVZp1,AmpVertexIRdrHpmTocSvSe)

 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_HpmTocSvSe(MAhOS,MChaOS,MChiOS,MFeOS,               &
...
& cplSecSvcVWmVP1,cplSecSvcVWmVZ1,cplSecSvcVWmVZp1,AmpVertexIRosHpmTocSvSe)
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_HpmToVZVWm(cplcHpmVWmVZ,MHpm,MVWm,MVZ,MHpm2,             &
& MVWm2,MVZ2,AmpTreeHpmToVZVWm)

  Else
Call Amplitude_Tree_NonUMSSM_HpmToVZVWm(ZcplcHpmVWmVZ,MHpm,MVWm,MVZ,MHpm2,            &
& MVWm2,MVZ2,AmpTreeHpmToVZVWm)
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_HpmToVZVWm(MLambda,em,gs,cplcHpmVWmVZ,MHpmOS,MVWmOS,         &
& MVZOS,MRPHpmToVZVWm,MRGHpmToVZVWm)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_HpmToVZVWm(MLambda,em,gs,ZcplcHpmVWmVZ,MHpmOS,               &
...
Else
 ! DR and no Z-factors
  If (.not.ExternalZfactors) Then
Call Gamma_Real_NonUMSSM_HpmToVZVWm(MLambda,em,gs,cplcHpmVWmVZ,MHpm,MVWm,             &
& MVZ,MRPHpmToVZVWm,MRGHpmToVZVWm)

  Else
 ! DR and Z-factors
Call Gamma_Real_NonUMSSM_HpmToVZVWm(MLambda,em,gs,ZcplcHpmVWmVZ,MHpm,MVWm,            &
& MVZ,MRPHpmToVZVWm,MRGHpmToVZVWm)
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_HpmToVZVWm(cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,      &
...
!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_HpmToVZVWm(MAh,MCha,MChi,MFd,MFe,MFu,MFv,              &
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            &
& MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhhhVZ,cplAhHpmcHpm,      &
...
If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_HpmToVZVWm(MAh,MCha,MChi,MFd,MFe,MFu,               &
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             &
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhhhVZ,              &
...
& cplcVWmVWmVZVZ1Q,cplcVWmVWmVZVZp3Q,cplcVWmVWmVZVZp2Q,cplcVWmVWmVZVZp1Q,AmpVertexIRdrHpmToVZVWm)
 ...
 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_HpmToVZVWm(MAhOS,MChaOS,MChiOS,MFdOS,               &
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,               &
& MVZpOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,              &
& MSd2OS,MSe2OS,MSu2OS,MSv2OS,MVP2,MVWm2OS,MVZ2OS,MVZp2OS,cplAhhhVZ,cplAhHpmcHpm,        &
& cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,cplcChaChaVZL,cplcChaChaVZR,cplChiChiVZL,   &
...
!Tree Level
  If (.not.ExternalZfactors) Then
Call Amplitude_Tree_NonUMSSM_HpmToVZpVWm(cplcHpmVWmVZp,MHpm,MVWm,MVZp,MHpm2,          &
& MVWm2,MVZp2,AmpTreeHpmToVZpVWm)

  Else
Call Amplitude_Tree_NonUMSSM_HpmToVZpVWm(ZcplcHpmVWmVZp,MHpm,MVWm,MVZp,               &
...
If (OSkinematics) Then
  If (.not.ExternalZfactors) Then
 ! OS and no Z-factors
Call Gamma_Real_NonUMSSM_HpmToVZpVWm(MLambda,em,gs,cplcHpmVWmVZp,MHpmOS,              &
& MVWmOS,MVZpOS,MRPHpmToVZpVWm,MRGHpmToVZpVWm)

  Else
 ! OS and Z-factors
Call Gamma_Real_NonUMSSM_HpmToVZpVWm(MLambda,em,gs,ZcplcHpmVWmVZp,MHpmOS,             &
& MVWmOS,MVZpOS,MRPHpmToVZpVWm,MRGHpmToVZpVWm)
...
Else
 ! DR and no Z-factors
  If (.not.ExternalZfactors) Then
Call Gamma_Real_NonUMSSM_HpmToVZpVWm(MLambda,em,gs,cplcHpmVWmVZp,MHpm,MVWm,           &
& MVZp,MRPHpmToVZpVWm,MRGHpmToVZpVWm)

  Else
 ! DR and Z-factors
Call Gamma_Real_NonUMSSM_HpmToVZpVWm(MLambda,em,gs,ZcplcHpmVWmVZp,MHpm,               &
...
!Self-energy Corrections
Call Amplitude_WAVE_NonUMSSM_HpmToVZpVWm(cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,     &
& ctcplcHpmVPVWm,ctcplcHpmVWmVZ,ctcplcHpmVWmVZp,MHpm,MHpm2,MVP,MVP2,MVWm,MVWm2,          &
...
!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_HpmToVZpVWm(MAh,MCha,MChi,MFd,MFe,MFu,MFv,             &
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            &
& MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhhhVZp,cplAhHpmcHpm,     &
...
If (ShiftIRdiv) Then
Call Amplitude_IR_VERTEX_NonUMSSM_HpmToVZpVWm(MAh,MCha,MChi,MFd,MFe,MFu,              &
& MFv,Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,             &
& MFu2,MFv2,Mhh2,MHpm2,MSd2,MSe2,MSu2,MSv2,MVP2,MVWm2,MVZ2,MVZp2,cplAhhhVZp,             &
...
& cplcVWmVWmVZpVZp1Q,AmpVertexIRdrHpmToVZpVWm)
 ...
 If (ExternalZfactors) Then
  If (OSkinematics) Then
 ! OS and Z-factors
Call Amplitude_IR_VERTEX_NonUMSSM_HpmToVZpVWm(MAhOS,MChaOS,MChiOS,MFdOS,              &
& MFeOS,MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,               &
& MVZpOS,MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,              &
& MSd2OS,MSe2OS,MSu2OS,MSv2OS,MVP2,MVWm2OS,MVZ2OS,MVZp2OS,cplAhhhVZp,cplAhHpmcHpm,       &
& cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,cplcChaChaVZpL,cplcChaChaVZpR,              &
...
!Self-energy Corrections
 If (ExternalZfactors) Then
Call Amplitude_WAVE_NonUMSSM_HpmToHpmVP(cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,      &
...
!Vertex Corrections
 If (ExternalZfactors) Then
Call Amplitude_VERTEX_NonUMSSM_HpmToHpmVP(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,            &
...
!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_HpmToHpmVP(MAh,MCha,MChi,MFd,MFe,MFu,MFv,              &
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            &
...
!Self-energy Corrections
 If (ExternalZfactors) Then
Call Amplitude_WAVE_NonUMSSM_HpmToVPVWm(cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,      &
...
!Vertex Corrections
 If (ExternalZfactors) Then
Call Amplitude_VERTEX_NonUMSSM_HpmToVPVWm(MAhOS,MChaOS,MChiOS,MFdOS,MFeOS,            &
& MFuOS,MFvOS,MhhOS,MHpmOS,MSdOS,MSeOS,MSuOS,MSvOS,MVP,MVWmOS,MVZOS,MVZpOS,              &
& MAh2OS,MCha2OS,MChi2OS,MFd2OS,MFe2OS,MFu2OS,MFv2OS,Mhh2OS,MHpm2OS,MSd2OS,              &
...
!Vertex Corrections
Call Amplitude_VERTEX_NonUMSSM_HpmToVPVWm(MAh,MCha,MChi,MFd,MFe,MFu,MFv,              &
& Mhh,MHpm,MSd,MSe,MSu,MSv,MVP,MVWm,MVZ,MVZp,MAh2,MCha2,MChi2,MFd2,MFe2,MFu2,            &
...
End Module Wrapper_OneLoopDecay_Hpm_NonUMSSM
