...
! ------------------------------------------------------------------------------  
! File created at 0:39 on 10.2.2021   
! ----------------------------------------------------------------------  
 
 
Module CouplingsForDecays_NonUMSSM
...
& vSinput,cplAhSdcSd,cplChaFucSdL,cplChaFucSdR,cplChiFdcSdL,cplChiFdcSdR,cplGluFdcSdL,   & 
...
Real(dp),Intent(in) :: g1input,g2input,g3input,gpinput,laminput,Tlaminput,ml012input,ml022input,             & 
& ml032input,mHd2input,mHu2input,me012input,me022input,me032input,ms2input,              & 
& vdinput,vuinput,vSinput

Complex(dp),Intent(in) :: Ydinput(3,3),Ye11input,Ye22input,Ye33input,Yuinput(3,3),Tdinput(3,3),TYe11input,      & 
...
If ((m_in.le.Qin).and.(RunningCouplingsDecays)) Then 
  ...
  dt=tz/50._dp 
  Call odeint(g1D,186,0._dp,tz,deltaM,dt,0._dp,rge186,kont)

End if 
Call GToParameters186(g1D,g1,g2,g3,gp,Yd,Ye11,Ye22,Ye33,lam,Yu,Td,TYe11,              & 
...
& md2,mu2,me012,me022,me032,ms2,M1,M2,M3,M4,Tdp,Tep,Tmup,.True.,kont)
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,ms2input,       & 
& M1input,M2input,M3input,M4input,Tdpinput,Tepinput,Tmupinput,vdinput,vuinput,           & 
& vSinput,cplAhSucSu,cplChiFucSuL,cplChiFucSuR,cplcChaFdcSuL,cplcChaFdcSuR,              & 
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,ms2input,       & 
& M1input,M2input,M3input,M4input,Tdpinput,Tepinput,Tmupinput,vdinput,vuinput,           & 
& vSinput,cplAhSecSe,cplChaFvcSeL,cplChaFvcSeR,cplChiFecSeL,cplChiFecSeR,cplhhSecSe,     & 
...
& lam,Tep,Tmup,vd,vu,vS,ZV,ZE,ZP,cplHpmSvcSe(gt1,gt2,gt3))
...
Do gt1 = 1, 2
 Do gt2 = 1, 3
  Do gt3 = 1, 6
Call CouplingChaFvcSeT(gt1,gt2,gt3,g2,Ye11,Ye22,Ye33,ZVL,ZE,UM,cplChaFvcSeL(gt1,gt2,gt3)& 
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,ms2input,       & 
& M1input,M2input,M3input,M4input,Tdpinput,Tepinput,Tmupinput,vdinput,vuinput,           & 
& vSinput,cplChiFvcSvL,cplChiFvcSvR,cplcChaFecSvL,cplcChaFecSvR,cplhhSvcSv,              & 
& cplSecHpmcSv,cplSecSvcVWm,cplSvcSvVZ,cplSvcSvVZp,deltaM)
...
& lam,Tep,Tmup,vd,vu,vS,ZV,ZE,ZP,cplSecHpmcSv(gt1,gt2,gt3))
...
Do gt1 = 1, 2
 Do gt2 = 1, 3
  Do gt3 = 1, 3
Call CouplingcChaFecSvT(gt1,gt2,gt3,g2,Ye11,Ye22,Ye33,ZV,UM,UP,ZEL,ZER,               & 
& cplcChaFecSvL(gt1,gt2,gt3),cplcChaFecSvR(gt1,gt2,gt3))
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,ms2input,       & 
& M1input,M2input,M3input,M4input,Tdpinput,Tepinput,Tmupinput,vdinput,vuinput,           & 
& vSinput,cplHiggsPP,cplHiggsGG,cplHiggsZZvirt,cplHiggsWWvirt,cplAhAhhh,cplAhhhVZ,       & 
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,ms2input,       & 
& M1input,M2input,M3input,M4input,Tdpinput,Tepinput,Tmupinput,vdinput,vuinput,           & 
& vSinput,cplPseudoHiggsPP,cplPseudoHiggsGG,cplAhAhhh,cplcChaChaAhL,cplcChaChaAhR,       & 
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,ms2input,       & 
& M1input,M2input,M3input,M4input,Tdpinput,Tepinput,Tmupinput,vdinput,vuinput,           & 
& vSinput,cplAhHpmcHpm,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,cplcFuFdcHpmL,         & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 2
Call CouplingcFvFecHpmT(gt1,gt2,gt3,Ye11,Ye22,Ye33,ZVL,ZP,ZER,cplcFvFecHpmL(gt1,gt2,gt3)& 
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,ms2input,       & 
& M1input,M2input,M3input,M4input,Tdpinput,Tepinput,Tmupinput,vdinput,vuinput,           & 
& vSinput,cplAhhhVZp,cplcChaChaVZpL,cplcChaChaVZpR,cplChiChiVZpL,cplChiChiVZpR,          & 
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,ms2input,       & 
& M1input,M2input,M3input,M4input,Tdpinput,Tepinput,Tmupinput,vdinput,vuinput,           & 
& vSinput,cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,cplGluFucSuR,deltaM)
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,ms2input,       & 
& M1input,M2input,M3input,M4input,Tdpinput,Tepinput,Tmupinput,vdinput,vuinput,           & 
& vSinput,cplChiChiAhL,cplChiChiAhR,cplChiChacHpmL,cplChiChacHpmR,cplChiChacVWmL,        & 
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,ms2input,       & 
& M1input,M2input,M3input,M4input,Tdpinput,Tepinput,Tmupinput,vdinput,vuinput,           & 
& vSinput,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,         & 
...
Do gt1 = 1, 2
 Do gt2 = 1, 3
  Do gt3 = 1, 6
Call CouplingcChacFvSeT(gt1,gt2,gt3,g2,Ye11,Ye22,Ye33,ZVL,ZE,UM,cplcChacFvSeL(gt1,gt2,gt3)& 
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,ms2input,       & 
& M1input,M2input,M3input,M4input,Tdpinput,Tepinput,Tmupinput,vdinput,vuinput,           & 
& vSinput,cplcFuFuAhL,cplcFuFuAhR,cplcFuChiSuL,cplcFuChiSuR,cplcFuFdcHpmL,               & 
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,ms2input,       & 
& M1input,M2input,M3input,M4input,Tdpinput,Tepinput,Tmupinput,vdinput,vuinput,           & 
& vSinput,cplcChacFuSdL,cplcChacFuSdR,cplcChaFdcSuL,cplcChaFdcSuR,cplcFdChiSdL,          & 
...
& cplcFvChiSvL,cplcFvChiSvR,cplcFvFvVZL,cplcFvFvVZpL,cplcFvFvVZpR,cplcFvFvVZR,           & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 2
  Do gt3 = 1, 3
Call CouplingcFeChaSvT(gt1,gt2,gt3,g2,Ye11,Ye22,Ye33,ZV,UM,UP,ZEL,ZER,cplcFeChaSvL(gt1,gt2,gt3)& 
...
Do gt1 = 1, 3
 Do gt2 = 1, 3
  Do gt3 = 1, 2
Call CouplingcFeFvHpmT(gt1,gt2,gt3,Ye11,Ye22,Ye33,ZVL,ZP,ZER,cplcFeFvHpmL(gt1,gt2,gt3)& 
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,ms2input,       & 
& M1input,M2input,M3input,M4input,Tdpinput,Tepinput,Tmupinput,vdinput,vuinput,           & 
& vSinput,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,cplcChaChaAhL,         & 
...
& cplChiChiVZR,cplChiFdcSdL,cplChiFdcSdR,cplChiFecSeL,cplChiFecSeR,cplGluFdcSdL,         & 
& cplGluFdcSdR,deltaM)
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,ms2input,       & 
& M1input,M2input,M3input,M4input,Tdpinput,Tepinput,Tmupinput,vdinput,vuinput,           & 
& vSinput,cplAhSdcSd,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,            & 
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,ms2input,       & 
& M1input,M2input,M3input,M4input,Tdpinput,Tepinput,Tmupinput,vdinput,vuinput,           & 
& vSinput,cplAhSucSu,cplcChacFuSdL,cplcChacFuSdR,cplcChaChaAhL,cplcChaChaAhR,            & 
...
& cplcFuGluSuL,cplcFuGluSuR,cplcFvChiSvL,cplcFvChiSvR,cplcFvFvVZL,cplcFvFvVZpL,          & 
& cplcFvFvVZpR,cplcFvFvVZR,cplChaFucSdL,cplChaFucSdR,cplChaFvcSeL,cplChaFvcSeR,          & 
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,ms2input,       & 
& M1input,M2input,M3input,M4input,Tdpinput,Tepinput,Tmupinput,vdinput,vuinput,           & 
& vSinput,cplAhSecSe,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,            & 
& cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,cplcChaChaVZpL,  & 
& cplcChaChaVZpR,cplcChaChaVZR,cplcChaChiHpmL,cplcChaChiHpmR,cplcChaFdcSuL,              & 
...
& mHd2input,mHu2input,md2input,mu2input,me012input,me022input,me032input,ms2input,       & 
& M1input,M2input,M3input,M4input,Tdpinput,Tepinput,Tmupinput,vdinput,vuinput,           & 
& vSinput,cplcChacFvSeL,cplcChacFvSeR,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,         & 
...
& cplcFeFvVWmR,cplcFuChiSuL,cplcFuChiSuR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,            & 
& cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplcFvChiSvL,cplcFvChiSvR,cplcFvFecHpmL,         & 
& cplcFvFecHpmR,cplcFvFvVZL,cplcFvFvVZpL,cplcFvFvVZpR,cplcFvFvVZR,cplChaFucSdL,          & 
& cplChaFucSdR,cplChaFvcSeL,cplChaFvcSeR,cplChiChacHpmL,cplChiChacHpmR,cplChiChiAhL,     & 
& cplChiChiAhR,cplChiChihhL,cplChiChihhR,cplChiChiVZL,cplChiChiVZpL,cplChiChiVZpR,       & 
& cplChiChiVZR,cplChiFdcSdL,cplChiFdcSdR,cplChiFecSeL,cplChiFecSeR,cplChiFucSuL,         & 
& cplChiFucSuR,cplChiFvcSvL,cplChiFvcSvR,cplhhSvcSv,cplSecHpmcSv,cplSecSvcVWm,           & 
...
End Module CouplingsForDecays_NonUMSSM
