...
! ------------------------------------------------------------------------------  
! File created at 16:24 on 4.2.2021   
! ----------------------------------------------------------------------  
 
 
Module LoopCouplings_NonUMSSM 
...
& MSv,MVWm,MVZp,g1,g2,gp,TW,TWp,UM,UP,vd,vu,Ye11,Ye22,Ye33,ZA,ZE,ZEL,ZER,ZH,             & 
& ZN,ZP,ZV,ZVL,res)
...
Complex(dp),Intent(in) :: UM(2,2),UP(2,2),Ye11,Ye22,Ye33,ZA(3,3),ZE(6,6),ZEL(3,3),ZER(3,3),ZH(3,3),             & 
& ZN(6,6),ZV(3,3),ZVL(3,3)
...
End Module LoopCouplings_NonUMSSM 
