...
InputValueformu2= .True. 
   ...
   Else If (read_line(7:11).Eq."TDPIN") Then 
InputValueforTdp= .True. 
    Call ReadMatrixC(99,3,3,TdpIN,0, "TdpIN",kont)

 
   Else If (read_line(7:13).Eq."IMTDPIN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMTdp") 
       Cycle 
     End If 
    Call ReadMatrixC(99,3,3,TdpIN,1, "TdpIN",kont)
...
Complex(dp) :: PDGSd(6),PDGSu(6),PDGSe(6),PDGSv(3),PDGhh(3),PDGAh(3),PDGHpm(2),PDGVP,PDGVZp,         & 
...
Write(io_L,100) "# SUSY Les Houches Accord 2 - NonUMSSM Spectrum + Decays + Flavor Observables"
...
Write(io_L,101) 4, Real(Azero,dp) ,"# Azero"
...
Write(io_L,101) 4, Aimag(Azero) ,"# Azero"
End if 
End if 
WriteNextBlock = .false. 
...
Write(io_L,101) 62, Real(ALambdaInput,dp) ,"# ALambdaInput"
End if 
If (Abs(Real(vSInput,dp)).gt.0._dp) Then 
Write(io_L,101) 63, Real(vSInput,dp) ,"# vSInput"
End if 
If (Abs(Real(Qq,dp)).gt.0._dp) Then 
Write(io_L,101) 71, Real(Qq,dp) ,"# Qq"
End if 
If (Abs(Real(Ql1,dp)).gt.0._dp) Then 
Write(io_L,101) 72, Real(Ql1,dp) ,"# Ql1"
End if 
If (Abs(Real(Ql2,dp)).gt.0._dp) Then 
Write(io_L,101) 73, Real(Ql2,dp) ,"# Ql2"
End if 
If (Abs(Real(Ql3,dp)).gt.0._dp) Then 
Write(io_L,101) 74, Real(Ql3,dp) ,"# Ql3"
End if 
If (Abs(Real(QHu,dp)).gt.0._dp) Then 
Write(io_L,101) 75, Real(QHu,dp) ,"# QHu"
End if 
If (Abs(Real(QHd,dp)).gt.0._dp) Then 
Write(io_L,101) 76, Real(QHd,dp) ,"# QHd"
End if 
If (Abs(Real(Qd,dp)).gt.0._dp) Then 
Write(io_L,101) 77, Real(Qd,dp) ,"# Qd"
End if 
If (Abs(Real(Qu,dp)).gt.0._dp) Then 
Write(io_L,101) 78, Real(Qu,dp) ,"# Qu"
End if 
If (Abs(Real(Qe1,dp)).gt.0._dp) Then 
Write(io_L,101) 79, Real(Qe1,dp) ,"# Qe1"
End if 
If (Abs(Real(Qe2,dp)).gt.0._dp) Then 
Write(io_L,101) 80, Real(Qe2,dp) ,"# Qe2"
End if 
If (Abs(Real(Qe3,dp)).gt.0._dp) Then 
Write(io_L,101) 81, Real(Qe3,dp) ,"# Qe3"
End if 
If (Abs(Real(Qs,dp)).gt.0._dp) Then 
Write(io_L,101) 82, Real(Qs,dp) ,"# Qs"
End if 
End if 
WriteNextBlock = .false. 
...
Write(io_L,101) 62, Aimag(ALambdaInput) ,"# ALambdaInput"
End if 
If (Abs(Aimag(vSInput)).gt.0._dp) Then 
Write(io_L,101) 63, Aimag(vSInput) ,"# vSInput"
End if 
End if 
...
Write(io_L,104) 2,Real(Tlam,dp), "# Tlam" 
...
End if 
If (WriteSLHA1) Then 
Write(io_L,104)  31,  Real(sqrt(ml012),dp), " # mL(1,1) " 
Write(io_L,104)  32,  Real(sqrt(ml022),dp), " # mL(2,2)" 
Write(io_L,104)  33,  Real(sqrt(ml032),dp), " # mL(3,3)" 
Write(io_L,104)  34,  Real(sqrt(me012),dp), " # mE(1,1)" 
Write(io_L,104)  35,  Real(sqrt(me022),dp), " # mE(2,2)" 
Write(io_L,104)  36,  Real(sqrt(me032),dp), " # mE(3,3)" 
...
Write(io_L,106) "Block TDP Q=",Q,"# (SUSY Scale)" 
Write(io_L,107)1,1,Real(Tdp(1,1),dp), "# Real(Tdp(1,1),dp)" 
Write(io_L,107)1,2,Real(Tdp(1,2),dp), "# Real(Tdp(1,2),dp)" 
Write(io_L,107)1,3,Real(Tdp(1,3),dp), "# Real(Tdp(1,3),dp)" 
Write(io_L,107)2,1,Real(Tdp(2,1),dp), "# Real(Tdp(2,1),dp)" 
Write(io_L,107)2,2,Real(Tdp(2,2),dp), "# Real(Tdp(2,2),dp)" 
Write(io_L,107)2,3,Real(Tdp(2,3),dp), "# Real(Tdp(2,3),dp)" 
Write(io_L,107)3,1,Real(Tdp(3,1),dp), "# Real(Tdp(3,1),dp)" 
Write(io_L,107)3,2,Real(Tdp(3,2),dp), "# Real(Tdp(3,2),dp)" 
Write(io_L,107)3,3,Real(Tdp(3,3),dp), "# Real(Tdp(3,3),dp)" 
If ((MaxVal(Abs(AImag(Tdp))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMTDP Q=",Q,"# (SUSY Scale)" 
Write(io_L,107)1,1,Aimag(Tdp(1,1)), "# Aimag(Tdp(1,1))" 
Write(io_L,107)1,2,Aimag(Tdp(1,2)), "# Aimag(Tdp(1,2))" 
Write(io_L,107)1,3,Aimag(Tdp(1,3)), "# Aimag(Tdp(1,3))" 
Write(io_L,107)2,1,Aimag(Tdp(2,1)), "# Aimag(Tdp(2,1))" 
Write(io_L,107)2,2,Aimag(Tdp(2,2)), "# Aimag(Tdp(2,2))" 
Write(io_L,107)2,3,Aimag(Tdp(2,3)), "# Aimag(Tdp(2,3))" 
Write(io_L,107)3,1,Aimag(Tdp(3,1)), "# Aimag(Tdp(3,1))" 
Write(io_L,107)3,2,Aimag(Tdp(3,2)), "# Aimag(Tdp(3,2))" 
Write(io_L,107)3,3,Aimag(Tdp(3,3)), "# Aimag(Tdp(3,3))" 
End If 
...
Write(io_L,106) "Block AE Q=",Q," # " 
 Write(io_L,107) 1, 1, Real(Tye11,dp)/Real(Ye11,dp),"# Te(1,1)/Ye(1,1) " 
Write(io_L,107) 2, 2, Real(Tye22,dp)/Real(Ye22,dp),"# Te(2,2)/Ye(2,2) " 
Write(io_L,107) 3, 3, Real(Tye33,dp)/Real(Ye33,dp),"# Te(3,3)/Ye(3,3) " 
End if 
...
Write(io_L,104) 2,Real(TlamGUT,dp), "# Tlam" 
...
Write(io_L,106) "Block TdpGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Real(TdpGUT(1,1),dp), "# Real(TdpGUT(1,1),dp)" 
Write(io_L,107)1,2,Real(TdpGUT(1,2),dp), "# Real(TdpGUT(1,2),dp)" 
Write(io_L,107)1,3,Real(TdpGUT(1,3),dp), "# Real(TdpGUT(1,3),dp)" 
Write(io_L,107)2,1,Real(TdpGUT(2,1),dp), "# Real(TdpGUT(2,1),dp)" 
Write(io_L,107)2,2,Real(TdpGUT(2,2),dp), "# Real(TdpGUT(2,2),dp)" 
Write(io_L,107)2,3,Real(TdpGUT(2,3),dp), "# Real(TdpGUT(2,3),dp)" 
Write(io_L,107)3,1,Real(TdpGUT(3,1),dp), "# Real(TdpGUT(3,1),dp)" 
Write(io_L,107)3,2,Real(TdpGUT(3,2),dp), "# Real(TdpGUT(3,2),dp)" 
Write(io_L,107)3,3,Real(TdpGUT(3,3),dp), "# Real(TdpGUT(3,3),dp)" 
If ((MaxVal(Abs(AImag(TdpGUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMTdpGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(TdpGUT(1,1)), "# Aimag(TdpGUT(1,1))" 
Write(io_L,107)1,2,Aimag(TdpGUT(1,2)), "# Aimag(TdpGUT(1,2))" 
Write(io_L,107)1,3,Aimag(TdpGUT(1,3)), "# Aimag(TdpGUT(1,3))" 
Write(io_L,107)2,1,Aimag(TdpGUT(2,1)), "# Aimag(TdpGUT(2,1))" 
Write(io_L,107)2,2,Aimag(TdpGUT(2,2)), "# Aimag(TdpGUT(2,2))" 
Write(io_L,107)2,3,Aimag(TdpGUT(2,3)), "# Aimag(TdpGUT(2,3))" 
Write(io_L,107)3,1,Aimag(TdpGUT(3,1)), "# Aimag(TdpGUT(3,1))" 
Write(io_L,107)3,2,Aimag(TdpGUT(3,2)), "# Aimag(TdpGUT(3,2))" 
Write(io_L,107)3,3,Aimag(TdpGUT(3,3)), "# Aimag(TdpGUT(3,3))" 
End If 
...
Write(io_L,100) "Block DMASS  # Overall uncertainty"
 ...
 Write(io_L,102) INT(Abs(1000055)), Sqrt(mass_uncertainty_Q(35)**2+mass_uncertainty_Yt(35)**2),"# MChi(6) " 
 Write(io_L,102) INT(Abs(-1000024)), Sqrt(mass_uncertainty_Q(36)**2+mass_uncertainty_Yt(36)**2),"# MCha(1) " 
 Write(io_L,102) INT(Abs(-1000037)), Sqrt(mass_uncertainty_Q(37)**2+mass_uncertainty_Yt(37)**2),"# MCha(2) " 
 Write(io_L,102) INT(Abs(1000021)), Sqrt(mass_uncertainty_Q(38)**2+mass_uncertainty_Yt(38)**2),"# MGlu(1) " 
Write(io_L,100) "Block DMASSQ  # Scale uncertainty"
 ...
 Write(io_L,102) INT(Abs(1000055)), mass_uncertainty_Q(35),"# MChi(6) " 
 Write(io_L,102) INT(Abs(-1000024)), mass_uncertainty_Q(36),"# MCha(1) " 
 Write(io_L,102) INT(Abs(-1000037)), mass_uncertainty_Q(37),"# MCha(2) " 
 Write(io_L,102) INT(Abs(1000021)), mass_uncertainty_Q(38),"# MGlu(1) " 
Write(io_L,100) "Block DMASST  # Top Matching uncertainty"
 ...
 Write(io_L,102) INT(Abs(1000055)), mass_uncertainty_Yt(35),"# MChi(6) " 
 Write(io_L,102) INT(Abs(-1000024)), mass_uncertainty_Yt(36),"# MCha(1) " 
 Write(io_L,102) INT(Abs(-1000037)), mass_uncertainty_Yt(37),"# MCha(2) " 
 Write(io_L,102) INT(Abs(1000021)), mass_uncertainty_Yt(38),"# MGlu(1) " 
End if
...
End if 
Write(io_L,106) "Block NEMIX Q=",Q,"# ()" 
...
Write(io_L,106) "Block IMNEMIX Q=",Q,"# ()" 
...
icount = icount +1 
  End Do 
If (Maxval(BRSd(1,76:1344)).Gt.BRmin) Then 
...
icount = icount +1 
  End Do 
If (Maxval(BRSd(2,76:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
icount = icount +1 
  End Do 
If (Maxval(BRSd(3,76:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
icount = icount +1 
  End Do 
If (Maxval(BRSd(4,76:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
icount = icount +1 
  End Do 
If (Maxval(BRSd(5,76:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
icount = icount +1 
  End Do 
If (Maxval(BRSd(6,76:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
icount = icount +1 
  End Do 
If (Maxval(BRSu(1,76:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRSu(2,76:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRSu(3,76:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRSu(4,76:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRSu(5,76:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRSu(6,76:1344)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRSe(1,67:1221)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
icount = icount +1 
  End Do 
If (Maxval(BRSe(2,67:1221)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
icount = icount +1 
  End Do 
If (Maxval(BRSe(3,67:1221)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
icount = icount +1 
  End Do 
If (Maxval(BRSe(4,67:1221)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
icount = icount +1 
  End Do 
If (Maxval(BRSe(5,67:1221)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
icount = icount +1 
  End Do 
If (Maxval(BRSe(6,67:1221)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=3,3
  Do gt2=1,2
...
icount = icount +1 
  End Do 
If (Maxval(BRSv(1,52:1068)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRSv(2,52:1068)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,6
...
icount = icount +1 
  End Do 
If (Maxval(BRSv(3,52:1068)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,3
  Do gt2=1,6
...
If (Maxval(BRChi(1,104:613)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,2
...
If (Maxval(BRChi(2,104:613)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,2
...
If (Maxval(BRChi(3,104:613)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,2
...
If (Maxval(BRChi(4,104:613)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,2
...
If (Maxval(BRChi(5,104:613)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,2
...
If (Maxval(BRChi(6,104:613)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,6
  Do gt2=1,2
...
If (Maxval(BRCha(1,88:356)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,2
  Do gt2=1,2
...
If (Maxval(BRCha(2,88:356)).Gt.BRmin) Then 
Write(io_L,100) "#    BR                NDA      ID1      ID2       ID3" 
End If 
Do gt1=1,2
  Do gt2=1,2
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.NonUMSSM",status="unknown")
...
Write(123,*) "Tdp11_r= ",Real(Tdp(1,1),dp)
Write(123,*) "Tdp12_r= ",Real(Tdp(1,2),dp)
Write(123,*) "Tdp13_r= ",Real(Tdp(1,3),dp)
Write(123,*) "Tdp21_r= ",Real(Tdp(2,1),dp)
Write(123,*) "Tdp22_r= ",Real(Tdp(2,2),dp)
Write(123,*) "Tdp23_r= ",Real(Tdp(2,3),dp)
Write(123,*) "Tdp31_r= ",Real(Tdp(3,1),dp)
Write(123,*) "Tdp32_r= ",Real(Tdp(3,2),dp)
Write(123,*) "Tdp33_r= ",Real(Tdp(3,3),dp)
Write(123,*) "Tdp11_i= ",AImag(Tdp(1,1))
Write(123,*) "Tdp12_i= ",AImag(Tdp(1,2))
Write(123,*) "Tdp13_i= ",AImag(Tdp(1,3))
Write(123,*) "Tdp21_i= ",AImag(Tdp(2,1))
Write(123,*) "Tdp22_i= ",AImag(Tdp(2,2))
Write(123,*) "Tdp23_i= ",AImag(Tdp(2,3))
Write(123,*) "Tdp31_i= ",AImag(Tdp(3,1))
Write(123,*) "Tdp32_i= ",AImag(Tdp(3,2))
Write(123,*) "Tdp33_i= ",AImag(Tdp(3,3))
...
Subroutine WriteWCXF 
   Open(123,file="WC.NonUMSSM_1.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
...
Write(123,*) "}"
    Close(123) 
   Open(123,file="WC.NonUMSSM_2.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
Write(123,*) '  "basis": "FlavorKit",'
Write(123,*) '  "scale": "91.",'
...
End Module InputOutput_NonUMSSM 
