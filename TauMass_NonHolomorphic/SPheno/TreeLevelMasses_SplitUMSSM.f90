...
! ------------------------------------------------------------------------------  
! File created at 4:01 on 15.11.2020   
! ----------------------------------------------------------------------  
 
 
Module TreeLevelMasses_SplitUMSSM 
...
& ms2,M1,M2,M3,M4,Tdp,Tep,GenerationMixing,kont)
...
Complex(dp) :: MGluC 
Iname = Iname + 1 
NameOfUnit(Iname) = 'TreeMassesSplitUMSSM'
...
Call CalculateMSv(g1,g2,gp,Ql4,Ql9,QHd,QHu,Qs,ml42,ml92,vd,vu,vS,ZV,MSv,              & 
& MSv2,kont)
...
Call CalculateMSe(g1,g2,gp,Ql4,Ql9,QHd,QHu,Qe4,Qe9,Qs,y1,Ty1,y2,Ty2,lam,              & 
& ml42,ml92,me42,me92,Tep,vd,vu,vS,ZE,MSe,MSe2,kont)
...
MCha2 = MCha**2 
Call CalculateMFe(y1,y2,vd,ZEL,ZER,MFe,kont)
...
& mHu2,md2,mu2,me42,me92,ms2,M1,M2,M3,M4,Tdp,Tep,kont)
...
& g3,gp,Yd,y1,y2,lam,Yu,Td,Ty1,Ty2,Tlam,Tu,mq2,ml42,ml92,mHd2,mHu2,md2,mu2,              & 
& me42,me92,ms2,M1,M2,M3,M4,Tdp,Tep,GenerationMixing,kont)
...
Call CalculateMSvEffPot(g1,g2,gp,Ql4,Ql9,QHd,QHu,Qs,ml42,ml92,vd,vu,vS,               & 
& ZV,MSv,MSv2,kont)
...
Call CalculateMSeEffPot(g1,g2,gp,Ql4,Ql9,QHd,QHu,Qe4,Qe9,Qs,y1,Ty1,y2,Ty2,            & 
& lam,ml42,ml92,me42,me92,Tep,vd,vu,vS,ZE,MSe,MSe2,kont)
...
MCha2 = MCha**2 
Call CalculateMFeEffPot(y1,y2,vd,ZEL,ZER,MFe,kont)
...
Subroutine CalculateMSv(g1,g2,gp,Ql4,Ql9,QHd,QHu,Qs,ml42,ml92,vd,vu,vS,               & 
& ZV,MSv,MSv2,kont)
...
mat(1,1) = 0._dp 
mat(1,1) = mat(1,1)+ml42
mat(1,1) = mat(1,1)+(g1**2*vd**2)/8._dp
mat(1,1) = mat(1,1)+(g2**2*vd**2)/8._dp
mat(1,1) = mat(1,1)+(gp**2*QHd*Ql4*vd**2)/2._dp
mat(1,1) = mat(1,1)+(gp**2*Ql4*Qs*vS**2)/2._dp
mat(1,1) = mat(1,1)-(g1**2*vu**2)/8._dp
mat(1,1) = mat(1,1)-(g2**2*vu**2)/8._dp
mat(1,1) = mat(1,1)+(gp**2*QHu*Ql4*vu**2)/2._dp
mat(1,2) = 0._dp 
mat(1,3) = 0._dp 
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)+(g1**2*vd**2)/8._dp
mat(2,2) = mat(2,2)+(g2**2*vd**2)/8._dp
mat(2,2) = mat(2,2)+(gp**2*QHd*Ql9*vd**2)/2._dp
mat(2,2) = mat(2,2)+(gp**2*Ql9*Qs*vS**2)/2._dp
mat(2,2) = mat(2,2)-(g1**2*vu**2)/8._dp
mat(2,2) = mat(2,2)-(g2**2*vu**2)/8._dp
mat(2,2) = mat(2,2)+(gp**2*QHu*Ql9*vu**2)/2._dp
mat(2,2) = mat(2,2)+ml92(1,1)
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)+ml92(1,2)
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+(g1**2*vd**2)/8._dp
mat(3,3) = mat(3,3)+(g2**2*vd**2)/8._dp
mat(3,3) = mat(3,3)+(gp**2*QHd*Ql9*vd**2)/2._dp
mat(3,3) = mat(3,3)+(gp**2*Ql9*Qs*vS**2)/2._dp
mat(3,3) = mat(3,3)-(g1**2*vu**2)/8._dp
mat(3,3) = mat(3,3)-(g2**2*vu**2)/8._dp
mat(3,3) = mat(3,3)+(gp**2*QHu*Ql9*vu**2)/2._dp
mat(3,3) = mat(3,3)+ml92(2,2)
...
Subroutine CalculateMSe(g1,g2,gp,Ql4,Ql9,QHd,QHu,Qe4,Qe9,Qs,y1,Ty1,y2,Ty2,            & 
& lam,ml42,ml92,me42,me92,Tep,vd,vu,vS,ZE,MSe,MSe2,kont)
...
mat(1,1) = mat(1,1)+(g2**2*vu**2)/8._dp
mat(1,1) = mat(1,1)+(gp**2*QHu*Ql4*vu**2)/2._dp
mat(1,1) = mat(1,1)+(vd**2*y1*Conjg(y1))/2._dp
mat(1,2) = 0._dp 
mat(1,3) = 0._dp 
mat(1,4) = 0._dp 
mat(1,4) = mat(1,4)-(vS*vu*lam*Conjg(y1))/2._dp
mat(1,4) = mat(1,4)+(vd*Conjg(Ty1))/sqrt(2._dp)
mat(1,5) = 0._dp 
mat(1,6) = 0._dp 
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)+(g1**2*vd**2)/8._dp
...
mat(2,2) = mat(2,2)+ml92(1,1)
Do j1 = 1,2
mat(2,2) = mat(2,2)+(vd**2*Conjg(y2(j1,1))*y2(j1,1))/2._dp
End Do 
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)+ml92(1,2)
Do j1 = 1,2
mat(2,3) = mat(2,3)+(vd**2*Conjg(y2(j1,1))*y2(j1,2))/2._dp
End Do 
mat(2,4) = 0._dp 
mat(2,5) = 0._dp 
mat(2,5) = mat(2,5)-((vu*Conjg(Tep(1,1)))/sqrt(2._dp))
mat(2,5) = mat(2,5)-(vS*vu*lam*Conjg(y2(1,1)))/2._dp
mat(2,5) = mat(2,5)+(vd*Conjg(Ty2(1,1)))/sqrt(2._dp)
mat(2,6) = 0._dp 
mat(2,6) = mat(2,6)-((vu*Conjg(Tep(2,1)))/sqrt(2._dp))
mat(2,6) = mat(2,6)-(vS*vu*lam*Conjg(y2(2,1)))/2._dp
mat(2,6) = mat(2,6)+(vd*Conjg(Ty2(2,1)))/sqrt(2._dp)
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+(g1**2*vd**2)/8._dp
mat(3,3) = mat(3,3)-(g2**2*vd**2)/8._dp
mat(3,3) = mat(3,3)+(gp**2*QHd*Ql9*vd**2)/2._dp
...
mat(3,3) = mat(3,3)+ml92(2,2)
Do j1 = 1,2
mat(3,3) = mat(3,3)+(vd**2*Conjg(y2(j1,2))*y2(j1,2))/2._dp
End Do 
mat(3,4) = 0._dp 
mat(3,5) = 0._dp 
mat(3,5) = mat(3,5)-((vu*Conjg(Tep(1,2)))/sqrt(2._dp))
mat(3,5) = mat(3,5)-(vS*vu*lam*Conjg(y2(1,2)))/2._dp
mat(3,5) = mat(3,5)+(vd*Conjg(Ty2(1,2)))/sqrt(2._dp)
mat(3,6) = 0._dp 
mat(3,6) = mat(3,6)-((vu*Conjg(Tep(2,2)))/sqrt(2._dp))
mat(3,6) = mat(3,6)-(vS*vu*lam*Conjg(y2(2,2)))/2._dp
mat(3,6) = mat(3,6)+(vd*Conjg(Ty2(2,2)))/sqrt(2._dp)
mat(4,4) = 0._dp 
mat(4,4) = mat(4,4)+me42
mat(4,4) = mat(4,4)-(g1**2*vd**2)/4._dp
mat(4,4) = mat(4,4)+(gp**2*Qe4*QHd*vd**2)/2._dp
mat(4,4) = mat(4,4)+(gp**2*Qe4*Qs*vS**2)/2._dp
mat(4,4) = mat(4,4)+(g1**2*vu**2)/4._dp
mat(4,4) = mat(4,4)+(gp**2*Qe4*QHu*vu**2)/2._dp
mat(4,4) = mat(4,4)+(vd**2*y1*Conjg(y1))/2._dp
mat(4,5) = 0._dp 
mat(4,6) = 0._dp 
mat(5,5) = 0._dp 
mat(5,5) = mat(5,5)-(g1**2*vd**2)/4._dp
mat(5,5) = mat(5,5)+(gp**2*Qe9*QHd*vd**2)/2._dp
mat(5,5) = mat(5,5)+(gp**2*Qe9*Qs*vS**2)/2._dp
mat(5,5) = mat(5,5)+(g1**2*vu**2)/4._dp
mat(5,5) = mat(5,5)+(gp**2*Qe9*QHu*vu**2)/2._dp
mat(5,5) = mat(5,5)+me92(1,1)
Do j1 = 1,2
mat(5,5) = mat(5,5)+(vd**2*Conjg(y2(1,j1))*y2(1,j1))/2._dp
End Do 
mat(5,6) = 0._dp 
mat(5,6) = mat(5,6)+me92(1,2)
Do j1 = 1,2
mat(5,6) = mat(5,6)+(vd**2*Conjg(y2(2,j1))*y2(1,j1))/2._dp
End Do 
mat(6,6) = 0._dp 
mat(6,6) = mat(6,6)-(g1**2*vd**2)/4._dp
mat(6,6) = mat(6,6)+(gp**2*Qe9*QHd*vd**2)/2._dp
mat(6,6) = mat(6,6)+(gp**2*Qe9*Qs*vS**2)/2._dp
mat(6,6) = mat(6,6)+(g1**2*vu**2)/4._dp
mat(6,6) = mat(6,6)+(gp**2*Qe9*QHu*vu**2)/2._dp
mat(6,6) = mat(6,6)+me92(2,2)
Do j1 = 1,2
mat(6,6) = mat(6,6)+(vd**2*Conjg(y2(2,j1))*y2(2,j1))/2._dp
End Do 
...
Subroutine CalculateMFe(y1,y2,vd,ZEL,ZER,MFe,kont)
...
ZER = 0._dp 
mat(1,1) = 0._dp 
mat(1,1) = mat(1,1)+(vd*y1)/sqrt(2._dp)
mat(1,2) = 0._dp 
mat(1,3) = 0._dp 
mat(2,1) = 0._dp 
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)+(vd*y2(1,1))/sqrt(2._dp)
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)+(vd*y2(2,1))/sqrt(2._dp)
mat(3,1) = 0._dp 
mat(3,2) = 0._dp 
mat(3,2) = mat(3,2)+(vd*y2(1,2))/sqrt(2._dp)
mat(3,3) = 0._dp 
mat(3,3) = mat(3,3)+(vd*y2(2,2))/sqrt(2._dp)
...
Subroutine CalculateMSvEffPot(g1,g2,gp,Ql4,Ql9,QHd,QHu,Qs,ml42,ml92,vd,               & 
...
mat(1,1) = mat(1,1)+(g2**2*vdFix**2)/8._dp
mat(1,1) = mat(1,1)+(gp**2*QHd*Ql4*vdFix**2)/2._dp
mat(1,1) = mat(1,1)+(gp**2*Ql4*Qs*vSFix**2)/2._dp
mat(1,1) = mat(1,1)-(g1**2*vuFix**2)/8._dp
mat(1,1) = mat(1,1)-(g2**2*vuFix**2)/8._dp
mat(1,1) = mat(1,1)+(gp**2*QHu*Ql4*vuFix**2)/2._dp
mat(1,2) = 0._dp 
mat(1,3) = 0._dp 
mat(2,2) = 0._dp 
mat(2,2) = mat(2,2)+(g1**2*vdFix**2)/8._dp
mat(2,2) = mat(2,2)+(g2**2*vdFix**2)/8._dp
mat(2,2) = mat(2,2)+(gp**2*QHd*Ql9*vdFix**2)/2._dp
mat(2,2) = mat(2,2)+(gp**2*Ql9*Qs*vSFix**2)/2._dp
mat(2,2) = mat(2,2)-(g1**2*vuFix**2)/8._dp
mat(2,2) = mat(2,2)-(g2**2*vuFix**2)/8._dp
mat(2,2) = mat(2,2)+(gp**2*QHu*Ql9*vuFix**2)/2._dp
mat(2,2) = mat(2,2)+ml92(1,1)
mat(2,3) = 0._dp 
mat(2,3) = mat(2,3)+ml92(1,2)
mat(3,3) = 0._dp 
...
mat(3,3) = mat(3,3)+(g2**2*vdFix**2)/8._dp
mat(3,3) = mat(3,3)+(gp**2*QHd*Ql9*vdFix**2)/2._dp
mat(3,3) = mat(3,3)+(gp**2*Ql9*Qs*vSFix**2)/2._dp
mat(3,3) = mat(3,3)-(g1**2*vuFix**2)/8._dp
mat(3,3) = mat(3,3)-(g2**2*vuFix**2)/8._dp
mat(3,3) = mat(3,3)+(gp**2*QHu*Ql9*vuFix**2)/2._dp
mat(3,3) = mat(3,3)+ml92(2,2)
...
Subroutine CalculateMSeEffPot(g1,g2,gp,Ql4,Ql9,QHd,QHu,Qe4,Qe9,Qs,y1,Ty1,             & 
& y2,Ty2,lam,ml42,ml92,me42,me92,Tep,vd,vu,vS,ZE,MSe,MSe2,kont)
...
mat(4,4) = mat(4,4)+(gp**2*Qe4*QHd*vdFix**2)/2._dp
mat(4,4) = mat(4,4)+(gp**2*Qe4*Qs*vSFix**2)/2._dp
mat(4,4) = mat(4,4)+(g1**2*vuFix**2)/4._dp
mat(4,4) = mat(4,4)+(gp**2*Qe4*QHu*vuFix**2)/2._dp
mat(4,4) = mat(4,4)+(vd**2*y1*Conjg(y1))/2._dp
mat(4,5) = 0._dp 
mat(4,6) = 0._dp 
mat(5,5) = 0._dp 
mat(5,5) = mat(5,5)-(g1**2*vdFix**2)/4._dp
mat(5,5) = mat(5,5)+(gp**2*Qe9*QHd*vdFix**2)/2._dp
mat(5,5) = mat(5,5)+(gp**2*Qe9*Qs*vSFix**2)/2._dp
mat(5,5) = mat(5,5)+(g1**2*vuFix**2)/4._dp
mat(5,5) = mat(5,5)+(gp**2*Qe9*QHu*vuFix**2)/2._dp
mat(5,5) = mat(5,5)+me92(1,1)
Do j1 = 1,2
mat(5,5) = mat(5,5)+(vd**2*Conjg(y2(1,j1))*y2(1,j1))/2._dp
End Do 
...
mat(6,6) = mat(6,6)+(gp**2*Qe9*QHd*vdFix**2)/2._dp
mat(6,6) = mat(6,6)+(gp**2*Qe9*Qs*vSFix**2)/2._dp
mat(6,6) = mat(6,6)+(g1**2*vuFix**2)/4._dp
mat(6,6) = mat(6,6)+(gp**2*Qe9*QHu*vuFix**2)/2._dp
mat(6,6) = mat(6,6)+me92(2,2)
Do j1 = 1,2
mat(6,6) = mat(6,6)+(vd**2*Conjg(y2(2,j1))*y2(2,j1))/2._dp
End Do 
...
Subroutine CalculateMFeEffPot(y1,y2,vd,ZEL,ZER,MFe,kont)
...
& mu2,me42,me92,ms2,M1,M2,M3,M4,Tdp,Tep,GenerationMixing,kont)
...
End Module TreeLevelMasses_SplitUMSSM 
