...
! ------------------------------------------------------------------------------  
! File created at 4:40 on 15.11.2020   
! ----------------------------------------------------------------------  
 
 
Module LoopMasses_SplitUMSSM 
...
Use Tadpoles_SplitUMSSM 
 Use EffectivePotential_SplitUMSSM 
 Use Pole2L_SplitUMSSM 
...
& g1,gp,ZN,ZDL,ZDR,g3,pG,vd,ZH,Tu,ZU,ZP,TW,TWp,y1,y2,ZE,ZV,ZVL,ZEL,ZER,Ty1,              & 
& Ty2,Tep,Tlam,cplAhSdcUSd,cplChaFucUSdL,cplChaFucUSdR,cplChiFdcUSdL,cplChiFdcUSdR,      & 
...
If (NewGBC) Then 
Call CalculatePi2S(125._dp**2,vd,vu,vS,g1,g2,g3,gp,Yd,y1,y2,lam,Yu,Td,Ty1,            & 
& Ty2,Tlam,Tu,mq2,ml42,ml92,mHd2,mHu2,md2,mu2,me42,me92,ms2,M1,M2,M3,M4,Tdp,             & 
& Tep,kont,ti_ep2L,Pi2S_EffPot,PiP2S_EffPot)

Else 
Call CalculatePi2S(0._dp,vd,vu,vS,g1,g2,g3,gp,Yd,y1,y2,lam,Yu,Td,Ty1,Ty2,             & 
...
Call OneLoopSv(g1,g2,gp,Ql4,Ql9,QHd,QHu,Qs,ml42,ml92,vd,vu,vS,MFv,MFv2,               & 
...
Call OneLoopSe(g1,g2,gp,Ql4,Ql9,QHd,QHu,Qe4,Qe9,Qs,y1,Ty1,y2,Ty2,lam,ml42,            & 
& ml92,me42,me92,Tep,vd,vu,vS,MSe,MSe2,MAh,MAh2,MFv,MFv2,MCha,MCha2,MFe,MFe2,            & 
...
Subroutine OneLoopSv(g1,g2,gp,Ql4,Ql9,QHd,QHu,Qs,ml42,ml92,vd,vu,vS,MFv,              & 
& MFv2,MChi,MChi2,MCha,MCha2,MFe,MFe2,MSv,MSv2,Mhh,Mhh2,MHpm,MHpm2,MSe,MSe2,             & 
& MVWm,MVWm2,MVZ,MVZ2,MVZp,MVZp2,MAh,MAh2,MSd,MSd2,MSu,MSu2,cplChiFvcUSvL,               & 
& cplChiFvcUSvR,cplcChaFecUSvL,cplcChaFecUSvR,cplhhSvcUSv,cplSecHpmcUSv,cplSecUSvcVWm,   & 
& cplSvcUSvVZ,cplSvcUSvVZp,cplAhAhUSvcUSv,cplhhhhUSvcUSv,cplHpmUSvcHpmcUSv,              & 
& cplSdUSvcSdcUSv,cplSeUSvcSecUSv,cplSuUSvcSucUSv,cplUSvSvcUSvcSv,cplUSvcUSvcVWmVWm,     & 
...
Real(dp), Intent(in) :: g1,g2,gp,Ql4,Ql9,QHd,QHu,Qs,ml42,vd,vu,vS

Complex(dp), Intent(in) :: ml92(2,2)
...
mat2a(1,1) = 0._dp 
mat2a(1,1) = mat2a(1,1)+ml42
mat2a(1,1) = mat2a(1,1)+(g1**2*vd**2)/8._dp
mat2a(1,1) = mat2a(1,1)+(g2**2*vd**2)/8._dp
mat2a(1,1) = mat2a(1,1)+(gp**2*QHd*Ql4*vd**2)/2._dp
mat2a(1,1) = mat2a(1,1)+(gp**2*Ql4*Qs*vS**2)/2._dp
mat2a(1,1) = mat2a(1,1)-(g1**2*vu**2)/8._dp
mat2a(1,1) = mat2a(1,1)-(g2**2*vu**2)/8._dp
mat2a(1,1) = mat2a(1,1)+(gp**2*QHu*Ql4*vu**2)/2._dp
mat2a(1,2) = 0._dp 
mat2a(1,3) = 0._dp 
mat2a(2,2) = 0._dp 
mat2a(2,2) = mat2a(2,2)+(g1**2*vd**2)/8._dp
mat2a(2,2) = mat2a(2,2)+(g2**2*vd**2)/8._dp
mat2a(2,2) = mat2a(2,2)+(gp**2*QHd*Ql9*vd**2)/2._dp
mat2a(2,2) = mat2a(2,2)+(gp**2*Ql9*Qs*vS**2)/2._dp
mat2a(2,2) = mat2a(2,2)-(g1**2*vu**2)/8._dp
mat2a(2,2) = mat2a(2,2)-(g2**2*vu**2)/8._dp
mat2a(2,2) = mat2a(2,2)+(gp**2*QHu*Ql9*vu**2)/2._dp
mat2a(2,2) = mat2a(2,2)+ml92(1,1)
mat2a(2,3) = 0._dp 
mat2a(2,3) = mat2a(2,3)+ml92(1,2)
mat2a(3,3) = 0._dp 
mat2a(3,3) = mat2a(3,3)+(g1**2*vd**2)/8._dp
mat2a(3,3) = mat2a(3,3)+(g2**2*vd**2)/8._dp
mat2a(3,3) = mat2a(3,3)+(gp**2*QHd*Ql9*vd**2)/2._dp
mat2a(3,3) = mat2a(3,3)+(gp**2*Ql9*Qs*vS**2)/2._dp
mat2a(3,3) = mat2a(3,3)-(g1**2*vu**2)/8._dp
mat2a(3,3) = mat2a(3,3)-(g2**2*vu**2)/8._dp
mat2a(3,3) = mat2a(3,3)+(gp**2*QHu*Ql9*vu**2)/2._dp
mat2a(3,3) = mat2a(3,3)+ml92(2,2)
...
Subroutine OneLoopSe(g1,g2,gp,Ql4,Ql9,QHd,QHu,Qe4,Qe9,Qs,y1,Ty1,y2,Ty2,               & 
& lam,ml42,ml92,me42,me92,Tep,vd,vu,vS,MSe,MSe2,MAh,MAh2,MFv,MFv2,MCha,MCha2,            & 
...
Real(dp), Intent(in) :: g1,g2,gp,Ql4,Ql9,QHd,QHu,Qe4,Qe9,Qs,lam,ml42,me42,vd,vu,vS

Complex(dp), Intent(in) :: y1,Ty1,y2(2,2),Ty2(2,2),ml92(2,2),me92(2,2),Tep(2,2)
...
mat2a(1,1) = mat2a(1,1)+(g2**2*vu**2)/8._dp
mat2a(1,1) = mat2a(1,1)+(gp**2*QHu*Ql4*vu**2)/2._dp
mat2a(1,1) = mat2a(1,1)+(vd**2*y1*Conjg(y1))/2._dp
mat2a(1,2) = 0._dp 
mat2a(1,3) = 0._dp 
mat2a(1,4) = 0._dp 
mat2a(1,4) = mat2a(1,4)-(vS*vu*lam*Conjg(y1))/2._dp
mat2a(1,4) = mat2a(1,4)+(vd*Conjg(Ty1))/sqrt(2._dp)
mat2a(1,5) = 0._dp 
mat2a(1,6) = 0._dp 
mat2a(2,2) = 0._dp 
mat2a(2,2) = mat2a(2,2)+(g1**2*vd**2)/8._dp
...
mat2a(2,2) = mat2a(2,2)+ml92(1,1)
Do j1 = 1,2
mat2a(2,2) = mat2a(2,2)+(vd**2*Conjg(y2(j1,1))*y2(j1,1))/2._dp
End Do 
mat2a(2,3) = 0._dp 
mat2a(2,3) = mat2a(2,3)+ml92(1,2)
Do j1 = 1,2
mat2a(2,3) = mat2a(2,3)+(vd**2*Conjg(y2(j1,1))*y2(j1,2))/2._dp
End Do 
mat2a(2,4) = 0._dp 
mat2a(2,5) = 0._dp 
mat2a(2,5) = mat2a(2,5)-((vu*Conjg(Tep(1,1)))/sqrt(2._dp))
mat2a(2,5) = mat2a(2,5)-(vS*vu*lam*Conjg(y2(1,1)))/2._dp
mat2a(2,5) = mat2a(2,5)+(vd*Conjg(Ty2(1,1)))/sqrt(2._dp)
mat2a(2,6) = 0._dp 
mat2a(2,6) = mat2a(2,6)-((vu*Conjg(Tep(2,1)))/sqrt(2._dp))
mat2a(2,6) = mat2a(2,6)-(vS*vu*lam*Conjg(y2(2,1)))/2._dp
mat2a(2,6) = mat2a(2,6)+(vd*Conjg(Ty2(2,1)))/sqrt(2._dp)
mat2a(3,3) = 0._dp 
mat2a(3,3) = mat2a(3,3)+(g1**2*vd**2)/8._dp
mat2a(3,3) = mat2a(3,3)-(g2**2*vd**2)/8._dp
mat2a(3,3) = mat2a(3,3)+(gp**2*QHd*Ql9*vd**2)/2._dp
...
mat2a(3,3) = mat2a(3,3)+ml92(2,2)
Do j1 = 1,2
mat2a(3,3) = mat2a(3,3)+(vd**2*Conjg(y2(j1,2))*y2(j1,2))/2._dp
End Do 
mat2a(3,4) = 0._dp 
mat2a(3,5) = 0._dp 
mat2a(3,5) = mat2a(3,5)-((vu*Conjg(Tep(1,2)))/sqrt(2._dp))
mat2a(3,5) = mat2a(3,5)-(vS*vu*lam*Conjg(y2(1,2)))/2._dp
mat2a(3,5) = mat2a(3,5)+(vd*Conjg(Ty2(1,2)))/sqrt(2._dp)
mat2a(3,6) = 0._dp 
mat2a(3,6) = mat2a(3,6)-((vu*Conjg(Tep(2,2)))/sqrt(2._dp))
mat2a(3,6) = mat2a(3,6)-(vS*vu*lam*Conjg(y2(2,2)))/2._dp
mat2a(3,6) = mat2a(3,6)+(vd*Conjg(Ty2(2,2)))/sqrt(2._dp)
mat2a(4,4) = 0._dp 
mat2a(4,4) = mat2a(4,4)+me42
mat2a(4,4) = mat2a(4,4)-(g1**2*vd**2)/4._dp
mat2a(4,4) = mat2a(4,4)+(gp**2*Qe4*QHd*vd**2)/2._dp
mat2a(4,4) = mat2a(4,4)+(gp**2*Qe4*Qs*vS**2)/2._dp
mat2a(4,4) = mat2a(4,4)+(g1**2*vu**2)/4._dp
mat2a(4,4) = mat2a(4,4)+(gp**2*Qe4*QHu*vu**2)/2._dp
mat2a(4,4) = mat2a(4,4)+(vd**2*y1*Conjg(y1))/2._dp
mat2a(4,5) = 0._dp 
mat2a(4,6) = 0._dp 
mat2a(5,5) = 0._dp 
mat2a(5,5) = mat2a(5,5)-(g1**2*vd**2)/4._dp
mat2a(5,5) = mat2a(5,5)+(gp**2*Qe9*QHd*vd**2)/2._dp
mat2a(5,5) = mat2a(5,5)+(gp**2*Qe9*Qs*vS**2)/2._dp
mat2a(5,5) = mat2a(5,5)+(g1**2*vu**2)/4._dp
mat2a(5,5) = mat2a(5,5)+(gp**2*Qe9*QHu*vu**2)/2._dp
mat2a(5,5) = mat2a(5,5)+me92(1,1)
Do j1 = 1,2
mat2a(5,5) = mat2a(5,5)+(vd**2*Conjg(y2(1,j1))*y2(1,j1))/2._dp
End Do 
mat2a(5,6) = 0._dp 
mat2a(5,6) = mat2a(5,6)+me92(1,2)
Do j1 = 1,2
mat2a(5,6) = mat2a(5,6)+(vd**2*Conjg(y2(2,j1))*y2(1,j1))/2._dp
End Do 
mat2a(6,6) = 0._dp 
mat2a(6,6) = mat2a(6,6)-(g1**2*vd**2)/4._dp
mat2a(6,6) = mat2a(6,6)+(gp**2*Qe9*QHd*vd**2)/2._dp
mat2a(6,6) = mat2a(6,6)+(gp**2*Qe9*Qs*vS**2)/2._dp
mat2a(6,6) = mat2a(6,6)+(g1**2*vu**2)/4._dp
mat2a(6,6) = mat2a(6,6)+(gp**2*Qe9*QHu*vu**2)/2._dp
mat2a(6,6) = mat2a(6,6)+me92(2,2)
Do j1 = 1,2
mat2a(6,6) = mat2a(6,6)+(vd**2*Conjg(y2(2,j1))*y2(2,j1))/2._dp
End Do 
...
Subroutine OneLoopFe(y1,y2,vd,MFe,MFe2,MAh,MAh2,MSv,MSv2,MCha,MCha2,MSe,              & 
...
Complex(dp), Intent(in) :: y1,y2(2,2)
...
mat1a(1,1) = 0._dp 
mat1a(1,1) = mat1a(1,1)+(vd*y1)/sqrt(2._dp)
mat1a(1,2) = 0._dp 
mat1a(1,3) = 0._dp 
mat1a(2,1) = 0._dp 
mat1a(2,2) = 0._dp 
mat1a(2,2) = mat1a(2,2)+(vd*y2(1,1))/sqrt(2._dp)
mat1a(2,3) = 0._dp 
mat1a(2,3) = mat1a(2,3)+(vd*y2(2,1))/sqrt(2._dp)
mat1a(3,1) = 0._dp 
mat1a(3,2) = 0._dp 
mat1a(3,2) = mat1a(3,2)+(vd*y2(1,2))/sqrt(2._dp)
mat1a(3,3) = 0._dp 
mat1a(3,3) = mat1a(3,3)+(vd*y2(2,2))/sqrt(2._dp)
...
End Module LoopMasses_SplitUMSSM 
