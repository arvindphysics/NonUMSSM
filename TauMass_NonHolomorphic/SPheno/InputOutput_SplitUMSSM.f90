...
! ------------------------------------------------------------------------------  
! File created at 7:30 on 15.11.2020   
! ----------------------------------------------------------------------  
 
 
Module InputOutput_SplitUMSSM 
...
InputValueforYd= .True. 
   ...
   Else If (read_line(7:10).Eq."Y2IN") Then 
InputValuefory2= .True. 
    Call ReadMatrixC(99,2,2,y2IN,0, "y2IN",kont)

 
   Else If (read_line(7:12).Eq."IMY2IN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMy2") 
       Cycle 
     End If 
    Call ReadMatrixC(99,2,2,y2IN,1, "y2IN",kont)
...
InputValueforTd= .True. 
   ...
   Else If (read_line(7:11).Eq."TY2IN") Then 
InputValueforTy2= .True. 
    Call ReadMatrixC(99,2,2,Ty2IN,0, "Ty2IN",kont)

 
   Else If (read_line(7:13).Eq."IMTY2IN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMTy2") 
       Cycle 
     End If 
    Call ReadMatrixC(99,2,2,Ty2IN,1, "Ty2IN",kont)
...
InputValueformq2= .True. 
   ...
   Else If (read_line(7:12).Eq."ML92IN") Then 
InputValueforml92= .True. 
    Call ReadMatrixC(99,2,2,ml92IN,0, "ml92IN",kont)

 
   Else If (read_line(7:14).Eq."IMML92IN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMml92") 
       Cycle 
     End If 
    Call ReadMatrixC(99,2,2,ml92IN,1, "ml92IN",kont)
...
InputValueformu2= .True. 
   ...
   Else If (read_line(7:12).Eq."ME92IN") Then 
InputValueforme92= .True. 
    Call ReadMatrixC(99,2,2,me92IN,0, "me92IN",kont)

 
   Else If (read_line(7:14).Eq."IMME92IN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMme92") 
       Cycle 
     End If 
    Call ReadMatrixC(99,2,2,me92IN,1, "me92IN",kont)
...
InputValueforTep= .True. 
    Call ReadMatrixC(99,2,2,TepIN,0, "TepIN",kont)

 
   Else If (read_line(7:13).Eq."IMTEPIN") Then 
     If (i_cpv.Lt.2) Then  
       Call Warn_CPV(i_cpv,"IMTep") 
       Cycle 
     End If 
    Call ReadMatrixC(99,2,2,TepIN,1, "TepIN",kont)
   ...
   Else If (read_line(7:10).Eq."Y1IN") Then 
    Call Read_y1IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:12).Eq."IMY1IN") Then 
    Call Read_y1IN(99,1,i_model,set_mod_par,kont) 
   ...
   Else If (read_line(7:11).Eq."TY1IN") Then 
    Call Read_TY1IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:13).Eq."IMTY1IN") Then 
    Call Read_TY1IN(99,1,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:12).Eq."ML42IN") Then 
    Call Read_ML42IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:14).Eq."IMML42IN") Then 
    Call Read_ML42IN(99,1,i_model,set_mod_par,kont) 
   ...
   Else If (read_line(7:12).Eq."ME42IN") Then 
    Call Read_ME42IN(99,0,i_model,set_mod_par,kont) 
 
   Else If (read_line(7:14).Eq."IMME42IN") Then 
    Call Read_ME42IN(99,1,i_model,set_mod_par,kont) 
...
Write(io_L,100) "# SUSY Les Houches Accord 2 - SplitUMSSM Spectrum + Decays + Flavor Observables"
...
End if 
If (Abs(Real(Ql4,dp)).gt.0._dp) Then 
Write(io_L,101) 72, Real(Ql4,dp) ,"# Ql4"
End if 
If (Abs(Real(Ql9,dp)).gt.0._dp) Then 
Write(io_L,101) 73, Real(Ql9,dp) ,"# Ql9"
End if 
If (Abs(Real(QHu,dp)).gt.0._dp) Then 
Write(io_L,101) 74, Real(QHu,dp) ,"# QHu"
End if 
If (Abs(Real(QHd,dp)).gt.0._dp) Then 
Write(io_L,101) 75, Real(QHd,dp) ,"# QHd"
End if 
If (Abs(Real(Qd,dp)).gt.0._dp) Then 
Write(io_L,101) 76, Real(Qd,dp) ,"# Qd"
End if 
If (Abs(Real(Qu,dp)).gt.0._dp) Then 
Write(io_L,101) 77, Real(Qu,dp) ,"# Qu"
End if 
If (Abs(Real(Qe4,dp)).gt.0._dp) Then 
Write(io_L,101) 78, Real(Qe4,dp) ,"# Qe4"
End if 
If (Abs(Real(Qe9,dp)).gt.0._dp) Then 
Write(io_L,101) 79, Real(Qe9,dp) ,"# Qe9"
End if 
If (Abs(Real(Qs,dp)).gt.0._dp) Then 
Write(io_L,101) 80, Real(Qs,dp) ,"# Qs"
End if 
End if 
WriteNextBlock = .false. 
If(WriteNextBlock) Then 
...
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block Y1 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(y1,dp), "# y1" 
If (Abs(Aimag(y1)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMY1 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(y1), "# y1" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
...
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block TY1 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(Ty1,dp), "# Ty1" 
If (Abs(Aimag(Ty1)).gt.0._dp) WriteNextBlock = .True. 
If(WriteNextBlock) Then 
Write(io_L,106) "Block IMTY1 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Aimag(Ty1), "# Ty1" 
End if 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block ML42 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(ml42,dp), "# ml42" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
...
End if 
If (WriteSLHA1) Then 
Write(io_L,104)  31,  Real(sqrt(ml42),dp), " # mL(1,1) "
Write(io_L,104)  32,  Real(sqrt(ml92(1,1)),dp), " # mL(2,2)"
Write(io_L,104)  33,  Real(sqrt(ml92(2,2)),dp), " # mL(3,3)"
Write(io_L,104)  34,  Real(sqrt(me42),dp), " # mE(1,1)"
Write(io_L,104)  35,  Real(sqrt(me92(1,1)),dp), " # mE(2,2)"
Write(io_L,104)  36,  Real(sqrt(me92(2,2)),dp), " # mE(3,3)"
...
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
Write(io_L,106) "Block ME42 Q=",Q,"# (SUSY Scale)" 
Write(io_L,104) 1,Real(me42,dp), "# me42" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
...
Write(io_L,104) 2,Real(Ql4,dp), "# Ql4" 
Write(io_L,104) 3,Real(Ql9,dp), "# Ql9" 
Write(io_L,104) 5,Real(QHd,dp), "# QHd" 
Write(io_L,104) 4,Real(QHu,dp), "# QHu" 
Write(io_L,104) 6,Real(Qd,dp), "# Qd" 
Write(io_L,104) 7,Real(Qu,dp), "# Qu" 
Write(io_L,104) 8,Real(Qe4,dp), "# Qe4" 
Write(io_L,104) 9,Real(Qe9,dp), "# Qe9" 
Write(io_L,104) 10,Real(Qs,dp), "# Qs" 
WriteNextBlock = .false. 
If (OutputForMG) WriteNextBlock = .True. 
...
Write(io_L,106) "Block Y2 Q=",Q,"# (SUSY Scale)" 
Write(io_L,107)1,1,Real(y2(1,1),dp), "# Real(y2(1,1),dp)" 
Write(io_L,107)1,2,Real(y2(1,2),dp), "# Real(y2(1,2),dp)" 
Write(io_L,107)2,1,Real(y2(2,1),dp), "# Real(y2(2,1),dp)" 
Write(io_L,107)2,2,Real(y2(2,2),dp), "# Real(y2(2,2),dp)" 
If ((MaxVal(Abs(AImag(y2))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMY2 Q=",Q,"# (SUSY Scale)" 
Write(io_L,107)1,1,Aimag(y2(1,1)), "# Aimag(y2(1,1))" 
Write(io_L,107)1,2,Aimag(y2(1,2)), "# Aimag(y2(1,2))" 
Write(io_L,107)2,1,Aimag(y2(2,1)), "# Aimag(y2(2,1))" 
Write(io_L,107)2,2,Aimag(y2(2,2)), "# Aimag(y2(2,2))" 
End If 
...
Write(io_L,106) "Block TY2 Q=",Q,"# (SUSY Scale)" 
Write(io_L,107)1,1,Real(Ty2(1,1),dp), "# Real(Ty2(1,1),dp)" 
Write(io_L,107)1,2,Real(Ty2(1,2),dp), "# Real(Ty2(1,2),dp)" 
Write(io_L,107)2,1,Real(Ty2(2,1),dp), "# Real(Ty2(2,1),dp)" 
Write(io_L,107)2,2,Real(Ty2(2,2),dp), "# Real(Ty2(2,2),dp)" 
If ((MaxVal(Abs(AImag(Ty2))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMTY2 Q=",Q,"# (SUSY Scale)" 
Write(io_L,107)1,1,Aimag(Ty2(1,1)), "# Aimag(Ty2(1,1))" 
Write(io_L,107)1,2,Aimag(Ty2(1,2)), "# Aimag(Ty2(1,2))" 
Write(io_L,107)2,1,Aimag(Ty2(2,1)), "# Aimag(Ty2(2,1))" 
Write(io_L,107)2,2,Aimag(Ty2(2,2)), "# Aimag(Ty2(2,2))" 
End If 
...
Write(io_L,106) "Block ML92 Q=",Q,"# (SUSY Scale)" 
Write(io_L,107)1,1,Real(ml92(1,1),dp), "# Real(ml92(1,1),dp)" 
Write(io_L,107)1,2,Real(ml92(1,2),dp), "# Real(ml92(1,2),dp)" 
Write(io_L,107)2,1,Real(ml92(2,1),dp), "# Real(ml92(2,1),dp)" 
Write(io_L,107)2,2,Real(ml92(2,2),dp), "# Real(ml92(2,2),dp)" 
If ((MaxVal(Abs(AImag(ml92))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMML92 Q=",Q,"# (SUSY Scale)" 
Write(io_L,107)1,1,Aimag(ml92(1,1)), "# Aimag(ml92(1,1))" 
Write(io_L,107)1,2,Aimag(ml92(1,2)), "# Aimag(ml92(1,2))" 
Write(io_L,107)2,1,Aimag(ml92(2,1)), "# Aimag(ml92(2,1))" 
Write(io_L,107)2,2,Aimag(ml92(2,2)), "# Aimag(ml92(2,2))" 
End If 
...
Write(io_L,106) "Block ME92 Q=",Q,"# (SUSY Scale)" 
Write(io_L,107)1,1,Real(me92(1,1),dp), "# Real(me92(1,1),dp)" 
Write(io_L,107)1,2,Real(me92(1,2),dp), "# Real(me92(1,2),dp)" 
Write(io_L,107)2,1,Real(me92(2,1),dp), "# Real(me92(2,1),dp)" 
Write(io_L,107)2,2,Real(me92(2,2),dp), "# Real(me92(2,2),dp)" 
If ((MaxVal(Abs(AImag(me92))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMME92 Q=",Q,"# (SUSY Scale)" 
Write(io_L,107)1,1,Aimag(me92(1,1)), "# Aimag(me92(1,1))" 
Write(io_L,107)1,2,Aimag(me92(1,2)), "# Aimag(me92(1,2))" 
Write(io_L,107)2,1,Aimag(me92(2,1)), "# Aimag(me92(2,1))" 
Write(io_L,107)2,2,Aimag(me92(2,2)), "# Aimag(me92(2,2))" 
End If 
...
Write(io_L,107)1,1,Real(Tep(1,1),dp), "# Real(Tep(1,1),dp)" 
Write(io_L,107)1,2,Real(Tep(1,2),dp), "# Real(Tep(1,2),dp)" 
Write(io_L,107)2,1,Real(Tep(2,1),dp), "# Real(Tep(2,1),dp)" 
Write(io_L,107)2,2,Real(Tep(2,2),dp), "# Real(Tep(2,2),dp)" 
If ((MaxVal(Abs(AImag(Tep))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMTEP Q=",Q,"# (SUSY Scale)" 
Write(io_L,107)1,1,Aimag(Tep(1,1)), "# Aimag(Tep(1,1))" 
Write(io_L,107)1,2,Aimag(Tep(1,2)), "# Aimag(Tep(1,2))" 
Write(io_L,107)2,1,Aimag(Tep(2,1)), "# Aimag(Tep(2,1))" 
Write(io_L,107)2,2,Aimag(Tep(2,2)), "# Aimag(Tep(2,2))" 
End If 
...
Write(io_L,106) "Block AE Q=",Q," # " 
 Write(io_L,107) 1, 1, Real(Ty1,dp)/Real(Y1,dp),"# Te(1,1)/Ye(1,1) "
Write(io_L,107) 2, 2, Real(Ty2(1,1),dp)/Real(Y2(1,1),dp),"# Te(1,1)/Ye(1,1) "
Write(io_L,107) 3, 3, Real(Ty2(2,2),dp)/Real(Y2(2,2),dp),"# Te(2,2)/Ye(2,2) "
End if 
...
Write(io_L,106) "Block Y1GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(y1GUT,dp), "# y1" 
...
Write(io_L,106) "Block TY1GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(Ty1GUT,dp), "# Ty1" 
Write(io_L,106) "Block ML42GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(ml42GUT,dp), "# ml42" 
...
Write(io_L,106) "Block ME42GUT Q=",M_GUT,"# (GUT scale)" 
Write(io_L,104) 1,Real(me42GUT,dp), "# me42" 
...
Write(io_L,106) "Block y2GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Real(y2GUT(1,1),dp), "# Real(y2GUT(1,1),dp)" 
Write(io_L,107)1,2,Real(y2GUT(1,2),dp), "# Real(y2GUT(1,2),dp)" 
Write(io_L,107)2,1,Real(y2GUT(2,1),dp), "# Real(y2GUT(2,1),dp)" 
Write(io_L,107)2,2,Real(y2GUT(2,2),dp), "# Real(y2GUT(2,2),dp)" 
If ((MaxVal(Abs(AImag(y2GUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMy2GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(y2GUT(1,1)), "# Aimag(y2GUT(1,1))" 
Write(io_L,107)1,2,Aimag(y2GUT(1,2)), "# Aimag(y2GUT(1,2))" 
Write(io_L,107)2,1,Aimag(y2GUT(2,1)), "# Aimag(y2GUT(2,1))" 
Write(io_L,107)2,2,Aimag(y2GUT(2,2)), "# Aimag(y2GUT(2,2))" 
End If 
...
Write(io_L,106) "Block Ty2GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Real(Ty2GUT(1,1),dp), "# Real(Ty2GUT(1,1),dp)" 
Write(io_L,107)1,2,Real(Ty2GUT(1,2),dp), "# Real(Ty2GUT(1,2),dp)" 
Write(io_L,107)2,1,Real(Ty2GUT(2,1),dp), "# Real(Ty2GUT(2,1),dp)" 
Write(io_L,107)2,2,Real(Ty2GUT(2,2),dp), "# Real(Ty2GUT(2,2),dp)" 
If ((MaxVal(Abs(AImag(Ty2GUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMTy2GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(Ty2GUT(1,1)), "# Aimag(Ty2GUT(1,1))" 
Write(io_L,107)1,2,Aimag(Ty2GUT(1,2)), "# Aimag(Ty2GUT(1,2))" 
Write(io_L,107)2,1,Aimag(Ty2GUT(2,1)), "# Aimag(Ty2GUT(2,1))" 
Write(io_L,107)2,2,Aimag(Ty2GUT(2,2)), "# Aimag(Ty2GUT(2,2))" 
End If 
...
Write(io_L,106) "Block ml92GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Real(ml92GUT(1,1),dp), "# Real(ml92GUT(1,1),dp)" 
Write(io_L,107)1,2,Real(ml92GUT(1,2),dp), "# Real(ml92GUT(1,2),dp)" 
Write(io_L,107)2,1,Real(ml92GUT(2,1),dp), "# Real(ml92GUT(2,1),dp)" 
Write(io_L,107)2,2,Real(ml92GUT(2,2),dp), "# Real(ml92GUT(2,2),dp)" 
If ((MaxVal(Abs(AImag(ml92GUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMml92GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(ml92GUT(1,1)), "# Aimag(ml92GUT(1,1))" 
Write(io_L,107)1,2,Aimag(ml92GUT(1,2)), "# Aimag(ml92GUT(1,2))" 
Write(io_L,107)2,1,Aimag(ml92GUT(2,1)), "# Aimag(ml92GUT(2,1))" 
Write(io_L,107)2,2,Aimag(ml92GUT(2,2)), "# Aimag(ml92GUT(2,2))" 
End If 
...
Write(io_L,106) "Block me92GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Real(me92GUT(1,1),dp), "# Real(me92GUT(1,1),dp)" 
Write(io_L,107)1,2,Real(me92GUT(1,2),dp), "# Real(me92GUT(1,2),dp)" 
Write(io_L,107)2,1,Real(me92GUT(2,1),dp), "# Real(me92GUT(2,1),dp)" 
Write(io_L,107)2,2,Real(me92GUT(2,2),dp), "# Real(me92GUT(2,2),dp)" 
If ((MaxVal(Abs(AImag(me92GUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMme92GUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(me92GUT(1,1)), "# Aimag(me92GUT(1,1))" 
Write(io_L,107)1,2,Aimag(me92GUT(1,2)), "# Aimag(me92GUT(1,2))" 
Write(io_L,107)2,1,Aimag(me92GUT(2,1)), "# Aimag(me92GUT(2,1))" 
Write(io_L,107)2,2,Aimag(me92GUT(2,2)), "# Aimag(me92GUT(2,2))" 
End If 
...
Write(io_L,107)1,1,Real(TepGUT(1,1),dp), "# Real(TepGUT(1,1),dp)" 
Write(io_L,107)1,2,Real(TepGUT(1,2),dp), "# Real(TepGUT(1,2),dp)" 
Write(io_L,107)2,1,Real(TepGUT(2,1),dp), "# Real(TepGUT(2,1),dp)" 
Write(io_L,107)2,2,Real(TepGUT(2,2),dp), "# Real(TepGUT(2,2),dp)" 
If ((MaxVal(Abs(AImag(TepGUT))).gt.0._dp).OR.(OutputForMG)) Then 
Write(io_L,106) "Block IMTepGUT Q=",M_GUT,"# (GUT Scale)" 
Write(io_L,107)1,1,Aimag(TepGUT(1,1)), "# Aimag(TepGUT(1,1))" 
Write(io_L,107)1,2,Aimag(TepGUT(1,2)), "# Aimag(TepGUT(1,2))" 
Write(io_L,107)2,1,Aimag(TepGUT(2,1)), "# Aimag(TepGUT(2,1))" 
Write(io_L,107)2,2,Aimag(TepGUT(2,2)), "# Aimag(TepGUT(2,2))" 
End If 

End if 
 
Write(io_L,106) "Block AddPars Q=1.0000E00 # Additional parameters not appearing elsewhere; scale Q just a dummy" 
Write(io_L,104) 1, Abs(ml4l92), "# ml4l92 "  
MassLSP = 100000._dp 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.SplitUMSSM",status="unknown")
...
Write(123,*) "y1_r = ",Real(y1,dp) 
Write(123,*) "y1_i = ",AImag(y1) 
Write(123,*) "y211_r= ",Real(y2(1,1),dp)
Write(123,*) "y212_r= ",Real(y2(1,2),dp)
Write(123,*) "y221_r= ",Real(y2(2,1),dp)
Write(123,*) "y222_r= ",Real(y2(2,2),dp)
Write(123,*) "y211_i= ",AImag(y2(1,1))
Write(123,*) "y212_i= ",AImag(y2(1,2))
Write(123,*) "y221_i= ",AImag(y2(2,1))
Write(123,*) "y222_i= ",AImag(y2(2,2))
Write(123,*) "lam= ",lam
...
Write(123,*) "Ty1_r = ",Real(Ty1,dp) 
Write(123,*) "Ty1_i = ",AImag(Ty1) 
Write(123,*) "Ty211_r= ",Real(Ty2(1,1),dp)
Write(123,*) "Ty212_r= ",Real(Ty2(1,2),dp)
Write(123,*) "Ty221_r= ",Real(Ty2(2,1),dp)
Write(123,*) "Ty222_r= ",Real(Ty2(2,2),dp)
Write(123,*) "Ty211_i= ",AImag(Ty2(1,1))
Write(123,*) "Ty212_i= ",AImag(Ty2(1,2))
Write(123,*) "Ty221_i= ",AImag(Ty2(2,1))
Write(123,*) "Ty222_i= ",AImag(Ty2(2,2))
Write(123,*) "Tlam= ",Tlam
...
Write(123,*) "Tep11_r= ",Real(Tep(1,1),dp)
Write(123,*) "Tep12_r= ",Real(Tep(1,2),dp)
Write(123,*) "Tep21_r= ",Real(Tep(2,1),dp)
Write(123,*) "Tep22_r= ",Real(Tep(2,2),dp)
Write(123,*) "Tep11_i= ",AImag(Tep(1,1))
Write(123,*) "Tep12_i= ",AImag(Tep(1,2))
Write(123,*) "Tep21_i= ",AImag(Tep(2,1))
Write(123,*) "Tep22_i= ",AImag(Tep(2,2))
Write(123,*) "vS= ",vS
Write(123,*) "vS= ",vS
...
Subroutine WriteWCXF 
   Open(123,file="WC.SplitUMSSM_1.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
...
Write(123,*) "}"
    Close(123) 
   Open(123,file="WC.SplitUMSSM_2.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
Write(123,*) '  "basis": "FlavorKit",'
Write(123,*) '  "scale": "91.",'
...
Subroutine Read_y1IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) y1IN= Cmplx(wert,Aimag(y1IN),dp) 
If (i_c.Eq.1) y1IN= Cmplx(Real(y1IN,dp),wert,dp) 
InputValuefory1= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block y1IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMy1IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block y1IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMy1IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_y1IN 
...
Subroutine Read_TY1IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
Read(io,*) i_par,wert!,read_line 
If (i_par.Eq.1) Then 
If (i_c.Eq.0) Ty1IN= Cmplx(wert,Aimag(Ty1IN),dp) 
If (i_c.Eq.1) Ty1IN= Cmplx(Real(Ty1IN,dp),wert,dp) 
InputValueforTy1= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block TY1IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMTY1IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block TY1IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMTY1IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_TY1IN 
 
 
Subroutine Read_ML42IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
ml42IN= wert 
InputValueforml42= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block ML42IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMML42IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block ML42IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMML42IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_ML42IN 
...
Subroutine Read_ME42IN(io,i_c,i_model,set_mod_par,kont) 
Implicit None 
Integer,Intent(in)::io,i_c,i_model 
Integer,Intent(inout)::kont,set_mod_par(:) 
Integer::i_par 
...
If (i_par.Eq.1) Then 
me42IN= wert 
InputValueforme42= .True. 
Else
Write(ErrCan,*) "Error in routine "//NameOfUnit(Iname)
If (i_c.Eq.0) Write(ErrCan,*) "Unknown entry for Block ME42IN ",i_par
If (i_c.Eq.1) Write(ErrCan,*) "Unknown entry for Block IMME42IN ",i_par
If (i_c.Eq.0) Write(*,*) "Unknown entry for Block ME42IN ",i_par
If (i_c.Eq.1) Write(*,*) "Unknown entry for Block IMME42IN ",i_par
Call AddError(304)
If (ErrorLevel.Eq.2) Call TerminateProgram
End If
End Do! i_par
200 Return
End Subroutine Read_ME42IN 
...
End Module InputOutput_SplitUMSSM 
