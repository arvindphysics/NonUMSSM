...
Module CouplingsForDecays_SplitUMSSM
...
& vdinput,vuinput,vSinput,cplAhSdcSd,cplChaFucSdL,cplChaFucSdR,cplChiFdcSdL,             & 
...
& ml42,ml92,mHd2,mHu2,md2,mu2,me42,me92,ms2,M1,M2,M3,M4,Tdp,Tep,vd,vu,vS,g1D)

If ((m_in.le.Qin).and.(RunningCouplingsDecays)) Then 
  tz=Log(m_in/Qin) 
  If (m_in.le.mz) tz=Log(mz/Qin)  
  dt=tz/50._dp 
  Call odeint(g1D,210,0._dp,tz,deltaM,dt,0._dp,rge210,kont)

End if 
Call GToParameters210(g1D,g1,g2,g3,gp,Yd,y1,y2,lam,Yu,Td,Ty1,Ty2,Tlam,Tu,             & 
...
& Tuinput,mq2input,ml42input,ml92input,mHd2input,mHu2input,md2input,mu2input,            & 
& me42input,me92input,ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,        & 
& vdinput,vuinput,vSinput,cplAhSucSu,cplChiFucSuL,cplChiFucSuR,cplcChaFdcSuL,            & 
...
& Tuinput,mq2input,ml42input,ml92input,mHd2input,mHu2input,md2input,mu2input,            & 
& me42input,me92input,ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,        & 
& vdinput,vuinput,vSinput,cplAhSecSe,cplChaFvcSeL,cplChaFvcSeR,cplChiFecSeL,             & 
...
Do gt1 = 1, 3
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplingAhSecSeT(gt1,gt2,gt3,y1,Ty1,y2,Ty2,lam,Tep,vu,vS,ZE,ZA,cplAhSecSe(gt1,gt2,gt3))
...
Do gt1 = 1, 3
 Do gt2 = 1, 6
  Do gt3 = 1, 6
Call CouplinghhSecSeT(gt1,gt2,gt3,g1,g2,gp,y1,Ty1,y2,Ty2,lam,Tep,vd,vu,               & 
...
Do gt1 = 1, 2
 Do gt2 = 1, 3
  Do gt3 = 1, 6
Call CouplingHpmSvcSeT(gt1,gt2,gt3,g2,y1,Ty1,y2,Ty2,lam,Tep,vd,vu,vS,ZV,              & 
& ZE,ZP,cplHpmSvcSe(gt1,gt2,gt3))
...
& Tuinput,mq2input,ml42input,ml92input,mHd2input,mHu2input,md2input,mu2input,            & 
& me42input,me92input,ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,        & 
& vdinput,vuinput,vSinput,cplChiFvcSvL,cplChiFvcSvR,cplcChaFecSvL,cplcChaFecSvR,         & 
...
Do gt1 = 1, 6
 Do gt2 = 1, 2
  Do gt3 = 1, 3
Call CouplingSecHpmcSvT(gt1,gt2,gt3,g2,y1,Ty1,y2,Ty2,lam,Tep,vd,vu,vS,ZV,             & 
& ZE,ZP,cplSecHpmcSv(gt1,gt2,gt3))
...
& Tuinput,mq2input,ml42input,ml92input,mHd2input,mHu2input,md2input,mu2input,            & 
& me42input,me92input,ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,        & 
& vdinput,vuinput,vSinput,cplHiggsPP,cplHiggsGG,cplHiggsZZvirt,cplHiggsWWvirt,           & 
...
& cplhhSvcSv,cplhhcVWmVWm,cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,deltaM)
...
& Tuinput,mq2input,ml42input,ml92input,mHd2input,mHu2input,md2input,mu2input,            & 
& me42input,me92input,ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,        & 
& vdinput,vuinput,vSinput,cplPseudoHiggsPP,cplPseudoHiggsGG,cplAhAhhh,cplcChaChaAhL,     & 
...
& cplAhSdcSd,cplAhSecSe,cplAhSucSu,deltaM)
...
& Tuinput,mq2input,ml42input,ml92input,mHd2input,mHu2input,md2input,mu2input,            & 
& me42input,me92input,ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,        & 
& vdinput,vuinput,vSinput,cplAhHpmcHpm,cplAhcHpmVWm,cplChiChacHpmL,cplChiChacHpmR,       & 
& cplcFuFdcHpmL,cplcFuFdcHpmR,cplcFvFecHpmL,cplcFvFecHpmR,cplhhHpmcHpm,cplhhcHpmVWm,     & 
& cplHpmcHpmVZ,cplHpmcHpmVZp,cplSdcHpmcSu,cplSecHpmcSv,cplcHpmVWmVZ,cplcHpmVWmVZp,deltaM)
...
& Tuinput,mq2input,ml42input,ml92input,mHd2input,mHu2input,md2input,mu2input,            & 
& me42input,me92input,ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,        & 
& vdinput,vuinput,vSinput,cplAhhhVZp,cplcChaChaVZpL,cplcChaChaVZpR,cplChiChiVZpL,        & 
& cplChiChiVZpR,cplcFdFdVZpL,cplcFdFdVZpR,cplcFeFeVZpL,cplcFeFeVZpR,cplcFuFuVZpL,        & 
& cplcFuFuVZpR,cplcFvFvVZpL,cplcFvFvVZpR,cplhhVZVZp,cplhhVZpVZp,cplHpmcHpmVZp,           & 
& cplHpmcVWmVZp,cplSdcSdVZp,cplSecSeVZp,cplSucSuVZp,cplSvcSvVZp,cplcVWmVWmVZp,deltaM)
...
& Tuinput,mq2input,ml42input,ml92input,mHd2input,mHu2input,md2input,mu2input,            & 
& me42input,me92input,ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,        & 
& vdinput,vuinput,vSinput,cplGluFdcSdL,cplGluFdcSdR,cplGluFucSuL,cplGluFucSuR,deltaM)
...
& Tuinput,mq2input,ml42input,ml92input,mHd2input,mHu2input,md2input,mu2input,            & 
& me42input,me92input,ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,        & 
& vdinput,vuinput,vSinput,cplChiChiAhL,cplChiChiAhR,cplChiChacHpmL,cplChiChacHpmR,       & 
...
& cplChiFucSuL,cplChiFucSuR,cplChiFvcSvL,cplChiFvcSvR,deltaM)
...
& Tuinput,mq2input,ml42input,ml92input,mHd2input,mHu2input,md2input,mu2input,            & 
& me42input,me92input,ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,        & 
& vdinput,vuinput,vSinput,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,       & 
...
& Tuinput,mq2input,ml42input,ml92input,mHd2input,mHu2input,md2input,mu2input,            & 
& me42input,me92input,ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,        & 
& vdinput,vuinput,vSinput,cplcFuFuAhL,cplcFuFuAhR,cplcFuChiSuL,cplcFuChiSuR,             & 
...
& Tuinput,mq2input,ml42input,ml92input,mHd2input,mHu2input,md2input,mu2input,            & 
& me42input,me92input,ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,        & 
& vdinput,vuinput,vSinput,cplcChacFuSdL,cplcChacFuSdR,cplcChaFdcSuL,cplcChaFdcSuR,       & 
...
& cplcFeFvVWmR,cplcFuChiSuL,cplcFuChiSuR,cplcFuFuAhL,cplcFuFuAhR,cplcFuFuhhL,            & 
& cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZpL,cplcFuFuVZpR,cplcFuFuVZR,cplcFuGluSuL,            & 
& cplcFuGluSuR,cplcFvChiSvL,cplcFvChiSvR,cplcFvFvVZL,cplcFvFvVZpL,cplcFvFvVZpR,          & 
...
& Tuinput,mq2input,ml42input,ml92input,mHd2input,mHu2input,md2input,mu2input,            & 
& me42input,me92input,ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,        & 
& vdinput,vuinput,vSinput,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,cplcChacFvSeR,       & 
...
& cplcFdFdVZpL,cplcFdFdVZpR,cplcFdFdVZR,cplcFeChaSvL,cplcFeChaSvR,cplcFeFeAhL,           & 
...
& Tuinput,mq2input,ml42input,ml92input,mHd2input,mHu2input,md2input,mu2input,            & 
& me42input,me92input,ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,        & 
& vdinput,vuinput,vSinput,cplAhSdcSd,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,          & 
...
& cplcFdGluSdL,cplcFdGluSdR,cplcFeChiSeL,cplcFeChiSeR,cplcFeFeAhL,cplcFeFeAhR,           & 
...
& cplcFvFvVZpR,cplcFvFvVZR,cplChaFucSdL,cplChaFucSdR,cplChiChacHpmL,cplChiChacHpmR,      & 
...
& Tuinput,mq2input,ml42input,ml92input,mHd2input,mHu2input,md2input,mu2input,            & 
& me42input,me92input,ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,        & 
& vdinput,vuinput,vSinput,cplAhSucSu,cplcChacFuSdL,cplcChacFuSdR,cplcChaChaAhL,          & 
...
& Tuinput,mq2input,ml42input,ml92input,mHd2input,mHu2input,md2input,mu2input,            & 
& me42input,me92input,ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,        & 
& vdinput,vuinput,vSinput,cplAhSecSe,cplcChacFuSdL,cplcChacFuSdR,cplcChacFvSeL,          & 
& cplcChacFvSeR,cplcChaChaAhL,cplcChaChaAhR,cplcChaChahhL,cplcChaChahhR,cplcChaChaVZL,   & 
& cplcChaChaVZpL,cplcChaChaVZpR,cplcChaChaVZR,cplcChaChiHpmL,cplcChaChiHpmR,             & 
& cplcChaFdcSuL,cplcChaFdcSuR,cplcChaFecSvL,cplcChaFecSvR,cplcFdChiSdL,cplcFdChiSdR,     & 
& cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZpL,              & 
& cplcFdFdVZpR,cplcFdFdVZR,cplcFeChaSvL,cplcFeChaSvR,cplcFeChiSeL,cplcFeChiSeR,          & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZpL,              & 
& cplcFeFeVZpR,cplcFeFeVZR,cplcFeFvHpmL,cplcFeFvHpmR,cplcFuChiSuL,cplcFuChiSuR,          & 
...
& cplChiFucSuR,cplChiFvcSvL,cplChiFvcSvR,cplhhSecSe,cplHpmSvcSe,cplSecSeVZ,              & 
...
& Tuinput,mq2input,ml42input,ml92input,mHd2input,mHu2input,md2input,mu2input,            & 
& me42input,me92input,ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,        & 
& vdinput,vuinput,vSinput,cplcChacFvSeL,cplcChacFvSeR,cplcChaChaAhL,cplcChaChaAhR,       & 
...
End Module CouplingsForDecays_SplitUMSSM
