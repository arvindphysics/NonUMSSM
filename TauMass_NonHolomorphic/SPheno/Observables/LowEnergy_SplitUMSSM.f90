...
! ------------------------------------------------------------------------------  
! File created at 5:15 on 15.11.2020   
! ----------------------------------------------------------------------  
 
 
Module LowEnergy_SplitUMSSM 
Use Control 
Use Settings 
...
Use StandardModel 
Use RunSM_SplitUMSSM
Use FlavorKit_LFV_SplitUMSSM
Use FlavorKit_QFV_SplitUMSSM
Use FlavorKit_Observables_SplitUMSSM
...
& Ydinput,y1input,y2input,laminput,Yuinput,Tdinput,Ty1input,Ty2input,Tlaminput,          & 
& Tuinput,mq2input,ml42input,ml92input,mHd2input,mHu2input,md2input,mu2input,            & 
& me42input,me92input,ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,        & 
& vdinput,vuinput,vSinput,Tpar,Spar,Upar,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho,             & 
...
Real(dp),Intent(inout) :: g1input,g2input,g3input,gpinput,laminput,Tlaminput,ml42input,mHd2input,               & 
& mHu2input,me42input,ms2input,vdinput,vuinput,vSinput

Complex(dp),Intent(inout) :: Ydinput(3,3),y1input,y2input(2,2),Yuinput(3,3),Tdinput(3,3),Ty1input,Ty2input(2,2),   & 
...
Real(dp) :: g1,g2,g3,gp,lam,Tlam,ml42,mHd2,mHu2,me42,ms2,vd,vu,vS
...
& y1input,y2input,laminput,Yuinput,Tdinput,Ty1input,Ty2input,Tlaminput,Tuinput,          & 
& mq2input,ml42input,ml92input,mHd2input,mHu2input,md2input,mu2input,me42input,          & 
& me92input,ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,vdinput,          & 
& vuinput,vSinput,g1,g2,g3,gp,Yd,y1,y2,lam,Yu,Td,Ty1,Ty2,Tlam,Tu,mq2,ml42,               & 
& ml92,mHd2,mHu2,md2,mu2,me42,me92,ms2,M1,M2,M3,M4,Tdp,Tep,vd,vu,vS,CKM_160,             & 
...
MHpm(1)=MVWm
MHpm2(1)=MVWm2
Call AllCouplings(g1,g2,gp,lam,Tlam,vd,vu,vS,ZH,ZA,ZP,Yd,Td,Tdp,ZD,y1,Ty1,            & 
& y2,Ty2,Tep,ZE,Yu,Tu,ZU,ZV,TW,TWp,g3,UM,UP,ZN,ZDL,ZDR,ZEL,ZER,ZUL,ZUR,ZVL,              & 
& pG,cplAhAhhh,cplAhHpmcHpm,cplAhSdcSd,cplAhSecSe,cplAhSucSu,cplhhhhhh,cplhhHpmcHpm,     & 
& cplhhSdcSd,cplhhSecSe,cplhhSucSu,cplhhSvcSv,cplHpmSucSd,cplHpmSvcSe,cplSdcHpmcSu,      & 
& cplSecHpmcSv,cplAhhhVZ,cplAhhhVZp,cplAhHpmcVWm,cplAhcHpmVWm,cplhhHpmcVWm,              & 
& cplhhcHpmVWm,cplHpmcHpmVP,cplHpmcHpmVZ,cplHpmcHpmVZp,cplSdcSdVG,cplSdcSdVP,            & 
& cplSdcSdVZ,cplSdcSdVZp,cplSdcSucVWm,cplSecSeVP,cplSecSeVZ,cplSecSeVZp,cplSecSvcVWm,    & 
& cplSucSuVG,cplSucSuVP,cplSucSdVWm,cplSucSuVZ,cplSucSuVZp,cplSvcSeVWm,cplSvcSvVZ,       & 
& cplSvcSvVZp,cplhhcVWmVWm,cplhhVZVZ,cplhhVZVZp,cplhhVZpVZp,cplHpmcVWmVP,cplHpmcVWmVZ,   & 
& cplHpmcVWmVZp,cplcHpmVPVWm,cplcHpmVWmVZ,cplcHpmVWmVZp,cplVGVGVG,cplcVWmVPVWm,          & 
...
If (MatchingOrder.gt.-1) Then 
Call RunSM_and_SUSY_RGEs(mz,g1input,g2input,g3input,gpinput,Ydinput,y1input,          & 
& y2input,laminput,Yuinput,Tdinput,Ty1input,Ty2input,Tlaminput,Tuinput,mq2input,         & 
& ml42input,ml92input,mHd2input,mHu2input,md2input,mu2input,me42input,me92input,         & 
& ms2input,M1input,M2input,M3input,M4input,Tdpinput,Tepinput,vdinput,vuinput,            & 
& vSinput,g1,g2,g3,gp,Yd,y1,y2,lam,Yu,Td,Ty1,Ty2,Tlam,Tu,mq2,ml42,ml92,mHd2,             & 
& mHu2,md2,mu2,me42,me92,ms2,M1,M2,M3,M4,Tdp,Tep,vd,vu,vS,CKM_MZ,sinW2_MZ,               & 
...
End Module LowEnergy_SplitUMSSM 
