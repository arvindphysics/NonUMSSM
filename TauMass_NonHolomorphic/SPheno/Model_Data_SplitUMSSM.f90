...
Real(dp) :: g1IN,g2IN,g3IN,gpIN,lamIN,TlamIN,ml42IN,mHd2IN,mHu2IN,me42IN,ms2IN

Complex(dp) :: YdIN(3,3),y1IN,y2IN(2,2),YuIN(3,3),TdIN(3,3),Ty1IN,Ty2IN(2,2),TuIN(3,3),              & 
& mq2IN(3,3),ml92IN(2,2),md2IN(3,3),mu2IN(3,3),me92IN(2,2),M1IN,M2IN,M3IN,               & 
& M4IN,TdpIN(3,3),TepIN(2,2)

Real(dp) :: g1MZ,g2MZ,g3MZ,gpMZ,lamMZ,TlamMZ,ml42MZ,mHd2MZ,mHu2MZ,me42MZ,ms2MZ

Complex(dp) :: YdMZ(3,3),y1MZ,y2MZ(2,2),YuMZ(3,3),TdMZ(3,3),Ty1MZ,Ty2MZ(2,2),TuMZ(3,3),              & 
& mq2MZ(3,3),ml92MZ(2,2),md2MZ(3,3),mu2MZ(3,3),me92MZ(2,2),M1MZ,M2MZ,M3MZ,               & 
& M4MZ,TdpMZ(3,3),TepMZ(2,2)

Real(dp) :: g1GUT,g2GUT,g3GUT,gpGUT,lamGUT,TlamGUT,ml42GUT,mHd2GUT,mHu2GUT,me42GUT,ms2GUT

Complex(dp) :: YdGUT(3,3),y1GUT,y2GUT(2,2),YuGUT(3,3),TdGUT(3,3),Ty1GUT,Ty2GUT(2,2),TuGUT(3,3),      & 
& mq2GUT(3,3),ml92GUT(2,2),md2GUT(3,3),mu2GUT(3,3),me92GUT(2,2),M1GUT,M2GUT,             & 
& M3GUT,M4GUT,TdpGUT(3,3),TepGUT(2,2)
...
Logical, save :: InputValuefory1 =.False. 
Logical, save :: InputValuefory2 =.False. 
Logical, save :: InputValueforlam =.False. 
Logical, save :: InputValueforYu =.False. 
Logical, save :: InputValueforTd =.False. 
Logical, save :: InputValueforTy1 =.False. 
Logical, save :: InputValueforTy2 =.False. 
Logical, save :: InputValueforTlam =.False. 
Logical, save :: InputValueforTu =.False. 
Logical, save :: InputValueformq2 =.False. 
Logical, save :: InputValueforml42 =.False. 
Logical, save :: InputValueforml92 =.False. 
...
Logical, save :: InputValueforme42 =.False. 
Logical, save :: InputValueforme92 =.False. 
...
& vS,g1,g2,g3,gp,Yd,y1,y2,lam,Yu,Td,Ty1,Ty2,Tlam,Tu,mq2,ml42,ml92,mHd2,mHu2,             & 
& md2,mu2,me42,me92,ms2,M1,M2,M3,M4,Tdp,Tep,MZsuffix)
...
End Module Model_Data_SplitUMSSM