...
! ------------------------------------------------------------------------------  
! File created at 5:11 on 15.11.2020   
! ----------------------------------------------------------------------  
 
 
Module Se3Decays_SplitUMSSM 
 
Use Control 
Use Settings 
Use CouplingsForDecays_SplitUMSSM 
...
& ms2,M1,M2,M3,M4,Tdp,Tep,vd,vu,vS,gSeAhChaFv,gSeAhChiFe,gSeSvChaChi,gSeChaFecHpm,       & 
...
Real(dp),Intent(inout) :: gSeAhChaFv(6,3,2,3),gSeAhChiFe(6,3,6,3),gSeSvChaChi(6,3,2,6),gSeChaFecHpm(6,2,3,2),   & 
& gSeSeChacCha(6,6,2,2),gSeSeChiChi(6,6,6,6),gSehhChiFe(6,3,6,3),gSeHpmChiFv(6,2,6,3),   & 
...
Real(dp) :: gSeAhChaFvi(3,2,3),gSeAhChiFei(3,6,3),gSeSvChaChii(3,2,6),gSeChaFecHpmi(2,3,2),       & 
& gSeSeChacChai(6,2,2),gSeSeChiChii(6,6,6),gSehhChiFei(3,6,3),gSeHpmChiFvi(2,6,3),       & 
...
& g1,g2,g3,gp,Yd,y1,y2,lam,Yu,Td,Ty1,Ty2,Tlam,Tu,mq2,ml42,ml92,mHd2,mHu2,md2,            & 
& mu2,me42,me92,ms2,M1,M2,M3,M4,Tdp,Tep,vd,vu,vS,cplAhSecSe,cplcChacFuSdL,               & 
...
& cplcChaChiHpmL,cplcChaChiHpmR,cplcChaFdcSuL,cplcChaFdcSuR,cplcChaFecSvL,               & 
& cplcChaFecSvR,cplcFdChiSdL,cplcFdChiSdR,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,           & 
...
gSeSeFvcFvi = 0._dp 
Call SeToSeFvcFv(i_run,MSe,MFv,MVZ,MVZp,MCha,cplSecSeVZ,cplSecSeVZp,cplcChacFvSeL,    & 
& cplcChacFvSeR,cplcFvFvVZL,cplcFvFvVZR,cplcFvFvVZpL,cplcFvFvVZpR,cplChaFvcSeL,          & 
& cplChaFvcSeR,deltaM,epsI,check,gSeSeFvcFvi)
...
Real(dp),Intent(in) :: MAh(3),MCha(2),MFv(3),MSe(6)
...
Real(dp),Intent(in) :: MAh(3),MChi(6),MFe(3),MSe(6)

Complex(dp),Intent(in) :: cplAhSecSe(3,6,6),cplcFeFeAhL(3,3,3),cplcFeFeAhR(3,3,3),cplChiChiAhL(6,6,3),          & 
& cplChiChiAhR(6,6,3),cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6)
...
Real(dp),Intent(in) :: MSv(3),MCha(2),MChi(6),MVWm,MHpm(2),MFv(3),MFe(3),MSe(6)

Complex(dp),Intent(in) :: cplHpmSvcSe(2,3,6),cplSvcSeVWm(3,6),cplcFeChaSvL(3,2,3),cplcFeChaSvR(3,2,3),          & 
& cplcFvChiSvL(3,6,3),cplcFvChiSvR(3,6,3),cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),       & 
& cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),cplChiChacVWmL(6,2),cplChiChacVWmR(6,2),   & 
& cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6)
...
Real(dp),Intent(in) :: MCha(2),MFe(3),MHpm(2),MFv(3),MChi(6),MSe(6)
...
Real(dp),Intent(in) :: MSe(6),MCha(2),MVZ,MVZp,MAh(3),Mhh(3),MFv(3)

Complex(dp),Intent(in) :: cplAhSecSe(3,6,6),cplhhSecSe(3,6,6),cplSecSeVZ(6,6),cplSecSeVZp(6,6),cplcChacFvSeL(2,3,6),& 
& cplcChacFvSeR(2,3,6),cplcChaChaAhL(2,2,3),cplcChaChaAhR(2,2,3),cplcChaChahhL(2,2,3),   & 
...
Real(dp),Intent(in) :: MSe(6),MChi(6),MVZ,MVZp,MAh(3),Mhh(3),MFe(3)

Complex(dp),Intent(in) :: cplAhSecSe(3,6,6),cplhhSecSe(3,6,6),cplSecSeVZ(6,6),cplSecSeVZp(6,6),cplcFeChiSeL(3,6,6),& 
& cplcFeChiSeR(3,6,6),cplChiChiAhL(6,6,3),cplChiChiAhR(6,6,3),cplChiChihhL(6,6,3),       & 
& cplChiChihhR(6,6,3),cplChiChiVZL(6,6),cplChiChiVZR(6,6),cplChiChiVZpL(6,6),            & 
& cplChiChiVZpR(6,6),cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6)
...
Real(dp),Intent(in) :: Mhh(3),MChi(6),MFe(3),MSe(6)

Complex(dp),Intent(in) :: cplhhSecSe(3,6,6),cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),cplChiChihhL(6,6,3),          & 
& cplChiChihhR(6,6,3),cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6)
...
Real(dp),Intent(in) :: MHpm(2),MChi(6),MFv(3),MSv(3),MFe(3),MCha(2),MSe(6)

Complex(dp),Intent(in) :: cplHpmSvcSe(2,3,6),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),cplcFeFvHpmL(3,3,2),   & 
& cplcFeFvHpmR(3,3,2),cplChaFvcSeL(2,3,6),cplChaFvcSeR(2,3,6),cplChiFecSeL(6,3,6),       & 
...
Real(dp),Intent(in) :: MFe(3),MFd(3),MSd(6),MChi(6),MSe(6)
...
Real(dp),Intent(in) :: MFe(3),MSe(6),MChi(6)
...
Real(dp),Intent(in) :: MFe(3),MFu(3),MSu(6),MChi(6),MSe(6)

Complex(dp),Intent(in) :: cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6)
...
Real(dp),Intent(in) :: MFv(3),MFe(3),MSv(3),MCha(2),MChi(6),MSe(6)
...
Real(dp),Intent(in) :: MHpm(2),MFe(3),MCha(2),MSv(3),MChi(6),MSe(6)

Complex(dp),Intent(in) :: cplHpmSvcSe(2,3,6),cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),cplcChaFecSvL(2,3,3),  & 
& cplcChaFecSvR(2,3,3),cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6)
...
Real(dp),Intent(in) :: MFe(3),MSd(6),MFd(3),MChi(6),MSe(6)

Complex(dp),Intent(in) :: cplcFdChiSdL(3,6,6),cplcFdChiSdR(3,6,6),cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6)
...
Real(dp),Intent(in) :: MSe(6),MFe(3),MVZ,MVZp,MAh(3),Mhh(3),MChi(6)
...
Real(dp),Intent(in) :: MFe(3),MSu(6),MFu(3),MChi(6),MSe(6)

Complex(dp),Intent(in) :: cplcFuChiSuL(3,6,6),cplcFuChiSuR(3,6,6),cplChiFecSeL(6,3,6),cplChiFecSeR(6,3,6)
...
Real(dp),Intent(in) :: MSv(3),MFe(3),MFv(3),MVWm,MHpm(2),MChi(6),MSe(6)

Complex(dp),Intent(in) :: cplHpmSvcSe(2,3,6),cplSvcSeVWm(3,6),cplcFvChiSvL(3,6,3),cplcFvChiSvR(3,6,3),          & 
...
Real(dp),Intent(in) :: Mhh(3),MCha(2),MFv(3),MSe(6)
...
Subroutine SeToSeFvcFv(iIN,MSe,MFv,MVZ,MVZp,MCha,cplSecSeVZ,cplSecSeVZp,              & 
& cplcChacFvSeL,cplcChacFvSeR,cplcFvFvVZL,cplcFvFvVZR,cplcFvFvVZpL,cplcFvFvVZpR,         & 
& cplChaFvcSeL,cplChaFvcSeR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSe(6),MFv(3),MVZ,MVZp,MCha(2)

Complex(dp),Intent(in) :: cplSecSeVZ(6,6),cplSecSeVZp(6,6),cplcChacFvSeL(2,3,6),cplcChacFvSeR(2,3,6),           & 
& cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplcFvFvVZpL(3,3),cplcFvFvVZpR(3,3),cplChaFvcSeL(2,3,6),& 
& cplChaFvcSeR(2,3,6)
...
Real(dp),Intent(in) :: MSe(6),MFd(3),MVZ,MVZp,MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplAhSecSe(3,6,6),cplhhSecSe(3,6,6),cplSecSeVZ(6,6),cplSecSeVZp(6,6),cplcFdFdAhL(3,3,3),& 
...
Real(dp),Intent(in) :: MSe(6),MFu(3),MVZ,MVZp,MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplAhSecSe(3,6,6),cplhhSecSe(3,6,6),cplSecSeVZ(6,6),cplSecSeVZp(6,6),cplcFuFuAhL(3,3,3),& 
...
End Module Se3Decays_SplitUMSSM 
