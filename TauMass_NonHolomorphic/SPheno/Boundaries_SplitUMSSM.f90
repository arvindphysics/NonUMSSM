...
Call GToParameters207(gA,g1,g2,g3,gp,Yd,y1,y2,lam,Yu,Td,Ty1,Ty2,Tlam,Tu,              & 
...
Call ParametersToG207(g1,g2,g3,gp,Yd,y1,y2,lam,Yu,Td,Ty1,Ty2,Tlam,Tu,mq2,             & 
& ml42,ml92,mHd2,mHu2,md2,mu2,me42,me92,ms2,M1,M2,M3,M4,Tdp,Tep,gB)
...
End if 
If (Abs(y1).gt.3._dp) Then 
Write(*,*) "Non pertubative coupling at GUT scale y1" 
If (ErrorLevel.gt.0) Call TerminateProgram 
End if 
If (Maxval(Abs(y2)).gt.3._dp) Then 
Write(*,*) "Non pertubative coupling at GUT scale y2" 
If (ErrorLevel.gt.0) Call TerminateProgram 
End if 
...
& me42,me92,ms2,M1,M2,M3,M4,Tdp,Tep,delta0,gMZ,kont)
...
& MVZp,g1,g2,gp,TW,TWp,UM,UP,vd,vu,y1,y2,ZA,ZE,ZEL,ZER,ZH,ZN,ZP,ZV,ZVL,delta)
...
Call SetMatchingConditions(g1SM,g2SM,g3SM,YuSM,YdSM,YeSM,vSM,vd,vu,vS,g1,             & 
& g2,g3,gp,Yd,y1,y2,lam,Yu,Td,Ty1,Ty2,Tlam,Tu,mq2,ml42,ml92,mHd2,mHu2,md2,               & 
& mu2,me42,me92,ms2,M1,M2,M3,M4,Tdp,Tep,.True.)
...
Call CouplingsForSMfermions(y1,y2,ZA,ZEL,ZER,g2,ZV,UM,UP,g1,gp,ZE,ZN,ZH,              & 
...
Call ParametersToG207(g1,g2,g3,gp,Yd,y1,y2,lam,Yu,Td,Ty1,Ty2,Tlam,Tu,mq2,             & 
& ml42,ml92,mHd2,mHu2,md2,mu2,me42,me92,ms2,M1,M2,M3,M4,Tdp,Tep,gMZ)
...
& Yu,Td,Ty1,Ty2,Tlam,Tu,mq2,ml42,ml92,mHd2,mHu2,md2,mu2,me42,me92,ms2,M1,M2,             & 
& M3,M4,Tdp,Tep,mGut,kont,WriteComment,niter)

Implicit None
Logical,Intent(in) :: WriteComment
Integer,Intent(inout) :: kont
Integer,Intent(in) :: niter
Real(dp) :: delta0,deltaG0, gA(207), gB(207)
Real(dp) :: gC(210),  gD(210) 
...
& ms2,M1,M2,M3,M4,Tdp,Tep,delta0,gB,kont)
...
& ml42,ml92,mHd2,mHu2,md2,mu2,me42,me92,ms2,M1,M2,M3,M4,Tdp,Tep,vd,vu,vS,gC)

Call odeint(gC,210,tz,0._dp,0.1_dp*delta0,dt,0._dp,rge210,kont)
Call GToParameters210(gC,g1,g2,g3,gp,Yd,y1,y2,lam,Yu,Td,Ty1,Ty2,Tlam,Tu,              & 
...
tz=Log(mZ/Q)
dt=-tz/50._dp
Call odeint(gD,210,tz,0._dp,0.1_dp*delta0,dt,0._dp,rge210,kont)
...
Real(dp),Intent(in)::delta0
Integer :: i1, i2, i3, i4 
Real(dp),Intent(inout)::g1A(207)
Real(dp),Intent(out)::g1C(207),mGUT
Real(dp)::tz,dt,t_out 
Real(dp)::mudim,gGUT,gA_h(207),g1b(207),m_hi,m_lo
Real(dp)::g1S(207)
...
dt=tz/100._dp
Call odeint(g1A,207,tz,0._dp,delta0,dt,0._dp,rge207,kont)
...
Call odeint(g1B,207,tz,0._dp,delta0,dt,0._dp,rge207,kont)
...
Call odeintB2(g1B,207,tz,0._dp,delta0,dt,0._dp,rge207,checkGUT207,t_out,kont)
...
dt=tz/100._dp
Call odeint(g1c,207,0._dp,tz,delta0,dt,0._dp,rge207,kont)
Iname=Iname-1
...
& y1,y2,lam,Yu,Td,Ty1,Ty2,Tlam,Tu,mq2,ml42,ml92,mHd2,mHu2,md2,mu2,me42,me92,             & 
& ms2,M1,M2,M3,M4,Tdp,Tep,mGut,kont,WriteComment,niter)
...
Real(dp),Intent(out)::g1C(207),mGUT
Real(dp)::tz,dt,t_out 
Real(dp)::mudim,gGUT,gA_h(207),m_hi,m_lo
Real(dp)::g1B(207)
Real(dp)::g1S(207)
Logical :: FoundUnification, unified, greater 
...
Subroutine checkGUT207(y,eps,unified,greater)  
Implicit None 
Real(dp), Intent(in) :: y(207), eps 
...
Call GToParameters207(y,g1,g2,g3,gp,Yd,y1,y2,lam,Yu,Td,Ty1,Ty2,Tlam,Tu,               & 
& mq2,ml42,ml92,mHd2,mHu2,md2,mu2,me42,me92,ms2,M1,M2,M3,M4,Tdp,Tep)
...
Real(dp):: gA(207), gB(207), Scale_Save 
...
Call ParametersToG207(g1,g2,g3,gp,Yd,y1,y2,lam,Yu,Td,Ty1,Ty2,Tlam,Tu,mq2,             & 
& ml42,ml92,mHd2,mHu2,md2,mu2,me42,me92,ms2,M1,M2,M3,M4,Tdp,Tep,gA)
...
Iname=Iname-1 
    ...
    Call TerminateProgram
End if 
Call GToParameters207(gB,g1,g2,g3,gp,Yd,y1,y2,lam,Yu,Td,Ty1,Ty2,Tlam,Tu,              & 
& mq2,ml42,ml92,mHd2,mHu2,md2,mu2,me42,me92,ms2,M1,M2,M3,M4,Tdp,Tep)
...
End Module Boundaries_SplitUMSSM 
