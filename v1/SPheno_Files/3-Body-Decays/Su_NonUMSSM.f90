...
! ------------------------------------------------------------------------------  
! File created at 16:29 on 4.2.2021   
! ----------------------------------------------------------------------  
 
 
Module Su3Decays_NonUMSSM 
...
& gSuAhChiFu,gSuAhFdcCha,gSuAhFuGlu,gSuSuChiChi,gSucHpmChiFd,gSuhhChiFu,gSuChiGluSu,     & 
& gSuSdChicCha,gSuFdFucSd,gSuFdFvcSe,gSuhhFdcCha,gSuSuFdcFd,gSuFdSvcFe,gSucHpmChaFu,     & 
& gSuFuFecSe,gSuFuFucSu,gSuFuFvcSv,gSucChaFuHpm,gSuSdFucFd,gSuFuSecFe,gSuSuFucFu,        & 
& gSuFuSvcFv,gSucHpmFdGlu,gSuhhFuGlu,gSuGluGluSu,gSuGluSdcCha,gSuSdFvcFe,gSuSuChacCha,   & 
...
Real(dp),Intent(inout) :: gSuAhChiFu(6,3,6,3),gSuAhFdcCha(6,3,3,2),gSuAhFuGlu(6,3,3,1),gSuSuChiChi(6,6,6,6),    & 
...
Real(dp) :: gSuAhChiFui(3,6,3),gSuAhFdcChai(3,3,2),gSuAhFuGlui(3,3,1),gSuSuChiChii(6,6,6),        & 
& gSucHpmChiFdi(2,6,3),gSuhhChiFui(3,6,3),gSuChiGluSui(6,1,6),gSuSdChicChai(6,6,2),      & 
...
& Tmup,vd,vu,vS,cplAhSucSu,cplcChacFuSdL,cplcChacFuSdR,cplcChaChaAhL,cplcChaChaAhR,      & 
...
gSuSuFvcFvi = 0._dp 
Call SuToSuFvcFv(i_run,MSu,MFv,MVZ,MVZp,cplSucSuVZ,cplSucSuVZp,cplcFvFvVZL,           & 
...
Real(dp),Intent(in) :: MAh(3),MChi(6),MFu(3),MSu(6)

Complex(dp),Intent(in) :: cplAhSucSu(3,6,6),cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),cplChiChiAhL(6,6,3),          & 
& cplChiChiAhR(6,6,3),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6)
...
Real(dp),Intent(in) :: MSu(6),MChi(6),MVZ,MVZp,MAh(3),Mhh(3),MFu(3)

Complex(dp),Intent(in) :: cplAhSucSu(3,6,6),cplhhSucSu(3,6,6),cplSucSuVZ(6,6),cplSucSuVZp(6,6),cplcFuChiSuL(3,6,6),& 
& cplcFuChiSuR(3,6,6),cplChiChiAhL(6,6,3),cplChiChiAhR(6,6,3),cplChiChihhL(6,6,3),       & 
& cplChiChihhR(6,6,3),cplChiChiVZL(6,6),cplChiChiVZR(6,6),cplChiChiVZpL(6,6),            & 
& cplChiChiVZpR(6,6),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6)
...
Real(dp),Intent(in) :: MHpm(2),MChi(6),MFd(3),MSd(6),MFu(3),MCha(2),MSu(6)

Complex(dp),Intent(in) :: cplSdcHpmcSu(6,2,6),cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),cplcFuFdcHpmL(3,3,2),   & 
& cplcFuFdcHpmR(3,3,2),cplChiChacHpmL(6,2,2),cplChiChacHpmR(6,2,2),cplChiFdcSdL(6,3,6),  & 
...
Real(dp),Intent(in) :: Mhh(3),MChi(6),MFu(3),MSu(6)

Complex(dp),Intent(in) :: cplhhSucSu(3,6,6),cplcFuFuhhL(3,3,3),cplcFuFuhhR(3,3,3),cplChiChihhL(6,6,3),          & 
& cplChiChihhR(6,6,3),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6)
...
Real(dp),Intent(in) :: MChi(6),MGlu,MSu(6),MFu(3)
...
Real(dp),Intent(in) :: MSd(6),MChi(6),MCha(2),MVWm,MHpm(2),MFu(3),MFd(3),MSu(6)
...
& cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),cplcFdChiSdL(3,6,6),cplcFdChiSdR(3,6,6),     & 
& cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6)
...
Real(dp),Intent(in) :: MFd(3),MFu(3),MSd(6),MCha(2),MChi(6),MGlu,MSu(6)
...
Real(dp),Intent(in) :: MSu(6),MFd(3),MVZ,MVZp,MAh(3),Mhh(3),MCha(2)

Complex(dp),Intent(in) :: cplAhSucSu(3,6,6),cplhhSucSu(3,6,6),cplSucSuVZ(6,6),cplSucSuVZp(6,6),cplcChaFdcSuL(2,3,6),& 
...
Real(dp),Intent(in) :: MHpm(2),MCha(2),MFu(3),MSd(6),MChi(6),MSu(6)

Complex(dp),Intent(in) :: cplSdcHpmcSu(6,2,6),cplChaFucSdL(2,3,6),cplChaFucSdR(2,3,6),cplChiChacHpmL(6,2,2),    & 
& cplChiChacHpmR(6,2,2),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6)
...
Real(dp),Intent(in) :: MFu(3),MFe(3),MSe(6),MChi(6),MSu(6)
...
Real(dp),Intent(in) :: MFu(3),MSu(6),MChi(6),MGlu

Complex(dp),Intent(in) :: cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6),cplGluFucSuL(3,6),cplGluFucSuR(3,6)
...
Real(dp),Intent(in) :: MFu(3),MFv(3),MSv(3),MChi(6),MSu(6)
...
Real(dp),Intent(in) :: MCha(2),MFu(3),MHpm(2),MFd(3),MChi(6),MSu(6)

Complex(dp),Intent(in) :: cplcChaChiHpmL(2,6,2),cplcChaChiHpmR(2,6,2),cplcChaFdcSuL(2,3,6),cplcChaFdcSuR(2,3,6),& 
& cplcFdFuHpmL(3,3,2),cplcFdFuHpmR(3,3,2),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6)
...
Real(dp),Intent(in) :: MSd(6),MFu(3),MFd(3),MVWm,MHpm(2),MChi(6),MGlu,MSu(6)

Complex(dp),Intent(in) :: cplSdcHpmcSu(6,2,6),cplSdcSucVWm(6,6),cplcFdChiSdL(3,6,6),cplcFdChiSdR(3,6,6),        & 
& cplcFdFuHpmL(3,3,2),cplcFdFuHpmR(3,3,2),cplcFdFuVWmL(3,3),cplcFdFuVWmR(3,3),           & 
& cplcFdGluSdL(3,6),cplcFdGluSdR(3,6),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6),           & 
...
Real(dp),Intent(in) :: MFu(3),MSe(6),MFe(3),MChi(6),MSu(6)

Complex(dp),Intent(in) :: cplcFeChiSeL(3,6,6),cplcFeChiSeR(3,6,6),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6)
...
Real(dp),Intent(in) :: MSu(6),MFu(3),MVZ,MVZp,MAh(3),Mhh(3),MChi(6),MGlu

Complex(dp),Intent(in) :: cplAhSucSu(3,6,6),cplhhSucSu(3,6,6),cplSucSuVZ(6,6),cplSucSuVZp(6,6),cplcFuChiSuL(3,6,6),& 
& cplcFuChiSuR(3,6,6),cplcFuFuAhL(3,3,3),cplcFuFuAhR(3,3,3),cplcFuFuhhL(3,3,3),          & 
& cplcFuFuhhR(3,3,3),cplcFuFuVZL(3,3),cplcFuFuVZR(3,3),cplcFuFuVZpL(3,3),cplcFuFuVZpR(3,3),& 
& cplcFuGluSuL(3,6),cplcFuGluSuR(3,6),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6),           & 
& cplGluFucSuL(3,6),cplGluFucSuR(3,6)
...
Real(dp),Intent(in) :: MFu(3),MSv(3),MFv(3),MChi(6),MSu(6)

Complex(dp),Intent(in) :: cplcFvChiSvL(3,6,3),cplcFvChiSvR(3,6,3),cplChiFucSuL(6,3,6),cplChiFucSuR(6,3,6)
...
Real(dp),Intent(in) :: MSu(6),MCha(2),MVZ,MVZp,MAh(3),Mhh(3),MFd(3)

Complex(dp),Intent(in) :: cplAhSucSu(3,6,6),cplhhSucSu(3,6,6),cplSucSuVZ(6,6),cplSucSuVZp(6,6),cplcChaChaAhL(2,2,3),& 
& cplcChaChaAhR(2,2,3),cplcChaChahhL(2,2,3),cplcChaChahhR(2,2,3),cplcChaChaVZL(2,2),     & 
...
Real(dp),Intent(in) :: MSu(6),MFe(3),MVZ,MVZp,MAh(3),Mhh(3)

Complex(dp),Intent(in) :: cplAhSucSu(3,6,6),cplhhSucSu(3,6,6),cplSucSuVZ(6,6),cplSucSuVZp(6,6),cplcFeFeAhL(3,3,3),& 
& cplcFeFeAhR(3,3,3),cplcFeFehhL(3,3,3),cplcFeFehhR(3,3,3),cplcFeFeVZL(3,3),             & 
...
Subroutine SuToSuFvcFv(iIN,MSu,MFv,MVZ,MVZp,cplSucSuVZ,cplSucSuVZp,cplcFvFvVZL,       & 
& cplcFvFvVZR,cplcFvFvVZpL,cplcFvFvVZpR,deltaM,epsI,check,g,WriteContributions)

Implicit None 
 
Real(dp),Intent(in) :: MSu(6),MFv(3),MVZ,MVZp

Complex(dp),Intent(in) :: cplSucSuVZ(6,6),cplSucSuVZp(6,6),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplcFvFvVZpL(3,3), & 
& cplcFvFvVZpR(3,3)
